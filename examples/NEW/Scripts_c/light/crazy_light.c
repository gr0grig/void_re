...
{
    // crazy_light.sc:17
    r0 = GetDotStr("Group");  // @src crazy_light.sc:17
    r0 = (int)r0;
    // crazy_light.sc:19
    ...
    // crazy_light.sc:23
  L_003c:
    r4 = GetDotStr("irandRange");  // @src crazy_light.sc:23
    r5 = 5000;
    r6 = 7000;
    GetDot(r3, 2);
    Free1(r4);
  ...
  L_006c:
    ...
    Call(r6, 0x0414);
    // crazy_light.sc:32
    r7 = GetDotStr("Scene");  // @src crazy_light.sc:32
    SetDotRaw(r6, 23);
    Free1(r7);
    r7 = r0;
    r9 = GetDotStr("!vec3");
  ...
  L_0184:
    ...
    r5 = r5 + r6;
    // crazy_light.sc:44
    r8 = GetDotStr("Scene");  // @src crazy_light.sc:44
    SetDotRaw(r7, 23);
    Free1(r8);
    r8 = r0;
    r10 = GetDotStr("!vec3");
  ...
  L_0284:
    ...
    Call(r7, 0x0414);
    // crazy_light.sc:54
    r8 = GetDotStr("Scene");  // @src crazy_light.sc:54
    SetDotRaw(r7, 23);
    Free1(r8);
    r8 = r0;
    r10 = GetDotStr("!vec3");
...
{
    // crazy_light.sc:12
    r1 = GetDotStr("rand");  // @src crazy_light.sc:12
    GetDot(r0, 0);
    Free1(r1);
