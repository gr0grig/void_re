...
func_1()
{
    ...
    CallMethod(r0, 0, 0x142);  // @patch+8 arena_flache_camera.sc:8
...
setPosition()
{
    ...
    r1 = GetDotStr("playAnimation");  // @src arena_flache_camera.sc:26
    r2 = "flache_camera";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    CallMethod(r1, 0, 0x36);  // @patch+8 arena_flache_camera.sc:28
