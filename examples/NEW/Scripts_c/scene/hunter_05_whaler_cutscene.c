...
func_1()
{
    ...
    CallMethod(r0, 0, 0x142);  // @patch+8 hunter_05_whaler_cutscene.sc:8
    if (r1) goto L_0000;
}
...
func_2()
{
    ...
    r1 = GetDotStr("loadAnimationSet");  // @src hunter_05_whaler_cutscene.sc:18
    r2 = "anim/camera_whaler_cutscene.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // hunter_05_whaler_cutscene.sc:19
    r1 = GetDotStr("playAnimation");  // @src hunter_05_whaler_cutscene.sc:19
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    CallMethod(r0, 0, 0x243);  // @patch+8 hunter_05_whaler_cutscene.sc:21
...
func_3()
{
  ...
  L_0120:
    ...
    CallMethod(r1, 0, 0x36);  // @patch+8 hunter_05_whaler_cutscene.sc:29
