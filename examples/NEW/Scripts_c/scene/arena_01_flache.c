...
// arena_01_flache.sc:61 (locals=0)
func_1()
{
    // arena_01_flache.sc:60
    Call(r0, 0x0028);  // @src arena_01_flache.sc:60
    // arena_01_flache.sc:61
    return r0;  // @src arena_01_flache.sc:61
}
...
// arena_01_flache.sc:20 (locals=4)
func_105()
{
    // arena_01_flache.sc:16
    Call(r1, 0x4960);  // @src arena_01_flache.sc:16
    // arena_01_flache.sc:19
    r1 = GetDotStr("sendGenericEventToWorld");  // @src arena_01_flache.sc:19
    r2 = GetDotStr("World");
    r3 = "onHunterDead";
    GetDot(r0, 2);
    Free4(r1, r2, r3, r0);
    // arena_01_flache.sc:20
    return r0;  // @src arena_01_flache.sc:20
}
...
// arena_01_flache.sc:57 (locals=3)
getActivePlane()
{
    // arena_01_flache.sc:41
    r0 = r_neg4;  // @src arena_01_flache.sc:41
    r0 = g16;
    Free1(r0);
    // arena_01_flache.sc:56
    g2 = r16;  // @src arena_01_flache.sc:56
    SetDotRaw(r1, 4000);
    Free1(r2);
    r2 = "damage_color";
    SetDot(r0, 1);
    ...
    r0 = (int)r0;
    Call(r1, 0x4d44);
    // arena_01_flache.sc:57
    Free1(r_neg4);  // @src arena_01_flache.sc:57
    return r0;
}
...
// arena_01_flache.sc:33 (locals=4)
func_110()
{
    // arena_01_flache.sc:28
    r0 = null_str2;  // @src arena_01_flache.sc:28
    // arena_01_flache.sc:30
    r2 = GetDotStr("hasVariable");  // @src arena_01_flache.sc:30
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_4fd4;
    r2 = GetDotStr("getVariable");  // @src arena_01_flache.sc:30
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
  ...
  L_4fd4:
    g1 = r16;  // @src arena_01_flache.sc:31
    if (!r1) goto L_5020;
    g3 = r16;  // @src arena_01_flache.sc:31
    SetDotRaw(r2, 4000);
    Free1(r3);
    r3 = "name";
    SetDot(r1, 1);
    ...
    r0 = r1;
    Free1(r1);
    // arena_01_flache.sc:32
  L_5020:
    r1 = r0;  // @src arena_01_flache.sc:32
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
}

// arena_01_flache.sc:38 (locals=2)
initMusic()
{
    // arena_01_flache.sc:37
    r1 = GetDotStr("rand");  // @src arena_01_flache.sc:37
    GetDot(r0, 0);
    Free1(r1);
...
{
    // playable.sci:214
    Call(r0, 0x59e4);  // @src playable.sci:214
    // playable.sci:215
...
disableWheel()
{
    ...
    Free2(r1, r0);
    // playable.sci:220
    Call(r0, 0x5a1c);  // @src playable.sci:220
    // playable.sci:221
...
{
    // playable.sci:225
    Call(r1, 0x5ad8);  // @src playable.sci:225
    // playable.sci:226
...
getSpeedFactor()
{
    ...
    // playable.sci:234
    goto L_5c00;  // @src playable.sci:234
    // playable.sci:237
  L_5bb4:
    ...
    // playable.sci:233
  L_5c00:
    goto L_5e54;  // @src playable.sci:233
    // playable.sci:241
  L_5c08:
  ...
  L_5cbc:
    ...
    // playable.sci:242
    goto L_5d20;  // @src playable.sci:242
    // playable.sci:245
  L_5cd4:
  ...
  L_5d28:
    ...
    if (!r0) goto L_5e54;
    // playable.sci:251
    Call(r1, 0x5ad8);  // @src playable.sci:251
    // playable.sci:252
