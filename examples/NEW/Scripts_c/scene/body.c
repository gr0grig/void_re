...
{
    // body.sc:50
    r1 = GetDotStr("!qtpair");  // @src body.sc:50
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // body.sc:51
    r3 = GetDotStr("World");  // @src body.sc:51
    SetDotRaw(r2, 14);
    Free1(r3);
    r3 = GetDotStr("self");
    r4 = "hero_last.xml";
    ...
    Free1(r1);
    // body.sc:53
    r2 = GetDotStr("!vector");  // @src body.sc:53
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g1;
    Free1(r1);
    // body.sc:54
    r2 = GetDotStr("!qtpair");  // @src body.sc:54
    ...
    Free3(r2, r3, r1);
    // body.sc:57
    r2 = GetDotStr("!qtpair");  // @src body.sc:57
    r4 = GetDotStr("!rotateY");
    ...
    Free3(r2, r3, r1);
    // body.sc:60
    r2 = GetDotStr("!qtpair");  // @src body.sc:60
    r4 = GetDotStr("!rotateY");
