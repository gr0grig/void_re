...
// @func_table: 19 groups offsets=76,812,1607,2343,3333,4319,5178,6002,6798,7589,8380,9147,9978,10773,11584,12391,13202,14013,14837
...
//   export "addGirlData" args=2 cb=-1 {func_23} types=[int,str]
...
//   export "addGirlDataByName" args=2 cb=-1 {func_22} types=[str,str]
//   export "addHunterDataByName" args=2 cb=-1 {func_133} types=[str,str]
//   export "getGirlByName" args=1 cb=-1 {func_27} types=[str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 17: parent=0 stack=6 locals=6 types=[str,str,str,str,str,str] vtable=[] imports=[(17,0)]
//   export "render" args=0 cb=-1 {func_111}
//   export "needViewRender" args=0 cb=-1 {func_112}
//   export "getActivePlane" args=0 cb=-1 {func_113}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 18: parent=0 stack=3 locals=3 types=[str,str,bool] vtable=[] imports=[(18,0)]
//   export "onInputAction" args=2 cb=-1 {func_115} types=[str,bool]
//   export "render" args=0 cb=-1 {func_116}
//   export "needViewRender" args=0 cb=-1 {func_117}
...
// #export {func_22} name="addGirlDataByName"
// #export {func_23} name="addGirlData"
// #export {func_27} name="getGirlByName"
...
// #export {func_113} name="getActivePlane"
// #export {func_115} name="onInputAction"
// #export {func_116} name="render"
// #export {func_117} name="needViewRender"
...
func_1()
{
    ...
    CallNat(r1, 40944, 0x0);  // @src talk_girl_base.sci:97
}
...
func_9()
{
  ...
  L_1030:
    ...
    CallNat(r3, 36240, 0x1);
}

// obscure_aya.sc:67 (locals=7)
getCurrentCamera()
{
    // obscure_aya.sc:42
    r0 = true;  // @src obscure_aya.sc:42
    r1 = r_neg6;
    r2 = -1;
    r1 = r1 == r2;
    if (r1) goto L_10bc;
  ...
  L_10bc:
    ...
    Free3(r1, r2, r0);
    // obscure_aya.sc:44
    return r0;  // @src obscure_aya.sc:44
    // obscure_aya.sc:47
  L_10f8:
    r1 = r_neg5;  // @src obscure_aya.sc:47
    Call(r2, 0x135c);
    if (r0) goto L_1338;
    // obscure_aya.sc:48
    r1 = GetDotStr("getGestureName");  // @src obscure_aya.sc:48
    r2 = "player";
    r3 = r_neg6;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    r_neg4 = r1;
    // obscure_aya.sc:52
    r1 = r_neg4;  // @src obscure_aya.sc:52
    r2 = -1;
    r1 = r1 == r2;
    if (!r1) goto L_1194;
    Free1(r0);  // @src obscure_aya.sc:52
    return r0;
    // obscure_aya.sc:54
  L_1194:
    r2 = r0;  // @src obscure_aya.sc:54
    r3 = r_neg5;
    r4 = r_neg4;
    Call(r5, 0x15cc);
    // obscure_aya.sc:55
    r2 = r1;  // @src obscure_aya.sc:55
    if (!r2) goto L_1330;
    // obscure_aya.sc:57
    r4 = GetDotStr("World");  // @src obscure_aya.sc:57
    SetDotRaw(r3, 173);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
    ...
    Free2(r5, r3);
    // obscure_aya.sc:61
    r3 = r1;  // @src obscure_aya.sc:61
    CallNat2(r5, 12080, 0x301);
    // obscure_aya.sc:62
    Free3(r2, r1, r0);  // @src obscure_aya.sc:62
    return r0;
    // obscure_aya.sc:47
  L_1330:
    Free2(r1, r0);  // @src obscure_aya.sc:47
    // obscure_aya.sc:66
  L_1338:
    r0 = r_neg6;  // @src obscure_aya.sc:66
    r1 = r_neg5;
    r2 = r_neg4;
    Call(r3, 0x3a90);
    // obscure_aya.sc:67
    return r0;  // @src obscure_aya.sc:67
}
...
// girl_aya_talk.sci:212 (locals=4)
func_13()
{
    // girl_aya_talk.sci:178
    r0 = null_str2;  // @src girl_aya_talk.sci:178
    // girl_aya_talk.sci:180
    r1 = r_neg6;  // @src girl_aya_talk.sci:180
    r2 = "gesture_about_common";
    r1 = r1 == r2;
    if (!r1) goto L_1768;
    // girl_aya_talk.sci:182
    r2 = 3;  // @src girl_aya_talk.sci:182
    Call(r3, 0x1800);
    if (!r1) goto L_1670;
    // girl_aya_talk.sci:184
    r2 = "common_aya_chapter4";  // @src girl_aya_talk.sci:184
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:185
    r1 = r0;  // @src girl_aya_talk.sci:185
    if (!r1) goto L_1670;
    r2 = r0;  // @src girl_aya_talk.sci:185
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_aya_talk.sci:188
  L_1670:
    r2 = 4;  // @src girl_aya_talk.sci:188
    Call(r3, 0x1800);
    if (!r1) goto L_16e8;
    // girl_aya_talk.sci:190
    r2 = "common_aya_chapter5";  // @src girl_aya_talk.sci:190
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:191
    r1 = r0;  // @src girl_aya_talk.sci:191
    if (!r1) goto L_16e8;
    r2 = r0;  // @src girl_aya_talk.sci:191
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_aya_talk.sci:194
  L_16e8:
    r2 = 6;  // @src girl_aya_talk.sci:194
    Call(r3, 0x1800);
    if (!r1) goto L_1760;
    // girl_aya_talk.sci:196
    r2 = "common_aya_chapter7";  // @src girl_aya_talk.sci:196
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:197
    r1 = r0;  // @src girl_aya_talk.sci:197
    if (!r1) goto L_1760;
    r2 = r0;  // @src girl_aya_talk.sci:197
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    ...
    // girl_aya_talk.sci:180
  L_1760:
    goto L_17e8;  // @src girl_aya_talk.sci:180
    // girl_aya_talk.sci:201
  L_1768:
    r1 = r_neg6;  // @src girl_aya_talk.sci:201
    r2 = "gesture_about_hunter";
    r1 = r1 == r2;
    if (!r1) goto L_17e8;
    // girl_aya_talk.sci:203
    r2 = "zagovor_aya_main1";  // @src girl_aya_talk.sci:203
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:204
    r1 = r0;  // @src girl_aya_talk.sci:204
    if (!r1) goto L_17e8;
    r2 = r0;  // @src girl_aya_talk.sci:204
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_aya_talk.sci:208
  L_17e8:
    r1 = null_str;  // @src girl_aya_talk.sci:208
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
}
...
func_17()
{
    ...
    Call(r0, 0x1a14);  // @src talk_girl_base.sci:710
...
func_20()
{
  ...
  L_1da0:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:677
    goto L_1da0;  // @src talk_girl_base.sci:677
  ...
  L_1f5c:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:694
    goto L_1f5c;  // @src talk_girl_base.sci:694
  ...
  L_1fc8:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:699
    goto L_1fc8;  // @src talk_girl_base.sci:699
    // talk_girl_base.sci:704
  L_2024:
    r4 = false;  // @src talk_girl_base.sci:704
    RetV(r3);
    Free2(r4, r3);
    goto L_2024;  // @src talk_girl_base.sci:704
}
...
func_28()
{
  ...
  L_2a84:
    ...
    // talk_base.sci:114
  L_2a94:
    goto L_2aac;  // @src talk_base.sci:114
    // talk_base.sci:136
  L_2a9c:
  ...
  L_2b30:
    ...
    RetV(r2);
    Free2(r3, r2);
    goto L_2b30;  // @src talk_base.sci:143
    // talk_base.sci:144
  L_2b4c:
...
func_30()
{
  ...
  L_2cb8:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_2cb8;  // @src talk_base.sci:700
}
...
skipBreachGesture()
{
    ...
    CallNat(r3, 12460, 0x0);  // @src talk_girl_base.sci:846
}
...
func_38()
{
  ...
  L_3070:
    ...
    Free1(r2);
    // talk_base.sci:28
    goto L_300c;  // @src talk_base.sci:28
    // talk_base.sci:23
  L_30a4:
    goto L_2ff0;  // @src talk_base.sci:23
}

// obscure_aya.sc:33 (locals=2)
func_39()
{
    // obscure_aya.sc:28
    Call(r1, 0x30f0);  // @src obscure_aya.sc:28
    // obscure_aya.sc:29
    r1 = r0;  // @src obscure_aya.sc:29
    if (!r1) goto L_30e0;
    // obscure_aya.sc:30
    r1 = r0;  // @src obscure_aya.sc:30
    CallNat(r5, 14756, 0x101);
    // obscure_aya.sc:32
  L_30e0:
    Call(r1, 0x3a3c);  // @src obscure_aya.sc:32
    // obscure_aya.sc:33
    Free1(r0);  // @src obscure_aya.sc:33
    return r0;
}

// girl_aya_talk.sci:170 (locals=8)
func_40()
{
    // girl_aya_talk.sci:126
    r0 = false;  // @src girl_aya_talk.sci:126
    r1 = false;
    r3 = GetDotStr("World");
    r3 = (str)r3;
    Call(r4, 0x3630);
  ...
  L_31b8:
    if (!r0) goto L_32a0;
    // girl_aya_talk.sci:129
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:129
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:130
    r3 = r0;  // @src girl_aya_talk.sci:130
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    ...
    r3 = r0;  // @src girl_aya_talk.sci:131
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "aya_turgor";
    r5 = true;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:132
    r1 = r0;  // @src girl_aya_talk.sci:132
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_aya_talk.sci:139
  L_32a0:
    r0 = false;  // @src girl_aya_talk.sci:139
    r1 = false;
    r3 = GetDotStr("World");
    r3 = (str)r3;
    Call(r4, 0x3630);
  ...
  L_3364:
    if (!r0) goto L_344c;
    // girl_aya_talk.sci:142
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:142
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:143
    r3 = r0;  // @src girl_aya_talk.sci:143
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:144
    r3 = r0;  // @src girl_aya_talk.sci:144
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "aya_not_turgor";
    r5 = true;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:145
    r1 = r0;  // @src girl_aya_talk.sci:145
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_aya_talk.sci:152
  L_344c:
    r0 = false;  // @src girl_aya_talk.sci:152
    r1 = false;
    r5 = GetDotStr("World");
    SetDotRaw(r4, 1493);
    Free1(r5);
  ...
  L_3534:
    if (!r0) goto L_361c;
    // girl_aya_talk.sci:155
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:155
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:156
    r3 = r0;  // @src girl_aya_talk.sci:156
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    r6 = "aya_treekiller_appears";
    r7 = true;
    Spawn(r3, 0, 0x19a4);
    r0 = null_str;
    Free3(r4, r5, r6);
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:157
    r3 = r0;  // @src girl_aya_talk.sci:157
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "aya_treekiller_appears1";
    r5 = true;
    Spawn(r3, 0, 0x2c30);
    r0 = 1.538625713828649e-42f;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:158
    r1 = r0;  // @src girl_aya_talk.sci:158
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_aya_talk.sci:166
  L_361c:
    r0 = null_str;  // @src girl_aya_talk.sci:166
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
needViewRender()
{
    ...
    CallNat(r3, 14888, 0x0);  // @src talk_girl_base.sci:854
}

// obscure_aya.sc:38 (locals=0)
getActivePlane()
{
    // obscure_aya.sc:37
    Call(r0, 0x3a3c);  // @src obscure_aya.sc:37
    // obscure_aya.sc:38
    return r0;  // @src obscure_aya.sc:38
}
...
func_48()
{
  ...
  L_3cbc:
    ...
    Call(r4, 0x2cd4);  // @src talk_girl_base.sci:410
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x6e40);
  ...
  L_406c:
    ...
    CopyExtRd(r4, 1, 4);
    // talk_girl_base.sci:413
    goto L_40b8;  // @src talk_girl_base.sci:413
  ...
  L_40c4:
    ...
    // talk_girl_base.sci:398
  L_40cc:
    goto L_4744;  // @src talk_girl_base.sci:398
  ...
  L_42d4:
    ...
    Call(r4, 0x2cd4);  // @src talk_girl_base.sci:457
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x6e40);
  ...
  L_44c8:
    ...
    Call(r4, 0x2cd4);  // @src talk_girl_base.sci:467
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x6e40);
    // talk_girl_base.sci:469
    Call(r3, 0x7a68);  // @src talk_girl_base.sci:469
    // talk_girl_base.sci:439
  L_45f0:
...
func_50()
{
  ...
  L_4890:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_4890;  // @src talk_girl_base.sci:739
}
...
func_51()
{
    ...
    Free2(r2, r0);
    // talk_girl_base.sci:273
    goto L_49c0;  // @src talk_girl_base.sci:273
...
func_52()
{
  ...
  L_4e48:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_4e48;  // @src talk_base.sci:692
}
...
func_55()
{
  ...
  L_510c:
    ...
    Free1(r4);
    // talk_girl_base.sci:981
    goto L_53a0;  // @src talk_girl_base.sci:981
  ...
  L_5610:
    ...
    Free2(r8, r7);
    // talk_girl_base.sci:996
    goto L_54c0;  // @src talk_girl_base.sci:996
    // talk_girl_base.sci:1007
  L_5658:
    r7 = false;  // @src talk_girl_base.sci:1007
    RetV(r6);
    Free2(r7, r6);
    goto L_5658;  // @src talk_girl_base.sci:1007
}
...
func_62()
{
    ...
    Call(r1, 0x5c0c);  // @src ../posteffects/posteffects.sci:110
    CopyExtRd(r0, 1, 11);
    Free1(r0);
  ...
  L_5c04:
    goto L_5ac4;  // @src ../posteffects/posteffects.sci:113
}
...
func_65()
{
    ...
    Call(r2, 0x60bc);  // @src ../posteffects/posteffects.sci:28
  ...
  L_5e2c:
    ...
    r4 = r7;
    // ../posteffects/posteffects.sci:39
    goto L_5fc4;  // @src ../posteffects/posteffects.sci:39
  ...
  L_5f04:
    ...
    r4 = r7;
    // ../posteffects/posteffects.sci:43
    goto L_5fc4;  // @src ../posteffects/posteffects.sci:43
...
func_76()
{
  ...
  L_68c0:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r15, 27036, 0x206);
    // ..\posteffects\darken.sci:74
  L_6994:
    goto L_68c0;  // @src ..\posteffects\darken.sci:74
}
...
func_77()
{
  ...
  L_6a34:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r16, 27352, 0x206);
    // ..\posteffects\darken.sci:97
  L_6ad0:
    goto L_6a34;  // @src ..\posteffects\darken.sci:97
}
...
func_78()
{
  ...
  L_6afc:
    ...
    goto L_6afc;  // @src ..\posteffects\darken.sci:112
  ...
  L_6c04:
    ...
    goto L_6c04;  // @src ..\posteffects\darken.sci:128
    // ..\posteffects\darken.sci:120
  L_6c20:
    goto L_6b50;  // @src ..\posteffects\darken.sci:120
}
...
func_82()
{
  ...
  L_6d30:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_6d30;  // @src talk_girl_base.sci:746
}
...
getAllowedTypes()
{
  ...
  L_71a8:
    ...
    CallNat2(r3, 29120, 0x1);
    // talk_girl_base.sci:828
    return r0;  // @src talk_girl_base.sci:828
}

// obscure_aya.sc:24 (locals=2)
func_88()
{
    // obscure_aya.sc:17
    r0 = r_neg4;  // @src obscure_aya.sc:17
    r1 = 1;
    r0 = r0 == r1;
    if (!r0) goto L_7214;
    // obscure_aya.sc:18
    Call(r1, 0x7220);  // @src obscure_aya.sc:18
    // obscure_aya.sc:19
    r1 = r0;  // @src obscure_aya.sc:19
    if (!r1) goto L_7210;
    // obscure_aya.sc:20
    r1 = r0;  // @src obscure_aya.sc:20
    CallNat(r5, 14756, 0x101);
    // obscure_aya.sc:17
  L_7210:
    Free1(r0);  // @src obscure_aya.sc:17
    // obscure_aya.sc:23
  L_7214:
    Call(r0, 0x30ac);  // @src obscure_aya.sc:23
    // obscure_aya.sc:24
    return r0;  // @src obscure_aya.sc:24
}

// girl_aya_talk.sci:39 (locals=9)
func_89()
{
    // girl_aya_talk.sci:18
    r0 = null_str2;  // @src girl_aya_talk.sci:18
    // girl_aya_talk.sci:19
    r2 = "aya_donor_01";  // @src girl_aya_talk.sci:19
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:20
    r1 = r0;  // @src girl_aya_talk.sci:20
    if (!r1) goto L_728c;
    r2 = r0;  // @src girl_aya_talk.sci:20
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_aya_talk.sci:22
  L_728c:
    r2 = "aya_donor_02";  // @src girl_aya_talk.sci:22
    Call(r3, 0x1850);
    r0 = r1;
    Free1(r1);
    // girl_aya_talk.sci:23
    r1 = r0;  // @src girl_aya_talk.sci:23
    if (!r1) goto L_72ec;
    r2 = r0;  // @src girl_aya_talk.sci:23
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_aya_talk.sci:25
  L_72ec:
    r1 = true;  // @src girl_aya_talk.sci:25
    r5 = GetDotStr("World");
    SetDotRaw(r4, 1493);
    Free1(r5);
    SetDotRaw(r3, 1512);
  ...
  L_7384:
    ...
    r2 = GetDotStr("!vector");  // @src girl_aya_talk.sci:27
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_aya_talk.sci:28
    r4 = r1;  // @src girl_aya_talk.sci:28
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_aya_talk.sci:30
    r5 = GetDotStr("World");  // @src girl_aya_talk.sci:30
    SetDotRaw(r4, 1493);
    Free1(r5);
    SetDotRaw(r3, 1512);
    Free1(r4);
    ...
    r4 = GetDotStr("World");  // @src girl_aya_talk.sci:31
    SetDotRaw(r3, 1493);
    Free1(r4);
    r4 = "aya_nothingnew";
    SetDot(r2, 1);
    ...
    Free2(r4, r2);
    // girl_aya_talk.sci:30
    goto L_74ec;  // @src girl_aya_talk.sci:30
    // girl_aya_talk.sci:33
  L_74b8:
    r2 = 1;  // @src girl_aya_talk.sci:33
    r4 = GetDotStr("World");
    SetDotRaw(r3, 1493);
    Free1(r4);
    r4 = "aya_nothingnew";
  ...
  L_74ec:
    r2 = r1;  // @src girl_aya_talk.sci:35
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_aya_talk.sci:38
  L_7508:
    r1 = null_str;  // @src girl_aya_talk.sci:38
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
}
...
func_90()
{
  ...
  L_7970:
    goto L_7998;  // @src talk_girl_base.sci:806
    // talk_girl_base.sci:799
  L_7978:
    goto L_7990;  // @src talk_girl_base.sci:799
  ...
  L_7990:
    goto L_77f4;  // @src talk_girl_base.sci:786
...
func_97()
{
  ...
  L_8464:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_8464;  // @src talk_girl_base.sci:731
}
...
OnDanceEnd()
{
  ...
  L_8558:
    ...
    Free4(r3, r4, r5, r2);
    // talk_girl_base.sci:236
    goto L_85f0;  // @src talk_girl_base.sci:236
...
onLevelup()
{
  ...
  L_8d24:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_8d24;  // @src talk_base.sci:684
}
...
func_106()
{
    ...
    CallNat(r5, 12080, 0x101);
    // obscure_aya.sc:12
  L_8dcc:
    Call(r1, 0x3a3c);  // @src obscure_aya.sc:12
    // obscure_aya.sc:13
    Free2(r0, r_neg4);  // @src obscure_aya.sc:13
    return r0;
}

// girl_aya_talk.sci:115 (locals=8)
processTalkGesture()
{
    ...
    r0 = 0;  // @src girl_aya_talk.sci:47
    r1 = GetDotStr("World");
    r1 = (str)r1;
    Call(r2, 0x9158);
    // girl_aya_talk.sci:49
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:49
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:50
    r3 = r0;  // @src girl_aya_talk.sci:50
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:51
    r3 = r0;  // @src girl_aya_talk.sci:51
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "aya_pomogi_mne";
    r5 = true;
    ...
    r3 = r0;  // @src girl_aya_talk.sci:52
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = 0;
    Spawn(r3, 0, 0x9334);
    r0 = 313;
    r0 = 588;
    r256 = "杯湉潦椀渀椀琀伀戀猀";  // len=10, pool_off=0x1, GARBLED  // @patch+4 girl_aya_talk.sci:53
    r_neg5 = r1;
    Free3(r1, r0, r_neg4);
    return r0;
    // girl_aya_talk.sci:56
  L_8f40:
    r0 = r_neg4;  // @src girl_aya_talk.sci:56
    r1 = "aya_notforyou";
    r0 = r0 == r1;
    if (!r0) goto L_9040;
    // girl_aya_talk.sci:58
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:58
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:59
    r3 = r0;  // @src girl_aya_talk.sci:59
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:60
    r3 = r0;  // @src girl_aya_talk.sci:60
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "aya_notforyou";
    r5 = true;
    ...
    r1 = r0;  // @src girl_aya_talk.sci:61
    r_neg5 = r1;
    Free3(r1, r0, r_neg4);
    return r0;
    // girl_aya_talk.sci:64
  L_9040:
    r0 = r_neg4;  // @src girl_aya_talk.sci:64
    r1 = "upgrade_aya_2";
    r0 = r0 == r1;
    if (!r0) goto L_9140;
    // girl_aya_talk.sci:66
    r1 = GetDotStr("!vector");  // @src girl_aya_talk.sci:66
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // girl_aya_talk.sci:67
    r3 = r0;  // @src girl_aya_talk.sci:67
    SetDotRaw(r2, 1042);
    Free1(r3);
    g4 = r0;
    g5 = r1;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:68
    r3 = r0;  // @src girl_aya_talk.sci:68
    SetDotRaw(r2, 1042);
    Free1(r3);
    r4 = "upgrade_aya_2";
    r5 = true;
    ...
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // girl_aya_talk.sci:69
    r1 = r0;  // @src girl_aya_talk.sci:69
    r_neg5 = r1;
    Free3(r1, r0, r_neg4);
    return r0;
    // girl_aya_talk.sci:114
  L_9140:
    r0 = null_str;  // @src girl_aya_talk.sci:114
    r_neg5 = r0;
    Free2(r0, r_neg4);
    return r0;
}
...
{
    // talk_base.sci:397
    CopyExtWr(r0, 2, 17);  // @src talk_base.sci:397
    SetDotRaw(r1, 1531);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // talk_base.sci:398
    CopyExtWr(r4, 0, 17);  // @src talk_base.sci:398
    if (!r0) goto L_93d0;
    CopyExtWr(r4, 2, 17);  // @src talk_base.sci:398
    SetDotRaw(r1, 1531);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // talk_base.sci:399
  L_93d0:
    CopyExtWr(r2, 2, 17);  // @src talk_base.sci:399
    SetDotRaw(r1, 1531);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
...
onBreakthroughEnd()
{
    ...
    Free1(r0);
    // talk_base.sci:334
    CopyExtWr(r2, 2, 17);  // @src talk_base.sci:334
    SetDotRaw(r1, 1773);
    Free1(r2);
    r2 = "paint_demo.xml";
    GetDot(r0, 1);
    ...
    Free1(r0);
    // talk_base.sci:337
    CopyExtWr(r0, 2, 17);  // @src talk_base.sci:337
    SetDotRaw(r1, 1773);
    Free1(r2);
    r2 = "body.xml";
    GetDot(r0, 1);
    ...
    Free1(r0);
    // talk_base.sci:339
    CopyExtWr(r0, 1, 17);  // @src talk_base.sci:339
    ...
    Free1(r5);
    // talk_base.sci:348
    CopyExtWr(r4, 7, 17);  // @src talk_base.sci:348
    SetDotRaw(r6, 1773);
    Free1(r7);
    r7 = "subtitle.xml";
    GetDot(r5, 1);
    ...
    Free1(r5);
    // talk_base.sci:349
    CopyExtWr(r5, 7, 17);  // @src talk_base.sci:349
    SetDotRaw(r6, 173);
    Free1(r7);
    r7 = "initSubtitleWnd";
    GetDot(r5, 1);
    ...
    r3 = r5;
    // talk_base.sci:354
    CopyExtWr(r5, 7, 17);  // @src talk_base.sci:354
    SetDotRaw(r6, 173);
    Free1(r7);
    r7 = "runSubtitle";
    r8 = r2;
    ...
    // talk_base.sci:357
  L_9768:
    CopyExtWr(r1, 7, 17);  // @src talk_base.sci:357
    SetDotRaw(r6, 173);
    Free1(r7);
    r7 = "initBodyNewZone";
    r8 = GetDotStr("World");
    ...
    if (!r5) goto L_982c;
    // talk_base.sci:362
    CopyExtWr(r0, 6, 17);  // @src talk_base.sci:362
    r7 = r2;
    r8 = "Voice";
    Call(r9, 0x5674);
    r4 = r5;
  ...
  L_98c4:
    ...
    r6 = (int)r6;
    // talk_base.sci:369
    CopyExtWr(r0, 9, 17);  // @src talk_base.sci:369
    SetDotRaw(r8, 1906);
    Free1(r9);
    r9 = r6;
    GetDot(r7, 1);
    Free2(r8, r7);
    // talk_base.sci:370
    CopyExtWr(r2, 9, 17);  // @src talk_base.sci:370
    SetDotRaw(r8, 1906);
    Free1(r9);
    r9 = r6;
    GetDot(r7, 1);
    Free2(r8, r7);
    // talk_base.sci:371
    CopyExtWr(r4, 7, 17);  // @src talk_base.sci:371
    if (!r7) goto L_9984;
    CopyExtWr(r4, 9, 17);  // @src talk_base.sci:371
    SetDotRaw(r8, 1906);
    Free1(r9);
    r9 = r6;
    GetDot(r7, 1);
  ...
  L_9984:
    ...
    if (r7) goto L_9a44;
    // talk_base.sci:376
    CopyExtWr(r5, 9, 17);  // @src talk_base.sci:376
    SetDotRaw(r8, 173);
    Free1(r9);
    r9 = "nextSubtitle";
    GetDot(r7, 1);
  ...
  L_9a34:
    ...
    // talk_base.sci:373
  L_9a44:
    goto L_9a5c;  // @src talk_base.sci:373
    // talk_base.sci:383
  L_9a4c:
    ...
    // talk_base.sci:367
  L_9a5c:
    goto L_9854;  // @src talk_base.sci:367
    // talk_base.sci:388
  L_9a64:
    CopyExtWr(r4, 6, 17);  // @src talk_base.sci:388
    if (!r6) goto L_9a8c;
...
{
    // talk_base.sci:468
    CopyExtWr(r0, 0, 18);  // @src talk_base.sci:468
    if (!r0) goto L_9ba0;
    // talk_base.sci:469
    CopyExtWr(r0, 2, 18);  // @src talk_base.sci:469
    SetDotRaw(r1, 1531);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_119()
{
    ...
    Free1(r3);
    // talk_base.sci:429
    CopyExtWr(r0, 5, 18);  // @src talk_base.sci:429
    SetDotRaw(r4, 1773);
    Free1(r5);
    r5 = "video.xml";
    GetDot(r3, 1);
    ...
    Free1(r3);
    // talk_base.sci:430
    CopyExtWr(r1, 5, 18);  // @src talk_base.sci:430
    SetDotRaw(r4, 173);
    Free1(r5);
    r5 = "initVideoWnd";
    r6 = r0;
    ...
    Free4(r4, r5, r6, r3);
    // talk_base.sci:432
    CopyExtWr(r0, 4, 18);  // @src talk_base.sci:432
    r5 = r1;
    r6 = "Voice";
    Call(r7, 0x5674);
    // talk_base.sci:433
  ...
  L_9e5c:
    ...
    r4 = (int)r4;
    // talk_base.sci:438
    CopyExtWr(r0, 5, 18);  // @src talk_base.sci:438
    if (!r5) goto L_9ebc;
    // talk_base.sci:439
    CopyExtWr(r0, 7, 18);  // @src talk_base.sci:439
    SetDotRaw(r6, 1906);
    Free1(r7);
    r7 = r4;
    GetDot(r5, 1);
  ...
  L_9ebc:
    ...
    r2 = r5;
    // talk_base.sci:445
    goto L_9f30;  // @src talk_base.sci:445
    // talk_base.sci:441
  L_9f10:
    goto L_9f28;  // @src talk_base.sci:441
    // talk_base.sci:449
  L_9f18:
    ...
    // talk_base.sci:435
  L_9f28:
    goto L_9e20;  // @src talk_base.sci:435
    // talk_base.sci:427
  L_9f30:
  ...
  L_9f34:
    ...
    RetV(r3);
    Free2(r4, r3);
    goto L_9f34;  // @src talk_base.sci:454
}
...
func_120()
{
    ...
    CallNat2(r2, 40840, 0x0);  // @src talk_girl_base.sci:202
...
func_121()
{
  ...
  L_9f90:
    ...
    Free1(r0);
    // talk_girl_base.sci:210
    goto L_9f90;  // @src talk_girl_base.sci:210
    // talk_girl_base.sci:214
  L_9fe4:
    CallNat(r3, 12460, 0x0);  // @src talk_girl_base.sci:214
}
...
addSubquest()
{
  ...
  L_bad0:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:177
    goto L_bd2c;  // @src ../ui/gesture_help.sci:177
  ...
  L_bbac:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:181
    goto L_bd2c;  // @src ../ui/gesture_help.sci:181
  ...
  L_bc04:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:185
    goto L_bd2c;  // @src ../ui/gesture_help.sci:185
  ...
  L_bc5c:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:189
    goto L_bd2c;  // @src ../ui/gesture_help.sci:189
  ...
  L_bca4:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:193
    goto L_bd2c;  // @src ../ui/gesture_help.sci:193
  ...
  L_be64:
    ...
    // ../ui/gesture_help.sci:138
  L_be6c:
    goto L_bea4;  // @src ../ui/gesture_help.sci:138
