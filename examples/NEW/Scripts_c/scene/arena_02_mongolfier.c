...
// arena_02_mongolfier.sc:52 (locals=3)
func_1()
{
    // arena_02_mongolfier.sc:50
    r1 = GetDotStr("logInfo");  // @src arena_02_mongolfier.sc:50
    r2 = "Arena > State = Main";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // arena_02_mongolfier.sc:51
    Call(r0, 0x004c);  // @src arena_02_mongolfier.sc:51
    // arena_02_mongolfier.sc:52
    return r0;  // @src arena_02_mongolfier.sc:52
}
...
{
    // arena.sci:160
    Call(r0, 0x008c);  // @src arena.sci:160
    // arena.sci:162
    Call(r0, 0x0334);  // @src arena.sci:162
    // arena.sci:163
    ...
    Call(r1, 0x0554);
    // arena.sci:168
    CallNat(r5, 5504, 0x0);  // @src arena.sci:168
}
...
func_3()
{
    ...
    Free4(r1, r2, r3, r0);
    // playable.sci:71
    Call(r0, 0x0288);  // @src playable.sci:71
    // playable.sci:72
...
{
    // arena.sci:263
    Call(r0, 0x159c);  // @src arena.sci:263
    // arena.sci:265
    CallNat(r7, 6392, 0x0);  // @src arena.sci:265
}
...
func_27()
{
  ...
  L_1658:
    ...
    CallMethod(r1, 3143, 0x247);  // @patch+8 playable.sci:371
    Free5(r12, r313, r0, r0, r0);
    Free1(r2);
    r1 = (str)r1;
    CopyExtRd(r1, 0, 6);
    Free1(r1);
  ...
  L_172c:
    ...
    Free3(r3, r4, r2);
    // playable.sci:376
    goto L_172c;  // @src playable.sci:376
    // playable.sci:380
  L_1774:
  ...
  L_17b4:
    ...
    CallMethod(r2, 3143, 0x447);  // @patch+8 playable.sci:387
    RawDword(0x00000074);  // UNKNOWN opcode 0x74
    SetDotRaw(r3, 97);
    Free1(r4);
    r4 = "onRestoreView";
    GetDot(r2, 1);
...
{
    // arena.sci:197
    CallNat2(r8, 7296, 0x0);  // @src arena.sci:197
    // arena.sci:198
...
func_30()
{
    ...
    if (!r0) goto L_18e8;
    // arena.sci:245
    CallNat2(r7, 6392, 0x0);  // @src arena.sci:245
    // arena.sci:244
    goto L_18f4;  // @src arena.sci:244
    // arena.sci:247
  L_18e8:
    CallNat(r7, 6392, 0x0);  // @src arena.sci:247
    // arena.sci:248
  L_18f4:
...
func_37()
{
    ...
    Free3(r1, r2, r0);
    // arena.sci:228
    Call(r0, 0x1d7c);  // @src arena.sci:228
    // arena.sci:230
  L_1cc8:
...
{
    // arena.sci:216
    CallNat2(r10, 8092, 0x0);  // @src arena.sci:216
    // arena.sci:217
...
{
    // arena.sci:273
    Call(r0, 0x1fb8);  // @src arena.sci:273
    // arena.sci:275
    CallNat(r7, 6392, 0x0);  // @src arena.sci:275
}
...
func_47()
{
    ...
    CallMethod(r0, 3143, 0x247);  // @patch+8 playable.sci:310
    RawDword(0x00000074);  // UNKNOWN opcode 0x74
    SetDotRaw(r1, 97);
    Free1(r2);
    r2 = "onDestroyView";
  ...
  L_20dc:
    ...
    Free3(r2, r3, r1);
    // playable.sci:317
    goto L_20dc;  // @src playable.sci:317
    // playable.sci:320
  L_2124:
    ...
    CallMethod(r1, 3143, 0x347);  // @patch+8 playable.sci:323
    RawDword(0x00000074);  // UNKNOWN opcode 0x74
    SetDotRaw(r2, 97);
    Free1(r3);
    r3 = "onRestoreView";
...
func_48()
{
    ...
    if (!r0) goto L_21f0;
    // arena.sci:205
    CallNat2(r5, 5504, 0x0);  // @src arena.sci:205
    // arena.sci:204
    goto L_223c;  // @src arena.sci:204
    // arena.sci:207
  L_21f0:
...
updateWheel()
{
    ...
    Call(r1, 0x243c);  // @src monster_wheel.sci:32
...
onLocationExit()
{
  ...
  L_265c:
    ...
    r1 = g3;
    // monster_wheel.sci:83
    goto L_265c;  // @src monster_wheel.sci:83
  ...
  L_26c4:
    ...
    Call(r3, 0x29c4);  // @src monster_wheel.sci:91
    g3 = r1;
    r4 = r1;
    GetDotRaw(r3, 513);
    // monster_wheel.sci:87
    goto L_26c4;  // @src monster_wheel.sci:87
  ...
  L_27ac:
    ...
    r1 = g5;
    // monster_wheel.sci:98
    goto L_27ac;  // @src monster_wheel.sci:98
  ...
  L_27ec:
    ...
    Free2(r2, r1);
    // monster_wheel.sci:101
    goto L_27ec;  // @src monster_wheel.sci:101
  ...
  L_2870:
    ...
    Call(r3, 0x29c4);  // @src monster_wheel.sci:110
    g3 = r2;
    r4 = r1;
    GetDotRaw(r3, 513);
    // monster_wheel.sci:106
    goto L_2870;  // @src monster_wheel.sci:106
  ...
  L_2958:
    ...
    r1 = g7;
    // monster_wheel.sci:117
    goto L_2958;  // @src monster_wheel.sci:117
...
{
    // playable.sci:48
    CallNat2(r12, 10832, 0x0);  // @src playable.sci:48
    // playable.sci:49
...
func_64()
{
  ...
  L_2f0c:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r16, 12264, 0x206);
    // ..\posteffects\darken.sci:74
  L_2fe0:
    goto L_2f0c;  // @src ..\posteffects\darken.sci:74
}
...
func_65()
{
  ...
  L_3080:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r17, 12580, 0x206);
    // ..\posteffects\darken.sci:97
  L_311c:
    goto L_3080;  // @src ..\posteffects\darken.sci:97
}
...
func_66()
{
  ...
  L_3148:
    ...
    goto L_3148;  // @src ..\posteffects\darken.sci:112
  ...
  L_3250:
    ...
    goto L_3250;  // @src ..\posteffects\darken.sci:128
    // ..\posteffects\darken.sci:120
  L_326c:
    goto L_319c;  // @src ..\posteffects\darken.sci:120
}
...
{
    // playable.sci:53
    CallNat2(r12, 13188, 0x0);  // @src playable.sci:53
    // playable.sci:54
...
func_95()
{
    ...
    CallMethod(r0, 3143, 0xfffffc0a);  // @patch+8 arena.sci:458
    r0 = 0x13f;
    r61 = (as_string)r61;
    // arena.sci:459
...
func_96()
{
  ...
  L_42a0:
    ...
    // arena.sci:517
  L_42d4:
    goto L_42e4;  // @src arena.sci:517
    // arena.sci:500
  L_42dc:
    goto L_4118;  // @src arena.sci:500
    // arena.sci:521
  L_42e4:
...
render()
{
  ...
  L_4868:
    ...
    if (!r4) goto L_489c;
    // arena.sci:565
    goto L_48a4;  // @src arena.sci:565
    // arena.sci:557
  L_489c:
    goto L_4804;  // @src arena.sci:557
    // arena.sci:549
  L_48a4:
  ...
  L_48a8:
    ...
    CallMethod(r2, 3143, 0x447);  // @patch+8 arena.sci:573
    RawDword(0x00000074);  // UNKNOWN opcode 0x74
    SetDotRaw(r3, 97);
    Free1(r4);
    r4 = "onRestoreView";
    ...
    Free3(r3, r4, r2);
    // arena.sci:575
    CallNat(r2, 18700, 0x200);  // @src arena.sci:575
}
...
{
    // arena.sci:156
    CallNat(r7, 6392, 0x0);  // @src arena.sci:156
}
...
// arena_02_mongolfier.sc:24 (locals=4)
func_105()
{
    // arena_02_mongolfier.sc:13
    Call(r1, 0x49f0);  // @src arena_02_mongolfier.sc:13
    if (r0) goto L_49bc;
    // arena_02_mongolfier.sc:15
    g2 = r16;  // @src arena_02_mongolfier.sc:15
    SetDotRaw(r1, 4040);
    Free1(r2);
    r2 = "name";
    SetDot(r0, 1);
    ...
    r0 = "mongolfier_dies";  // @src arena_02_mongolfier.sc:17
    r1 = 3;
    r1 = (float)r1;
    Call(r2, 0x3ad0);
    // arena_02_mongolfier.sc:23
  L_49bc:
    r1 = GetDotStr("sendGenericEventToWorld");  // @src arena_02_mongolfier.sc:23
    r2 = GetDotStr("World");
    r3 = "onHunterDead";
    GetDot(r0, 2);
    Free4(r1, r2, r3, r0);
    // arena_02_mongolfier.sc:24
    return r0;  // @src arena_02_mongolfier.sc:24
}
...
// arena_02_mongolfier.sc:47 (locals=3)
getActivePlane()
{
    // arena_02_mongolfier.sc:45
    r0 = r_neg4;  // @src arena_02_mongolfier.sc:45
    r0 = g16;
    Free1(r0);
    // arena_02_mongolfier.sc:46
    g2 = r16;  // @src arena_02_mongolfier.sc:46
    SetDotRaw(r1, 4040);
    Free1(r2);
    r2 = "damage_color";
    SetDot(r0, 1);
    ...
    r0 = (int)r0;
    Call(r1, 0x4dd4);
    // arena_02_mongolfier.sc:47
    Free1(r_neg4);  // @src arena_02_mongolfier.sc:47
    return r0;
}
...
// arena_02_mongolfier.sc:37 (locals=4)
func_110()
{
    // arena_02_mongolfier.sc:32
    r0 = null_str2;  // @src arena_02_mongolfier.sc:32
    // arena_02_mongolfier.sc:34
    r2 = GetDotStr("hasVariable");  // @src arena_02_mongolfier.sc:34
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_5064;
    r2 = GetDotStr("getVariable");  // @src arena_02_mongolfier.sc:34
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    r0 = r1;
    Free1(r1);
    // arena_02_mongolfier.sc:35
  L_5064:
    g1 = r16;  // @src arena_02_mongolfier.sc:35
    if (!r1) goto L_50b0;
    g3 = r16;  // @src arena_02_mongolfier.sc:35
    SetDotRaw(r2, 4040);
    Free1(r3);
    r3 = "name";
    SetDot(r1, 1);
    ...
    r0 = r1;
    Free1(r1);
    // arena_02_mongolfier.sc:36
  L_50b0:
    r1 = r0;  // @src arena_02_mongolfier.sc:36
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
}

// arena_02_mongolfier.sc:42 (locals=1)
initMusic()
{
    // arena_02_mongolfier.sc:41
    r0 = "arena_2_mongolfier";  // @src arena_02_mongolfier.sc:41
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
{
    // playable.sci:214
    Call(r0, 0x5a38);  // @src playable.sci:214
    // playable.sci:215
...
disableWheel()
{
    ...
    Free2(r1, r0);
    // playable.sci:220
    Call(r0, 0x5a70);  // @src playable.sci:220
    // playable.sci:221
...
{
    // playable.sci:225
    Call(r1, 0x5b2c);  // @src playable.sci:225
    // playable.sci:226
...
getSpeedFactor()
{
    ...
    // playable.sci:234
    goto L_5c54;  // @src playable.sci:234
    // playable.sci:237
  L_5c08:
    ...
    // playable.sci:233
  L_5c54:
    goto L_5ea8;  // @src playable.sci:233
    // playable.sci:241
  L_5c5c:
  ...
  L_5d10:
    ...
    // playable.sci:242
    goto L_5d74;  // @src playable.sci:242
    // playable.sci:245
  L_5d28:
  ...
  L_5d7c:
    ...
    if (!r0) goto L_5ea8;
    // playable.sci:251
    Call(r1, 0x5b2c);  // @src playable.sci:251
    // playable.sci:252
