...
// arena_general.sc:16 (locals=0)
func_1()
{
    // arena_general.sc:15
    Call(r0, 0x0028);  // @src arena_general.sc:15
    // arena_general.sc:16
    return r0;  // @src arena_general.sc:16
}
...
// arena_general.sc:12 (locals=4)
getWheelLevel0()
{
    // arena_general.sc:7
    r0 = null_str2;  // @src arena_general.sc:7
    // arena_general.sc:8
    r2 = GetDotStr("hasVariable");  // @src arena_general.sc:8
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_4968;
    // arena_general.sc:9
    r2 = GetDotStr("getVariable");  // @src arena_general.sc:9
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
