...
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
//   export "setQuestStatus" args=2 cb=-1 {func_127} types=[str,bool]
//   export "addSubquest" args=2 cb=-1 {func_128} types=[str,str]
//   export "setSubquestStatus" args=3 cb=-1 {func_129} types=[str,str,bool]
//   export "addGirlData" args=2 cb=-1 {func_22} types=[int,str]
//   export "addHunterData" args=2 cb=-1 {func_130} types=[int,str]
//   export "addColorData" args=2 cb=-1 {func_131} types=[int,str]
//   export "addColorData" args=1 cb=-1 {func_132} types=[str]
//   export "addGirlDataByName" args=2 cb=-1 {func_21} types=[str,str]
//   export "addHunterDataByName" args=2 cb=-1 {func_133} types=[str,str]
//   export "getGirlByName" args=1 cb=-1 {func_26} types=[str]
//   export "skipBreachGesture" args=0 cb=-1 {func_108}
//   export "processTalkGesture" args=3 cb=-1 {func_12} types=[str,int,int]
//   export "onLocationExit" args=1 cb=-1 {func_135} types=[float]
//   export "getLimfa" args=0 cb=-1 {func_6}
//   export "getCurrentCamera" args=0 cb=-1 {func_136}
//   export "runPPEffect" args=1 cb=-1 {func_137} types=[str]
//   export "getHelpStatus" args=0 cb=-1 {func_138}
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 1: parent=0 stack=0 locals=0 vtable=[] imports=[(1,0)]
//   export "initObscure" args=3 cb=-1 {func_2} types=[str,str,str]
//   export "initObscure" args=2 cb=-1 {func_120} types=[str,str]
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 3: parent=0 stack=2 locals=2 types=[int,int] vtable=[{func_104},{func_63},{func_65}] imports=[(4,0),(3,2)]
//   export "OnGesture" args=3 cb=-1 {func_10} types=[int,int,float]
//   export "OnLevelupEnd" args=1 cb=-1 {func_111} types=[int]
//   export "onConsoleCommand" args=2 cb=1000 {func_113} types=[str,str]
//   export "onVampire" args=0 cb=-1 {func_105}
//   export "onLevelup" args=1 cb=-1 {func_114} types=[int]
//   export "onBreakthrough" args=0 cb=-1 {func_115}
//   export "onBreakthroughEnd" args=0 cb=-1 {func_116}
//   export "IsPaletteActive" args=0 cb=-1 {func_118}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 4: parent=0 stack=2 locals=2 types=[int,int] vtable=[{func_104},{func_63},{func_65}] imports=[(4,0)]
//   export "OnLevelupEnd" args=1 cb=-1 {func_111} types=[int]
//   export "onConsoleCommand" args=2 cb=1000 {func_113} types=[str,str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 5: parent=0 stack=2 locals=2 types=[str,str] vtable=[{func_32}] imports=[(6,0),(5,2)]
//   export "IsPaletteActive" args=0 cb=-1 {func_31}
//   export "render" args=0 cb=-1 {func_33}
//   export "needViewRender" args=0 cb=-1 {func_34}
//   export "getActivePlane" args=0 cb=-1 {func_35}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "setHelpStatus" args=1 cb=-1 {func_139} types=[str]
//   export "enableHelp" args=2 cb=-1 {func_140} types=[bool,int]
// @ft_group 6: parent=0 stack=2 locals=2 types=[str,str] vtable=[{func_32}] imports=[(6,0)]
//   export "render" args=0 cb=-1 {func_33}
//   export "needViewRender" args=0 cb=-1 {func_34}
//   export "getActivePlane" args=0 cb=-1 {func_35}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
...
//   export "onDance" args=1 cb=-1 {func_99} types=[int]
//   export "OnDanceEnd" args=0 cb=-1 {func_100}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "updateView" args=1 cb=-1 {func_71} types=[str]
//   export "isEffectRunning" args=1 cb=-1 {func_72} types=[int]
//   export "enablePPEffect" args=1 cb=-1 {func_73} types=[str]
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "initProc" args=1 cb=-1 {func_86} types=[str]
//   export "getEffectType" args=0 cb=-1 {func_93}
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
//   export "getDarkenStrength" args=0 cb=-1 {func_87}
//   export "updateComposerData" args=2 cb=-1 {func_88} types=[str,str]
//   export "getAllowedTypes" args=1 cb=-1 {func_123} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_124}
//   export "initSound" args=1 cb=1 {func_125} types=[str]
//   export "addQuest" args=1 cb=-1 {func_126} types=[str]
...
// #export {func_31} name="IsPaletteActive"
// #export {func_33} name="render"
// #export {func_34} name="needViewRender"
// #export {func_35} name="getActivePlane"
...
// #export {func_71} name="updateView"
// #export {func_72} name="isEffectRunning"
// #export {func_73} name="enablePPEffect"
// #export {func_86} name="initProc"
// #export {func_87} name="getDarkenStrength"
// #export {func_88} name="updateComposerData"
// #export {func_93} name="getEffectType"
// #export {func_99} name="onDance"
// #export {func_100} name="OnDanceEnd"
// #export {func_105} name="onVampire"
// #export {func_108} name="skipBreachGesture"
// #export {func_111} name="OnLevelupEnd"
// #export {func_113} name="onConsoleCommand"
// #export {func_114} name="onLevelup"
// #export {func_115} name="onBreakthrough"
// #export {func_116} name="onBreakthroughEnd"
// #export {func_118} name="IsPaletteActive"
// #export {func_120} name="initObscure"
// #export {func_123} name="getAllowedTypes"
// #export {func_124} name="getHunterGlotokList"
// #export {func_125} name="initSound"
// #export {func_126} name="addQuest"
// #export {func_127} name="setQuestStatus"
// #export {func_128} name="addSubquest"
// #export {func_129} name="setSubquestStatus"
// #export {func_130} name="addHunterData"
// #export {func_131} name="addColorData"
// #export {func_132} name="addColorData"
// #export {func_133} name="addHunterDataByName"
// #export {func_135} name="onLocationExit"
// #export {func_136} name="getCurrentCamera"
// #export {func_137} name="runPPEffect"
// #export {func_138} name="getHelpStatus"
// #export {func_139} name="setHelpStatus"
// #export {func_140} name="enableHelp"
...
func_1()
{
    ...
    CallNat(r1, 40460, 0x0);  // @src talk_girl_base.sci:97
}
...
func_9()
{
  ...
  L_1030:
    ...
    CallNat(r3, 40284, 0x1);
}

// obscure_ole.sc:62 (locals=7)
getCurrentCamera()
{
    // obscure_ole.sc:37
    r0 = true;  // @src obscure_ole.sc:37
    r1 = r_neg6;
    r2 = -1;
    r1 = r1 == r2;
    if (r1) goto L_10bc;
  ...
  L_10bc:
    ...
    Free3(r1, r2, r0);
    // obscure_ole.sc:39
    return r0;  // @src obscure_ole.sc:39
    // obscure_ole.sc:42
  L_10f8:
    r1 = r_neg5;  // @src obscure_ole.sc:42
    Call(r2, 0x135c);
    if (r0) goto L_1338;
    // obscure_ole.sc:43
    r1 = GetDotStr("getGestureName");  // @src obscure_ole.sc:43
    r2 = "player";
    r3 = r_neg6;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    r_neg4 = r1;
    // obscure_ole.sc:47
    r1 = r_neg4;  // @src obscure_ole.sc:47
    r2 = -1;
    r1 = r1 == r2;
    if (!r1) goto L_1194;
    Free1(r0);  // @src obscure_ole.sc:47
    return r0;
    // obscure_ole.sc:49
  L_1194:
    r2 = r0;  // @src obscure_ole.sc:49
    r3 = r_neg5;
    r4 = r_neg4;
    Call(r5, 0x15cc);
    // obscure_ole.sc:50
    r2 = r1;  // @src obscure_ole.sc:50
    if (!r2) goto L_1330;
    // obscure_ole.sc:52
    r4 = GetDotStr("World");  // @src obscure_ole.sc:52
    SetDotRaw(r3, 173);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
    ...
    Free2(r5, r3);
    // obscure_ole.sc:56
    r3 = r1;  // @src obscure_ole.sc:56
    CallNat2(r5, 11928, 0x301);
    // obscure_ole.sc:57
    Free3(r2, r1, r0);  // @src obscure_ole.sc:57
    return r0;
    // obscure_ole.sc:42
  L_1330:
    Free2(r1, r0);  // @src obscure_ole.sc:42
    // obscure_ole.sc:61
  L_1338:
    r0 = r_neg6;  // @src obscure_ole.sc:61
    r1 = r_neg5;
    r2 = r_neg4;
    Call(r3, 0x4cf8);
    // obscure_ole.sc:62
    return r0;  // @src obscure_ole.sc:62
}
...
// girl_ole_talk.sci:146 (locals=4)
func_13()
{
    // girl_ole_talk.sci:121
    r0 = null_str2;  // @src girl_ole_talk.sci:121
    // girl_ole_talk.sci:123
    r1 = r_neg6;  // @src girl_ole_talk.sci:123
    r2 = "gesture_about_common";
    r1 = r1 == r2;
    if (!r1) goto L_1720;
    // girl_ole_talk.sci:125
    r2 = "common_ole_main1";  // @src girl_ole_talk.sci:125
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:126
    r1 = r0;  // @src girl_ole_talk.sci:126
    if (!r1) goto L_1658;
    r2 = r0;  // @src girl_ole_talk.sci:126
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_ole_talk.sci:128
  L_1658:
    r2 = "common_ole_main2";  // @src girl_ole_talk.sci:128
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:129
    r1 = r0;  // @src girl_ole_talk.sci:129
    if (!r1) goto L_16b8;
    r2 = r0;  // @src girl_ole_talk.sci:129
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_ole_talk.sci:131
  L_16b8:
    r2 = "common_ole_main3";  // @src girl_ole_talk.sci:131
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:132
    r1 = r0;  // @src girl_ole_talk.sci:132
    if (!r1) goto L_1718;
    r2 = r0;  // @src girl_ole_talk.sci:132
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    ...
    // girl_ole_talk.sci:123
  L_1718:
    goto L_17a0;  // @src girl_ole_talk.sci:123
    // girl_ole_talk.sci:135
  L_1720:
    r1 = r_neg6;  // @src girl_ole_talk.sci:135
    r2 = "gesture_about_hunter";
    r1 = r1 == r2;
    if (!r1) goto L_17a0;
    // girl_ole_talk.sci:137
    r2 = "zagovor_ole_main1";  // @src girl_ole_talk.sci:137
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:138
    r1 = r0;  // @src girl_ole_talk.sci:138
    if (!r1) goto L_17a0;
    r2 = r0;  // @src girl_ole_talk.sci:138
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
    // girl_ole_talk.sci:142
  L_17a0:
    r1 = null_str;  // @src girl_ole_talk.sci:142
    r_neg7 = r1;
    Free3(r1, r0, r_neg6);
    return r0;
}
...
func_16()
{
    ...
    Call(r0, 0x197c);  // @src talk_girl_base.sci:710
...
func_19()
{
  ...
  L_1d08:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:677
    goto L_1d08;  // @src talk_girl_base.sci:677
  ...
  L_1ec4:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:694
    goto L_1ec4;  // @src talk_girl_base.sci:694
  ...
  L_1f30:
    ...
    Free2(r4, r3);
    // talk_girl_base.sci:699
    goto L_1f30;  // @src talk_girl_base.sci:699
    // talk_girl_base.sci:704
  L_1f8c:
    r4 = false;  // @src talk_girl_base.sci:704
    RetV(r3);
    Free2(r4, r3);
    goto L_1f8c;  // @src talk_girl_base.sci:704
}
...
func_22()
{
    ...
    r0 = (str)r0;
    // ../souls.sci:243
    Call(r2, 0x2210);  // @src ../souls.sci:243
    if (!r1) goto L_2204;
    // ../souls.sci:244
...
func_27()
{
  ...
  L_29ec:
    ...
    // talk_base.sci:114
  L_29fc:
    goto L_2a14;  // @src talk_base.sci:114
    // talk_base.sci:136
  L_2a04:
  ...
  L_2a98:
    ...
    RetV(r2);
    Free2(r3, r2);
    goto L_2a98;  // @src talk_base.sci:143
    // talk_base.sci:144
  L_2ab4:
...
func_29()
{
  ...
  L_2c20:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_2c20;  // @src talk_base.sci:700
}
...
skipBreachGesture()
{
    ...
    CallNat(r3, 12308, 0x0);  // @src talk_girl_base.sci:846
}
...
func_37()
{
  ...
  L_2fd8:
    ...
    Free1(r2);
    // talk_base.sci:28
    goto L_2f74;  // @src talk_base.sci:28
    // talk_base.sci:23
  L_300c:
    goto L_2f58;  // @src talk_base.sci:23
}

// obscure_ole.sc:28 (locals=2)
func_38()
{
    // obscure_ole.sc:23
    Call(r1, 0x3058);  // @src obscure_ole.sc:23
    // obscure_ole.sc:24
    r1 = r0;  // @src obscure_ole.sc:24
    if (!r1) goto L_3048;
    // obscure_ole.sc:25
    r1 = r0;  // @src obscure_ole.sc:25
    CallNat(r5, 19468, 0x101);
    // obscure_ole.sc:27
  L_3048:
    Call(r1, 0x4ca4);  // @src obscure_ole.sc:27
    // obscure_ole.sc:28
    Free1(r0);  // @src obscure_ole.sc:28
    return r0;
}

// girl_ole_talk.sci:113 (locals=9)
func_39()
{
    // girl_ole_talk.sci:38
    r0 = null_str2;  // @src girl_ole_talk.sci:38
    // girl_ole_talk.sci:39
    r2 = "ole_meeting";  // @src girl_ole_talk.sci:39
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:40
    r1 = r0;  // @src girl_ole_talk.sci:40
    if (!r1) goto L_30c4;
    r2 = r0;  // @src girl_ole_talk.sci:40
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg4 = r1;
  ...
  L_30c4:
    r1 = false;  // @src girl_ole_talk.sci:43
    r3 = 3;
    r4 = GetDotStr("World");
    r4 = (str)r4;
    Call(r5, 0x38c8);
  ...
  L_3114:
    ...
    r1 = 3;  // @src girl_ole_talk.sci:46
    r2 = GetDotStr("World");
    r2 = (str)r2;
    Call(r3, 0x39c0);
    // girl_ole_talk.sci:48
    r2 = GetDotStr("!vector");  // @src girl_ole_talk.sci:48
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_ole_talk.sci:49
    r4 = r1;  // @src girl_ole_talk.sci:49
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:50
    r4 = r1;  // @src girl_ole_talk.sci:50
    SetDotRaw(r3, 1042);
    Free1(r4);
    r5 = 3;
    Spawn(r4, 0, 0x3b9c);
    ...
    r0 = 844;
    r512 = null_str;
    // girl_ole_talk.sci:51
    r2 = r1;  // @src girl_ole_talk.sci:51
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_ole_talk.sci:57
  L_3208:
    r1 = false;  // @src girl_ole_talk.sci:57
    r5 = GetDotStr("World");
    SetDotRaw(r4, 1475);
    Free1(r5);
    SetDotRaw(r3, 1480);
  ...
  L_32a4:
    if (!r1) goto L_338c;
    // girl_ole_talk.sci:60
    r2 = GetDotStr("!vector");  // @src girl_ole_talk.sci:60
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_ole_talk.sci:61
    r4 = r1;  // @src girl_ole_talk.sci:61
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:62
    r4 = r1;  // @src girl_ole_talk.sci:62
    SetDotRaw(r3, 1042);
    Free1(r4);
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:63
    r2 = r1;  // @src girl_ole_talk.sci:63
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_ole_talk.sci:69
  L_338c:
    r1 = false;  // @src girl_ole_talk.sci:69
    r2 = false;
    r4 = GetDotStr("World");
    r4 = (str)r4;
    Call(r5, 0x4898);
  ...
  L_344c:
    if (!r1) goto L_3534;
    // girl_ole_talk.sci:72
    r2 = GetDotStr("!vector");  // @src girl_ole_talk.sci:72
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_ole_talk.sci:73
    r4 = r1;  // @src girl_ole_talk.sci:73
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:74
    r4 = r1;  // @src girl_ole_talk.sci:74
    SetDotRaw(r3, 1042);
    Free1(r4);
    r5 = "ole_turgor";
    r6 = true;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:75
    r2 = r1;  // @src girl_ole_talk.sci:75
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_ole_talk.sci:82
  L_3534:
    r1 = false;  // @src girl_ole_talk.sci:82
    r2 = false;
    r4 = GetDotStr("World");
    r4 = (str)r4;
    Call(r5, 0x4898);
  ...
  L_35f8:
    ...
    r2 = GetDotStr("!vector");  // @src girl_ole_talk.sci:85
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_ole_talk.sci:86
    r4 = r1;  // @src girl_ole_talk.sci:86
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    ...
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:87
    r4 = r1;  // @src girl_ole_talk.sci:87
    SetDotRaw(r3, 1042);
    Free1(r4);
    r5 = "ole_not_turgor";
    r6 = true;
    ...
    r2 = r1;  // @src girl_ole_talk.sci:88
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_ole_talk.sci:95
  L_36e0:
    r1 = false;  // @src girl_ole_talk.sci:95
    r2 = false;
    r6 = GetDotStr("World");
    SetDotRaw(r5, 1475);
    Free1(r6);
  ...
  L_37c8:
    if (!r1) goto L_38b0;
    // girl_ole_talk.sci:98
    r2 = GetDotStr("!vector");  // @src girl_ole_talk.sci:98
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // girl_ole_talk.sci:99
    r4 = r1;  // @src girl_ole_talk.sci:99
    SetDotRaw(r3, 1042);
    Free1(r4);
    g5 = r0;
    g6 = r1;
    r7 = "ole_treekiller_appears";
    r8 = true;
    Spawn(r4, 0, 0x190c);
    r0 = null_str;
    Free3(r5, r6, r7);
    ...
    r4 = r1;  // @src girl_ole_talk.sci:100
    SetDotRaw(r3, 1042);
    Free1(r4);
    r5 = "ole_treekiller_appears1";
    r6 = true;
    Spawn(r4, 0, 0x2b98);
    r0 = 1.8973581206958023e-42f;
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // girl_ole_talk.sci:101
    r2 = r1;  // @src girl_ole_talk.sci:101
    r_neg4 = r2;
    Free3(r2, r1, r0);
    return r0;
    // girl_ole_talk.sci:109
  L_38b0:
    r1 = null_str;  // @src girl_ole_talk.sci:109
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
}
...
func_48()
{
  ...
  L_429c:
    ...
    // talk_base.sci:373
  L_42ac:
    goto L_42c4;  // @src talk_base.sci:373
    // talk_base.sci:383
  L_42b4:
    ...
    // talk_base.sci:367
  L_42c4:
    goto L_40bc;  // @src talk_base.sci:367
    // talk_base.sci:388
  L_42cc:
...
func_54()
{
  ...
  L_4804:
    ...
    r2 = r5;
    // talk_base.sci:445
    goto L_4878;  // @src talk_base.sci:445
    // talk_base.sci:441
  L_4858:
    goto L_4870;  // @src talk_base.sci:441
    // talk_base.sci:449
  L_4860:
    ...
    // talk_base.sci:435
  L_4870:
    goto L_4768;  // @src talk_base.sci:435
    // talk_base.sci:427
  L_4878:
  ...
  L_487c:
    ...
    RetV(r3);
    Free2(r4, r3);
    goto L_487c;  // @src talk_base.sci:454
}
...
func_59()
{
    ...
    CallNat(r3, 19600, 0x0);  // @src talk_girl_base.sci:854
}

// obscure_ole.sc:33 (locals=0)
func_60()
{
    // obscure_ole.sc:32
    Call(r0, 0x4ca4);  // @src obscure_ole.sc:32
    // obscure_ole.sc:33
    return r0;  // @src obscure_ole.sc:33
}
...
needViewRender()
{
  ...
  L_4f24:
    ...
    Call(r4, 0x2c3c);  // @src talk_girl_base.sci:410
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x7fc8);
  ...
  L_52d4:
    ...
    CopyExtRd(r4, 1, 4);
    // talk_girl_base.sci:413
    goto L_5320;  // @src talk_girl_base.sci:413
  ...
  L_532c:
    ...
    // talk_girl_base.sci:398
  L_5334:
    goto L_59ac;  // @src talk_girl_base.sci:398
  ...
  L_553c:
    ...
    Call(r4, 0x2c3c);  // @src talk_girl_base.sci:457
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x7fc8);
  ...
  L_5730:
    ...
    Call(r4, 0x2c3c);  // @src talk_girl_base.sci:467
    r4 = r_neg4;
    r3 = r3 * r4;
    r3 = (int)r3;
    Call(r4, 0x7fc8);
    // talk_girl_base.sci:469
    Call(r3, 0x8a34);  // @src talk_girl_base.sci:469
    // talk_girl_base.sci:439
  L_5858:
...
getAllowedTypes()
{
  ...
  L_5af8:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_5af8;  // @src talk_girl_base.sci:739
}
...
func_65()
{
    ...
    Free2(r2, r0);
    // talk_girl_base.sci:273
    goto L_5c28;  // @src talk_girl_base.sci:273
...
func_66()
{
  ...
  L_60b0:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_60b0;  // @src talk_base.sci:692
}
...
func_69()
{
  ...
  L_6374:
    ...
    Free1(r4);
    // talk_girl_base.sci:981
    goto L_6608;  // @src talk_girl_base.sci:981
  ...
  L_6878:
    ...
    Free2(r8, r7);
    // talk_girl_base.sci:996
    goto L_6728;  // @src talk_girl_base.sci:996
    // talk_girl_base.sci:1007
  L_68c0:
    r7 = false;  // @src talk_girl_base.sci:1007
    RetV(r6);
    Free2(r7, r6);
    goto L_68c0;  // @src talk_girl_base.sci:1007
}
...
func_75()
{
    ...
    Call(r1, 0x6d94);  // @src ../posteffects/posteffects.sci:110
    CopyExtRd(r0, 1, 13);
    Free1(r0);
  ...
  L_6d8c:
    goto L_6c4c;  // @src ../posteffects/posteffects.sci:113
}
...
func_78()
{
    ...
    Call(r2, 0x7244);  // @src ../posteffects/posteffects.sci:28
  ...
  L_6fb4:
    ...
    r4 = r7;
    // ../posteffects/posteffects.sci:39
    goto L_714c;  // @src ../posteffects/posteffects.sci:39
  ...
  L_708c:
    ...
    r4 = r7;
    // ../posteffects/posteffects.sci:43
    goto L_714c;  // @src ../posteffects/posteffects.sci:43
...
func_89()
{
  ...
  L_7a48:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r17, 31524, 0x206);
    // ..\posteffects\darken.sci:74
  L_7b1c:
    goto L_7a48;  // @src ..\posteffects\darken.sci:74
}
...
func_90()
{
  ...
  L_7bbc:
    ...
    r6 = r_neg5;
    r7 = r_neg4;
    CallNat(r18, 31840, 0x206);
    // ..\posteffects\darken.sci:97
  L_7c58:
    goto L_7bbc;  // @src ..\posteffects\darken.sci:97
}
...
func_91()
{
  ...
  L_7c84:
    ...
    goto L_7c84;  // @src ..\posteffects\darken.sci:112
  ...
  L_7d8c:
    ...
    goto L_7d8c;  // @src ..\posteffects\darken.sci:128
    // ..\posteffects\darken.sci:120
  L_7da8:
    goto L_7cd8;  // @src ..\posteffects\darken.sci:120
}
...
func_95()
{
  ...
  L_7eb8:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_7eb8;  // @src talk_girl_base.sci:746
}
...
getAllowedTypes()
{
  ...
  L_8330:
    ...
    CallNat2(r3, 33608, 0x1);
    // talk_girl_base.sci:828
    return r0;  // @src talk_girl_base.sci:828
}

// obscure_ole.sc:19 (locals=2)
func_101()
{
    // obscure_ole.sc:12
    r0 = r_neg4;  // @src obscure_ole.sc:12
    r1 = 1;
    r0 = r0 == r1;
    if (!r0) goto L_839c;
    // obscure_ole.sc:13
    Call(r1, 0x83a8);  // @src obscure_ole.sc:13
    // obscure_ole.sc:14
    r1 = r0;  // @src obscure_ole.sc:14
    if (!r1) goto L_8398;
    // obscure_ole.sc:15
    r1 = r0;  // @src obscure_ole.sc:15
    CallNat(r5, 19468, 0x101);
    // obscure_ole.sc:12
  L_8398:
    Free1(r0);  // @src obscure_ole.sc:12
    // obscure_ole.sc:18
  L_839c:
    Call(r0, 0x3014);  // @src obscure_ole.sc:18
    // obscure_ole.sc:19
    return r0;  // @src obscure_ole.sc:19
}

// girl_ole_talk.sci:29 (locals=4)
func_102()
{
    // girl_ole_talk.sci:18
    r0 = null_str2;  // @src girl_ole_talk.sci:18
    // girl_ole_talk.sci:19
    r2 = "ole_donor_01";  // @src girl_ole_talk.sci:19
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:20
    r1 = r0;  // @src girl_ole_talk.sci:20
    if (!r1) goto L_8414;
    r2 = r0;  // @src girl_ole_talk.sci:20
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg4 = r1;
  ...
  L_8414:
    r2 = "ole_donor_02";  // @src girl_ole_talk.sci:22
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    ...
    Free2(r1, r0);
    return r0;
    // girl_ole_talk.sci:25
  L_8474:
    r2 = "ole_donor_03";  // @src girl_ole_talk.sci:25
    Call(r3, 0x17b8);
    r0 = r1;
    Free1(r1);
    // girl_ole_talk.sci:26
    r1 = r0;  // @src girl_ole_talk.sci:26
    if (!r1) goto L_84d4;
    r2 = r0;  // @src girl_ole_talk.sci:26
    r3 = 0;
    SetDot(r1, 1);
    r1 = (str)r1;
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
    // girl_ole_talk.sci:28
  L_84d4:
    r1 = null_str;  // @src girl_ole_talk.sci:28
    r_neg4 = r1;
    Free2(r1, r0);
    return r0;
}
...
func_103()
{
  ...
  L_893c:
    goto L_8964;  // @src talk_girl_base.sci:806
    // talk_girl_base.sci:799
  L_8944:
    goto L_895c;  // @src talk_girl_base.sci:799
  ...
  L_895c:
    goto L_87c0;  // @src talk_girl_base.sci:786
...
func_110()
{
  ...
  L_9430:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_9430;  // @src talk_girl_base.sci:731
}
...
OnDanceEnd()
{
  ...
  L_9524:
    ...
    Free4(r3, r4, r5, r2);
    // talk_girl_base.sci:236
    goto L_95bc;  // @src talk_girl_base.sci:236
...
onLevelup()
{
  ...
  L_9cf0:
    ...
    RetV(r0);
    Free2(r1, r0);
    goto L_9cf0;  // @src talk_base.sci:684
}
...
processTalkGesture()
{
    ...
    CallNat2(r2, 40356, 0x0);  // @src talk_girl_base.sci:202
...
func_121()
{
  ...
  L_9dac:
    ...
    Free1(r0);
    // talk_girl_base.sci:210
    goto L_9dac;  // @src talk_girl_base.sci:210
    // talk_girl_base.sci:214
  L_9e00:
    CallNat(r3, 12308, 0x0);  // @src talk_girl_base.sci:214
}
...
getAllowedTypes()
{
    ...
    r0 = (str)r0;
    // ../souls.sci:252
    Call(r2, 0x2210);  // @src ../souls.sci:252
    if (!r1) goto L_acf8;
    // ../souls.sci:253
...
func_131()
{
  ...
  L_af18:
    ...
    // ../souls.sci:278
  L_af38:
    Call(r4, 0x2210);  // @src ../souls.sci:278
    if (!r3) goto L_afac;
    // ../souls.sci:279
...
addSubquest()
{
  ...
  L_b8ec:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:177
    goto L_bb48;  // @src ../ui/gesture_help.sci:177
  ...
  L_b9c8:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:181
    goto L_bb48;  // @src ../ui/gesture_help.sci:181
  ...
  L_ba20:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:185
    goto L_bb48;  // @src ../ui/gesture_help.sci:185
  ...
  L_ba78:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:189
    goto L_bb48;  // @src ../ui/gesture_help.sci:189
  ...
  L_bac0:
    ...
    Free1(r3);
    // ../ui/gesture_help.sci:193
    goto L_bb48;  // @src ../ui/gesture_help.sci:193
  ...
  L_bc80:
    ...
    // ../ui/gesture_help.sci:138
  L_bc88:
    goto L_bcc0;  // @src ../ui/gesture_help.sci:138
