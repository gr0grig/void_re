...
func_1()
{
    ...
    r0 = (float)r0;
    // una_wheel.sc:6
    r2 = GetDotStr("randRange");  // @src una_wheel.sc:6
    ...
    r1 = (float)r1;
    // una_wheel.sc:7
    r2 = GetDotStr("Rotation");  // @src una_wheel.sc:7
    r2 = (str)r2;
    // una_wheel.sc:9
    r4 = GetDotStr("setKinematic");  // @src una_wheel.sc:9
    r5 = true;
    GetDot(r3, 1);
    Free2(r4, r3);
    // una_wheel.sc:13
  L_007c:
    ...
    // una_wheel.sc:17
  L_00e8:
    r4 = GetDotStr("setRotation");  // @src una_wheel.sc:17
    r5 = r2;
