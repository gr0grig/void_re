...
func_1()
{
    ...
    RawDword(0x0000107c);  // UNKNOWN opcode 0x7c
...
func_2()
{
    ...
    // vein_base.sci:83
    goto L_030c;  // @src vein_base.sci:83
    // vein_base.sci:87
  L_0300:
    CallNat2(r3, 3672, 0x200);  // @src vein_base.sci:87
    // vein_base.sci:89
  L_030c:
...
getVeinLimfaType()
{
    ...
    r1 = GetDotStr("findMaterial");  // @src vein_fort_rock.sc:26
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fort_rock.sc:27
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_fort_rock.sc:27
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
onHarpoon()
{
    ...
    CopyExtRd(r0, 1, 2);
    // vein_base.sci:120
    Call(r0, 0x04a0);  // @src vein_base.sci:120
    // vein_base.sci:121
...
func_11()
{
    ...
    r0 = 0x49;
    r2 = "潗汲d牐灯牥楴獥最瑥嘀攀椀渀⼀䰀浩慦牆浯...";  // len=583, pool_off=0x14b, GARBLED  // @patch+4 vein_base.sci:135
    SetDotRaw(r1, 268);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:137
    Call(r1, 0x04a0);  // @src vein_base.sci:137
    // vein_base.sci:138
  ...
  L_05f4:
    ...
    // vein_base.sci:140
  L_0648:
    goto L_05f4;  // @src vein_base.sci:140
    // vein_base.sci:146
  L_0650:
...
getVeinLimfaType()
{
  ...
  L_0750:
    ...
    r0 = r4;
    // vein_base.sci:27
    goto L_06e0;  // @src vein_base.sci:27
}
...
func_14()
{
    ...
    r1 = GetDotStr("findMaterial");  // @src vein_fort_rock.sc:33
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fort_rock.sc:34
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_fort_rock.sc:34
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:166
    CallNat2(r5, 2384, 0x0);  // @src vein_base.sci:166
    // vein_base.sci:167
...
func_23()
{
    ...
    r3 = GetDotStr("World");  // @src vein_fort_rock.sc:16
    SetDotRaw(r2, 769);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_fort_rock.sc:18
    SetDotRaw(r2, 769);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_fort_rock.sc:20
    SetDotRaw(r2, 769);
    Free1(r3);
    r3 = GetDotStr("Scene");
...
func_24()
{
    ...
    r0 = 73;
    r2 = "物湡剤湡敧\0";  // len=583, pool_off=0x380, GARBLED  // @patch+4 vein_base.sci:159
    r3 = 1000000.0f;
    r4 = 2000000.0f;
    GetDot(r1, 2);
    Free1(r2);
    ...
    Call(r2, 0x0ebc);
    // vein_base.sci:161
    CallNat(r6, 3896, 0x0);  // @src vein_base.sci:161
}
...
{
    // vein_base.sci:195
    CallNat2(r5, 2384, 0x0);  // @src vein_base.sci:195
    // vein_base.sci:196
...
getVeinLimfaType()
{
    ...
    r0 = 73;
    r2 = "物湡剤湡敧\0";  // len=327, pool_off=0x380, GARBLED  // @patch+4 vein_base.sci:179
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_0fb4:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 515, 0x20a);  // @patch+8 vein_base.sci:186
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
    // vein_base.sci:182
    goto L_0fb4;  // @src vein_base.sci:182
    // vein_base.sci:180
  L_1054:
    r2 = r1;  // @src vein_base.sci:180
    r2 = Incr(r2);
    ...
    // vein_base.sci:190
  L_1070:
    CallNat(r6, 3896, 0x100);  // @src vein_base.sci:190
}
