...
{
    // ui_newgame.sc:12
    r1 = GetDotStr("trace");  // @src ui_newgame.sc:12
    r2 = "ui_newgame.sc started";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // ui_newgame.sc:13
    r2 = GetDotStr("Plane");  // @src ui_newgame.sc:13
    SetDotRaw(r1, 54);
    Free1(r2);
    r2 = "fontmain_20.ft";
    GetDot(r0, 1);
...
func_5()
{
  ...
  L_047c:
    ...
    // ui_newgame.sc:114
  L_08c8:
    r6 = GetDotStr("Plane");  // @src ui_newgame.sc:114
    SetDotRaw(r5, 227);
    Free1(r6);
    GetDot(r4, 0);
    Free1(r5);
...
{
    // ui_newgame.sc:29
    r1 = GetDotStr("!vector");  // @src ui_newgame.sc:29
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 1, 1);
    Free1(r0);
    // ui_newgame.sc:30
    r1 = GetDotStr("!vector");  // @src ui_newgame.sc:30
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 2, 1);
    Free1(r0);
    // ui_newgame.sc:32
    r2 = GetDotStr("Plane");  // @src ui_newgame.sc:32
    SetDotRaw(r1, 263);
    Free1(r2);
    r2 = "cursor_paint";
    GetDot(r0, 1);
    ...
    Free1(r0);
    // ui_newgame.sc:34
    r2 = GetDotStr("Plane");  // @src ui_newgame.sc:34
    SetDotRaw(r1, 297);
    Free1(r2);
    g2 = r0;
    r3 = 128;
    ...
    Free3(r1, r2, r0);
    // ui_newgame.sc:37
    r2 = GetDotStr("Plane");  // @src ui_newgame.sc:37
    SetDotRaw(r1, 297);
    Free1(r2);
    g2 = r0;
    r3 = 128;
  ...
  L_0f78:
    ...
    // ui_newgame.sc:52
    r4 = GetDotStr("Plane");  // @src ui_newgame.sc:52
    SetDotRaw(r3, 227);
    Free1(r4);
    GetDot(r2, 0);
    Free1(r3);
