...
func_10()
{
  ...
  L_01bc:
    ...
    Free1(r2);
    // companioncube.sc:75
    r3 = GetDotStr("applyForce");  // @src companioncube.sc:75
    r4 = 16.0f;
    g5 = r1;
    r4 = r4 * r5;
    r5 = 3.0f;
...
isTrapAttracted()
{
    ...
    Free1(r2);
    // companioncube.sc:52
    r1 = GetDotStr("applyForce");  // @src companioncube.sc:52
    r2 = r_neg4;
    r2 = Inv(r2);
    r3 = GetDotStr("Mass");
    r2 = r2 * r3;
    ...
    Free3(r1, r2, r0);
    // companioncube.sc:53
    r1 = GetDotStr("LinearVelocity");  // @src companioncube.sc:53
    r1 = (str)r1;
    Call(r2, 0x03cc);
    ...
    if (!r0) goto L_03c4;
    // companioncube.sc:54
    r0 = GetDotStr("LinearVelocity");  // @src companioncube.sc:54
    r0 = Inv(r0);
    r1 = 5;
    r0 = r0 * r1;
