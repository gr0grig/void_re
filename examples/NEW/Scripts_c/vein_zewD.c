...
{
    // vein_zewD.sc:32
    r1 = GetDotStr("findMaterial");  // @src vein_zewD.sc:32
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewD.sc:33
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_zewD.sc:33
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_zewD.sc:39
    r1 = GetDotStr("findMaterial");  // @src vein_zewD.sc:39
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewD.sc:40
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_zewD.sc:40
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
func_23()
{
    ...
    // vein_zewD.sc:18
    r3 = GetDotStr("World");  // @src vein_zewD.sc:18
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:20
    r3 = GetDotStr("World");  // @src vein_zewD.sc:20
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:22
    r3 = GetDotStr("World");  // @src vein_zewD.sc:22
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:24
    r3 = GetDotStr("World");  // @src vein_zewD.sc:24
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:26
    r3 = GetDotStr("World");  // @src vein_zewD.sc:26
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
...
getVeinLimfaType()
{
  ...
  L_114c:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 623, 0x20a);  // @patch+8 vein_base.sci:186
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
