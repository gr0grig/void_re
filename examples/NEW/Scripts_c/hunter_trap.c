...
func_1()
{
    ...
    Free1(r0);
    // hunter_trap.sc:39
    r2 = GetDotStr("Scene");  // @src hunter_trap.sc:39
    SetDotRaw(r1, 6);
    Free1(r2);
  ...
  L_00e4:
    ...
    // hunter_trap.sc:45
  L_0100:
    CallNat(r2, 2748, 0x0);  // @src hunter_trap.sc:45
}

// hunter_trap.sc:95 (locals=1)
getUseDistance()
{
    // hunter_trap.sc:94
    r0 = true;  // @src hunter_trap.sc:94
    r_neg4 = r0;
    return r0;
}

// hunter_trap.sc:113 (locals=9)
func_3()
{
    // hunter_trap.sc:99
    r2 = GetDotStr("loadSound3D");  // @src hunter_trap.sc:99
    ...
    Free1(r0);
    // hunter_trap.sc:100
    g0 = r2;  // @src hunter_trap.sc:100
    Call(r1, 0x04f0);
    // hunter_trap.sc:102
    r1 = GetDotStr("!qtpair");  // @src hunter_trap.sc:102
    ...
    r0 = (str)r0;
    // hunter_trap.sc:103
    r3 = GetDotStr("World");  // @src hunter_trap.sc:103
    SetDotRaw(r2, 175);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_treetrap.ps";
  ...
  L_02d0:
    r1 = (int)r1;
    // hunter_trap.sc:107
    r3 = r1;  // @src hunter_trap.sc:107
    Call(r4, 0x053c);
    // hunter_trap.sc:108
    r3 = 0;  // @src hunter_trap.sc:108
  L_02ec:
    r4 = r3;  // @src hunter_trap.sc:108
    r5 = 3;
    r4 = r4 < r5;
    if (!r4) goto L_0368;
    // hunter_trap.sc:109
    g6 = r0;  // @src hunter_trap.sc:109
    SetDotRaw(r5, 271);
    Free1(r6);
    r6 = r3;
    r7 = "PSColor";
    ...
    // hunter_trap.sc:111
  L_0368:
    r3 = r_neg4;  // @src hunter_trap.sc:111
    if (!r3) goto L_03a4;
    // hunter_trap.sc:112
    g5 = r0;  // @src hunter_trap.sc:112
    SetDotRaw(r4, 307);
    Free1(r5);
    r5 = 25000000;
    GetDot(r3, 1);
    ...
    // hunter_trap.sc:113
  L_03a4:
    Free2(r2, r0);  // @src hunter_trap.sc:113
    return r0;
}
...
{
    // hunter_trap.sc:32
    r5 = GetDotStr("World");  // @src hunter_trap.sc:32
    SetDotRaw(r4, 445);
    Free1(r5);
    SetDotRaw(r3, 456);
    Free1(r4);
...
getUseDistance()
{
  ...
  L_062c:
    ...
    Free1(r5);
    // hunter_trap.sc:68
    r4 = GetDotStr("Scene");  // @src hunter_trap.sc:68
    r4 = (str)r4;
    ...
    // hunter_trap.sc:65
    goto L_07b0;  // @src hunter_trap.sc:65
    // hunter_trap.sc:74
  L_0764:
    r4 = GetDotStr("Scene");  // @src hunter_trap.sc:74
    r4 = (str)r4;
    r6 = GetDotStr("loadSound");
  ...
  L_07b0:
    ...
    Free1(r5);
    // hunter_trap.sc:81
    r5 = GetDotStr("World");  // @src hunter_trap.sc:81
    SetDotRaw(r4, 6);
    Free1(r5);
    r5 = "getPlayerEntity";
    GetDot(r3, 1);
    ...
    Free2(r6, r4);
    // hunter_trap.sc:85
    r6 = GetDotStr("Scene");  // @src hunter_trap.sc:85
    SetDotRaw(r5, 6);
    Free1(r6);
    ...
    Free3(r5, r6, r4);
    // hunter_trap.sc:80
    Free1(r3);  // @src hunter_trap.sc:80
    // hunter_trap.sc:87
    Free1(r_neg6);  // @src hunter_trap.sc:87
    return r0;
}
...
{
    // hunter_trap.sc:17
    r1 = GetDotStr("callDef");  // @src hunter_trap.sc:17
    r2 = false;
    r3 = "isActive";
    GetDot(r0, 2);
    Free2(r1, r3);
    ...
    // hunter_trap.sc:21
  L_0b44:
    r3 = GetDotStr("Scene");  // @src hunter_trap.sc:21
    SetDotRaw(r2, 6);
    Free1(r3);
    ...
    // hunter_trap.sc:27
  L_0be0:
    r4 = GetDotStr("!tuple");  // @src hunter_trap.sc:27
    r5 = r2;
    r7 = r1;
    SetDotRaw(r6, 474);
    Free1(r7);
