...
func_1()
{
  ...
  L_0660:
    ...
    r3 = g9;
    // tree_base.sci:184
    CallNat(r3, 15836, 0x300);  // @src tree_base.sci:184
}
...
// tree_garden1b.sc:75 (locals=8)
getAllowedTypes()
{
    // tree_garden1b.sc:60
    g0 = r15;  // @src tree_garden1b.sc:60
    if (r0) goto L_104c;
    // tree_garden1b.sc:61
    r1 = GetDotStr("!qtpair");  // @src tree_garden1b.sc:61
    ...
    r0 = (str)r0;
    // tree_garden1b.sc:62
    r1 = r_neg4;  // @src tree_garden1b.sc:62
    if (r1) goto L_0ec0;
    // tree_garden1b.sc:63
    r3 = GetDotStr("World");  // @src tree_garden1b.sc:63
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_garden1treeb_dead_1.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    ...
    Free1(r1);
    // tree_garden1b.sc:62
    goto L_0f20;  // @src tree_garden1b.sc:62
    // tree_garden1b.sc:65
  L_0ec0:
    r3 = GetDotStr("World");  // @src tree_garden1b.sc:65
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_garden1treeb_dead.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    // tree_garden1b.sc:68
  L_0f20:
    r6 = GetDotStr("World");  // @src tree_garden1b.sc:68
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    Free1(r5);
    ...
    r1 = (str)r1;
    // tree_garden1b.sc:69
    r2 = 0;  // @src tree_garden1b.sc:69
  L_0f90:
    r3 = r2;  // @src tree_garden1b.sc:69
    g5 = r15;
    SetDotRaw(r4, 1095);
    Free1(r5);
    r3 = r3 < r4;
    if (!r3) goto L_1018;
    // tree_garden1b.sc:70
    g5 = r15;  // @src tree_garden1b.sc:70
    SetDotRaw(r4, 1108);
    Free1(r5);
    r5 = r2;
    r6 = "PSColor";
    ...
    // tree_garden1b.sc:73
  L_1018:
    g4 = r15;  // @src tree_garden1b.sc:73
    SetDotRaw(r3, 1144);
    Free1(r4);
    r4 = 60000000;
    GetDot(r2, 1);
    Free2(r3, r2);
    // tree_garden1b.sc:60
    Free2(r1, r0);  // @src tree_garden1b.sc:60
    // tree_garden1b.sc:75
  L_104c:
    return r0;  // @src tree_garden1b.sc:75
}
...
func_21()
{
  ...
  L_1d04:
    ...
    if (!r3) goto L_1d44;
    // tree_base.sci:415
    Call(r3, 0x2590);  // @src tree_base.sci:415
    // tree_base.sci:416
    Call(r3, 0x25dc);  // @src tree_base.sci:416
    // tree_base.sci:413
  ...
  L_1ffc:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:456
    Call(r8, 0x25dc);  // @src tree_base.sci:456
    // tree_base.sci:429
...
// tree_garden1b.sc:16 (locals=7)
func_23()
{
    // tree_garden1b.sc:11
    g0 = r11;  // @src tree_garden1b.sc:11
    if (r0) goto L_2370;
    // tree_garden1b.sc:12
    r1 = GetDotStr("!qtpair");  // @src tree_garden1b.sc:12
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden1b.sc:13
    r3 = GetDotStr("World");  // @src tree_garden1b.sc:13
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_Garden1treeBBloom.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free1(r1);
    // tree_garden1b.sc:14
    r1 = r_neg4;  // @src tree_garden1b.sc:14
    Call(r2, 0x2374);
    // tree_garden1b.sc:11
    Free1(r0);  // @src tree_garden1b.sc:11
    // tree_garden1b.sc:16
  L_2370:
    return r0;  // @src tree_garden1b.sc:16
}

// tree_garden1b.sc:27 (locals=7)
func_24()
{
    // tree_garden1b.sc:20
    r0 = r_neg4;  // @src tree_garden1b.sc:20
    r6 = GetDotStr("World");
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    ...
    r0 = (str)r0;
    // tree_garden1b.sc:21
    g3 = r11;  // @src tree_garden1b.sc:21
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:22
    g3 = r11;  // @src tree_garden1b.sc:22
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:23
    g3 = r11;  // @src tree_garden1b.sc:23
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:24
    g3 = r11;  // @src tree_garden1b.sc:24
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:25
    g3 = r11;  // @src tree_garden1b.sc:25
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 4;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:26
    g3 = r11;  // @src tree_garden1b.sc:26
    SetDotRaw(r2, 1108);
    Free1(r3);
    r3 = 5;
    r4 = "PSColor";
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1b.sc:27
    Free1(r0);  // @src tree_garden1b.sc:27
    return r0;
}

// tree_garden1b.sc:35 (locals=4)
func_25()
{
    // tree_garden1b.sc:31
    g0 = r12;  // @src tree_garden1b.sc:31
    if (r0) goto L_25d8;
    // tree_garden1b.sc:32
    r1 = GetDotStr("!qtpair");  // @src tree_garden1b.sc:32
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden1b.sc:31
    Free1(r0);  // @src tree_garden1b.sc:31
    // tree_garden1b.sc:35
  L_25d8:
    return r0;  // @src tree_garden1b.sc:35
}

// tree_garden1b.sc:42 (locals=6)
func_26()
{
    // tree_garden1b.sc:39
    r5 = GetDotStr("World");  // @src tree_garden1b.sc:39
    SetDotRaw(r4, 494);
    Free1(r5);
    SetDotRaw(r3, 505);
    Free1(r4);
    ...
    r0 = (str)r0;
    // tree_garden1b.sc:40
    g1 = r8;  // @src tree_garden1b.sc:40
    r1 = (float)r1;
    g2 = r13;
    r2 = (float)r2;
    r1 = r1 / r2;
    // tree_garden1b.sc:42
    Free1(r0);  // @src tree_garden1b.sc:42
    return r0;
}
...
// tree_garden1b.sc:51 (locals=3)
func_30()
{
    // tree_garden1b.sc:46
    g0 = r12;  // @src tree_garden1b.sc:46
    if (!r0) goto L_291c;
    // tree_garden1b.sc:47
    g2 = r12;  // @src tree_garden1b.sc:47
    SetDotRaw(r1, 1144);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1b.sc:49
  L_291c:
    g0 = r11;  // @src tree_garden1b.sc:49
    if (!r0) goto L_2958;
    // tree_garden1b.sc:50
    g2 = r11;  // @src tree_garden1b.sc:50
    SetDotRaw(r1, 1144);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1b.sc:51
  L_2958:
    return r0;  // @src tree_garden1b.sc:51
}
...
func_32()
{
    ...
    Free2(r3, r1);
    // gameplay.sci:1038
    goto L_2b24;  // @src gameplay.sci:1038
    // gameplay.sci:1043
  L_2af4:
...
func_33()
{
  ...
  L_2dc0:
    ...
    SetInd(r5);
    r0 = null_str;
    RawDword(0x00000883);  // UNKNOWN opcode 0x83
    Free1(r5);
    // tree_base.sci:229
    ...
    if (!r6) goto L_2fc8;
    // tree_base.sci:233
    Call(r6, 0x32a4);  // @src tree_base.sci:233
    // tree_base.sci:234
  L_2fc8:
    ...
    if (!r6) goto L_2ff4;
    // tree_base.sci:235
    Call(r6, 0x3314);  // @src tree_base.sci:235
    // tree_base.sci:234
    goto L_2ffc;  // @src tree_base.sci:234
    // tree_base.sci:237
  L_2ff4:
    Call(r6, 0x3384);  // @src tree_base.sci:237
    // tree_base.sci:239
  L_2ffc:
...
isWaitable()
{
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:309
    goto L_39b0;  // @src tree_base.sci:309
    // tree_base.sci:314
  L_36a4:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:314
    goto L_39b0;  // @src tree_base.sci:314
    // tree_base.sci:319
  L_376c:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:319
    goto L_39b0;  // @src tree_base.sci:319
    // tree_base.sci:324
  L_3834:
  ...
  L_39b0:
    ...
    Call(r1, 0x22b8);
    // tree_base.sci:337
    Call(r1, 0x3cc4);  // @src tree_base.sci:337
    // tree_base.sci:339
  ...
  L_3b74:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:347
    goto L_3b74;  // @src tree_base.sci:347
    // tree_base.sci:355
  L_3cb0:
...
// tree_garden1b.sc:7 (locals=1)
getHelperText()
{
    // tree_garden1b.sc:6
    r0 = 3;  // @src tree_garden1b.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
