...
{
    // vein_zewA.sc:32
    r1 = GetDotStr("findMaterial");  // @src vein_zewA.sc:32
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewA.sc:33
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_zewA.sc:33
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_zewA.sc:39
    r1 = GetDotStr("findMaterial");  // @src vein_zewA.sc:39
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewA.sc:40
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_zewA.sc:40
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
func_23()
{
    ...
    // vein_zewA.sc:18
    r3 = GetDotStr("World");  // @src vein_zewA.sc:18
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewA.sc:20
    r3 = GetDotStr("World");  // @src vein_zewA.sc:20
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewA.sc:22
    r3 = GetDotStr("World");  // @src vein_zewA.sc:22
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewA.sc:24
    r3 = GetDotStr("World");  // @src vein_zewA.sc:24
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewA.sc:26
    r3 = GetDotStr("World");  // @src vein_zewA.sc:26
    SetDotRaw(r2, 877);
    Free1(r3);
    r3 = GetDotStr("Scene");
