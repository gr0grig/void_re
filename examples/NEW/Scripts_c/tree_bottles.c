...
func_1()
{
  ...
  L_0660:
    ...
    r3 = g9;
    // tree_base.sci:184
    CallNat(r3, 15768, 0x300);  // @src tree_base.sci:184
}
...
// tree_bottles.sc:74 (locals=8)
getAllowedTypes()
{
    // tree_bottles.sc:59
    g0 = r15;  // @src tree_bottles.sc:59
    if (r0) goto L_104c;
    // tree_bottles.sc:60
    r1 = GetDotStr("!qtpair");  // @src tree_bottles.sc:60
    ...
    r0 = (str)r0;
    // tree_bottles.sc:61
    r1 = r_neg4;  // @src tree_bottles.sc:61
    if (r1) goto L_0ec0;
    // tree_bottles.sc:62
    r3 = GetDotStr("World");  // @src tree_bottles.sc:62
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_gardenbottles_tree_dead_1.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    ...
    Free1(r1);
    // tree_bottles.sc:61
    goto L_0f20;  // @src tree_bottles.sc:61
    // tree_bottles.sc:64
  L_0ec0:
    r3 = GetDotStr("World");  // @src tree_bottles.sc:64
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_gardenbottles_tree_dead_1.ps";
    ...
    // tree_bottles.sc:67
  L_0f20:
    r6 = GetDotStr("World");  // @src tree_bottles.sc:67
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    Free1(r5);
    ...
    r1 = (str)r1;
    // tree_bottles.sc:68
    r2 = 0;  // @src tree_bottles.sc:68
  L_0f90:
    r3 = r2;  // @src tree_bottles.sc:68
    g5 = r15;
    SetDotRaw(r4, 1065);
    Free1(r5);
    r3 = r3 < r4;
  ...
  L_1018:
    ...
    Free2(r3, r2);
    // tree_bottles.sc:59
    Free2(r1, r0);  // @src tree_bottles.sc:59
    // tree_bottles.sc:74
  L_104c:
    return r0;  // @src tree_bottles.sc:74
}
...
func_21()
{
  ...
  L_1d04:
    ...
    if (!r3) goto L_1d44;
    // tree_base.sci:415
    Call(r3, 0x254c);  // @src tree_base.sci:415
    // tree_base.sci:416
    Call(r3, 0x2598);  // @src tree_base.sci:416
    // tree_base.sci:413
  ...
  L_1ffc:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:456
    Call(r8, 0x2598);  // @src tree_base.sci:456
    // tree_base.sci:429
...
// tree_bottles.sc:16 (locals=7)
func_23()
{
    // tree_bottles.sc:11
    g0 = r11;  // @src tree_bottles.sc:11
    if (r0) goto L_2370;
    // tree_bottles.sc:12
    r1 = GetDotStr("!qtpair");  // @src tree_bottles.sc:12
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_bottles.sc:13
    r3 = GetDotStr("World");  // @src tree_bottles.sc:13
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_gardenbottles_treeBloom.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free1(r1);
    // tree_bottles.sc:14
    r1 = r_neg4;  // @src tree_bottles.sc:14
    Call(r2, 0x2374);
    // tree_bottles.sc:11
    Free1(r0);  // @src tree_bottles.sc:11
    // tree_bottles.sc:16
  L_2370:
    return r0;  // @src tree_bottles.sc:16
}

// tree_bottles.sc:26 (locals=7)
func_24()
{
    // tree_bottles.sc:20
    r0 = r_neg4;  // @src tree_bottles.sc:20
    r6 = GetDotStr("World");
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    ...
    Free4(r2, r4, r5, r1);
    // tree_bottles.sc:26
    Free1(r0);  // @src tree_bottles.sc:26
    return r0;
}

// tree_bottles.sc:34 (locals=4)
func_25()
{
    // tree_bottles.sc:30
    g0 = r12;  // @src tree_bottles.sc:30
    if (r0) goto L_2594;
    // tree_bottles.sc:31
    r1 = GetDotStr("!qtpair");  // @src tree_bottles.sc:31
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_bottles.sc:30
    Free1(r0);  // @src tree_bottles.sc:30
    // tree_bottles.sc:34
  L_2594:
    return r0;  // @src tree_bottles.sc:34
}

// tree_bottles.sc:41 (locals=6)
func_26()
{
    // tree_bottles.sc:38
    r5 = GetDotStr("World");  // @src tree_bottles.sc:38
    SetDotRaw(r4, 494);
    Free1(r5);
    SetDotRaw(r3, 505);
    Free1(r4);
    ...
    r0 = (str)r0;
    // tree_bottles.sc:39
    g1 = r8;  // @src tree_bottles.sc:39
    r1 = (float)r1;
    g2 = r13;
    r2 = (float)r2;
    r1 = r1 / r2;
    // tree_bottles.sc:41
    Free1(r0);  // @src tree_bottles.sc:41
    return r0;
}
...
// tree_bottles.sc:50 (locals=3)
func_30()
{
    // tree_bottles.sc:45
    g0 = r12;  // @src tree_bottles.sc:45
    if (!r0) goto L_28d8;
    // tree_bottles.sc:46
    g2 = r12;  // @src tree_bottles.sc:46
    SetDotRaw(r1, 1114);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_bottles.sc:48
  L_28d8:
    g0 = r11;  // @src tree_bottles.sc:48
    if (!r0) goto L_2914;
    // tree_bottles.sc:49
    g2 = r11;  // @src tree_bottles.sc:49
    SetDotRaw(r1, 1114);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_bottles.sc:50
  L_2914:
    return r0;  // @src tree_bottles.sc:50
}
...
func_32()
{
    ...
    Free2(r3, r1);
    // gameplay.sci:1038
    goto L_2ae0;  // @src gameplay.sci:1038
    // gameplay.sci:1043
  L_2ab0:
...
func_33()
{
  ...
  L_2d7c:
    ...
    SetInd(r5);
    r0 = null_str;
    RawDword(0x00000871);  // UNKNOWN opcode 0x71
    Free1(r5);
    // tree_base.sci:229
    ...
    if (!r6) goto L_2f84;
    // tree_base.sci:233
    Call(r6, 0x3260);  // @src tree_base.sci:233
    // tree_base.sci:234
  L_2f84:
    ...
    if (!r6) goto L_2fb0;
    // tree_base.sci:235
    Call(r6, 0x32d0);  // @src tree_base.sci:235
    // tree_base.sci:234
    goto L_2fb8;  // @src tree_base.sci:234
    // tree_base.sci:237
  L_2fb0:
    Call(r6, 0x3340);  // @src tree_base.sci:237
    // tree_base.sci:239
  L_2fb8:
...
isWaitable()
{
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:309
    goto L_396c;  // @src tree_base.sci:309
    // tree_base.sci:314
  L_3660:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:314
    goto L_396c;  // @src tree_base.sci:314
    // tree_base.sci:319
  L_3728:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:319
    goto L_396c;  // @src tree_base.sci:319
    // tree_base.sci:324
  L_37f0:
  ...
  L_396c:
    ...
    Call(r1, 0x22b8);
    // tree_base.sci:337
    Call(r1, 0x3c80);  // @src tree_base.sci:337
    // tree_base.sci:339
  ...
  L_3b30:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:347
    goto L_3b30;  // @src tree_base.sci:347
    // tree_base.sci:355
  L_3c6c:
...
// tree_bottles.sc:7 (locals=1)
getHelperText()
{
    // tree_bottles.sc:6
    r0 = 3;  // @src tree_bottles.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
