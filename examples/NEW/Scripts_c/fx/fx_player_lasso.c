...
func_1()
{
    ...
    r0 = 73;
    CallNat2(r0, 322, 0x3114);  // @patch+4 fx_player_lasso.sc:27
    r0 = 0xffffffff;  // @patch+4 fx_player_lasso.sc:50
    r0 = null_str;
    // fx_player_lasso.sc:36
    r1 = GetDotStr("logInfo");  // @src fx_player_lasso.sc:36
    r2 = "initLasso: ";
    r3 = r_neg9;
    r3 = (as_string)r3;
    r2 = r2 + r3;
...
onPartCollision()
{
  ...
  L_0408:
    ...
    r3 = GetDotStr("!fixedJointDesc");  // @src fx_player_lasso.sc:296
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "物吀慲獮慬楴湯瀀猀开氀椀洀昀愀开攀砀瀀氀...";  // len=255, pool_off=0x44b, GARBLED
...
func_3()
{
    ...
    r4 = GetDotStr("World");  // @src fx_player_lasso.sc:192
    SetDotRaw(r3, 331);
    Free1(r4);
    r4 = GetDotStr("Scene");
    r5 = "ps_lasso.ps";
  ...
  L_0844:
    ...
    r7 = GetDotStr("Scene");  // @src fx_player_lasso.sc:209
    SetDotRaw(r6, 460);
    Free1(r7);
    r8 = GetDotStr("!sphere");
  ...
  L_099c:
    r7 = GetDotStr("!vec3");  // @src fx_player_lasso.sc:217
    r8 = 0;
    r9 = 0;
    r10 = 0;
    GetDot(r6, 3);
...
func_6()
{
    ...
    r1 = GetDotStr("!vector");  // @src fx_player_lasso.sc:173
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r3 = GetDotStr("!spline");  // @src fx_player_lasso.sc:176
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
  ...
  L_2050:
    ...
    r5 = GetDotStr("!bezier3D");  // @src fx_player_lasso.sc:179
    r7 = r0;
    r8 = r3;
    SetDot(r6, 1);
    r8 = r1;
...
func_11()
{
    ...
    r1 = GetDotStr("logInfo");  // @src fx_player_lasso.sc:321
    r2 = "Lasso explode";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // fx_player_lasso.sc:323
    r2 = GetDotStr("Scene");  // @src fx_player_lasso.sc:323
    SetDotRaw(r1, 460);
    Free1(r2);
    r3 = GetDotStr("!sphere");
  ...
  L_27a4:
    r3 = GetDotStr("loadSound3D");  // @src fx_player_lasso.sc:333
  ...
  L_2838:
    ...
    r4 = GetDotStr("irandRange");  // @src fx_player_lasso.sc:337
    r5 = 1;
    r6 = 3;
    GetDot(r3, 2);
    Free1(r4);
    ...
    Call(r5, 0x2f6c);  // @src fx_player_lasso.sc:338
    // fx_player_lasso.sc:339
    r6 = GetDotStr("randRange");  // @src fx_player_lasso.sc:339
    r7 = 0.5f;
    r8 = 1;
    GetDot(r5, 2);
    Free1(r6);
    ...
    r8 = GetDotStr("World");  // @src fx_player_lasso.sc:340
    SetDotRaw(r7, 835);
    Free1(r8);
    r8 = GetDotStr("Scene");
  ...
  L_2998:
    Call(r3, 0x3030);  // @src fx_player_lasso.sc:344
  ...
  L_2b80:
    r4 = GetDotStr("!qtpair");  // @src fx_player_lasso.sc:360
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    // fx_player_lasso.sc:361
    r4 = GetDotStr("Position");  // @src fx_player_lasso.sc:361
    r5 = r3;
    SetInd(r5);
    r0 = null_str;
    Free5(r4, r1355, r0, r4, r0);
    // fx_player_lasso.sc:362
    r6 = GetDotStr("World");  // @src fx_player_lasso.sc:362
    SetDotRaw(r5, 331);
    Free1(r6);
    r6 = GetDotStr("Scene");
    ...
    r7 = GetDotStr("Scene");  // @src fx_player_lasso.sc:366
    SetDotRaw(r6, 1236);
    Free1(r7);
  ...
  L_2d34:
    ...
    Free1(r5);
    // fx_player_lasso.sc:368
    goto L_2d34;  // @src fx_player_lasso.sc:368
...
func_18()
{
  ...
  L_3100:
    ...
    goto L_3100;  // @src fx_player_lasso.sc:61
}
