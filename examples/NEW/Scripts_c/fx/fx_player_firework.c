...
func_1()
{
    ...
    r1 = GetDotStr("!vector");  // @src fx_player_firework.sc:54
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
    ...
    r1 = GetDotStr("!vector");  // @src fx_player_firework.sc:64
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g6;
    ...
    r1 = GetDotStr("!vector");  // @src fx_player_firework.sc:71
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    ...
    r1 = GetDotStr("!vector");  // @src fx_player_firework.sc:76
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
...
isTrapAttracted()
{
    ...
    r1 = GetDotStr("logInfo");  // @src fx_player_firework.sc:96
    r2 = "initFirework: ";
    r3 = r_neg6;
    r3 = (as_string)r3;
    r2 = r2 + r3;
    ...
    r2 = GetDotStr("loadSound3D");  // @src fx_player_firework.sc:100
    g4 = r6;
...
// fx_player_firework.sc:226 (locals=18)
func_9()
{
  ...
  L_081c:
    ...
    r2 = GetDotStr("logInfo");  // @src fx_player_firework.sc:175
    r3 = "Collision: ";
    r4 = r0;
    r4 = (as_string)r4;
    r3 = r3 + r4;
  ...
  L_0954:
    r3 = GetDotStr("Scene");  // @src fx_player_firework.sc:190
    SetDotRaw(r2, 1639);
    Free1(r3);
    r4 = GetDotStr("!sphere");
    ...
    r2 = r1;  // @src fx_player_firework.sc:192
    if (!r2) goto L_0a8c;
    // fx_player_firework.sc:193
    r2 = 0;  // @src fx_player_firework.sc:193
  L_09cc:
    r3 = r2;  // @src fx_player_firework.sc:193
    r5 = r1;
    SetDotRaw(r4, 1434);
    Free1(r5);
    r3 = r3 < r4;
    ...
    r4 = r1;  // @src fx_player_firework.sc:194
    r5 = r2;
    SetDot(r3, 1);
    r3 = (str)r3;
    // fx_player_firework.sc:195
    r5 = r3;  // @src fx_player_firework.sc:195
    GetInd(r4);
    RawDword(0x000005b6);  // UNKNOWN opcode 0xb6
    Free1(r5);
    if (!r4) goto L_0a6c;
    // fx_player_firework.sc:196
    r6 = r3;  // @src fx_player_firework.sc:196
    SetDotRaw(r5, 1462);
    Free1(r6);
    r6 = "onFireworkHit";
    g7 = r1;
    ...
    // fx_player_firework.sc:193
  L_0a6c:
    Free1(r3);  // @src fx_player_firework.sc:193
    r3 = r2;
    r3 = Incr(r3);
    r2 = r3;
    goto L_09cc;
  ...
  L_0a8c:
    r4 = r_neg5;  // @src fx_player_firework.sc:200
    SetDotRaw(r3, 1698);
    Free1(r4);
    GetDot(r2, 0);
    Free1(r3);
    ...
    r5 = r2;  // @src fx_player_firework.sc:201
    SetDotRaw(r4, 1724);
    Free1(r5);
    r5 = 2;
    GetDot(r3, 1);
    ...
    r3 = 0;  // @src fx_player_firework.sc:203
  L_0ae8:
    r4 = r3;  // @src fx_player_firework.sc:203
    r5 = 3;
    r4 = r4 < r5;
    if (!r4) goto L_0c44;
    // fx_player_firework.sc:204
    g5 = r5;  // @src fx_player_firework.sc:204
    ...
    Free1(r6);
    r4 = (str)r4;
    // fx_player_firework.sc:205
    r7 = GetDotStr("World");  // @src fx_player_firework.sc:205
    SetDotRaw(r6, 1745);
    Free1(r7);
    r7 = GetDotStr("Scene");
    r8 = r4;
    ...
    r17 = 0.30000001192092896f;
    GetDot(r14, 2);
    Free1(r15);
    GetDot(r10, 3);
    Free4(r11, r12, r13, r14);
    r9 = r9 + r10;
    r10 = "fx/fx_player_firework_prefab";
    GetDot(r5, 4);
    Free5(r6, r7, r8, r9, r10);
    Free1(r5);
    // fx_player_firework.sc:203
    Free1(r4);  // @src fx_player_firework.sc:203
    r4 = r3;
    r4 = Incr(r4);
    r3 = r4;
    goto L_0ae8;
  ...
  L_0c44:
    r5 = GetDotStr("loadSound3D");  // @src fx_player_firework.sc:208
    g7 = r7;
    ...
    Call(r4, 0x0634);
    // fx_player_firework.sc:201
    goto L_0dd8;  // @src fx_player_firework.sc:201
    // fx_player_firework.sc:212
  L_0d20:
    r5 = GetDotStr("loadSound3D");  // @src fx_player_firework.sc:212
    g7 = r8;
    r9 = GetDotStr("irandMax");
    g11 = r8;
    SetDotRaw(r10, 1434);
  ...
  L_0dd8:
    r3 = true;  // @src fx_player_firework.sc:215
    CopyExtRd(r3, 0, 2);
    // fx_player_firework.sc:217
    r4 = r_neg5;  // @src fx_player_firework.sc:217
    SetDotRaw(r3, 1828);
    Free1(r4);
    if (!r3) goto L_0edc;
    // fx_player_firework.sc:219
    r3 = 0;  // @src fx_player_firework.sc:219
  L_0e10:
    r4 = r3;  // @src fx_player_firework.sc:219
    r6 = r_neg5;
    SetDotRaw(r5, 1828);
    Free1(r6);
    r4 = r4 < r5;
    ...
    r5 = r_neg5;  // @src fx_player_firework.sc:220
    r6 = r3;
    SetDot(r4, 1);
    r4 = (str)r4;
    // fx_player_firework.sc:221
    CopyExtWr(r2, 5, 2);  // @src fx_player_firework.sc:221
    r7 = r4;
    SetDotRaw(r6, 1841);
    Free1(r7);
    r5 = r5 + r6;
    ...
    Free1(r5);
    // fx_player_firework.sc:219
    Free1(r4);  // @src fx_player_firework.sc:219
    r4 = r3;
    r4 = Incr(r4);
    r3 = r4;
    goto L_0e10;
  ...
  L_0eac:
    r3 = -0.05000000074505806f;  // @src fx_player_firework.sc:224
    CopyExtWr(r2, 4, 2);
    r4 = Inv(r4);
    r3 = r3 * r4;
    r3 = (str)r3;
  ...
  L_0edc:
    Free4(r2, r1, r0, r_neg5);  // @src fx_player_firework.sc:226
    return r0;
}
...
func_11()
{
    ...
    r1 = GetDotStr("!vec3");  // @src fx_player_firework.sc:126
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 2, 2);
    ...
    r2 = GetDotStr("World");  // @src fx_player_firework.sc:128
    SetDotRaw(r1, 1898);
    Free1(r2);
    r2 = GetDotStr("Scene");
    r3 = "ps_flare.ps";
  ...
  L_10d0:
    ...
    r4 = GetDotStr("Position");  // @src fx_player_firework.sc:142
    r5 = 1;
    r6 = r3;
    r5 = r5 - r6;
    ...
    SetInd(r5);
    r0 = null_str;
    RawDword(0x0000067f);  // UNKNOWN opcode 0x7f
    Free2(r5, r4);
    // fx_player_firework.sc:143
    r5 = GetDotStr("applyForce");  // @src fx_player_firework.sc:143
    r6 = r_neg4;
    r7 = 20;
    r6 = r6 * r7;
    r7 = GetDotStr("Mass");
  ...
  L_124c:
    ...
    r3 = GetDotStr("World");  // @src fx_player_firework.sc:151
    SetDotRaw(r2, 1898);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src fx_player_firework.sc:158
    SetDotRaw(r2, 2215);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = GetDotStr("Position");
  ...
  L_1498:
    r3 = GetDotStr("remove");  // @src fx_player_firework.sc:166
    GetDot(r2, 0);
    Free2(r3, r2);
...
func_12()
{
    ...
    r5 = GetDotStr("World");  // @src fx_player_firework.sc:44
    SetDotRaw(r4, 2246);
    Free1(r5);
    SetDotRaw(r3, 2257);
    Free1(r4);
...
isLimfaFixed()
{
    ...
    r1 = GetDotStr("applyForce");  // @src fx_player_firework.sc:32
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
