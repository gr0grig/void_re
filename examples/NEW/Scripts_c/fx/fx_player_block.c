...
func_1()
{
    ...
    r1 = GetDotStr("!vec3");  // @src fx_player_block.sc:17
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("!vec3");  // @src fx_player_block.sc:18
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("!vec3");  // @src fx_player_block.sc:19
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
  ...
  L_0140:
    ...
    r1 = GetDotStr("setGeomParameterColor");  // @src fx_player_block.sc:28
    r2 = 0;
    r3 = "Color";
    g4 = r3;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setGeomParameterFloat");  // @src fx_player_block.sc:29
    r2 = 0;
    r3 = "Alpha";
    g4 = r6;
    GetDot(r0, 3);
  ...
  L_0288:
    ...
    r2 = GetDotStr("remove");  // @src fx_player_block.sc:37
    GetDot(r1, 0);
    Free2(r2, r1);
...
setColor()
{
    ...
    r1 = GetDotStr("setPosition");  // @src fx_player_block.sc:44
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
func_5()
{
    ...
    r1 = GetDotStr("!vec3");  // @src fx_player_block.sc:63
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
