...
func_1()
{
    ...
    r1 = GetDotStr("logInfo");  // @src fx_player_swarm.sc:43
    ...
    r0 = 0x49;
    CallExt(r0, 0);  // @patch+4 fx_player_swarm.sc:46
    r0 = 0x49;
    RawDword(0x0000004f);  // UNKNOWN opcode 0x4f
    // fx_player_swarm.sc:47
    r0 = false;  // @src fx_player_swarm.sc:47
    CallMethod(r0, 94, 0x0);  // @patch+8 fx_player_swarm.sc:48
    r0 = 0x49;
    RawDword(0x0000006d);  // UNKNOWN opcode 0x6d
    // fx_player_swarm.sc:49
    r0 = false;  // @src fx_player_swarm.sc:49
    CallMethod(r0, 117, 0x1);  // @patch+8 fx_player_swarm.sc:51
    r0 = (bool)r0;
    r0 = (float)r0;
    r0 = g2;
    ...
    CallNat(r1, 3088, 0x0);  // @src fx_player_swarm.sc:56
}
...
isSwarm()
{
    ...
    r1 = GetDotStr("logInfo");  // @src fx_player_swarm.sc:70
    r2 = "initSwarm: ";
    r3 = r_neg5;
    r3 = (as_string)r3;
    r2 = r2 + r3;
    ...
    r1 = GetDotStr("randCone");  // @src fx_player_swarm.sc:75
    g3 = r6;
    SetDotRaw(r2, 197);
    Free1(r3);
    ...
    r1 = GetDotStr("applyForce");  // @src fx_player_swarm.sc:76
    g2 = r5;
    r3 = 25.0f;
    r2 = r2 * r3;
    GetDot(r0, 1);
...
func_4()
{
    ...
    r2 = GetDotStr("World");  // @src fx_player_swarm.sc:89
    SetDotRaw(r1, 222);
    Free1(r2);
    r2 = GetDotStr("Scene");
    ...
    r5 = GetDotStr("World");  // @src fx_player_swarm.sc:90
    SetDotRaw(r4, 344);
    Free1(r5);
    SetDotRaw(r3, 355);
    Free1(r4);
  ...
  L_0300:
    ...
    r5 = GetDotStr("Scene");  // @src fx_player_swarm.sc:103
    SetDotRaw(r4, 383);
    Free1(r5);
    r6 = GetDotStr("!sphere");
  ...
  L_0520:
    r6 = GetDotStr("Scene");  // @src fx_player_swarm.sc:113
    SetDotRaw(r5, 383);
    Free1(r6);
    r7 = GetDotStr("!sphere");
  ...
  L_061c:
    r5 = GetDotStr("!vec3");  // @src fx_player_swarm.sc:116
    r6 = 0;
    r7 = 0;
    r8 = 0;
    GetDot(r4, 3);
  ...
  L_0848:
    ...
    r10 = GetDotStr("applyForce");  // @src fx_player_swarm.sc:139
    r11 = r4;
    r12 = r2;
    g13 = r3;
    r12 = r12 * r13;
  ...
  L_08f8:
    r7 = GetDotStr("Position");  // @src fx_player_swarm.sc:142
    g8 = r4;
    SetInd(r8);
    LoadFloatZero(r0);
    r1 = ASin(r1);
...
// fx_player_swarm.sc:164 (locals=8)
func_7()
{
    // fx_player_swarm.sc:151
    r3 = GetDotStr("World");  // @src fx_player_swarm.sc:151
    SetDotRaw(r2, 344);
    Free1(r3);
    SetDotRaw(r1, 355);
    Free1(r2);
    r2 = "Gesture/gesture_swarm";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    // fx_player_swarm.sc:152
    r3 = r0;  // @src fx_player_swarm.sc:152
    SetDotRaw(r2, 619);
    Free1(r3);
    SetDotRaw(r1, 630);
    Free1(r2);
    r1 = (float)r1;
    // fx_player_swarm.sc:155
    r4 = r_neg4;  // @src fx_player_swarm.sc:155
    SetDotRaw(r3, 638);
    Free1(r4);
    r4 = "onDamage";
    g5 = r0;
    ...
    r4 = r_neg4;  // @src fx_player_swarm.sc:156
    SetDotRaw(r3, 638);
    Free1(r4);
    r4 = "onCreateDebris";
    ...
    r2 = 0;  // @src fx_player_swarm.sc:159
  L_0afc:
    r3 = r2;  // @src fx_player_swarm.sc:159
    g5 = r4;
    SetDotRaw(r4, 528);
    Free1(r5);
    r3 = r3 < r4;
    ...
    g5 = r4;  // @src fx_player_swarm.sc:160
    SetDotRaw(r4, 697);
    Free1(r5);
    r5 = r2;
    r6 = "PPeriod";
    ...
    r2 = r3;
    goto L_0afc;
    // fx_player_swarm.sc:162
  L_0b80:
    g4 = r4;  // @src fx_player_swarm.sc:162
    SetDotRaw(r3, 638);
    Free1(r4);
    r4 = "remove";
    r5 = 3.0f;
    GetDot(r2, 2);
    Free3(r3, r4, r2);
    // fx_player_swarm.sc:163
    r3 = GetDotStr("remove");  // @src fx_player_swarm.sc:163
    GetDot(r2, 0);
    Free2(r3, r2);
    // fx_player_swarm.sc:164
    Free2(r0, r_neg4);  // @src fx_player_swarm.sc:164
    return r0;
}
...
func_9()
{
    ...
    r1 = GetDotStr("logInfo");  // @src fx_player_swarm.sc:62
  ...
  L_0c3c:
    ...
    goto L_0c3c;  // @src fx_player_swarm.sc:63
}
