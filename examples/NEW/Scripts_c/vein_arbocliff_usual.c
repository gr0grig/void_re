...
func_1()
{
    ...
    RawDword(0x000012e0);  // UNKNOWN opcode 0xe0
...
func_2()
{
    ...
    // vein_base.sci:83
    goto L_039c;  // @src vein_base.sci:83
    // vein_base.sci:87
  L_0390:
    CallNat2(r3, 4284, 0x200);  // @src vein_base.sci:87
    // vein_base.sci:89
  L_039c:
...
getVeinLimfaType()
{
    ...
    r1 = GetDotStr("findMaterial");  // @src vein_arbocliff_usual.sc:35
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_arbocliff_usual.sc:36
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_arbocliff_usual.sc:36
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
onHarpoon()
{
    ...
    CopyExtRd(r0, 1, 2);
    // vein_base.sci:120
    Call(r0, 0x0530);  // @src vein_base.sci:120
    // vein_base.sci:121
...
func_11()
{
    ...
    Free1(r1);
    // vein_base.sci:137
    Call(r1, 0x0530);  // @src vein_base.sci:137
    // vein_base.sci:138
  ...
  L_0684:
    ...
    // vein_base.sci:140
  L_06d8:
    goto L_0684;  // @src vein_base.sci:140
    // vein_base.sci:146
  L_06e0:
...
getVeinLimfaType()
{
  ...
  L_07e0:
    ...
    r0 = r4;
    // vein_base.sci:27
    goto L_0770;  // @src vein_base.sci:27
}
...
func_14()
{
    ...
    r1 = GetDotStr("findMaterial");  // @src vein_arbocliff_usual.sc:42
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_arbocliff_usual.sc:43
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_arbocliff_usual.sc:43
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:166
    CallNat2(r5, 2528, 0x0);  // @src vein_base.sci:166
    // vein_base.sci:167
...
func_23()
{
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:19
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:21
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:23
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:25
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:27
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("World");  // @src vein_arbocliff_usual.sc:29
    SetDotRaw(r2, 1003);
    Free1(r3);
    r3 = GetDotStr("Scene");
...
func_24()
{
    ...
    Call(r2, 0x1120);
    // vein_base.sci:161
    CallNat(r6, 4508, 0x0);  // @src vein_base.sci:161
}
...
{
    // vein_base.sci:195
    CallNat2(r5, 2528, 0x0);  // @src vein_base.sci:195
    // vein_base.sci:196
...
getVeinLimfaType()
{
  ...
  L_1218:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 749, 0x20a);  // @patch+8 vein_base.sci:186
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
    // vein_base.sci:182
    goto L_1218;  // @src vein_base.sci:182
    // vein_base.sci:180
  L_12b8:
    r2 = r1;  // @src vein_base.sci:180
    r2 = Incr(r2);
    ...
    // vein_base.sci:190
  L_12d4:
    CallNat(r6, 4508, 0x100);  // @src vein_base.sci:190
}
