...
// tree_garden2_abig.sc:73 (locals=8)
getAllowedTypes()
{
    // tree_garden2_abig.sc:58
    g0 = r15;  // @src tree_garden2_abig.sc:58
    if (r0) goto L_104c;
    // tree_garden2_abig.sc:59
    r1 = GetDotStr("!qtpair");  // @src tree_garden2_abig.sc:59
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden2_abig.sc:60
    r1 = r_neg4;  // @src tree_garden2_abig.sc:60
    if (r1) goto L_0ec0;
    // tree_garden2_abig.sc:61
    r3 = GetDotStr("World");  // @src tree_garden2_abig.sc:61
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_trunk_treeabig_dead_1.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    ...
    Free1(r1);
    // tree_garden2_abig.sc:60
    goto L_0f20;  // @src tree_garden2_abig.sc:60
    // tree_garden2_abig.sc:63
  L_0ec0:
    r3 = GetDotStr("World");  // @src tree_garden2_abig.sc:63
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_trunk_treeabig_dead.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r1 = g15;
    Free1(r1);
    // tree_garden2_abig.sc:66
  L_0f20:
    r6 = GetDotStr("World");  // @src tree_garden2_abig.sc:66
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    Free1(r5);
    ...
    Free1(r2);
    r1 = (str)r1;
    // tree_garden2_abig.sc:67
    r2 = 0;  // @src tree_garden2_abig.sc:67
  L_0f90:
    r3 = r2;  // @src tree_garden2_abig.sc:67
    g5 = r15;
    SetDotRaw(r4, 1103);
    Free1(r5);
    r3 = r3 < r4;
    if (!r3) goto L_1018;
    // tree_garden2_abig.sc:68
    g5 = r15;  // @src tree_garden2_abig.sc:68
    SetDotRaw(r4, 1116);
    Free1(r5);
    r5 = r2;
    r6 = "PSColor";
    ...
    r2 = r3;
    goto L_0f90;
    // tree_garden2_abig.sc:71
  L_1018:
    g4 = r15;  // @src tree_garden2_abig.sc:71
    SetDotRaw(r3, 1152);
    Free1(r4);
    r4 = 60000000;
    GetDot(r2, 1);
    Free2(r3, r2);
    // tree_garden2_abig.sc:58
    Free2(r1, r0);  // @src tree_garden2_abig.sc:58
    // tree_garden2_abig.sc:73
  L_104c:
    return r0;  // @src tree_garden2_abig.sc:73
}
...
// tree_garden2_abig.sc:16 (locals=7)
func_23()
{
    // tree_garden2_abig.sc:11
    g0 = r11;  // @src tree_garden2_abig.sc:11
    if (r0) goto L_2370;
    // tree_garden2_abig.sc:12
    r1 = GetDotStr("!qtpair");  // @src tree_garden2_abig.sc:12
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden2_abig.sc:13
    r3 = GetDotStr("World");  // @src tree_garden2_abig.sc:13
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_Trunk_TreeAbigFruit.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r1 = g11;
    Free1(r1);
    // tree_garden2_abig.sc:14
    r1 = r_neg4;  // @src tree_garden2_abig.sc:14
    Call(r2, 0x2374);
    // tree_garden2_abig.sc:11
    Free1(r0);  // @src tree_garden2_abig.sc:11
    // tree_garden2_abig.sc:16
  L_2370:
    return r0;  // @src tree_garden2_abig.sc:16
}

// tree_garden2_abig.sc:25 (locals=7)
func_24()
{
    // tree_garden2_abig.sc:20
    r0 = r_neg4;  // @src tree_garden2_abig.sc:20
    r6 = GetDotStr("World");
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    ...
    r0 = r0 * r1;
    r0 = (str)r0;
    // tree_garden2_abig.sc:21
    g3 = r11;  // @src tree_garden2_abig.sc:21
    SetDotRaw(r2, 1116);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_garden2_abig.sc:22
    g3 = r11;  // @src tree_garden2_abig.sc:22
    SetDotRaw(r2, 1116);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_garden2_abig.sc:23
    g3 = r11;  // @src tree_garden2_abig.sc:23
    SetDotRaw(r2, 1116);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_garden2_abig.sc:24
    g3 = r11;  // @src tree_garden2_abig.sc:24
    SetDotRaw(r2, 1116);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_garden2_abig.sc:25
    Free1(r0);  // @src tree_garden2_abig.sc:25
    return r0;
}

// tree_garden2_abig.sc:33 (locals=4)
func_25()
{
    // tree_garden2_abig.sc:29
    g0 = r12;  // @src tree_garden2_abig.sc:29
    if (r0) goto L_2550;
    // tree_garden2_abig.sc:30
    r1 = GetDotStr("!qtpair");  // @src tree_garden2_abig.sc:30
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden2_abig.sc:29
    Free1(r0);  // @src tree_garden2_abig.sc:29
    // tree_garden2_abig.sc:33
  L_2550:
    return r0;  // @src tree_garden2_abig.sc:33
}

// tree_garden2_abig.sc:40 (locals=6)
func_26()
{
    // tree_garden2_abig.sc:37
    r5 = GetDotStr("World");  // @src tree_garden2_abig.sc:37
    SetDotRaw(r4, 494);
    Free1(r5);
    SetDotRaw(r3, 505);
    Free1(r4);
    ...
    Free1(r1);
    r0 = (str)r0;
    // tree_garden2_abig.sc:38
    g1 = r8;  // @src tree_garden2_abig.sc:38
    r1 = (float)r1;
    g2 = r13;
    r2 = (float)r2;
    r1 = r1 / r2;
    // tree_garden2_abig.sc:40
    Free1(r0);  // @src tree_garden2_abig.sc:40
    return r0;
}
...
// tree_garden2_abig.sc:49 (locals=3)
func_30()
{
    // tree_garden2_abig.sc:44
    g0 = r12;  // @src tree_garden2_abig.sc:44
    if (!r0) goto L_2894;
    // tree_garden2_abig.sc:45
    g2 = r12;  // @src tree_garden2_abig.sc:45
    SetDotRaw(r1, 1152);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r0);
    // tree_garden2_abig.sc:47
  L_2894:
    g0 = r11;  // @src tree_garden2_abig.sc:47
    if (!r0) goto L_28d0;
    // tree_garden2_abig.sc:48
    g2 = r11;  // @src tree_garden2_abig.sc:48
    SetDotRaw(r1, 1152);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r0);
    // tree_garden2_abig.sc:49
  L_28d0:
    return r0;  // @src tree_garden2_abig.sc:49
}
...
// tree_garden2_abig.sc:7 (locals=1)
getHelperText()
{
    // tree_garden2_abig.sc:6
    r0 = 3;  // @src tree_garden2_abig.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
