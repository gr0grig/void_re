...
{
    // main.sc:16
    r1 = GetDotStr("!table");  // @src main.sc:16
    GetDot(r0, 0);
    Free1(r1);
    ...
    Free2(r1, r0);
    // main.sc:17
    r1 = GetDotStr("!vector");  // @src main.sc:17
    GetDot(r0, 0);
    Free1(r1);
    ...
    Free2(r2, r0);
    // main.sc:18
    r1 = GetDotStr("!vector");  // @src main.sc:18
    GetDot(r0, 0);
    Free1(r1);
    r2 = GetDotStr("Globals");
    SetDotRaw(r1, 15);
    ...
    Free2(r2, r0);
    // main.sc:19
    r1 = GetDotStr("!vector");  // @src main.sc:19
    GetDot(r0, 0);
    Free1(r1);
    r2 = GetDotStr("Globals");
    SetDotRaw(r1, 15);
    ...
    CopyExtRd(r0, 6, 1);
    // main.sc:22
    r1 = GetDotStr("createWorld");  // @src main.sc:22
    r2 = "test.xml";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // main.sc:24
    r1 = GetDotStr("!customLoop");  // @src main.sc:24
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // main.sc:25
    r2 = GetDotStr("runScript");  // @src main.sc:25
    r3 = "loading";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    ...
    // main.sc:31
    r2 = GetDotStr("hasVariable");  // @src main.sc:31
    r3 = "post_effect";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_04e4;
    // main.sc:32
    r2 = GetDotStr("logInfo");  // @src main.sc:32
    r3 = "Post-effect enabled";
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // main.sc:33
    r2 = GetDotStr("splitString");  // @src main.sc:33
    ...
    Free2(r3, r2);
    // main.sc:39
    r3 = GetDotStr("hasVariable");  // @src main.sc:39
    r4 = "post_effect_fp";
    GetDot(r2, 1);
    Free2(r3, r4);
    if (!r2) goto L_04e0;
    // main.sc:40
    r3 = GetDotStr("getVariable");  // @src main.sc:40
    r4 = "post_effect_fp";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
    ...
    if (!r3) goto L_04dc;
    // main.sc:42
    r5 = GetDotStr("toBool");  // @src main.sc:42
    r6 = r2;
    r6 = (as_string)r6;
    GetDot(r4, 1);
    Free2(r5, r6);
  ...
  L_04e4:
    ...
    Free4(r2, r3, r4, r1);
    // main.sc:47
    r2 = GetDotStr("hasVariable");  // @src main.sc:47
    r3 = "Shadows";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_0654;
    // main.sc:48
    r2 = GetDotStr("toInt");  // @src main.sc:48
    r4 = GetDotStr("getVariable");
    r5 = "Shadows";
    GetDot(r3, 1);
    Free2(r4, r5);
  ...
  L_0654:
    ...
    // main.sc:59
  L_06e0:
    r3 = GetDotStr("!qtpair");  // @src main.sc:59
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    r1 = r2;
  ...
  L_0704:
    ...
    if (r2) goto L_09a4;
    // main.sc:65
    r3 = GetDotStr("getVariable");  // @src main.sc:65
    r4 = "Mode";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (as_string)r2;
    ...
    if (!r3) goto L_0868;
    // main.sc:67
    r4 = GetDotStr("logInfo");  // @src main.sc:67
    r5 = "Mode: fly";
    GetDot(r3, 1);
    Free3(r4, r5, r3);
    // main.sc:68
    r4 = GetDotStr("createSpectatorCamera");  // @src main.sc:68
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    CopyExtRd(r3, 3, 1);
    ...
    r0 = "";  // len=54, pool_off=0x998, GARBLED  // @patch+4 main.sc:66
    // main.sc:73
  L_0868:
    ...
    if (!r3) goto L_0998;
    // main.sc:74
    r4 = GetDotStr("logInfo");  // @src main.sc:74
    r5 = "Mode: walk";
    GetDot(r3, 1);
    Free3(r4, r5, r3);
    // main.sc:75
    ...
    Free1(r3);
    // main.sc:76
    r4 = GetDotStr("createAttachedCamera");  // @src main.sc:76
    CopyExtWr(r5, 7, 1);
    SetDotRaw(r6, 674);
    Free1(r7);
    r7 = "camera";
  ...
  L_0b18:
    ...
    Free3(r5, r6, r4);
    // main.sc:99
    r5 = GetDotStr("setSoundListenerParameters");  // @src main.sc:99
    r7 = r3;
    SetDotRaw(r6, 582);
    Free1(r7);
    r8 = r3;
    ...
    Free4(r5, r6, r7, r4);
    // main.sc:101
    r5 = GetDotStr("isKeyPressed");  // @src main.sc:101
    r6 = 19;
    GetDot(r4, 1);
    Free1(r5);
    if (!r4) goto L_0e00;
  ...
  L_0df0:
    ...
    // main.sc:109
  L_0e00:
    r5 = GetDotStr("isKeyPressed");  // @src main.sc:109
    r6 = 20;
    GetDot(r4, 1);
    Free1(r5);
    if (!r4) goto L_0fc8;
...
func_3()
{
    ...
    Free3(r1, r2, r0);
    // main.sc:129
    r1 = GetDotStr("flushDebugRender");  // @src main.sc:129
    CopyExtWr(r2, 2, 1);
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // main.sc:130
...
func_6()
{
  ...
  L_1324:
    ...
    // main.sc:154
  L_13a4:
    r2 = GetDotStr("!tuple");  // @src main.sc:154
    r3 = "Wrong number of parameters";
    r4 = GetDotStr("ConsoleColorError");
    GetDot(r1, 2);
    Free3(r2, r3, r4);
    r1 = (str)r1;
    r_neg6 = r1;
  ...
  L_13ec:
    ...
    if (r1) goto L_1444;
    // main.sc:158
    r2 = GetDotStr("!tuple");  // @src main.sc:158
    r3 = "Invalid regex";
    r4 = GetDotStr("ConsoleColorError");
    GetDot(r1, 2);
    Free3(r2, r3, r4);
  ...
  L_144c:
    ...
    if (!r2) goto L_14c4;
    // main.sc:161
    r3 = GetDotStr("logInfo");  // @src main.sc:161
    r5 = r0;
    r6 = r1;
    SetDot(r4, 1);
    r4 = (as_string)r4;
  ...
  L_15b0:
    ...
    // main.sc:182
  L_1604:
    r1 = GetDotStr("!lookAt");  // @src main.sc:182
    CopyExtWr(r7, 2, 1);
    r4 = GetDotStr("!vec3");
    r5 = 0;
