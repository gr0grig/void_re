...
func_2()
{
    ...
    r1 = GetDotStr("!qtpair");  // @src camera_player_die.sc:16
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g0;
...
func_3()
{
  ...
  L_00f0:
    r2 = GetDotStr("!rotateX");  // @src camera_player_die.sc:29
    ...
    r3 = GetDotStr("!rotateY");  // @src camera_player_die.sc:30
    ...
    r4 = GetDotStr("!rotateZ");  // @src camera_player_die.sc:31
    ...
    r5 = GetDotStr("!lookAt");  // @src camera_player_die.sc:35
    r7 = r_neg5;
    SetDotRaw(r6, 8);
    Free1(r7);
    r9 = r_neg4;
