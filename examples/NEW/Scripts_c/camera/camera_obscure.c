...
_getAnimationLength()
{
    ...
    r1 = GetDotStr("loadAnimationSet");  // @src camera_obscure.sc:49
  ...
  L_00b0:
    ...
    r2 = GetDotStr("!vector");  // @src camera_obscure.sc:56
    GetDot(r1, 0);
    Free1(r2);
    g2 = r0;
    r3 = r0;
  ...
  L_0104:
    ...
    r4 = GetDotStr("canPlayAnimation");  // @src camera_obscure.sc:62
    r5 = r2;
    GetDot(r3, 1);
    Free2(r4, r5);
    if (r3) goto L_0158;
  ...
  L_0158:
    r4 = GetDotStr("playAnimation");  // @src camera_obscure.sc:66
    r5 = r2;
    GetDot(r3, 1);
    Free2(r4, r5);
    r3 = (str)r3;
  ...
  L_01f8:
    ...
    r2 = GetDotStr("logError");  // @src camera_obscure.sc:72
  ...
  L_0278:
    r2 = GetDotStr("logInfo");  // @src camera_obscure.sc:76
    ...
    r2 = GetDotStr("!vector");  // @src camera_obscure.sc:78
    GetDot(r1, 0);
    Free1(r2);
    g2 = r1;
    r3 = r0;
  ...
  L_0320:
    ...
    r4 = GetDotStr("canPlayAnimation");  // @src camera_obscure.sc:84
    r5 = r2;
    GetDot(r3, 1);
    Free2(r4, r5);
    if (r3) goto L_0374;
  ...
  L_0374:
    r4 = GetDotStr("playAnimation");  // @src camera_obscure.sc:88
    r5 = r2;
    GetDot(r3, 1);
    Free2(r4, r5);
    r3 = (str)r3;
  ...
  L_0414:
    ...
    r2 = GetDotStr("logError");  // @src camera_obscure.sc:94
  ...
  L_0494:
    r2 = GetDotStr("logInfo");  // @src camera_obscure.sc:98
  ...
  L_057c:
    ...
    r2 = GetDotStr("logError");  // @src camera_obscure.sc:101
...
func_7()
{
  ...
  L_0760:
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:124
    r2 = "camera_girl_talk";
    CopyExtWr(r0, 3, 2);
    r4 = 1;
    r3 = r3 + r4;
...
func_8()
{
    ...
    r1 = GetDotStr("!vector");  // @src camera_obscure.sc:305
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
  ...
  L_092c:
    r2 = GetDotStr("!vector");  // @src camera_obscure.sc:310
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
...
onTalk()
{
    ...
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:357
...
onTalkEnd()
{
  ...
  L_0d58:
    ...
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:209
    r2 = "camera_girl_talk";
    CopyExtWr(r2, 3, 5);
    r4 = 1;
    r3 = r3 + r4;
  ...
  L_0e04:
    ...
    r2 = GetDotStr("playAnimation");  // @src camera_obscure.sc:214
    r3 = "camera_girl_talk";
    CopyExtWr(r2, 4, 5);
    r5 = 1;
    r4 = r4 + r5;
...
_getAnimationLength()
{
  ...
  L_1004:
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:198
    r2 = "camera_girl_talk";
    CopyExtWr(r2, 3, 5);
    r4 = 1;
    r3 = r3 + r4;
...
_getAnimationLength()
{
    ...
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:380
...
func_20()
{
    ...
    r1 = GetDotStr("playAnimation");  // @src camera_obscure.sc:10
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
