...
// @version: 0
// @globals: 15 types=03 03 03 03 03 00 01 01 01 01 01 03 03 01 03
...
func_1()
{
  ...
  L_0660:
    ...
    r3 = g9;
    // tree_base.sci:184
    CallNat(r3, 14236, 0x300);  // @src tree_base.sci:184
}
...
// treeonlysprout.sc:35 (locals=0)
getAllowedTypes()
{
    // treeonlysprout.sc:35
    return r0;  // @src treeonlysprout.sc:35
}
...
func_9()
{
    ...
    // tree_base.sci:478
  L_0f3c:
    goto L_0f74;  // @src tree_base.sci:478
    // tree_base.sci:493
  L_0f44:
...
func_21()
{
  ...
  L_1ac4:
    ...
    if (!r3) goto L_1b04;
    // tree_base.sci:415
    Call(r3, 0x2084);  // @src tree_base.sci:415
    // tree_base.sci:416
    Call(r3, 0x2090);  // @src tree_base.sci:416
    // tree_base.sci:413
    goto L_1b04;  // @src tree_base.sci:413
    // tree_base.sci:422
  L_1b04:
  ...
  L_1ce4:
    ...
    r5 = r8;
    // tree_base.sci:433
    goto L_1dbc;  // @src tree_base.sci:433
    // tree_base.sci:445
  L_1da0:
  ...
  L_1dbc:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:456
    Call(r8, 0x2090);  // @src tree_base.sci:456
    // tree_base.sci:429
  ...
  L_1ff4:
    ...
    // tree_base.sci:424
  L_2028:
    goto L_1b18;  // @src tree_base.sci:424
}
...
func_32()
{
    ...
    Free2(r3, r1);
    // gameplay.sci:1038
    goto L_24e4;  // @src gameplay.sci:1038
    // gameplay.sci:1043
  L_24b4:
...
func_33()
{
  ...
  L_2780:
    ...
    if (!r6) goto L_2988;
    // tree_base.sci:233
    Call(r6, 0x2c64);  // @src tree_base.sci:233
    // tree_base.sci:234
  L_2988:
    ...
    if (!r6) goto L_29b4;
    // tree_base.sci:235
    Call(r6, 0x2cd4);  // @src tree_base.sci:235
    // tree_base.sci:234
    goto L_29bc;  // @src tree_base.sci:234
    // tree_base.sci:237
  L_29b4:
    Call(r6, 0x2d44);  // @src tree_base.sci:237
    // tree_base.sci:239
  L_29bc:
...
isWaitable()
{
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:309
    goto L_3370;  // @src tree_base.sci:309
    // tree_base.sci:314
  L_3064:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:314
    goto L_3370;  // @src tree_base.sci:314
    // tree_base.sci:319
  L_312c:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:319
    goto L_3370;  // @src tree_base.sci:319
    // tree_base.sci:324
  L_31f4:
  ...
  L_3370:
    ...
    Call(r1, 0x2078);
    // tree_base.sci:337
    Call(r1, 0x3684);  // @src tree_base.sci:337
    // tree_base.sci:339
  ...
  L_3534:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:347
    goto L_3534;  // @src tree_base.sci:347
    // tree_base.sci:355
  L_3670:
