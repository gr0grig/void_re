...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @src gen_sound2dlooped.sc:6
    r0 = (str)r0;
    // gen_sound2dlooped.sc:8
    r2 = GetDotStr("loadSound");  // @src gen_sound2dlooped.sc:8
    r4 = r0;
    SetDotRaw(r3, 15);
    Free1(r4);
    GetDot(r1, 1);
    ...
    r3 = GetDotStr("Scene");  // @src gen_sound2dlooped.sc:11
    r3 = (str)r3;
    r4 = r1;
    r5 = "Sound";
    r7 = r0;
...
func_2()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:219
    r6 = GetDotStr("Globals");  // @src ..\sound.sci:219
    SetDotRaw(r5, 80);
    Free1(r6);
    r6 = r_neg5;
    SetDot(r4, 1);
