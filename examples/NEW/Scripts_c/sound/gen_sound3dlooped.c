...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @src gen_sound3dlooped.sc:6
    r0 = (str)r0;
    // gen_sound3dlooped.sc:8
    r2 = GetDotStr("loadSound3D");  // @src gen_sound3dlooped.sc:8
    r4 = r0;
    SetDotRaw(r3, 23);
    Free1(r4);
    GetDot(r1, 1);
...
// ..\sound.sci:321 (locals=9)
func_2()
{
    // ..\sound.sci:317
    r1 = "Master";  // @src ..\sound.sci:317
    Call(r2, 0x01e0);
    r2 = r_neg5;
    Call(r3, 0x01e0);
    r0 = r0 * r1;
    // ..\sound.sci:318
    r2 = GetDotStr("playSound3DLooped");  // @src ..\sound.sci:318
    r3 = r_neg9;
    r4 = r_neg8;
    r5 = r_neg7;
    r6 = r_neg6;
    ...
    r1 = (str)r1;
    // ..\sound.sci:319
    r6 = GetDotStr("Globals");  // @src ..\sound.sci:319
    SetDotRaw(r5, 114);
    Free1(r6);
    r6 = r_neg5;
    SetDot(r4, 1);
