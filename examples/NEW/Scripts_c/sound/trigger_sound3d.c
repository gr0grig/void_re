...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @src trigger_sound3d.sc:13
    r0 = (str)r0;
    r0 = g0;
    Free1(r0);
    ...
    r1 = GetDotStr("!vector");  // @src trigger_sound3d.sc:18
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g1;
  ...
  L_0244:
    r2 = GetDotStr("remove");  // @src trigger_sound3d.sc:38
    GetDot(r1, 0);
    Free2(r2, r1);
...
func_7()
{
    ...
    r1 = GetDotStr("remove");  // @src trigger_sound3d.sc:47
    GetDot(r0, 0);
    Free2(r1, r0);
