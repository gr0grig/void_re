...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @src trigger_sound2d.sc:11
    r0 = (str)r0;
    r0 = g0;
    Free1(r0);
    ...
    if (r0) goto L_005c;
    r1 = GetDotStr("remove");  // @src trigger_sound2d.sc:12
    GetDot(r0, 0);
    Free2(r1, r0);
  ...
  L_007c:
    r1 = GetDotStr("!vector");  // @src trigger_sound2d.sc:19
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g1;
  ...
  L_0100:
    ...
    r2 = GetDotStr("self");  // @src trigger_sound2d.sc:29
    r2 = (str)r2;
    Call(r3, 0x027c);
    r2 = 0;
    SetDot(r0, 1);
    ...
    r1 = GetDotStr("Scene");  // @src trigger_sound2d.sc:30
    r1 = (str)r1;
    g3 = r1;
  ...
  L_020c:
    r1 = GetDotStr("remove");  // @src trigger_sound2d.sc:37
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_3()
{
    ...
    // ../std.sci:1092
  L_02ac:
    Call(r1, 0x022c);  // @src ../std.sci:1092
    // ../std.sci:1093
...
func_8()
{
    ...
    r1 = GetDotStr("remove");  // @src trigger_sound2d.sc:46
    GetDot(r0, 0);
    Free2(r1, r0);
