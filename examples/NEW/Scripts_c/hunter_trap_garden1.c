...
func_1()
{
    ...
    r2 = GetDotStr("Scene");  // @src hunter_trap_garden1.sc:39
    SetDotRaw(r1, 6);
    Free1(r2);
  ...
  L_0100:
    CallNat(r2, 2748, 0x0);  // @src hunter_trap_garden1.sc:45
}

// hunter_trap_garden1.sc:95 (locals=1)
getUseDistance()
{
    // hunter_trap_garden1.sc:94
    r0 = true;  // @src hunter_trap_garden1.sc:94
    r_neg4 = r0;
    return r0;
}

// hunter_trap_garden1.sc:114 (locals=9)
func_3()
{
    // hunter_trap_garden1.sc:99
    r2 = GetDotStr("loadSound3D");  // @src hunter_trap_garden1.sc:99
    ...
    r0 = g2;
    Free1(r0);
    // hunter_trap_garden1.sc:100
    g0 = r2;  // @src hunter_trap_garden1.sc:100
    Call(r1, 0x04f0);
    // hunter_trap_garden1.sc:102
    r1 = GetDotStr("!qtpair");  // @src hunter_trap_garden1.sc:102
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // hunter_trap_garden1.sc:104
    r3 = GetDotStr("World");  // @src hunter_trap_garden1.sc:104
    SetDotRaw(r2, 175);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r1 = g0;
    Free1(r1);
    // hunter_trap_garden1.sc:106
    g3 = r1;  // @src hunter_trap_garden1.sc:106
    SetDotRaw(r2, 53);
    Free1(r3);
  ...
  L_02d0:
    ...
    r3 = r1;  // @src hunter_trap_garden1.sc:108
    Call(r4, 0x053c);
    // hunter_trap_garden1.sc:109
    r3 = 0;  // @src hunter_trap_garden1.sc:109
  L_02ec:
    r4 = r3;  // @src hunter_trap_garden1.sc:109
    r5 = 3;
    r4 = r4 < r5;
    if (!r4) goto L_0368;
    // hunter_trap_garden1.sc:110
    g6 = r0;  // @src hunter_trap_garden1.sc:110
    SetDotRaw(r5, 281);
    Free1(r6);
    r6 = r3;
    r7 = "PSColor";
  ...
  L_0368:
    r3 = r_neg4;  // @src hunter_trap_garden1.sc:112
    if (!r3) goto L_03a4;
    // hunter_trap_garden1.sc:113
    g5 = r0;  // @src hunter_trap_garden1.sc:113
    SetDotRaw(r4, 317);
    Free1(r5);
    r5 = 25000000;
    GetDot(r3, 1);
    Free2(r4, r3);
    // hunter_trap_garden1.sc:114
  L_03a4:
    Free2(r2, r0);  // @src hunter_trap_garden1.sc:114
    return r0;
}
...
func_7()
{
    ...
    r5 = GetDotStr("World");  // @src hunter_trap_garden1.sc:32
    SetDotRaw(r4, 455);
    Free1(r5);
    SetDotRaw(r3, 466);
    Free1(r4);
...
// hunter_trap_garden1.sc:87 (locals=11)
getUseDistance()
{
  ...
  L_062c:
    ...
    r4 = GetDotStr("Scene");  // @src hunter_trap_garden1.sc:68
    r4 = (str)r4;
    ...
    // hunter_trap_garden1.sc:65
    goto L_07b0;  // @src hunter_trap_garden1.sc:65
    // hunter_trap_garden1.sc:74
  L_0764:
    r4 = GetDotStr("Scene");  // @src hunter_trap_garden1.sc:74
    r4 = (str)r4;
    r6 = GetDotStr("loadSound");
    ...
    Call(r7, 0x099c);
    Free1(r3);
    // hunter_trap_garden1.sc:78
  L_07b0:
    r3 = r0;  // @src hunter_trap_garden1.sc:78
    r4 = r2;
    r3 = r3 - r4;
    g4 = r1;
    r5 = "HunterTrapLimfa";
    ...
    r5 = GetDotStr("World");  // @src hunter_trap_garden1.sc:81
    SetDotRaw(r4, 6);
    Free1(r5);
    r5 = "getPlayerEntity";
    GetDot(r3, 1);
    ...
    GetDotRaw(r5, 1025);
    Free2(r6, r4);
    // hunter_trap_garden1.sc:83
    r7 = r3;  // @src hunter_trap_garden1.sc:83
    SetDotRaw(r6, 455);
    Free1(r7);
    SetDotRaw(r5, 636);
    Free1(r6);
    ...
    GetDotRaw(r5, 1025);
    Free2(r6, r4);
    // hunter_trap_garden1.sc:85
    r6 = GetDotStr("Scene");  // @src hunter_trap_garden1.sc:85
    SetDotRaw(r5, 6);
    Free1(r6);
    ...
    Free1(r3);  // @src hunter_trap_garden1.sc:80
    // hunter_trap_garden1.sc:87
    Free1(r_neg6);  // @src hunter_trap_garden1.sc:87
    return r0;
}
...
onUse()
{
    ...
    r1 = GetDotStr("callDef");  // @src hunter_trap_garden1.sc:17
    r2 = false;
    r3 = "isActive";
    GetDot(r0, 2);
    Free2(r1, r3);
  ...
  L_0b44:
    r3 = GetDotStr("Scene");  // @src hunter_trap_garden1.sc:21
    SetDotRaw(r2, 6);
    Free1(r3);
  ...
  L_0be0:
    r4 = GetDotStr("!tuple");  // @src hunter_trap_garden1.sc:27
    r5 = r2;
    r7 = r1;
    SetDotRaw(r6, 484);
    Free1(r7);
