...
fadeOut()
{
    ...
    r0 = 0x49;
    Free3(r0, r579, r0);  // @patch+4 fadeable.sc:58
    RawDword(0x00000250);  // UNKNOWN opcode 0x50
    r0 = 0x41;  // @patch+4 fadeable.sc:59
}
...
fadeIn()
{
    ...
    r0 = 73;
    Free3(r0, r323, r0);  // @patch+4 fadeable.sc:105
    RawDword(0x000000fc);  // UNKNOWN opcode 0xfc
    r0 = 0x41;  // @patch+4 fadeable.sc:106
}
...
func_4()
{
    ...
    if (!r0) goto L_0170;
    // fadeable.sc:42
    r0 = GetDotStr("GeomTransparency");  // @src fadeable.sc:42
    g1 = r0;
    Free1(r4);
    RetV(r3);
    r3 = (int)r3;
    ...
    // fadeable.sc:46
  L_0170:
    r1 = GetDotStr("!vec3");  // @src fadeable.sc:46
    GetDot(r0, 0);
    Free1(r1);
    CallMethod(r0, 90, 0x4a);
    // fadeable.sc:47
    r1 = GetDotStr("!vec3");  // @src fadeable.sc:47
    GetDot(r0, 0);
    Free1(r1);
...
{
    // fadeable.sc:119
    r1 = GetDotStr("setTransform");  // @src fadeable.sc:119
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // fadeable.sc:120
...
func_9()
{
    // fadeable.sc:89
  L_0258:
    r0 = GetDotStr("GeomTransparency");  // @src fadeable.sc:89
    r1 = 1;
    r0 = r0 < r1;
    if (!r0) goto L_02b4;
    // fadeable.sc:90
    r0 = GetDotStr("GeomTransparency");  // @src fadeable.sc:90
    g1 = r0;
    Free1(r4);
    RetV(r3);
    r3 = (int)r3;
...
{
    // fadeable.sc:72
    r1 = GetDotStr("setTransform");  // @src fadeable.sc:72
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // fadeable.sc:73
