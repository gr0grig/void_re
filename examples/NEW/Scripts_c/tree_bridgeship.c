...
func_1()
{
  ...
  L_0660:
    ...
    r3 = g9;
    // tree_base.sci:184
    CallNat(r3, 15500, 0x300);  // @src tree_base.sci:184
}
...
// tree_bridgeship.sc:78 (locals=8)
getAllowedTypes()
{
    // tree_bridgeship.sc:63
    g0 = r15;  // @src tree_bridgeship.sc:63
    if (r0) goto L_104c;
    // tree_bridgeship.sc:64
    r1 = GetDotStr("!qtpair");  // @src tree_bridgeship.sc:64
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_bridgeship.sc:65
    r1 = r_neg4;  // @src tree_bridgeship.sc:65
    if (r1) goto L_0ec0;
    // tree_bridgeship.sc:66
    r3 = GetDotStr("World");  // @src tree_bridgeship.sc:66
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_bridgeship_tree_dead_1.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    ...
    Free1(r1);
    // tree_bridgeship.sc:65
    goto L_0f20;  // @src tree_bridgeship.sc:65
    // tree_bridgeship.sc:68
  L_0ec0:
    r3 = GetDotStr("World");  // @src tree_bridgeship.sc:68
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_bridgeship_tree_dead.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r1 = g15;
    Free1(r1);
    // tree_bridgeship.sc:71
  L_0f20:
    r6 = GetDotStr("World");  // @src tree_bridgeship.sc:71
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    Free1(r5);
    ...
    Free1(r2);
    r1 = (str)r1;
    // tree_bridgeship.sc:72
    r2 = 0;  // @src tree_bridgeship.sc:72
  L_0f90:
    r3 = r2;  // @src tree_bridgeship.sc:72
    g5 = r15;
    SetDotRaw(r4, 1107);
    Free1(r5);
    r3 = r3 < r4;
    if (!r3) goto L_1018;
    // tree_bridgeship.sc:73
    g5 = r15;  // @src tree_bridgeship.sc:73
    SetDotRaw(r4, 1120);
    Free1(r5);
    r5 = r2;
    r6 = "PSColor";
    ...
    r2 = r3;
    goto L_0f90;
    // tree_bridgeship.sc:76
  L_1018:
    g4 = r15;  // @src tree_bridgeship.sc:76
    SetDotRaw(r3, 1156);
    Free1(r4);
    r4 = 60000000;
    GetDot(r2, 1);
    Free2(r3, r2);
    // tree_bridgeship.sc:63
    Free2(r1, r0);  // @src tree_bridgeship.sc:63
    // tree_bridgeship.sc:78
  L_104c:
    return r0;  // @src tree_bridgeship.sc:78
}
...
func_21()
{
  ...
  L_1d04:
    ...
    // tree_base.sci:416
    Call(r3, 0x2514);  // @src tree_base.sci:416
    // tree_base.sci:413
  ...
  L_1ffc:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:456
    Call(r8, 0x2514);  // @src tree_base.sci:456
    // tree_base.sci:429
...
// tree_bridgeship.sc:16 (locals=7)
func_23()
{
    // tree_bridgeship.sc:11
    g0 = r11;  // @src tree_bridgeship.sc:11
    if (r0) goto L_2370;
    // tree_bridgeship.sc:12
    r1 = GetDotStr("!qtpair");  // @src tree_bridgeship.sc:12
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_bridgeship.sc:13
    r3 = GetDotStr("World");  // @src tree_bridgeship.sc:13
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_bridgeship_treefruit.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r1 = g11;
    Free1(r1);
    // tree_bridgeship.sc:14
    r1 = r_neg4;  // @src tree_bridgeship.sc:14
    Call(r2, 0x2374);
    // tree_bridgeship.sc:11
    Free1(r0);  // @src tree_bridgeship.sc:11
    // tree_bridgeship.sc:16
  L_2370:
    return r0;  // @src tree_bridgeship.sc:16
}

// tree_bridgeship.sc:25 (locals=7)
func_24()
{
    // tree_bridgeship.sc:20
    r0 = r_neg4;  // @src tree_bridgeship.sc:20
    r6 = GetDotStr("World");
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    ...
    r0 = r0 * r1;
    r0 = (str)r0;
    // tree_bridgeship.sc:21
    g3 = r11;  // @src tree_bridgeship.sc:21
    SetDotRaw(r2, 1120);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_bridgeship.sc:22
    g3 = r11;  // @src tree_bridgeship.sc:22
    SetDotRaw(r2, 1120);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_bridgeship.sc:23
    g3 = r11;  // @src tree_bridgeship.sc:23
    SetDotRaw(r2, 1120);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_bridgeship.sc:24
    g3 = r11;  // @src tree_bridgeship.sc:24
    SetDotRaw(r2, 1120);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
    ...
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // tree_bridgeship.sc:25
    Free1(r0);  // @src tree_bridgeship.sc:25
    return r0;
}

// tree_bridgeship.sc:36 (locals=0)
func_25()
{
    // tree_bridgeship.sc:36
    return r0;  // @src tree_bridgeship.sc:36
}

// tree_bridgeship.sc:45 (locals=0)
func_26()
{
    // tree_bridgeship.sc:45
    return r0;  // @src tree_bridgeship.sc:45
}
...
// tree_bridgeship.sc:54 (locals=3)
func_30()
{
    // tree_bridgeship.sc:49
    g0 = r12;  // @src tree_bridgeship.sc:49
    if (!r0) goto L_27cc;
    // tree_bridgeship.sc:50
    g2 = r12;  // @src tree_bridgeship.sc:50
    SetDotRaw(r1, 1156);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r0);
    // tree_bridgeship.sc:52
  L_27cc:
    g0 = r11;  // @src tree_bridgeship.sc:52
    if (!r0) goto L_2808;
    // tree_bridgeship.sc:53
    g2 = r11;  // @src tree_bridgeship.sc:53
    SetDotRaw(r1, 1156);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r0);
    // tree_bridgeship.sc:54
  L_2808:
    return r0;  // @src tree_bridgeship.sc:54
}
...
func_32()
{
    ...
    Free2(r3, r1);
    // gameplay.sci:1038
    goto L_29d4;  // @src gameplay.sci:1038
    // gameplay.sci:1043
  L_29a4:
...
func_33()
{
  ...
  L_2c70:
    ...
    SetInd(r5);
    r0 = null_str;
    RawDword(0x00000895);  // UNKNOWN opcode 0x95
    Free1(r5);
    // tree_base.sci:229
    ...
    if (!r6) goto L_2e78;
    // tree_base.sci:233
    Call(r6, 0x3154);  // @src tree_base.sci:233
    // tree_base.sci:234
  L_2e78:
    ...
    if (!r6) goto L_2ea4;
    // tree_base.sci:235
    Call(r6, 0x31c4);  // @src tree_base.sci:235
    // tree_base.sci:234
    goto L_2eac;  // @src tree_base.sci:234
    // tree_base.sci:237
  L_2ea4:
    Call(r6, 0x3234);  // @src tree_base.sci:237
    // tree_base.sci:239
  L_2eac:
...
isWaitable()
{
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:309
    goto L_3860;  // @src tree_base.sci:309
    // tree_base.sci:314
  L_3554:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:314
    goto L_3860;  // @src tree_base.sci:314
    // tree_base.sci:319
  L_361c:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:319
    goto L_3860;  // @src tree_base.sci:319
    // tree_base.sci:324
  L_36e4:
  ...
  L_3860:
    ...
    Call(r1, 0x22b8);
    // tree_base.sci:337
    Call(r1, 0x3b74);  // @src tree_base.sci:337
    // tree_base.sci:339
  ...
  L_3a24:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:347
    goto L_3a24;  // @src tree_base.sci:347
    // tree_base.sci:355
  L_3b60:
...
// tree_bridgeship.sc:7 (locals=1)
getHelperText()
{
    // tree_bridgeship.sc:6
    r0 = 3;  // @src tree_bridgeship.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
