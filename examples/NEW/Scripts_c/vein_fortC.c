...
// vein_fortC.sc:12 (locals=3)
func_2()
{
    // vein_fortC.sc:7
    r1 = GetDotStr("!geometryCache");  // @src vein_fortC.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // vein_fortC.sc:8
    g2 = r9;  // @src vein_fortC.sc:8
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fortC_part1.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fortC.sc:9
    g2 = r9;  // @src vein_fortC.sc:9
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fortC_part2.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fortC.sc:10
    g2 = r9;  // @src vein_fortC.sc:10
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fortC_part3.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fortC.sc:11
    g2 = r9;  // @src vein_fortC.sc:11
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fortC_part4.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fortC.sc:12
    return r0;  // @src vein_fortC.sc:12
}
...
// vein_fortC.sc:31 (locals=6)
func_4()
{
    // vein_fortC.sc:29
    r1 = GetDotStr("findMaterial");  // @src vein_fortC.sc:29
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortC.sc:30
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_fortC.sc:30
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // vein_fortC.sc:31
    Free1(r_neg4);  // @src vein_fortC.sc:31
    return r0;
}
...
// vein_fortC.sc:38 (locals=9)
func_15()
{
    // vein_fortC.sc:36
    r1 = GetDotStr("findMaterial");  // @src vein_fortC.sc:36
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortC.sc:37
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_fortC.sc:37
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
    ...
    Free3(r2, r4, r1);
    // vein_fortC.sc:38
    return r0;  // @src vein_fortC.sc:38
}
...
// vein_fortC.sc:25 (locals=7)
func_24()
{
    // vein_fortC.sc:16
    r0 = null_str2;  // @src vein_fortC.sc:16
    // vein_fortC.sc:17
    r3 = GetDotStr("World");  // @src vein_fortC.sc:17
    SetDotRaw(r2, 819);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_fortC_part1.pre";
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:19
    r3 = GetDotStr("World");  // @src vein_fortC.sc:19
    SetDotRaw(r2, 819);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_fortC_part2.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:21
    r3 = GetDotStr("World");  // @src vein_fortC.sc:21
    SetDotRaw(r2, 819);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_fortC_part3.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:23
    r3 = GetDotStr("World");  // @src vein_fortC.sc:23
    SetDotRaw(r2, 819);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_fortC_part4.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:25
    Free2(r0, r_neg4);  // @src vein_fortC.sc:25
    return r0;
}
...
func_28()
{
  ...
  L_1080:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 565, 0x20a);  // @patch+8 vein_base.sci:186
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
