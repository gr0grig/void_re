...
initTriggerByGroup()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_0_3_rooftop.sc:20
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getNahodka";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("remove");  // @src surface_exit_0_3_rooftop.sc:23
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_4()
{
    ...
    r1 = GetDotStr("call");  // @src surface_exit_0_3_rooftop.sc:31
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_0_3_rooftop.sc:30
  ...
  L_011c:
    r1 = GetDotStr("remove");  // @src surface_exit_0_3_rooftop.sc:33
    GetDot(r0, 0);
    Free2(r1, r0);
