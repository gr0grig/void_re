...
onTriggerPlayer()
{
    ...
    r1 = GetDotStr("trace");  // @src surface_exit_2_tunnel.sc:7
...
func_3()
{
    ...
    r1 = GetDotStr("trace");  // @src surface_exit_2_tunnel.sc:12
    r2 = "Activate: pool pigeons";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_2_tunnel.sc:14
    r2 = GetDotStr("Scene");  // @src surface_exit_2_tunnel.sc:14
    SetDotRaw(r1, 106);
    Free1(r2);
    r2 = "createNahodkaAt";
    r3 = "pt_2_1";
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_2_tunnel.sc:17
    SetDotRaw(r1, 153);
    Free1(r2);
    ...
    r3 = GetDotStr("World");  // @src surface_exit_2_tunnel.sc:18
    SetDotRaw(r2, 213);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("remove");  // @src surface_exit_2_tunnel.sc:21
    GetDot(r2, 0);
    Free2(r3, r2);
