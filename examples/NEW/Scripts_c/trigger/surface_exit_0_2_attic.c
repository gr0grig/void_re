...
onTimer()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_0_2_attic.sc:21
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getNahodka";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("setTimer");  // @src surface_exit_0_2_attic.sc:23
    r2 = 0;
    r3 = 5000000;
    GetDot(r0, 2);
    Free2(r1, r0);
    // surface_exit_0_2_attic.sc:26
    r2 = GetDotStr("Scene");  // @src surface_exit_0_2_attic.sc:26
    SetDotRaw(r1, 74);
    Free1(r2);
    r2 = "pt_pigeon_blast";
    GetDot(r0, 1);
    ...
    r3 = GetDotStr("World");  // @src surface_exit_0_2_attic.sc:27
    SetDotRaw(r2, 130);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r4 = GetDotStr("Scene");  // @src surface_exit_0_2_attic.sc:30
    SetDotRaw(r3, 74);
    Free1(r4);
    ...
    r4 = GetDotStr("World");  // @src surface_exit_0_2_attic.sc:31
    SetDotRaw(r3, 130);
    Free1(r4);
    r4 = GetDotStr("Scene");
...
initTriggerByGroup()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_0_2_attic.sc:38
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "createNahodkaAt";
    r3 = "pt_0_3";
    ...
    r1 = GetDotStr("remove");  // @src surface_exit_0_2_attic.sc:39
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_5()
{
    ...
    r1 = GetDotStr("call");  // @src surface_exit_0_2_attic.sc:48
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_0_2_attic.sc:47
  ...
  L_0364:
    r1 = GetDotStr("remove");  // @src surface_exit_0_2_attic.sc:50
    GetDot(r0, 0);
    Free2(r1, r0);
