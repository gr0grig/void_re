...
func_1()
{
  ...
  L_002c:
    ...
    if (!r0) goto L_01bc;
    // plot.sc:10
    r1 = GetDotStr("isActionActive");  // @src plot.sc:10
    r2 = "use";
    GetDot(r0, 1);
    Free2(r1, r2);
    if (!r0) goto L_01bc;
    // plot.sc:11
    r3 = GetDotStr("World");  // @src plot.sc:11
    SetDotRaw(r2, 27);
    Free1(r3);
    SetDotRaw(r1, 32);
    Free1(r2);
    ...
    if (!r0) goto L_0128;
    // plot.sc:12
    r2 = GetDotStr("World");  // @src plot.sc:12
    SetDotRaw(r1, 27);
    Free1(r2);
    r2 = "uplevel_completed";
    SetDot(r0, 1);
  ...
  L_0128:
    ...
    // plot.sc:16
  L_015c:
    r1 = GetDotStr("sendGenericEventToWorld");  // @src plot.sc:16
    r2 = GetDotStr("World");
    r3 = "onPlot";
    GetDot(r0, 2);
    Free4(r1, r2, r3, r0);
    // plot.sc:17
    r1 = GetDotStr("sendGenericEventToWorld");  // @src plot.sc:17
    r2 = GetDotStr("World");
    r3 = "onLocationExit";
    GetDot(r0, 2);
    Free4(r1, r2, r3, r0);
...
{
    // plot.sc:25
    r1 = GetDotStr("trace");  // @src plot.sc:25
    r2 = "Activate: plot;";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // plot.sc:26
