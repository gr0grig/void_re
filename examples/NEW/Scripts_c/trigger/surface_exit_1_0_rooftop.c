...
initTriggerByGroup()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_1_0_rooftop.sc:20
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "createNahodkaAt";
    r3 = "pt_1_1";
    ...
    r1 = GetDotStr("!tuple");  // @src surface_exit_1_0_rooftop.sc:21
    r3 = GetDotStr("!vec3");
    r4 = 0;
    r5 = 0;
    r6 = -1;
    ...
    r3 = GetDotStr("Scene");  // @src surface_exit_1_0_rooftop.sc:25
    SetDotRaw(r2, 100);
    Free1(r3);
    ...
    r4 = GetDotStr("World");  // @src surface_exit_1_0_rooftop.sc:26
    SetDotRaw(r3, 160);
    Free1(r4);
    r4 = GetDotStr("Scene");
    ...
    r4 = GetDotStr("remove");  // @src surface_exit_1_0_rooftop.sc:29
    GetDot(r3, 0);
    Free2(r4, r3);
...
func_4()
{
    ...
    r1 = GetDotStr("call");  // @src surface_exit_1_0_rooftop.sc:37
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_1_0_rooftop.sc:36
  ...
  L_0254:
    r1 = GetDotStr("remove");  // @src surface_exit_1_0_rooftop.sc:39
    GetDot(r0, 0);
    Free2(r1, r0);
