// gscript: trigger_hunger_swos_2.bin
// @version: 0
// @globals: 0
...
// trigger_hunger_swos_2.sc:6 (locals=0)
func_1()
{
    // trigger_hunger_swos_2.sc:6
    return r0;  // @src trigger_hunger_swos_2.sc:6
}

// trigger_hunger_swos_2.sc:19 (locals=5)
func_2()
{
    // trigger_hunger_swos_2.sc:12
    r0 = r_neg4;  // @src trigger_hunger_swos_2.sc:12
    if (!r0) goto L_012c;
    // trigger_hunger_swos_2.sc:13
    r0 = false;  // @src trigger_hunger_swos_2.sc:13
    r4 = GetDotStr("World");
    SetDotRaw(r3, 6);
    Free1(r4);
    SetDotRaw(r2, 11);
    Free1(r3);
    r3 = "trigger_hunger_swos_2";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = Not(r1);
    if (!r1) goto L_00d0;
  ...
  L_00d0:
    if (!r0) goto L_012c;
    // trigger_hunger_swos_2.sc:15
    r0 = true;  // @src trigger_hunger_swos_2.sc:15
    r2 = GetDotStr("World");
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "trigger_hunger_swos_2";
    GetDotRaw(r1, 1);
    Free1(r2);
    // trigger_hunger_swos_2.sc:16
    r0 = GetDotStr("Scene");  // @src trigger_hunger_swos_2.sc:16
    r0 = (str)r0;
    r1 = GetDotStr("World");
    r1 = (str)r1;
    Call(r2, 0x0134);
    // trigger_hunger_swos_2.sc:19
  L_012c:
    Free1(r_neg5);  // @src trigger_hunger_swos_2.sc:19
    return r0;
}
