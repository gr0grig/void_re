...
// map_exit_fall_zew.sc:6 (locals=0)
func_1()
{
    // map_exit_fall_zew.sc:6
    return r0;  // @src map_exit_fall_zew.sc:6
}
...
// map_exit_fall_zew.sc:18 (locals=3)
func_4()
{
    // map_exit_fall_zew.sc:10
    r1 = 16;  // @src map_exit_fall_zew.sc:10
    r2 = GetDotStr("World");
    r2 = (str)r2;
    Call(r3, 0x0370);
    if (!r0) goto L_0338;
    // map_exit_fall_zew.sc:14
    r0 = true;  // @src map_exit_fall_zew.sc:14
    r2 = GetDotStr("World");
    SetDotRaw(r1, 18);
    Free1(r2);
    r2 = "tutorial_zew_fall_with_block";
    GetDotRaw(r1, 1);
    Free1(r2);
    // map_exit_fall_zew.sc:17
  L_0338:
    r2 = GetDotStr("Scene");  // @src map_exit_fall_zew.sc:17
    SetDotRaw(r1, 157);
    Free1(r2);
    r2 = "onLocationExit";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // map_exit_fall_zew.sc:18
    Free1(r_neg5);  // @src map_exit_fall_zew.sc:18
    return r0;
}
