...
initTrigger()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_1_1_exit.sc:27
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "createNahodkaAt";
    r3 = "pt_1_2";
    ...
    r1 = GetDotStr("setTimer");  // @src surface_exit_1_1_exit.sc:29
    r2 = 0;
    r3 = 20000000;
    GetDot(r0, 2);
    Free2(r1, r0);
    // surface_exit_1_1_exit.sc:30
    r1 = GetDotStr("setTimer");  // @src surface_exit_1_1_exit.sc:30
    r2 = 1;
    r3 = 5000000;
    GetDot(r0, 2);
    Free2(r1, r0);
    // surface_exit_1_1_exit.sc:32
    r2 = GetDotStr("Scene");  // @src surface_exit_1_1_exit.sc:32
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "requestExit";
    GetDot(r0, 1);
...
initTrigger()
{
    ...
    r2 = GetDotStr("Scene");  // @src surface_exit_1_1_exit.sc:47
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "onLocationExit";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("remove");  // @src surface_exit_1_1_exit.sc:48
    GetDot(r0, 0);
    Free2(r1, r0);
    // surface_exit_1_1_exit.sc:46
...
onTimer()
{
    ...
    r1 = GetDotStr("call");  // @src surface_exit_1_1_exit.sc:60
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_1_1_exit.sc:59
  ...
  L_0264:
    r1 = GetDotStr("remove");  // @src surface_exit_1_1_exit.sc:62
    GetDot(r0, 0);
    Free2(r1, r0);
