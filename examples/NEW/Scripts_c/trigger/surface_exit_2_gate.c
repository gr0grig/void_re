...
onTriggerPlayer()
{
    ...
    r1 = GetDotStr("trace");  // @src surface_exit_2_gate.sc:7
...
func_3()
{
    ...
    r1 = GetDotStr("trace");  // @src surface_exit_2_gate.sc:12
    r2 = "Activate: opening gate";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_2_gate.sc:14
    r2 = GetDotStr("Scene");  // @src surface_exit_2_gate.sc:14
    SetDotRaw(r1, 106);
    Free1(r2);
    r2 = "breakGate";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("remove");  // @src surface_exit_2_gate.sc:15
    GetDot(r0, 0);
    Free2(r1, r0);
