...
func_1()
{
  ...
  L_0660:
    ...
    r3 = g9;
    // tree_base.sci:184
    CallNat(r3, 15904, 0x300);  // @src tree_base.sci:184
}
...
// tree_garden1.sc:76 (locals=8)
getAllowedTypes()
{
    // tree_garden1.sc:61
    g0 = r15;  // @src tree_garden1.sc:61
    if (r0) goto L_104c;
    // tree_garden1.sc:62
    r1 = GetDotStr("!qtpair");  // @src tree_garden1.sc:62
    ...
    r0 = (str)r0;
    // tree_garden1.sc:63
    r1 = r_neg4;  // @src tree_garden1.sc:63
    if (r1) goto L_0ec0;
    // tree_garden1.sc:64
    r3 = GetDotStr("World");  // @src tree_garden1.sc:64
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_garden1tree_dead_1.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    ...
    Free1(r1);
    // tree_garden1.sc:63
    goto L_0f20;  // @src tree_garden1.sc:63
    // tree_garden1.sc:66
  L_0ec0:
    r3 = GetDotStr("World");  // @src tree_garden1.sc:66
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_garden1tree_dead.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    // tree_garden1.sc:69
  L_0f20:
    r6 = GetDotStr("World");  // @src tree_garden1.sc:69
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    Free1(r5);
    ...
    r1 = (str)r1;
    // tree_garden1.sc:70
    r2 = 0;  // @src tree_garden1.sc:70
  L_0f90:
    r3 = r2;  // @src tree_garden1.sc:70
    g5 = r15;
    SetDotRaw(r4, 1091);
    Free1(r5);
    r3 = r3 < r4;
  ...
  L_1018:
    ...
    Free2(r3, r2);
    // tree_garden1.sc:61
    Free2(r1, r0);  // @src tree_garden1.sc:61
    // tree_garden1.sc:76
  L_104c:
    return r0;  // @src tree_garden1.sc:76
}
...
func_21()
{
  ...
  L_1d04:
    ...
    if (!r3) goto L_1d44;
    // tree_base.sci:415
    Call(r3, 0x25d4);  // @src tree_base.sci:415
    // tree_base.sci:416
    Call(r3, 0x2620);  // @src tree_base.sci:416
    // tree_base.sci:413
  ...
  L_1ffc:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:456
    Call(r8, 0x2620);  // @src tree_base.sci:456
    // tree_base.sci:429
...
// tree_garden1.sc:16 (locals=7)
func_23()
{
    // tree_garden1.sc:11
    g0 = r11;  // @src tree_garden1.sc:11
    if (r0) goto L_2370;
    // tree_garden1.sc:12
    r1 = GetDotStr("!qtpair");  // @src tree_garden1.sc:12
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden1.sc:13
    r3 = GetDotStr("World");  // @src tree_garden1.sc:13
    SetDotRaw(r2, 982);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ps_Garden1treeBloom.ps";
    r5 = r0;
    r6 = "";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free1(r1);
    // tree_garden1.sc:14
    r1 = r_neg4;  // @src tree_garden1.sc:14
    Call(r2, 0x2374);
    // tree_garden1.sc:11
    Free1(r0);  // @src tree_garden1.sc:11
    // tree_garden1.sc:16
  L_2370:
    return r0;  // @src tree_garden1.sc:16
}

// tree_garden1.sc:28 (locals=7)
func_24()
{
    // tree_garden1.sc:20
    r0 = r_neg4;  // @src tree_garden1.sc:20
    r6 = GetDotStr("World");
    SetDotRaw(r5, 494);
    Free1(r6);
    SetDotRaw(r4, 505);
    ...
    Free4(r2, r4, r5, r1);
    // tree_garden1.sc:28
    Free1(r0);  // @src tree_garden1.sc:28
    return r0;
}

// tree_garden1.sc:36 (locals=4)
func_25()
{
    // tree_garden1.sc:32
    g0 = r12;  // @src tree_garden1.sc:32
    if (r0) goto L_261c;
    // tree_garden1.sc:33
    r1 = GetDotStr("!qtpair");  // @src tree_garden1.sc:33
    r2 = GetDotStr("Rotation");
    r3 = GetDotStr("Position");
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // tree_garden1.sc:32
    Free1(r0);  // @src tree_garden1.sc:32
    // tree_garden1.sc:36
  L_261c:
    return r0;  // @src tree_garden1.sc:36
}

// tree_garden1.sc:43 (locals=6)
func_26()
{
    // tree_garden1.sc:40
    r5 = GetDotStr("World");  // @src tree_garden1.sc:40
    SetDotRaw(r4, 494);
    Free1(r5);
    SetDotRaw(r3, 505);
    Free1(r4);
    ...
    r0 = (str)r0;
    // tree_garden1.sc:41
    g1 = r8;  // @src tree_garden1.sc:41
    r1 = (float)r1;
    g2 = r13;
    r2 = (float)r2;
    r1 = r1 / r2;
    // tree_garden1.sc:43
    Free1(r0);  // @src tree_garden1.sc:43
    return r0;
}
...
// tree_garden1.sc:52 (locals=3)
func_30()
{
    // tree_garden1.sc:47
    g0 = r12;  // @src tree_garden1.sc:47
    if (!r0) goto L_2960;
    // tree_garden1.sc:48
    g2 = r12;  // @src tree_garden1.sc:48
    SetDotRaw(r1, 1140);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1.sc:50
  L_2960:
    g0 = r11;  // @src tree_garden1.sc:50
    if (!r0) goto L_299c;
    // tree_garden1.sc:51
    g2 = r11;  // @src tree_garden1.sc:51
    SetDotRaw(r1, 1140);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1.sc:52
  L_299c:
    return r0;  // @src tree_garden1.sc:52
}
...
func_32()
{
    ...
    Free2(r3, r1);
    // gameplay.sci:1038
    goto L_2b68;  // @src gameplay.sci:1038
    // gameplay.sci:1043
  L_2b38:
...
func_33()
{
  ...
  L_2e04:
    ...
    if (!r6) goto L_300c;
    // tree_base.sci:233
    Call(r6, 0x32e8);  // @src tree_base.sci:233
    // tree_base.sci:234
  L_300c:
    ...
    if (!r6) goto L_3038;
    // tree_base.sci:235
    Call(r6, 0x3358);  // @src tree_base.sci:235
    // tree_base.sci:234
    goto L_3040;  // @src tree_base.sci:234
    // tree_base.sci:237
  L_3038:
    Call(r6, 0x33c8);  // @src tree_base.sci:237
    // tree_base.sci:239
  L_3040:
...
isWaitable()
{
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:309
    goto L_39f4;  // @src tree_base.sci:309
    // tree_base.sci:314
  L_36e8:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:314
    goto L_39f4;  // @src tree_base.sci:314
    // tree_base.sci:319
  L_37b0:
    ...
    Free4(r1, r2, r3, r0);
    // tree_base.sci:319
    goto L_39f4;  // @src tree_base.sci:319
    // tree_base.sci:324
  L_3878:
  ...
  L_39f4:
    ...
    Call(r1, 0x22b8);
    // tree_base.sci:337
    Call(r1, 0x3d08);  // @src tree_base.sci:337
    // tree_base.sci:339
  ...
  L_3bb8:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:347
    goto L_3bb8;  // @src tree_base.sci:347
    // tree_base.sci:355
  L_3cf4:
...
// tree_garden1.sc:7 (locals=1)
getHelperText()
{
    // tree_garden1.sc:6
    r0 = 3;  // @src tree_garden1.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
