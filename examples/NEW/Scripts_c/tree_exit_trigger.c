...
func_1()
{
  ...
  L_0040:
    r2 = GetDotStr("World");  // @src tree_exit_trigger.sc:12
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "runPPEffect";
    r5 = GetDotStr("!vec3");
    ...
    r1 = GetDotStr("sendWorldGenericEvent");  // @src tree_exit_trigger.sc:15
    r2 = GetDotStr("World");
    r3 = "onFinal";
    r4 = "self";
    GetDot(r0, 3);
...
func_8()
{
  ...
  L_0620:
    ...
    goto L_0620;  // @src posteffects\darken.sci:112
  ...
  L_0728:
    ...
    goto L_0728;  // @src posteffects\darken.sci:128
    // posteffects\darken.sci:120
  L_0744:
    goto L_0674;  // @src posteffects\darken.sci:120
}
