...
{
    // pelican_water.sc:68
    r1 = GetDotStr("playAnimation");  // @src pelican_water.sc:68
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_011c:
    ...
    // pelican_water.sc:75
  L_0154:
    r2 = GetDotStr("GeomTransparency");  // @src pelican_water.sc:75
    r3 = 0.5f;
    r2 = r2 > r3;
    if (!r2) goto L_0198;
    r2 = GetDotStr("GeomTransparency");  // @src pelican_water.sc:75
  ...
  L_01dc:
    ...
    Free2(r3, r2);
    // pelican_water.sc:86
    r2 = GetDotStr("GeomTransparency");  // @src pelican_water.sc:86
    r3 = 1.0f;
    r2 = r2 < r3;
    if (!r2) goto L_0260;
    // pelican_water.sc:87
    ...
    r2 = r2 * r3;
    // pelican_water.sc:88
    r3 = GetDotStr("GeomTransparency");  // @src pelican_water.sc:88
    r4 = r2;
    r3 = r3 + r4;
  ...
  L_0268:
    ...
    // pelican_water.sc:94
  L_0270:
    r2 = GetDotStr("remove");  // @src pelican_water.sc:94
    GetDot(r1, 0);
    Free2(r2, r1);
    // pelican_water.sc:95
...
{
    // pelican_water.sc:46
    r1 = GetDotStr("setPosition");  // @src pelican_water.sc:46
    r3 = GetDotStr("!vec3");
    r4 = 0;
    r5 = 32;
    r6 = 0;
...
func_8()
{
  ...
  L_041c:
    ...
    if (r2) goto L_0454;
    // ../std.sci:1058
    goto L_045c;  // @src ../std.sci:1058
    // ../std.sci:1055
  L_0454:
    goto L_041c;  // @src ../std.sci:1055
    // ../std.sci:1060
  L_045c:
