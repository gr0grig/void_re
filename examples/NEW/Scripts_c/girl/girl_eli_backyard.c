...
// girl_eli_backyard.sc:26 (locals=8)
func_1()
{
    // girl_eli_backyard.sc:17
    r1 = GetDotStr("loadAnimationSet");  // @src girl_eli_backyard.sc:17
    r2 = "anim/eli_dressed.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girl_eli_backyard.sc:19
    r1 = GetDotStr("setSensorFlags");  // @src girl_eli_backyard.sc:19
    r2 = -2147483648;
    r3 = -2147483648;
    GetDot(r0, 2);
    Free2(r1, r0);
    // girl_eli_backyard.sc:20
    r1 = GetDotStr("addConeSector");  // @src girl_eli_backyard.sc:20
    r3 = GetDotStr("!vec2");
    r4 = 1;
    r5 = 0;
    GetDot(r2, 2);
    ...
    GetDot(r0, 6);
    Free3(r1, r2, r0);
    // girl_eli_backyard.sc:21
    r0 = false;  // @src girl_eli_backyard.sc:21
    r0 = g6;
    // girl_eli_backyard.sc:23
    r0 = "Head";  // @src girl_eli_backyard.sc:23
    r1 = "Eye_l";
    r2 = "Eye_r";
    Call(r3, 0x0114);
    // girl_eli_backyard.sc:25
    CallNat(r1, 556, 0x0);  // @src girl_eli_backyard.sc:25
}
...
// girl_eli_backyard.sc:54 (locals=2)
onSectorLeave()
{
    // girl_eli_backyard.sc:52
    Call(r1, 0x01a0);  // @src girl_eli_backyard.sc:52
    r1 = r_neg5;
    r0 = r0 == r1;
    if (!r0) goto L_0198;
    // girl_eli_backyard.sc:53
    r0 = true;  // @src girl_eli_backyard.sc:53
    r0 = g6;
    // girl_eli_backyard.sc:54
  L_0198:
    Free1(r_neg5);  // @src girl_eli_backyard.sc:54
    return r0;
}
...
// girl_eli_backyard.sc:62 (locals=2)
getAllowedTypes()
{
    // girl_eli_backyard.sc:60
    Call(r1, 0x01a0);  // @src girl_eli_backyard.sc:60
    r1 = r_neg5;
    r0 = r0 == r1;
    if (!r0) goto L_0224;
    // girl_eli_backyard.sc:61
    r0 = false;  // @src girl_eli_backyard.sc:61
    r0 = g6;
    // girl_eli_backyard.sc:62
  L_0224:
    Free1(r_neg5);  // @src girl_eli_backyard.sc:62
    return r0;
}

// girl_eli_backyard.sc:46 (locals=6)
func_6()
{
    // girl_eli_backyard.sc:32
  L_0234:
    r0 = true;  // @src girl_eli_backyard.sc:32
    if (!r0) goto L_0348;
    // girl_eli_backyard.sc:33
    r1 = GetDotStr("playAnimation");  // @src girl_eli_backyard.sc:33
    r2 = "unaware_idle_";
    ...
    r2 = r0;  // @src girl_eli_backyard.sc:35
    GetDot(r1, 0);
    Free2(r2, r1);
    // girl_eli_backyard.sc:36
    r1 = 0;  // @src girl_eli_backyard.sc:36
    // girl_eli_backyard.sc:37
  L_02b0:
    r3 = r0;  // @src girl_eli_backyard.sc:37
    r4 = r1;
    GetDot(r2, 1);
    Free1(r3);
    if (!r2) goto L_033c;
    // girl_eli_backyard.sc:38
    r2 = r1;  // @src girl_eli_backyard.sc:38
    Call(r3, 0x034c);
    // girl_eli_backyard.sc:39
    r3 = true;  // @src girl_eli_backyard.sc:39
    RetV(r2);
    Free1(r3);
    r2 = (int)r2;
    r1 = r2;
    // girl_eli_backyard.sc:40
    g2 = r6;  // @src girl_eli_backyard.sc:40
    if (!r2) goto L_0334;
    // girl_eli_backyard.sc:41
    r3 = GetDotStr("clearSensor");  // @src girl_eli_backyard.sc:41
    GetDot(r2, 0);
    Free2(r3, r2);
    // girl_eli_backyard.sc:42
    CallNat(r2, 3068, 0x200);  // @src girl_eli_backyard.sc:42
    // girl_eli_backyard.sc:37
  L_0334:
    goto L_02b0;  // @src girl_eli_backyard.sc:37
    // girl_eli_backyard.sc:32
  L_033c:
    Free1(r0);  // @src girl_eli_backyard.sc:32
    goto L_0234;
    // girl_eli_backyard.sc:46
  L_0348:
    return r0;  // @src girl_eli_backyard.sc:46
}
...
// girl_eli_backyard.sc:92 (locals=7)
func_11()
{
    // girl_eli_backyard.sc:71
    r0 = 0;  // @src girl_eli_backyard.sc:71
    // girl_eli_backyard.sc:74
    r2 = GetDotStr("playAnimation");  // @src girl_eli_backyard.sc:74
    r3 = "unaware_to_aware";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
  ...
  L_0c4c:
    r3 = r1;  // @src girl_eli_backyard.sc:76
    r4 = r0;
    GetDot(r2, 1);
    Free1(r3);
    if (!r2) goto L_0ca4;
    // girl_eli_backyard.sc:77
    r2 = r0;  // @src girl_eli_backyard.sc:77
    Call(r3, 0x034c);
    // girl_eli_backyard.sc:78
    r3 = true;  // @src girl_eli_backyard.sc:78
    RetV(r2);
    Free1(r3);
    r2 = (int)r2;
    r0 = r2;
    // girl_eli_backyard.sc:76
    goto L_0c4c;  // @src girl_eli_backyard.sc:76
    // girl_eli_backyard.sc:73
  L_0ca4:
    Free1(r1);  // @src girl_eli_backyard.sc:73
    // girl_eli_backyard.sc:83
  L_0ca8:
    r1 = true;  // @src girl_eli_backyard.sc:83
    if (!r1) goto L_0d80;
    // girl_eli_backyard.sc:84
    r2 = GetDotStr("playAnimation");  // @src girl_eli_backyard.sc:84
    r3 = "aware_idle_";
    ...
    Free2(r2, r3);
    r1 = (str)r1;
    // girl_eli_backyard.sc:85
    r3 = r1;  // @src girl_eli_backyard.sc:85
    GetDot(r2, 0);
    Free2(r3, r2);
    // girl_eli_backyard.sc:87
  L_0d1c:
    r3 = r1;  // @src girl_eli_backyard.sc:87
    r4 = r0;
    GetDot(r2, 1);
    Free1(r3);
    if (!r2) goto L_0d74;
    // girl_eli_backyard.sc:88
    r2 = r0;  // @src girl_eli_backyard.sc:88
    Call(r3, 0x0d84);
    // girl_eli_backyard.sc:89
    r3 = true;  // @src girl_eli_backyard.sc:89
    RetV(r2);
    Free1(r3);
    r2 = (int)r2;
    r0 = r2;
    // girl_eli_backyard.sc:87
    goto L_0d1c;  // @src girl_eli_backyard.sc:87
    // girl_eli_backyard.sc:83
  L_0d74:
    Free1(r1);  // @src girl_eli_backyard.sc:83
    goto L_0ca8;
    // girl_eli_backyard.sc:92
  L_0d80:
    return r0;  // @src girl_eli_backyard.sc:92
}
...
// girl_eli_backyard.sc:10 (locals=6)
onUse()
{
    // girl_eli_backyard.sc:9
    r2 = GetDotStr("getBoneAbsTransform");  // @src girl_eli_backyard.sc:9
...
// girl_eli_backyard.sc:108 (locals=8)
isPaintable()
{
    // girl_eli_backyard.sc:101
    r2 = GetDotStr("World");  // @src girl_eli_backyard.sc:101
    SetDotRaw(r1, 500);
    Free1(r2);
    r2 = "getPlayerEntity";
    GetDot(r0, 1);
    ...
    GetDotRaw(r2, 257);
    Free2(r3, r1);
    // girl_eli_backyard.sc:103
    r4 = r0;  // @src girl_eli_backyard.sc:103
    SetDotRaw(r3, 535);
    Free1(r4);
    SetDotRaw(r2, 558);
    Free1(r3);
    ...
    GetDotRaw(r2, 257);
    Free2(r3, r1);
    // girl_eli_backyard.sc:105
    r3 = GetDotStr("Scene");  // @src girl_eli_backyard.sc:105
    SetDotRaw(r2, 500);
    Free1(r3);
    ...
    r3 = GetDotStr("Scene");  // @src girl_eli_backyard.sc:107
    SetDotRaw(r2, 500);
    Free1(r3);
    r3 = "activateObscure";
    r4 = "eli";
    ...
    GetDot(r1, 3);
    Free4(r2, r3, r4, r1);
    // girl_eli_backyard.sc:108
    Free2(r0, r_neg6);  // @src girl_eli_backyard.sc:108
    return r0;
}
...
// girl_eli_backyard.sc:115 (locals=1)
getAllowedTypes()
{
    // girl_eli_backyard.sc:114
    r0 = true;  // @src girl_eli_backyard.sc:114
    r_neg4 = r0;
    return r0;
}
