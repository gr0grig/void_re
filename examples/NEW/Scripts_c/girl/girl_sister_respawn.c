...
func_1()
{
    ...
    r1 = GetDotStr("loadAnimationSet");  // @src girl_sister_respawn.sc:7
...
isFinished()
{
    ...
    r1 = GetDotStr("playAnimation");  // @src girl_sister_respawn.sc:13
    r2 = "sister_respawn";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_5()
{
    ...
    r1 = GetDotStr("trace");  // @src girl_sister_respawn.sc:35
