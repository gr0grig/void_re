...
{
    // nahodka.sc:9
    r2 = GetDotStr("World");  // @src nahodka.sc:9
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = GetDotStr("Scene");
    r3 = "ps_nahodka1.ps";
    ...
    Free1(r0);
    // nahodka.sc:12
    r1 = GetDotStr("!vector");  // @src nahodka.sc:12
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g0;
    ...
    // nahodka.sc:16
  L_00b4:
    r2 = GetDotStr("!vector");  // @src nahodka.sc:16
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // nahodka.sc:18
  ...
  L_00d4:
    ...
    if (!r4) goto L_0178;
    // nahodka.sc:22
    r5 = GetDotStr("makeAttachPoint");  // @src nahodka.sc:22
    r6 = "spline_";
    r7 = r0;
    r8 = 1;
    r7 = r7 + r8;
    ...
    // nahodka.sc:25
  L_0178:
    r5 = GetDotStr("makeAttachPoint");  // @src nahodka.sc:25
    r6 = "spline_";
    r7 = r0;
    r8 = 1;
    r7 = r7 + r8;
  ...
  L_0284:
    ...
    // nahodka.sc:43
  L_02d0:
    r1 = GetDotStr("loadAnimationSet");  // @src nahodka.sc:43
    r2 = "anim/nahodka.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // nahodka.sc:45
...
{
    // nahodka.sc:191
    r1 = GetDotStr("playAnimation");  // @src nahodka.sc:191
    r2 = "move_left";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_5()
{
  ...
  L_04f4:
    ...
    r2 = (str)r2;
    // nahodka.sc:280
    r4 = GetDotStr("!vector");  // @src nahodka.sc:280
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    // nahodka.sc:282
  ...
  L_05e4:
    ...
    Call(r6, 0x09a0);
    // nahodka.sc:288
    r6 = GetDotStr("!spline");  // @src nahodka.sc:288
    GetDot(r5, 0);
    Free1(r6);
    r5 = (str)r5;
    // nahodka.sc:290
  ...
  L_0614:
    ...
    if (!r7) goto L_0758;
    // nahodka.sc:291
    r8 = GetDotStr("!bezier3D");  // @src nahodka.sc:291
    r10 = r3;
    r11 = r6;
    SetDot(r9, 1);
    r11 = r4;
...
func_8()
{
  ...
  L_0ea8:
    ...
    // nahodka.sc:266
  L_0ecc:
    r1 = GetDotStr("remove");  // @src nahodka.sc:266
    GetDot(r0, 0);
    Free2(r1, r0);
    // nahodka.sc:267
...
{
    // nahodka.sc:212
    r1 = GetDotStr("playAnimation");  // @src nahodka.sc:212
    r2 = "move_right";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // nahodka.sc:233
    r1 = GetDotStr("playAnimation");  // @src nahodka.sc:233
    r2 = "ascend";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // nahodka.sc:156
    r1 = GetDotStr("moveLine");  // @src nahodka.sc:156
    ...
    Free4(r1, r2, r3, r0);
    // nahodka.sc:157
    r1 = GetDotStr("move");  // @src nahodka.sc:157
    r2 = 0;
    GetDot(r0, 1);
    Free2(r1, r0);
    // nahodka.sc:159
    r1 = GetDotStr("setRotation");  // @src nahodka.sc:159
    r2 = 0;
    GetDot(r0, 1);
    Free2(r1, r0);
    // nahodka.sc:161
    r1 = GetDotStr("playAnimationInplace");  // @src nahodka.sc:161
    r2 = "moving_loop";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_1100:
    ...
    // nahodka.sc:175
  L_116c:
    r4 = GetDotStr("move");  // @src nahodka.sc:175
    r6 = r2;
    Call(r7, 0x1208);
    GetDot(r3, 1);
    Free2(r4, r3);
...
func_13()
{
    ...
    // nahodka.sc:114
    r2 = GetDotStr("!tuple");  // @src nahodka.sc:114
    r3 = 0;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (str)r1;
...
func_16()
{
    ...
    // nahodka.sc:86
    r3 = GetDotStr("playAnimationInplace");  // @src nahodka.sc:86
    r4 = "moving_loop";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
  ...
  L_1828:
    ...
    // nahodka.sc:95
  L_1894:
    r5 = GetDotStr("move");  // @src nahodka.sc:95
    r6 = r0;
    r8 = r3;
    Call(r9, 0x1208);
    r6 = r6 * r7;
...
{
    // nahodka.sc:52
    r1 = GetDotStr("playAnimation");  // @src nahodka.sc:52
    r2 = "stay_idle";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
