...
func_1()
{
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:7
    r2 = 0;
    r3 = "PPeriod";
    r4 = 2.5f;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:8
    r2 = 1;
    r3 = "PPeriod";
    r4 = 5;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:9
    r2 = 2;
    r3 = "PPeriod";
    r4 = 2;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:10
    r2 = 3;
    r3 = "PPeriod";
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:11
    r2 = 4;
    r3 = "PPeriod";
    r4 = 3;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:12
    r2 = 5;
    r3 = "PPeriod";
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:13
    r2 = 6;
    r3 = "PPeriod";
    r4 = 1.6670000553131104f;
    GetDot(r0, 3);
  ...
  L_01a0:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_boom.sc:18
    r3 = r0;
    r4 = "PPeriod";
    r5 = 65535;
    GetDot(r1, 3);
...
func_3()
{
  ...
  L_02e0:
    r2 = GetDotStr("remove");  // @src ps_hunter_09_piper_boom.sc:33
    GetDot(r1, 0);
    Free2(r2, r1);
