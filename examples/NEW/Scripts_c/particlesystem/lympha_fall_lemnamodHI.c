...
func_2()
{
  ...
  L_0038:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @src lympha_fall_lemnamodHI.sc:19
    r3 = r0;
    r4 = "PPeriod";
    r5 = 2048;
    GetDot(r1, 3);
  ...
  L_00a4:
    ...
    r1 = GetDotStr("updateAllEmmiters");  // @src lympha_fall_lemnamodHI.sc:24
    r2 = 16000000;
    GetDot(r0, 1);
    Free2(r1, r0);
...
func_3()
{
    ...
    r1 = GetDotStr("!vector");  // @src lympha_fall_lemnamodHI.sc:36
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // lympha_fall_lemnamodHI.sc:37
    r2 = GetDotStr("!vector");  // @src lympha_fall_lemnamodHI.sc:37
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // lympha_fall_lemnamodHI.sc:40
    r4 = GetDotStr("World");  // @src lympha_fall_lemnamodHI.sc:40
    SetDotRaw(r3, 67);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
...
func_5()
{
  ...
  L_0670:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @src lympha_fall_lemnamodHI.sc:84
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 1;
