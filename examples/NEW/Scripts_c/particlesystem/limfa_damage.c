...
func_1()
{
  ...
  L_0034:
    ...
    if (!r1) goto L_00a0;
    // limfa_damage.sc:17
    r2 = GetDotStr("setSysParameterFloat");  // @src limfa_damage.sc:17
    r3 = r0;
    r4 = "PPeriod";
    r5 = 65535;
    GetDot(r1, 3);
...
func_3()
{
  ...
  L_0128:
    ...
    // limfa_damage.sc:32
  L_0174:
    r2 = GetDotStr("remove");  // @src limfa_damage.sc:32
    GetDot(r1, 0);
    Free2(r2, r1);
    // limfa_damage.sc:33
...
setColor()
{
  ...
  L_01c8:
    ...
    if (!r1) goto L_0238;
    // limfa_damage.sc:6
    r2 = GetDotStr("setSysParameterVector");  // @src limfa_damage.sc:6
    r3 = r0;
    r4 = "PSColor";
    r5 = r_neg4;
    GetDot(r1, 3);
