...
func_1()
{
  ...
  L_0028:
    ...
    r5 = GetDotStr("setSysParameterFloat");  // @src ps_BranchesGhostyFireA.sc:13
    r6 = 1;
    r7 = "bx";
    r8 = r1;
    GetDot(r4, 3);
    ...
    r5 = GetDotStr("setSysParameterFloat");  // @src ps_BranchesGhostyFireA.sc:14
    r6 = 1;
    r7 = "by";
    r8 = r2;
    GetDot(r4, 3);
    ...
    r5 = GetDotStr("setSysParameterFloat");  // @src ps_BranchesGhostyFireA.sc:15
    r6 = 1;
    r7 = "bz";
    r8 = r3;
    GetDot(r4, 3);
