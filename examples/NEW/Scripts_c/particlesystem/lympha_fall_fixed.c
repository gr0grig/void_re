...
func_1()
{
    ...
    r1 = GetDotStr("trace");  // @src lympha_fall_fixed.sc:5
...
func_2()
{
    ...
    r1 = GetDotStr("trace");  // @src lympha_fall_fixed.sc:15
  ...
  L_0080:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @src lympha_fall_fixed.sc:18
    r3 = r0;
    r4 = "PPeriod";
    r5 = 2048;
    GetDot(r1, 3);
  ...
  L_00ec:
    ...
    r1 = GetDotStr("updateAllEmmiters");  // @src lympha_fall_fixed.sc:23
    r2 = 16000000;
    GetDot(r0, 1);
    Free2(r1, r0);
...
func_3()
{
    ...
    r1 = GetDotStr("!vector");  // @src lympha_fall_fixed.sc:35
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // lympha_fall_fixed.sc:36
    r2 = GetDotStr("!vector");  // @src lympha_fall_fixed.sc:36
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // lympha_fall_fixed.sc:39
    r4 = GetDotStr("World");  // @src lympha_fall_fixed.sc:39
    SetDotRaw(r3, 203);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
...
func_4()
{
  ...
  L_0428:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @src lympha_fall_fixed.sc:67
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 1;
