...
func_1()
{
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_teleport_in.sc:7
    r2 = 0;
    r3 = "PPeriod";
    r4 = 5;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_teleport_in.sc:8
    r2 = 1;
    r3 = "PPeriod";
    r4 = 6;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_teleport_in.sc:12
    r2 = 0;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @src ps_hunter_09_piper_teleport_in.sc:13
    r2 = 1;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
...
func_3()
{
  ...
  L_01d0:
    r2 = GetDotStr("remove");  // @src ps_hunter_09_piper_teleport_in.sc:27
    GetDot(r1, 0);
    Free2(r2, r1);
