...
func_1()
{
  ...
  L_0030:
    ...
    r2 = r2 + r3;
    // rodent_dirt.sc:14
    r4 = GetDotStr("setSysParameterFloat");  // @src rodent_dirt.sc:14
    r5 = 0;
    r6 = "PPeriod";
    r7 = r2;
    GetDot(r3, 3);
    ...
    // rodent_dirt.sc:18
  L_00fc:
    r2 = GetDotStr("setSysParameterFloat");  // @src rodent_dirt.sc:18
    r3 = 0;
    r4 = "PPeriod";
    r5 = 100000;
    GetDot(r1, 3);
    ...
    Call(r3, 0x015c);
    // rodent_dirt.sc:20
    r2 = GetDotStr("remove");  // @src rodent_dirt.sc:20
    GetDot(r1, 0);
    Free2(r2, r1);
    // rodent_dirt.sc:21
