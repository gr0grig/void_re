...
func_3()
{
  ...
  L_0098:
    ...
    r3 = GetDotStr("EmmiterCount");
    r2 = r2 < r3;
    if (!r2) goto L_0104;
    // pelicansplash.sc:38
    r3 = GetDotStr("setSysParameterFloat");  // @src pelicansplash.sc:38
    r4 = r1;
    r5 = "PPeriod";
    r6 = 65535;
    GetDot(r2, 3);
...
func_5()
{
  ...
  L_0194:
    ...
    // pelicansplash.sc:54
  L_01d8:
    r2 = GetDotStr("remove");  // @src pelicansplash.sc:54
    GetDot(r1, 0);
    Free2(r2, r1);
    // pelicansplash.sc:55
