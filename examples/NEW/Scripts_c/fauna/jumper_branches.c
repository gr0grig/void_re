...
// @func_table: 10 groups offsets=40,1009,2047,3051,4051,5020,5989,6958,7927,8896
...
//   export "isPangolinAttackable" args=0 cb=-1 {func_84}
//   export "attackPangolinBegin" args=1 cb=-1 {func_85} types=[str]
//   export "onBranchesDestroy" args=0 cb=-1 {func_89}
//   export "OnPangolinAttack" args=1 cb=-1 {func_90} types=[str]
...
//   export "attackPangolinEnd" args=0 cb=-1 {func_86}
...
// #export {func_84} name="isPangolinAttackable"
// #export {func_85} name="attackPangolinBegin"
// #export {func_86} name="attackPangolinEnd"
// #export {func_87} name="onDamage"
// #export {func_89} name="onBranchesDestroy"
// #export {func_90} name="OnPangolinAttack"
...
func_1()
{
    ...
    // fauna_base.sci:12
    CallNat(r1, 13572, 0x0);  // @src fauna_base.sci:12
}
...
func_32()
{
  ...
  L_2538:
    ...
    CallMethod(r2, 1724, 0x242);  // @patch+8 jumper_base.sci:641
...
// jumper_branches.sc:49 (locals=4)
func_36()
{
    // jumper_branches.sc:45
    g0 = r21;  // @src jumper_branches.sc:45
    if (!r0) goto L_2c34;
    // jumper_branches.sc:46
    r1 = GetDotStr("!tuple");  // @src jumper_branches.sc:46
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
    ...
    Free1(r0);
    return r0;
    // jumper_branches.sc:48
  L_2c34:
    r1 = GetDotStr("!tuple");  // @src jumper_branches.sc:48
    r2 = 3;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
...
func_37()
{
    ...
    r0 = 567;
    RawDword(0x00002d80);  // UNKNOWN opcode 0x80
    // ../std.sci:844
    Free1(r3);  // @src ../std.sci:844
    RetV(r2);
    r2 = (int)r2;
    // ../std.sci:845
    ...
    if (r3) goto L_2d78;
    // ../std.sci:847
    goto L_2d80;  // @src ../std.sci:847
    // ../std.sci:843
  L_2d78:
    goto L_2d10;  // @src ../std.sci:843
    // ../std.sci:850
  L_2d80:
...
func_41()
{
  ...
  L_30fc:
    ...
    if (r3) goto L_3138;
    // jumper_base.sci:558
    goto L_3170;  // @src jumper_base.sci:558
    // jumper_base.sci:560
  L_3138:
    ...
    // jumper_base.sci:554
  L_3168:
    goto L_30fc;  // @src jumper_base.sci:554
    // jumper_base.sci:544
  L_3170:
...
func_43()
{
  ...
  L_320c:
    ...
    if (r2) goto L_3244;
    // ../std.sci:1058
    goto L_324c;  // @src ../std.sci:1058
    // ../std.sci:1055
  L_3244:
    goto L_320c;  // @src ../std.sci:1055
    // ../std.sci:1060
  L_324c:
...
func_44()
{
  ...
  L_32cc:
    ...
    if (r3) goto L_330c;
    // jumper_base.sci:278
    goto L_33fc;  // @src jumper_base.sci:278
    // jumper_base.sci:280
  L_330c:
  ...
  L_333c:
    ...
    r4 = (float)r4;
    r3 = r3 / r4;
    CallMethod(r3, 1724, 0x36);  // @patch+8 jumper_base.sci:284
    RawDword(0x000033f4);  // UNKNOWN opcode 0xf4
    // jumper_base.sci:287
  L_33ac:
    ...
    r4 = r4 / r5;
    r3 = r3 - r4;
    CallMethod(r3, 1724, 0x36);  // @patch+8 jumper_base.sci:274
    RawDword(0x000032d4);  // UNKNOWN opcode 0xd4
    // jumper_base.sci:290
  L_33fc:
    ...
    CallMethod(r2, 1724, 0x36);  // @patch+8 jumper_base.sci:290
    r52 = r52 && r53;
    // jumper_base.sci:293
  L_3424:
    r2 = 0;  // @src jumper_base.sci:293
    CallMethod(r2, 1724, 0x4b);  // @patch+8 jumper_base.sci:294
...
func_46()
{
    ...
    CallMethod(r0, 2049, 0x1);  // @patch+8 jumper_base.sci:301
    r0 = "桓摡睯䙳摡䉥来湩氀慯䅤楮慭楴湯敓tani...";  // len=73, pool_off=0x80d, GARBLED
    // jumper_base.sci:303
    ...
    Free3(r1, r2, r0);
    // jumper_base.sci:305
    Call(r0, 0x355c);  // @src jumper_base.sci:305
    // jumper_base.sci:306
...
setFaunaHealth()
{
  ...
  L_3a30:
    ...
    r_neg4 = r0;
    // fauna_base.sci:73
    goto L_3b90;  // @src fauna_base.sci:73
    // fauna_base.sci:78
  L_3ae4:
...
getLassoLimfaAmount()
{
  ...
  L_3e54:
    ...
    // jumper_base.sci:168
  L_3ef0:
    Spawn(r0, 0, 0x3f94);  // @src jumper_base.sci:168
    r0 = 0xd;
    r0 = (float)r0;
    Free1(r0);
    // jumper_base.sci:170
...
{
    // jumper_base.sci:134
    Call(r0, 0x3fd0);  // @src jumper_base.sci:134
    // jumper_base.sci:136
  L_3fa4:
    ...
    Call(r1, 0x41e0);
    // jumper_base.sci:135
    goto L_3fa4;  // @src jumper_base.sci:135
}
...
func_68()
{
  ...
  L_4008:
    ...
    Free1(r3);
    // jumper_base.sci:85
    goto L_40d0;  // @src jumper_base.sci:85
    // jumper_base.sci:89
  L_4080:
...
func_69()
{
  ...
  L_4410:
    ...
    Free3(r5, r7, r4);
    // jumper_base.sci:125
    goto L_44c0;  // @src jumper_base.sci:125
    // jumper_base.sci:128
  L_4484:
...
isRodentEnemy()
{
    ...
    // jumper_base.sci:207
  L_49f8:
    Call(r1, 0x3c20);  // @src jumper_base.sci:207
    if (!r0) goto L_4a0c;
  ...
  L_4a0c:
    ...
    Call(r2, 0x38c4);
    // jumper_base.sci:210
    Call(r1, 0x3c20);  // @src jumper_base.sci:210
    if (!r0) goto L_4a40;
    // jumper_base.sci:211
    CallNat2(r8, 19040, 0x0);  // @src jumper_base.sci:211
    // jumper_base.sci:212
  L_4a40:
...
isPangolinAttackable()
{
  ...
  L_4ac8:
    ...
    Free2(r4, r3);
    // jumper_base.sci:695
    Call(r4, 0x51d8);  // @src jumper_base.sci:695
    if (!r3) goto L_4b84;
    // jumper_base.sci:696
  ...
  L_4b84:
    ...
    // jumper_base.sci:689
  L_4bb4:
    goto L_4ac8;  // @src jumper_base.sci:689
    // jumper_base.sci:702
  L_4bbc:
  ...
  L_4ccc:
    ...
    if (!r2) goto L_4dec;
    // jumper_base.sci:712
    Call(r3, 0x51d8);  // @src jumper_base.sci:712
    if (!r2) goto L_4d48;
    // jumper_base.sci:713
  ...
  L_4d48:
    ...
    r3 = 2000000.0f;
    r2 = r2 / r3;
    CallMethod(r2, 1724, 0x34a);  // @patch+8 jumper_base.sci:716
    RetV(r2);
    r2 = (int)r2;
    // jumper_base.sci:717
    ...
    // jumper_base.sci:711
  L_4de4:
    goto L_4ccc;  // @src jumper_base.sci:711
    // jumper_base.sci:725
  L_4dec:
...
getAllowedTypes()
{
  ...
  L_4edc:
    ...
    Free2(r6, r5);
    // jumper_base.sci:251
    goto L_4f90;  // @src jumper_base.sci:251
    // jumper_base.sci:247
  L_4f74:
    r4 = r2;  // @src jumper_base.sci:247
    r4 = Incr(r4);
...
func_85()
{
    ...
    CallNat2(r9, 21276, 0x1);
    // jumper_branches.sc:23
    Free1(r_neg4);  // @src jumper_branches.sc:23
    return r0;
}

// jumper_branches.sc:93 (locals=1)
func_86()
{
    // jumper_branches.sc:92
    r0 = true;  // @src jumper_branches.sc:92
    CopyExtRd(r0, 0, 9);
    // jumper_branches.sc:93
    return r0;  // @src jumper_branches.sc:93
}

// jumper_branches.sc:97 (locals=0)
attackPangolinBegin()
{
    // jumper_branches.sc:97
    return r0;  // @src jumper_branches.sc:97
}

// jumper_branches.sc:88 (locals=13)
onBranchesDestroy()
{
    // jumper_branches.sc:58
    r0 = false;  // @src jumper_branches.sc:58
    CopyExtRd(r0, 0, 9);
    // jumper_branches.sc:59
    r1 = GetDotStr("stop");  // @src jumper_branches.sc:59
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // jumper_branches.sc:60
    r2 = r_neg4;  // @src jumper_branches.sc:60
    SetDotRaw(r1, 2663);
    Free1(r2);
    r2 = "loc_attack_pos";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    // jumper_branches.sc:62
    r2 = GetDotStr("findBone");  // @src jumper_branches.sc:62
    r3 = "";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (int)r1;
    // jumper_branches.sc:63
    r3 = GetDotStr("getBoneRotation");  // @src jumper_branches.sc:63
    r4 = r1;
    GetDot(r2, 1);
    Free1(r3);
    r2 = (str)r2;
    // jumper_branches.sc:64
    r4 = GetDotStr("invert");  // @src jumper_branches.sc:64
    r6 = r0;
    SetDotRaw(r5, 1251);
    Free1(r6);
    GetDot(r3, 1);
    Free2(r4, r5);
    r3 = (str)r3;
    // jumper_branches.sc:66
    r4 = 1000000;  // @src jumper_branches.sc:66
    // jumper_branches.sc:67
    r5 = true;  // @src jumper_branches.sc:67
    CopyExtWr(r0, 6, 9);
    r7 = false;
    r6 = r6 == r7;
    if (r6) goto L_5458;
  ...
  L_5458:
    if (!r5) goto L_5578;
    // jumper_branches.sc:68
    Free1(r6);  // @src jumper_branches.sc:68
    RetV(r5);
    r5 = (int)r5;
    // jumper_branches.sc:69
    r7 = GetDotStr("setPosition");  // @src jumper_branches.sc:69
    r9 = r0;
    SetDotRaw(r8, 115);
    Free1(r9);
    GetDot(r6, 1);
    ...
    r7 = GetDotStr("setBoneRotation");  // @src jumper_branches.sc:70
    r8 = r1;
    r9 = r2;
    r10 = r3;
    r12 = r0;
    ...
    g6 = r17;  // @src jumper_branches.sc:72
    if (!r6) goto L_5514;
    // jumper_branches.sc:73
    g7 = r17;  // @src jumper_branches.sc:73
    r8 = r5;
    GetDot(r6, 1);
    Free2(r7, r6);
    // jumper_branches.sc:75
  L_5514:
    CopyExtWr(r0, 6, 9);  // @src jumper_branches.sc:75
    if (!r6) goto L_5570;
    // jumper_branches.sc:76
    r6 = r4;  // @src jumper_branches.sc:76
    r7 = r5;
    r6 = r6 - r7;
    r4 = r6;
    // jumper_branches.sc:77
    r6 = 1.0f;  // @src jumper_branches.sc:77
    r7 = r4;
    r7 = (float)r7;
    r8 = 1000000.0f;
    r7 = r7 / r8;
    r6 = r6 - r7;
    CallMethod(r6, 1724, 0x36);  // @patch+8 jumper_branches.sc:67
    CopyExtWr(r84, 1280, 0);  // @patch+4 jumper_branches.sc:82
    Call(r6, 0x4e40);
    // jumper_branches.sc:84
    g5 = r16;  // @src jumper_branches.sc:84
    if (!r5) goto L_55bc;
    // jumper_branches.sc:85
    g7 = r16;  // @src jumper_branches.sc:85
    SetDotRaw(r6, 2887);
    Free1(r7);
    GetDot(r5, 0);
    Free2(r6, r5);
  ...
  L_55bc:
    r6 = GetDotStr("remove");  // @src jumper_branches.sc:87
    GetDot(r5, 0);
    Free2(r6, r5);
    // jumper_branches.sc:88
    Free4(r3, r2, r0, r_neg4);  // @src jumper_branches.sc:88
    return r0;
}

// jumper_branches.sc:30 (locals=3)
onDamage()
{
    ...
    r1 = GetDotStr("stop");  // @src jumper_branches.sc:28
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // jumper_branches.sc:29
    CallNat2(r5, 9212, 0x0);  // @src jumper_branches.sc:29
    // jumper_branches.sc:30
    return r0;  // @src jumper_branches.sc:30
}

// jumper_branches.sc:41 (locals=0)
getAllowedTypes()
{
    // jumper_branches.sc:41
    Free1(r_neg4);  // @src jumper_branches.sc:41
    return r0;
}
