...
func_1()
{
    ...
    Free1(r0);
    // bulldog.sc:29
    r1 = GetDotStr("loadSound3D");  // @src bulldog.sc:29
    r2 = "bulldog_move";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // bulldog.sc:31
    r1 = GetDotStr("loadAnimationSet");  // @src bulldog.sc:31
    r2 = "anim/bulldog.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // bulldog.sc:33
    r1 = GetDotStr("changeNavMesh");  // @src bulldog.sc:33
    r2 = "bulldog";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // bulldog.sc:34
    r1 = GetDotStr("putOnGrid");  // @src bulldog.sc:34
    GetDot(r0, 0);
    Free2(r1, r0);
    // bulldog.sc:36
...
func_8()
{
    ...
    if (!r3) goto L_0494;
    // bulldog.sc:228
    r4 = GetDotStr("stop");  // @src bulldog.sc:228
    r5 = true;
    GetDot(r3, 1);
    Free2(r4, r3);
    // bulldog.sc:229
...
func_10()
{
    // bulldog.sc:201
  L_04c0:
    r1 = GetDotStr("irandMax");  // @src bulldog.sc:201
    r2 = 2;
    GetDot(r0, 1);
    Free1(r1);
    r1 = 1;
    ...
    r0 = (int)r0;
    // bulldog.sc:202
    r2 = GetDotStr("playAnimationInplace");  // @src bulldog.sc:202
    r3 = "run";
    r4 = r0;
    r4 = (as_string)r4;
    r3 = r3 + r4;
...
{
    // bulldog.sc:313
    r1 = GetDotStr("remove");  // @src bulldog.sc:313
    GetDot(r0, 0);
    Free2(r1, r0);
    // bulldog.sc:314
...
{
    // bulldog.sc:280
    r1 = GetDotStr("stop");  // @src bulldog.sc:280
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // bulldog.sc:282
    r0 = GetDotStr("Position");  // @src bulldog.sc:282
    r0 = (str)r0;
    // bulldog.sc:283
    ...
    r1 = (str)r1;
    // bulldog.sc:284
    r3 = GetDotStr("moveLine");  // @src bulldog.sc:284
    r4 = r0;
    r5 = r1;
    r5 = Inv(r5);
    GetDot(r2, 2);
    Free4(r3, r4, r5, r2);
    // bulldog.sc:286
    r3 = GetDotStr("playAnimationInplace");  // @src bulldog.sc:286
    r4 = "bite";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
  ...
  L_0e4c:
    ...
    Free2(r5, r4);
    // bulldog.sc:300
    r5 = GetDotStr("findBone");  // @src bulldog.sc:300
    r6 = "";
    GetDot(r4, 1);
    Free2(r5, r6);
    r4 = (int)r4;
    // bulldog.sc:301
    r6 = GetDotStr("getBoneRotation");  // @src bulldog.sc:301
    r7 = r4;
    GetDot(r5, 1);
    Free1(r6);
    r5 = (str)r5;
    // bulldog.sc:302
    r7 = GetDotStr("invert");  // @src bulldog.sc:302
    r8 = r_neg5;
    GetDot(r6, 1);
    Free2(r7, r8);
    r6 = (str)r6;
    ...
    // bulldog.sc:305
  L_0f68:
    r7 = GetDotStr("setPosition");  // @src bulldog.sc:305
    r9 = r_neg4;
    SetDotRaw(r8, 335);
    Free1(r9);
    GetDot(r6, 1);
    Free3(r7, r8, r6);
    // bulldog.sc:306
    r7 = GetDotStr("setBoneRotation");  // @src bulldog.sc:306
    r8 = r4;
    r9 = r5;
    r10 = r_neg5;
    r12 = r_neg4;
...
{
    // bulldog.sc:15
    r1 = GetDotStr("playAnimation");  // @src bulldog.sc:15
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_24()
{
    ...
    // bulldog.sc:102
  L_11ec:
    r1 = GetDotStr("playAnimation");  // @src bulldog.sc:102
    r2 = "wait";
...
func_27()
{
    ...
    r0 = (float)0xfffffc0a;
    r0 = "獡却慨潤獷氀慯卤畯摮䐳戀甀氀氀搀漀最开愀...";  // len=313, pool_off=0x1, GARBLED
    Free1(r2);
    r1 = (int)r1;
    // bulldog.sc:171
    ...
    if (!r2) goto L_1520;
    // bulldog.sc:172
    r3 = GetDotStr("stop");  // @src bulldog.sc:172
    r4 = true;
    GetDot(r2, 1);
    Free2(r3, r2);
    // bulldog.sc:173
  ...
  L_1520:
    ...
    if (!r2) goto L_1580;
    // bulldog.sc:176
    r3 = GetDotStr("stop");  // @src bulldog.sc:176
    r4 = true;
    GetDot(r2, 1);
    Free2(r3, r2);
    // bulldog.sc:177
...
func_30()
{
    // bulldog.sc:133
  L_15e8:
    r1 = GetDotStr("irandMax");  // @src bulldog.sc:133
    r2 = 2;
    GetDot(r0, 1);
    Free1(r1);
    r1 = 1;
    ...
    r0 = (int)r0;
    // bulldog.sc:134
    r2 = GetDotStr("playAnimationInplace");  // @src bulldog.sc:134
    r3 = "run";
    r4 = r0;
    r4 = (as_string)r4;
    r3 = r3 + r4;
...
{
    // bulldog.sc:45
    r1 = GetDotStr("irandMax");  // @src bulldog.sc:45
    r2 = 2;
    GetDot(r0, 1);
    Free1(r1);
    r1 = 1;
    ...
    r0 = (int)r0;
    // bulldog.sc:46
    r2 = GetDotStr("playAnimation");  // @src bulldog.sc:46
    r3 = "wakeup";
    r4 = r0;
    r4 = (as_string)r4;
    r3 = r3 + r4;
