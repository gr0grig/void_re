...
// @version: 0
// @globals: 24 types=02 01 01 01 01 01 02 03 03 03 03 03 03 03 03 03 03 03 01 01 03 00 00 03
// @func_table: 10 groups offsets=40,818,1626,2434,3337,4177,4955,5790,6709,7623
...
//   export "getActorCenter" args=0 cb=-1 {func_85}
//   export "onGetTargetList" args=1 cb=-1 {func_86} types=[str]
//   export "isPelicanAttackable" args=0 cb=-1 {func_87}
//   export "onPelicanAttack" args=1 cb=-1 {func_88} types=[str]
...
//   export "onDamage" args=2 cb=-1 {func_89} types=[int,int]
//   export "isMineAttractor" args=0 cb=-1 {func_90}
//   export "onCancelAttack" args=0 cb=-1 {func_91}
//   export "getAllowedTypes" args=1 cb=-1 {func_64} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_65}
//   export "getFaunaProps" args=0 cb=-1 {func_3}
//   export "initFaunaHealth" args=0 cb=-1 {func_2}
...
// #export {func_85} name="getActorCenter"
// #export {func_86} name="onGetTargetList"
// #export {func_87} name="isPelicanAttackable"
// #export {func_88} name="onPelicanAttack"
// #export {func_89} name="onDamage"
// #export {func_90} name="isMineAttractor"
// #export {func_91} name="onCancelAttack"
...
// ushan_lemna.sc:20 (locals=1)
func_4()
{
    // ushan_lemna.sc:19
    r0 = "ushan_lemna";  // @src ushan_lemna.sc:19
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
func_62()
{
    ...
    CallMethod(r0, 1798, 0x147);  // @patch+8 ushan_base.sci:365
    r7 = (str)r7;
    r2 = "anim/ushan.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
// ushan_lemna.sc:10 (locals=6)
getCameraTarget()
{
    // ushan_lemna.sc:9
    r0 = GetDotStr("Position");  // @src ushan_lemna.sc:9
    r2 = GetDotStr("!vec3");
    r3 = 0;
    r4 = 1;
    r5 = 0;
...
// ushan_lemna.sc:34 (locals=4)
removeLasso()
{
    // ushan_lemna.sc:32
    r0 = r_neg4;  // @src ushan_lemna.sc:32
    r0 = g23;
    Free1(r0);
    // ushan_lemna.sc:33
    g2 = r23;  // @src ushan_lemna.sc:33
    SetDotRaw(r1, 464);
    Free1(r2);
    r2 = "onTargetNotify";
    r3 = GetDotStr("self");
    ...
    Free4(r1, r2, r3, r0);
    // ushan_lemna.sc:34
    Free1(r_neg4);  // @src ushan_lemna.sc:34
    return r0;
}

// ushan_lemna.sc:39 (locals=1)
onGetTargetList()
{
    // ushan_lemna.sc:38
    r0 = true;  // @src ushan_lemna.sc:38
    r_neg4 = r0;
    return r0;
}

// ushan_lemna.sc:45 (locals=1)
isPelicanAttackable()
{
    // ushan_lemna.sc:43
    Call(r1, 0x08a0);  // @src ushan_lemna.sc:43
    if (!r0) goto L_59d8;
    Free1(r_neg4);  // @src ushan_lemna.sc:43
    return r0;
    // ushan_lemna.sc:44
  L_59d8:
    r0 = r_neg4;  // @src ushan_lemna.sc:44
    CallNat2(r9, 23200, 0x1);
    // ushan_lemna.sc:45
    Free1(r_neg4);  // @src ushan_lemna.sc:45
    return r0;
}

// ushan_lemna.sc:94 (locals=3)
onPelicanAttack()
{
    // ushan_lemna.sc:89
    r0 = r_neg5;  // @src ushan_lemna.sc:89
    r1 = r_neg4;
    Call(r2, 0x0544);
    // ushan_lemna.sc:90
    Call(r1, 0x08a0);  // @src ushan_lemna.sc:90
    if (!r0) goto L_5a60;
    // ushan_lemna.sc:91
    g2 = r23;  // @src ushan_lemna.sc:91
    SetDotRaw(r1, 464);
    Free1(r2);
    r2 = "cancelAttack";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // ushan_lemna.sc:92
    CallNat2(r5, 2280, 0x0);  // @src ushan_lemna.sc:92
    // ushan_lemna.sc:94
  L_5a60:
    return r0;  // @src ushan_lemna.sc:94
}

// ushan_lemna.sc:101 (locals=1)
onDamage()
{
    // ushan_lemna.sc:100
    r0 = true;  // @src ushan_lemna.sc:100
    r_neg4 = r0;
    return r0;
}

// ushan_lemna.sc:109 (locals=0)
isMineAttractor()
{
    // ushan_lemna.sc:107
    Call(r0, 0x0ed0);  // @src ushan_lemna.sc:107
    // ushan_lemna.sc:108
    CallNat2(r5, 2280, 0x0);  // @src ushan_lemna.sc:108
    // ushan_lemna.sc:109
    return r0;  // @src ushan_lemna.sc:109
}

// ushan_lemna.sc:83 (locals=7)
onCancelAttack()
{
    // ushan_lemna.sc:61
  L_5aa8:
    r0 = null_str2;  // @src ushan_lemna.sc:61
    r1 = null_str2;  // @src ushan_lemna.sc:61
    // ushan_lemna.sc:63
    r3 = GetDotStr("moveLine");  // @src ushan_lemna.sc:63
    r4 = GetDotStr("Position");
    r5 = r_neg4;
    r6 = GetDotStr("Position");
    r5 = r5 - r6;
    ...
    Free1(r2);
    // ushan_lemna.sc:66
    CopyExtWr(r0, 3, 9);  // @src ushan_lemna.sc:66
    r4 = 0;
    GetDot(r2, 1);
    Free2(r3, r2);
    // ushan_lemna.sc:68
    r3 = 0;  // @src ushan_lemna.sc:68
    r3 = (float)r3;
    r4 = 0.7853981852531433f;
    Spawn(r2, 0, 0x3028);
    r0 = 1.0761972206014595e-42f;  // @patch+4 ushan_lemna.sc:69
    r0 = 823;
    if (r92) goto L_044a;  // @patch+4 ushan_lemna.sc:70
    RetV(r3);
    r3 = (int)r3;
    // ushan_lemna.sc:71
    CopyExtWr(r0, 5, 9);  // @src ushan_lemna.sc:71
    r6 = r3;
    GetDot(r4, 1);
    Free2(r5, r4);
    // ushan_lemna.sc:72
    r5 = r_neg4;  // @src ushan_lemna.sc:72
    r6 = GetDotStr("Position");
    r5 = r5 - r6;
    r5 = (str)r5;
    Call(r6, 0x2938);
    ...
    Free3(r5, r6, r4);
    // ushan_lemna.sc:74
    goto L_5c38;  // @src ushan_lemna.sc:74
    // ushan_lemna.sc:69
  L_5c30:
    goto L_5b84;  // @src ushan_lemna.sc:69
    // ushan_lemna.sc:79
  L_5c38:
    r3 = true;  // @src ushan_lemna.sc:79
    if (!r3) goto L_5c64;
    // ushan_lemna.sc:80
    r3 = "flyup";  // @src ushan_lemna.sc:80
    Call(r4, 0x44ec);
    // ushan_lemna.sc:79
    goto L_5c38;  // @src ushan_lemna.sc:79
    // ushan_lemna.sc:59
  L_5c64:
    Free3(r2, r1, r0);  // @src ushan_lemna.sc:59
    goto L_5aa8;
}
