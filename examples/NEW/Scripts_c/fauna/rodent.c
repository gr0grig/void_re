...
{
    // rodent_base.sci:51
    CallNat(r1, 11536, 0x0);  // @src rodent_base.sci:51
}
...
func_17()
{
  ...
  L_14a4:
    ...
    if (!r1) goto L_1504;
    // rodent_base.sci:268
    CallNat(r8, 7844, 0x100);  // @src rodent_base.sci:268
    // rodent_base.sci:251
  L_1504:
...
{
    // rodent.sc:9
    r1 = GetDotStr("!tuple");  // @src rodent.sc:9
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
...
func_23()
{
    ...
    SetDotRaw(r25, 10);  // @patch+4 ../std.sci:879
    r0 = (float)0xfffffb0a;
    r0 = "";  // len=1087, pool_off=0x1ca0, GARBLED
    r_neg7 = r1;
...
func_27()
{
  ...
  L_1bd4:
    ...
    r4 = r7;
    // ../std.sci:285
    goto L_1ab0;  // @src ../std.sci:285
    // ../std.sci:307
  L_1c5c:
    r6 = false;  // @src ../std.sci:307
    RetV(r5);
    Free2(r6, r5);
    goto L_1c5c;  // @src ../std.sci:307
}
...
func_30()
{
  ...
  L_1e54:
    ...
    if (r2) goto L_1e90;
    // rodent_base.sci:233
    goto L_1e98;  // @src rodent_base.sci:233
    // rodent_base.sci:230
  L_1e90:
    goto L_1e54;  // @src rodent_base.sci:230
    // rodent_base.sci:225
  L_1e98:
...
func_31()
{
  ...
  L_1ff8:
    ...
    if (r2) goto L_2030;
    // rodent_base.sci:498
    goto L_2038;  // @src rodent_base.sci:498
    // rodent_base.sci:495
  L_2030:
    goto L_1ff8;  // @src rodent_base.sci:495
    // rodent_base.sci:501
  L_2038:
...
func_33()
{
  ...
  L_230c:
    ...
    if (r4) goto L_237c;
    // rodent_base.sci:425
    goto L_2384;  // @src rodent_base.sci:425
    // rodent_base.sci:413
  L_237c:
    goto L_2230;  // @src rodent_base.sci:413
    // rodent_base.sci:409
  L_2384:
...
func_36()
{
  ...
  L_2460:
    ...
    Free2(r2, r1);
    // rodent_base.sci:351
    goto L_2508;  // @src rodent_base.sci:351
    // rodent_base.sci:353
  L_24c4:
    ...
    if (r2) goto L_2500;
    // rodent_base.sci:355
    goto L_2508;  // @src rodent_base.sci:355
    // rodent_base.sci:348
  L_2500:
    goto L_2460;  // @src rodent_base.sci:348
    // rodent_base.sci:344
  L_2508:
...
onSectorEnter()
{
    ...
    CallNat2(r10, 9936, 0x1);
    // rodent_base.sci:198
    goto L_26c8;  // @src rodent_base.sci:198
    // rodent_base.sci:204
  L_2640:
    ...
    Call(r2, 0x0870);
    // rodent_base.sci:205
    goto L_26c8;  // @src rodent_base.sci:205
    // rodent_base.sci:209
  L_26b8:
...
onStartUsing()
{
  ...
  L_2888:
    ...
    if (r5) goto L_28c0;
    // rodent_base.sci:293
    goto L_28c8;  // @src rodent_base.sci:293
    // rodent_base.sci:290
  L_28c0:
    goto L_2888;  // @src rodent_base.sci:290
    // rodent_base.sci:296
  L_28c8:
    r4 = r_neg4;  // @src rodent_base.sci:296
    CallNat(r11, 10696, 0x401);
}
...
func_41()
{
  ...
  L_2af4:
    ...
    Free2(r2, r1);
    // rodent_base.sci:314
    CallNat(r12, 11048, 0x100);  // @src rodent_base.sci:314
    // rodent_base.sci:309
  L_2b20:
    goto L_2a80;  // @src rodent_base.sci:309
}
...
func_42()
{
  ...
  L_2c1c:
    ...
    if (r2) goto L_2c54;
    // rodent_base.sci:335
    goto L_2c5c;  // @src rodent_base.sci:335
    // rodent_base.sci:332
  L_2c54:
    goto L_2c1c;  // @src rodent_base.sci:332
    // rodent_base.sci:338
  L_2c5c:
...
onStartUsing()
{
    ...
    Free3(r1, r2, r0);
    // rodent_base.sci:62
    Call(r0, 0x2d58);  // @src rodent_base.sci:62
    // rodent_base.sci:63
