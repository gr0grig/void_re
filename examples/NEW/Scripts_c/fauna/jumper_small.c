...
// jumper_small.sc:10 (locals=1)
func_4()
{
    // jumper_small.sc:9
    r0 = "jumper_small";  // @src jumper_small.sc:9
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
func_32()
{
  ...
  L_2538:
    ...
    CallMethod(r2, 1718, 0x242);  // @patch+8 jumper_base.sci:641
...
// jumper_small.sc:15 (locals=4)
func_36()
{
    // jumper_small.sc:14
    r1 = GetDotStr("!tuple");  // @src jumper_small.sc:14
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
...
func_44()
{
  ...
  L_32f4:
    ...
    r4 = (float)r4;
    r3 = r3 / r4;
    CallMethod(r3, 1718, 0x36);  // @patch+8 jumper_base.sci:284
  ...
  L_3364:
    ...
    r4 = r4 / r5;
    r3 = r3 - r4;
    CallMethod(r3, 1718, 0x36);  // @patch+8 jumper_base.sci:274
  ...
  L_33b4:
    ...
    CallMethod(r2, 1718, 0x36);  // @patch+8 jumper_base.sci:290
    RawDword(0x000033ec);  // UNKNOWN opcode 0xec
    // jumper_base.sci:293
  L_33dc:
    r2 = 0;  // @src jumper_base.sci:293
    CallMethod(r2, 1718, 0x4b);  // @patch+8 jumper_base.sci:294
...
func_46()
{
    ...
    CallMethod(r0, 2043, 0x1);  // @patch+8 jumper_base.sci:301
    r0 = "桓摡睯䙳摡䉥来湩氀慯䅤楮慭楴湯敓tani...";  // len=73, pool_off=0x807, GARBLED
    // jumper_base.sci:303
...
// jumper_small.sc:5 (locals=0)
func_47()
{
    // jumper_small.sc:5
    return r0;  // @src jumper_small.sc:5
}
...
isMineAttractor()
{
  ...
  L_4cf0:
    ...
    r3 = 2000000.0f;
    r2 = r2 / r3;
    CallMethod(r2, 1718, 0x34a);  // @patch+8 jumper_base.sci:716
    RetV(r2);
    r2 = (int)r2;
    // jumper_base.sci:717
