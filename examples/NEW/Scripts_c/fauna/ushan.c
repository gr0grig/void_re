...
// ushan.sc:10 (locals=1)
func_4()
{
    // ushan.sc:9
    r0 = "ushan";  // @src ushan.sc:9
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
onSectorLeave()
{
    ...
    GetInd(r0);
    RawDword(0x0000019e);  // UNKNOWN opcode 0x9e
    Free1(r1);
    if (r0) goto L_1008;
    // ushan_base.sci:429
...
func_33()
{
    ...
    RawDword(0x000004cd);  // UNKNOWN opcode 0xcd
}
...
func_62()
{
    ...
    CallMethod(r0, 1786, 0x147);  // @patch+8 ushan_base.sci:365
    LoadIntZero(r7);
    r2 = "anim/ushan.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
