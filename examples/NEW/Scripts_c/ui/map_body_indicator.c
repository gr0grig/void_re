...
// @func_table: 3 groups offsets=12,307,632
...
//   export "checkHitTest" args=2 cb=1 {func_6} types=[int,int]
//   export "render" args=1 cb=0 {func_7} types=[str]
//   export "onMouseEnter" args=2 cb=-1 {func_8} types=[int,int]
//   export "onMouseLeave" args=2 cb=-1 {func_9} types=[int,int]
//   export "removeControl" args=0 cb=-1 {func_10}
// @ft_group 1: parent=0 stack=0 locals=0 vtable=[] imports=[(1,0)]
//   export "initIndicator" args=1 cb=-1 {func_11} types=[str]
//   export "getAllowedTypes" args=1 cb=-1 {func_2} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_3}
//   export "hideControl" args=1 cb=-1 {func_4} types=[bool]
//   export "isControlHided" args=0 cb=-1 {func_5}
...
//   export "renderButtonTooltip" args=3 cb=-1 {func_13} types=[str,int,int]
//   export "render" args=1 cb=0 {func_14} types=[str]
//   export "onMouseButtonLeft" args=3 cb=-1 {func_16} types=[int,int,bool]
//   export "getAllowedTypes" args=1 cb=-1 {func_2} types=[int]
//   export "getHunterGlotokList" args=0 cb=-1 {func_3}
//   export "hideControl" args=1 cb=-1 {func_4} types=[bool]
//   export "isControlHided" args=0 cb=-1 {func_5}
...
// #export {func_6} name="checkHitTest"
// #export {func_7} name="render"
// #export {func_8} name="onMouseEnter"
// #export {func_9} name="onMouseLeave"
// #export {func_10} name="removeControl"
// #export {func_11} name="initIndicator"
// #export {func_12} name="checkHitTest"
// #export {func_13} name="renderButtonTooltip"
// #export {func_14} name="render"
// #export {func_16} name="onMouseButtonLeft"
...
getAllowedTypes()
{
    ...
    r1 = GetDotStr("!ppconfig");  // @src map_body_indicator.sc:58
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g6;
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @src map_body_indicator.sc:62
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @src map_body_indicator.sc:64
    r5 = r0;
    SetDotRaw(r4, 234);
    Free1(r5);
    GetDot(r3, 0);
    ...
    r3 = GetDotStr("Plane");  // @src map_body_indicator.sc:66
    SetDotRaw(r2, 247);
    Free1(r3);
    ...
    r3 = GetDotStr("Plane");  // @src map_body_indicator.sc:67
    SetDotRaw(r2, 247);
    Free1(r3);
    ...
    r2 = GetDotStr("!regionMask");  // @src map_body_indicator.sc:72
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g2;
    ...
    r3 = GetDotStr("Plane");  // @src map_body_indicator.sc:73
    SetDotRaw(r2, 247);
    Free1(r3);
    ...
    CallNat2(r2, 4388, 0x200);  // @src map_body_indicator.sc:76
...
onMouseButtonLeft()
{
  ...
  L_07c4:
    r0 = GetDotStr("Width");  // @src map_body_indicator.sc:135
    r1 = 0.5f;
    r0 = r0 * r1;
    CopyExtWr(r1, 2, 2);
    r3 = 0;
    ...
    r0 = GetDotStr("Height");  // @src map_body_indicator.sc:136
    r1 = 0.5f;
    r0 = r0 * r1;
    CopyExtWr(r1, 2, 2);
    r3 = 1;
...
func_14()
{
  ...
  L_0b30:
    ...
    r2 = GetDotStr("Plane");  // @src map_body_indicator.sc:164
    SetDotRaw(r1, 432);
    Free1(r2);
    GetDot(r0, 0);
    Free1(r1);
...
func_16()
{
  ...
  L_10e0:
    ...
    r2 = GetDotStr("Window");  // @src map_body_indicator.sc:215
    SetDotRaw(r1, 450);
    Free1(r2);
    r2 = "onBody";
    GetDot(r0, 1);
...
func_17()
{
    ...
    Call(r0, 0x1318);  // @src map_body_indicator.sc:98
  ...
  L_1154:
    ...
    // map_body_indicator.sc:104
  L_1220:
    goto L_12c8;  // @src map_body_indicator.sc:104
  ...
  L_12c8:
    ...
    if (!r2) goto L_130c;
    goto L_1314;  // @src map_body_indicator.sc:119
    // map_body_indicator.sc:100
  L_130c:
    goto L_1154;  // @src map_body_indicator.sc:100
...
getAllowedTypes()
{
    ...
    r2 = GetDotStr("Plane");  // @src map_body_indicator.sc:148
    SetDotRaw(r1, 607);
    Free1(r2);
    r2 = "fontmain_11.ft";
    GetDot(r0, 1);
    ...
    r3 = GetDotStr("Plane");  // @src map_body_indicator.sc:150
    SetDotRaw(r2, 644);
    Free1(r3);
    r3 = r0;
    r4 = 256;
  ...
  L_13b8:
    r2 = GetDotStr("format");  // @src map_body_indicator.sc:152
