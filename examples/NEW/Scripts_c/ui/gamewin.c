...
func_1()
{
    ...
    Free1(r0);
    // gamewin.sc:32
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:32
    ...
    if (!r0) goto L_0180;
    // gamewin.sc:36
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:36
  ...
  L_0180:
    ...
    if (!r0) goto L_0218;
    // gamewin.sc:39
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:39
  ...
  L_0218:
    ...
    if (!r0) goto L_02b0;
    // gamewin.sc:45
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:45
  ...
  L_02b0:
    ...
    if (!r0) goto L_0340;
    // gamewin.sc:48
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:48
  ...
  L_0340:
    ...
    // gamewin.sc:56
  L_0348:
    r1 = GetDotStr("getNamedString");  // @src gamewin.sc:56
    r2 = "credits_ending_hero_hunter";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_069c:
    ...
    // gamewin.sc:101
  L_07b0:
    r1 = GetDotStr("!vector");  // @src gamewin.sc:101
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g16;
  ...
  L_1648:
    ...
    // gamewin.sc:178
  L_1770:
    r2 = GetDotStr("Plane");  // @src gamewin.sc:178
    SetDotRaw(r1, 1735);
    Free1(r2);
    g2 = r2;
    r3 = GetDotStr("Width");
    ...
    Free1(r0);
    // gamewin.sc:180
    r1 = GetDotStr("!vec2");  // @src gamewin.sc:180
    r2 = GetDotStr("Width");
    r3 = 0.5f;
    r2 = r2 * r3;
    g4 = r5;
    ...
    Free1(r0);
    // gamewin.sc:182
    r2 = GetDotStr("Plane");  // @src gamewin.sc:182
    SetDotRaw(r1, 1735);
    Free1(r2);
    g2 = r2;
    r3 = GetDotStr("Width");
    ...
    Free1(r0);
    // gamewin.sc:184
    r1 = GetDotStr("!vec2");  // @src gamewin.sc:184
    r2 = GetDotStr("Width");
    r3 = 0.5f;
    r2 = r2 * r3;
    g4 = r2;
    ...
    Free1(r0);
    // gamewin.sc:187
    r2 = GetDotStr("Plane");  // @src gamewin.sc:187
    SetDotRaw(r1, 1735);
    Free1(r2);
    g2 = r3;
    r3 = GetDotStr("Width");
    ...
    Free1(r0);
    // gamewin.sc:189
    r1 = GetDotStr("!vec2");  // @src gamewin.sc:189
    r2 = GetDotStr("Width");
    g4 = r11;
    r5 = 0;
    SetDot(r3, 1);
    ...
    Free1(r0);
    // gamewin.sc:192
    r2 = GetDotStr("Plane");  // @src gamewin.sc:192
    SetDotRaw(r1, 1735);
    Free1(r2);
    g2 = r3;
    r3 = GetDotStr("Width");
    ...
    Free1(r0);
    // gamewin.sc:194
    r1 = GetDotStr("!vec2");  // @src gamewin.sc:194
    r2 = GetDotStr("Width");
    g4 = r14;
    r5 = 0;
    SetDot(r3, 1);
...
{
    // gamewin.sc:243
    r0 = GetDotStr("Height");  // @src gamewin.sc:243
    r0 = (float)r0;
    r1 = 1200.0f;
    r0 = r0 / r1;
    // gamewin.sc:244
    r3 = GetDotStr("Plane");  // @src gamewin.sc:244
    SetDotRaw(r2, 1879);
    Free1(r3);
    r3 = "fontmain_";
    r5 = r_neg4;
...
initUI()
{
    ...
    if (r0) goto L_1dc8;
    // gamewin.sc:209
    r1 = GetDotStr("destroy");  // @src gamewin.sc:209
    GetDot(r0, 0);
    Free2(r1, r0);
    // gamewin.sc:211
  L_1dc8:
...
func_6()
{
  ...
  L_2014:
    ...
    if (!r0) goto L_21d4;
    // gamewin.sc:226
    r0 = GetDotStr("Width");  // @src gamewin.sc:226
    ...
    r1 = (int)r1;
    // gamewin.sc:229
    r2 = GetDotStr("Width");  // @src gamewin.sc:229
