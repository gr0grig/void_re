...
{
    // tooltip_image.sc:11
    r1 = GetDotStr("fillA");  // @src tooltip_image.sc:11
    r3 = GetDotStr("!vec3");
    r4 = 0;
    r5 = 0;
    r6 = 0;
    ...
    r0 = g4;
    // tooltip_image.sc:16
    r1 = GetDotStr("createImageComposerBuilder");  // @src tooltip_image.sc:16
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // tooltip_image.sc:17
    ...
    Free3(r2, r3, r1);
    // tooltip_image.sc:18
    r2 = GetDotStr("createPostProcessComposer");  // @src tooltip_image.sc:18
    r5 = r0;
    SetDotRaw(r4, 99);
    Free1(r5);
    GetDot(r3, 0);
  ...
  L_0188:
    ...
    if (!r1) goto L_023c;
    // tooltip_image.sc:26
    r2 = GetDotStr("fillA");  // @src tooltip_image.sc:26
    r4 = GetDotStr("!vec3");
    r5 = 0;
    r6 = 0;
    r7 = 0;
...
func_6()
{
    ...
    if (r0) goto L_0470;
    // tooltip_image.sc:61
    r1 = GetDotStr("createRTImage");  // @src tooltip_image.sc:61
    r3 = r_neg6;
    SetDotRaw(r2, 203);
    Free1(r3);
    r4 = r_neg6;
