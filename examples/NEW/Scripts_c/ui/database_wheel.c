...
// @func_table: 3 groups offsets=12,245,527
...
//   export "initWheel" args=1 cb=-1 {func_9} types=[str]
...
func_1()
{
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @src database_wheel.sc:137
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r3 = GetDotStr("createPostProcessComposer");  // @src database_wheel.sc:140
    r6 = r0;
    SetDotRaw(r5, 89);
    Free1(r6);
    GetDot(r4, 0);
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @src database_wheel.sc:144
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @src database_wheel.sc:146
    r5 = r0;
    SetDotRaw(r4, 89);
    Free1(r5);
    GetDot(r3, 0);
...
initUI()
{
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:47
    SetDotRaw(r1, 249);
    Free1(r2);
    r2 = "fontmain_20.ft";
    GetDot(r0, 1);
  ...
  L_052c:
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:50
    SetDotRaw(r1, 286);
    Free1(r2);
    g2 = r21;
    r3 = 256;
  ...
  L_0588:
    ...
    r3 = GetDotStr("World");  // @src database_wheel.sc:55
    SetDotRaw(r2, 313);
    Free1(r3);
...
getAllowedTypes()
{
  ...
  L_078c:
    ...
    r3 = GetDotStr("Plane");  // @src database_wheel.sc:163
    SetDotRaw(r2, 354);
    Free1(r3);
  ...
  L_0820:
    r2 = GetDotStr("Window");  // @src database_wheel.sc:166
    SetDotRaw(r1, 313);
    Free1(r2);
    r2 = "getWidth";
    GetDot(r0, 1);
    ...
    r2 = GetDotStr("Window");  // @src database_wheel.sc:167
    SetDotRaw(r1, 313);
    Free1(r2);
    r2 = "getHeight";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:169
    g2 = r14;
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:170
    g2 = r14;
    r3 = 0.4000000059604645f;
    r2 = r2 * r3;
    g5 = r5;
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:171
    g2 = r14;
    r3 = 0.4000000059604645f;
    r2 = r2 * r3;
    g5 = r5;
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:173
    SetDotRaw(r1, 354);
    Free1(r2);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:175
    r2 = 57;
    r3 = GetDotStr("Height");
    r4 = 100;
    r3 = r3 - r4;
  ...
  L_0b64:
    ...
    r3 = GetDotStr("Plane");  // @src database_wheel.sc:178
    SetDotRaw(r2, 354);
    Free1(r3);
    ...
    r3 = GetDotStr("Plane");  // @src database_wheel.sc:179
    SetDotRaw(r2, 354);
    Free1(r3);
  ...
  L_0c74:
    ...
    r4 = GetDotStr("Plane");  // @src database_wheel.sc:184
    SetDotRaw(r3, 354);
    Free1(r4);
    ...
    r4 = GetDotStr("Plane");  // @src database_wheel.sc:185
    SetDotRaw(r3, 354);
    Free1(r4);
  ...
  L_0d78:
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:188
    SetDotRaw(r1, 354);
    Free1(r2);
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:189
    SetDotRaw(r1, 354);
    Free1(r2);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:191
    r2 = 75;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:192
    r2 = 119;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:194
    r2 = 196;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:195
    r2 = 273;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:196
    r2 = 334;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:197
    r2 = 346;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:199
    r2 = 366;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:201
    r2 = 315;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:202
    r2 = 244;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:203
    r2 = 168;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:204
    r2 = 108;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:205
    r2 = 66;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:208
    r2 = 101;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:209
    r2 = 169;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:210
    r2 = 128;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:212
    r2 = 164;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:213
    r2 = 98;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:214
    r2 = 33;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:215
    r2 = 0;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:216
    r2 = 33;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    r1 = GetDotStr("!tuple");  // @src database_wheel.sc:218
    r2 = 0;
    g5 = r8;
    r6 = 2;
    SetDot(r4, 1);
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:222
    SetDotRaw(r1, 354);
    Free1(r2);
    ...
    r2 = GetDotStr("Plane");  // @src database_wheel.sc:223
    SetDotRaw(r1, 354);
    Free1(r2);
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @src database_wheel.sc:225
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @src database_wheel.sc:227
    r5 = r0;
    SetDotRaw(r4, 89);
    Free1(r5);
    GetDot(r3, 0);
    ...
    CallNat2(r1, 11596, 0x0);  // @src database_wheel.sc:233
...
getAllowedTypes()
{
    ...
    CallNat2(r2, 10904, 0x0);  // @src database_wheel.sc:246
...
func_11()
{
    ...
    r1 = GetDotStr("!ppconfig");  // @src database_wheel.sc:61
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("!vec2");  // @src database_wheel.sc:63
    r3 = 0;
    r4 = 0;
    GetDot(r1, 2);
    Free1(r2);
...
func_12()
{
    ...
    r1 = GetDotStr("!ppconfig");  // @src database_wheel.sc:75
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r6 = GetDotStr("!vec2");  // @src database_wheel.sc:83
    r7 = r3;
    r8 = r4;
    GetDot(r5, 2);
    Free1(r6);
    ...
    SetInd(r6);
    LoadFalse(r0);
    RawDword(0x000003c0);  // UNKNOWN opcode 0xc0
    Free2(r6, r5);
  ...
  L_257c:
    ...
    Free2(r7, r6);
    // database_wheel.sc:105
    goto L_269c;  // @src database_wheel.sc:105
...
func_15()
{
  ...
  L_2b28:
    ...
    Call(r3, 0x04d4);  // @src database_wheel.sc:274
  ...
  L_2c7c:
    ...
    Free1(r4);
    // database_wheel.sc:277
    goto L_2c7c;  // @src database_wheel.sc:277
    // database_wheel.sc:276
  L_2cf0:
    r4 = r3;  // @src database_wheel.sc:276
    r4 = Incr(r4);
  ...
  L_2d0c:
    goto L_2b28;  // @src database_wheel.sc:266
}
