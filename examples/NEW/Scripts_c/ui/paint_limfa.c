...
{
    // paint_limfa.sc:30
    r1 = GetDotStr("!vector");  // @src paint_limfa.sc:30
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
...
renderTooltip()
{
    ...
    if (r0) goto L_0218;
    // paint_limfa.sc:50
    r2 = GetDotStr("Plane");  // @src paint_limfa.sc:50
    SetDotRaw(r1, 58);
    Free1(r2);
    g2 = r12;
    r3 = 256;
    ...
    // paint_limfa.sc:51
  L_0218:
    r1 = GetDotStr("format");  // @src paint_limfa.sc:51
    r2 = "%s\n%u / %u";
...
addOverSound()
{
  ...
  L_0368:
    ...
    r_neg5 = r0;
    // paint_limfa.sc:62
    r2 = GetDotStr("Window");  // @src paint_limfa.sc:62
    SetDotRaw(r1, 129);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
{
    // paint_limfa.sc:77
    r1 = GetDotStr("loadSound");  // @src paint_limfa.sc:77
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
onMouseButtonLeft()
{
    ...
    Call(r1, 0x0804);
    // paint_limfa.sc:92
    r1 = GetDotStr("!regionMask");  // @src paint_limfa.sc:92
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    Free1(r0);
    // paint_limfa.sc:93
    r2 = GetDotStr("Plane");  // @src paint_limfa.sc:93
    SetDotRaw(r1, 214);
    Free1(r2);
    r4 = r_neg4;
    SetDotRaw(r3, 209);
    ...
    Free3(r2, r3, r1);
    // paint_limfa.sc:96
    r3 = GetDotStr("Plane");  // @src paint_limfa.sc:96
    SetDotRaw(r2, 247);
    Free1(r3);
    r3 = "fontmain_10.ft";
    GetDot(r1, 1);
...
func_14()
{
    ...
    if (!r0) goto L_0b58;
    // paint_limfa.sc:109
    r2 = GetDotStr("Window");  // @src paint_limfa.sc:109
    SetDotRaw(r1, 129);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
setProgress()
{
    ...
    if (!r0) goto L_0bb0;
    // paint_limfa.sc:120
    r2 = GetDotStr("Window");  // @src paint_limfa.sc:120
    SetDotRaw(r1, 129);
    Free1(r2);
    r2 = "onSetLimfa";
    g3 = r4;
...
setProgress()
{
  ...
  L_0cd0:
    ...
    if (!r0) goto L_0d5c;
    // paint_limfa.sc:147
    r1 = GetDotStr("Plane");  // @src paint_limfa.sc:147
    r1 = (str)r1;
    g3 = r8;
