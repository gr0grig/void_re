...
{
    // readtext.sc:12
    r2 = GetDotStr("Plane");  // @src readtext.sc:12
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "cursor_paint";
    GetDot(r0, 1);
...
onWinKeyDown()
{
    ...
    if (!r0) goto L_010c;
    // readtext.sc:54
    r0 = GetDotStr("Height");  // @src readtext.sc:54
    ...
    // readtext.sc:56
  L_010c:
    r0 = GetDotStr("Height");  // @src readtext.sc:56
    r2 = r_neg4;
    r3 = 1;
    SetDot(r1, 1);
    r0 = r0 - r1;
...
onReturn()
{
  ...
  L_03ac:
    if (!r0) goto L_03cc;
    // readtext.sc:23
    r1 = GetDotStr("destroy");  // @src readtext.sc:23
    GetDot(r0, 0);
    Free2(r1, r0);
    // readtext.sc:25
  L_03cc:
...
{
    // readtext.sc:31
    r1 = GetDotStr("destroy");  // @src readtext.sc:31
    GetDot(r0, 0);
    Free2(r1, r0);
    // readtext.sc:32
