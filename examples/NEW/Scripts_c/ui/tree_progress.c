...
func_1()
{
    ...
    CallMethod(r0, 0, 0x41);  // @patch+8 tree_progress.sc:29
}
...
{
    // tree_progress.sc:33
    r2 = GetDotStr("Plane");  // @src tree_progress.sc:33
    SetDotRaw(r1, 18);
    Free1(r2);
    ...
    Free1(r0);
    // tree_progress.sc:34
    r2 = GetDotStr("Plane");  // @src tree_progress.sc:34
    SetDotRaw(r1, 18);
    Free1(r2);
    ...
    Free1(r0);
    // tree_progress.sc:36
    r1 = GetDotStr("!ppconfig");  // @src tree_progress.sc:36
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    ...
    Free2(r1, r0);
    // tree_progress.sc:40
    r1 = GetDotStr("createImageComposerBuilder");  // @src tree_progress.sc:40
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // tree_progress.sc:41
    ...
    Free3(r2, r3, r1);
    // tree_progress.sc:42
    r2 = GetDotStr("createPostProcessComposer");  // @src tree_progress.sc:42
    r5 = r0;
    SetDotRaw(r4, 321);
    Free1(r5);
    GetDot(r3, 0);
    ...
    Free2(r2, r1);
    // tree_progress.sc:47
    r2 = GetDotStr("!vec3");  // @src tree_progress.sc:47
    r3 = 1;
    r4 = 1;
    r5 = 1;
    GetDot(r1, 3);
