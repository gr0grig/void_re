...
func_1()
{
    ...
    r1 = GetDotStr("!vec3");  // @src health_progress_hud.sc:25
    r2 = 255.0f;
    r3 = 207.0f;
    r4 = 113.0f;
    GetDot(r0, 3);
...
getAllowedTypes()
{
    ...
    r0 = 4.5f;  // @src health_progress_hud.sc:122
    CopyExtRd(r0, 0, 3);
...
func_7()
{
    ...
    r0 = 4.5f;  // @src health_progress_hud.sc:109
    CopyExtRd(r0, 0, 3);
...
func_15()
{
    ...
    r2 = GetDotStr("Plane");  // @src health_progress_hud.sc:34
    SetDotRaw(r1, 24);
    Free1(r2);
    ...
    r2 = GetDotStr("Plane");  // @src health_progress_hud.sc:35
    SetDotRaw(r1, 24);
    Free1(r2);
    ...
    r1 = GetDotStr("!ppconfig");  // @src health_progress_hud.sc:37
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g4;
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @src health_progress_hud.sc:41
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @src health_progress_hud.sc:43
    r5 = r0;
    SetDotRaw(r4, 327);
    Free1(r5);
    GetDot(r3, 0);
...
func_19()
{
    ...
    r1 = GetDotStr("callDef");  // @src health_progress_hud.sc:62
    r2 = false;
    r3 = "isVisible";
    GetDot(r0, 2);
    Free2(r1, r3);
  ...
  L_08e4:
    ...
    r2 = 0;  // @src health_progress_hud.sc:68
    ...
    r4 = GetDotStr("Width");  // @src health_progress_hud.sc:71
    r5 = r1;
    r4 = r4 * r5;
    r5 = r3;
    r4 = r4 / r5;
    ...
    r5 = GetDotStr("Width");  // @src health_progress_hud.sc:72
    r6 = r2;
    r5 = r5 * r6;
    r6 = r3;
    r5 = r5 / r6;
