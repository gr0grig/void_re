...
{
    // loading.sc:78
    r2 = GetDotStr("Plane");  // @src loading.sc:78
    SetDotRaw(r1, 6);
    Free1(r2);
    ...
    Free1(r0);
    // loading.sc:80
    r1 = GetDotStr("createRTImage");  // @src loading.sc:80
    r2 = 800;
    r3 = 600;
    r4 = true;
    r5 = "ui/paint_image";
  ...
  L_0160:
    ...
    Free3(r2, r3, r1);
    // loading.sc:86
    r1 = GetDotStr("Height");  // @src loading.sc:86
    r1 = (float)r1;
    r2 = 900.0f;
    r1 = r1 / r2;
    // loading.sc:87
    ...
    if (!r3) goto L_0248;
    // loading.sc:89
    r3 = GetDotStr("Width");  // @src loading.sc:89
    r3 = (float)r3;
    r4 = 1440.0f;
    r3 = r3 / r4;
    r1 = r3;
...
initLoading()
{
    ...
    r6 = (float)r6;
    // loading.sc:157
    r8 = GetDotStr("!tuple");  // @src loading.sc:157
    r9 = r5;
    r10 = r6;
    GetDot(r7, 2);
    Free1(r8);
    ...
    r6 = (float)r6;
    // loading.sc:166
    r8 = GetDotStr("!tuple");  // @src loading.sc:166
    r9 = r5;
    r10 = r6;
    GetDot(r7, 2);
    Free1(r8);
  ...
  L_0614:
    ...
    r6 = (float)r6;
    // loading.sc:175
    r8 = GetDotStr("!tuple");  // @src loading.sc:175
    r9 = r5;
    r10 = r6;
    GetDot(r7, 2);
    Free1(r8);
    ...
    r6 = (float)r6;
    // loading.sc:184
    r8 = GetDotStr("!tuple");  // @src loading.sc:184
    r9 = r5;
    r10 = r6;
    GetDot(r7, 2);
    Free1(r8);
...
{
    // loading.sc:195
    r0 = GetDotStr("Width");  // @src loading.sc:195
    r1 = 1024.0f;
    g2 = r2;
    r1 = r1 * r2;
    r0 = r0 - r1;
    ...
    r0 = (int)r0;
    // loading.sc:196
    r1 = GetDotStr("Height");  // @src loading.sc:196
    r2 = 1024.0f;
    g3 = r3;
    r2 = r2 * r3;
    r1 = r1 - r2;
...
{
    // loading.sc:118
    r1 = GetDotStr("createAnimations");  // @src loading.sc:118
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // loading.sc:119
    ...
    // loading.sc:126
    r1 = GetDotStr("createAnimations");  // @src loading.sc:126
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // loading.sc:127
