...
initUI()
{
    ...
    if (!r0) goto L_007c;
    // gameover.sc:50
    r1 = GetDotStr("sendGenericEventToLoop");  // @src gameover.sc:50
...
func_4()
{
    ...
    // gameover.sc:56
    r0 = GetDotStr("Width");  // @src gameover.sc:56
    CopyExtWr(r1, 2, 1);
    SetDotRaw(r1, 70);
    Free1(r2);
    r0 = r0 * r1;
...
func_5()
{
    ...
    // gameover.sc:22
    r3 = GetDotStr("Plane");  // @src gameover.sc:22
    SetDotRaw(r2, 105);
    Free1(r3);
    r3 = "gameover.the";
    GetDot(r1, 1);
    ...
    Free1(r1);
    // gameover.sc:23
    r2 = GetDotStr("Plane");  // @src gameover.sc:23
    r2 = (str)r2;
    ...
    Free1(r1);
    // gameover.sc:24
    r2 = GetDotStr("Plane");  // @src gameover.sc:24
    r2 = (str)r2;
    r4 = GetDotStr("loadSound");
  ...
  L_03b0:
    ...
    // gameover.sc:44
  L_03ec:
    r2 = GetDotStr("sendGenericEventToLoop");  // @src gameover.sc:44
