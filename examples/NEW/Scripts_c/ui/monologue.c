...
{
    // monologue.sc:77
    r2 = GetDotStr("Plane");  // @src monologue.sc:77
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "fontmain_11.ft";
    GetDot(r0, 1);
    ...
    if (r1) goto L_0278;
    // monologue.sc:79
    r3 = GetDotStr("Plane");  // @src monologue.sc:79
    SetDotRaw(r2, 43);
    Free1(r3);
    r3 = r0;
    r4 = 256;
    ...
    // monologue.sc:81
  L_0278:
    r2 = GetDotStr("format");  // @src monologue.sc:81
...
hideControl()
{
    ...
    // monologue.sc:64
  L_04f8:
    r0 = GetDotStr("Width");  // @src monologue.sc:64
    r1 = 0.5f;
    r0 = r0 * r1;
    g2 = r7;
    r3 = 0;
...
{
    // monologue.sc:98
    r2 = GetDotStr("Plane");  // @src monologue.sc:98
    SetDotRaw(r1, 160);
    Free1(r2);
    ...
    Free1(r0);
    // monologue.sc:100
    r1 = GetDotStr("!regionMask");  // @src monologue.sc:100
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // monologue.sc:101
    r2 = GetDotStr("Plane");  // @src monologue.sc:101
    SetDotRaw(r1, 160);
    Free1(r2);
...
func_10()
{
  ...
  L_090c:
    ...
    Free2(r6, r0);
    // monologue.sc:114
    r2 = GetDotStr("Plane");  // @src monologue.sc:114
    SetDotRaw(r1, 310);
    Free1(r2);
    GetDot(r0, 0);
    Free1(r1);
...
onMouseEnter()
{
  ...
  L_0a88:
    ...
    if (!r0) goto L_0ad0;
    // monologue.sc:124
    r2 = GetDotStr("Window");  // @src monologue.sc:124
    SetDotRaw(r1, 335);
    Free1(r2);
    r2 = "onMonologueMode";
    r3 = true;
