// gscript: vein_zewC.bin
// @version: 0
// @globals: 10 types=03 01 01 01 01 01 01 01 03 03
// @func_table: 7 groups offsets=28,88,178,348,439,529,672
// @ft_group 0: parent=-1 stack=0 locals=0 vtable=[] imports=[(0,0)]
//   export "getVeinLimfaType" args=0 cb=-1 {func_30}
// @ft_group 1: parent=0 stack=0 locals=0 vtable=[] imports=[(1,0)]
//   export "initVein" args=6 cb=-1 {func_3} types=[int,int,int,int,bool,bool]
//   export "getVeinLimfaType" args=0 cb=-1 {func_30}
// @ft_group 2: parent=0 stack=2 locals=2 types=[str,bool] vtable=[] imports=[(2,0)]
//   export "isOpenVein" args=0 cb=-1 {func_6}
//   export "getVeinLimfaType" args=0 cb=-1 {func_7}
//   export "getVeinLocator" args=0 cb=-1 {func_8}
//   export "getVeinType" args=0 cb=-1 {func_9}
//   export "onHarpoon" args=0 cb=-1 {func_10}
// @ft_group 3: parent=0 stack=0 locals=0 vtable=[] imports=[(3,0)]
//   export "onFireworkHit" args=2 cb=-1 {func_18} types=[int,int]
//   export "getVeinLimfaType" args=0 cb=-1 {func_30}
// @ft_group 4: parent=0 stack=1 locals=1 types=[float] vtable=[] imports=[(4,0)]
//   export "setAmplitude" args=1 cb=-1 {func_13} types=[float]
//   export "getVeinLimfaType" args=0 cb=-1 {func_30}
// @ft_group 5: parent=0 stack=0 locals=0 vtable=[] imports=[(5,0)]
//   export "isOpenVein" args=0 cb=-1 {func_19}
//   export "getVeinLimfaType" args=0 cb=-1 {func_20}
//   export "getVeinLocator" args=0 cb=-1 {func_21}
//   export "getVeinType" args=0 cb=-1 {func_22}
// @ft_group 6: parent=0 stack=0 locals=0 vtable=[] imports=[(6,0)]
//   export "onFireworkHit" args=2 cb=-1 {func_27} types=[int,int]
//   export "getVeinLimfaType" args=0 cb=-1 {func_30}
// #export {func_3} name="initVein"
// #export {func_6} name="isOpenVein"
// #export {func_7} name="getVeinLimfaType"
// #export {func_8} name="getVeinLocator"
// #export {func_9} name="getVeinType"
// #export {func_10} name="onHarpoon"
// #export {func_13} name="setAmplitude"
// #export {func_18} name="onFireworkHit"
// #export {func_19} name="isOpenVein"
// #export {func_20} name="getVeinLimfaType"
// #export {func_21} name="getVeinLocator"
// #export {func_22} name="getVeinType"
// #export {func_27} name="onFireworkHit"
// #export {func_30} name="getVeinLimfaType"
...
func_1()
{
    ...
    SetDotStr(r17, "Visible");
}

// vein_zewC.sc:12 (locals=3)
func_2()
{
    // vein_zewC.sc:7
    r1 = GetDotStr("!geometryCache");  // @src vein_zewC.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // vein_zewC.sc:8
    g2 = r9;  // @src vein_zewC.sc:8
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewC_part1.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewC.sc:9
    g2 = r9;  // @src vein_zewC.sc:9
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewC_part2.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewC.sc:10
    g2 = r9;  // @src vein_zewC.sc:10
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewC_part3.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewC.sc:11
    g2 = r9;  // @src vein_zewC.sc:11
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewC_part4.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewC.sc:12
    return r0;  // @src vein_zewC.sc:12
}
...
getVeinLimfaType()
{
    ...
    CallNat2(r2, 1352, 0x201);
    // vein_base.sci:83
    goto L_033c;  // @src vein_base.sci:83
    // vein_base.sci:87
  L_0330:
    CallNat2(r3, 3876, 0x200);  // @src vein_base.sci:87
    // vein_base.sci:89
  L_033c:
...
// vein_zewC.sc:31 (locals=6)
func_4()
{
    // vein_zewC.sc:29
    r1 = GetDotStr("findMaterial");  // @src vein_zewC.sc:29
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewC.sc:30
    r2 = GetDotStr("setLocalGeomParameterColor");  // @src vein_zewC.sc:30
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // vein_zewC.sc:31
    Free1(r_neg4);  // @src vein_zewC.sc:31
    return r0;
}
...
onFireworkHit()
{
    ...
    CopyExtRd(r0, 1, 2);
    // vein_base.sci:120
    Call(r0, 0x04d0);  // @src vein_base.sci:120
    // vein_base.sci:121
...
func_12()
{
    ...
    r0 = 0x49;
    RawDword(0x0000022d);  // UNKNOWN opcode 0x2d
    // vein_base.sci:135
    ...
    Free1(r1);
    // vein_base.sci:137
    Call(r1, 0x04d0);  // @src vein_base.sci:137
    // vein_base.sci:138
  ...
  L_0624:
    ...
    // vein_base.sci:140
  L_0678:
    goto L_0624;  // @src vein_base.sci:140
    // vein_base.sci:146
  L_0680:
...
func_14()
{
  ...
  L_0780:
    ...
    r0 = r4;
    // vein_base.sci:27
    goto L_0710;  // @src vein_base.sci:27
}

// vein_zewC.sc:38 (locals=9)
func_15()
{
    // vein_zewC.sc:36
    r1 = GetDotStr("findMaterial");  // @src vein_zewC.sc:36
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewC.sc:37
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @src vein_zewC.sc:37
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:166
    CallNat2(r5, 2432, 0x0);  // @src vein_base.sci:166
    // vein_base.sci:167
...
func_23()
{
  ...
  L_0c88:
    ...
    CallNat(r2, 1352, 0x401);
}

// vein_zewC.sc:25 (locals=7)
func_24()
{
    // vein_zewC.sc:16
    r0 = null_str2;  // @src vein_zewC.sc:16
    // vein_zewC.sc:17
    r3 = GetDotStr("World");  // @src vein_zewC.sc:17
    SetDotRaw(r2, 811);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_zewC_part1.pre";
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:19
    r3 = GetDotStr("World");  // @src vein_zewC.sc:19
    SetDotRaw(r2, 811);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_zewC_part2.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:21
    r3 = GetDotStr("World");  // @src vein_zewC.sc:21
    SetDotRaw(r2, 811);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_zewC_part3.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:23
    r3 = GetDotStr("World");  // @src vein_zewC.sc:23
    SetDotRaw(r2, 811);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "minewalls/minewall_zewC_part4.pre";
    r5 = GetDotStr("Transform");
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:25
    Free2(r0, r_neg4);  // @src vein_zewC.sc:25
    return r0;
}
...
func_25()
{
    ...
    Call(r2, 0x0f88);
    // vein_base.sci:161
    CallNat(r6, 4100, 0x0);  // @src vein_base.sci:161
}
...
{
    // vein_base.sci:195
    CallNat2(r5, 2432, 0x0);  // @src vein_base.sci:195
    // vein_base.sci:196
...
func_28()
{
  ...
  L_1080:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 557, 0x20a);  // @patch+8 vein_base.sci:186
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
    // vein_base.sci:182
    goto L_1080;  // @src vein_base.sci:182
    // vein_base.sci:180
  L_1120:
    r2 = r1;  // @src vein_base.sci:180
    r2 = Incr(r2);
    ...
    // vein_base.sci:190
  L_113c:
    CallNat(r6, 4100, 0x100);  // @src vein_base.sci:190
}
