...
func_1()
{
    ...
    Free1(r0);
    // fx_hole_smoke.sc:14
    r1 = GetDotStr("loadSound3D");  // @src fx_hole_smoke.sc:14
    ...
    Free1(r0);
    // fx_hole_smoke.sc:15
    r1 = GetDotStr("loadSound3D");  // @src fx_hole_smoke.sc:15
    r2 = "hole_mine_loop";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // fx_hole_smoke.sc:16
    r1 = GetDotStr("loadSound3D");  // @src fx_hole_smoke.sc:16
    ...
    Free1(r0);
    // fx_hole_smoke.sc:18
    CallNat(r1, 5596, 0x0);  // @src fx_hole_smoke.sc:18
}
...
initProc()
{
    ...
    r0 = g6;
    // fx_hole_smoke.sc:39
    r2 = GetDotStr("Scene");  // @src fx_hole_smoke.sc:39
    SetDotRaw(r1, 164);
    Free1(r2);
    r2 = "ironclad";
    GetDot(r0, 1);
    ...
    if (r0) goto L_01bc;
    // fx_hole_smoke.sc:42
    r1 = GetDotStr("remove");  // @src fx_hole_smoke.sc:42
    GetDot(r0, 0);
    Free2(r1, r0);
    // fx_hole_smoke.sc:45
  L_01bc:
    ...
    // fx_hole_smoke.sc:47
    r2 = GetDotStr("!vec3");  // @src fx_hole_smoke.sc:47
    r5 = r0;
    SetDotRaw(r4, 204);
    Free1(r5);
    SetDotRaw(r3, 86);
...
func_9()
{
    ...
    r3 = GetDotStr("World");  // @src fx_hole_smoke.sc:109
    SetDotRaw(r2, 422);
    Free1(r3);
    SetDotRaw(r1, 433);
    Free1(r2);
    ...
    r3 = GetDotStr("World");  // @src fx_hole_smoke.sc:111
    SetDotRaw(r2, 479);
    Free1(r3);
    r3 = GetDotStr("Scene");
  ...
  L_08a0:
    r7 = GetDotStr("self");  // @src fx_hole_smoke.sc:126
    r7 = (str)r7;
    Call(r8, 0x0dc0);
    r7 = 0;
    SetDot(r5, 1);
    ...
    r7 = GetDotStr("World");  // @src fx_hole_smoke.sc:129
    SetDotRaw(r6, 303);
    Free1(r7);
    r7 = "runPPEffect";
    r10 = GetDotStr("!vec3");
...
func_11()
{
    ...
    r1 = GetDotStr("!qtpair");  // @src fx_hole_smoke.sc:144
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_hole_smoke.sc:145
    r1 = GetDotStr("Position");  // @src fx_hole_smoke.sc:145
    r2 = r0;
    SetInd(r2);
    r0 = 760;
    Free2(r2, r1);
    // fx_hole_smoke.sc:146
    r3 = GetDotStr("World");  // @src fx_hole_smoke.sc:146
    SetDotRaw(r2, 479);
    Free1(r3);
    r3 = GetDotStr("Scene");
  ...
  L_0d9c:
    r3 = GetDotStr("remove");  // @src fx_hole_smoke.sc:159
    GetDot(r2, 0);
    Free2(r3, r2);
...
func_12()
{
    ...
    // ../../std.sci:1104
  L_0df0:
    Call(r1, 0x03f0);  // @src ../../std.sci:1104
    // ../../std.sci:1105
...
func_20()
{
  ...
  L_141c:
    ...
    goto L_141c;  // @src ..\..\posteffects\darken.sci:112
  ...
  L_1524:
    ...
    goto L_1524;  // @src ..\..\posteffects\darken.sci:128
    // ..\..\posteffects\darken.sci:120
  L_1540:
    goto L_1470;  // @src ..\..\posteffects\darken.sci:120
}
