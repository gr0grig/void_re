...
func_1()
{
    ...
    CallMethod(r0, 27, 0x142);  // @patch+8 fx_ironclad_cannon.sc:18
    r5 = Neg(r5);
    ...
    r1 = GetDotStr("!vec3");  // @src fx_ironclad_cannon.sc:58
    r3 = GetDotStr("rand");
    GetDot(r2, 0);
    Free1(r3);
    r4 = GetDotStr("rand");
    ...
    r1 = GetDotStr("!qtpair");  // @src fx_ironclad_cannon.sc:60
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_ironclad_cannon.sc:61
    r1 = GetDotStr("Position");  // @src fx_ironclad_cannon.sc:61
    r2 = r0;
    SetInd(r2);
    r0 = 88;
    Free2(r2, r1);
    // fx_ironclad_cannon.sc:62
    r3 = GetDotStr("World");  // @src fx_ironclad_cannon.sc:62
    SetDotRaw(r2, 106);
    Free1(r3);
    r3 = GetDotStr("Scene");
...
func_3()
{
    ...
    r2 = GetDotStr("Position");  // @src fx_ironclad_cannon.sc:77
    SetDotRaw(r1, 69);
    Free1(r2);
    r2 = 0.25f;
    r1 = r1 + r2;
    ...
    r4 = GetDotStr("!vec3");  // @src fx_ironclad_cannon.sc:78
    r7 = r0;
    SetDotRaw(r6, 79);
    Free1(r7);
    SetDotRaw(r5, 262);
    ...
    r4 = GetDotStr("!vec3");  // @src fx_ironclad_cannon.sc:79
    r7 = r0;
    SetDotRaw(r6, 79);
    Free1(r7);
    SetDotRaw(r5, 262);
    ...
    r5 = GetDotStr("applyForce");  // @src fx_ironclad_cannon.sc:83
    r6 = GetDotStr("Mass");
    r7 = r3;
    r6 = r6 * r7;
    r7 = r2;
    ...
    r6 = GetDotStr("Position");  // @src fx_ironclad_cannon.sc:88
    g8 = r2;
    SetDotRaw(r7, 79);
    Free1(r8);
    r6 = r6 - r7;
...
func_8()
{
  ...
  L_0588:
    ...
    r2 = GetDotStr("!vec3");  // @src fx_ironclad_cannon.sc:30
    GetDot(r1, 0);
    Free1(r2);
...
func_9()
{
  ...
  L_0630:
    ...
    r2 = GetDotStr("irandRange");  // @src fx_ironclad_cannon.sc:113
    r3 = 1;
    r4 = 3;
    GetDot(r1, 2);
    Free1(r2);
    ...
    r4 = GetDotStr("randRange");  // @src fx_ironclad_cannon.sc:115
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r6 = GetDotStr("World");  // @src fx_ironclad_cannon.sc:116
    SetDotRaw(r5, 348);
    Free1(r6);
    r6 = GetDotStr("Scene");
  ...
  L_08dc:
    ...
    r4 = GetDotStr("World");  // @src fx_ironclad_cannon.sc:138
    SetDotRaw(r3, 106);
    Free1(r4);
    r4 = GetDotStr("Scene");
    ...
    r5 = GetDotStr("World");  // @src fx_ironclad_cannon.sc:140
    SetDotRaw(r4, 348);
    Free1(r5);
    r5 = GetDotStr("Scene");
    ...
    r5 = GetDotStr("loadSound3D");  // @src fx_ironclad_cannon.sc:143
    ...
    r5 = GetDotStr("Scene");  // @src fx_ironclad_cannon.sc:146
    SetDotRaw(r4, 942);
    Free1(r5);
    ...
    r4 = GetDotStr("remove");  // @src fx_ironclad_cannon.sc:150
    GetDot(r3, 0);
    Free2(r4, r3);
