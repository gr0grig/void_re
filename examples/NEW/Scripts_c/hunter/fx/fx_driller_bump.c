...
func_1()
{
    ...
    r1 = GetDotStr("GeomTransparency");  // @src fx_driller_bump.sc:9
    r2 = r0;
    r1 = r1 - r2;
    CallMethod(r1, 0, 0x14a);
    // fx_driller_bump.sc:7
    r0 = GetDotStr("GeomTransparency");  // @src fx_driller_bump.sc:7
    r1 = 0.0f;
    r0 = r0 > r1;
    if (r0) goto L_002c;
...
func_4()
{
  ...
  L_00e0:
    ...
    r1 = GetDotStr("GeomTransparency");  // @src fx_driller_bump.sc:32
    r2 = r0;
    r1 = r1 + r2;
    CallMethod(r1, 0, 0x14a);
    // fx_driller_bump.sc:30
    r0 = GetDotStr("GeomTransparency");  // @src fx_driller_bump.sc:30
    r1 = 1.0f;
    r0 = r0 < r1;
    if (r0) goto L_00e0;
    // fx_driller_bump.sc:35
    r1 = GetDotStr("remove");  // @src fx_driller_bump.sc:35
    GetDot(r0, 0);
    Free2(r1, r0);
...
remove()
{
    ...
    r1 = GetDotStr("setPosition");  // @src fx_driller_bump.sc:20
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
