...
onUse()
{
    ...
    r1 = GetDotStr("remove");  // @src fx_ironclad_homing_cannon.sc:61
    GetDot(r0, 0);
    Free2(r1, r0);
  ...
  L_00a4:
    ...
    r1 = GetDotStr("remove");  // @src fx_ironclad_homing_cannon.sc:70
    GetDot(r0, 0);
    Free2(r1, r0);
  ...
  L_00ec:
    ...
    r1 = GetDotStr("!vec3");  // @src fx_ironclad_homing_cannon.sc:78
    r3 = GetDotStr("rand");
    GetDot(r2, 0);
    Free1(r3);
    r4 = GetDotStr("rand");
    ...
    r1 = GetDotStr("!qtpair");  // @src fx_ironclad_homing_cannon.sc:80
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_ironclad_homing_cannon.sc:81
    r1 = GetDotStr("Position");  // @src fx_ironclad_homing_cannon.sc:81
    r2 = r0;
    SetInd(r2);
    r0 = 112;
    Free2(r2, r1);
    // fx_ironclad_homing_cannon.sc:82
    r3 = GetDotStr("World");  // @src fx_ironclad_homing_cannon.sc:82
    SetDotRaw(r2, 130);
    Free1(r3);
    r3 = GetDotStr("Scene");
...
func_4()
{
    ...
    r2 = GetDotStr("applyForce");  // @src fx_ironclad_homing_cannon.sc:97
    g3 = r2;
    r4 = r0;
    r3 = r3 * r4;
    r4 = 16;
  ...
  L_0300:
    ...
    r2 = GetDotStr("Position");  // @src fx_ironclad_homing_cannon.sc:103
    g3 = r0;
    SetInd(r3);
...
func_6()
{
  ...
  L_03dc:
    ...
    r3 = GetDotStr("applyForce");  // @src fx_ironclad_homing_cannon.sc:132
    r4 = r1;
    r6 = r0;
    SetDotRaw(r5, 103);
    Free1(r6);
    ...
    r3 = GetDotStr("applyForce");  // @src fx_ironclad_homing_cannon.sc:133
    r4 = r1;
    r6 = GetDotStr("!vec3");
    r7 = 0;
    r8 = 5;
    ...
    r2 = GetDotStr("Position");  // @src fx_ironclad_homing_cannon.sc:135
    g3 = r0;
    SetInd(r3);
    r0 = 1.4433374182545616e-43f;
    Free2(r3, r2);
  ...
  L_0518:
    r1 = GetDotStr("self");  // @src fx_ironclad_homing_cannon.sc:138
...
func_8()
{
  ...
  L_05ac:
    ...
    r2 = GetDotStr("irandRange");  // @src fx_ironclad_homing_cannon.sc:153
    r3 = 1;
    r4 = 3;
    GetDot(r1, 2);
    Free1(r2);
    ...
    r4 = GetDotStr("randRange");  // @src fx_ironclad_homing_cannon.sc:155
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r6 = GetDotStr("World");  // @src fx_ironclad_homing_cannon.sc:156
    SetDotRaw(r5, 382);
    Free1(r6);
    r6 = GetDotStr("Scene");
  ...
  L_06f0:
    ...
    r5 = 48000;  // @src fx_ironclad_homing_cannon.sc:170
    r6 = 1;
    r7 = r2;
    r8 = 4.0f;
    r7 = r7 / r8;
  ...
  L_0858:
    ...
    r3 = GetDotStr("!qtpair");  // @src fx_ironclad_homing_cannon.sc:178
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    // fx_ironclad_homing_cannon.sc:179
    r3 = GetDotStr("Position");  // @src fx_ironclad_homing_cannon.sc:179
    r5 = GetDotStr("!vec3");
    r6 = 0;
    r7 = 0.25f;
    r8 = 0;
    ...
    r6 = GetDotStr("Scene");  // @src fx_ironclad_homing_cannon.sc:183
    SetDotRaw(r5, 648);
    Free1(r6);
    r6 = GetDotStr("Position");
    r7 = 7;
    ...
    r5 = GetDotStr("loadSound3D");  // @src fx_ironclad_homing_cannon.sc:189
    ...
    r5 = GetDotStr("remove");  // @src fx_ironclad_homing_cannon.sc:191
    GetDot(r4, 0);
    Free2(r5, r4);
...
func_11()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:267
    r2 = GetDotStr("playSound3D");  // @src ..\..\sound.sci:267
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:268
    r6 = GetDotStr("Globals");  // @src ..\..\sound.sci:268
    SetDotRaw(r5, 800);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
