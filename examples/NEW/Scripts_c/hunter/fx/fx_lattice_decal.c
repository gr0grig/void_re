...
func_1()
{
    ...
    r1 = GetDotStr("setKinematic");  // @src fx_lattice_decal.sc:12
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    GetDot(r0, 3);
    Free1(r1);
    r1 = GetDotStr("Rotation");
    r0 = r0 * r1;
    r0 = (str)r0;
    // fx_lattice_decal.sc:17
    r2 = GetDotStr("setRotation");  // @src fx_lattice_decal.sc:17
  ...
  L_0124:
    ...
    r2 = GetDotStr("GeomTransparency");  // @src fx_lattice_decal.sc:21
    r3 = r1;
    r2 = r2 - r3;
    CallMethod(r2, 42, 0x24a);
    // fx_lattice_decal.sc:19
    r1 = GetDotStr("GeomTransparency");  // @src fx_lattice_decal.sc:19
    r2 = 0;
    r1 = r1 > r2;
    if (r1) goto L_0124;
...
func_3()
{
  ...
  L_0204:
    ...
    r1 = GetDotStr("GeomTransparency");  // @src fx_lattice_decal.sc:38
    r2 = r0;
    r1 = r1 + r2;
    CallMethod(r1, 42, 0x14a);
    // fx_lattice_decal.sc:36
    r0 = GetDotStr("GeomTransparency");  // @src fx_lattice_decal.sc:36
    r1 = 1;
    r0 = r0 < r1;
    if (r0) goto L_0204;
    // fx_lattice_decal.sc:40
    r1 = GetDotStr("remove");  // @src fx_lattice_decal.sc:40
    GetDot(r0, 0);
    Free2(r1, r0);
