...
func_1()
{
    ...
    r1 = GetDotStr("GeomTransparency");  // @src fx_driller_decal.sc:12
    r2 = r0;
    r1 = r1 - r2;
    CallMethod(r1, 0, 0x14a);
    // fx_driller_decal.sc:10
    r0 = GetDotStr("GeomTransparency");  // @src fx_driller_decal.sc:10
    r1 = 0.0f;
    r0 = r0 > r1;
    if (r0) goto L_002c;
    // fx_driller_decal.sc:16
    r2 = GetDotStr("World");  // @src fx_driller_decal.sc:16
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = GetDotStr("Scene");
  ...
  L_0470:
    ...
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:34
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0524:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:35
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_05bc:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:36
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0654:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:37
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_06ec:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:38
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0784:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:39
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_081c:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:40
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_08b4:
    r2 = GetDotStr("rand");  // @src fx_driller_decal.sc:41
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0954:
    r1 = GetDotStr("remove");  // @src fx_driller_decal.sc:44
    GetDot(r0, 0);
    Free2(r1, r0);
