...
func_1()
{
  ...
  L_01f4:
    ...
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:23
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0260:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:24
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_02b0:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:25
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0300:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:26
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0350:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:27
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_03a0:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:28
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_03f0:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:29
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_0440:
    r2 = GetDotStr("rand");  // @src fx_ironclad_cannon_decal.sc:30
    GetDot(r1, 0);
    Free1(r2);
    r2 = 0.5f;
    r1 = r1 < r2;
  ...
  L_04ac:
    r1 = GetDotStr("remove");  // @src fx_ironclad_cannon_decal.sc:33
    GetDot(r0, 0);
    Free2(r1, r0);
