...
// hunter_04_mongolfier_talk.sc:73 (locals=6)
func_1()
{
    // hunter_04_mongolfier_talk.sc:53
    r1 = GetDotStr("loadAnimationSet");  // @src hunter_04_mongolfier_talk.sc:53
    r2 = "anim/hunter_04_mongolfier_talk.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // hunter_04_mongolfier_talk.sc:56
  L_0040:
    r1 = GetDotStr("playAnimation");  // @src hunter_04_mongolfier_talk.sc:56
    r2 = "idle";
    ...
    Free2(r1, r2);
    r0 = (str)r0;
    // hunter_04_mongolfier_talk.sc:57
    r2 = r0;  // @src hunter_04_mongolfier_talk.sc:57
    GetDot(r1, 0);
    Free2(r2, r1);
    // hunter_04_mongolfier_talk.sc:58
    r2 = 0;  // @src hunter_04_mongolfier_talk.sc:58
    Call(r3, 0x0184);
    // hunter_04_mongolfier_talk.sc:60
    r2 = GetDotStr("makeAttachPoint");  // @src hunter_04_mongolfier_talk.sc:60
    r3 = "Head";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    r1 = g8;
    Free1(r1);
    // hunter_04_mongolfier_talk.sc:62
    g1 = r7;  // @src hunter_04_mongolfier_talk.sc:62
    if (r1) goto L_0128;
    // hunter_04_mongolfier_talk.sc:63
    g2 = r8;  // @src hunter_04_mongolfier_talk.sc:63
    SetDotRaw(r1, 140);
    Free1(r2);
    r1 = (str)r1;
    r1 = g7;
  ...
  L_0128:
    Free1(r2);  // @src hunter_04_mongolfier_talk.sc:67
    RetV(r1);
    r1 = (int)r1;
    // hunter_04_mongolfier_talk.sc:68
    r3 = r0;  // @src hunter_04_mongolfier_talk.sc:68
    r4 = r1;
    GetDot(r2, 1);
    Free1(r3);
    if (r2) goto L_0160;
    // hunter_04_mongolfier_talk.sc:69
    goto L_0178;  // @src hunter_04_mongolfier_talk.sc:69
    // hunter_04_mongolfier_talk.sc:70
  L_0160:
    r3 = r1;  // @src hunter_04_mongolfier_talk.sc:70
    Call(r4, 0x0184);
    // hunter_04_mongolfier_talk.sc:66
    goto L_0128;  // @src hunter_04_mongolfier_talk.sc:66
    // hunter_04_mongolfier_talk.sc:55
  L_0178:
    Free1(r0);  // @src hunter_04_mongolfier_talk.sc:55
    goto L_0040;
}
...
onSubtitleChange()
{
  ...
  L_107c:
    ...
    Free1(r2);
    // hunter_lipsync.sci:101
    goto L_1150;  // @src hunter_lipsync.sci:101
...
// hunter_04_mongolfier_talk.sc:9 (locals=1)
getLookFromPosition()
{
    // hunter_04_mongolfier_talk.sc:8
    r0 = 4;  // @src hunter_04_mongolfier_talk.sc:8
    r_neg4 = r0;
    return r0;
}

// hunter_04_mongolfier_talk.sc:22 (locals=6)
getLookAtPosition()
{
    // hunter_04_mongolfier_talk.sc:13
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:13
    r1 = 0;
    r0 = r0 == r1;
    if (!r0) goto L_12e4;
    // hunter_04_mongolfier_talk.sc:14
    g0 = r7;  // @src hunter_04_mongolfier_talk.sc:14
    r2 = GetDotStr("!vec3");
    r3 = 0;
    r4 = -7;
    r5 = 37;
  ...
  L_12e4:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:15
    r1 = 1;
    r0 = r0 == r1;
    if (!r0) goto L_1388;
    // hunter_04_mongolfier_talk.sc:16
    g0 = r7;  // @src hunter_04_mongolfier_talk.sc:16
    r2 = GetDotStr("!vec3");
    r3 = 0;
    r4 = -10;
    r5 = 25;
  ...
  L_1388:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:17
    r1 = 2;
    r0 = r0 == r1;
    if (!r0) goto L_142c;
    // hunter_04_mongolfier_talk.sc:18
    g0 = r7;  // @src hunter_04_mongolfier_talk.sc:18
    r2 = GetDotStr("!vec3");
    r3 = 0;
    r4 = -8;
    r5 = 14;
  ...
  L_142c:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:19
    r1 = 3;
    r0 = r0 == r1;
    if (!r0) goto L_14d0;
    // hunter_04_mongolfier_talk.sc:20
    g0 = r7;  // @src hunter_04_mongolfier_talk.sc:20
    r2 = GetDotStr("!vec3");
    r3 = 0;
    ...
    Free1(r0);
    return r0;
    // hunter_04_mongolfier_talk.sc:21
  L_14d0:
    r0 = null_str;  // @src hunter_04_mongolfier_talk.sc:21
    r_neg5 = r0;
    Free1(r0);
    return r0;
}

// hunter_04_mongolfier_talk.sc:35 (locals=6)
getCameraFOV()
{
    // hunter_04_mongolfier_talk.sc:26
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:26
    r1 = 0;
    r0 = r0 == r1;
    if (!r0) goto L_1590;
    // hunter_04_mongolfier_talk.sc:27
    g1 = r8;  // @src hunter_04_mongolfier_talk.sc:27
    SetDotRaw(r0, 140);
    Free1(r1);
    r2 = GetDotStr("!vec3");
    r3 = -5.0f;
  ...
  L_1590:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:28
    r1 = 1;
    r0 = r0 == r1;
    if (!r0) goto L_1634;
    // hunter_04_mongolfier_talk.sc:29
    g1 = r8;  // @src hunter_04_mongolfier_talk.sc:29
    SetDotRaw(r0, 140);
    Free1(r1);
    r2 = GetDotStr("!vec3");
    r3 = 0.0f;
  ...
  L_1634:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:30
    r1 = 2;
    r0 = r0 == r1;
    if (!r0) goto L_16d8;
    // hunter_04_mongolfier_talk.sc:31
    g1 = r8;  // @src hunter_04_mongolfier_talk.sc:31
    SetDotRaw(r0, 140);
    Free1(r1);
    r2 = GetDotStr("!vec3");
    r3 = 0.0f;
  ...
  L_16d8:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:32
    r1 = 3;
    r0 = r0 == r1;
    if (!r0) goto L_177c;
    // hunter_04_mongolfier_talk.sc:33
    g1 = r8;  // @src hunter_04_mongolfier_talk.sc:33
    SetDotRaw(r0, 140);
    Free1(r1);
    r2 = GetDotStr("!vec3");
    r3 = 3;
    ...
    Free1(r0);
    return r0;
    // hunter_04_mongolfier_talk.sc:34
  L_177c:
    r0 = null_str;  // @src hunter_04_mongolfier_talk.sc:34
    r_neg5 = r0;
    Free1(r0);
    return r0;
}

// hunter_04_mongolfier_talk.sc:49 (locals=2)
func_9()
{
    // hunter_04_mongolfier_talk.sc:39
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:39
    r1 = 0;
    r0 = r0 == r1;
    if (!r0) goto L_17c8;
    // hunter_04_mongolfier_talk.sc:40
    r0 = 0.669261634349823f;  // @src hunter_04_mongolfier_talk.sc:40
    r_neg5 = r0;
    return r0;
    // hunter_04_mongolfier_talk.sc:41
  L_17c8:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:41
    r1 = 1;
    r0 = r0 == r1;
    if (!r0) goto L_17f8;
    // hunter_04_mongolfier_talk.sc:42
    r0 = 0.3936832845211029f;  // @src hunter_04_mongolfier_talk.sc:42
    r_neg5 = r0;
    return r0;
    // hunter_04_mongolfier_talk.sc:43
  L_17f8:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:43
    r1 = 2;
    r0 = r0 == r1;
    if (!r0) goto L_1828;
    // hunter_04_mongolfier_talk.sc:44
    r0 = 0.32806938886642456f;  // @src hunter_04_mongolfier_talk.sc:44
    r_neg5 = r0;
    return r0;
    // hunter_04_mongolfier_talk.sc:45
  L_1828:
    r0 = r_neg4;  // @src hunter_04_mongolfier_talk.sc:45
    r1 = 3;
    r0 = r0 == r1;
    if (!r0) goto L_1858;
    // hunter_04_mongolfier_talk.sc:46
    r0 = 0.41992881894111633f;  // @src hunter_04_mongolfier_talk.sc:46
    r_neg5 = r0;
    return r0;
    // hunter_04_mongolfier_talk.sc:47
  L_1858:
    r0 = 0.6561387777328491f;  // @src hunter_04_mongolfier_talk.sc:47
    r_neg5 = r0;
    return r0;
}

// hunter_04_mongolfier_talk.sc:80 (locals=1)
func_10()
{
    // hunter_04_mongolfier_talk.sc:78
    r0 = "hunter_04_mongolfier";  // @src hunter_04_mongolfier_talk.sc:78
    Call(r1, 0x030c);
    // hunter_04_mongolfier_talk.sc:79
    r0 = true;  // @src hunter_04_mongolfier_talk.sc:79
    r_neg4 = r0;
    return r0;
}
