...
func_1()
{
    ...
    CallMethod(r0, 59, 0x142);  // @patch+8 hunter_02_ironclad_gun_phys.sc:15
...
setParent()
{
    ...
    r1 = GetDotStr("setTransform");  // @src hunter_02_ironclad_gun_phys.sc:95
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
applyForce()
{
    ...
    r1 = GetDotStr("applyForce");  // @src hunter_02_ironclad_gun_phys.sc:116
    r2 = r_neg4;
    r3 = GetDotStr("Mass");
    r2 = r2 * r3;
    GetDot(r0, 1);
...
func_10()
{
    ...
    r1 = GetDotStr("LinearVelocity");  // @src hunter_02_ironclad_gun_phys.sc:130
    r1 = (str)r1;
    Call(r2, 0x0234);
    ...
    r1 = GetDotStr("AngularVelocity");  // @src hunter_02_ironclad_gun_phys.sc:131
    r1 = (str)r1;
    Call(r2, 0x0234);
    r1 = 0.0010000000474974513f;
    r0 = r0 <= r1;
...
destroyPhys()
{
    ...
    r1 = GetDotStr("remove");  // @src hunter_02_ironclad_gun_phys.sc:38
    GetDot(r0, 0);
    Free2(r1, r0);
