...
func_1()
{
    ...
    r0 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:47
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // hunter_05_whaler_head_phys.sc:48
    r0 = GetDotStr("AngularVelocity");  // @src hunter_05_whaler_head_phys.sc:48
    r0 = (str)r0;
    r0 = g4;
    Free1(r0);
...
func_5()
{
  ...
  L_00f4:
    ...
    r1 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:177
    r1 = (str)r1;
    ...
    r4 = GetDotStr("setRotation");  // @src hunter_05_whaler_head_phys.sc:179
    ...
    r4 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:183
    r4 = (str)r4;
    Call(r5, 0x0250);
    ...
    r3 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:184
...
func_8()
{
  ...
  L_028c:
    ...
    r4 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:230
    r5 = 0;
    r6 = 0;
    r7 = 0;
    GetDot(r3, 3);
    ...
    r4 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:233
    r4 = (str)r4;
    ...
    r7 = GetDotStr("setRotation");  // @src hunter_05_whaler_head_phys.sc:235
    ...
    r8 = GetDotStr("applyForce");  // @src hunter_05_whaler_head_phys.sc:242
    r9 = r3;
    r10 = r2;
...
isMoving()
{
    ...
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:200
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:201
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
...
setPosition()
{
    ...
    r2 = GetDotStr("applyForce");  // @src hunter_05_whaler_head_phys.sc:33
    r3 = r_neg4;
    g4 = r1;
    ...
    r2 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:35
    r2 = (str)r2;
    Call(r3, 0x0250);
    r2 = 15.0f;
    r1 = r1 > r2;
...
getPosition()
{
    ...
    r1 = GetDotStr("setPosition");  // @src hunter_05_whaler_head_phys.sc:59
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
setRotation()
{
    ...
    r0 = GetDotStr("Position");  // @src hunter_05_whaler_head_phys.sc:66
    r0 = (str)r0;
    r_neg4 = r0;
    Free1(r0);
    return r0;
...
onDamage()
{
    ...
    r0 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:80
    r0 = (str)r0;
...
disable()
{
    ...
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:103
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:104
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
...
enable()
{
    ...
    r0 = GetDotStr("LinearVelocity");  // @src hunter_05_whaler_head_phys.sc:114
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // hunter_05_whaler_head_phys.sc:115
    r0 = GetDotStr("AngularVelocity");  // @src hunter_05_whaler_head_phys.sc:115
    r0 = (str)r0;
    r0 = g4;
    Free1(r0);
    // hunter_05_whaler_head_phys.sc:117
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:117
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("!vec3");  // @src hunter_05_whaler_head_phys.sc:118
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
...
onUse()
{
    ...
    r1 = GetDotStr("remove");  // @src hunter_05_whaler_head_phys.sc:131
    GetDot(r0, 0);
    Free2(r1, r0);
...
isMineAttractor()
{
    ...
    CallMethod(r0, 8, 0x143);  // @patch+8 hunter_05_whaler_head_phys.sc:272
    RawDword(0x000000ec);  // UNKNOWN opcode 0xec
    r0 = 0x41;  // @patch+4 hunter_05_whaler_head_phys.sc:273
}
