...
func_1()
{
    ...
    r0 = 5000;  // @src hunter_02_ironclad_gun.sc:29
    r0 = g0;
    // hunter_02_ironclad_gun.sc:31
    r1 = GetDotStr("loadSound3D");  // @src hunter_02_ironclad_gun.sc:31
    ...
    r1 = GetDotStr("makeAttachPoint");  // @src hunter_02_ironclad_gun.sc:33
    r2 = "loc_gun_barrel";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
hasJibs()
{
    ...
    r2 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:58
    SetDotRaw(r1, 150);
    Free1(r2);
    r2 = GetDotStr("Scene");
...
onDamage()
{
    ...
    r0 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:176
    r2 = GetDotStr("!vec3");
    r3 = 0;
    r4 = 0;
    r5 = 1;
    ...
    r2 = GetDotStr("!vec3");  // @src hunter_02_ironclad_gun.sc:177
    r4 = r0;
    SetDotRaw(r3, 430);
    Free1(r4);
    r4 = 0;
    ...
    r2 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:178
    SetDotRaw(r1, 319);
    Free1(r2);
    r1 = (float)r1;
  ...
  L_0490:
    r4 = GetDotStr("!vec3");  // @src hunter_02_ironclad_gun.sc:181
    r6 = r0;
    SetDotRaw(r5, 430);
    Free1(r6);
    ...
    r4 = GetDotStr("!vec3");  // @src hunter_02_ironclad_gun.sc:182
    r6 = r0;
    SetDotRaw(r5, 430);
    Free1(r6);
    r7 = GetDotStr("Position");
    ...
    r5 = GetDotStr("!qtpair");  // @src hunter_02_ironclad_gun.sc:187
    GetDot(r4, 0);
    Free1(r5);
    r4 = (str)r4;
    // hunter_02_ironclad_gun.sc:188
    r5 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:188
    r6 = r4;
    SetInd(r6);
    LoadFalse(r0);
    ...
    r7 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:189
    SetDotRaw(r6, 466);
    Free1(r7);
    r7 = GetDotStr("Scene");
...
func_11()
{
    ...
    r3 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:352
    SetDotRaw(r2, 150);
    Free1(r3);
    r3 = GetDotStr("Scene");
    r4 = "ironclad_gun_body.pre";
    r6 = GetDotStr("!qtpair");
    r8 = GetDotStr("getBoneRotation");
    ...
    r3 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:356
    SetDotRaw(r2, 150);
    Free1(r3);
    r3 = GetDotStr("Scene");
    ...
    r3 = GetDotStr("Scene");  // @src hunter_02_ironclad_gun.sc:360
    SetDotRaw(r2, 831);
    Free1(r3);
    ...
    r3 = GetDotStr("loadSound3D");  // @src hunter_02_ironclad_gun.sc:362
    ...
    r2 = GetDotStr("!qtpair");  // @src hunter_02_ironclad_gun.sc:365
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // hunter_02_ironclad_gun.sc:366
    r2 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:366
    r3 = r1;
    SetInd(r3);
    r0 = 6.3618950280346695e-43f;
    Free2(r3, r2);
    // hunter_02_ironclad_gun.sc:367
    r4 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:367
    SetDotRaw(r3, 466);
    Free1(r4);
    r4 = GetDotStr("Scene");
    ...
    r4 = GetDotStr("remove");  // @src hunter_02_ironclad_gun.sc:376
    GetDot(r3, 0);
    Free2(r4, r3);
...
func_16()
{
    ...
    r1 = GetDotStr("setRotation");  // @src hunter_02_ironclad_gun.sc:217
    r2 = 0;
    GetDot(r0, 1);
    Free2(r1, r0);
  ...
  L_0f3c:
    ...
    r2 = GetDotStr("setPosition");  // @src hunter_02_ironclad_gun.sc:223
    g4 = r4;
    SetDotRaw(r3, 234);
    Free1(r4);
    GetDot(r1, 1);
    ...
    r2 = GetDotStr("findBone");  // @src hunter_02_ironclad_gun.sc:226
    r3 = "body";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (int)r1;
    // hunter_02_ironclad_gun.sc:227
    r3 = GetDotStr("setBoneRotation");  // @src hunter_02_ironclad_gun.sc:227
    r4 = r1;
    g6 = r4;
    SetDotRaw(r5, 225);
    Free1(r6);
    ...
    r2 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:231
    g3 = r5;
    SetInd(r3);
...
hasJibs()
{
    ...
    r1 = GetDotStr("setBoneTranslation");  // @src hunter_02_ironclad_gun.sc:269
    ...
    r1 = GetDotStr("findBone");  // @src hunter_02_ironclad_gun.sc:272
    r2 = "body";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // hunter_02_ironclad_gun.sc:273
    r2 = GetDotStr("setBoneRotation");  // @src hunter_02_ironclad_gun.sc:273
    r3 = r0;
  ...
  L_122c:
    ...
    r4 = GetDotStr("setPosition");  // @src hunter_02_ironclad_gun.sc:279
    g6 = r4;
    SetDotRaw(r5, 234);
    Free1(r6);
    GetDot(r3, 1);
    ...
    r4 = GetDotStr("!vec3");  // @src hunter_02_ironclad_gun.sc:280
    r5 = 0;
    r6 = 0;
    r7 = 1;
    GetDot(r3, 3);
    ...
    r5 = GetDotStr("setRotation");  // @src hunter_02_ironclad_gun.sc:281
    r7 = r3;
    SetDotRaw(r6, 430);
    Free1(r7);
    r8 = r3;
  ...
  L_1390:
    r6 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:289
    r6 = (str)r6;
    Call(r9, 0x17a8);
    SetDotRaw(r7, 234);
    Free1(r8);
    ...
    r8 = GetDotStr("self");  // @src hunter_02_ironclad_gun.sc:291
    r8 = (str)r8;
    Call(r9, 0x17f8);
    r8 = 0;
    SetDot(r6, 1);
    ...
    r8 = GetDotStr("setRotation");  // @src hunter_02_ironclad_gun.sc:295
...
func_24()
{
    ...
    // ../../std.sci:1092
  L_1828:
    Call(r1, 0x17a8);  // @src ../../std.sci:1092
    // ../../std.sci:1093
...
func_25()
{
    ...
    r2 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:328
    SetDotRaw(r1, 150);
    Free1(r2);
    r2 = GetDotStr("Scene");
...
func_27()
{
    ...
    r1 = GetDotStr("setRotation");  // @src hunter_02_ironclad_gun.sc:84
    r2 = 0;
    GetDot(r0, 1);
    Free2(r1, r0);
  ...
  L_1a1c:
    ...
    r3 = GetDotStr("setPosition");  // @src hunter_02_ironclad_gun.sc:92
    g5 = r3;
    SetDotRaw(r4, 234);
    Free1(r5);
    GetDot(r2, 1);
    ...
    r3 = GetDotStr("findBone");  // @src hunter_02_ironclad_gun.sc:97
    r4 = "body";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (int)r2;
    // hunter_02_ironclad_gun.sc:98
    r4 = GetDotStr("setBoneRotation");  // @src hunter_02_ironclad_gun.sc:98
    r5 = r2;
    g7 = r3;
    SetDotRaw(r6, 225);
    Free1(r7);
...
hasJibs()
{
    ...
    r2 = GetDotStr("World");  // @src hunter_02_ironclad_gun.sc:159
    SetDotRaw(r1, 150);
    Free1(r2);
    r2 = GetDotStr("Scene");
    r3 = "cannonball_sm.pre";
    ...
    r1 = GetDotStr("Position");  // @src hunter_02_ironclad_gun.sc:160
    r3 = GetDotStr("!vec3");
    r4 = 0;
    r5 = 0;
    r6 = 1;
