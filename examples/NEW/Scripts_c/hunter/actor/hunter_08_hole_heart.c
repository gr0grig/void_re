...
func_1()
{
    ...
    r1 = GetDotStr("setKinematic");  // @src hunter_08_hole_heart.sc:12
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
...
onDamage()
{
    ...
    r2 = GetDotStr("World");  // @src hunter_08_hole_heart.sc:64
    SetDotRaw(r1, 59);
    Free1(r2);
    r2 = GetDotStr("Scene");
...
func_6()
{
    ...
    r1 = GetDotStr("setKinematic");  // @src hunter_08_hole_heart.sc:103
    r2 = false;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    r1 = GetDotStr("remove");  // @src hunter_08_hole_heart.sc:114
    GetDot(r0, 0);
    Free2(r1, r0);
...
isMineAttractor()
{
    ...
    r1 = GetDotStr("setTransform");  // @src hunter_08_hole_heart.sc:82
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
