...
func_1()
{
    ...
    r1 = GetDotStr("changeNavMesh");  // @src hunter_04_mongolfier_die.sc:17
    r2 = "mongolfier";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // hunter_04_mongolfier_die.sc:18
    r1 = GetDotStr("putOnGrid");  // @src hunter_04_mongolfier_die.sc:18
    GetDot(r0, 0);
    Free2(r1, r0);
    // hunter_04_mongolfier_die.sc:20
    r0 = GetDotStr("Location");  // @src hunter_04_mongolfier_die.sc:20
    if (!r0) goto L_00f4;
    // hunter_04_mongolfier_die.sc:21
    r1 = GetDotStr("Location");  // @src hunter_04_mongolfier_die.sc:21
    SetDotRaw(r0, 168);
    Free1(r1);
    if (!r0) goto L_00ec;
...
func_2()
{
    ...
    r1 = GetDotStr("stop");  // @src hunter_04_mongolfier_die.sc:42
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // hunter_04_mongolfier_die.sc:43
    r1 = GetDotStr("getRotation");  // @src hunter_04_mongolfier_die.sc:43
    GetDot(r0, 0);
    Free1(r1);
    ...
    r2 = GetDotStr("moveLine");  // @src hunter_04_mongolfier_die.sc:44
    ...
    r2 = GetDotStr("move");  // @src hunter_04_mongolfier_die.sc:45
    r3 = 0;
    GetDot(r1, 1);
    Free2(r2, r1);
    // hunter_04_mongolfier_die.sc:46
    r2 = GetDotStr("setRotation");  // @src hunter_04_mongolfier_die.sc:46
    r3 = r0;
    ...
    r2 = GetDotStr("playAnimationInplace");  // @src hunter_04_mongolfier_die.sc:48
    r3 = "moving_loop_0";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    ...
    r4 = GetDotStr("loadSound3D");  // @src hunter_04_mongolfier_die.sc:51
  ...
  L_0304:
    ...
    r0 = "";  // len=1354, pool_off=0x444, GARBLED
    GetDot(r2, 1);
    Free2(r3, r4);
    if (r2) goto L_0388;
