...
func_1()
{
    ...
    r1 = GetDotStr("loadAnimationSet");  // @src hunter_09_dudochnik_talk.sc:48
    r2 = "anim/hunter_09_piper.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // hunter_09_dudochnik_talk.sc:51
  L_0040:
    r1 = GetDotStr("playAnimation");  // @src hunter_09_dudochnik_talk.sc:51
    r2 = "idle";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("makeAttachPoint");  // @src hunter_09_dudochnik_talk.sc:54
    r3 = "Head";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
