...
func_1()
{
    ...
    CallMethod(r0, 27, 0x142);  // @patch+8 rigid_fragment_fall_and_fade.sc:28
    RetV(r2);
    r0 = 0xffffffff;  // @patch+4 rigid_fragment_fall_and_fade.sc:36
    r0 = null_str;
...
applyForce()
{
    ...
    r1 = GetDotStr("applyForce");  // @src rigid_fragment_fall_and_fade.sc:17
    r2 = r_neg4;
    r3 = GetDotStr("Mass");
    r2 = r2 * r3;
    GetDot(r0, 1);
