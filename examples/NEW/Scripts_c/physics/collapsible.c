...
func_3()
{
  ...
  L_00a0:
    ...
    if (!r2) goto L_01b8;
    // collapsible.sc:56
    r4 = GetDotStr("World");  // @src collapsible.sc:56
    SetDotRaw(r3, 43);
    Free1(r4);
    r4 = GetDotStr("Scene");
    g6 = r0;
    ...
    // collapsible.sc:60
  L_01b8:
    r2 = GetDotStr("remove");  // @src collapsible.sc:60
    GetDot(r1, 0);
    Free2(r2, r1);
    // collapsible.sc:61
...
func_4()
{
    // collapsible.sc:38
  L_01e4:
    r1 = GetDotStr("trace");  // @src collapsible.sc:38
    r2 = GetDotStr("Position");
    r2 = (as_string)r2;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // collapsible.sc:39
    r1 = GetDotStr("Position");  // @src collapsible.sc:39
    SetDotRaw(r0, 104);
    Free1(r1);
    ...
    if (!r0) goto L_0254;
    // collapsible.sc:40
    r1 = GetDotStr("trace");  // @src collapsible.sc:40
    r2 = "Ya upal";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // collapsible.sc:42
...
{
    // collapsible.sc:16
    r1 = GetDotStr("trace");  // @src collapsible.sc:16
