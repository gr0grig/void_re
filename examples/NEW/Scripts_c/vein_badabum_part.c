...
func_1()
{
    ...
    CallMethod(r0, 0, 0x142);  // @patch+8 vein_badabum_part.sc:15
...
func_2()
{
    ...
    r2 = GetDotStr("World");  // @src vein_badabum_part.sc:39
    SetDotRaw(r1, 29);
    Free1(r2);
    r2 = GetDotStr("Scene");
  ...
  L_0184:
    ...
    r1 = GetDotStr("Position");  // @src vein_badabum_part.sc:45
    r2 = r0;
    SetInd(r2);
    r0 = 110;
    Free2(r2, r1);
  ...
  L_01cc:
    r2 = GetDotStr("remove");  // @src vein_badabum_part.sc:49
    GetDot(r1, 0);
    Free2(r2, r1);
...
func_4()
{
    ...
    r5 = GetDotStr("World");  // @src vein_badabum_part.sc:9
    SetDotRaw(r4, 204);
    Free1(r5);
    SetDotRaw(r3, 215);
    Free1(r4);
