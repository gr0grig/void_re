// gscript: garden_bridge_ship.bin
// @version: 0
// @globals: 1 types=03
...
// garden_bridge_ship.sc:7 (locals=0)
func_1()
{
    // garden_bridge_ship.sc:7
    return r0;  // @src garden_bridge_ship.sc:7
}
...
// garden_bridge_ship.sc:12 (locals=1)
func_5()
{
    // garden_bridge_ship.sc:11
    r0 = r_neg4;  // @src garden_bridge_ship.sc:11
    r0 = g0;
    Free1(r0);
    // garden_bridge_ship.sc:12
    Free1(r_neg4);  // @src garden_bridge_ship.sc:12
    return r0;
}

// garden_bridge_ship.sc:51 (locals=1)
getAutomonolog()
{
    // garden_bridge_ship.sc:50
    Call(r1, 0x03fc);  // @src garden_bridge_ship.sc:50
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
func_7()
{
  ...
  L_04f8:
    ...
    Call(r0, 0x1574);  // @src location_base.sci:26
  ...
  L_05bc:
    Call(r1, 0x15ec);  // @src location_base.sci:30
    if (r0) goto L_0a74;
  ...
  L_0b6c:
    ...
    Call(r0, 0x1574);  // @src location_base.sci:79
  ...
  L_0ccc:
    ...
    Call(r0, 0x1574);  // @src location_base.sci:87
  ...
  L_0e2c:
    ...
    Call(r0, 0x1574);  // @src location_base.sci:95
  ...
  L_0fe4:
    ...
    Call(r0, 0x1574);  // @src location_base.sci:103
  ...
  L_1458:
    ...
    Call(r2, 0x1574);  // @src location_base.sci:140
