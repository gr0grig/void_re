...
//   export "getInitialPlayerTransform" args=1 cb=-1 {func_12} types=[str]
//   export "initScene" args=1 cb=-1 {func_13} types=[str]
//   export "onDeath" args=0 cb=-1 {func_14}
//   export "onBreakthrough" args=0 cb=-1 {func_15}
//   export "onConsoleTalk" args=0 cb=-1 {func_16}
...
// #export {func_12} name="getInitialPlayerTransform"
// #export {func_13} name="initScene"
// #export {func_14} name="onDeath"
// #export {func_15} name="onBreakthrough"
// #export {func_16} name="onConsoleTalk"
...
// girlUta.sc:10 (locals=3)
func_1()
{
    // girlUta.sc:9
    r1 = GetDotStr("logInfo");  // @src girlUta.sc:9
    r2 = "Uta location first run.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUta.sc:10
    return r0;  // @src girlUta.sc:10
}
...
// girlUta.sc:15 (locals=1)
isAutowalk()
{
    // girlUta.sc:14
    r0 = true;  // @src girlUta.sc:14
    r_neg4 = r0;
    return r0;
}

// girlUta.sc:26 (locals=4)
getAutomonolog()
{
    // girlUta.sc:19
    r3 = GetDotStr("World");  // @src girlUta.sc:19
    SetDotRaw(r2, 143);
    Free1(r3);
    SetDotRaw(r1, 148);
    Free1(r2);
    ...
    Free1(r2);
    // girlUta.sc:22
    r1 = GetDotStr("!tuple");  // @src girlUta.sc:22
    r2 = "sister_opening_sisters";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    // girlUta.sc:25
  L_0770:
    Call(r1, 0x0788);  // @src girlUta.sc:25
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
// girlUta.sc:34 (locals=3)
func_12()
{
    // girlUta.sc:30
    r2 = GetDotStr("World");  // @src girlUta.sc:30
    SetDotRaw(r1, 143);
    Free1(r2);
    r2 = "uta_scene_enter_count";
    SetDot(r0, 1);
    Free1(r2);
    r1 = 1;
    r0 = r0 == r1;
...
// girlUta.sc:53 (locals=7)
func_13()
{
    // girlUta.sc:38
    r1 = GetDotStr("logInfo");  // @src girlUta.sc:38
    r2 = "Uta location inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUta.sc:39
    r0 = r_neg4;  // @src girlUta.sc:39
    r0 = g1;
    Free1(r0);
    // girlUta.sc:41
    r0 = false;  // @src girlUta.sc:41
    r4 = GetDotStr("World");
    SetDotRaw(r3, 143);
    Free1(r4);
    SetDotRaw(r2, 148);
  ...
  L_1c1c:
    if (!r0) goto L_1cb8;
    // girlUta.sc:42
    r1 = GetDotStr("!vec3");  // @src girlUta.sc:42
    ...
    r0 = (str)r0;
    // girlUta.sc:43
    r3 = GetDotStr("World");  // @src girlUta.sc:43
    SetDotRaw(r2, 1426);
    Free1(r3);
    r3 = r_neg4;
    r4 = "uta_dressed.xml";
    ...
    Free1(r1);
    // girlUta.sc:41
    Free1(r0);  // @src girlUta.sc:41
    // girlUta.sc:46
  L_1cb8:
    r0 = 0;  // @src girlUta.sc:46
    // girlUta.sc:47
    r4 = GetDotStr("World");  // @src girlUta.sc:47
    SetDotRaw(r3, 143);
    Free1(r4);
    SetDotRaw(r2, 148);
    Free1(r3);
    r3 = "uta_scene_enter_count";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_1d3c;
    // girlUta.sc:48
    r3 = GetDotStr("World");  // @src girlUta.sc:48
    SetDotRaw(r2, 143);
    Free1(r3);
    r3 = "uta_scene_enter_count";
    SetDot(r1, 1);
  ...
  L_1d3c:
    ...
    Free1(r3);
    // girlUta.sc:53
    Free1(r_neg4);  // @src girlUta.sc:53
    return r0;
}

// girlUta.sc:59 (locals=3)
initScene()
{
    // girlUta.sc:57
    r1 = GetDotStr("logInfo");  // @src girlUta.sc:57
    r2 = "uta loc script: onDeath";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUta.sc:58
    g2 = r0;  // @src girlUta.sc:58
    SetDotRaw(r1, 1553);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlUta.sc:59
    return r0;  // @src girlUta.sc:59
}

// girlUta.sc:65 (locals=3)
onDeath()
{
    // girlUta.sc:63
    r1 = GetDotStr("logInfo");  // @src girlUta.sc:63
    r2 = "uta loc script: onBreakthrough";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUta.sc:64
    g2 = r0;  // @src girlUta.sc:64
    SetDotRaw(r1, 1553);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlUta.sc:65
    return r0;  // @src girlUta.sc:65
}

// girlUta.sc:70 (locals=5)
onBreakthrough()
{
    // girlUta.sc:69
    g2 = r1;  // @src girlUta.sc:69
    SetDotRaw(r1, 54);
    Free1(r2);
    r2 = "activateObscure";
    r3 = "uta";
