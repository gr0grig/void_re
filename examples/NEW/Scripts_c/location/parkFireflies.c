...
// parkFireflies.sc:5 (locals=0)
func_1()
{
    // parkFireflies.sc:5
    return r0;  // @src parkFireflies.sc:5
}
...
// parkFireflies.sc:41 (locals=6)
func_5()
{
    // parkFireflies.sc:9
    r3 = GetDotStr("World");  // @src parkFireflies.sc:9
    SetDotRaw(r2, 89);
    Free1(r3);
    SetDotRaw(r1, 94);
    Free1(r2);
    r2 = "tutorial_automonolog_park";
    GetDot(r0, 1);
    Free2(r1, r2);
    if (r0) goto L_0478;
    // parkFireflies.sc:11
    r0 = true;  // @src parkFireflies.sc:11
    r2 = GetDotStr("World");
    SetDotRaw(r1, 89);
    Free1(r2);
    r2 = "tutorial_automonolog_park";
    ...
    Free1(r2);
    // parkFireflies.sc:12
    r1 = GetDotStr("!tuple");  // @src parkFireflies.sc:12
    r2 = "tutorial_automonolog_park";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    // parkFireflies.sc:15
  L_0478:
    r0 = false;  // @src parkFireflies.sc:15
    r4 = GetDotStr("World");
    SetDotRaw(r3, 89);
    Free1(r4);
    SetDotRaw(r2, 94);
  ...
  L_0514:
    if (!r0) goto L_0754;
    // parkFireflies.sc:18
    r2 = GetDotStr("World");  // @src parkFireflies.sc:18
    SetDotRaw(r1, 0);
    Free1(r2);
    r2 = "getLocationIndex";
    r3 = "1";
    ...
    r0 = (int)r0;
    // parkFireflies.sc:19
    r3 = GetDotStr("World");  // @src parkFireflies.sc:19
    SetDotRaw(r2, 0);
    Free1(r3);
    ...
    r1 = (int)r1;
    // parkFireflies.sc:21
    r2 = r1;  // @src parkFireflies.sc:21
    r3 = 0;
    r2 = r2 == r3;
    if (!r2) goto L_0640;
    // parkFireflies.sc:22
    r5 = GetDotStr("World");  // @src parkFireflies.sc:22
    SetDotRaw(r4, 89);
    Free1(r5);
    SetDotRaw(r3, 94);
    Free1(r4);
    ...
    if (r2) goto L_0638;
    // parkFireflies.sc:23
    r3 = GetDotStr("!tuple");  // @src parkFireflies.sc:23
    ...
    // parkFireflies.sc:21
  L_0638:
    goto L_0754;  // @src parkFireflies.sc:21
    // parkFireflies.sc:26
  L_0640:
    r2 = r1;  // @src parkFireflies.sc:26
    r3 = 1;
    r2 = r2 == r3;
    if (!r2) goto L_069c;
    // parkFireflies.sc:27
    r3 = GetDotStr("!tuple");  // @src parkFireflies.sc:27
    ...
    // parkFireflies.sc:30
  L_069c:
    r2 = r1;  // @src parkFireflies.sc:30
    r3 = 2;
    r2 = r2 == r3;
    if (!r2) goto L_06f8;
    // parkFireflies.sc:31
    r3 = GetDotStr("!tuple");  // @src parkFireflies.sc:31
    ...
    // parkFireflies.sc:34
  L_06f8:
    r2 = r1;  // @src parkFireflies.sc:34
    r3 = 3;
    r2 = r2 == r3;
    if (!r2) goto L_0754;
    // parkFireflies.sc:36
    r3 = GetDotStr("!tuple");  // @src parkFireflies.sc:36
    r4 = "tutorial_two_predators_left";
    r5 = 2;
    GetDot(r2, 2);
    Free2(r3, r4);
    ...
    // parkFireflies.sc:40
  L_0754:
    Call(r1, 0x076c);  // @src parkFireflies.sc:40
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
