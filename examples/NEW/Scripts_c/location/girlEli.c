...
// girlEli.sc:10 (locals=3)
func_1()
{
    // girlEli.sc:9
    r1 = GetDotStr("logInfo");  // @src girlEli.sc:9
    r2 = "Eli location first run.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlEli.sc:10
    return r0;  // @src girlEli.sc:10
}
...
// girlEli.sc:15 (locals=1)
isAutowalk()
{
    // girlEli.sc:14
    r0 = true;  // @src girlEli.sc:14
    r_neg4 = r0;
    return r0;
}

// girlEli.sc:20 (locals=1)
getAutomonolog()
{
    // girlEli.sc:19
    Call(r1, 0x06d0);  // @src girlEli.sc:19
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
// girlEli.sc:31 (locals=7)
func_12()
{
    // girlEli.sc:24
    r1 = GetDotStr("logInfo");  // @src girlEli.sc:24
    r2 = "Eli location inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlEli.sc:25
    r0 = r_neg4;  // @src girlEli.sc:25
    r0 = g1;
    Free1(r0);
    // girlEli.sc:27
    r0 = false;  // @src girlEli.sc:27
    r4 = GetDotStr("World");
    SetDotRaw(r3, 143);
    Free1(r4);
    SetDotRaw(r2, 148);
  ...
  L_1a8c:
    ...
    r0 = (str)r0;
    // girlEli.sc:29
    r3 = GetDotStr("World");  // @src girlEli.sc:29
    SetDotRaw(r2, 1288);
    Free1(r3);
    r3 = r_neg4;
    r4 = "eli_dressed.xml";
    ...
    Free1(r1);
    // girlEli.sc:27
    Free1(r0);  // @src girlEli.sc:27
    // girlEli.sc:31
  L_1b2c:
    Free1(r_neg4);  // @src girlEli.sc:31
    return r0;
}

// girlEli.sc:37 (locals=3)
func_13()
{
    // girlEli.sc:35
    r1 = GetDotStr("logInfo");  // @src girlEli.sc:35
    r2 = "eli loc script: onDeath";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlEli.sc:36
    g2 = r0;  // @src girlEli.sc:36
    SetDotRaw(r1, 1415);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlEli.sc:37
    return r0;  // @src girlEli.sc:37
}

// girlEli.sc:43 (locals=3)
onDeath()
{
    // girlEli.sc:41
    r1 = GetDotStr("logInfo");  // @src girlEli.sc:41
    r2 = "eli loc script: onBreakthrough";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlEli.sc:42
    g2 = r0;  // @src girlEli.sc:42
    SetDotRaw(r1, 1415);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlEli.sc:43
    return r0;  // @src girlEli.sc:43
}

// girlEli.sc:48 (locals=5)
onBreakthrough()
{
    // girlEli.sc:47
    g2 = r1;  // @src girlEli.sc:47
    SetDotRaw(r1, 54);
    Free1(r2);
    r2 = "activateObscure";
    r3 = "eli";
