...
// girlUna.sc:10 (locals=3)
func_1()
{
    // girlUna.sc:9
    r1 = GetDotStr("logInfo");  // @src girlUna.sc:9
    r2 = "Una location first run.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUna.sc:10
    return r0;  // @src girlUna.sc:10
}
...
// girlUna.sc:15 (locals=1)
isAutowalk()
{
    // girlUna.sc:14
    r0 = true;  // @src girlUna.sc:14
    r_neg4 = r0;
    return r0;
}

// girlUna.sc:20 (locals=1)
getAutomonolog()
{
    // girlUna.sc:19
    Call(r1, 0x06d0);  // @src girlUna.sc:19
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
// girlUna.sc:32 (locals=8)
func_12()
{
    // girlUna.sc:24
    r1 = GetDotStr("logInfo");  // @src girlUna.sc:24
    r2 = "Una location inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUna.sc:25
    r0 = r_neg4;  // @src girlUna.sc:25
    r0 = g1;
    Free1(r0);
    // girlUna.sc:27
    r0 = false;  // @src girlUna.sc:27
    r4 = GetDotStr("World");
    SetDotRaw(r3, 143);
    Free1(r4);
    SetDotRaw(r2, 148);
  ...
  L_1a8c:
    if (!r0) goto L_1b68;
    // girlUna.sc:28
    r1 = GetDotStr("irandMax");  // @src girlUna.sc:28
    r2 = 1;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // girlUna.sc:29
    r3 = r_neg4;  // @src girlUna.sc:29
    SetDotRaw(r2, 1256);
    Free1(r3);
    r3 = "pt_una";
    r4 = r0;
    ...
    r1 = (str)r1;
    // girlUna.sc:30
    r4 = GetDotStr("World");  // @src girlUna.sc:30
    SetDotRaw(r3, 1288);
    Free1(r4);
    r4 = r_neg4;
    r5 = "una_dressed.xml";
    ...
    Free1(r2);
    // girlUna.sc:27
    Free1(r1);  // @src girlUna.sc:27
    // girlUna.sc:32
  L_1b68:
    Free1(r_neg4);  // @src girlUna.sc:32
    return r0;
}

// girlUna.sc:38 (locals=3)
func_13()
{
    // girlUna.sc:36
    r1 = GetDotStr("logInfo");  // @src girlUna.sc:36
    r2 = "sister script: onDeath";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUna.sc:37
    g2 = r0;  // @src girlUna.sc:37
    SetDotRaw(r1, 1413);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlUna.sc:38
    return r0;  // @src girlUna.sc:38
}

// girlUna.sc:44 (locals=3)
onDeath()
{
    // girlUna.sc:42
    r1 = GetDotStr("logInfo");  // @src girlUna.sc:42
    r2 = "una loc script: onBreakthrough";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlUna.sc:43
    g2 = r0;  // @src girlUna.sc:43
    SetDotRaw(r1, 1413);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlUna.sc:44
    return r0;  // @src girlUna.sc:44
}

// girlUna.sc:49 (locals=5)
onBreakthrough()
{
    // girlUna.sc:48
    g2 = r1;  // @src girlUna.sc:48
    SetDotRaw(r1, 54);
    Free1(r2);
    r2 = "activateObscure";
    r3 = "una";
