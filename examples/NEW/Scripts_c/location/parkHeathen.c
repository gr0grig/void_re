...
// parkHeathen.sc:5 (locals=0)
func_1()
{
    // parkHeathen.sc:5
    return r0;  // @src parkHeathen.sc:5
}
...
// parkHeathen.sc:16 (locals=4)
func_5()
{
    // parkHeathen.sc:9
    r3 = GetDotStr("World");  // @src parkHeathen.sc:9
    SetDotRaw(r2, 89);
    Free1(r3);
    SetDotRaw(r1, 94);
    Free1(r2);
    r2 = "uta_automonolog_heathen_lament";
    GetDot(r0, 1);
    Free2(r1, r2);
    if (r0) goto L_0478;
    // parkHeathen.sc:11
    r0 = true;  // @src parkHeathen.sc:11
    r2 = GetDotStr("World");
    SetDotRaw(r1, 89);
    Free1(r2);
    r2 = "uta_automonolog_heathen_lament";
    ...
    Free1(r2);
    // parkHeathen.sc:12
    r1 = GetDotStr("!tuple");  // @src parkHeathen.sc:12
    r2 = "uta_automonolog_heathen_lament";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    // parkHeathen.sc:15
  L_0478:
    Call(r1, 0x0490);  // @src parkHeathen.sc:15
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
