...
// gardenMemory.sc:5 (locals=0)
func_1()
{
    // gardenMemory.sc:5
    return r0;  // @src gardenMemory.sc:5
}
...
// gardenMemory.sc:50 (locals=4)
func_5()
{
    // gardenMemory.sc:42
    r3 = GetDotStr("World");  // @src gardenMemory.sc:42
    SetDotRaw(r2, 89);
    Free1(r3);
    SetDotRaw(r1, 94);
    Free1(r2);
    ...
    if (r0) goto L_04b8;
    // gardenMemory.sc:44
    r2 = GetDotStr("World");  // @src gardenMemory.sc:44
    SetDotRaw(r1, 0);
    Free1(r2);
    r2 = "addColorData";
    r3 = "color_sleeper";
    ...
    Free4(r1, r2, r3, r0);
    // gardenMemory.sc:45
    r0 = true;  // @src gardenMemory.sc:45
    r2 = GetDotStr("World");
    SetDotRaw(r1, 89);
    Free1(r2);
    r2 = "color_sleeper";
    ...
    Free1(r2);
    // gardenMemory.sc:46
    r1 = GetDotStr("!tuple");  // @src gardenMemory.sc:46
    r2 = "color_sleeper";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    // gardenMemory.sc:49
  L_04b8:
    Call(r1, 0x04d0);  // @src gardenMemory.sc:49
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
func_6()
{
  ...
  L_05cc:
    ...
    Call(r0, 0x1648);  // @src location_base.sci:26
  ...
  L_0690:
    Call(r1, 0x16c0);  // @src location_base.sci:30
    if (r0) goto L_0b48;
  ...
  L_0c40:
    ...
    Call(r0, 0x1648);  // @src location_base.sci:79
  ...
  L_0da0:
    ...
    Call(r0, 0x1648);  // @src location_base.sci:87
  ...
  L_0f00:
    ...
    Call(r0, 0x1648);  // @src location_base.sci:95
  ...
  L_10b8:
    ...
    Call(r0, 0x1648);  // @src location_base.sci:103
  ...
  L_152c:
    ...
    Call(r2, 0x1648);  // @src location_base.sci:140
