...
// girlYani.sc:10 (locals=3)
func_1()
{
    // girlYani.sc:9
    r1 = GetDotStr("logInfo");  // @src girlYani.sc:9
    r2 = "Yani location first run.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlYani.sc:10
    return r0;  // @src girlYani.sc:10
}
...
// girlYani.sc:15 (locals=1)
isAutowalk()
{
    // girlYani.sc:14
    r0 = true;  // @src girlYani.sc:14
    r_neg4 = r0;
    return r0;
}

// girlYani.sc:27 (locals=5)
getAutomonolog()
{
    // girlYani.sc:19
    r0 = false;  // @src girlYani.sc:19
    r4 = GetDotStr("World");
    SetDotRaw(r3, 145);
    Free1(r4);
    SetDotRaw(r2, 150);
  ...
  L_0754:
    if (!r0) goto L_0810;
    // girlYani.sc:21
    r2 = GetDotStr("World");  // @src girlYani.sc:21
    SetDotRaw(r1, 56);
    Free1(r2);
    r2 = "addColorData";
    r3 = "color_vo_06";
    ...
    Free1(r2);
    // girlYani.sc:23
    r1 = GetDotStr("!tuple");  // @src girlYani.sc:23
    r2 = "color_vo_06";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
    ...
    // girlYani.sc:26
  L_0810:
    Call(r1, 0x0828);  // @src girlYani.sc:26
    r_neg4 = r0;
    Free1(r0);
    return r0;
}
...
// girlYani.sc:38 (locals=6)
func_12()
{
    // girlYani.sc:31
    r1 = GetDotStr("logInfo");  // @src girlYani.sc:31
    r2 = "Yani location initing.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlYani.sc:32
    r0 = r_neg4;  // @src girlYani.sc:32
    r0 = g1;
    Free1(r0);
    // girlYani.sc:34
    r0 = false;  // @src girlYani.sc:34
    r4 = GetDotStr("World");
    SetDotRaw(r3, 145);
    Free1(r4);
    SetDotRaw(r2, 150);
  ...
  L_1be4:
    if (!r0) goto L_1c58;
    // girlYani.sc:35
    r2 = GetDotStr("World");  // @src girlYani.sc:35
    SetDotRaw(r1, 1288);
    Free1(r2);
    r2 = r_neg4;
    r3 = "yani_dressed.xml";
    ...
    // girlYani.sc:37
  L_1c58:
    r1 = GetDotStr("logInfo");  // @src girlYani.sc:37
    r2 = "Yani location inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlYani.sc:38
    Free1(r_neg4);  // @src girlYani.sc:38
    return r0;
}

// girlYani.sc:44 (locals=3)
func_13()
{
    // girlYani.sc:42
    r1 = GetDotStr("logInfo");  // @src girlYani.sc:42
    r2 = "yani loc script: onDeath";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlYani.sc:43
    g2 = r0;  // @src girlYani.sc:43
    SetDotRaw(r1, 1469);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlYani.sc:44
    return r0;  // @src girlYani.sc:44
}

// girlYani.sc:50 (locals=3)
onDeath()
{
    // girlYani.sc:48
    r1 = GetDotStr("logInfo");  // @src girlYani.sc:48
    r2 = "yani loc script: onBreakthrough";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girlYani.sc:49
    g2 = r0;  // @src girlYani.sc:49
    SetDotRaw(r1, 1469);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girlYani.sc:50
    return r0;  // @src girlYani.sc:50
}

// girlYani.sc:55 (locals=5)
onBreakthrough()
{
    // girlYani.sc:54
    g2 = r1;  // @src girlYani.sc:54
    SetDotRaw(r1, 56);
    Free1(r2);
    r2 = "activateObscure";
    r3 = "yani";
