...
{
    // exit.sc:9
    r0 = false;  // @src exit.sc:9
    r4 = GetDotStr("World");
    SetDotRaw(r3, 89);
    Free1(r4);
    SetDotRaw(r2, 94);
    Free1(r3);
    r3 = "color_exit_shaft_talk";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_045c;
    r4 = GetDotStr("World");
  ...
  L_045c:
    if (!r0) goto L_0518;
    // exit.sc:12
    r2 = GetDotStr("World");  // @src exit.sc:12
    SetDotRaw(r1, 0);
    Free1(r2);
    r2 = "addColorData";
    r3 = "color_main_quest";
    ...
    Free1(r2);
    // exit.sc:14
    r1 = GetDotStr("!tuple");  // @src exit.sc:14
    r2 = "color_main_quest";
    r3 = 2;
    GetDot(r0, 2);
    Free2(r1, r2);
...
func_6()
{
  ...
  L_062c:
    ...
    Call(r0, 0x16a8);  // @src location_base.sci:26
  ...
  L_06f0:
    Call(r1, 0x1720);  // @src location_base.sci:30
    if (r0) goto L_0ba8;
  ...
  L_0ca0:
    ...
    Call(r0, 0x16a8);  // @src location_base.sci:79
  ...
  L_0e00:
    ...
    Call(r0, 0x16a8);  // @src location_base.sci:87
  ...
  L_0f60:
    ...
    Call(r0, 0x16a8);  // @src location_base.sci:95
  ...
  L_1118:
    ...
    Call(r0, 0x16a8);  // @src location_base.sci:103
  ...
  L_158c:
    ...
    Call(r2, 0x16a8);  // @src location_base.sci:140
