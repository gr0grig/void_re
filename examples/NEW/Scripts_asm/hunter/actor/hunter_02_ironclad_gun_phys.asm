...
;   bc=0x0234 str=2("../../std.sci") val=126
;   bc=0x023c str=2("../../std.sci") val=125
...
func_1:
  ...
  0x0064: CallMethod r0, 59, 0x142  ; @patch+8 hunter_02_ironclad_gun_phys.sc:15
...
func_4:
  0x00e4: GetDotStr r1, "setTransform"  ; hunter_02_ironclad_gun_phys.sc:95
  0x00ec: Copy r-4, r2
  0x00f4: GetDot r0, 1
...
func_7:
  0x014c: GetDotStr r1, "applyForce"  ; hunter_02_ironclad_gun_phys.sc:116
  0x0154: Copy r-4, r2
  0x015c: GetDotStr r3, "Mass"
  0x0164: Mul r2
  0x0168: GetDot r0, 1
...
func_10:
  0x01bc: GetDotStr r1, "LinearVelocity"  ; hunter_02_ironclad_gun_phys.sc:130
  0x01c4: ToStr r1
  0x01c8: Call r2, 0x0234
  0x01d0: LoadFloat r1, 0.0010000000474974513
  0x01d8: CmpLe r0
  0x01dc: BrZ r0, 0x0220
  0x01e4: GetDotStr r1, "AngularVelocity"  ; hunter_02_ironclad_gun_phys.sc:131
  0x01ec: ToStr r1
...
; === function 11 (setParent, ../../std.sci, line 126) locals=2 ===
func_11:
  0x023c: Copy r-4, r0  ; ../../std.sci:125
  0x0244: Copy r-4, r1
  0x024c: BOr r0
  0x0250: Sqrt r0
  0x0254: ToFloat r0
...
func_15:
  0x032c: GetDotStr r1, "remove"  ; hunter_02_ironclad_gun_phys.sc:38
  0x0334: GetDot r0, 0
  0x033c: Free2 r1, r0
