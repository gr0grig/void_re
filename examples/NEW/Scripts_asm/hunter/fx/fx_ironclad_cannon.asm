...
;   bc=0x046c str=2("../../std.sci") val=131
;   bc=0x0474 str=2("../../std.sci") val=130
;   bc=0x04bc str=2("../../std.sci") val=126
;   bc=0x04c4 str=2("../../std.sci") val=125
;   bc=0x04f0 str=2("../../std.sci") val=106
;   bc=0x04f8 str=2("../../std.sci") val=105
...
;   bc=0x0ba8 str=2("../../std.sci") val=233
;   bc=0x0bb0 str=2("../../std.sci") val=230
;   bc=0x0bd8 str=2("../../std.sci") val=231
;   bc=0x0c00 str=2("../../std.sci") val=232
...
;   bc=0x0df8 str=2("../../std.sci") val=242
;   bc=0x0e00 str=2("../../std.sci") val=238
;   bc=0x0e20 str=2("../../std.sci") val=239
;   bc=0x0e3c str=2("../../std.sci") val=240
;   bc=0x0e54 str=2("../../std.sci") val=237
; func_names:
;   0=initMissle
;   2=onUse
...
func_1:
  ...
  0x0044: CallMethod r0, 27, 0x142  ; @patch+8 fx_ironclad_cannon.sc:18
  0x0050: Neg r5
  ...
  0x009c: GetDotStr r1, "!vec3"  ; fx_ironclad_cannon.sc:58
  0x00a4: GetDotStr r3, "rand"
  0x00ac: GetDot r2, 0
  0x00b4: Free1 r3
  0x00b8: GetDotStr r4, "rand"
  0x00c0: GetDot r3, 0
  0x00c8: Free1 r4
  0x00cc: GetDotStr r5, "rand"
  0x00d4: GetDot r4, 0
  0x00dc: Free1 r5
  0x00e0: GetDot r0, 3
  ...
  0x010c: GetDotStr r1, "!qtpair"  ; fx_ironclad_cannon.sc:60
  0x0114: GetDot r0, 0
  0x011c: Free1 r1
  0x0120: ToStr r0
  0x0124: GetDotStr r1, "Position"  ; fx_ironclad_cannon.sc:61
  0x012c: Copy r0, r2
  0x0134: SetInd r2
  0x0138: LoadInt r0, 88
  0x0140: Free2 r2, r1
  0x0148: GetDotStr r3, "World"  ; fx_ironclad_cannon.sc:62
  0x0150: SetDotRaw r2, 106
  0x0158: Free1 r3
  0x015c: GetDotStr r3, "Scene"
...
func_3:
  ...
  0x0220: GetDotStr r2, "Position"  ; fx_ironclad_cannon.sc:77
  0x0228: SetDotRaw r1, 69
  0x0230: Free1 r2
  0x0234: LoadFloat r2, 0.25
  0x023c: Add r1
  0x0240: ToFloat r1
  0x0244: GetDotStr r4, "!vec3"  ; fx_ironclad_cannon.sc:78
  0x024c: Copy r0, r7
  0x0254: SetDotRaw r6, 79
  0x025c: Free1 r7
  0x0260: SetDotRaw r5, 262
  0x0268: Free1 r6
  0x026c: GetDotStr r7, "Position"
  ...
  0x02e0: GetDotStr r4, "!vec3"  ; fx_ironclad_cannon.sc:79
  0x02e8: Copy r0, r7
  0x02f0: SetDotRaw r6, 79
  0x02f8: Free1 r7
  0x02fc: SetDotRaw r5, 262
  0x0304: Free1 r6
  0x0308: GetDotStr r7, "Position"
  ...
  0x0370: Inv r3
  0x0374: ToStr r3
  0x0378: GetDotStr r5, "applyForce"  ; fx_ironclad_cannon.sc:83
  0x0380: GetDotStr r6, "Mass"
  0x0388: Copy r3, r7
  0x0390: Mul r6
  0x0394: Copy r2, r7
  0x039c: Mul r6
  ...
  0x03f0: GetDotStr r6, "Position"  ; fx_ironclad_cannon.sc:88
...
func_4:
  0x0474: GetDotStr r2, "World"  ; ../../std.sci:130
...
func_5:
  0x04c4: Copy r-4, r0  ; ../../std.sci:125
  0x04cc: Copy r-4, r1
  0x04d4: BOr r0
  0x04d8: Sqrt r0
  0x04dc: ToFloat r0
...
func_6:
  0x04f8: Copy r-4, r0  ; ../../std.sci:105
...
func_8:
  ...
  0x05c0: GetDotStr r2, "!vec3"  ; fx_ironclad_cannon.sc:30
  0x05c8: GetDot r1, 0
  0x05d0: Free1 r2
...
func_9:
  ...
  0x064c: GetDotStr r2, "irandRange"  ; fx_ironclad_cannon.sc:113
  0x0654: LoadInt r3, 1
  0x065c: LoadInt r4, 3
  0x0664: GetDot r1, 2
  0x066c: Free1 r2
  ...
  0x067c: GetDotStr r4, "randRange"  ; fx_ironclad_cannon.sc:115
  0x0684: LoadFloat r5, 0.5
  0x068c: LoadInt r6, 1
  0x0694: GetDot r3, 2
  0x069c: Free1 r4
  0x06a0: ToFloat r3
  0x06a4: GetDotStr r6, "World"  ; fx_ironclad_cannon.sc:116
  0x06ac: SetDotRaw r5, 348
  0x06b4: Free1 r6
  0x06b8: GetDotStr r6, "Scene"
  0x06c0: LoadString r7, "fx_cannonball_shard.pre"  ; len=23, pool_off=0x16d
  0x06cc: GetDotStr r8, "Position"
  0x06d4: Copy r3, r9
  0x06dc: Copy r2, r10
  0x06e4: Mul r9
  0x06e8: Add r8
  ...
  0x0a0c: Free1 r3
  0x0a10: GetDotStr r5, "loadSound3D"  ; fx_ironclad_cannon.sc:143
  0x0a18: LoadString r6, "ironclad_attack_cannon_blast"  ; len=28, pool_off=0x36c
  0x0a24: GetDot r4, 1
  0x0a2c: Free2 r5, r6
  0x0a34: ToStr r4
  0x0a38: GetDotStr r6, "!vec3"
  0x0a40: GetDot r5, 0
  0x0a48: Free1 r6
  0x0a4c: ToStr r5
  ...
  0x0a80: RetV r3
  0x0a84: Free1 r3
  0x0a88: GetDotStr r5, "Scene"  ; fx_ironclad_cannon.sc:146
  0x0a90: SetDotRaw r4, 942
  0x0a98: Free1 r5
  0x0a9c: GetDotStr r5, "Position"
  0x0aa4: LoadInt r6, 7
  0x0aac: GetDotStr r8, "!invQuadratic"
  ...
  0x0b84: GetDotStr r4, "remove"  ; fx_ironclad_cannon.sc:150
  0x0b8c: GetDot r3, 0
  0x0b94: Free2 r4, r3
  0x0b9c: Free3 r2, r0, r-4  ; fx_ironclad_cannon.sc:151
  0x0ba4: Ret r0

; === function 10 (../../std.sci, line 233) locals=8 ===
func_10:
  0x0bb0: GetDotStr r1, "randRange"  ; ../../std.sci:230
  0x0bb8: LoadInt r2, 0
  0x0bc0: LoadFloat r3, 1.5707963705062866
  0x0bc8: GetDot r0, 2
  0x0bd0: Free1 r1
  0x0bd4: ToFloat r0
  0x0bd8: GetDotStr r2, "randRange"  ; ../../std.sci:231
  0x0be0: LoadInt r3, 0
  0x0be8: LoadFloat r4, 6.2831854820251465
  0x0bf0: GetDot r1, 2
  0x0bf8: Free1 r2
  0x0bfc: ToFloat r1
  0x0c00: GetDotStr r3, "!vec3"  ; ../../std.sci:232
  0x0c08: Copy r0, r4
  0x0c10: Cos r4
  0x0c14: Copy r1, r5
  0x0c1c: Sin r5
...
func_11:
  0x0c74: GetDotStr r2, "Scene"  ; ..\..\sound.sci:28
...
func_12:
  ...
  0x0ce4: Mul r0
  0x0ce8: GetDotStr r2, "playSound3D"  ; ..\..\sound.sci:259
  0x0cf0: Copy r-8, r3
  0x0cf8: Copy r-7, r4
  0x0d00: Copy r-6, r5
  0x0d08: Copy r-5, r6
  ...
  0x0d30: ToStr r1
  0x0d34: GetDotStr r6, "Globals"  ; ..\..\sound.sci:260
...
func_13:
  0x0dac: GetDotStr r2, "Settings"  ; ..\..\sound.sci:9
  0x0db4: Copy r-4, r3
...
func_14:
  0x0e00: Copy r-4, r0  ; ../../std.sci:238
  0x0e08: Free1 r2
  0x0e0c: RetV r1
  0x0e10: Sub r0
  0x0e14: ToInt r0
  0x0e18: Copy r0, r4294967292
  0x0e20: Copy r-4, r0  ; ../../std.sci:239
  0x0e28: LoadInt r1, 0
  0x0e30: CmpLe r0
  0x0e34: BrZ r0, 0x0e54
  0x0e3c: Copy r-4, r0  ; ../../std.sci:240
  0x0e44: Neg r0
  0x0e48: Copy r0, r4294967291
  0x0e50: Ret r0
  0x0e54: Jmp r0, 0x0e00  ; ../../std.sci:237
