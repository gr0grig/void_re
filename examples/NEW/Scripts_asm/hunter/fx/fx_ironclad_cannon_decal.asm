...
;   bc=0x04c8 str=2("../../std.sci") val=44
;   bc=0x04d0 str=2("../../std.sci") val=42
;   bc=0x0520 str=2("../../std.sci") val=43
;   bc=0x0560 str=2("../../std.sci") val=44
; func_table (36 bytes):
...
func_1:
  ...
  0x0210: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:23
  0x0218: GetDot r1, 0
  0x0220: Free1 r2
  ...
  0x0244: GetDotStr r2, "Transform"
  0x024c: ToStr r2
  0x0250: LoadInt r3, 16000000
  0x0258: Call r4, 0x04c8
  0x0260: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:24
  0x0268: GetDot r1, 0
  0x0270: Free1 r2
  ...
  0x0294: GetDotStr r2, "Transform"
  0x029c: ToStr r2
  0x02a0: LoadInt r3, 16000000
  0x02a8: Call r4, 0x04c8
  0x02b0: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:25
  0x02b8: GetDot r1, 0
  0x02c0: Free1 r2
  ...
  0x02e4: GetDotStr r2, "Transform"
  0x02ec: ToStr r2
  0x02f0: LoadInt r3, 16000000
  0x02f8: Call r4, 0x04c8
  0x0300: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:26
  0x0308: GetDot r1, 0
  0x0310: Free1 r2
  ...
  0x0334: GetDotStr r2, "Transform"
  0x033c: ToStr r2
  0x0340: LoadInt r3, 16000000
  0x0348: Call r4, 0x04c8
  0x0350: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:27
  0x0358: GetDot r1, 0
  0x0360: Free1 r2
  ...
  0x0384: GetDotStr r2, "Transform"
  0x038c: ToStr r2
  0x0390: LoadInt r3, 16000000
  0x0398: Call r4, 0x04c8
  0x03a0: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:28
  0x03a8: GetDot r1, 0
  0x03b0: Free1 r2
  ...
  0x03d4: GetDotStr r2, "Transform"
  0x03dc: ToStr r2
  0x03e0: LoadInt r3, 16000000
  0x03e8: Call r4, 0x04c8
  0x03f0: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:29
  0x03f8: GetDot r1, 0
  0x0400: Free1 r2
  ...
  0x0424: GetDotStr r2, "Transform"
  0x042c: ToStr r2
  0x0430: LoadInt r3, 16000000
  0x0438: Call r4, 0x04c8
  0x0440: GetDotStr r2, "rand"  ; fx_ironclad_cannon_decal.sc:30
  0x0448: GetDot r1, 0
  0x0450: Free1 r2
  ...
  0x04ac: GetDotStr r1, "remove"  ; fx_ironclad_cannon_decal.sc:33
  0x04b4: GetDot r0, 0
  0x04bc: Free2 r1, r0
  0x04c4: Ret r0  ; fx_ironclad_cannon_decal.sc:34

; === function 2 (../../std.sci, line 44) locals=6 ===
func_2:
  0x04d0: GetDotStr r2, "World"  ; ../../std.sci:42
  0x04d8: SetDotRaw r1, 1312
  0x04e0: Free1 r2
  0x04e4: GetDotStr r2, "Scene"
  0x04ec: Copy r-6, r3
  0x04f4: Copy r-5, r4
  ...
  0x0560: Free3 r0, r-5, r-6  ; ../../std.sci:44
  0x0568: Ret r0
