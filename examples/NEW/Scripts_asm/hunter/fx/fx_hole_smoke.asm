...
;   bc=0x03f0 str=2("../../std.sci") val=131
;   bc=0x03f8 str=2("../../std.sci") val=130
...
;   bc=0x0698 str=2("../../std.sci") val=106
;   bc=0x06a0 str=2("../../std.sci") val=105
...
;   bc=0x0dc0 str=2("../../std.sci") val=1109
;   bc=0x0dc8 str=2("../../std.sci") val=1101
;   bc=0x0dd8 str=2("../../std.sci") val=1102
;   bc=0x0df0 str=2("../../std.sci") val=1104
;   bc=0x0df8 str=2("../../std.sci") val=1105
;   bc=0x0e08 str=2("../../std.sci") val=1106
;   bc=0x0e20 str=2("../../std.sci") val=1108
;   bc=0x0f00 str=2("../../std.sci") val=126
;   bc=0x0f08 str=2("../../std.sci") val=125
...
;   bc=0x13f8 str=4("..\..\posteffects\darken.sci") val=133
;   bc=0x1400 str=4("..\..\posteffects\darken.sci") val=111
;   bc=0x141c str=4("..\..\posteffects\darken.sci") val=113
;   bc=0x1430 str=4("..\..\posteffects\darken.sci") val=112
;   bc=0x1438 str=4("..\..\posteffects\darken.sci") val=117
;   bc=0x1444 str=4("..\..\posteffects\darken.sci") val=118
;   bc=0x1458 str=4("..\..\posteffects\darken.sci") val=119
;   bc=0x1470 str=4("..\..\posteffects\darken.sci") val=121
;   bc=0x148c str=4("..\..\posteffects\darken.sci") val=122
;   bc=0x14b8 str=4("..\..\posteffects\darken.sci") val=123
;   bc=0x14e0 str=4("..\..\posteffects\darken.sci") val=124
;   bc=0x14fc str=4("..\..\posteffects\darken.sci") val=125
;   bc=0x1510 str=4("..\..\posteffects\darken.sci") val=126
;   bc=0x1524 str=4("..\..\posteffects\darken.sci") val=129
;   bc=0x1538 str=4("..\..\posteffects\darken.sci") val=128
;   bc=0x1540 str=4("..\..\posteffects\darken.sci") val=120
;   bc=0x1548 str=4("..\..\posteffects\darken.sci") val=42
;   bc=0x1550 str=4("..\..\posteffects\darken.sci") val=41
;   bc=0x1564 str=4("..\..\posteffects\darken.sci") val=33
;   bc=0x156c str=4("..\..\posteffects\darken.sci") val=28
;   bc=0x1584 str=4("..\..\posteffects\darken.sci") val=29
;   bc=0x1598 str=4("..\..\posteffects\darken.sci") val=30
;   bc=0x15ac str=4("..\..\posteffects\darken.sci") val=31
;   bc=0x15c0 str=4("..\..\posteffects\darken.sci") val=32
;   bc=0x15d4 str=4("..\..\posteffects\darken.sci") val=33
;   bc=0x15dc str=1("fx_hole_smoke.sc") val=30
;   bc=0x15e4 str=1("fx_hole_smoke.sc") val=30
; func_names:
;   0=initSmoke
;   2=initProc
;   15=getEffectType
...
;   +288: 54 79 70 65 ff ff ff ff 48 15 00 00 00 00 00 00
...
func_1:
  ...
  0x007c: Free1 r0
  0x0080: GetDotStr r1, "loadSound3D"  ; fx_hole_smoke.sc:14
  ...
  0x00b0: Free1 r0
  0x00b4: GetDotStr r1, "loadSound3D"  ; fx_hole_smoke.sc:15
  ...
  0x00e4: Free1 r0
  0x00e8: GetDotStr r1, "loadSound3D"  ; fx_hole_smoke.sc:16
  ...
  0x0118: Free1 r0
  0x011c: CallNat r1, func=5596, info=0x0  ; fx_hole_smoke.sc:18
...
func_2:
  ...
  0x0154: GetDotStr r2, "Scene"  ; fx_hole_smoke.sc:39
  ...
  0x01a4: GetDotStr r1, "remove"  ; fx_hole_smoke.sc:42
  0x01ac: GetDot r0, 0
  0x01b4: Free2 r1, r0
  0x01bc: Call r1, 0x03f0  ; fx_hole_smoke.sc:45
  0x01c4: GetDotStr r2, "!vec3"  ; fx_hole_smoke.sc:47
  0x01cc: Copy r0, r5
...
func_3:
  0x03f8: GetDotStr r2, "World"  ; ../../std.sci:130
...
func_4:
  0x0448: GetDotStr r2, "Scene"  ; ..\..\sound.sci:28
...
func_5:
  ...
  0x04b8: Mul r0
  0x04bc: GetDotStr r2, "playSound3D"  ; ..\..\sound.sci:259
  0x04c4: Copy r-8, r3
  0x04cc: Copy r-7, r4
  0x04d4: Copy r-6, r5
  0x04dc: Copy r-5, r6
  ...
  0x0504: ToStr r1
  0x0508: GetDotStr r6, "Globals"  ; ..\..\sound.sci:260
...
func_8:
  0x06a0: Copy r-4, r0  ; ../../std.sci:105
...
func_9:
  ...
  0x0730: GetDotStr r3, "World"  ; fx_hole_smoke.sc:109
  ...
  0x08a0: GetDotStr r7, "self"  ; fx_hole_smoke.sc:126
  0x08a8: ToStr r7
  ...
  0x08f8: GetDotStr r8, "self"
  0x0900: GetDotStr r10, "irandMax"
...
func_10:
  ...
  0x0a58: Mul r0
  0x0a5c: GetDotStr r2, "playSound3DLooped"  ; ..\..\sound.sci:276
  0x0a64: Copy r-8, r3
  0x0a6c: Copy r-7, r4
  0x0a74: Copy r-6, r5
  0x0a7c: Copy r-5, r6
  ...
  0x0aa4: ToStr r1
  0x0aa8: GetDotStr r6, "Globals"  ; ..\..\sound.sci:277
...
func_11:
  0x0b20: GetDotStr r1, "!qtpair"  ; fx_hole_smoke.sc:144
  0x0b28: GetDot r0, 0
  0x0b30: Free1 r1
  0x0b34: ToStr r0
  0x0b38: GetDotStr r1, "Position"  ; fx_hole_smoke.sc:145
  0x0b40: Copy r0, r2
  0x0b48: SetInd r2
  0x0b4c: LoadInt r0, 760
  0x0b54: Free2 r2, r1
  0x0b5c: GetDotStr r3, "World"  ; fx_hole_smoke.sc:146
  0x0b64: SetDotRaw r2, 479
  0x0b6c: Free1 r3
  0x0b70: GetDotStr r3, "Scene"
  ...
  0x0d9c: GetDotStr r3, "remove"  ; fx_hole_smoke.sc:159
  0x0da4: GetDot r2, 0
  0x0dac: Free2 r3, r2
  0x0db4: Free2 r1, r0  ; fx_hole_smoke.sc:160
  0x0dbc: Ret r0

; === function 12 (../../std.sci, line 1109) locals=12 ===
func_12:
  0x0dc8: Copy r-4, r0  ; ../../std.sci:1101
  0x0dd0: BrNZ r0, 0x0df0
  0x0dd8: LoadNullStr r0  ; ../../std.sci:1102
  0x0ddc: Copy r0, r4294967291
  0x0de4: Free2 r0, r-4
  0x0dec: Ret r0
  0x0df0: Call r1, 0x03f0  ; ../../std.sci:1104
  0x0df8: Copy r0, r1  ; ../../std.sci:1105
  0x0e00: BrNZ r1, 0x0e20
  0x0e08: LoadNullStr r1  ; ../../std.sci:1106
  0x0e0c: Copy r1, r4294967291
  0x0e14: Free3 r1, r0, r-4
  0x0e1c: Ret r0
  0x0e20: GetDotStr r2, "!tuple"  ; ../../std.sci:1108
  0x0e28: GetDotStr r5, "!vec3"
  0x0e30: Copy r-4, r8
...
func_13:
  0x0f08: Copy r-4, r0  ; ../../std.sci:125
  0x0f10: Copy r-4, r1
  0x0f18: BOr r0
  0x0f1c: Sqrt r0
  0x0f20: ToFloat r0
...
func_14:
  ...
  0x0f54: Copy r-5, r3
  0x0f5c: Copy r-4, r4
  0x0f64: CallNat r5, func=5476, info=0x5
...
; === function 20 (..\..\posteffects\darken.sci, line 133) locals=5 ===
func_20:
  0x1400: Copy r-4, r0  ; ..\..\posteffects\darken.sci:111
  0x1408: LoadInt r1, 0
  0x1410: CmpEq r0
  0x1414: BrZ r0, 0x1438
  0x141c: LoadBool r1, false  ; ..\..\posteffects\darken.sci:113
  0x1424: RetV r0
  0x1428: Free2 r1, r0
  0x1430: Jmp r0, 0x141c  ; ..\..\posteffects\darken.sci:112
  0x1438: LoadInt r0, 0  ; ..\..\posteffects\darken.sci:117
  0x1440: ToFloat r0
  0x1444: Copy r-7, r1  ; ..\..\posteffects\darken.sci:118
  0x144c: CopyExtRd r1, 0, 7
  0x1458: Copy r-9, r1  ; ..\..\posteffects\darken.sci:119
  0x1460: CopyExtRd r1, 1, 7
  0x146c: Free1 r1
  0x1470: LoadBool r3, true  ; ..\..\posteffects\darken.sci:121
  0x1478: RetV r2
  0x147c: Free1 r3
  0x1480: ToInt r2
  0x1484: Call r3, 0x0698
  0x148c: Copy r-7, r2  ; ..\..\posteffects\darken.sci:122
  0x1494: Copy r-7, r3
  0x149c: Copy r0, r4
  0x14a4: Mul r3
  0x14a8: Sub r2
  0x14ac: CopyExtRd r2, 0, 7
  0x14b8: Copy r0, r2  ; ..\..\posteffects\darken.sci:123
  0x14c0: Copy r1, r3
  0x14c8: Copy r-4, r4
  0x14d0: Div r3
  0x14d4: Add r2
  0x14d8: Copy r2, r0
  0x14e0: Copy r0, r2  ; ..\..\posteffects\darken.sci:124
  0x14e8: LoadInt r3, 1
  0x14f0: CmpGt r2
  0x14f4: BrZ r2, 0x1540
  0x14fc: LoadInt r2, 1  ; ..\..\posteffects\darken.sci:125
  0x1504: ToFloat r2
  0x1508: Copy r2, r0
  0x1510: LoadBool r3, true  ; ..\..\posteffects\darken.sci:126
  0x1518: RetV r2
  0x151c: Free2 r3, r2
  0x1524: LoadBool r3, false  ; ..\..\posteffects\darken.sci:129
  0x152c: RetV r2
  0x1530: Free2 r3, r2
  0x1538: Jmp r0, 0x1524  ; ..\..\posteffects\darken.sci:128
  0x1540: Jmp r0, 0x1470  ; ..\..\posteffects\darken.sci:120

; === function 21 (getDarkenStrength, ..\..\posteffects\darken.sci, line 42) locals=1 ===
func_21:
  0x1550: LoadInt r0, 2  ; ..\..\posteffects\darken.sci:41
  0x1558: Copy r0, r4294967292
  0x1560: Ret r0

; === function 22 (..\..\posteffects\darken.sci, line 33) locals=1 ===
func_22:
  0x156c: Copy r-8, r0  ; ..\..\posteffects\darken.sci:28
  0x1574: CopyExtRd r0, 0, 5
  0x1580: Free1 r0
  0x1584: Copy r-7, r0  ; ..\..\posteffects\darken.sci:29
  0x158c: CopyExtRd r0, 1, 5
  0x1598: Copy r-6, r0  ; ..\..\posteffects\darken.sci:30
  0x15a0: CopyExtRd r0, 2, 5
  0x15ac: Copy r-5, r0  ; ..\..\posteffects\darken.sci:31
  0x15b4: CopyExtRd r0, 3, 5
  0x15c0: Copy r-4, r0  ; ..\..\posteffects\darken.sci:32
  0x15c8: CopyExtRd r0, 4, 5
  0x15d4: Free1 r-8  ; ..\..\posteffects\darken.sci:33
  0x15d8: Ret r0

; === function 23 (fx_hole_smoke.sc, line 30) locals=0 ===
func_23:
  0x15e4: Ret r0  ; fx_hole_smoke.sc:30
