...
;   bc=0x0ca8 str=3("../../std.sci") val=106
;   bc=0x0cb0 str=3("../../std.sci") val=105
;   bc=0x0cd0 str=3("../../std.sci") val=126
;   bc=0x0cd8 str=3("../../std.sci") val=125
...
;   bc=0x0de4 str=3("../../std.sci") val=131
;   bc=0x0dec str=3("../../std.sci") val=130
...
func_1:
  ...
  0x007c: Free1 r0
  0x0080: GetDotStr r1, "loadSound3D"  ; fx_stiltman_energy_ball.sc:53
...
func_2:
  ...
  0x0154: Mul r0
  0x0158: GetDotStr r2, "playSound3DLooped"  ; ..\..\sound.sci:276
  0x0160: Copy r-8, r3
  0x0168: Copy r-7, r4
  0x0170: Copy r-6, r5
  0x0178: Copy r-5, r6
  ...
  0x01a0: ToStr r1
  0x01a4: GetDotStr r6, "Globals"  ; ..\..\sound.sci:277
...
func_3:
  0x021c: GetDotStr r2, "Settings"  ; ..\..\sound.sci:9
  0x0224: Copy r-4, r3
...
func_4:
  0x0270: GetDotStr r2, "Scene"  ; ..\..\sound.sci:28
...
func_5:
  ...
  0x0300: Free1 r0
  0x0304: GetDotStr r1, "!qtpair"  ; fx_stiltman_energy_ball.sc:76
  0x030c: GetDot r0, 0
  0x0314: Free1 r1
  0x0318: ToStr r0
  0x031c: GetDotStr r1, "Position"  ; fx_stiltman_energy_ball.sc:77
  0x0324: Copy r0, r2
  0x032c: SetInd r2
  0x0330: LoadInt r0, 300
  0x0338: Free2 r2, r1
  0x0340: GetDotStr r3, "World"  ; fx_stiltman_energy_ball.sc:78
  0x0348: SetDotRaw r2, 318
  0x0350: Free1 r3
  0x0354: GetDotStr r3, "Scene"
  ...
  0x039c: Free1 r1
  0x03a0: GetDotStr r2, "applyForce"  ; fx_stiltman_energy_ball.sc:81
  0x03a8: Copy r-4, r3
  0x03b0: GetDotStr r4, "Mass"
  0x03b8: Mul r3
  0x03bc: GetDot r1, 1
  0x03c4: Free3 r2, r3, r1
  0x03cc: LoadFloat r1, 1.0  ; fx_stiltman_energy_ball.sc:83
  0x03d4: LoadFloat r2, 0.5
  0x03dc: GetDotStr r4, "rand"
  0x03e4: GetDot r3, 0
  0x03ec: Free1 r4
  0x03f0: Mul r2
  0x03f4: Add r1
...
func_6:
  ...
  0x05a0: GetDotStr r7, "Mass"
  0x05a8: Mul r6
  0x05ac: CopyGlobWr r4, g7
  0x05b4: Mul r6
  0x05b8: ToFloat r6
  0x05bc: GetDotStr r8, "applyForce"  ; fx_stiltman_energy_ball.sc:116
  0x05c4: Copy r3, r9
  0x05cc: Copy r6, r10
  0x05d4: Copy r4, r11
  0x05dc: Mul r10
  ...
  0x05f4: GetDotStr r12, "LinearVelocity"
  0x05fc: Mul r11
  0x0600: Sub r10
  0x0604: Mul r9
  0x0608: GetDot r7, 1
  0x0610: Free3 r8, r9, r7
  0x0618: GetDotStr r7, "setRotation"  ; fx_stiltman_energy_ball.sc:119
  0x0620: GetDotStr r10, "!lookAt"
  0x0628: GetDotStr r11, "Position"
  0x0630: GetDotStr r12, "Position"
  0x0638: GetDotStr r13, "LinearVelocity"
  0x0640: Add r12
  0x0644: GetDot r9, 2
  ...
  0x0670: GetDotStr r6, "Position"  ; fx_stiltman_energy_ball.sc:120
  0x0678: CopyGlobWr r0, g7
  0x0680: SetInd r7
  0x0684: LoadIntZero r0
  0x0688: Log r1
  0x068c: Free2 r7, r6
  0x0694: GetDotStr r8, "Scene"  ; fx_stiltman_energy_ball.sc:123
  0x069c: SetDotRaw r7, 573
  0x06a4: Free1 r8
  0x06a8: GetDotStr r9, "!sphere"
  0x06b0: GetDotStr r10, "Position"
  ...
  0x0794: GetDotStr r9, "Scene"  ; fx_stiltman_energy_ball.sc:130
  0x079c: ToStr r9
  0x07a0: GetDotStr r11, "loadSound"
...
func_7:
  ...
  0x0ab0: GetDotStr r3, "World"  ; fx_stiltman_energy_ball.sc:169
  0x0ab8: SetDotRaw r2, 318
  0x0ac0: Free1 r3
  0x0ac4: GetDotStr r3, "Scene"
  0x0acc: LoadString r4, "hunter/ps_hunter_03_stiltmanEnergyBallexplode.ps"  ; len=48, pool_off=0x322
  0x0ad8: GetDotStr r5, "Position"
  0x0ae0: GetDotStr r7, "!vec3"
  0x0ae8: LoadInt r8, 0
  ...
  0x0b98: GetDotStr r3, "remove"  ; fx_stiltman_energy_ball.sc:174
  0x0ba0: GetDot r2, 0
  0x0ba8: Free2 r3, r2
...
func_8:
  ...
  0x0be8: Mul r0
  0x0bec: GetDotStr r2, "playSound3D"  ; ..\..\sound.sci:259
  0x0bf4: Copy r-8, r3
  0x0bfc: Copy r-7, r4
  0x0c04: Copy r-6, r5
  0x0c0c: Copy r-5, r6
  ...
  0x0c34: ToStr r1
  0x0c38: GetDotStr r6, "Globals"  ; ..\..\sound.sci:260
...
func_9:
  0x0cb0: Copy r-4, r0  ; ../../std.sci:105
...
func_10:
  0x0cd8: Copy r-4, r0  ; ../../std.sci:125
  0x0ce0: Copy r-4, r1
  0x0ce8: BOr r0
  0x0cec: Sqrt r0
  0x0cf0: ToFloat r0
...
func_11:
  ...
  0x0d68: Free2 r2, r3
  0x0d70: ToStr r1
  0x0d74: GetDotStr r6, "Globals"  ; ..\..\sound.sci:162
...
; === function 12 (../../std.sci, line 131) locals=4 ===
func_12:
  0x0dec: GetDotStr r2, "World"  ; ../../std.sci:130
...
func_15:
  ...
  0x0e6c: Copy r-4, r1
  0x0e74: Inv r1
  0x0e78: GetDotStr r2, "LinearVelocity"
  0x0e80: Inv r2
  0x0e84: Add r1
  0x0e88: Mul r0
  0x0e8c: Inv r0
  0x0e90: ToStr r0
  0x0e94: GetDotStr r2, "applyForce"  ; fx_stiltman_energy_ball.sc:37
  0x0e9c: Copy r0, r3
  0x0ea4: GetDotStr r5, "LinearVelocity"
  0x0eac: ToStr r5
