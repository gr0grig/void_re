...
;   bc=0x0434 str=2("../../std.sci") val=126
;   bc=0x043c str=2("../../std.sci") val=125
;   bc=0x0468 str=2("../../std.sci") val=106
;   bc=0x0470 str=2("../../std.sci") val=105
...
func_1:
  0x001c: GetDotStr r1, "setKinematic"  ; fx_kolesnik_disc.sc:12
  0x0024: LoadBool r2, true
  0x002c: GetDot r0, 1
  0x0034: Free2 r1, r0
  0x003c: GetDotStr r1, "setCollisionGroup"  ; fx_kolesnik_disc.sc:13
  0x0044: LoadInt r2, 1
  0x004c: GetDot r0, 1
  0x0054: Free2 r1, r0
  ...
  0x0070: RetV r0
  0x0074: ToInt r0
  0x0078: GetDotStr r1, "Position"  ; fx_kolesnik_disc.sc:18
  0x0080: ToStr r1
  ...
  0x0198: GetDotStr r9, "setPosition"  ; fx_kolesnik_disc.sc:30
  0x01a0: CopyGlobWr r1, g10
  0x01a8: GetDot r8, 1
  0x01b0: Free3 r9, r10, r8
  0x01b8: Jmp r0, 0x02bc  ; fx_kolesnik_disc.sc:31
  0x01c0: GetDotStr r9, "setTransform"  ; fx_kolesnik_disc.sc:33
  0x01c8: GetDotStr r11, "!qtpair"
  0x01d0: GetDotStr r13, "!rotateY"
  0x01d8: Copy r5, r14
  0x01e0: Neg r14
  0x01e4: Copy r3, r15
  0x01ec: Mul r14
  ...
  0x02bc: GetDotStr r8, "remove"  ; fx_kolesnik_disc.sc:37
  0x02c4: GetDot r7, 0
  0x02cc: Free2 r8, r7
  0x02d4: CopyGlobWr r0, g8  ; fx_kolesnik_disc.sc:39
  0x02dc: GetDotStr r9, "Position"
  0x02e4: Sub r8
  0x02e8: ToStr r8
...
; === function 2 (../../std.sci, line 126) locals=2 ===
func_2:
  0x043c: Copy r-4, r0  ; ../../std.sci:125
  0x0444: Copy r-4, r1
  0x044c: BOr r0
  0x0450: Sqrt r0
  0x0454: ToFloat r0
...
func_3:
  0x0470: Copy r-4, r0  ; ../../std.sci:105
