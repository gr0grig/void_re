...
;   bc=0x03a4 str=2("../../std.sci") val=106
;   bc=0x03ac str=2("../../std.sci") val=105
...
;   bc=0x052c str=2("../../std.sci") val=131
;   bc=0x0534 str=2("../../std.sci") val=130
...
;   bc=0x0ae0 str=2("../../std.sci") val=233
;   bc=0x0ae8 str=2("../../std.sci") val=230
;   bc=0x0b10 str=2("../../std.sci") val=231
;   bc=0x0b38 str=2("../../std.sci") val=232
;   bc=0x0ba4 str=2("../../std.sci") val=126
;   bc=0x0bac str=2("../../std.sci") val=125
...
func_2:
  ...
  0x0080: GetDotStr r1, "remove"  ; fx_ironclad_homing_cannon.sc:61
  0x0088: GetDot r0, 0
  0x0090: Free2 r1, r0
  ...
  0x00c8: GetDotStr r1, "remove"  ; fx_ironclad_homing_cannon.sc:70
  0x00d0: GetDot r0, 0
  0x00d8: Free2 r1, r0
  ...
  0x0114: GetDotStr r1, "!vec3"  ; fx_ironclad_homing_cannon.sc:78
  0x011c: GetDotStr r3, "rand"
  0x0124: GetDot r2, 0
  0x012c: Free1 r3
  0x0130: GetDotStr r4, "rand"
  0x0138: GetDot r3, 0
  0x0140: Free1 r4
  0x0144: GetDotStr r5, "rand"
  0x014c: GetDot r4, 0
  0x0154: Free1 r5
  0x0158: GetDot r0, 3
  ...
  0x0184: GetDotStr r1, "!qtpair"  ; fx_ironclad_homing_cannon.sc:80
  0x018c: GetDot r0, 0
  0x0194: Free1 r1
  0x0198: ToStr r0
  0x019c: GetDotStr r1, "Position"  ; fx_ironclad_homing_cannon.sc:81
  0x01a4: Copy r0, r2
  0x01ac: SetInd r2
  0x01b0: LoadInt r0, 112
  0x01b8: Free2 r2, r1
  0x01c0: GetDotStr r3, "World"  ; fx_ironclad_homing_cannon.sc:82
  0x01c8: SetDotRaw r2, 130
  0x01d0: Free1 r3
  0x01d4: GetDotStr r3, "Scene"
...
func_4:
  ...
  0x02c4: ToStr r0
  0x02c8: GetDotStr r2, "applyForce"  ; fx_ironclad_homing_cannon.sc:97
  ...
  0x034c: GetDotStr r2, "Position"  ; fx_ironclad_homing_cannon.sc:103
...
func_5:
  0x03ac: Copy r-4, r0  ; ../../std.sci:105
...
func_6:
  ...
  0x0428: GetDotStr r3, "applyForce"  ; fx_ironclad_homing_cannon.sc:132
  0x0430: Copy r1, r4
  0x0438: Copy r0, r6
  0x0440: SetDotRaw r5, 103
  0x0448: Free1 r6
  0x044c: GetDotStr r6, "Position"
  0x0454: Sub r5
  0x0458: Mul r4
  0x045c: LoadFloat r5, 2.5
  0x0464: Mul r4
  0x0468: GetDotStr r5, "Mass"
  0x0470: Mul r4
  0x0474: LoadFloat r5, 0.5
  0x047c: Mul r4
  0x0480: GetDot r2, 1
  0x0488: Free3 r3, r4, r2
  0x0490: GetDotStr r3, "applyForce"  ; fx_ironclad_homing_cannon.sc:133
  0x0498: Copy r1, r4
  0x04a0: GetDotStr r6, "!vec3"
  0x04a8: LoadInt r7, 0
  0x04b0: LoadInt r8, 5
  0x04b8: LoadInt r9, 0
  0x04c0: GetDot r5, 3
...
func_8:
  ...
  0x05c8: GetDotStr r2, "irandRange"  ; fx_ironclad_homing_cannon.sc:153
  0x05d0: LoadInt r3, 1
  0x05d8: LoadInt r4, 3
  0x05e0: GetDot r1, 2
  0x05e8: Free1 r2
  ...
  0x05f8: GetDotStr r4, "randRange"  ; fx_ironclad_homing_cannon.sc:155
  0x0600: LoadFloat r5, 0.5
  0x0608: LoadInt r6, 1
  0x0610: GetDot r3, 2
  0x0618: Free1 r4
  0x061c: ToFloat r3
  0x0620: GetDotStr r6, "World"  ; fx_ironclad_homing_cannon.sc:156
  0x0628: SetDotRaw r5, 382
  0x0630: Free1 r6
  0x0634: GetDotStr r6, "Scene"
  0x063c: LoadString r7, "fx_cannonball_shard.pre"  ; len=23, pool_off=0x18f
  0x0648: GetDotStr r8, "Position"
  0x0650: Copy r3, r9
  0x0658: Copy r2, r10
  0x0660: Mul r9
  0x0664: Add r8
  ...
  0x07d8: LoadInt r5, 48000  ; fx_ironclad_homing_cannon.sc:170
  0x07e0: LoadInt r6, 1
  0x07e8: Copy r2, r7
  ...
  0x08a4: GetDotStr r3, "!qtpair"  ; fx_ironclad_homing_cannon.sc:178
  0x08ac: GetDot r2, 0
  0x08b4: Free1 r3
  0x08b8: ToStr r2
  0x08bc: GetDotStr r3, "Position"  ; fx_ironclad_homing_cannon.sc:179
  0x08c4: GetDotStr r5, "!vec3"
  0x08cc: LoadInt r6, 0
  ...
  0x0968: RetV r4
  0x096c: Free1 r4
  0x0970: GetDotStr r6, "Scene"  ; fx_ironclad_homing_cannon.sc:183
  0x0978: SetDotRaw r5, 648
  0x0980: Free1 r6
  0x0984: GetDotStr r6, "Position"
  0x098c: LoadInt r7, 7
  0x0994: GetDotStr r9, "!invQuadratic"
  ...
  0x0a54: GetDotStr r5, "loadSound3D"  ; fx_ironclad_homing_cannon.sc:189
  0x0a5c: LoadString r6, "ironclad_attack_homing_blast"  ; len=28, pool_off=0x2be
  0x0a68: GetDot r4, 1
  0x0a70: Free2 r5, r6
  0x0a78: ToStr r4
  0x0a7c: GetDotStr r6, "!vec3"
  0x0a84: GetDot r5, 0
  0x0a8c: Free1 r6
  0x0a90: ToStr r5
  ...
  0x0ab8: GetDotStr r5, "remove"  ; fx_ironclad_homing_cannon.sc:191
  0x0ac0: GetDot r4, 0
  0x0ac8: Free2 r5, r4
...
func_9:
  0x0ae8: GetDotStr r1, "randRange"  ; ../../std.sci:230
  0x0af0: LoadInt r2, 0
  0x0af8: LoadFloat r3, 1.5707963705062866
  0x0b00: GetDot r0, 2
  0x0b08: Free1 r1
  0x0b0c: ToFloat r0
  0x0b10: GetDotStr r2, "randRange"  ; ../../std.sci:231
  0x0b18: LoadInt r3, 0
  0x0b20: LoadFloat r4, 6.2831854820251465
  0x0b28: GetDot r1, 2
  0x0b30: Free1 r2
  0x0b34: ToFloat r1
  0x0b38: GetDotStr r3, "!vec3"  ; ../../std.sci:232
  0x0b40: Copy r0, r4
  0x0b48: Cos r4
  0x0b4c: Copy r1, r5
  0x0b54: Sin r5
...
func_10:
  0x0bac: Copy r-4, r0  ; ../../std.sci:125
  0x0bb4: Copy r-4, r1
  0x0bbc: BOr r0
  0x0bc0: Sqrt r0
  0x0bc4: ToFloat r0
...
func_11:
  ...
  0x0c04: Mul r0
  0x0c08: GetDotStr r2, "playSound3D"  ; ..\..\sound.sci:267
  0x0c10: Copy r-8, r3
  0x0c18: Copy r-7, r4
  0x0c20: Copy r-6, r5
  0x0c28: Copy r-5, r6
  ...
  0x0c50: ToStr r1
  0x0c54: GetDotStr r6, "Globals"  ; ..\..\sound.sci:268
...
func_12:
  0x0cf0: GetDotStr r2, "Settings"  ; ..\..\sound.sci:9
  0x0cf8: Copy r-4, r3
...
func_13:
  0x0d44: GetDotStr r2, "Scene"  ; ..\..\sound.sci:28
