...
func_1:
  0x001c: GetDotStr r1, "setKinematic"  ; fx_whaler_head_attached.sc:8
  0x0024: LoadBool r2, true
  0x002c: GetDot r0, 1
  0x0034: Free2 r1, r0
  0x003c: LoadBool r0, false  ; fx_whaler_head_attached.sc:9
  0x0044: CallMethod r0, 13, 0x142  ; @patch+8 fx_whaler_head_attached.sc:10
  0x0050: Free3 r5, r0, r0

; === function 2 (destroy, fx_whaler_head_attached.sc, line 36) locals=3 ===
func_2:
  0x0060: GetDotStr r1, "setTransform"  ; fx_whaler_head_attached.sc:35
  0x0068: Copy r-4, r2
  0x0070: GetDot r0, 1
...
func_4:
  0x00a8: GetDotStr r2, "World"  ; fx_whaler_head_attached.sc:53
  0x00b0: SetDotRaw r1, 47
  0x00b8: Free1 r2
  0x00bc: GetDotStr r2, "Scene"
  ...
  0x00ec: Add r3
  0x00f0: GetDotStr r5, "!qtpair"
  0x00f8: GetDotStr r6, "Rotation"
  0x0100: GetDotStr r7, "Position"
  0x0108: GetDot r4, 2
  ...
  0x017c: GetDotStr r3, "World"  ; fx_whaler_head_attached.sc:56
  0x0184: SetDotRaw r2, 47
  0x018c: Free1 r3
  0x0190: GetDotStr r3, "Scene"
  ...
  0x01c0: Add r4
  0x01c4: GetDotStr r6, "!qtpair"
  0x01cc: GetDotStr r7, "Rotation"
  0x01d4: GetDotStr r8, "Position"
  0x01dc: GetDot r5, 2
  ...
  0x025c: GetDotStr r3, "World"  ; fx_whaler_head_attached.sc:59
  0x0264: SetDotRaw r2, 47
  0x026c: Free1 r3
  0x0270: GetDotStr r3, "Scene"
  ...
  0x02a0: Add r4
  0x02a4: GetDotStr r6, "!qtpair"
  0x02ac: GetDotStr r7, "Rotation"
  0x02b4: GetDotStr r8, "Position"
  0x02bc: GetDot r5, 2
  ...
  0x0358: GetDotStr r3, "World"  ; fx_whaler_head_attached.sc:63
  0x0360: SetDotRaw r2, 47
  0x0368: Free1 r3
  0x036c: GetDotStr r3, "Scene"
  ...
  0x039c: Add r4
  0x03a0: GetDotStr r6, "!qtpair"
  0x03a8: GetDotStr r7, "Rotation"
  ...
  0x0438: GetDotStr r3, "Scene"  ; fx_whaler_head_attached.sc:68
  0x0440: SetDotRaw r2, 327
  0x0448: Free1 r3
  0x044c: GetDotStr r3, "Position"
  0x0454: GetDotStr r5, "!vec3"
  0x045c: GetDotStr r7, "rand"
  0x0464: GetDot r6, 0
  0x046c: Free1 r7
  0x0470: LoadFloat r7, 0.5
  0x0478: Sub r6
  0x047c: GetDotStr r8, "rand"
  0x0484: GetDot r7, 0
  0x048c: Free1 r8
  0x0490: LoadFloat r8, 0.5
  0x0498: Sub r7
  0x049c: GetDotStr r9, "rand"
  0x04a4: GetDot r8, 0
  0x04ac: Free1 r9
  ...
  0x04d0: Add r3
  0x04d4: LoadInt r4, 3
  0x04dc: GetDotStr r6, "!invQuadratic"
  ...
  0x052c: GetDotStr r2, "remove"  ; fx_whaler_head_attached.sc:70
  0x0534: GetDot r1, 0
  0x053c: Free2 r2, r1
