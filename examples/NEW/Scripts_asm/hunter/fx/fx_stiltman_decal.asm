...
;   bc=0x0030 str=2("../../std.sci") val=242
;   bc=0x0038 str=2("../../std.sci") val=238
;   bc=0x0058 str=2("../../std.sci") val=239
;   bc=0x0074 str=2("../../std.sci") val=240
;   bc=0x008c str=2("../../std.sci") val=237
; func_table (36 bytes):
...
func_2:
  0x0038: Copy r-4, r0  ; ../../std.sci:238
  0x0040: Free1 r2
  0x0044: RetV r1
  0x0048: Sub r0
  0x004c: ToInt r0
  0x0050: Copy r0, r4294967292
  0x0058: Copy r-4, r0  ; ../../std.sci:239
  0x0060: LoadInt r1, 0
  0x0068: CmpLe r0
  0x006c: BrZ r0, 0x008c
  0x0074: Copy r-4, r0  ; ../../std.sci:240
  0x007c: Neg r0
  0x0080: Copy r0, r4294967291
  0x0088: Ret r0
  0x008c: Jmp r0, 0x0038  ; ../../std.sci:237
