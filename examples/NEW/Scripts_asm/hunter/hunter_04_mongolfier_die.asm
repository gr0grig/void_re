...
func_1:
  ...
  0x0060: SetDotRaw r0, 515
  0x0068: Cos r0
  0x006c: Free4 r0, r57, r0, r1
  0x0078: Free3 r1, r2, r0
  0x0080: GetDotStr r1, "changeNavMesh"  ; hunter_04_mongolfier_die.sc:17
  0x0088: LoadString r2, "mongolfier"  ; len=10, pool_off=0x6b
  0x0094: GetDot r0, 1
  0x009c: Free3 r1, r2, r0
  0x00a4: GetDotStr r1, "putOnGrid"  ; hunter_04_mongolfier_die.sc:18
  0x00ac: GetDot r0, 0
  0x00b4: Free2 r1, r0
  0x00bc: GetDotStr r0, "Location"  ; hunter_04_mongolfier_die.sc:20
  0x00c4: BrZ r0, 0x00f4
  0x00cc: GetDotStr r1, "Location"  ; hunter_04_mongolfier_die.sc:21
...
func_2:
  0x0118: GetDotStr r1, "stop"  ; hunter_04_mongolfier_die.sc:42
  0x0120: LoadBool r2, true
  0x0128: GetDot r0, 1
  0x0130: Free2 r1, r0
  0x0138: GetDotStr r1, "getRotation"  ; hunter_04_mongolfier_die.sc:43
  0x0140: GetDot r0, 0
  0x0148: Free1 r1
  0x014c: GetDotStr r1, "TrajectoryRotation"
  0x0154: Add r0
  0x0158: ToFloat r0
  0x015c: GetDotStr r2, "moveLine"  ; hunter_04_mongolfier_die.sc:44
  0x0164: GetDotStr r3, "Position"
  0x016c: GetDotStr r5, "!vec3"
  0x0174: LoadInt r6, 0
  ...
  0x0194: Free1 r5
  0x0198: Add r3
  0x019c: GetDotStr r5, "!vec3"
  0x01a4: LoadInt r6, 0
  0x01ac: LoadInt r7, 0
  0x01b4: LoadInt r8, 0
  0x01bc: GetDot r4, 3
  0x01c4: Free1 r5
  0x01c8: GetDotStr r5, "Position"
  0x01d0: Sub r4
  0x01d4: GetDot r1, 2
  0x01dc: Free4 r2, r3, r4, r1
  0x01e8: GetDotStr r2, "move"  ; hunter_04_mongolfier_die.sc:45
  0x01f0: LoadInt r3, 0
  0x01f8: GetDot r1, 1
  0x0200: Free2 r2, r1
  0x0208: GetDotStr r2, "setRotation"  ; hunter_04_mongolfier_die.sc:46
  0x0210: Copy r0, r3
  0x0218: GetDotStr r4, "TrajectoryRotation"
  0x0220: Sub r3
  0x0224: LoadFloat r4, 1.0471975803375244
  0x022c: Sub r3
  0x0230: GetDot r1, 1
  0x0238: Free3 r2, r3, r1
  0x0240: GetDotStr r2, "playAnimationInplace"  ; hunter_04_mongolfier_die.sc:48
  ...
  0x0270: GetDot r2, 0
  0x0278: Free2 r3, r2
  0x0280: GetDotStr r4, "loadSound3D"  ; hunter_04_mongolfier_die.sc:51
  0x0288: LoadString r5, "mongolfier_moving_loop_0"  ; len=24, pool_off=0x138
  0x0294: GetDot r3, 1
  0x029c: Free2 r4, r5
  0x02a4: ToStr r3
  0x02a8: GetDotStr r5, "!vec3"
  0x02b0: LoadInt r6, 0
  0x02b8: LoadInt r7, 0
  0x02c0: LoadInt r8, 0
  0x02c8: GetDot r4, 3
  ...
  0x0328: LoadString r0, ""  ; len=1354, pool_off=0x444, GARBLED
  0x0334: GetDot r2, 1
  0x033c: Free2 r3, r4
...
func_4:
  ...
  0x041c: Mul r0
  0x0420: GetDotStr r2, "playSound3DLooped"  ; ..\sound.sci:276
  0x0428: Copy r-8, r3
  0x0430: Copy r-7, r4
  0x0438: Copy r-6, r5
  0x0440: Copy r-5, r6
  ...
  0x0468: ToStr r1
  0x046c: GetDotStr r6, "Globals"  ; ..\sound.sci:277
