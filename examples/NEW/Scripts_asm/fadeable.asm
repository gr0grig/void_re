...
;   bc=0x01c4 str=2("std.sci") val=106
;   bc=0x01cc str=2("std.sci") val=105
...
;   bc=0x0378 str=2("std.sci") val=71
;   bc=0x0380 str=2("std.sci") val=66
;   bc=0x039c str=2("std.sci") val=67
;   bc=0x03b0 str=2("std.sci") val=68
;   bc=0x03cc str=2("std.sci") val=69
;   bc=0x03e0 str=2("std.sci") val=70
...
func_2:
  ...
  0x00b0: Free3 r0, r579, r0  ; @patch+4 fadeable.sc:58
  0x00b8: .dword 0x00000250  ; UNKNOWN opcode 0x50
  0x00bc: LoadBool r0, 0x41  ; @patch+4 fadeable.sc:59
...
func_3:
  ...
  0x00e8: Free3 r0, r323, r0  ; @patch+4 fadeable.sc:105
  0x00f0: .dword 0x000000fc  ; UNKNOWN opcode 0xfc
  0x00f4: LoadBool r0, 0x41  ; @patch+4 fadeable.sc:106
...
func_4:
  ...
  0x0130: GetDotStr r0, "GeomTransparency"  ; fadeable.sc:42
  ...
  0x0170: GetDotStr r1, "!vec3"  ; fadeable.sc:46
  0x0178: GetDot r0, 0
  0x0180: Free1 r1
  0x0184: CallMethod r0, 90, 0x4a
  0x0190: GetDotStr r1, "!vec3"  ; fadeable.sc:47
  0x0198: GetDot r0, 0
  0x01a0: Free1 r1
...
func_5:
  0x01cc: Copy r-4, r0  ; std.sci:105
...
func_7:
  0x020c: GetDotStr r1, "setTransform"  ; fadeable.sc:119
  0x0214: Copy r-4, r2
  0x021c: GetDot r0, 1
...
func_9:
  0x0258: GetDotStr r0, "GeomTransparency"  ; fadeable.sc:89
  0x0260: LoadInt r1, 1
  0x0268: CmpLt r0
  0x026c: BrZ r0, 0x02b4
  0x0274: GetDotStr r0, "GeomTransparency"  ; fadeable.sc:90
...
func_11:
  0x02f8: GetDotStr r1, "setTransform"  ; fadeable.sc:72
  0x0300: Copy r-4, r2
  0x0308: GetDot r0, 1
...
; === function 14 (std.sci, line 71) locals=2 ===
func_14:
  0x0380: Copy r-6, r0  ; std.sci:66
  0x0388: Copy r-5, r1
  0x0390: CmpLt r0
  0x0394: BrZ r0, 0x03b0
  0x039c: Copy r-5, r0  ; std.sci:67
  0x03a4: Copy r0, r4294967289
  0x03ac: Ret r0
  0x03b0: Copy r-6, r0  ; std.sci:68
  0x03b8: Copy r-4, r1
  0x03c0: CmpGt r0
  0x03c4: BrZ r0, 0x03e0
  0x03cc: Copy r-4, r0  ; std.sci:69
  0x03d4: Copy r0, r4294967289
  0x03dc: Ret r0
  0x03e0: Copy r-6, r0  ; std.sci:70
