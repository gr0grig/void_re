; gscript disassembly: trigger_ava.bin
...
;   bc=0x0014 str=1("trigger_ava.sc") val=7
;   bc=0x001c str=1("trigger_ava.sc") val=7
...
;   bc=0x02d8 str=1("trigger_ava.sc") val=21
;   bc=0x02e0 str=1("trigger_ava.sc") val=21
;   bc=0x02e8 str=1("trigger_ava.sc") val=25
;   bc=0x02f0 str=1("trigger_ava.sc") val=25
; func_names:
;   0=getAllowedTypes
...
;   +144: 6f 6e 54 69 6d 65 72 ff ff ff ff e8 02 00 00 01

; === function 0 (getAllowedTypes, .init, line -1) locals=0 ===
func_0:
  0x0008: CallNat r0, func=20, info=0x0

; === function 1 (trigger_ava.sc, line 7) locals=0 ===
func_1:
  0x001c: Ret r0  ; trigger_ava.sc:7
...
; === function 4 (onTimer, trigger_ava.sc, line 21) locals=0 ===
func_4:
  0x02e0: Free1 r-5  ; trigger_ava.sc:21
  0x02e4: Ret r0

; === function 5 (trigger_ava.sc, line 25) locals=0 ===
func_5:
  0x02f0: Ret r0  ; trigger_ava.sc:25
