...
func_1:
  ...
  0x0048: GetDotStr r1, "isActionActive"  ; plot.sc:10
  0x0050: LoadString r2, "use"  ; len=3, pool_off=0xf
  0x005c: GetDot r0, 1
  0x0064: Free2 r1, r2
  0x006c: BrZ r0, 0x01bc
  0x0074: GetDotStr r3, "World"  ; plot.sc:11
  ...
  0x00b8: GetDotStr r2, "World"  ; plot.sc:12
  ...
  0x0130: GetDotStr r2, "World"
  0x0138: SetDotRaw r1, 27
  0x0140: Free1 r2
  0x0144: LoadString r2, "uplevel_completed"  ; len=17, pool_off=0x24
  0x0150: GetDotRaw r1, 1
  0x0158: Free1 r2
  0x015c: GetDotStr r1, "sendGenericEventToWorld"  ; plot.sc:16
  0x0164: GetDotStr r2, "World"
  0x016c: LoadString r3, "onPlot"  ; len=6, pool_off=0x5e
  0x0178: GetDot r0, 2
  0x0180: Free4 r1, r2, r3, r0
  0x018c: GetDotStr r1, "sendGenericEventToWorld"  ; plot.sc:17
  0x0194: GetDotStr r2, "World"
...
func_2:
  0x01cc: GetDotStr r1, "trace"  ; plot.sc:25
