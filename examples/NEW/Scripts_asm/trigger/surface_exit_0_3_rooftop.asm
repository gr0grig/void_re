...
func_3:
  0x0034: GetDotStr r2, "Scene"  ; surface_exit_0_3_rooftop.sc:20
  ...
  0x00ac: GetDotStr r1, "remove"  ; surface_exit_0_3_rooftop.sc:23
  0x00b4: GetDot r0, 0
  0x00bc: Free2 r1, r0
...
func_4:
  ...
  0x00f0: GetDotStr r1, "call"  ; surface_exit_0_3_rooftop.sc:31
  ...
  0x011c: GetDotStr r1, "remove"  ; surface_exit_0_3_rooftop.sc:33
  0x0124: GetDot r0, 0
  0x012c: Free2 r1, r0
