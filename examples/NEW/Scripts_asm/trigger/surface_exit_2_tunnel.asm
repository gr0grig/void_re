...
func_2:
  0x0028: GetDotStr r1, "trace"  ; surface_exit_2_tunnel.sc:7
...
func_3:
  0x0058: GetDotStr r1, "trace"  ; surface_exit_2_tunnel.sc:12
  0x0060: LoadString r2, "Activate: pool pigeons"  ; len=22, pool_off=0x38
  0x006c: GetDot r0, 1
  0x0074: Free3 r1, r2, r0
  0x007c: GetDotStr r2, "Scene"  ; surface_exit_2_tunnel.sc:14
  ...
  0x00bc: GetDotStr r2, "Scene"  ; surface_exit_2_tunnel.sc:17
  ...
  0x00e4: Free2 r1, r2
  0x00ec: ToStr r0
  0x00f0: GetDotStr r3, "World"  ; surface_exit_2_tunnel.sc:18
  0x00f8: SetDotRaw r2, 213
  0x0100: Free1 r3
  0x0104: GetDotStr r3, "Scene"
  ...
  0x0184: GetDotStr r3, "remove"  ; surface_exit_2_tunnel.sc:21
  0x018c: GetDot r2, 0
  0x0194: Free2 r3, r2
