...
func_3:
  0x0034: GetDotStr r2, "Scene"  ; surface_exit_0_1_staircase.sc:21
  ...
  0x00bc: GetDotStr r2, "Scene"  ; surface_exit_0_1_staircase.sc:25
  ...
  0x0104: Free1 r0
  0x0108: GetDotStr r1, "remove"  ; surface_exit_0_1_staircase.sc:27
  0x0110: GetDot r0, 0
  0x0118: Free2 r1, r0
...
func_4:
  ...
  0x014c: GetDotStr r1, "call"  ; surface_exit_0_1_staircase.sc:35
  ...
  0x0178: GetDotStr r1, "remove"  ; surface_exit_0_1_staircase.sc:37
  0x0180: GetDot r0, 0
  0x0188: Free2 r1, r0
