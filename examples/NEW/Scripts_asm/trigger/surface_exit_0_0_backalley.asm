...
func_2:
  0x0028: GetDotStr r2, "Scene"  ; surface_exit_0_0_backalley.sc:14
...
func_3:
  ...
  0x00ac: GetDotStr r2, "Scene"  ; surface_exit_0_0_backalley.sc:24
  ...
  0x00f4: Free1 r0
  0x00f8: GetDotStr r1, "remove"  ; surface_exit_0_0_backalley.sc:26
  0x0100: GetDot r0, 0
  0x0108: Free2 r1, r0
...
func_4:
  ...
  0x013c: GetDotStr r1, "call"  ; surface_exit_0_0_backalley.sc:35
  ...
  0x0168: GetDotStr r1, "remove"  ; surface_exit_0_0_backalley.sc:37
  0x0170: GetDot r0, 0
  0x0178: Free2 r1, r0
