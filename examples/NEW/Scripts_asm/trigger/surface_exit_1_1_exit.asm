...
func_3:
  0x0040: GetDotStr r2, "Scene"  ; surface_exit_1_1_exit.sc:27
  ...
  0x0088: Free1 r0
  0x008c: GetDotStr r1, "setTimer"  ; surface_exit_1_1_exit.sc:29
  0x0094: LoadInt r2, 0
  0x009c: LoadInt r3, 20000000
  0x00a4: GetDot r0, 2
  0x00ac: Free2 r1, r0
  0x00b4: GetDotStr r1, "setTimer"  ; surface_exit_1_1_exit.sc:30
  0x00bc: LoadInt r2, 1
  0x00c4: LoadInt r3, 5000000
  0x00cc: GetDot r0, 2
  0x00d4: Free2 r1, r0
  0x00dc: GetDotStr r2, "Scene"  ; surface_exit_1_1_exit.sc:32
...
func_4:
  ...
  0x0144: GetDotStr r2, "Scene"  ; surface_exit_1_1_exit.sc:47
  0x014c: SetDotRaw r1, 6
  0x0154: Free1 r2
  0x0158: LoadString r2, "onLocationExit"  ; len=14, pool_off=0x52
  0x0164: GetDot r0, 1
  0x016c: Free3 r1, r2, r0
  0x0174: GetDotStr r1, "remove"  ; surface_exit_1_1_exit.sc:48
  0x017c: GetDot r0, 0
  0x0184: Free2 r1, r0
...
func_7:
  ...
  0x0238: GetDotStr r1, "call"  ; surface_exit_1_1_exit.sc:60
  ...
  0x0264: GetDotStr r1, "remove"  ; surface_exit_1_1_exit.sc:62
  0x026c: GetDot r0, 0
  0x0274: Free2 r1, r0
