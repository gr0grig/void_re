; gscript disassembly: trigger_hunger_swos_3.bin
...
; inline strings:
;   [0] ".init"
;   [1] "trigger_hunger_swos_3.sc"
;   [2] "../hunger_swos_base.sci"
;   [3] "..\sound.sci"
; patches:
;   bc=0x0000 str=0(".init") val=-1
;   bc=0x0014 str=1("trigger_hunger_swos_3.sc") val=6
;   bc=0x001c str=1("trigger_hunger_swos_3.sc") val=6
;   bc=0x0020 str=1("trigger_hunger_swos_3.sc") val=19
;   bc=0x0028 str=1("trigger_hunger_swos_3.sc") val=12
;   bc=0x0038 str=1("trigger_hunger_swos_3.sc") val=13
;   bc=0x00d8 str=1("trigger_hunger_swos_3.sc") val=15
;   bc=0x010c str=1("trigger_hunger_swos_3.sc") val=16
;   bc=0x012c str=1("trigger_hunger_swos_3.sc") val=19
...
; === function 1 (trigger_hunger_swos_3.sc, line 6) locals=0 ===
func_1:
  0x001c: Ret r0  ; trigger_hunger_swos_3.sc:6

; === function 2 (trigger_hunger_swos_3.sc, line 19) locals=5 ===
func_2:
  0x0028: Copy r-4, r0  ; trigger_hunger_swos_3.sc:12
  0x0030: BrZ r0, 0x012c
  0x0038: LoadBool r0, false  ; trigger_hunger_swos_3.sc:13
  0x0040: GetDotStr r4, "World"
  0x0048: SetDotRaw r3, 6
  0x0050: Free1 r4
  0x0054: SetDotRaw r2, 11
  0x005c: Free1 r3
  0x0060: LoadString r3, "trigger_hunger_swos_3"  ; len=21, pool_off=0xf
  0x006c: GetDot r1, 1
  0x0074: Free2 r2, r3
  0x007c: Not r1
  ...
  0x00d8: LoadBool r0, true  ; trigger_hunger_swos_3.sc:15
  0x00e0: GetDotStr r2, "World"
  0x00e8: SetDotRaw r1, 6
  0x00f0: Free1 r2
  0x00f4: LoadString r2, "trigger_hunger_swos_3"  ; len=21, pool_off=0xf
  0x0100: GetDotRaw r1, 1
  0x0108: Free1 r2
  0x010c: GetDotStr r0, "Scene"  ; trigger_hunger_swos_3.sc:16
  0x0114: ToStr r0
  0x0118: GetDotStr r1, "World"
  0x0120: ToStr r1
  0x0124: Call r2, 0x0134
  0x012c: Free1 r-5  ; trigger_hunger_swos_3.sc:19
  0x0130: Ret r0
