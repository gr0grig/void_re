...
;   bc=0x07c0 str=2("vein_fortC.sc") val=38
;   bc=0x07c8 str=2("vein_fortC.sc") val=36
;   bc=0x07f0 str=2("vein_fortC.sc") val=37
;   bc=0x0850 str=2("vein_fortC.sc") val=38
...
;   bc=0x0c9c str=2("vein_fortC.sc") val=25
;   bc=0x0ca4 str=2("vein_fortC.sc") val=16
;   bc=0x0ca8 str=2("vein_fortC.sc") val=17
;   bc=0x0d08 str=2("vein_fortC.sc") val=18
;   bc=0x0d44 str=2("vein_fortC.sc") val=19
;   bc=0x0da4 str=2("vein_fortC.sc") val=20
;   bc=0x0de0 str=2("vein_fortC.sc") val=21
;   bc=0x0e40 str=2("vein_fortC.sc") val=22
;   bc=0x0e7c str=2("vein_fortC.sc") val=23
;   bc=0x0edc str=2("vein_fortC.sc") val=24
;   bc=0x0f18 str=2("vein_fortC.sc") val=25
...
; === function 2 (vein_fortC.sc, line 12) locals=3 ===
func_2:
  0x0048: GetDotStr r1, "!geometryCache"  ; vein_fortC.sc:7
  0x0050: GetDot r0, 0
  0x0058: Free1 r1
  0x005c: ToStr r0
...
; === function 4 (vein_fortC.sc, line 31) locals=6 ===
func_4:
  0x0350: GetDotStr r1, "findMaterial"  ; vein_fortC.sc:29
  0x0358: LoadString r2, "Material #4"  ; len=11, pool_off=0x1d0
  0x0364: GetDot r0, 1
  0x036c: Free2 r1, r2
  0x0374: ToInt r0
  0x0378: GetDotStr r2, "setLocalGeomParameterColor"  ; vein_fortC.sc:30
  0x0380: Copy r0, r3
...
func_12:
  ...
  0x058c: SetDotRaw r1, 318
  0x0594: Free1 r2
  0x0598: LoadString r2, "getDomainMineIncome"  ; len=19, pool_off=0x246
  0x05a4: GetDot r0, 1
  0x05ac: Free2 r1, r2
  0x05b4: ToFloat r0
...
; === function 15 (vein_fortC.sc, line 38) locals=9 ===
func_15:
  0x07c8: GetDotStr r1, "findMaterial"  ; vein_fortC.sc:36
  0x07d0: LoadString r2, "Material #4"  ; len=11, pool_off=0x1d0
  0x07dc: GetDot r0, 1
  0x07e4: Free2 r1, r2
  0x07ec: ToInt r0
  0x07f0: GetDotStr r2, "setLocalGeomParameterFloat"  ; vein_fortC.sc:37
  0x07f8: Copy r0, r3
  0x0800: LoadString r4, "Threshold"  ; len=9, pool_off=0x299
  0x080c: LoadInt r6, 1
  0x0814: Copy r-4, r7
  0x081c: Sub r6
  0x0820: LoadInt r7, 0
  ...
  0x0850: Ret r0  ; vein_fortC.sc:38
...
func_23:
  ...
  0x0990: SetDotRaw r1, 318
  0x0998: Free1 r2
  0x099c: LoadString r2, "updateVeinData"  ; len=14, pool_off=0x2ab
  ...
  0x09e0: SetDotRaw r1, 711
  0x09e8: Free1 r2
  0x09ec: LoadNullStr r2
  0x09f0: LoadString r3, "getLocationProps"  ; len=16, pool_off=0x2cf
  0x09fc: GetDot r0, 2
  ...
  0x0a28: Copy r0, r3
  0x0a30: SetDotRaw r2, 751
  0x0a38: Free1 r3
  0x0a3c: BrZ r2, 0x0a4c
  0x0a44: LoadBool r1, true
  0x0a4c: BrZ r1, 0x0a90
  0x0a54: Copy r0, r4  ; vein_base.sci:229
  0x0a5c: SetDotRaw r3, 751
  0x0a64: Free1 r4
  0x0a68: SetDotRaw r2, 318
  0x0a70: Free1 r3
  0x0a74: LoadString r3, "onVeinOpened"  ; len=12, pool_off=0x2f6
  0x0a80: GetDot r1, 1
  ...
  0x0bb4: SetDotRaw r7, 819
  0x0bbc: Free1 r8
  0x0bc0: GetDotStr r8, "Scene"
  0x0bc8: LoadString r9, "limfa.pre"  ; len=9, pool_off=0x344
  0x0bd4: Copy r5, r10
  0x0bdc: LoadString r11, "vein_badabum_part"  ; len=17, pool_off=0x356
  0x0be8: GetDot r6, 4
  0x0bf0: Free5 r7, r8, r9, r10, r11
  0x0bfc: ToStr r6
  0x0c00: Copy r6, r9  ; vein_base.sci:245
  0x0c08: SetDotRaw r8, 318
  0x0c10: Free1 r9
  0x0c14: LoadString r9, "initPart"  ; len=8, pool_off=0x378
...
; === function 24 (vein_fortC.sc, line 25) locals=7 ===
func_24:
  0x0ca4: LoadNullStr2 r0  ; vein_fortC.sc:16
  0x0ca8: GetDotStr r3, "World"  ; vein_fortC.sc:17
  0x0cb0: SetDotRaw r2, 819
  0x0cb8: Free1 r3
  0x0cbc: GetDotStr r3, "Scene"
  0x0cc4: LoadString r4, "minewalls/minewall_fortC_part1.pre"  ; len=34, pool_off=0x28
  0x0cd0: GetDotStr r5, "Transform"
  0x0cd8: LoadString r6, "vein_part"  ; len=9, pool_off=0x388
  0x0ce4: GetDot r1, 4
  0x0cec: Free5 r2, r3, r4, r5, r6
  0x0cf8: ToStr r1
  0x0cfc: Copy r1, r0
  0x0d04: Free1 r1
  0x0d08: Copy r0, r3  ; vein_fortC.sc:18
  0x0d10: SetDotRaw r2, 318
  0x0d18: Free1 r3
  0x0d1c: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x39a
  0x0d28: Copy r-4, r4
  0x0d30: GetDot r1, 2
  0x0d38: Free4 r2, r3, r4, r1
  0x0d44: GetDotStr r3, "World"  ; vein_fortC.sc:19
  0x0d4c: SetDotRaw r2, 819
  0x0d54: Free1 r3
  0x0d58: GetDotStr r3, "Scene"
  0x0d60: LoadString r4, "minewalls/minewall_fortC_part2.pre"  ; len=34, pool_off=0x6c
  0x0d6c: GetDotStr r5, "Transform"
  0x0d74: LoadString r6, "vein_part"  ; len=9, pool_off=0x388
  0x0d80: GetDot r1, 4
  0x0d88: Free5 r2, r3, r4, r5, r6
  0x0d94: ToStr r1
  0x0d98: Copy r1, r0
  0x0da0: Free1 r1
  0x0da4: Copy r0, r3  ; vein_fortC.sc:20
  0x0dac: SetDotRaw r2, 318
  0x0db4: Free1 r3
  0x0db8: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x39a
  0x0dc4: Copy r-4, r4
  0x0dcc: GetDot r1, 2
  0x0dd4: Free4 r2, r3, r4, r1
  0x0de0: GetDotStr r3, "World"  ; vein_fortC.sc:21
  0x0de8: SetDotRaw r2, 819
  0x0df0: Free1 r3
  0x0df4: GetDotStr r3, "Scene"
  0x0dfc: LoadString r4, "minewalls/minewall_fortC_part3.pre"  ; len=34, pool_off=0xb0
  0x0e08: GetDotStr r5, "Transform"
  0x0e10: LoadString r6, "vein_part"  ; len=9, pool_off=0x388
  0x0e1c: GetDot r1, 4
  0x0e24: Free5 r2, r3, r4, r5, r6
  0x0e30: ToStr r1
  0x0e34: Copy r1, r0
  0x0e3c: Free1 r1
  0x0e40: Copy r0, r3  ; vein_fortC.sc:22
  0x0e48: SetDotRaw r2, 318
  0x0e50: Free1 r3
  0x0e54: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x39a
  0x0e60: Copy r-4, r4
  0x0e68: GetDot r1, 2
  0x0e70: Free4 r2, r3, r4, r1
  0x0e7c: GetDotStr r3, "World"  ; vein_fortC.sc:23
  0x0e84: SetDotRaw r2, 819
  0x0e8c: Free1 r3
  0x0e90: GetDotStr r3, "Scene"
  0x0e98: LoadString r4, "minewalls/minewall_fortC_part4.pre"  ; len=34, pool_off=0xf4
  0x0ea4: GetDotStr r5, "Transform"
  0x0eac: LoadString r6, "vein_part"  ; len=9, pool_off=0x388
  0x0eb8: GetDot r1, 4
  0x0ec0: Free5 r2, r3, r4, r5, r6
  0x0ecc: ToStr r1
  0x0ed0: Copy r1, r0
  0x0ed8: Free1 r1
  0x0edc: Copy r0, r3  ; vein_fortC.sc:24
  0x0ee4: SetDotRaw r2, 318
  0x0eec: Free1 r3
  0x0ef0: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x39a
  0x0efc: Copy r-4, r4
  0x0f04: GetDot r1, 2
  0x0f0c: Free4 r2, r3, r4, r1
  0x0f18: Free2 r0, r-4  ; vein_fortC.sc:25
  0x0f20: Ret r0
...
func_28:
  ...
  0x10ec: Mul r6
  0x10f0: Sub r5
  0x10f4: CallMethod r5, 565, 0x20a  ; @patch+8 vein_base.sci:186
  0x1100: LoadFalse r0
  0x1104: Copy r4, r6
  0x110c: Sub r5
  0x1110: Copy r5, r2
