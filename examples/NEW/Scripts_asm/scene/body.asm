...
func_1:
  0x001c: GetDotStr r1, "!qtpair"  ; body.sc:50
  0x0024: GetDot r0, 0
  0x002c: Free1 r1
  0x0030: ToStr r0
  0x0034: GetDotStr r3, "World"  ; body.sc:51
  0x003c: SetDotRaw r2, 14
  0x0044: Free1 r3
  0x0048: GetDotStr r3, "self"
  ...
  0x0090: Free1 r1
  0x0094: GetDotStr r2, "!vector"  ; body.sc:53
  0x009c: GetDot r1, 0
  0x00a4: Free1 r2
  0x00a8: ToStr r1
  0x00ac: CopyGlobRd r1, g1
  0x00b4: Free1 r1
  0x00b8: GetDotStr r2, "!qtpair"  ; body.sc:54
  0x00c0: GetDotStr r4, "!rotateY"
  0x00c8: LoadFloat r5, 0.0
  0x00d0: GetDot r3, 1
  0x00d8: Free1 r4
  0x00dc: GetDotStr r5, "!vec3"
  0x00e4: LoadInt r6, 0
  ...
  0x0138: Free1 r3
  0x013c: GetDotStr r5, "World"
  0x0144: SetDotRaw r4, 107
  0x014c: Free1 r5
  0x0150: GetDotStr r5, "self"
  ...
  0x019c: GetDotStr r2, "!qtpair"  ; body.sc:57
  0x01a4: GetDotStr r4, "!rotateY"
  0x01ac: LoadFloat r5, 2.094395160675049
  0x01b4: GetDot r3, 1
  0x01bc: Free1 r4
  0x01c0: GetDotStr r5, "!vec3"
  0x01c8: LoadInt r6, 0
  ...
  0x021c: Free1 r3
  0x0220: GetDotStr r5, "World"
  0x0228: SetDotRaw r4, 107
  0x0230: Free1 r5
  0x0234: GetDotStr r5, "self"
  ...
  0x0280: GetDotStr r2, "!qtpair"  ; body.sc:60
  0x0288: GetDotStr r4, "!rotateY"
  0x0290: LoadFloat r5, 4.188790321350098
  0x0298: GetDot r3, 1
  0x02a0: Free1 r4
  0x02a4: GetDotStr r5, "!vec3"
  0x02ac: LoadInt r6, 0
  ...
  0x0300: Free1 r3
  0x0304: GetDotStr r5, "World"
  0x030c: SetDotRaw r4, 107
  0x0314: Free1 r5
  0x0318: GetDotStr r5, "self"
