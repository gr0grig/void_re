...
func_1:
  ...
  0x0024: CallMethod r0, 0, 0x142  ; @patch+8 arena_flache_camera.sc:8
...
func_2:
  0x007c: GetDotStr r1, "playAnimation"  ; arena_flache_camera.sc:26
  ...
  0x00dc: CallMethod r1, 0, 0x36  ; @patch+8 arena_flache_camera.sc:28
