...
;   bc=0xb8a8 str=11("branches_pangolin.sc") val=8
;   bc=0xb8b0 str=11("branches_pangolin.sc") val=7
;   bc=0xb8c8 str=11("branches_pangolin.sc") val=13
;   bc=0xb8d0 str=11("branches_pangolin.sc") val=12
;   bc=0xb8e4 str=11("branches_pangolin.sc") val=13
...
; === function 180 (addHarpoon, branches_pangolin.sc, line 8) locals=1 ===
func_180:
  0xb8b0: CopyGlobWr r22, g0  ; branches_pangolin.sc:7
  0xb8b8: Copy r0, r4294967292
  0xb8c0: Free1 r0
  0xb8c4: Ret r0

; === function 181 (updateVeinData, branches_pangolin.sc, line 13) locals=1 ===
func_181:
  0xb8d0: Copy r-4, r0  ; branches_pangolin.sc:12
  0xb8d8: CopyGlobRd r0, g22
  0xb8e0: Free1 r0
  0xb8e4: Free1 r-4  ; branches_pangolin.sc:13
  0xb8e8: Ret r0
