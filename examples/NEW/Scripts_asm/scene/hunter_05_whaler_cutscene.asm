...
func_1:
  ...
  0x0024: CallMethod r0, 0, 0x142  ; @patch+8 hunter_05_whaler_cutscene.sc:8
  0x0030: BrNZ r1, 0x0000
...
func_2:
  ...
  0x0050: Free1 r0
  0x0054: GetDotStr r1, "loadAnimationSet"  ; hunter_05_whaler_cutscene.sc:18
  0x005c: LoadString r2, "anim/camera_whaler_cutscene.ase"  ; len=31, pool_off=0x15
  0x0068: GetDot r0, 1
  0x0070: Free3 r1, r2, r0
  0x0078: GetDotStr r1, "playAnimation"  ; hunter_05_whaler_cutscene.sc:19
  0x0080: Copy r-4, r2
  0x0088: GetDot r0, 1
  0x0090: Free2 r1, r2
  0x0098: ToStr r0
  ...
  0x00b0: CallMethod r0, 0, 0x243  ; @patch+8 hunter_05_whaler_cutscene.sc:21
...
func_3:
  ...
  0x0128: CallMethod r1, 0, 0x36  ; @patch+8 hunter_05_whaler_cutscene.sc:29
