...
;   bc=0x0954 str=1("fx_player_firework.sc") val=190
;   bc=0x09b4 str=1("fx_player_firework.sc") val=192
;   bc=0x09c4 str=1("fx_player_firework.sc") val=193
;   bc=0x09cc str=1("fx_player_firework.sc") val=193
;   bc=0x09f4 str=1("fx_player_firework.sc") val=194
;   bc=0x0a10 str=1("fx_player_firework.sc") val=195
;   bc=0x0a2c str=1("fx_player_firework.sc") val=196
;   bc=0x0a6c str=1("fx_player_firework.sc") val=193
;   bc=0x0a8c str=1("fx_player_firework.sc") val=200
;   bc=0x0ab0 str=1("fx_player_firework.sc") val=201
;   bc=0x0ae0 str=1("fx_player_firework.sc") val=203
;   bc=0x0ae8 str=1("fx_player_firework.sc") val=203
;   bc=0x0b04 str=1("fx_player_firework.sc") val=204
;   bc=0x0b48 str=1("fx_player_firework.sc") val=205
;   bc=0x0c24 str=1("fx_player_firework.sc") val=203
;   bc=0x0c44 str=1("fx_player_firework.sc") val=208
;   bc=0x0d04 str=1("fx_player_firework.sc") val=209
;   bc=0x0d18 str=1("fx_player_firework.sc") val=201
;   bc=0x0d20 str=1("fx_player_firework.sc") val=212
;   bc=0x0dd8 str=1("fx_player_firework.sc") val=215
;   bc=0x0dec str=1("fx_player_firework.sc") val=217
;   bc=0x0e08 str=1("fx_player_firework.sc") val=219
;   bc=0x0e10 str=1("fx_player_firework.sc") val=219
;   bc=0x0e38 str=1("fx_player_firework.sc") val=220
;   bc=0x0e54 str=1("fx_player_firework.sc") val=221
;   bc=0x0e8c str=1("fx_player_firework.sc") val=219
;   bc=0x0eac str=1("fx_player_firework.sc") val=224
;   bc=0x0edc str=1("fx_player_firework.sc") val=226
;   bc=0x0eec str=3("../std.sci") val=131
;   bc=0x0ef4 str=3("../std.sci") val=130
...
;   bc=0x153c str=3("../std.sci") val=106
;   bc=0x1544 str=3("../std.sci") val=105
;   bc=0x1564 str=3("../std.sci") val=242
;   bc=0x156c str=3("../std.sci") val=238
;   bc=0x158c str=3("../std.sci") val=239
;   bc=0x15a8 str=3("../std.sci") val=240
;   bc=0x15c0 str=3("../std.sci") val=237
...
func_1:
  ...
  0x0058: Sub r0
  0x005c: GetDotStr r1, "!vector"  ; fx_player_firework.sc:54
  0x0064: GetDot r0, 0
  0x006c: Free1 r1
  0x0070: ToStr r0
  ...
  0x0200: GetDotStr r1, "!vector"  ; fx_player_firework.sc:64
  0x0208: GetDot r0, 0
  0x0210: Free1 r1
  0x0214: ToStr r0
  ...
  0x0314: GetDotStr r1, "!vector"  ; fx_player_firework.sc:71
  0x031c: GetDot r0, 0
  0x0324: Free1 r1
  0x0328: ToStr r0
  ...
  0x03c8: GetDotStr r1, "!vector"  ; fx_player_firework.sc:76
  0x03d0: GetDot r0, 0
  0x03d8: Free1 r1
  0x03dc: ToStr r0
...
func_3:
  0x050c: GetDotStr r1, "logInfo"  ; fx_player_firework.sc:96
  ...
  0x0560: GetDotStr r2, "loadSound3D"  ; fx_player_firework.sc:100
  0x0568: CopyGlobWr r6, g4
  0x0570: GetDotStr r6, "irandMax"
...
func_4:
  0x063c: GetDotStr r2, "Scene"  ; ..\sound.sci:28
...
func_5:
  ...
  0x06ac: Mul r0
  0x06b0: GetDotStr r2, "playSound3D"  ; ..\sound.sci:259
  0x06b8: Copy r-8, r3
  0x06c0: Copy r-7, r4
  0x06c8: Copy r-6, r5
  0x06d0: Copy r-5, r6
  ...
  0x06f8: ToStr r1
  0x06fc: GetDotStr r6, "Globals"  ; ..\sound.sci:260
...
func_6:
  0x0774: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x077c: Copy r-4, r3
...
; === function 9 (fx_player_firework.sc, line 226) locals=18 ===
func_9:
  ...
  0x082c: Free1 r1
  0x0830: ToStr r0
  0x0834: GetDotStr r2, "logInfo"  ; fx_player_firework.sc:175
  ...
  0x0898: GetInd r1
  0x089c: Spawn r6, 586, 0x137
  0x08a8: .dword 0x000008f8  ; UNKNOWN opcode 0xf8
  ...
  0x0954: GetDotStr r3, "Scene"  ; fx_player_firework.sc:190
  0x095c: SetDotRaw r2, 1639
  0x0964: Free1 r3
  0x0968: GetDotStr r4, "!sphere"
  0x0970: GetDotStr r5, "Position"
  0x0978: LoadInt r6, 1
  0x0980: GetDot r3, 2
  0x0988: Free2 r4, r5
  0x0990: LoadBool r4, false
  0x0998: LoadInt r5, 2147483647
  0x09a0: GetDot r1, 3
  0x09a8: Free2 r2, r3
  0x09b0: ToStr r1
  0x09b4: Copy r1, r2  ; fx_player_firework.sc:192
  0x09bc: BrZ r2, 0x0a8c
  0x09c4: LoadInt r2, 0  ; fx_player_firework.sc:193
  0x09cc: Copy r2, r3  ; fx_player_firework.sc:193
  0x09d4: Copy r1, r5
  0x09dc: SetDotRaw r4, 1434
  0x09e4: Free1 r5
  0x09e8: CmpLt r3
  0x09ec: BrZ r3, 0x0a8c
  0x09f4: Copy r1, r4  ; fx_player_firework.sc:194
  0x09fc: Copy r2, r5
  0x0a04: SetDot r3, 1
  0x0a0c: ToStr r3
  0x0a10: Copy r3, r5  ; fx_player_firework.sc:195
  0x0a18: GetInd r4
  0x0a1c: .dword 0x000005b6  ; UNKNOWN opcode 0xb6
  0x0a20: Free1 r5
  0x0a24: BrZ r4, 0x0a6c
  0x0a2c: Copy r3, r6  ; fx_player_firework.sc:196
  0x0a34: SetDotRaw r5, 1462
  0x0a3c: Free1 r6
  0x0a40: LoadString r6, "onFireworkHit"  ; len=13, pool_off=0x688
  0x0a4c: CopyGlobWr r1, g7
  0x0a54: CopyGlobWr r2, g8
  0x0a5c: GetDot r4, 3
  0x0a64: Free3 r5, r6, r4
  0x0a6c: Free1 r3  ; fx_player_firework.sc:193
  0x0a70: Copy r2, r3
  0x0a78: Incr r3
  0x0a7c: Copy r3, r2
  0x0a84: Jmp r0, 0x09cc
  0x0a8c: Copy r-5, r4  ; fx_player_firework.sc:200
  0x0a94: SetDotRaw r3, 1698
  0x0a9c: Free1 r4
  0x0aa0: GetDot r2, 0
  0x0aa8: Free1 r3
  0x0aac: ToStr r2
  0x0ab0: Copy r2, r5  ; fx_player_firework.sc:201
  0x0ab8: SetDotRaw r4, 1724
  0x0ac0: Free1 r5
  0x0ac4: LoadInt r5, 2
  0x0acc: GetDot r3, 1
  0x0ad4: Free1 r4
  0x0ad8: BrZ r3, 0x0d20
  0x0ae0: LoadInt r3, 0  ; fx_player_firework.sc:203
  0x0ae8: Copy r3, r4  ; fx_player_firework.sc:203
  0x0af0: LoadInt r5, 3
  0x0af8: CmpLt r4
  0x0afc: BrZ r4, 0x0c44
  0x0b04: CopyGlobWr r5, g5  ; fx_player_firework.sc:204
  0x0b0c: GetDotStr r7, "irandMax"
  0x0b14: CopyGlobWr r5, g9
  0x0b1c: SetDotRaw r8, 1434
  0x0b24: Free1 r9
  0x0b28: GetDot r6, 1
  0x0b30: Free2 r7, r8
  0x0b38: SetDot r4, 1
  0x0b40: Free1 r6
  0x0b44: ToStr r4
  0x0b48: GetDotStr r7, "World"  ; fx_player_firework.sc:205
  0x0b50: SetDotRaw r6, 1745
  0x0b58: Free1 r7
  0x0b5c: GetDotStr r7, "Scene"
  0x0b64: Copy r4, r8
  0x0b6c: GetDotStr r9, "Position"
  0x0b74: GetDotStr r11, "!vec3"
  0x0b7c: GetDotStr r13, "randRange"
  0x0b84: LoadFloat r14, -0.30000001192092896
  0x0b8c: LoadFloat r15, 0.30000001192092896
  0x0b94: GetDot r12, 2
  0x0b9c: Free1 r13
  0x0ba0: GetDotStr r14, "randRange"
  0x0ba8: LoadInt r15, 0
  0x0bb0: LoadFloat r16, 0.5
  0x0bb8: GetDot r13, 2
  0x0bc0: Free1 r14
  0x0bc4: GetDotStr r15, "randRange"
  0x0bcc: LoadFloat r16, -0.30000001192092896
  0x0bd4: LoadFloat r17, 0.30000001192092896
  0x0bdc: GetDot r14, 2
  0x0be4: Free1 r15
  0x0be8: GetDot r10, 3
  0x0bf0: Free4 r11, r12, r13, r14
  0x0bfc: Add r9
  0x0c00: LoadString r10, "fx/fx_player_firework_prefab"  ; len=28, pool_off=0x6ec
  0x0c0c: GetDot r5, 4
  0x0c14: Free5 r6, r7, r8, r9, r10
  0x0c20: Free1 r5
  0x0c24: Free1 r4  ; fx_player_firework.sc:203
  0x0c28: Copy r3, r4
  0x0c30: Incr r4
  0x0c34: Copy r4, r3
  0x0c3c: Jmp r0, 0x0ae8
  0x0c44: GetDotStr r5, "loadSound3D"  ; fx_player_firework.sc:208
  0x0c4c: CopyGlobWr r7, g7
  0x0c54: GetDotStr r9, "irandMax"
  ...
  0x0d18: Jmp r0, 0x0dd8  ; fx_player_firework.sc:201
  0x0d20: GetDotStr r5, "loadSound3D"  ; fx_player_firework.sc:212
  0x0d28: CopyGlobWr r8, g7
  0x0d30: GetDotStr r9, "irandMax"
  0x0d38: CopyGlobWr r8, g11
  0x0d40: SetDotRaw r10, 1434
  0x0d48: Free1 r11
  0x0d4c: GetDot r8, 1
  0x0d54: Free2 r9, r10
  0x0d5c: SetDot r6, 1
  ...
  0x0da4: Free1 r6
  0x0da8: ToStr r5
  0x0dac: LoadFloat r6, 5.0
  0x0db4: LoadFloat r7, 20.0
  0x0dbc: LoadString r8, "Sound"  ; len=5, pool_off=0x5a6
  0x0dc8: Call r9, 0x0680
  0x0dd0: Call r4, 0x0634
  0x0dd8: LoadBool r3, true  ; fx_player_firework.sc:215
  0x0de0: CopyExtRd r3, 0, 2
  0x0dec: Copy r-5, r4  ; fx_player_firework.sc:217
  0x0df4: SetDotRaw r3, 1828
  0x0dfc: Free1 r4
  0x0e00: BrZ r3, 0x0edc
  0x0e08: LoadInt r3, 0  ; fx_player_firework.sc:219
  0x0e10: Copy r3, r4  ; fx_player_firework.sc:219
  0x0e18: Copy r-5, r6
  0x0e20: SetDotRaw r5, 1828
  0x0e28: Free1 r6
  0x0e2c: CmpLt r4
  0x0e30: BrZ r4, 0x0eac
  0x0e38: Copy r-5, r5  ; fx_player_firework.sc:220
  0x0e40: Copy r3, r6
  0x0e48: SetDot r4, 1
  0x0e50: ToStr r4
  0x0e54: CopyExtWr r2, 5, 2  ; fx_player_firework.sc:221
  0x0e60: Copy r4, r7
  0x0e68: SetDotRaw r6, 1841
  0x0e70: Free1 r7
  0x0e74: Add r5
  0x0e78: ToStr r5
  0x0e7c: CopyExtRd r5, 2, 2
  0x0e88: Free1 r5
  0x0e8c: Free1 r4  ; fx_player_firework.sc:219
  0x0e90: Copy r3, r4
  0x0e98: Incr r4
  0x0e9c: Copy r4, r3
  0x0ea4: Jmp r0, 0x0e10
  0x0eac: LoadFloat r3, -0.05000000074505806  ; fx_player_firework.sc:224
  0x0eb4: CopyExtWr r2, 4, 2
  0x0ec0: Inv r4
  0x0ec4: Mul r3
  0x0ec8: ToStr r3
  0x0ecc: CopyExtRd r3, 2, 2
  0x0ed8: Free1 r3
  0x0edc: Free4 r2, r1, r0, r-5  ; fx_player_firework.sc:226
  0x0ee8: Ret r0

; === function 10 (../std.sci, line 131) locals=4 ===
func_10:
  0x0ef4: GetDotStr r2, "World"  ; ../std.sci:130
...
func_11:
  ...
  0x0f64: GetDotStr r1, "!vec3"  ; fx_player_firework.sc:126
  0x0f6c: GetDot r0, 0
  0x0f74: Free1 r1
  0x0f78: ToStr r0
  0x0f7c: CopyExtRd r0, 2, 2
  0x0f88: Free1 r0
  0x0f8c: GetDotStr r2, "World"  ; fx_player_firework.sc:128
  0x0f94: SetDotRaw r1, 1898
  0x0f9c: Free1 r2
  0x0fa0: GetDotStr r2, "Scene"
  0x0fa8: LoadString r3, "ps_flare.ps"  ; len=11, pool_off=0x77f
  0x0fb4: GetDotStr r4, "Position"
  ...
  0x1124: Div r3
  0x1128: GetDotStr r4, "Position"  ; fx_player_firework.sc:142
  0x1130: LoadInt r5, 1
  0x1138: Copy r3, r6
  0x1140: Sub r5
  0x1144: LoadFloat r6, 0.4000000059604645
  0x114c: Mul r5
  0x1150: GetDotStr r7, "!vec3"
  ...
  0x11f4: .dword 0x0000067f  ; UNKNOWN opcode 0x7f
  0x11f8: Free2 r5, r4
  0x1200: GetDotStr r5, "applyForce"  ; fx_player_firework.sc:143
  0x1208: Copy r-4, r6
  0x1210: LoadInt r7, 20
  0x1218: Mul r6
  0x121c: GetDotStr r7, "Mass"
  0x1224: Mul r6
  0x1228: Copy r2, r7
  0x1230: Mul r6
  0x1234: GetDot r4, 1
  ...
  0x1260: RetV r1
  0x1264: Free1 r1
  0x1268: GetDotStr r3, "World"  ; fx_player_firework.sc:151
  0x1270: SetDotRaw r2, 1898
  0x1278: Free1 r3
  0x127c: GetDotStr r3, "Scene"
  0x1284: LoadString r4, "ps_firework_rbuffer_mine_physics.ps"  ; len=35, pool_off=0x804
  0x1290: GetDotStr r5, "Position"
  ...
  0x13e8: GetDotStr r3, "World"  ; fx_player_firework.sc:158
  0x13f0: SetDotRaw r2, 2215
  0x13f8: Free1 r3
  0x13fc: GetDotStr r3, "Scene"
  0x1404: GetDotStr r4, "Position"
  ...
  0x1498: GetDotStr r3, "remove"  ; fx_player_firework.sc:166
  0x14a0: GetDot r2, 0
  0x14a8: Free2 r3, r2
...
func_12:
  0x14c4: GetDotStr r5, "World"  ; fx_player_firework.sc:44
...
func_13:
  0x1544: Copy r-4, r0  ; ../std.sci:105
  0x154c: LoadFloat r1, 1000000.0
  0x1554: Div r0
  0x1558: Copy r0, r4294967291
  0x1560: Ret r0

; === function 14 (../std.sci, line 242) locals=3 ===
func_14:
  0x156c: Copy r-4, r0  ; ../std.sci:238
  0x1574: Free1 r2
  0x1578: RetV r1
  0x157c: Sub r0
  0x1580: ToInt r0
  0x1584: Copy r0, r4294967292
  0x158c: Copy r-4, r0  ; ../std.sci:239
  0x1594: LoadInt r1, 0
  0x159c: CmpLe r0
  0x15a0: BrZ r0, 0x15c0
  0x15a8: Copy r-4, r0  ; ../std.sci:240
  0x15b0: Neg r0
  0x15b4: Copy r0, r4294967291
  0x15bc: Ret r0
  0x15c0: Jmp r0, 0x156c  ; ../std.sci:237
...
func_18:
  0x1614: GetDotStr r1, "applyForce"  ; fx_player_firework.sc:32
  0x161c: Copy r-4, r2
  0x1624: GetDot r0, 1
