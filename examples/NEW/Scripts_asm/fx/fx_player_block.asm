...
;   bc=0x02b8 str=2("../std.sci") val=106
;   bc=0x02c0 str=2("../std.sci") val=105
...
func_1:
  ...
  0x0050: GetDotStr r1, "!vec3"  ; fx_player_block.sc:17
  0x0058: LoadInt r2, 0
  0x0060: LoadInt r3, 0
  0x0068: LoadInt r4, 0
  0x0070: GetDot r0, 3
  ...
  0x0088: Free1 r0
  0x008c: GetDotStr r1, "!vec3"  ; fx_player_block.sc:18
  0x0094: LoadInt r2, 0
  0x009c: LoadInt r3, 0
  0x00a4: LoadInt r4, 0
  0x00ac: GetDot r0, 3
  ...
  0x00c4: Free1 r0
  0x00c8: GetDotStr r1, "!vec3"  ; fx_player_block.sc:19
  0x00d0: LoadInt r2, 0
  0x00d8: LoadInt r3, 0
  0x00e0: LoadInt r4, 0
  0x00e8: GetDot r0, 3
  ...
  0x01c8: GetDotStr r1, "setGeomParameterColor"  ; fx_player_block.sc:28
  0x01d0: LoadInt r2, 0
  0x01d8: LoadString r3, "Color"  ; len=5, pool_off=0x28
  0x01e4: CopyGlobWr r3, g4
  0x01ec: GetDot r0, 3
  0x01f4: Free4 r1, r3, r4, r0
  0x0200: GetDotStr r1, "setGeomParameterFloat"  ; fx_player_block.sc:29
  0x0208: LoadInt r2, 0
  ...
  0x0298: GetDotStr r2, "remove"  ; fx_player_block.sc:37
  0x02a0: GetDot r1, 0
  0x02a8: Free2 r2, r1
...
func_2:
  0x02c0: Copy r-4, r0  ; ../std.sci:105
...
func_3:
  0x02e8: GetDotStr r1, "setPosition"  ; fx_player_block.sc:44
  0x02f0: Copy r-4, r2
  0x02f8: GetDot r0, 1
...
func_5:
  0x039c: GetDotStr r1, "!vec3"  ; fx_player_block.sc:63
  0x03a4: LoadInt r2, 0
  0x03ac: LoadInt r3, 0
  0x03b4: LoadInt r4, 0
  0x03bc: GetDot r0, 3
