...
; version=0, pool_size=1424
; globals=3, func_table=264
; bytecode=12576 bytes
...
;   bc=0x0ff4 str=2("../std.sci") val=27
;   bc=0x0ffc str=2("../std.sci") val=26
...
;   bc=0x25a4 str=2("../std.sci") val=106
;   bc=0x25ac str=2("../std.sci") val=105
;   bc=0x25cc str=2("../std.sci") val=126
;   bc=0x25d4 str=2("../std.sci") val=125
...
;   bc=0x2b64 str=1("fx_player_lasso.sc") val=354
;   bc=0x2b80 str=1("fx_player_lasso.sc") val=360
;   bc=0x2b98 str=1("fx_player_lasso.sc") val=361
;   bc=0x2bbc str=1("fx_player_lasso.sc") val=362
;   bc=0x2c10 str=1("fx_player_lasso.sc") val=363
;   bc=0x2cb4 str=1("fx_player_lasso.sc") val=365
;   bc=0x2cc0 str=1("fx_player_lasso.sc") val=366
;   bc=0x2d34 str=1("fx_player_lasso.sc") val=368
;   bc=0x2d44 str=1("fx_player_lasso.sc") val=369
;   bc=0x2d50 str=1("fx_player_lasso.sc") val=368
;   bc=0x2d58 str=1("fx_player_lasso.sc") val=372
;   bc=0x2d60 str=1("fx_player_lasso.sc") val=372
;   bc=0x2d7c str=1("fx_player_lasso.sc") val=373
;   bc=0x2db0 str=1("fx_player_lasso.sc") val=372
;   bc=0x2dcc str=1("fx_player_lasso.sc") val=376
;   bc=0x2de0 str=4("..\sound.sci") val=262
;   bc=0x2de8 str=4("..\sound.sci") val=258
;   bc=0x2e10 str=4("..\sound.sci") val=259
;   bc=0x2e5c str=4("..\sound.sci") val=260
;   bc=0x2eac str=4("..\sound.sci") val=261
;   bc=0x2ecc str=4("..\sound.sci") val=10
;   bc=0x2ed4 str=4("..\sound.sci") val=9
;   bc=0x2f20 str=4("..\sound.sci") val=29
;   bc=0x2f28 str=4("..\sound.sci") val=28
;   bc=0x2f64 str=4("..\sound.sci") val=29
;   bc=0x2f6c str=2("../std.sci") val=233
;   bc=0x2f74 str=2("../std.sci") val=230
;   bc=0x2f9c str=2("../std.sci") val=231
;   bc=0x2fc4 str=2("../std.sci") val=232
;   bc=0x3030 str=2("../std.sci") val=131
;   bc=0x3038 str=2("../std.sci") val=130
;   bc=0x3080 str=1("fx_player_lasso.sc") val=69
;   bc=0x3088 str=1("fx_player_lasso.sc") val=68
;   bc=0x30d8 str=1("fx_player_lasso.sc") val=69
;   bc=0x30e0 str=1("fx_player_lasso.sc") val=64
;   bc=0x30e8 str=1("fx_player_lasso.sc") val=59
;   bc=0x3100 str=1("fx_player_lasso.sc") val=62
;   bc=0x310c str=1("fx_player_lasso.sc") val=61
;   bc=0x3114 str=1("fx_player_lasso.sc") val=32
;   bc=0x311c str=1("fx_player_lasso.sc") val=32
; func_names:
;   0=initLasso
;   2=onPartCollision
...
;   +224: 6f 6e 00 00 00 00 80 30 00 00 03 00 00 00 00 00
...
func_1:
  ...
  0x0078: CallNat2 r0, func=322, info=0x3114  ; @patch+4 fx_player_lasso.sc:27
  0x0084: LoadBool r0, 0xffffffff  ; @patch+4 fx_player_lasso.sc:50
  0x008c: LoadNullStr r0
  0x0090: GetDotStr r1, "logInfo"  ; fx_player_lasso.sc:36
  ...
  0x0154: LoadInt r3, 5
  0x015c: SetDot r1, 1
  0x0164: CallNat2 r3, func=12512, info=0x2
...
func_2:
  ...
  0x0410: GetDotStr r3, "!fixedJointDesc"  ; fx_player_lasso.sc:296
  0x0418: GetDot r2, 0
  0x0420: Free1 r3
  0x0424: ToStr r2
  ...
  0x04cc: Copy r2, r4
  0x04d4: SetInd r4
  0x04d8: LoadString r0, "物吀慲獮慬楴湯瀀猀开氀椀洀昀愀开攀砀瀀氀..."  ; len=255, pool_off=0x44b, GARBLED
...
func_3:
  ...
  0x0678: Free1 r2
  0x067c: GetDotStr r4, "World"  ; fx_player_lasso.sc:192
  0x0684: SetDotRaw r3, 331
  0x068c: Free1 r4
  0x0690: GetDotStr r4, "Scene"
  0x0698: LoadString r5, "ps_lasso.ps"  ; len=11, pool_off=0x160
  0x06a4: GetDotStr r7, "!vec3"
  0x06ac: GetDot r6, 0
  0x06b4: Free1 r7
  ...
  0x0870: GetDotStr r7, "Scene"  ; fx_player_lasso.sc:209
  0x0878: SetDotRaw r6, 460
  0x0880: Free1 r7
  0x0884: GetDotStr r8, "!sphere"
  0x088c: GetDotStr r9, "Position"
  ...
  0x099c: GetDotStr r7, "!vec3"  ; fx_player_lasso.sc:217
  0x09a4: LoadInt r8, 0
  0x09ac: LoadInt r9, 0
...
; === function 4 (../std.sci, line 27) locals=6 ===
func_4:
  0x0ffc: Copy r-5, r5  ; ../std.sci:26
...
func_6:
  0x1f84: GetDotStr r1, "!vector"  ; fx_player_lasso.sc:173
  0x1f8c: GetDot r0, 0
  0x1f94: Free1 r1
  0x1f98: ToStr r0
  ...
  0x2030: GetDotStr r3, "!spline"  ; fx_player_lasso.sc:176
  0x2038: GetDot r2, 0
  0x2040: Free1 r3
  0x2044: ToStr r2
  ...
  0x2084: GetDotStr r5, "!bezier3D"  ; fx_player_lasso.sc:179
  0x208c: Copy r0, r7
  0x2094: Copy r3, r8
  0x209c: SetDot r6, 1
  0x20a4: Copy r1, r8
...
func_8:
  ...
  0x2208: Free1 r1
  0x220c: ToInt r0
  0x2210: GetDotStr r2, "!vector"  ; ../spline.sci:8
  0x2218: GetDot r1, 0
  0x2220: Free1 r2
  0x2224: ToStr r1
...
func_9:
  0x25ac: Copy r-4, r0  ; ../std.sci:105
  0x25b4: LoadFloat r1, 1000000.0
  0x25bc: Div r0
  0x25c0: Copy r0, r4294967291
  0x25c8: Ret r0

; === function 10 (../std.sci, line 126) locals=2 ===
func_10:
  0x25d4: Copy r-4, r0  ; ../std.sci:125
  0x25dc: Copy r-4, r1
  0x25e4: BOr r0
  0x25e8: Sqrt r0
  0x25ec: ToFloat r0
...
func_11:
  0x2608: GetDotStr r1, "logInfo"  ; fx_player_lasso.sc:321
  0x2610: LoadString r2, "Lasso explode"  ; len=13, pool_off=0x2cf
  0x261c: GetDot r0, 1
  0x2624: Free3 r1, r2, r0
  0x262c: GetDotStr r2, "Scene"  ; fx_player_lasso.sc:323
  0x2634: SetDotRaw r1, 460
  0x263c: Free1 r2
  0x2640: GetDotStr r3, "!sphere"
  0x2648: GetDotStr r4, "Position"
  0x2650: LoadInt r5, 1
  0x2658: GetDot r2, 2
  0x2660: Free2 r3, r4
  ...
  0x27a4: GetDotStr r3, "loadSound3D"  ; fx_player_lasso.sc:333
  0x27ac: LoadString r4, "fx_player_air_mine_explode"  ; len=26, pool_off=0x2fa
  0x27b8: GetDot r2, 1
  0x27c0: Free2 r3, r4
  0x27c8: ToStr r2
  0x27cc: GetDotStr r4, "!vec3"
  0x27d4: LoadInt r5, 0
  0x27dc: LoadInt r6, 0
  0x27e4: LoadInt r7, 0
  0x27ec: GetDot r3, 3
  ...
  0x2818: Call r7, 0x2de0
  0x2820: Copy r1, r2  ; fx_player_lasso.sc:334
  0x2828: Call r3, 0x2f20
  ...
  0x2854: GetDotStr r4, "irandRange"  ; fx_player_lasso.sc:337
  0x285c: LoadInt r5, 1
  0x2864: LoadInt r6, 3
  0x286c: GetDot r3, 2
  0x2874: Free1 r4
  0x2878: AsString r3
  0x287c: Call r5, 0x2f6c  ; fx_player_lasso.sc:338
  0x2884: GetDotStr r6, "randRange"  ; fx_player_lasso.sc:339
  0x288c: LoadFloat r7, 0.5
  0x2894: LoadInt r8, 1
  0x289c: GetDot r5, 2
  0x28a4: Free1 r6
  0x28a8: ToFloat r5
  0x28ac: GetDotStr r8, "World"  ; fx_player_lasso.sc:340
  0x28b4: SetDotRaw r7, 835
  0x28bc: Free1 r8
  0x28c0: GetDotStr r8, "Scene"
  0x28c8: LoadString r9, "fx_player_mine_part"  ; len=19, pool_off=0x354
  0x28d4: Copy r3, r10
  0x28dc: Add r9
  0x28e0: LoadString r10, ".pre"  ; len=4, pool_off=0x37a
  0x28ec: Add r9
  0x28f0: GetDotStr r10, "Position"
  0x28f8: Copy r5, r11
  0x2900: Copy r4, r12
  0x2908: Mul r11
  0x290c: Add r10
  ...
  0x2998: Call r3, 0x3030  ; fx_player_lasso.sc:344
  ...
  0x2b14: Free1 r6
  0x2b18: LoadString r6, "onDamageEx"  ; len=10, pool_off=0x418
  0x2b24: CopyGlobWr r0, g7
  0x2b2c: CopyGlobWr r1, g8
  0x2b34: GetDotStr r9, "Transform"
  0x2b3c: GetDotStr r10, "LinearVelocity"
  0x2b44: GetDotStr r11, "AngularVelocity"
  0x2b4c: GetDot r4, 6
  0x2b54: Free5 r5, r6, r9, r10, r11
  0x2b60: Free1 r4
  0x2b64: Copy r3, r4  ; fx_player_lasso.sc:354
  0x2b6c: Incr r4
  0x2b70: Copy r4, r3
  0x2b78: Jmp r0, 0x2a64
  0x2b80: GetDotStr r4, "!qtpair"  ; fx_player_lasso.sc:360
  0x2b88: GetDot r3, 0
  0x2b90: Free1 r4
  0x2b94: ToStr r3
  0x2b98: GetDotStr r4, "Position"  ; fx_player_lasso.sc:361
  0x2ba0: Copy r3, r5
  0x2ba8: SetInd r5
  0x2bac: LoadNullStr r0
  0x2bb0: Free5 r4, r1355, r0, r4, r0
  0x2bbc: GetDotStr r6, "World"  ; fx_player_lasso.sc:362
  0x2bc4: SetDotRaw r5, 331
  0x2bcc: Free1 r6
  0x2bd0: GetDotStr r6, "Scene"
  0x2bd8: LoadString r7, "ps_limfa_explode.ps"  ; len=19, pool_off=0x45a
  0x2be4: Copy r3, r8
  0x2bec: LoadString r9, "particlesystem/ps_limfa_explode"  ; len=31, pool_off=0x480
  0x2bf8: GetDot r4, 4
  0x2c00: Free5 r5, r6, r7, r8, r9
  0x2c0c: ToStr r4
  0x2c10: Copy r4, r7  ; fx_player_lasso.sc:363
  0x2c18: SetDotRaw r6, 540
  0x2c20: Free1 r7
  0x2c24: LoadString r7, "initExplode"  ; len=11, pool_off=0x4be
  0x2c30: GetDotStr r13, "World"
  0x2c38: SetDotRaw r12, 597
  0x2c40: Free1 r13
  0x2c44: SetDotRaw r11, 608
  0x2c4c: Free1 r12
  0x2c50: LoadString r12, "Limfa"  ; len=5, pool_off=0x264
  0x2c5c: CopyGlobWr r0, g13
  0x2c64: AsString r13
  0x2c68: Add r12
  0x2c6c: GetDot r10, 1
  0x2c74: Free2 r11, r12
  0x2c7c: SetDotRaw r9, 622
  0x2c84: Free1 r10
  0x2c88: SetDotRaw r8, 628
  0x2c90: Free1 r9
  0x2c94: LoadFloat r9, 0.5
  0x2c9c: Mul r8
  0x2ca0: GetDot r5, 2
  0x2ca8: Free4 r6, r7, r8, r5
  0x2cb4: Free1 r6  ; fx_player_lasso.sc:365
  0x2cb8: RetV r5
  0x2cbc: Free1 r5
  0x2cc0: GetDotStr r7, "Scene"  ; fx_player_lasso.sc:366
  0x2cc8: SetDotRaw r6, 1236
  0x2cd0: Free1 r7
  0x2cd4: GetDotStr r7, "Position"
  0x2cdc: LoadInt r8, 7
  0x2ce4: GetDotStr r10, "!invQuadratic"
  0x2cec: LoadInt r11, 30
  0x2cf4: LoadInt r12, 0
  0x2cfc: LoadInt r13, 0
  0x2d04: LoadInt r14, 1
  0x2d0c: GetDot r9, 4
  0x2d14: Free1 r10
  0x2d18: LoadInt r10, -1
  0x2d20: GetDot r5, 4
  0x2d28: Free4 r6, r7, r9, r5
  0x2d34: Copy r1, r5  ; fx_player_lasso.sc:368
  0x2d3c: BrZ r5, 0x2d58
  0x2d44: Free1 r6  ; fx_player_lasso.sc:369
  0x2d48: RetV r5
  0x2d4c: Free1 r5
  0x2d50: Jmp r0, 0x2d34  ; fx_player_lasso.sc:368
  0x2d58: LoadInt r5, 0  ; fx_player_lasso.sc:372
  0x2d60: Copy r5, r6  ; fx_player_lasso.sc:372
  0x2d68: LoadInt r7, 13
  0x2d70: CmpLt r6
  0x2d74: BrZ r6, 0x2dcc
  0x2d7c: Copy r-4, r9  ; fx_player_lasso.sc:373
  0x2d84: Copy r5, r10
  0x2d8c: SetDot r8, 1
  0x2d94: SetDotRaw r7, 489
  0x2d9c: Free1 r8
  0x2da0: GetDot r6, 0
  0x2da8: Free2 r7, r6
  0x2db0: Copy r5, r6  ; fx_player_lasso.sc:372
  0x2db8: Incr r6
  0x2dbc: Copy r6, r5
  0x2dc4: Jmp r0, 0x2d60
  0x2dcc: Free5 r4, r3, r2, r1, r0  ; fx_player_lasso.sc:376
  0x2dd8: Free1 r-4
  0x2ddc: Ret r0

; === function 12 (..\sound.sci, line 262) locals=9 ===
func_12:
  0x2de8: LoadString r1, "Master"  ; len=6, pool_off=0x4f2  ; ..\sound.sci:258
  0x2df4: Call r2, 0x2ecc
  0x2dfc: Copy r-4, r2
  0x2e04: Call r3, 0x2ecc
  0x2e0c: Mul r0
  0x2e10: GetDotStr r2, "playSound3D"  ; ..\sound.sci:259
  0x2e18: Copy r-8, r3
  0x2e20: Copy r-7, r4
  0x2e28: Copy r-6, r5
  0x2e30: Copy r-5, r6
  ...
  0x2e40: Copy r0, r8
  0x2e48: GetDot r1, 6
  0x2e50: Free3 r2, r3, r4
  0x2e58: ToStr r1
  0x2e5c: GetDotStr r6, "Globals"  ; ..\sound.sci:260
  0x2e64: SetDotRaw r5, 1298
  0x2e6c: Free1 r6
  0x2e70: Copy r-4, r6
  0x2e78: SetDot r4, 1
  0x2e80: Free1 r6
  0x2e84: SetDotRaw r3, 678
  0x2e8c: Free1 r4
  0x2e90: Copy r1, r4
  0x2e98: ToObj r4
  0x2e9c: GetDot r2, 1
  0x2ea4: Free3 r3, r4, r2
  0x2eac: Copy r1, r2  ; ..\sound.sci:261
  0x2eb4: Copy r2, r4294967287
  0x2ebc: Free5 r2, r1, r-4, r-7, r-8
  0x2ec8: Ret r0

; === function 13 (..\sound.sci, line 10) locals=5 ===
func_13:
  0x2ed4: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x2edc: Copy r-4, r3
  0x2ee4: LoadString r4, "Volume"  ; len=6, pool_off=0x522
  0x2ef0: Add r3
  0x2ef4: SetDot r1, 1
  0x2efc: Free1 r3
  0x2f00: SetDotRaw r0, 1326
  0x2f08: Free1 r1
  0x2f0c: ToFloat r0
  0x2f10: Copy r0, r4294967291
  0x2f18: Free1 r-4
  0x2f1c: Ret r0

; === function 14 (..\sound.sci, line 29) locals=4 ===
func_14:
  0x2f28: GetDotStr r2, "Scene"  ; ..\sound.sci:28
  0x2f30: SetDotRaw r1, 540
  0x2f38: Free1 r2
  0x2f3c: LoadString r2, "registerSlowMotionSFX"  ; len=21, pool_off=0x536
  0x2f48: Copy r-4, r3
  0x2f50: GetDot r0, 2
  0x2f58: Free4 r1, r2, r3, r0
  0x2f64: Free1 r-4  ; ..\sound.sci:29
  0x2f68: Ret r0

; === function 15 (../std.sci, line 233) locals=8 ===
func_15:
  0x2f74: GetDotStr r1, "randRange"  ; ../std.sci:230
  0x2f7c: LoadInt r2, 0
  0x2f84: LoadFloat r3, 1.5707963705062866
  0x2f8c: GetDot r0, 2
  0x2f94: Free1 r1
  0x2f98: ToFloat r0
  0x2f9c: GetDotStr r2, "randRange"  ; ../std.sci:231
  0x2fa4: LoadInt r3, 0
  0x2fac: LoadFloat r4, 6.2831854820251465
  0x2fb4: GetDot r1, 2
  0x2fbc: Free1 r2
  0x2fc0: ToFloat r1
  0x2fc4: GetDotStr r3, "!vec3"  ; ../std.sci:232
  0x2fcc: Copy r0, r4
  0x2fd4: Cos r4
  0x2fd8: Copy r1, r5
  0x2fe0: Sin r5
  ...
  0x3018: Free1 r3
  0x301c: ToStr r2
  0x3020: Copy r2, r4294967292
  0x3028: Free1 r2
  0x302c: Ret r0

; === function 16 (../std.sci, line 131) locals=4 ===
func_16:
  0x3038: GetDotStr r2, "World"  ; ../std.sci:130
  0x3040: SetDotRaw r1, 140
  0x3048: Free1 r2
  0x304c: LoadNullStr r2
  0x3050: LoadString r3, "getPlayer"  ; len=9, pool_off=0x560
  0x305c: GetDot r0, 2
  0x3064: Free3 r1, r2, r3
  0x306c: ToStr r0
  0x3070: Copy r0, r4294967292
  0x3078: Free1 r0
  0x307c: Ret r0

; === function 17 (fx_player_lasso.sc, line 69) locals=6 ===
func_17:
  0x3088: CopyExtWr r0, 2, 3  ; fx_player_lasso.sc:68
  0x3094: SetDotRaw r1, 540
  0x309c: Free1 r2
  0x30a0: LoadString r2, "onPartCollision"  ; len=15, pool_off=0x572
  0x30ac: GetDotStr r3, "self"
  0x30b4: Copy r-5, r4
  0x30bc: Copy r-4, r5
  0x30c4: GetDot r0, 4
  0x30cc: Free5 r1, r2, r3, r4, r0
  0x30d8: Free1 r-5  ; fx_player_lasso.sc:69
  0x30dc: Ret r0

; === function 18 (fx_player_lasso.sc, line 64) locals=2 ===
func_18:
  0x30e8: Copy r-4, r0  ; fx_player_lasso.sc:59
  0x30f0: CopyExtRd r0, 0, 3
  0x30fc: Free1 r0
  0x3100: Free1 r1  ; fx_player_lasso.sc:62
  0x3104: RetV r0
  0x3108: ToInt r0
  0x310c: Jmp r0, 0x3100  ; fx_player_lasso.sc:61

; === function 19 (fx_player_lasso.sc, line 32) locals=0 ===
func_19:
  0x311c: Ret r0  ; fx_player_lasso.sc:32
