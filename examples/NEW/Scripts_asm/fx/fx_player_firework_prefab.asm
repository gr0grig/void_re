...
;   bc=0x00f0 str=2("../std.sci") val=242
;   bc=0x00f8 str=2("../std.sci") val=238
;   bc=0x0118 str=2("../std.sci") val=239
;   bc=0x0134 str=2("../std.sci") val=240
;   bc=0x014c str=2("../std.sci") val=237
...
func_1:
  0x001c: GetDotStr r1, "irandRange"  ; fx_player_firework_prefab.sc:5
  ...
  0x00d4: GetDotStr r2, "remove"  ; fx_player_firework_prefab.sc:15
  0x00dc: GetDot r1, 0
  0x00e4: Free2 r2, r1
...
func_2:
  0x00f8: Copy r-4, r0  ; ../std.sci:238
  0x0100: Free1 r2
  0x0104: RetV r1
  0x0108: Sub r0
  0x010c: ToInt r0
  0x0110: Copy r0, r4294967292
  0x0118: Copy r-4, r0  ; ../std.sci:239
  0x0120: LoadInt r1, 0
  0x0128: CmpLe r0
  0x012c: BrZ r0, 0x014c
  0x0134: Copy r-4, r0  ; ../std.sci:240
  0x013c: Neg r0
  0x0140: Copy r0, r4294967291
  0x0148: Ret r0
  0x014c: Jmp r0, 0x00f8  ; ../std.sci:237
