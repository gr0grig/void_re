...
;   bc=0x0790 str=2("vein_arbocliff_rock.sc") val=35
;   bc=0x0798 str=2("vein_arbocliff_rock.sc") val=33
;   bc=0x07c0 str=2("vein_arbocliff_rock.sc") val=34
;   bc=0x0820 str=2("vein_arbocliff_rock.sc") val=35
...
;   bc=0x0c6c str=2("vein_arbocliff_rock.sc") val=22
;   bc=0x0c74 str=2("vein_arbocliff_rock.sc") val=15
;   bc=0x0c78 str=2("vein_arbocliff_rock.sc") val=16
;   bc=0x0cd8 str=2("vein_arbocliff_rock.sc") val=17
;   bc=0x0d14 str=2("vein_arbocliff_rock.sc") val=18
;   bc=0x0d74 str=2("vein_arbocliff_rock.sc") val=19
;   bc=0x0db0 str=2("vein_arbocliff_rock.sc") val=20
;   bc=0x0e10 str=2("vein_arbocliff_rock.sc") val=21
;   bc=0x0e4c str=2("vein_arbocliff_rock.sc") val=22
...
func_3:
  0x0320: GetDotStr r1, "findMaterial"  ; vein_arbocliff_rock.sc:26
  0x0328: LoadString r2, "Material #4"  ; len=11, pool_off=0x1bc
  0x0334: GetDot r0, 1
  0x033c: Free2 r1, r2
  0x0344: ToInt r0
  0x0348: GetDotStr r2, "setLocalGeomParameterColor"  ; vein_arbocliff_rock.sc:27
  0x0350: Copy r0, r3
...
func_11:
  ...
  0x0550: ATan r2
  0x0554: GetDotStr r2, "World"  ; vein_base.sci:135
  0x055c: SetDotRaw r1, 298
  0x0564: Free1 r2
  0x0568: LoadString r2, "getDomainMineIncome"  ; len=19, pool_off=0x232
  0x0574: GetDot r0, 1
  0x057c: Free2 r1, r2
  0x0584: ToFloat r0
...
func_14:
  0x0798: GetDotStr r1, "findMaterial"  ; vein_arbocliff_rock.sc:33
  0x07a0: LoadString r2, "Material #4"  ; len=11, pool_off=0x1bc
  0x07ac: GetDot r0, 1
  0x07b4: Free2 r1, r2
  0x07bc: ToInt r0
  0x07c0: GetDotStr r2, "setLocalGeomParameterFloat"  ; vein_arbocliff_rock.sc:34
  0x07c8: Copy r0, r3
  0x07d0: LoadString r4, "Threshold"  ; len=9, pool_off=0x285
  0x07dc: LoadInt r6, 1
  0x07e4: Copy r-4, r7
  0x07ec: Sub r6
  0x07f0: LoadInt r7, 0
  ...
  0x0820: Ret r0  ; vein_arbocliff_rock.sc:35
...
func_22:
  ...
  0x0960: SetDotRaw r1, 298
  0x0968: Free1 r2
  0x096c: LoadString r2, "updateVeinData"  ; len=14, pool_off=0x297
  ...
  0x09b0: SetDotRaw r1, 691
  0x09b8: Free1 r2
  0x09bc: LoadNullStr r2
  0x09c0: LoadString r3, "getLocationProps"  ; len=16, pool_off=0x2bb
  0x09cc: GetDot r0, 2
  ...
  0x09f8: Copy r0, r3
  0x0a00: SetDotRaw r2, 731
  0x0a08: Free1 r3
  0x0a0c: BrZ r2, 0x0a1c
  0x0a14: LoadBool r1, true
  0x0a1c: BrZ r1, 0x0a60
  0x0a24: Copy r0, r4  ; vein_base.sci:229
  0x0a2c: SetDotRaw r3, 731
  0x0a34: Free1 r4
  0x0a38: SetDotRaw r2, 298
  0x0a40: Free1 r3
  0x0a44: LoadString r3, "onVeinOpened"  ; len=12, pool_off=0x2e2
  0x0a50: GetDot r1, 1
  ...
  0x0b84: SetDotRaw r7, 799
  0x0b8c: Free1 r8
  0x0b90: GetDotStr r8, "Scene"
  0x0b98: LoadString r9, "limfa.pre"  ; len=9, pool_off=0x330
  0x0ba4: Copy r5, r10
  0x0bac: LoadString r11, "vein_badabum_part"  ; len=17, pool_off=0x342
  0x0bb8: GetDot r6, 4
  0x0bc0: Free5 r7, r8, r9, r10, r11
  0x0bcc: ToStr r6
  0x0bd0: Copy r6, r9  ; vein_base.sci:245
  0x0bd8: SetDotRaw r8, 298
  0x0be0: Free1 r9
  0x0be4: LoadString r9, "initPart"  ; len=8, pool_off=0x364
...
func_23:
  0x0c74: LoadNullStr2 r0  ; vein_arbocliff_rock.sc:15
  0x0c78: GetDotStr r3, "World"  ; vein_arbocliff_rock.sc:16
  0x0c80: SetDotRaw r2, 799
  0x0c88: Free1 r3
  0x0c8c: GetDotStr r3, "Scene"
  0x0c94: LoadString r4, "minewalls/minewall_arbocliff_rockpart1.pre"  ; len=42, pool_off=0x28
  0x0ca0: GetDotStr r5, "Transform"
  0x0ca8: LoadString r6, "vein_part"  ; len=9, pool_off=0x374
  0x0cb4: GetDot r1, 4
  0x0cbc: Free5 r2, r3, r4, r5, r6
  0x0cc8: ToStr r1
  0x0ccc: Copy r1, r0
  0x0cd4: Free1 r1
  0x0cd8: Copy r0, r3  ; vein_arbocliff_rock.sc:17
  0x0ce0: SetDotRaw r2, 298
  0x0ce8: Free1 r3
  0x0cec: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x386
  0x0cf8: Copy r-4, r4
  0x0d00: GetDot r1, 2
  0x0d08: Free4 r2, r3, r4, r1
  0x0d14: GetDotStr r3, "World"  ; vein_arbocliff_rock.sc:18
  0x0d1c: SetDotRaw r2, 799
  0x0d24: Free1 r3
  0x0d28: GetDotStr r3, "Scene"
  0x0d30: LoadString r4, "minewalls/minewall_arbocliff_rockpart2.pre"  ; len=42, pool_off=0x7c
  0x0d3c: GetDotStr r5, "Transform"
  0x0d44: LoadString r6, "vein_part"  ; len=9, pool_off=0x374
  0x0d50: GetDot r1, 4
  0x0d58: Free5 r2, r3, r4, r5, r6
  0x0d64: ToStr r1
  0x0d68: Copy r1, r0
  0x0d70: Free1 r1
  0x0d74: Copy r0, r3  ; vein_arbocliff_rock.sc:19
  0x0d7c: SetDotRaw r2, 298
  0x0d84: Free1 r3
  0x0d88: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x386
  0x0d94: Copy r-4, r4
  0x0d9c: GetDot r1, 2
  0x0da4: Free4 r2, r3, r4, r1
  0x0db0: GetDotStr r3, "World"  ; vein_arbocliff_rock.sc:20
  0x0db8: SetDotRaw r2, 799
  0x0dc0: Free1 r3
  0x0dc4: GetDotStr r3, "Scene"
  0x0dcc: LoadString r4, "minewalls/minewall_arbocliff_rockpart3.pre"  ; len=42, pool_off=0xd0
  0x0dd8: GetDotStr r5, "Transform"
  0x0de0: LoadString r6, "vein_part"  ; len=9, pool_off=0x374
  0x0dec: GetDot r1, 4
  0x0df4: Free5 r2, r3, r4, r5, r6
  0x0e00: ToStr r1
  0x0e04: Copy r1, r0
  0x0e0c: Free1 r1
  0x0e10: Copy r0, r3  ; vein_arbocliff_rock.sc:21
  0x0e18: SetDotRaw r2, 298
  0x0e20: Free1 r3
  0x0e24: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x386
  0x0e30: Copy r-4, r4
  0x0e38: GetDot r1, 2
  0x0e40: Free4 r2, r3, r4, r1
  0x0e4c: Free2 r0, r-4  ; vein_arbocliff_rock.sc:22
  0x0e54: Ret r0
...
func_24:
  ...
  0x0e7c: ATan r2
  0x0e80: GetDotStr r2, "irandRange"  ; vein_base.sci:159
...
func_27:
  ...
  0x0f5c: ATan r2
  0x0f60: GetDotStr r1, "irandRange"  ; vein_base.sci:179
  0x0f68: LoadInt r2, 2
  0x0f70: LoadInt r3, 3
  0x0f78: GetDot r0, 2
  0x0f80: Free1 r1
  ...
  0x1020: Mul r6
  0x1024: Sub r5
  0x1028: CallMethod r5, 545, 0x20a  ; @patch+8 vein_base.sci:186
  0x1034: LoadFalse r0
  0x1038: Copy r4, r6
  0x1040: Sub r5
  0x1044: Copy r5, r2
