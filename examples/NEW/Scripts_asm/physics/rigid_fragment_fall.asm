...
;   bc=0x011c str=2("../std.sci") val=242
;   bc=0x0124 str=2("../std.sci") val=238
;   bc=0x0144 str=2("../std.sci") val=239
;   bc=0x0160 str=2("../std.sci") val=240
;   bc=0x0178 str=2("../std.sci") val=237
...
func_1:
  ...
  0x0044: CallMethod r0, 27, 0x142  ; @patch+8 rigid_fragment_fall.sc:28
...
func_3:
  0x0124: Copy r-4, r0  ; ../std.sci:238
  0x012c: Free1 r2
  0x0130: RetV r1
  0x0134: Sub r0
  0x0138: ToInt r0
  0x013c: Copy r0, r4294967292
  0x0144: Copy r-4, r0  ; ../std.sci:239
  0x014c: LoadInt r1, 0
  0x0154: CmpLe r0
  0x0158: BrZ r0, 0x0178
  0x0160: Copy r-4, r0  ; ../std.sci:240
  0x0168: Neg r0
  0x016c: Copy r0, r4294967291
  0x0174: Ret r0
  0x0178: Jmp r0, 0x0124  ; ../std.sci:237
...
func_7:
  0x01f0: GetDotStr r1, "applyForce"  ; rigid_fragment_fall.sc:17
  0x01f8: Copy r-4, r2
  0x0200: GetDotStr r3, "Mass"
  0x0208: Mul r2
  0x020c: GetDot r0, 1
