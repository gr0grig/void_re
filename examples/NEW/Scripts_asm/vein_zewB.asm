...
;   bc=0x07c0 str=2("vein_zewB.sc") val=38
;   bc=0x07c8 str=2("vein_zewB.sc") val=36
;   bc=0x07f0 str=2("vein_zewB.sc") val=37
;   bc=0x0850 str=2("vein_zewB.sc") val=38
...
;   bc=0x0c9c str=2("vein_zewB.sc") val=25
;   bc=0x0ca4 str=2("vein_zewB.sc") val=16
;   bc=0x0ca8 str=2("vein_zewB.sc") val=17
;   bc=0x0d08 str=2("vein_zewB.sc") val=18
;   bc=0x0d44 str=2("vein_zewB.sc") val=19
;   bc=0x0da4 str=2("vein_zewB.sc") val=20
;   bc=0x0de0 str=2("vein_zewB.sc") val=21
;   bc=0x0e40 str=2("vein_zewB.sc") val=22
;   bc=0x0e7c str=2("vein_zewB.sc") val=23
;   bc=0x0edc str=2("vein_zewB.sc") val=24
;   bc=0x0f18 str=2("vein_zewB.sc") val=25
...
; === function 2 (vein_zewB.sc, line 12) locals=3 ===
func_2:
  0x0048: GetDotStr r1, "!geometryCache"  ; vein_zewB.sc:7
  0x0050: GetDot r0, 0
  0x0058: Free1 r1
  0x005c: ToStr r0
...
; === function 4 (vein_zewB.sc, line 31) locals=6 ===
func_4:
  0x0350: GetDotStr r1, "findMaterial"  ; vein_zewB.sc:29
  0x0358: LoadString r2, "Material #4"  ; len=11, pool_off=0x1c8
  0x0364: GetDot r0, 1
  0x036c: Free2 r1, r2
  0x0374: ToInt r0
  0x0378: GetDotStr r2, "setLocalGeomParameterColor"  ; vein_zewB.sc:30
  0x0380: Copy r0, r3
...
; === function 15 (vein_zewB.sc, line 38) locals=9 ===
func_15:
  0x07c8: GetDotStr r1, "findMaterial"  ; vein_zewB.sc:36
  0x07d0: LoadString r2, "Material #4"  ; len=11, pool_off=0x1c8
  0x07dc: GetDot r0, 1
  0x07e4: Free2 r1, r2
  0x07ec: ToInt r0
  0x07f0: GetDotStr r2, "setLocalGeomParameterFloat"  ; vein_zewB.sc:37
  0x07f8: Copy r0, r3
...
; === function 24 (vein_zewB.sc, line 25) locals=7 ===
func_24:
  0x0ca4: LoadNullStr2 r0  ; vein_zewB.sc:16
  0x0ca8: GetDotStr r3, "World"  ; vein_zewB.sc:17
  0x0cb0: SetDotRaw r2, 811
  0x0cb8: Free1 r3
  0x0cbc: GetDotStr r3, "Scene"
  0x0cc4: LoadString r4, "minewalls/minewall_zewB_part1.pre"  ; len=33, pool_off=0x28
  ...
  0x0cfc: Copy r1, r0
  0x0d04: Free1 r1
  0x0d08: Copy r0, r3  ; vein_zewB.sc:18
  ...
  0x0d44: GetDotStr r3, "World"  ; vein_zewB.sc:19
  0x0d4c: SetDotRaw r2, 811
  0x0d54: Free1 r3
  0x0d58: GetDotStr r3, "Scene"
  0x0d60: LoadString r4, "minewalls/minewall_zewB_part2.pre"  ; len=33, pool_off=0x6a
  ...
  0x0d98: Copy r1, r0
  0x0da0: Free1 r1
  0x0da4: Copy r0, r3  ; vein_zewB.sc:20
  ...
  0x0de0: GetDotStr r3, "World"  ; vein_zewB.sc:21
  0x0de8: SetDotRaw r2, 811
  0x0df0: Free1 r3
  0x0df4: GetDotStr r3, "Scene"
  0x0dfc: LoadString r4, "minewalls/minewall_zewB_part3.pre"  ; len=33, pool_off=0xac
  ...
  0x0e34: Copy r1, r0
  0x0e3c: Free1 r1
  0x0e40: Copy r0, r3  ; vein_zewB.sc:22
  ...
  0x0e7c: GetDotStr r3, "World"  ; vein_zewB.sc:23
  0x0e84: SetDotRaw r2, 811
  0x0e8c: Free1 r3
  0x0e90: GetDotStr r3, "Scene"
  0x0e98: LoadString r4, "minewalls/minewall_zewB_part4.pre"  ; len=33, pool_off=0xee
  ...
  0x0ed0: Copy r1, r0
  0x0ed8: Free1 r1
  0x0edc: Copy r0, r3  ; vein_zewB.sc:24
  ...
  0x0f18: Free2 r0, r-4  ; vein_zewB.sc:25
  0x0f20: Ret r0
