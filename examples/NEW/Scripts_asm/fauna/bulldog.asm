...
;   bc=0x05f8 str=3("../std.sci") val=126
;   bc=0x0600 str=3("../std.sci") val=125
...
;   bc=0x09cc str=3("../std.sci") val=116
;   bc=0x09d4 str=3("../std.sci") val=115
;   bc=0x09f4 str=3("../std.sci") val=405
;   bc=0x09fc str=3("../std.sci") val=384
;   bc=0x0a08 str=3("../std.sci") val=384
;   bc=0x0a14 str=3("../std.sci") val=385
;   bc=0x0a20 str=3("../std.sci") val=385
;   bc=0x0a2c str=3("../std.sci") val=387
;   bc=0x0a6c str=3("../std.sci") val=388
;   bc=0x0a80 str=3("../std.sci") val=390
;   bc=0x0aac str=3("../std.sci") val=391
;   bc=0x0acc str=3("../std.sci") val=392
;   bc=0x0ae0 str=3("../std.sci") val=393
;   bc=0x0b00 str=3("../std.sci") val=394
;   bc=0x0b1c str=3("../std.sci") val=395
;   bc=0x0b38 str=3("../std.sci") val=394
;   bc=0x0b40 str=3("../std.sci") val=397
;   bc=0x0b5c str=3("../std.sci") val=393
;   bc=0x0b64 str=3("../std.sci") val=400
;   bc=0x0b80 str=3("../std.sci") val=403
;   bc=0x0bac str=3("../std.sci") val=404
;   bc=0x0bc0 str=3("../std.sci") val=106
;   bc=0x0bc8 str=3("../std.sci") val=105
...
func_1:
  ...
  0x005c: Free1 r0
  0x0060: GetDotStr r1, "loadSound3D"  ; bulldog.sc:29
...
func_5:
  0x0248: GetDotStr r2, "Scene"  ; ..\sound.sci:28
...
func_6:
  ...
  0x02b8: Mul r0
  0x02bc: GetDotStr r2, "playSound3D"  ; ..\sound.sci:259
  0x02c4: Copy r-8, r3
  0x02cc: Copy r-7, r4
  0x02d4: Copy r-6, r5
  0x02dc: Copy r-5, r6
  ...
  0x0304: ToStr r1
  0x0308: GetDotStr r6, "Globals"  ; ..\sound.sci:260
...
func_7:
  0x0380: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x0388: Copy r-4, r3
...
func_8:
  ...
  0x0458: GetDotStr r4, "stop"  ; bulldog.sc:228
...
func_10:
  0x04c0: GetDotStr r1, "irandMax"  ; bulldog.sc:201
  0x04c8: LoadInt r2, 2
  0x04d0: GetDot r0, 1
  0x04d8: Free1 r1
  0x04dc: LoadInt r1, 1
  0x04e4: Add r0
  0x04e8: ToInt r0
  0x04ec: GetDotStr r2, "playAnimationInplace"  ; bulldog.sc:202
...
func_11:
  0x0600: Copy r-4, r0  ; ../std.sci:125
  0x0608: Copy r-4, r1
  0x0610: BOr r0
  0x0614: Sqrt r0
  0x0618: ToFloat r0
...
func_13:
  ...
  0x06bc: RetV r2
  0x06c0: ToInt r2
  0x06c4: GetDotStr r4, "getRotation"  ; ../follow.sci:24
  0x06cc: GetDot r3, 0
  0x06d4: Free1 r4
  0x06d8: GetDotStr r4, "TrajectoryRotation"
  0x06e0: Add r3
  0x06e4: ToFloat r3
  0x06e8: Copy r-6, r6  ; ../follow.sci:27
  0x06f0: SetDotRaw r5, 375
  0x06f8: Free1 r6
  0x06fc: GetDotStr r6, "NavMesh"
  0x0704: GetDot r4, 1
  0x070c: Free2 r5, r6
  0x0714: ToStr r4
  ...
  0x0734: GetDotStr r6, "findPath"  ; ../follow.sci:29
  0x073c: Copy r4, r8
  ...
  0x07b4: GetDot r5, 0
  0x07bc: Free2 r6, r5
  0x07c4: GetDotStr r6, "moveRoute"  ; ../follow.sci:32
  0x07cc: Copy r1, r7
  0x07d4: GetDot r5, 1
  ...
  0x0800: GetDotStr r9, "TrajectoryRotation"
  0x0808: ToFloat r9
  ...
  0x0848: GetDot r7, 1
  0x0850: Free1 r8
  0x0854: GetDotStr r9, "updateTrajectory"  ; ../follow.sci:43
  0x085c: GetDot r8, 0
  0x0864: Free1 r9
  0x0868: ToFloat r8
  0x086c: Copy r8, r6
  ...
  0x0998: GetDotStr r8, "moveRoute"  ; ../follow.sci:62
  0x09a0: Copy r1, r9
  0x09a8: GetDot r7, 1
...
; === function 14 (../std.sci, line 116) locals=2 ===
func_14:
  0x09d4: Copy r-4, r0  ; ../std.sci:115
  0x09dc: LoadInt r1, 1000
  0x09e4: Mul r0
  0x09e8: Copy r0, r4294967291
  0x09f0: Ret r0

; === function 15 (../std.sci, line 405) locals=9 ===
func_15:
  0x09fc: Copy r-5, r0  ; ../std.sci:384
  0x0a04: Cos r0
  0x0a08: Copy r-5, r1  ; ../std.sci:384
  0x0a10: Sin r1
  0x0a14: Copy r-6, r2  ; ../std.sci:385
  0x0a1c: Cos r2
  0x0a20: Copy r-6, r3  ; ../std.sci:385
  0x0a28: Sin r3
  0x0a2c: Copy r1, r4  ; ../std.sci:387
  0x0a34: Copy r2, r5
  0x0a3c: Mul r4
  0x0a40: Copy r0, r5
  0x0a48: Copy r3, r6
  ...
  0x0a6c: Copy r-4, r4  ; ../std.sci:388
  0x0a74: Neg r4
  0x0a78: Copy r4, r4294967292
  0x0a80: Copy r1, r4  ; ../std.sci:390
  0x0a88: Copy r3, r5
  0x0a90: Mul r4
  0x0a94: Copy r0, r5
  0x0a9c: Copy r2, r6
  0x0aa4: Mul r5
  0x0aa8: Add r4
  0x0aac: Copy r4, r5  ; ../std.sci:391
  0x0ab4: Abs r5
  0x0ab8: LoadInt r6, 1
  0x0ac0: CmpLt r5
  0x0ac4: BrZ r5, 0x0b80
  0x0acc: Copy r4, r5  ; ../std.sci:392
  0x0ad4: ACos r5
  0x0ad8: Copy r5, r4
  0x0ae0: Copy r-4, r5  ; ../std.sci:393
  0x0ae8: Abs r5
  0x0aec: Copy r4, r6
  0x0af4: CmpGe r5
  0x0af8: BrZ r5, 0x0b64
  0x0b00: Copy r-4, r5  ; ../std.sci:394
  0x0b08: LoadInt r6, 0
  0x0b10: CmpLt r5
  0x0b14: BrZ r5, 0x0b40
  0x0b1c: Copy r-6, r5  ; ../std.sci:395
  0x0b24: Copy r4, r6
  0x0b2c: Sub r5
  0x0b30: Copy r5, r4294967290
  0x0b38: Jmp r0, 0x0b5c  ; ../std.sci:394
  0x0b40: Copy r-6, r5  ; ../std.sci:397
  0x0b48: Copy r4, r6
  0x0b50: Add r5
  0x0b54: Copy r5, r4294967290
  0x0b5c: Jmp r0, 0x0b80  ; ../std.sci:393
  0x0b64: Copy r-6, r5  ; ../std.sci:400
  0x0b6c: Copy r-4, r6
  0x0b74: Add r5
  0x0b78: Copy r5, r4294967290
  0x0b80: GetDotStr r6, "setRotation"  ; ../std.sci:403
  0x0b88: Copy r-6, r7
  0x0b90: GetDotStr r8, "TrajectoryRotation"
  0x0b98: Sub r7
  0x0b9c: GetDot r5, 1
  0x0ba4: Free3 r6, r7, r5
  0x0bac: Copy r-6, r5  ; ../std.sci:404
  0x0bb4: Copy r5, r4294967289
  0x0bbc: Ret r0

; === function 16 (../std.sci, line 106) locals=2 ===
func_16:
  0x0bc8: Copy r-4, r0  ; ../std.sci:105
...
func_19:
  0x0d4c: GetDotStr r1, "remove"  ; bulldog.sc:313
  0x0d54: GetDot r0, 0
  0x0d5c: Free2 r1, r0
...
func_20:
  0x0d70: GetDotStr r1, "stop"  ; bulldog.sc:280
  0x0d78: LoadBool r2, true
  0x0d80: GetDot r0, 1
  0x0d88: Free2 r1, r0
  0x0d90: GetDotStr r0, "Position"  ; bulldog.sc:282
  0x0d98: ToStr r0
  0x0d9c: Copy r-6, r1  ; bulldog.sc:283
  0x0da4: Copy r0, r2
  0x0dac: Sub r1
  0x0db0: ToStr r1
  0x0db4: GetDotStr r3, "moveLine"  ; bulldog.sc:284
  0x0dbc: Copy r0, r4
  0x0dc4: Copy r1, r5
  0x0dcc: Inv r5
  0x0dd0: GetDot r2, 2
  0x0dd8: Free4 r3, r4, r5, r2
  0x0de4: GetDotStr r3, "playAnimationInplace"  ; bulldog.sc:286
  ...
  0x0ee0: GetDot r4, 0
  0x0ee8: Free2 r5, r4
  0x0ef0: GetDotStr r5, "findBone"  ; bulldog.sc:300
  0x0ef8: LoadString r6, ""  ; len=0, pool_off=0x0
  0x0f04: GetDot r4, 1
  0x0f0c: Free2 r5, r6
  0x0f14: ToInt r4
  0x0f18: GetDotStr r6, "getBoneRotation"  ; bulldog.sc:301
  0x0f20: Copy r4, r7
  0x0f28: GetDot r5, 1
  0x0f30: Free1 r6
  0x0f34: ToStr r5
  0x0f38: GetDotStr r7, "invert"  ; bulldog.sc:302
  0x0f40: Copy r-5, r8
  0x0f48: GetDot r6, 1
  0x0f50: Free2 r7, r8
  0x0f58: ToStr r6
  ...
  0x0f64: Free1 r6
  0x0f68: GetDotStr r7, "setPosition"  ; bulldog.sc:305
  0x0f70: Copy r-4, r9
  0x0f78: SetDotRaw r8, 335
  0x0f80: Free1 r9
  0x0f84: GetDot r6, 1
  0x0f8c: Free3 r7, r8, r6
  0x0f94: GetDotStr r7, "setBoneRotation"  ; bulldog.sc:306
  0x0f9c: Copy r4, r8
  0x0fa4: Copy r5, r9
  0x0fac: Copy r-5, r10
  0x0fb4: Copy r-4, r12
...
func_22:
  0x10c8: GetDotStr r1, "playAnimation"  ; bulldog.sc:15
  0x10d0: Copy r-5, r2
  0x10d8: GetDot r0, 1
  0x10e0: Free2 r1, r2
  0x10e8: ToStr r0
...
func_24:
  ...
  0x11ec: GetDotStr r1, "playAnimation"  ; bulldog.sc:102
  0x11f4: LoadString r2, "wait"  ; len=4, pool_off=0x1ef
  0x1200: GetDotStr r4, "irandMax"
  0x1208: LoadInt r5, 3
  0x1210: GetDot r3, 1
  0x1218: Free1 r4
  0x121c: LoadInt r4, 1
...
func_25:
  ...
  0x1338: Mul r0
  0x133c: GetDotStr r2, "playSound3DLooped"  ; ..\sound.sci:276
  0x1344: Copy r-8, r3
  0x134c: Copy r-7, r4
  0x1354: Copy r-6, r5
  0x135c: Copy r-5, r6
  ...
  0x1384: ToStr r1
  0x1388: GetDotStr r6, "Globals"  ; ..\sound.sci:277
...
func_27:
  ...
  0x14b4: LoadString r0, "獡却慨潤獷氀慯卤畯摮䐳戀甀氀氀搀漀最开愀..."  ; len=313, pool_off=0x1, GARBLED
  0x14c0: Free1 r2
  0x14c4: ToInt r1
  ...
  0x14e4: GetDotStr r3, "stop"  ; bulldog.sc:172
  ...
  0x153c: GetDotStr r3, "stop"  ; bulldog.sc:176
...
func_30:
  0x15e8: GetDotStr r1, "irandMax"  ; bulldog.sc:133
  0x15f0: LoadInt r2, 2
  0x15f8: GetDot r0, 1
  0x1600: Free1 r1
  0x1604: LoadInt r1, 1
  0x160c: Add r0
  0x1610: ToInt r0
  0x1614: GetDotStr r2, "playAnimationInplace"  ; bulldog.sc:134
...
func_32:
  0x1790: GetDotStr r1, "irandMax"  ; bulldog.sc:45
  0x1798: LoadInt r2, 2
  0x17a0: GetDot r0, 1
  0x17a8: Free1 r1
  0x17ac: LoadInt r1, 1
  0x17b4: Add r0
  0x17b8: ToInt r0
  0x17bc: GetDotStr r2, "playAnimation"  ; bulldog.sc:46
