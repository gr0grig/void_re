; gscript disassembly: jumper_bottles.bin
; version=0, pool_size=3136
...
;   bc=0x00e4 str=2("jumper_bottles.sc") val=10
;   bc=0x00ec str=2("jumper_bottles.sc") val=9
...
;   bc=0x2be4 str=2("jumper_bottles.sc") val=15
;   bc=0x2bec str=2("jumper_bottles.sc") val=14
...
;   bc=0x3514 str=2("jumper_bottles.sc") val=5
;   bc=0x351c str=2("jumper_bottles.sc") val=5
...
; === function 4 (jumper_bottles.sc, line 10) locals=1 ===
func_4:
  0x00ec: LoadString r0, "jumper_bottles"  ; len=14, pool_off=0x38  ; jumper_bottles.sc:9
...
func_7:
  ...
  0x0278: LoadString r3, "no grid under jumper"  ; len=20, pool_off=0x89
  0x0284: GetDot r1, 1
  ...
  0x0340: SetDotRaw r1, 198
  0x0348: Free1 r2
  0x034c: BrZ r1, 0x0390
  0x0354: GetDotStr r2, "logInfo"  ; jumper_base.sci:334
  0x035c: LoadString r3, "Jumper on blocked polygon"  ; len=25, pool_off=0xd6
  0x0368: GetDot r1, 1
  ...
  0x03a0: LoadString r3, "Jumper is not on grid"  ; len=21, pool_off=0x108
  0x03ac: GetDot r1, 1
...
func_8:
  ...
  0x0434: SetDotRaw r1, 314
  0x043c: Free1 r2
  0x0440: GetDotStr r3, "loadSound3D"
  0x0448: LoadString r4, "jumper_attack1_1"  ; len=16, pool_off=0x14a
  0x0454: GetDot r2, 1
  0x045c: Free2 r3, r4
  0x0464: GetDot r0, 1
  0x046c: Free3 r1, r2, r0
  0x0474: CopyGlobWr r7, g2  ; jumper_base.sci:50
  0x047c: SetDotRaw r1, 314
  0x0484: Free1 r2
  0x0488: GetDotStr r3, "loadSound3D"
  0x0490: LoadString r4, "jumper_attack1_2"  ; len=16, pool_off=0x16a
  0x049c: GetDot r2, 1
  0x04a4: Free2 r3, r4
  0x04ac: GetDot r0, 1
  ...
  0x04e8: SetDotRaw r1, 314
  0x04f0: Free1 r2
  0x04f4: GetDotStr r3, "loadSound3D"
  0x04fc: LoadString r4, "jumper_attack2_1"  ; len=16, pool_off=0x18a
  0x0508: GetDot r2, 1
  0x0510: Free2 r3, r4
  0x0518: GetDot r0, 1
  0x0520: Free3 r1, r2, r0
  0x0528: CopyGlobWr r8, g2  ; jumper_base.sci:54
  0x0530: SetDotRaw r1, 314
  0x0538: Free1 r2
  0x053c: GetDotStr r3, "loadSound3D"
  0x0544: LoadString r4, "jumper_attack2_2"  ; len=16, pool_off=0x1aa
  0x0550: GetDot r2, 1
  0x0558: Free2 r3, r4
  0x0560: GetDot r0, 1
  0x0568: Free3 r1, r2, r0
  0x0570: GetDotStr r1, "loadSound3D"  ; jumper_base.sci:56
  0x0578: LoadString r2, "jumper_scream"  ; len=13, pool_off=0x1ca
  0x0584: GetDot r0, 1
  0x058c: Free2 r1, r2
  0x0594: ToStr r0
  ...
  0x05ac: LoadString r2, "jumper_teleport_in"  ; len=18, pool_off=0x1e4
  0x05b8: GetDot r0, 1
  0x05c0: Free2 r1, r2
  0x05c8: ToStr r0
  ...
  0x05e0: LoadString r2, "jumper_teleport_out"  ; len=19, pool_off=0x208
  0x05ec: GetDot r0, 1
  0x05f4: Free2 r1, r2
  0x05fc: ToStr r0
  ...
  0x0614: LoadString r2, "jumper_run_begin"  ; len=16, pool_off=0x22e
  0x0620: GetDot r0, 1
  0x0628: Free2 r1, r2
  0x0630: ToStr r0
  ...
  0x0648: LoadString r2, "jumper_run"  ; len=10, pool_off=0x22e
  0x0654: GetDot r0, 1
  0x065c: Free2 r1, r2
  0x0664: ToStr r0
  ...
  0x06a0: LoadString r2, "jumper_jump1_1"  ; len=14, pool_off=0x24e
  0x06ac: GetDot r0, 1
  0x06b4: Free2 r1, r2
  ...
  0x06e8: LoadString r2, "jumper_jump1_2"  ; len=14, pool_off=0x26a
  0x06f4: GetDot r0, 1
  0x06fc: Free2 r1, r2
  ...
  0x0730: LoadString r2, "jumper_jump2_1"  ; len=14, pool_off=0x286
  0x073c: GetDot r0, 1
  0x0744: Free2 r1, r2
  ...
  0x0778: LoadString r2, "jumper_jump2_2"  ; len=14, pool_off=0x2a2
  0x0784: GetDot r0, 1
  0x078c: Free2 r1, r2
  ...
  0x07c0: LoadString r2, "jumper_jump3_1"  ; len=14, pool_off=0x2be
  0x07cc: GetDot r0, 1
  0x07d4: Free2 r1, r2
  ...
  0x0808: LoadString r2, "jumper_jump3_2"  ; len=14, pool_off=0x2da
  0x0814: GetDot r0, 1
  0x081c: Free2 r1, r2
...
func_10:
  ...
  0x08d4: SetDotRaw r1, 775
  0x08dc: Free1 r2
  0x08e0: LoadNullStr r2
  0x08e4: LoadString r3, "getPlayer"  ; len=9, pool_off=0x30f
  0x08f0: GetDot r0, 2
...
func_11:
  ...
  0x0964: LoadString r5, "Sound"  ; len=5, pool_off=0x321
  0x0970: Call r6, 0x1334
  0x0978: Call r1, 0x12e8
  0x0980: LoadString r0, "scream_attack"  ; len=13, pool_off=0x32b  ; jumper_base.sci:469
  0x098c: Copy r-4, r1
  ...
  0x0a6c: LoadString r5, "jumper_bottles"  ; len=14, pool_off=0x38
  0x0a78: CmpNe r4
  ...
  0x0aec: LoadString r9, "Sound"  ; len=5, pool_off=0x321
  0x0af8: Call r10, 0x1334
  0x0b00: Call r5, 0x12e8
  0x0b08: LoadString r4, "scream_attack"  ; len=13, pool_off=0x32b  ; jumper_base.sci:482
  0x0b14: Copy r-4, r5
  ...
  0x0bbc: LoadString r9, "Sound"  ; len=5, pool_off=0x321
  0x0bc8: Call r10, 0x1334
  0x0bd0: Call r5, 0x12e8
  0x0bd8: LoadString r4, "scream_attack"  ; len=13, pool_off=0x32b  ; jumper_base.sci:490
  0x0be4: Copy r-4, r5
  ...
  0x0d6c: Mul r9
  0x0d70: Copy r5, r12
  0x0d78: SetDotRaw r11, 857
  0x0d80: Free1 r12
  0x0d84: SetDotRaw r10, 11
  0x0d8c: Free1 r11
  0x0d90: Copy r5, r13
  0x0d98: SetDotRaw r12, 868
  0x0da0: Free1 r13
  ...
  0x0e74: LoadString r13, "Sound"  ; len=5, pool_off=0x321
  0x0e80: Call r14, 0x1334
  0x0e88: Call r9, 0x12e8
  0x0e90: LoadString r8, "attack1_begin"  ; len=13, pool_off=0x376  ; jumper_base.sci:516
  0x0e9c: Copy r-4, r9
  ...
  0x0eec: SetDotRaw r9, 917
  0x0ef4: Free1 r10
  0x0ef8: LoadString r10, "onDamage"  ; len=8, pool_off=0x39a
  0x0f04: GetDotStr r11, "self"
  0x0f0c: Copy r6, r12
  0x0f14: Copy r7, r13
  0x0f1c: GetDot r8, 4
  0x0f24: Free4 r9, r10, r11, r8
  0x0f30: LoadString r8, "attack1_end"  ; len=11, pool_off=0x3aa  ; jumper_base.sci:518
  0x0f3c: Copy r-4, r9
  0x0f44: Call r10, 0x1474
  0x0f4c: GetDotStr r10, "Scene"  ; jumper_base.sci:519
  0x0f54: SetDotRaw r9, 917
  0x0f5c: Free1 r10
  0x0f60: LoadString r10, "onPredatorAttackedPlayer"  ; len=24, pool_off=0x3c6
  ...
  0x1030: LoadString r13, "Sound"  ; len=5, pool_off=0x321
  0x103c: Call r14, 0x1334
  0x1044: Call r9, 0x12e8
  0x104c: LoadString r8, "attack2_begin"  ; len=13, pool_off=0x3f6  ; jumper_base.sci:524
  0x1058: Copy r-4, r9
  ...
  0x10a8: SetDotRaw r9, 917
  0x10b0: Free1 r10
  0x10b4: LoadString r10, "onDamage"  ; len=8, pool_off=0x39a
  ...
  0x10f8: LoadString r8, "attack2_middle1"  ; len=15, pool_off=0x410  ; jumper_base.sci:526
  0x1104: Copy r-4, r9
  ...
  0x1154: SetDotRaw r9, 917
  0x115c: Free1 r10
  0x1160: LoadString r10, "onDamage"  ; len=8, pool_off=0x39a
  ...
  0x11b0: LoadString r8, "attack2_end"  ; len=11, pool_off=0x42e  ; jumper_base.sci:528
  0x11bc: Copy r-4, r9
  0x11c4: Call r10, 0x1474
  0x11cc: GetDotStr r10, "Scene"  ; jumper_base.sci:529
  0x11d4: SetDotRaw r9, 917
  0x11dc: Free1 r10
  0x11e0: LoadString r10, "onPredatorAttackedPlayer"  ; len=24, pool_off=0x3c6
  ...
  0x1280: LoadString r13, "Sound"  ; len=5, pool_off=0x321
  0x128c: Call r14, 0x1334
  0x1294: Call r9, 0x12e8
  0x129c: LoadString r8, "scream_attack"  ; len=13, pool_off=0x32b  ; jumper_base.sci:534
  0x12a8: Copy r-4, r9
...
func_12:
  ...
  0x12f8: SetDotRaw r1, 917
  0x1300: Free1 r2
  0x1304: LoadString r2, "registerSlowMotionSFX"  ; len=21, pool_off=0x444
  0x1310: Copy r-4, r3
  0x1318: GetDot r0, 2
...
func_13:
  0x133c: LoadString r1, "Master"  ; len=6, pool_off=0x46e  ; ..\sound.sci:258
  ...
  0x13b8: SetDotRaw r5, 1166
  0x13c0: Free1 r6
  0x13c4: Copy r-4, r6
  0x13cc: SetDot r4, 1
  0x13d4: Free1 r6
  0x13d8: SetDotRaw r3, 314
  0x13e0: Free1 r4
  0x13e4: Copy r1, r4
  0x13ec: ToObj r4
  0x13f0: GetDot r2, 1
...
func_14:
  ...
  0x1430: Copy r-4, r3
  0x1438: LoadString r4, "Volume"  ; len=6, pool_off=0x49e
  0x1444: Add r3
  0x1448: SetDot r1, 1
  0x1450: Free1 r3
  0x1454: SetDotRaw r0, 1194
  0x145c: Free1 r1
  0x1460: ToFloat r0
...
func_17:
  ...
  0x1604: SetDotRaw r0, 844
  0x160c: Free1 r1
  0x1610: Copy r-6, r2
  0x1618: SetDotRaw r1, 844
  0x1620: Free1 r2
  0x1624: Sub r0
  0x1628: ToFloat r0
  0x162c: Copy r-5, r2
  0x1634: SetDotRaw r1, 1216
  0x163c: Free1 r2
  0x1640: Copy r-6, r3
  0x1648: SetDotRaw r2, 1216
  0x1650: Free1 r3
  0x1654: Sub r1
  0x1658: ToFloat r1
  0x165c: Copy r-4, r2
...
func_21:
  ...
  0x1a58: LoadString r5, "Sound"  ; len=5, pool_off=0x321
  0x1a64: Call r6, 0x1334
  0x1a6c: Call r1, 0x12e8
  0x1a74: LoadString r0, "run_begin"  ; len=9, pool_off=0x23c  ; jumper_base.sci:434
  ...
  0x1ad0: LoadString r5, "Sound"  ; len=5, pool_off=0x321
  0x1adc: Call r6, 0x1334
  0x1ae4: Call r1, 0x12e8
  0x1aec: LoadString r0, "run"  ; len=3, pool_off=0x23c  ; jumper_base.sci:438
  0x1af8: Call r1, 0x1d20
  0x1b00: Copy r-4, r1  ; jumper_base.sci:440
  0x1b08: Call r2, 0x1be8
  0x1b10: BrZ r0, 0x1b48
  0x1b18: LoadString r0, "run_end"  ; len=7, pool_off=0x4da  ; jumper_base.sci:441
  ...
  0x1b60: LoadString r0, "run_end"  ; len=7, pool_off=0x4da  ; jumper_base.sci:447
  ...
  0x1ba8: LoadString r0, "run_end"  ; len=7, pool_off=0x4da  ; jumper_base.sci:453
...
func_24:
  ...
  0x1c7c: LoadString r2, "run_begin"  ; len=9, pool_off=0x23c
  0x1c88: GetDot r0, 1
  0x1c90: Free2 r1, r2
  0x1c98: ToStr r0
...
func_32:
  ...
  0x240c: LoadString r1, "jumper_bottles"  ; len=14, pool_off=0x38
  0x2418: CmpEq r0
  ...
  0x2438: SetDotRaw r1, 1364
  0x2440: Free1 r2
  0x2444: LoadString r2, "animals"  ; len=7, pool_off=0x55e
  0x2450: GetDot r0, 1
  0x2458: Free2 r1, r2
  0x2460: ToStr r0
  ...
  0x247c: LoadString r3, "Warning: Animal locators was not found, can't teleport"  ; len=54, pool_off=0x56c
  0x2488: GetDot r1, 1
  ...
  0x24ec: LoadString r6, "Sound"  ; len=5, pool_off=0x321
  0x24f8: Call r7, 0x1334
  0x2500: Call r2, 0x12e8
  0x2508: LoadString r1, "teleport_in_begin"  ; len=17, pool_off=0x5c8  ; jumper_base.sci:632
  0x2514: Call r2, 0x3134
  0x251c: LoadString r1, "teleport_in_end"  ; len=15, pool_off=0x5ea  ; jumper_base.sci:633
  0x2528: LoadBool r2, true
  0x2530: Call r3, 0x3210
  0x2538: Copy r0, r3  ; jumper_base.sci:637
  0x2540: SetDotRaw r2, 1544
  0x2548: Free1 r3
  ...
  0x258c: LoadString r4, "Warning: Animal locators doesn't containe jumper group, can't teleport"  ; len=70, pool_off=0x612
  0x2598: GetDot r2, 1
  0x25a0: Free3 r3, r4, r2
  0x25a8: LoadInt r2, 0  ; jumper_base.sci:640
  0x25b0: CallMethod r2, 1694, 0x242  ; @patch+8 jumper_base.sci:641
  0x25bc: .dword 0x000028a4  ; UNKNOWN opcode 0xa4
  0x25c0: LoadBool r2, 0xa  ; @patch+4 jumper_base.sci:644
  0x25c8: LoadNullStr r0
  0x25cc: SetDotRaw r3, 1711
  0x25d4: Free1 r4
  0x25d8: Copy r1, r4
  0x25e0: LoadInt r5, 0
  0x25e8: LoadInt r6, 0
  ...
  0x2684: LoadString r6, "jumper teleport on blocked polygon. Trying to displace."  ; len=55, pool_off=0x6df
  0x2690: GetDot r4, 1
  ...
  0x26b4: SetDotRaw r4, 198
  0x26bc: Free1 r5
  0x26c0: BrZ r4, 0x26f8
  0x26c8: GetDotStr r5, "logInfo"  ; jumper_base.sci:657
  0x26d0: LoadString r6, "jumper teleport on blocked polygon"  ; len=34, pool_off=0x6df
  0x26dc: GetDot r4, 1
  ...
  0x2758: LoadString r6, "Sound"  ; len=5, pool_off=0x321
  0x2764: Call r7, 0x1334
  0x276c: Call r2, 0x12e8
  0x2774: LoadString r1, "teleport_out_begin"  ; len=18, pool_off=0x74d  ; jumper_base.sci:664
  0x2780: LoadBool r2, false
  0x2788: Call r3, 0x3210
  0x2790: LoadString r1, "teleport_out_end"  ; len=16, pool_off=0x771  ; jumper_base.sci:665
...
func_33:
  ...
  0x27c0: LoadString r2, "idle"  ; len=4, pool_off=0x791
  0x27cc: GetDot r0, 1
  0x27d4: Free2 r1, r2
  0x27dc: ToStr r0
...
func_34:
  ...
  0x2990: SetDotRaw r5, 844
  0x2998: Free1 r6
  0x299c: AsString r5
  0x29a0: LoadString r6, ", "  ; len=2, pool_off=0x5b8
  0x29ac: Add r5
  0x29b0: GetDotStr r7, "Position"
  0x29b8: SetDotRaw r6, 177
  0x29c0: Free1 r7
  0x29c4: AsString r6
  0x29c8: Add r5
  0x29cc: LoadString r6, ", "  ; len=2, pool_off=0x5b8
  0x29d8: Add r5
  0x29dc: GetDotStr r7, "Position"
  0x29e4: SetDotRaw r6, 1216
  0x29ec: Free1 r7
  0x29f0: AsString r6
  0x29f4: Add r5
  0x29f8: GetDot r3, 1
  ...
  0x2a10: Copy r2, r7
  0x2a18: SetDotRaw r6, 113
  0x2a20: Free1 r7
  0x2a24: SetDotRaw r5, 844
  0x2a2c: Free1 r6
  0x2a30: AsString r5
  0x2a34: LoadString r6, ", "  ; len=2, pool_off=0x5b8
  0x2a40: Add r5
  0x2a44: Copy r2, r8
  0x2a4c: SetDotRaw r7, 113
  0x2a54: Free1 r8
  0x2a58: SetDotRaw r6, 177
  0x2a60: Free1 r7
  0x2a64: AsString r6
  0x2a68: Add r5
  0x2a6c: LoadString r6, ", "  ; len=2, pool_off=0x5b8
  0x2a78: Add r5
  0x2a7c: Copy r2, r8
  0x2a84: SetDotRaw r7, 113
  0x2a8c: Free1 r8
  0x2a90: SetDotRaw r6, 1216
  0x2a98: Free1 r7
  0x2a9c: AsString r6
  0x2aa0: Add r5
  0x2aa4: GetDot r3, 1
...
; === function 36 (jumper_bottles.sc, line 15) locals=4 ===
func_36:
  0x2bec: GetDotStr r1, "!tuple"  ; jumper_bottles.sc:14
  0x2bf4: LoadInt r2, 0
  0x2bfc: LoadInt r3, 0
  0x2c04: GetDot r0, 2
  0x2c0c: Free1 r1
...
func_37:
  ...
  0x2c34: SetDotRaw r1, 1318
  0x2c3c: Free1 r2
  0x2c40: GetDot r0, 0
  0x2c48: Free1 r1
  0x2c4c: ToStr r0
  0x2c50: Copy r0, r3  ; ../std.sci:837
  0x2c58: SetDotRaw r2, 1332
  0x2c60: Free1 r3
  0x2c64: GetDot r1, 0
  0x2c6c: Free2 r2, r1
...
func_41:
  ...
  0x3098: LoadString r7, "Sound"  ; len=5, pool_off=0x321
...
func_44:
  ...
  0x339c: Div r4
  0x33a0: Sub r3
  0x33a4: CallMethod r3, 1694, 0x36  ; @patch+8 jumper_base.sci:274
  ...
  0x33cc: CallMethod r2, 1694, 0x36  ; @patch+8 jumper_base.sci:290
  0x33d8: .dword 0x000033ec  ; UNKNOWN opcode 0xec
  0x33dc: LoadInt r2, 0  ; jumper_base.sci:293
  0x33e4: CallMethod r2, 1694, 0x4b  ; @patch+8 jumper_base.sci:294
...
func_45:
  ...
  0x3460: Copy r-4, r5
  0x3468: SetDotRaw r4, 113
  0x3470: Free1 r5
  0x3474: Copy r0, r6
  0x347c: SetDotRaw r5, 113
  0x3484: Free1 r6
  0x3488: Sub r4
  0x348c: ToStr r4
...
func_46:
  ...
  0x34cc: CallMethod r0, 2019, 0x1  ; @patch+8 jumper_base.sci:301
  0x34d8: LoadString r0, "桓摡睯䙳摡䉥来湩氀慯䅤楮慭楴湯敓tani..."  ; len=73, pool_off=0x7ef, GARBLED
  0x34e4: GetDotStr r1, "loadAnimationSet"  ; jumper_base.sci:303
  0x34ec: LoadString r2, "anim/jumper.ase"  ; len=15, pool_off=0x811
  0x34f8: GetDot r0, 1
  0x3500: Free3 r1, r2, r0
  0x3508: Call r0, 0x3514  ; jumper_base.sci:305
  0x3510: Ret r0  ; jumper_base.sci:306

; === function 47 (jumper_bottles.sc, line 5) locals=0 ===
func_47:
  0x351c: Ret r0  ; jumper_bottles.sc:5
...
func_48:
  ...
  0x35ac: SetDotRaw r3, 2095
  0x35b4: Free1 r4
  0x35b8: SetDotRaw r2, 2100
  0x35c0: Free1 r3
  0x35c4: LoadString r3, "tutorial_quest_kill_predators_done"  ; len=34, pool_off=0x838
  0x35d0: GetDot r1, 1
  0x35d8: Free2 r2, r3
  0x35e0: BrZ r1, 0x3614
  0x35e8: Copy r0, r3  ; ../gameplay.sci:579
  0x35f0: SetDotRaw r2, 314
  0x35f8: Free1 r3
  0x35fc: LoadInt r3, 1
  0x3604: GetDot r1, 1
  0x360c: Free2 r2, r1
...
func_53:
  ...
  0x387c: SetDotRaw r2, 2095
  0x3884: Free1 r3
  0x3888: SetDotRaw r1, 2100
  0x3890: Free1 r2
  0x3894: LoadString r2, "ava_automonolog_bottles_color2"  ; len=30, pool_off=0x87c
  0x38a0: GetDot r0, 1
  0x38a8: Free2 r1, r2
  0x38b0: BrZ r0, 0x39d8
  0x38b8: LoadBool r0, false  ; fauna_base.sci:65
  0x38c0: GetDotStr r4, "World"
  0x38c8: SetDotRaw r3, 2095
  0x38d0: Free1 r4
  0x38d4: SetDotRaw r2, 2100
  0x38dc: Free1 r3
  0x38e0: LoadString r3, "ava_crimson"  ; len=11, pool_off=0x8b8
  0x38ec: GetDot r1, 1
  0x38f4: Free2 r2, r3
  0x38fc: Not r1
  ...
  0x393c: SetDotRaw r1, 775
  0x3944: Free1 r2
  0x3948: LoadNullStr r2
  0x394c: LoadString r3, "getLocationName"  ; len=15, pool_off=0x8ce
  0x3958: GetDot r0, 2
  0x3960: Free3 r1, r2, r3
  0x3968: GetDotStr r2, "World"
  0x3970: SetDotRaw r1, 2095
  0x3978: Free1 r2
  0x397c: LoadString r2, "ava_crimson"  ; len=11, pool_off=0x8b8
  0x3988: GetDotRaw r1, 1
  0x3990: Free2 r2, r0
  0x3998: GetDotStr r2, "Scene"  ; fauna_base.sci:68
  0x39a0: SetDotRaw r1, 917
  0x39a8: Free1 r2
  0x39ac: LoadString r2, "runAutomonolog"  ; len=14, pool_off=0x8ec
  0x39b8: LoadString r3, "ava_crimson"  ; len=11, pool_off=0x8b8
  0x39c4: GetDot r0, 2
  0x39cc: Free4 r1, r2, r3, r0
  0x39d8: GetDotStr r2, "World"  ; fauna_base.sci:73
  0x39e0: SetDotRaw r1, 917
  0x39e8: Free1 r2
  0x39ec: LoadString r2, "isDomainGoodColor"  ; len=17, pool_off=0x908
  0x39f8: Copy r-5, r3
  0x3a00: GetDot r0, 2
  0x3a08: Free2 r1, r2
  ...
  0x3a3c: Free1 r5
  0x3a40: LoadString r5, "Gameplay"  ; len=8, pool_off=0x92a
  0x3a4c: GetDot r3, 1
  0x3a54: Free2 r4, r5
  0x3a5c: SetDotRaw r2, 2362
  0x3a64: Free1 r3
  0x3a68: SetDotRaw r1, 1194
  0x3a70: Free1 r2
  0x3a74: Mul r0
  0x3a78: ToInt r0
  ...
  0x3a94: SetDotRaw r1, 917
  0x3a9c: Free1 r2
  0x3aa0: LoadString r2, "isDomainBadColor"  ; len=16, pool_off=0x953
  0x3aac: Copy r-5, r3
  0x3ab4: GetDot r0, 2
  0x3abc: Free2 r1, r2
  ...
  0x3af0: Free1 r5
  0x3af4: LoadString r5, "Gameplay"  ; len=8, pool_off=0x92a
  0x3b00: GetDot r3, 1
  0x3b08: Free2 r4, r5
  0x3b10: SetDotRaw r2, 2419
  0x3b18: Free1 r3
  0x3b1c: SetDotRaw r1, 1194
  0x3b24: Free1 r2
  0x3b28: Mul r0
  0x3b2c: ToInt r0
...
func_54:
  ...
  0x3b94: SetDotRaw r1, 2095
  0x3b9c: Free1 r2
  0x3ba0: LoadString r2, "Chapter"  ; len=7, pool_off=0x98b
  0x3bac: SetDot r0, 1
  0x3bb4: Free1 r2
  0x3bb8: ToInt r0
...
func_65:
  ...
  0x3d90: SetDotRaw r1, 2457
  0x3d98: Free1 r2
  0x3d9c: GetDotStr r2, "Scene"
  0x3da4: LoadString r3, "ps_jumperlasso.ps"  ; len=17, pool_off=0x9ae
  0x3db0: GetDotStr r5, "!vec3"
  0x3db8: GetDot r4, 0
  0x3dc0: Free1 r5
  0x3dc4: LoadString r5, "particlesystem/removable"  ; len=24, pool_off=0x9d0
  0x3dd0: GetDot r0, 4
  ...
  0x3e0c: SetDotRaw r2, 2560
  0x3e14: Free1 r3
  0x3e18: CmpLt r1
  0x3e1c: BrZ r1, 0x3e98
  0x3e24: CopyGlobWr r16, g3  ; jumper_base.sci:165
  0x3e2c: SetDotRaw r2, 2573
  0x3e34: Free1 r3
  0x3e38: Copy r0, r3
  0x3e40: LoadString r4, "PSColor"  ; len=7, pool_off=0xa23
...
func_66:
  ...
  0x3edc: Free1 r4
  0x3ee0: LoadString r4, "Limfa"  ; len=5, pool_off=0xa31
  0x3eec: Copy r-4, r5
  0x3ef4: AsString r5
  0x3ef8: Add r4
  0x3efc: GetDot r2, 1
  0x3f04: Free2 r3, r4
  0x3f0c: SetDotRaw r1, 2619
  0x3f14: Free1 r2
  0x3f18: SetDotRaw r0, 2625
  0x3f20: Free1 r1
  0x3f24: ToStr r0
...
func_68:
  ...
  0x3fd8: LoadString r5, "loc_lasso_0"  ; len=11, pool_off=0xa59
  0x3fe4: Copy r1, r6
  0x3fec: LoadInt r7, 1
  0x3ff4: Add r6
  0x3ff8: AsString r6
  ...
  0x4030: LoadString r5, "loc_lasso_"  ; len=10, pool_off=0xa59
  0x403c: Copy r1, r6
  0x4044: LoadInt r7, 1
  0x404c: Add r6
  0x4050: AsString r6
...
func_80:
  ...
  0x4a28: LoadString r2, "jumper.rd"  ; len=9, pool_off=0xabf
  0x4a34: LoadInt r3, 0
  0x4a3c: GetDot r0, 2
  0x4a44: Free2 r1, r2
  0x4a4c: ToStr r0
  ...
  0x4b7c: SetDotRaw r3, 917
  0x4b84: Free1 r4
  0x4b88: LoadString r4, "remove"  ; len=6, pool_off=0xae9
  ...
  0x4d10: Div r2
  0x4d14: CallMethod r2, 1694, 0x34a  ; @patch+8 jumper_base.sci:716
  0x4d20: RetV r2
  0x4d24: ToInt r2
...
func_81:
  ...
  0x4e14: SetDotRaw r1, 917
  0x4e1c: Free1 r2
  0x4e20: LoadString r2, "getLocationProperties"  ; len=21, pool_off=0xb30
  0x4e2c: GetDot r0, 1
  0x4e34: Free2 r1, r2
  0x4e3c: ToStr r0
  0x4e40: Copy r0, r2  ; jumper_base.sci:245
  0x4e48: LoadString r3, "Predators"  ; len=9, pool_off=0xb5a
  0x4e54: SetDot r1, 1
  0x4e5c: Free1 r3
  0x4e60: ToStr r1
  0x4e64: LoadInt r2, 0  ; jumper_base.sci:247
  0x4e6c: Copy r1, r4  ; jumper_base.sci:247
  0x4e74: SetDotRaw r3, 880
  0x4e7c: Free1 r4
  0x4e80: ToInt r3
  ...
  0x4f48: SetDotRaw r1, 917
  0x4f50: Free1 r2
  0x4f54: LoadString r2, "onPredatorDie"  ; len=13, pool_off=0xb6c
  ...
  0x4f94: SetDotRaw r1, 2950
  0x4f9c: Free1 r2
  0x4fa0: GetDotStr r2, "Scene"
  0x4fa8: LoadString r3, "limfa.pre"  ; len=9, pool_off=0xb97
  ...
  0x4fe4: Free1 r6
  0x4fe8: Add r4
  0x4fec: LoadString r5, "limfa_disposed_fly"  ; len=18, pool_off=0xba9
  0x4ff8: GetDot r0, 4
  0x5000: Free5 r1, r2, r3, r4, r5
  0x500c: ToStr r0
  0x5010: GetDotStr r3, "World"  ; jumper_base.sci:260
  0x5018: SetDotRaw r2, 917
  0x5020: Free1 r3
  0x5024: LoadString r3, "getDomainMonsterIncome"  ; len=22, pool_off=0xbcd
  0x5030: GetDot r1, 1
  0x5038: Free2 r2, r3
  0x5040: ToFloat r1
  0x5044: Copy r0, r4  ; jumper_base.sci:261
  0x504c: SetDotRaw r3, 917
  0x5054: Free1 r4
  0x5058: LoadString r4, "initLimfa"  ; len=9, pool_off=0xbf9
...
func_83:
  ...
  0x5190: LoadString r2, "show_debug"  ; len=10, pool_off=0xc17
  0x519c: GetDot r0, 1
  0x51a4: Free2 r1, r2
  0x51ac: BrZ r0, 0x5244
  0x51b4: GetDotStr r1, "toBool"  ; ../std.sci:144
  0x51bc: GetDotStr r3, "getVariable"
  0x51c4: LoadString r4, "show_debug"  ; len=10, pool_off=0xc17
  0x51d0: GetDot r2, 1
  0x51d8: Free2 r3, r4
  0x51e0: GetDot r0, 1
  0x51e8: Free2 r1, r2
