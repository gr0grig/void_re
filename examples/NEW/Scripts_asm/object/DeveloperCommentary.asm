...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; DeveloperCommentary.sc:11
  0x0024: ToStr r0
...
func_2:
  0x0048: GetDotStr r2, "Scene"  ; DeveloperCommentary.sc:38
  0x0050: SetDotRaw r1, 17
  0x0058: Free1 r2
  0x005c: LoadString r2, "onCommentaryActivate"  ; len=20, pool_off=0x16
  0x0068: GetDotStr r3, "self"
  0x0070: GetDot r0, 2
  0x0078: Free4 r1, r2, r3, r0
  0x0084: GetDotStr r1, "playSoundInScene"  ; DeveloperCommentary.sc:40
  0x008c: GetDotStr r2, "Scene"
  0x0094: GetDotStr r4, "loadSound"
...
func_3:
  0x0118: GetDotStr r2, "Scene"  ; DeveloperCommentary.sc:64
...
func_5:
  0x01b4: GetDotStr r1, "call"  ; DeveloperCommentary.sc:76
