...
func_1:
  0x001c: GetDotStr r1, "trace"  ; gate.sc:3
  0x0024: LoadString r2, "gate"  ; len=4, pool_off=0x6
  0x0030: GetDot r0, 1
  0x0038: Free3 r1, r2, r0
  0x0040: GetDotStr r1, "setKinematic"  ; gate.sc:4
  ...
  0x0064: RetV r0
  0x0068: Free1 r0
  0x006c: GetDotStr r2, "Scene"  ; gate.sc:8
  ...
  0x00ac: GetDotStr r1, "setKinematic"  ; gate.sc:9
