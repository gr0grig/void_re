...
;   bc=0x144c str=2("../std.sci") val=106
;   bc=0x1454 str=2("../std.sci") val=105
...
func_1:
  0x001c: GetDotStr r1, "fillA"  ; paint_image.sc:17
  0x0024: GetDotStr r3, "!vec3"
  0x002c: LoadInt r4, 0
  0x0034: LoadInt r5, 0
  0x003c: LoadInt r6, 0
  0x0044: GetDot r2, 3
  ...
  0x00c8: Mul r1
  0x00cc: ToFloat r1
  0x00d0: GetDotStr r3, "createImageComposerBuilder"  ; paint_image.sc:26
  0x00d8: GetDot r2, 0
  0x00e0: Free1 r3
  0x00e4: ToStr r2
  ...
  0x0140: GetDot r4, 3
  0x0148: Free2 r5, r4
  0x0150: GetDotStr r5, "createPostProcessComposer"  ; paint_image.sc:29
  0x0158: Copy r2, r8
  ...
  0x019c: GetDotStr r3, "!ppconfig"  ; paint_image.sc:32
  0x01a4: GetDot r2, 0
  0x01ac: Free1 r3
  0x01b0: ToStr r2
  ...
  0x0264: GetDot r2, 0
  0x026c: Free2 r3, r2
  0x0274: GetDotStr r3, "createImageComposerBuilder"  ; paint_image.sc:40
  0x027c: GetDot r2, 0
  0x0284: Free1 r3
  0x0288: ToStr r2
  ...
  0x0304: GetDotStr r4, "createPostProcessComposer"  ; paint_image.sc:42
  0x030c: Copy r2, r7
  ...
  0x035c: Free1 r5
  0x0360: LoadInt r5, 0
  0x0368: GetDotStr r6, "self"
  0x0370: GetDot r3, 2
  0x0378: Free3 r4, r6, r3
  0x0380: Free1 r2  ; paint_image.sc:39
  0x0384: GetDotStr r3, "!vector"  ; paint_image.sc:46
  0x038c: GetDot r2, 0
  0x0394: Free1 r3
  0x0398: ToStr r2
  ...
  0x04ec: Div r11
  0x04f0: Sub r10
  0x04f4: GetDotStr r12, "!vec3"  ; paint_image.sc:63
  0x04fc: GetDot r11, 0
  0x0504: Free1 r12
  0x0508: ToStr r11
  ...
  0x061c: GetDotStr r10, "rand"  ; paint_image.sc:70
  0x0624: GetDot r9, 0
  0x062c: Free1 r10
  ...
  0x08b8: Add r8
  0x08bc: Copy r0, r9
  0x08c4: GetDotStr r11, "randRange"
  ...
  0x0920: Add r9
  0x0924: Copy r0, r10
  0x092c: GetDotStr r12, "randRange"
  ...
  0x0954: Add r9
  0x0958: ToFloat r9
  0x095c: GetDotStr r11, "randRange"  ; paint_image.sc:95
  ...
  0x09c0: GetDotStr r15, "randRange"
  ...
  0x0ab0: GetDotStr r15, "irandMax"  ; paint_image.sc:103
  ...
  0x0ae0: GetDotStr r15, "randRange"  ; paint_image.sc:108
  ...
  0x0b10: ToFloat r14
  0x0b14: Copy r14, r12
  0x0b1c: GetDotStr r15, "randRange"  ; paint_image.sc:109
  ...
  0x0b60: GetDotStr r15, "randRange"  ; paint_image.sc:115
  ...
  0x0b90: ToFloat r14
  0x0b94: Copy r14, r12
  0x0b9c: GetDotStr r15, "randRange"  ; paint_image.sc:116
  ...
  0x0bcc: ToFloat r14
  0x0bd0: Copy r14, r13
  0x0bd8: GetDotStr r15, "!vector"  ; paint_image.sc:119
  0x0be0: GetDot r14, 0
  0x0be8: Free1 r15
  0x0bec: ToStr r14
  0x0bf0: GetDotStr r16, "irandRange"  ; paint_image.sc:120
  ...
  0x0d10: Free1 r18
  0x0d14: GetDotStr r19, "randRange"
...
func_3:
  ...
  0x0ed8: Free1 r0
  0x0edc: GetDotStr r1, "!vector"  ; paint_image.sc:151
  0x0ee4: GetDot r0, 0
  0x0eec: Free1 r1
  0x0ef0: ToStr r0
...
func_4:
  0x1128: GetDotStr r1, "fillA"  ; paint_image.sc:166
  0x1130: GetDotStr r3, "!vec3"
  0x1138: LoadInt r4, 0
  0x1140: LoadInt r5, 0
  0x1148: LoadInt r6, 0
  0x1150: GetDot r2, 3
...
; === function 8 (onMouseMove, ../std.sci, line 106) locals=2 ===
func_8:
  0x1454: Copy r-4, r0  ; ../std.sci:105
...
func_10:
  ...
  0x14e8: GetDotStr r1, "createRTImage"  ; paint_image.sc:222
  0x14f0: Copy r-4, r3
