...
;   bc=0x0378 str=2("../std.sci") val=106
;   bc=0x0380 str=2("../std.sci") val=105
...
func_2:
  ...
  0x012c: GetDot r2, 1
  0x0134: Free2 r3, r2
  0x013c: GetDotStr r3, "createSceneRemover"  ; show_glotok.sc:33
  ...
  0x0248: GetDotStr r6, "loadSound3D"
...
func_5:
  0x0380: Copy r-4, r0  ; ../std.sci:105
...
func_6:
  ...
  0x03d8: ToFloat r2
  0x03dc: GetDotStr r4, "!rotateX"  ; show_glotok.sc:73
  0x03e4: Copy r0, r5
  0x03ec: GetDot r3, 1
  0x03f4: Free1 r4
  0x03f8: GetDotStr r5, "!rotateY"
  0x0400: Copy r1, r6
  ...
  0x0444: Free2 r5, r4
  0x044c: GetDotStr r5, "!vec3"  ; show_glotok.sc:75
  0x0454: LoadInt r6, 0
  0x045c: LoadInt r7, 0
  0x0464: Copy r2, r8
  0x046c: Neg r8
