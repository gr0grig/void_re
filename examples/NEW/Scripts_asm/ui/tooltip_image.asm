...
func_1:
  0x001c: GetDotStr r1, "fillA"  ; tooltip_image.sc:11
  ...
  0x0078: GetDotStr r1, "createImageComposerBuilder"  ; tooltip_image.sc:16
  0x0080: GetDot r0, 0
  0x0088: Free1 r1
  0x008c: ToStr r0
  ...
  0x0108: GetDotStr r2, "createPostProcessComposer"  ; tooltip_image.sc:18
  0x0110: Copy r0, r5
  ...
  0x01a4: GetDotStr r2, "fillA"  ; tooltip_image.sc:26
  0x01ac: GetDotStr r4, "!vec3"
  0x01b4: LoadInt r5, 0
  0x01bc: LoadInt r6, 0
  0x01c4: LoadInt r7, 0
  0x01cc: GetDot r3, 3
...
func_6:
  ...
  0x03d4: GetDotStr r1, "createRTImage"  ; tooltip_image.sc:61
  0x03dc: Copy r-6, r3
