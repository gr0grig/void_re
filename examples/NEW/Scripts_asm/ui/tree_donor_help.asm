...
;   bc=0x0238 str=2("../std.sci") val=86
;   bc=0x0240 str=2("../std.sci") val=85
;   bc=0x0280 str=2("../std.sci") val=106
;   bc=0x0288 str=2("../std.sci") val=105
...
func_3:
  0x0050: GetDotStr r0, "Width"  ; tree_donor_help.sc:57
  ...
  0x007c: Div r0
  0x0080: ToInt r0
  0x0084: GetDotStr r1, "Height"  ; tree_donor_help.sc:58
...
func_4:
  0x0114: GetDotStr r2, "Plane"  ; tree_donor_help.sc:40
...
; === function 5 (../std.sci, line 86) locals=2 ===
func_5:
  0x0240: Copy r-5, r0  ; ../std.sci:85
  0x0248: Copy r-4, r1
  0x0250: CmpLt r0
...
func_6:
  0x0288: Copy r-4, r0  ; ../std.sci:105
