...
func_3:
  ...
  0x0058: GetDotStr r1, "sendGenericEventToLoop"  ; gameover.sc:50
...
func_4:
  ...
  0x009c: LoadInt r2, 0
  0x00a4: LoadInt r3, 0
  0x00ac: GetDotStr r4, "Width"
  0x00b4: GetDotStr r5, "Height"
  0x00bc: GetDotStr r7, "!vec3"
  0x00c4: LoadInt r8, 0
  0x00cc: LoadInt r9, 0
  ...
  0x00fc: GetDotStr r0, "Width"  ; gameover.sc:56
  ...
  0x0160: LoadInt r4, 0
  0x0168: GetDotStr r5, "Height"
  0x0170: Copy r0, r6
  0x0178: Sub r5
  0x017c: LoadInt r6, 2
  0x0184: Div r5
  0x0188: GetDotStr r6, "Width"
  0x0190: Copy r0, r7
  0x0198: GetDot r1, 5
...
func_5:
  ...
  0x01c0: GetDotStr r3, "Plane"  ; gameover.sc:22
  ...
  0x0200: Free1 r1
  0x0204: GetDotStr r2, "Plane"  ; gameover.sc:23
  0x020c: ToStr r2
  0x0210: GetDotStr r4, "loadSound"
  ...
  0x0258: Free1 r1
  0x025c: GetDotStr r2, "Plane"  ; gameover.sc:24
  0x0264: ToStr r2
  0x0268: GetDotStr r4, "loadSound"
  ...
  0x03dc: GetDot r1, 0
  0x03e4: Free2 r2, r1
  0x03ec: GetDotStr r2, "sendGenericEventToLoop"  ; gameover.sc:44
...
func_6:
  ...
  0x0478: Free2 r2, r3
  0x0480: ToStr r1
  0x0484: GetDotStr r6, "Globals"  ; ..\sound.sci:162
...
func_7:
  0x04fc: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x0504: Copy r-4, r3
