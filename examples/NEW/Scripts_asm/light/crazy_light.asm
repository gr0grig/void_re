...
;   bc=0x03c4 str=2("../std.sci") val=116
;   bc=0x03cc str=2("../std.sci") val=115
;   bc=0x03ec str=2("../std.sci") val=106
;   bc=0x03f4 str=2("../std.sci") val=105
...
func_1:
  0x001c: GetDotStr r0, "Group"  ; crazy_light.sc:17
  0x0024: ToInt r0
  0x0028: Call r1, 0x038c  ; crazy_light.sc:19
  0x0030: LoadInt r1, 0  ; crazy_light.sc:21
  0x0038: ToFloat r1
  0x003c: GetDotStr r4, "irandRange"  ; crazy_light.sc:23
  ...
  0x00d4: GetDotStr r7, "Scene"  ; crazy_light.sc:32
  0x00dc: SetDotRaw r6, 23
  0x00e4: Free1 r7
  0x00e8: Copy r0, r7
  0x00f0: GetDotStr r9, "!vec3"
  0x00f8: Copy r4, r10
  0x0100: Copy r4, r11
  0x0108: Copy r4, r12
  0x0110: GetDot r8, 3
  ...
  0x01f4: Add r5
  0x01f8: GetDotStr r8, "Scene"  ; crazy_light.sc:44
  0x0200: SetDotRaw r7, 23
  0x0208: Free1 r8
  0x020c: Copy r0, r8
  0x0214: GetDotStr r10, "!vec3"
  0x021c: Copy r5, r11
  0x0224: Copy r5, r12
  0x022c: Copy r5, r13
  0x0234: GetDot r9, 3
  ...
  0x02ec: GetDotStr r8, "Scene"  ; crazy_light.sc:54
  0x02f4: SetDotRaw r7, 23
  0x02fc: Free1 r8
  0x0300: Copy r0, r8
  0x0308: GetDotStr r10, "!vec3"
  0x0310: Copy r5, r11
  0x0318: Copy r5, r12
  0x0320: Copy r5, r13
  0x0328: GetDot r9, 3
...
func_2:
  0x0394: GetDotStr r1, "rand"  ; crazy_light.sc:12
  0x039c: GetDot r0, 0
  0x03a4: Free1 r1
...
; === function 3 (../std.sci, line 116) locals=2 ===
func_3:
  0x03cc: Copy r-4, r0  ; ../std.sci:115
...
func_4:
  0x03f4: Copy r-4, r0  ; ../std.sci:105
