...
;   bc=0x0bd8 str=2("../std.sci") val=106
;   bc=0x0be0 str=2("../std.sci") val=105
...
func_2:
  0x0030: GetDotStr r1, "loadAnimationSet"  ; camera_obscure.sc:49
  ...
  0x00cc: GetDotStr r2, "!vector"  ; camera_obscure.sc:56
  0x00d4: GetDot r1, 0
  0x00dc: Free1 r2
  ...
  0x011c: GetDotStr r4, "canPlayAnimation"  ; camera_obscure.sc:62
  0x0124: Copy r2, r5
  0x012c: GetDot r3, 1
  0x0134: Free2 r4, r5
  ...
  0x0158: GetDotStr r4, "playAnimation"  ; camera_obscure.sc:66
  0x0160: Copy r2, r5
  0x0168: GetDot r3, 1
  0x0170: Free2 r4, r5
  0x0178: ToStr r3
  ...
  0x0230: GetDotStr r2, "logError"  ; camera_obscure.sc:72
  ...
  0x0274: Ret r0
  0x0278: GetDotStr r2, "logInfo"  ; camera_obscure.sc:76
  ...
  0x02e8: GetDotStr r2, "!vector"  ; camera_obscure.sc:78
  0x02f0: GetDot r1, 0
  0x02f8: Free1 r2
  ...
  0x0338: GetDotStr r4, "canPlayAnimation"  ; camera_obscure.sc:84
  0x0340: Copy r2, r5
  0x0348: GetDot r3, 1
  0x0350: Free2 r4, r5
  ...
  0x0374: GetDotStr r4, "playAnimation"  ; camera_obscure.sc:88
  0x037c: Copy r2, r5
  0x0384: GetDot r3, 1
  0x038c: Free2 r4, r5
  0x0394: ToStr r3
  ...
  0x044c: GetDotStr r2, "logError"  ; camera_obscure.sc:94
  ...
  0x0490: Ret r0
  0x0494: GetDotStr r2, "logInfo"  ; camera_obscure.sc:98
  ...
  0x0528: GetDotStr r3, "canPlayAnimation"
  ...
  0x0584: GetDotStr r2, "logError"  ; camera_obscure.sc:101
...
func_7:
  ...
  0x0760: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:124
...
func_8:
  ...
  0x085c: GetDotStr r1, "!vector"  ; camera_obscure.sc:305
  0x0864: GetDot r0, 0
  0x086c: Free1 r1
  0x0870: ToStr r0
  ...
  0x08c8: Free1 r4
  0x08cc: GetDotStr r5, "playAnimation"
  ...
  0x092c: GetDotStr r2, "!vector"  ; camera_obscure.sc:310
  0x0934: GetDot r1, 0
  0x093c: Free1 r2
  0x0940: ToStr r1
...
func_9:
  0x0be0: Copy r-4, r0  ; ../std.sci:105
...
func_11:
  ...
  0x0c48: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:357
...
func_13:
  ...
  0x0d94: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:209
  ...
  0x0eb0: GetDotStr r2, "playAnimation"  ; camera_obscure.sc:214
...
func_15:
  ...
  0x1004: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:198
...
func_18:
  ...
  0x10f8: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:380
...
func_20:
  0x1198: GetDotStr r1, "playAnimation"  ; camera_obscure.sc:10
  0x11a0: Copy r-4, r2
  0x11a8: GetDot r0, 1
  0x11b0: Free2 r1, r2
  0x11b8: ToStr r0
