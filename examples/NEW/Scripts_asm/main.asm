...
func_1:
  0x001c: GetDotStr r1, "!table"  ; main.sc:16
  0x0024: GetDot r0, 0
  0x002c: Free1 r1
  ...
  0x0044: Free2 r1, r0
  0x004c: GetDotStr r1, "!vector"  ; main.sc:17
  0x0054: GetDot r0, 0
  0x005c: Free1 r1
  ...
  0x0088: Free2 r2, r0
  0x0090: GetDotStr r1, "!vector"  ; main.sc:18
  0x0098: GetDot r0, 0
  0x00a0: Free1 r1
  ...
  0x00cc: Free2 r2, r0
  0x00d4: GetDotStr r1, "!vector"  ; main.sc:19
  0x00dc: GetDot r0, 0
  0x00e4: Free1 r1
  ...
  0x012c: GetDotStr r1, "createWorld"  ; main.sc:22
  ...
  0x0160: Free1 r0
  0x0164: GetDotStr r1, "!customLoop"  ; main.sc:24
  0x016c: GetDot r0, 0
  0x0174: Free1 r1
  0x0178: ToStr r0
  0x017c: GetDotStr r2, "runScript"  ; main.sc:25
  ...
  0x0208: Free1 r4
  0x020c: GetDotStr r5, "getVariable"
  ...
  0x0420: Free2 r3, r2
  0x0428: GetDotStr r3, "hasVariable"  ; main.sc:39
  0x0430: LoadString r4, "post_effect_fp"  ; len=14, pool_off=0x143
  0x043c: GetDot r2, 1
  0x0444: Free2 r3, r4
  0x044c: BrZ r2, 0x04e0
  0x0454: GetDotStr r3, "getVariable"  ; main.sc:40
  ...
  0x048c: GetDotStr r5, "toBool"  ; main.sc:42
  0x0494: Copy r2, r6
  0x049c: AsString r6
  0x04a0: GetDot r4, 1
  0x04a8: Free2 r5, r6
  ...
  0x0598: GetDotStr r2, "hasVariable"  ; main.sc:47
  0x05a0: LoadString r3, "Shadows"  ; len=7, pool_off=0x19d
  0x05ac: GetDot r1, 1
  0x05b4: Free2 r2, r3
  0x05bc: BrZ r1, 0x0654
  0x05c4: GetDotStr r2, "toInt"  ; main.sc:48
  0x05cc: GetDotStr r4, "getVariable"
  ...
  0x06e0: GetDotStr r3, "!qtpair"  ; main.sc:59
  0x06e8: GetDot r2, 0
  0x06f0: Free1 r3
  0x06f4: ToStr r2
  0x06f8: Copy r2, r1
  ...
  0x0764: GetDotStr r3, "getVariable"  ; main.sc:65
  ...
  0x07ac: GetDotStr r4, "logInfo"  ; main.sc:67
  0x07b4: LoadString r5, "Mode: fly"  ; len=9, pool_off=0x212
  0x07c0: GetDot r3, 1
  0x07c8: Free3 r4, r5, r3
  0x07d0: GetDotStr r4, "createSpectatorCamera"  ; main.sc:68
  0x07d8: GetDot r3, 0
  0x07e0: Free1 r4
  0x07e4: ToStr r3
  ...
  0x085c: LoadString r0, ""  ; len=54, pool_off=0x998, GARBLED  ; @patch+4 main.sc:66
  0x0868: Copy r2, r3  ; main.sc:73
  0x0870: LoadString r4, "walk"  ; len=4, pool_off=0x258
  0x087c: CmpEq r3
  0x0880: BrZ r3, 0x0998
  0x0888: GetDotStr r4, "logInfo"  ; main.sc:74
  ...
  0x0934: Free1 r3
  0x0938: GetDotStr r4, "createAttachedCamera"  ; main.sc:76
  ...
  0x0b74: GetDotStr r5, "setSoundListenerParameters"  ; main.sc:99
  0x0b7c: Copy r3, r7
  ...
  0x0c30: GetDotStr r5, "isKeyPressed"  ; main.sc:101
  ...
  0x0e00: GetDotStr r5, "isKeyPressed"  ; main.sc:109
...
func_2:
  0x1048: GetDotStr r2, "Globals"  ; sound.sci:14
...
func_3:
  ...
  0x11b0: GetDotStr r1, "flushDebugRender"  ; main.sc:129
...
func_6:
  ...
  0x13a4: GetDotStr r2, "!tuple"  ; main.sc:154
  0x13ac: LoadString r3, "Wrong number of parameters"  ; len=26, pool_off=0x40f
  0x13b8: GetDotStr r4, "ConsoleColorError"
  0x13c0: GetDot r1, 2
  ...
  0x13fc: GetDotStr r2, "!tuple"  ; main.sc:158
  0x1404: LoadString r3, "Invalid regex"  ; len=13, pool_off=0x455
  0x1410: GetDotStr r4, "ConsoleColorError"
  0x1418: GetDot r1, 2
  ...
  0x1474: GetDotStr r3, "logInfo"  ; main.sc:161
  0x147c: Copy r0, r5
  0x1484: Copy r1, r6
  0x148c: SetDot r4, 1
  0x1494: AsString r4
  ...
  0x1600: Ret r0
  0x1604: GetDotStr r1, "!lookAt"  ; main.sc:182
  0x160c: CopyExtWr r7, 2, 1
  0x1618: GetDotStr r4, "!vec3"
  0x1620: LoadInt r5, 0
