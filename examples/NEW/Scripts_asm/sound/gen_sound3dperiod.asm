...
;   bc=0x0270 str=2("../std.sci") val=106
;   bc=0x0278 str=2("../std.sci") val=105
;   bc=0x0298 str=3("..\sound.sci") val=313
;   bc=0x02a0 str=3("..\sound.sci") val=309
;   bc=0x02c8 str=3("..\sound.sci") val=310
;   bc=0x0314 str=3("..\sound.sci") val=311
;   bc=0x0364 str=3("..\sound.sci") val=312
...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; gen_sound3dperiod.sc:11
  0x0024: ToStr r0
  0x0028: CopyGlobRd r0, g0
  0x0030: Free1 r0
  0x0034: GetDotStr r1, "!vector"  ; gen_sound3dperiod.sc:14
  0x003c: GetDot r0, 0
  0x0044: Free1 r1
  0x0048: ToStr r0
  ...
  0x0068: Free1 r2
  0x006c: GetDotStr r3, "loadSound3D"
...
func_2:
  0x0278: Copy r-4, r0  ; ../std.sci:105
  0x0280: LoadFloat r1, 1000000.0
  0x0288: Div r0
  0x028c: Copy r0, r4294967291
  0x0294: Ret r0

; === function 3 (..\sound.sci, line 313) locals=9 ===
func_3:
  0x02a0: LoadString r1, "Master"  ; len=6, pool_off=0x84  ; ..\sound.sci:309
  0x02ac: Call r2, 0x0384
  0x02b4: Copy r-5, r2
  0x02bc: Call r3, 0x0384
  0x02c4: Mul r0
  0x02c8: GetDotStr r2, "playSound3D"  ; ..\sound.sci:310
  0x02d0: Copy r-9, r3
  0x02d8: Copy r-8, r4
  0x02e0: Copy r-7, r5
  0x02e8: Copy r-6, r6
  ...
  0x0310: ToStr r1
  0x0314: GetDotStr r6, "Globals"  ; ..\sound.sci:311
  ...
  0x0364: Copy r1, r2  ; ..\sound.sci:312
...
func_4:
  0x038c: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x0394: Copy r-4, r3
...
func_5:
  0x03e0: GetDotStr r2, "Scene"  ; ..\sound.sci:28
