...
;   bc=0x01c0 str=2("../std.sci") val=106
;   bc=0x01c8 str=2("../std.sci") val=105
...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; gen_sound2dperiod.sc:11
  0x0024: ToStr r0
  0x0028: CopyGlobRd r0, g0
  0x0030: Free1 r0
  0x0034: GetDotStr r1, "loadSound"  ; gen_sound2dperiod.sc:13
  ...
  0x0100: GetDotStr r1, "Scene"  ; gen_sound2dperiod.sc:24
  0x0108: ToStr r1
...
func_2:
  0x01c8: Copy r-4, r0  ; ../std.sci:105
...
func_3:
  ...
  0x024c: Free2 r2, r3
  0x0254: ToStr r1
  0x0258: GetDotStr r6, "Globals"  ; ..\sound.sci:211
...
func_4:
  0x02d0: GetDotStr r2, "Settings"  ; ..\sound.sci:9
  0x02d8: Copy r-4, r3
...
func_5:
  0x0324: GetDotStr r2, "Scene"  ; ..\sound.sci:28
