...
;   bc=0x01ec str=2("std.sci") val=242
;   bc=0x01f4 str=2("std.sci") val=238
;   bc=0x0214 str=2("std.sci") val=239
;   bc=0x0230 str=2("std.sci") val=240
;   bc=0x0248 str=2("std.sci") val=237
...
func_1:
  ...
  0x0024: CallMethod r0, 0, 0x142  ; @patch+8 vein_badabum_part.sc:15
...
func_2:
  ...
  0x0098: GetDotStr r2, "World"  ; vein_badabum_part.sc:39
  0x00a0: SetDotRaw r1, 29
  0x00a8: Free1 r2
  0x00ac: GetDotStr r2, "Scene"
  ...
  0x0194: GetDotStr r1, "Position"  ; vein_badabum_part.sc:45
  0x019c: Copy r0, r2
  0x01a4: SetInd r2
  ...
  0x01cc: GetDotStr r2, "remove"  ; vein_badabum_part.sc:49
  0x01d4: GetDot r1, 0
  0x01dc: Free2 r2, r1
...
func_3:
  0x01f4: Copy r-4, r0  ; std.sci:238
  0x01fc: Free1 r2
  0x0200: RetV r1
  0x0204: Sub r0
  0x0208: ToInt r0
  0x020c: Copy r0, r4294967292
  0x0214: Copy r-4, r0  ; std.sci:239
  0x021c: LoadInt r1, 0
  0x0224: CmpLe r0
  0x0228: BrZ r0, 0x0248
  0x0230: Copy r-4, r0  ; std.sci:240
  0x0238: Neg r0
  0x023c: Copy r0, r4294967291
  0x0244: Ret r0
  0x0248: Jmp r0, 0x01f4  ; std.sci:237

; === function 4 (vein_badabum_part.sc, line 10) locals=6 ===
func_4:
  0x0258: GetDotStr r5, "World"  ; vein_badabum_part.sc:9
