...
func_2:
  ...
  0x0054: GetDotStr r2, "setSysParameterFloat"  ; lympha_fall_bottles1.sc:19
  0x005c: Copy r0, r3
  ...
  0x00d0: GetDotStr r1, "updateAllEmmiters"  ; lympha_fall_bottles1.sc:24
...
func_3:
  0x0138: GetDotStr r1, "!vector"  ; lympha_fall_bottles1.sc:36
  0x0140: GetDot r0, 0
  0x0148: Free1 r1
  0x014c: ToStr r0
  0x0150: GetDotStr r2, "!vector"  ; lympha_fall_bottles1.sc:37
  0x0158: GetDot r1, 0
  0x0160: Free1 r2
  0x0164: ToStr r1
  0x0168: GetDotStr r4, "World"  ; lympha_fall_bottles1.sc:40
...
func_5:
  ...
  0x0460: GetDotStr r2, "setSysParameterFloat"  ; lympha_fall_bottles1.sc:68
  0x0468: Copy r-4, r5
  0x0470: Copy r0, r6
  0x0478: SetDot r4, 1
  0x0480: LoadInt r5, 1
