...
;   bc=0x0220 str=2("../std.sci") val=242
;   bc=0x0228 str=2("../std.sci") val=238
;   bc=0x0248 str=2("../std.sci") val=239
;   bc=0x0264 str=2("../std.sci") val=240
;   bc=0x027c str=2("../std.sci") val=237
...
func_1:
  ...
  0x01a8: GetDotStr r2, "EmmiterCount"
  0x01b0: CmpLt r1
  0x01b4: BrZ r1, 0x020c
  0x01bc: GetDotStr r2, "setSysParameterFloat"  ; ps_hunter_09_piper_boom.sc:18
  0x01c4: Copy r0, r3
...
func_2:
  0x0228: Copy r-4, r0  ; ../std.sci:238
  0x0230: Free1 r2
  0x0234: RetV r1
  0x0238: Sub r0
  0x023c: ToInt r0
  0x0240: Copy r0, r4294967292
  0x0248: Copy r-4, r0  ; ../std.sci:239
  0x0250: LoadInt r1, 0
  0x0258: CmpLe r0
  0x025c: BrZ r0, 0x027c
  0x0264: Copy r-4, r0  ; ../std.sci:240
  0x026c: Neg r0
  0x0270: Copy r0, r4294967291
  0x0278: Ret r0
  0x027c: Jmp r0, 0x0228  ; ../std.sci:237
...
func_3:
  ...
  0x02e0: GetDotStr r2, "remove"  ; ps_hunter_09_piper_boom.sc:33
  0x02e8: GetDot r1, 0
  0x02f0: Free2 r2, r1
