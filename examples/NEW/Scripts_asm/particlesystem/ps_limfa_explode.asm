...
;   bc=0x0170 str=2("../std.sci") val=242
;   bc=0x0178 str=2("../std.sci") val=238
;   bc=0x0198 str=2("../std.sci") val=239
;   bc=0x01b4 str=2("../std.sci") val=240
;   bc=0x01cc str=2("../std.sci") val=237
...
func_2:
  0x0030: GetDotStr r1, "setSysParameterVector"  ; ps_limfa_explode.sc:17
  0x0038: LoadInt r2, 0
  0x0040: LoadString r3, "PColor"  ; len=6, pool_off=0x16
  0x004c: Copy r-4, r4
  0x0054: GetDot r0, 3
  0x005c: Free4 r1, r3, r4, r0
  0x0068: GetDotStr r1, "setSysParameterVector"  ; ps_limfa_explode.sc:18
  0x0070: LoadInt r2, 2
...
func_3:
  ...
  0x00cc: GetDotStr r1, "setSysParameterFloat"  ; ps_limfa_explode.sc:28
  0x00d4: LoadInt r2, 0
  ...
  0x0110: GetDotStr r1, "setSysParameterFloat"  ; ps_limfa_explode.sc:30
  0x0118: LoadInt r2, 2
  ...
  0x0154: GetDotStr r1, "remove"  ; ps_limfa_explode.sc:33
  0x015c: GetDot r0, 0
  0x0164: Free2 r1, r0
...
func_4:
  0x0178: Copy r-4, r0  ; ../std.sci:238
  0x0180: Free1 r2
  0x0184: RetV r1
  0x0188: Sub r0
  0x018c: ToInt r0
  0x0190: Copy r0, r4294967292
  0x0198: Copy r-4, r0  ; ../std.sci:239
  0x01a0: LoadInt r1, 0
  0x01a8: CmpLe r0
  0x01ac: BrZ r0, 0x01cc
  0x01b4: Copy r-4, r0  ; ../std.sci:240
  0x01bc: Neg r0
  0x01c0: Copy r0, r4294967291
  0x01c8: Ret r0
  0x01cc: Jmp r0, 0x0178  ; ../std.sci:237
