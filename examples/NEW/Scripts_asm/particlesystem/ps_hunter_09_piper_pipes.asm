...
;   bc=0x00d8 str=2("../std.sci") val=242
;   bc=0x00e0 str=2("../std.sci") val=238
;   bc=0x0100 str=2("../std.sci") val=239
;   bc=0x011c str=2("../std.sci") val=240
;   bc=0x0134 str=2("../std.sci") val=237
...
;   bc=0x01b4 str=2("../std.sci") val=106
;   bc=0x01bc str=2("../std.sci") val=105
...
func_1:
  ...
  0x005c: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_pipes.sc:17
  0x0064: LoadInt r2, 0
  0x006c: LoadString r3, "PPeriod"  ; len=7, pool_off=0x1d
  0x0078: LoadInt r4, 65535
  0x0080: GetDot r0, 3
  0x0088: Free3 r1, r3, r0
  0x0090: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_pipes.sc:18
  0x0098: LoadInt r2, 1
...
func_2:
  0x00e0: Copy r-4, r0  ; ../std.sci:238
  0x00e8: Free1 r2
  0x00ec: RetV r1
  0x00f0: Sub r0
  0x00f4: ToInt r0
  0x00f8: Copy r0, r4294967292
  0x0100: Copy r-4, r0  ; ../std.sci:239
  0x0108: LoadInt r1, 0
  0x0110: CmpLe r0
  0x0114: BrZ r0, 0x0134
  0x011c: Copy r-4, r0  ; ../std.sci:240
  0x0124: Neg r0
  0x0128: Copy r0, r4294967291
  0x0130: Ret r0
  0x0134: Jmp r0, 0x00e0  ; ../std.sci:237
...
func_3:
  ...
  0x0198: GetDotStr r2, "remove"  ; ps_hunter_09_piper_pipes.sc:32
  0x01a0: GetDot r1, 0
  0x01a8: Free2 r2, r1
...
func_4:
  0x01bc: Copy r-4, r0  ; ../std.sci:105
