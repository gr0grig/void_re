...
;   bc=0x01a8 str=2("../std.sci") val=242
;   bc=0x01b0 str=2("../std.sci") val=238
;   bc=0x01d0 str=2("../std.sci") val=239
;   bc=0x01ec str=2("../std.sci") val=240
;   bc=0x0204 str=2("../std.sci") val=237
...
;   bc=0x0284 str=2("../std.sci") val=106
;   bc=0x028c str=2("../std.sci") val=105
...
func_1:
  0x001c: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_teleport_out.sc:8
  0x0024: LoadInt r2, 0
  0x002c: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x0038: LoadInt r4, 0
  0x0040: GetDot r0, 3
  0x0048: Free3 r1, r3, r0
  0x0050: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_teleport_out.sc:9
  0x0058: LoadInt r2, 1
  ...
  0x00e8: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_teleport_out.sc:17
  0x00f0: LoadInt r2, 1
  ...
  0x012c: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_teleport_out.sc:21
  0x0134: LoadInt r2, 0
  0x013c: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x0148: LoadInt r4, 65535
  0x0150: GetDot r0, 3
  0x0158: Free3 r1, r3, r0
  0x0160: GetDotStr r1, "setSysParameterFloat"  ; ps_hunter_09_piper_teleport_out.sc:22
  0x0168: LoadInt r2, 1
...
func_2:
  0x01b0: Copy r-4, r0  ; ../std.sci:238
  0x01b8: Free1 r2
  0x01bc: RetV r1
  0x01c0: Sub r0
  0x01c4: ToInt r0
  0x01c8: Copy r0, r4294967292
  0x01d0: Copy r-4, r0  ; ../std.sci:239
  0x01d8: LoadInt r1, 0
  0x01e0: CmpLe r0
  0x01e4: BrZ r0, 0x0204
  0x01ec: Copy r-4, r0  ; ../std.sci:240
  0x01f4: Neg r0
  0x01f8: Copy r0, r4294967291
  0x0200: Ret r0
  0x0204: Jmp r0, 0x01b0  ; ../std.sci:237
...
func_3:
  ...
  0x0268: GetDotStr r2, "remove"  ; ps_hunter_09_piper_teleport_out.sc:36
  0x0270: GetDot r1, 0
  0x0278: Free2 r2, r1
...
func_4:
  0x028c: Copy r-4, r0  ; ../std.sci:105
