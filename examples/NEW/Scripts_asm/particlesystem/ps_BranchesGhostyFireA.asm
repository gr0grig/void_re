...
;   bc=0x019c str=2("../std.sci") val=106
;   bc=0x01a4 str=2("../std.sci") val=105
; func_table (36 bytes):
...
func_1:
  ...
  0x00c8: Mul r4
  0x00cc: Add r3
  0x00d0: GetDotStr r5, "setSysParameterFloat"  ; ps_BranchesGhostyFireA.sc:13
  0x00d8: LoadInt r6, 1
  0x00e0: LoadString r7, "bx"  ; len=2, pool_off=0x15
  0x00ec: Copy r1, r8
  0x00f4: GetDot r4, 3
  0x00fc: Free3 r5, r7, r4
  0x0104: GetDotStr r5, "setSysParameterFloat"  ; ps_BranchesGhostyFireA.sc:14
  0x010c: LoadInt r6, 1
  0x0114: LoadString r7, "by"  ; len=2, pool_off=0x19
  0x0120: Copy r2, r8
  0x0128: GetDot r4, 3
  0x0130: Free3 r5, r7, r4
  0x0138: GetDotStr r5, "setSysParameterFloat"  ; ps_BranchesGhostyFireA.sc:15
  0x0140: LoadInt r6, 1
...
func_2:
  0x01a4: Copy r-4, r0  ; ../std.sci:105
