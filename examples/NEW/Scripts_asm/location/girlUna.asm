; gscript disassembly: girlUna.bin
; version=0, pool_size=1600
; globals=2, func_table=300
; bytecode=7508 bytes
; inline_strings=5, patches=150
; globals_data: 03 03
; pool (1600 bytes)
; inline strings:
;   [0] ".init"
...
;   bc=0x0014 str=1("girlUna.sc") val=10
;   bc=0x001c str=1("girlUna.sc") val=9
;   bc=0x0040 str=1("girlUna.sc") val=10
...
;   bc=0x0694 str=1("girlUna.sc") val=15
;   bc=0x069c str=1("girlUna.sc") val=14
;   bc=0x06b0 str=1("girlUna.sc") val=20
;   bc=0x06b8 str=1("girlUna.sc") val=19
...
;   bc=0x19ac str=1("girlUna.sc") val=32
;   bc=0x19b4 str=1("girlUna.sc") val=24
;   bc=0x19d8 str=1("girlUna.sc") val=25
;   bc=0x19ec str=1("girlUna.sc") val=27
;   bc=0x1a94 str=1("girlUna.sc") val=28
;   bc=0x1ab4 str=1("girlUna.sc") val=29
;   bc=0x1b04 str=1("girlUna.sc") val=30
;   bc=0x1b64 str=1("girlUna.sc") val=27
;   bc=0x1b68 str=1("girlUna.sc") val=32
;   bc=0x1b70 str=1("girlUna.sc") val=38
;   bc=0x1b78 str=1("girlUna.sc") val=36
;   bc=0x1b9c str=1("girlUna.sc") val=37
;   bc=0x1bc0 str=1("girlUna.sc") val=38
;   bc=0x1bc4 str=1("girlUna.sc") val=44
;   bc=0x1bcc str=1("girlUna.sc") val=42
;   bc=0x1bf0 str=1("girlUna.sc") val=43
;   bc=0x1c14 str=1("girlUna.sc") val=44
;   bc=0x1c18 str=1("girlUna.sc") val=49
;   bc=0x1c20 str=1("girlUna.sc") val=48
;   bc=0x1c68 str=1("girlUna.sc") val=49
;   bc=0x1c6c str=4("../gameplay.sci") val=1051
;   bc=0x1c74 str=4("../gameplay.sci") val=1048
;   bc=0x1ca8 str=4("../gameplay.sci") val=1049
;   bc=0x1d3c str=4("../gameplay.sci") val=1050
; func_names:
;   0=tabooViolation
;   2=getAllowedTypes
...
;   +224: 00 00 6f 6e 44 65 61 74 68 ff ff ff ff 70 1b 00
;   +240: 00 00 00 00 00 0e 00 00 00 6f 6e 42 72 65 61 6b
;   +256: 74 68 72 6f 75 67 68 ff ff ff ff c4 1b 00 00 00
;   +272: 00 00 00 0d 00 00 00 6f 6e 43 6f 6e 73 6f 6c 65
;   +288: 54 61 6c 6b ff ff ff ff 18 1c 00 00

; === function 0 (tabooViolation, .init, line -1) locals=0 ===
func_0:
  0x0008: CallNat r0, func=20, info=0x0

; === function 1 (girlUna.sc, line 10) locals=3 ===
func_1:
  0x001c: GetDotStr r1, "logInfo"  ; girlUna.sc:9
  0x0024: LoadString r2, "Una location first run."  ; len=23, pool_off=0x8
  0x0030: GetDot r0, 1
  0x0038: Free3 r1, r2, r0
  0x0040: Ret r0  ; girlUna.sc:10
...
; === function 7 (isAutowalk, girlUna.sc, line 15) locals=1 ===
func_7:
  0x069c: LoadBool r0, true  ; girlUna.sc:14
  0x06a4: Copy r0, r4294967292
  0x06ac: Ret r0

; === function 8 (getAutomonolog, girlUna.sc, line 20) locals=1 ===
func_8:
  0x06b8: Call r1, 0x06d0  ; girlUna.sc:19
...
; === function 12 (girlUna.sc, line 32) locals=8 ===
func_12:
  0x19b4: GetDotStr r1, "logInfo"  ; girlUna.sc:24
  0x19bc: LoadString r2, "Una location inited."  ; len=20, pool_off=0x490
  0x19c8: GetDot r0, 1
  0x19d0: Free3 r1, r2, r0
  0x19d8: Copy r-4, r0  ; girlUna.sc:25
  0x19e0: CopyGlobRd r0, g1
  0x19e8: Free1 r0
  0x19ec: LoadBool r0, false  ; girlUna.sc:27
  0x19f4: GetDotStr r4, "World"
  0x19fc: SetDotRaw r3, 143
  0x1a04: Free1 r4
  0x1a08: SetDotRaw r2, 148
  0x1a10: Free1 r3
  0x1a14: LoadString r3, "una_dead"  ; len=8, pool_off=0x4b8
  0x1a20: GetDot r1, 1
  0x1a28: Free2 r2, r3
  0x1a30: Not r1
  ...
  0x1a58: Free1 r3
  0x1a5c: LoadString r3, "una_breakthrough"  ; len=16, pool_off=0x4c8
  0x1a68: GetDot r1, 1
  0x1a70: Free2 r2, r3
  0x1a78: Not r1
  0x1a7c: BrZ r1, 0x1a8c
  0x1a84: LoadBool r0, true
  0x1a8c: BrZ r0, 0x1b68
  0x1a94: GetDotStr r1, "irandMax"  ; girlUna.sc:28
  0x1a9c: LoadInt r2, 1
  0x1aa4: GetDot r0, 1
  0x1aac: Free1 r1
  0x1ab0: ToInt r0
  0x1ab4: Copy r-4, r3  ; girlUna.sc:29
  0x1abc: SetDotRaw r2, 1256
  0x1ac4: Free1 r3
  0x1ac8: LoadString r3, "pt_una"  ; len=6, pool_off=0x4fc
  0x1ad4: Copy r0, r4
  0x1adc: LoadInt r5, 1
  0x1ae4: Add r4
  0x1ae8: AsString r4
  ...
  0x1af8: Free2 r2, r3
  0x1b00: ToStr r1
  0x1b04: GetDotStr r4, "World"  ; girlUna.sc:30
  0x1b0c: SetDotRaw r3, 1288
  0x1b14: Free1 r4
  0x1b18: Copy r-4, r4
  0x1b20: LoadString r5, "una_dressed.xml"  ; len=15, pool_off=0x519
  0x1b2c: Copy r1, r6
  0x1b34: LoadString r7, "girl/girl_una_loc"  ; len=17, pool_off=0x537
  0x1b40: GetDot r2, 4
  0x1b48: Free5 r3, r4, r5, r6, r7
  0x1b54: ToStr r2
  0x1b58: CopyGlobRd r2, g0
  0x1b60: Free1 r2
  0x1b64: Free1 r1  ; girlUna.sc:27
  0x1b68: Free1 r-4  ; girlUna.sc:32
  0x1b6c: Ret r0

; === function 13 (girlUna.sc, line 38) locals=3 ===
func_13:
  0x1b78: GetDotStr r1, "logInfo"  ; girlUna.sc:36
  0x1b80: LoadString r2, "sister script: onDeath"  ; len=22, pool_off=0x559
  0x1b8c: GetDot r0, 1
  0x1b94: Free3 r1, r2, r0
  0x1b9c: CopyGlobWr r0, g2  ; girlUna.sc:37
  0x1ba4: SetDotRaw r1, 1413
  0x1bac: Free1 r2
  0x1bb0: GetDot r0, 0
  0x1bb8: Free2 r1, r0
  0x1bc0: Ret r0  ; girlUna.sc:38

; === function 14 (onDeath, girlUna.sc, line 44) locals=3 ===
func_14:
  0x1bcc: GetDotStr r1, "logInfo"  ; girlUna.sc:42
  0x1bd4: LoadString r2, "una loc script: onBreakthrough"  ; len=30, pool_off=0x58c
  0x1be0: GetDot r0, 1
  0x1be8: Free3 r1, r2, r0
  0x1bf0: CopyGlobWr r0, g2  ; girlUna.sc:43
  0x1bf8: SetDotRaw r1, 1413
  0x1c00: Free1 r2
  0x1c04: GetDot r0, 0
  0x1c0c: Free2 r1, r0
  0x1c14: Ret r0  ; girlUna.sc:44

; === function 15 (onBreakthrough, girlUna.sc, line 49) locals=5 ===
func_15:
  0x1c20: CopyGlobWr r1, g2  ; girlUna.sc:48
  0x1c28: SetDotRaw r1, 54
  0x1c30: Free1 r2
  0x1c34: LoadString r2, "activateObscure"  ; len=15, pool_off=0x5c8
  0x1c40: LoadString r3, "una"  ; len=3, pool_off=0x4b8
  0x1c4c: Call r5, 0x1c6c
  0x1c54: GetDot r0, 3
  0x1c5c: Free4 r1, r2, r3, r0
  0x1c68: Ret r0  ; girlUna.sc:49

; === function 16 (onConsoleTalk, ../gameplay.sci, line 1051) locals=9 ===
func_16:
  0x1c74: GetDotStr r2, "World"  ; ../gameplay.sci:1048
  0x1c7c: SetDotRaw r1, 54
  0x1c84: Free1 r2
  0x1c88: LoadString r2, "getPlayerEntity"  ; len=15, pool_off=0x5e6
  0x1c94: GetDot r0, 1
  0x1c9c: Free2 r1, r2
  0x1ca4: ToStr r0
  0x1ca8: LoadFloat r1, 1.0  ; ../gameplay.sci:1049
  0x1cb0: Copy r0, r4
  0x1cb8: SetDotRaw r3, 1540
  0x1cc0: Free1 r4
  0x1cc4: SetDotRaw r2, 1551
  0x1ccc: Free1 r3
  0x1cd0: GetDotStr r8, "World"
  0x1cd8: SetDotRaw r7, 1540
  0x1ce0: Free1 r8
  0x1ce4: SetDotRaw r6, 1560
  0x1cec: Free1 r7
  0x1cf0: LoadString r7, "Gameplay"  ; len=8, pool_off=0x61c
  0x1cfc: GetDot r5, 1
  0x1d04: Free2 r6, r7
  0x1d0c: SetDotRaw r4, 1580
  0x1d14: Free1 r5
  0x1d18: SetDotRaw r3, 266
  0x1d20: Free1 r4
  0x1d24: LoadFloat r4, 1.0
  0x1d2c: Sub r3
  0x1d30: Mul r2
  0x1d34: Add r1
  0x1d38: ToFloat r1
  0x1d3c: Copy r1, r2  ; ../gameplay.sci:1050
  0x1d44: Copy r2, r4294967292
  0x1d4c: Free1 r0
  0x1d50: Ret r0
