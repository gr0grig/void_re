...
;   bc=0x0014 str=1("mine.sc") val=5
;   bc=0x001c str=1("mine.sc") val=5
...
;   bc=0x03b8 str=1("mine.sc") val=16
;   bc=0x03c0 str=1("mine.sc") val=9
;   bc=0x0404 str=1("mine.sc") val=11
;   bc=0x0438 str=1("mine.sc") val=12
;   bc=0x0478 str=1("mine.sc") val=15
...
; === function 1 (mine.sc, line 5) locals=0 ===
func_1:
  0x001c: Ret r0  ; mine.sc:5
...
; === function 5 (mine.sc, line 16) locals=4 ===
func_5:
  0x03c0: GetDotStr r3, "World"  ; mine.sc:9
  0x03c8: SetDotRaw r2, 89
  0x03d0: Free1 r3
  0x03d4: SetDotRaw r1, 94
  0x03dc: Free1 r2
  0x03e0: LoadString r2, "tutorial_automonolog_mine"  ; len=25, pool_off=0xda
  0x03ec: GetDot r0, 1
  0x03f4: Free2 r1, r2
  0x03fc: BrNZ r0, 0x0478
  0x0404: LoadBool r0, true  ; mine.sc:11
  0x040c: GetDotStr r2, "World"
  0x0414: SetDotRaw r1, 89
  0x041c: Free1 r2
  0x0420: LoadString r2, "tutorial_automonolog_mine"  ; len=25, pool_off=0xda
  0x042c: GetDotRaw r1, 1
  0x0434: Free1 r2
  0x0438: GetDotStr r1, "!tuple"  ; mine.sc:12
  0x0440: LoadString r2, "tutorial_automonolog_mine"  ; len=25, pool_off=0xda
  0x044c: LoadInt r3, 2
  0x0454: GetDot r0, 2
  0x045c: Free2 r1, r2
  0x0464: ToStr r0
  ...
  0x0470: Free1 r0
  0x0474: Ret r0
  0x0478: Call r1, 0x0490  ; mine.sc:15
