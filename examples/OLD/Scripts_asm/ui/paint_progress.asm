...
func_5:
  0x0190: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; color_progress_base.sci:14
  ...
  0x01e0: Free1 r0
  0x01e4: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; color_progress_base.sci:15
  ...
  0x0234: Free1 r0
  0x0238: GetDotStr r1, "!ppconfig"  ; pool_off=0x4e  ; color_progress_base.sci:17
  0x0240: GetDot r0, 0
  0x0248: Free1 r1
  0x024c: ToStr r0
  ...
  0x0294: GetDot r0, 0
  0x029c: Free2 r1, r0
  0x02a4: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0x84  ; color_progress_base.sci:21
  0x02ac: GetDot r0, 0
  0x02b4: Free1 r1
  0x02b8: ToStr r0
  ...
  0x032c: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0xbf  ; color_progress_base.sci:23
  0x0334: Copy r0, r5
...
func_7:
  ...
  0x048c: GetDotStr r2, "Window"  ; pool_off=0xe9  ; paint_progress.sc:26
