...
func_1:
  0x001c: GetDotStr r1, "!vec3"  ; pool_off=0x0  ; block_image.sc:13
  0x0024: LoadInt r2, 0
  0x002c: LoadInt r3, 0
  0x0034: LoadInt r4, 0
  0x003c: GetDot r0, 3
  ...
  0x0054: Free1 r0
  0x0058: GetDotStr r1, "fillA"  ; pool_off=0x6  ; block_image.sc:14
  0x0060: CopyGlobWr r3, g2
  0x0068: CopyGlobWr r4, g3
  0x0070: GetDot r0, 2
  0x0078: Free3 r1, r2, r0
  0x0080: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0xc  ; block_image.sc:17
  0x0088: GetDot r0, 0
  0x0090: Free1 r1
  0x0094: ToStr r0
  ...
  0x0110: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0x49  ; block_image.sc:19
  0x0118: Copy r0, r5
  ...
  0x0168: Free1 r3
  0x016c: LoadInt r3, 0
  0x0174: GetDotStr r4, "self"  ; pool_off=0x73
  0x017c: GetDot r1, 2
  ...
  0x0194: RetV r0
  0x0198: ToStr r0
  0x019c: GetDotStr r2, "fillA"  ; pool_off=0x6  ; block_image.sc:25
...
func_5:
  ...
  0x0300: GetDotStr r1, "createRTImage"  ; pool_off=0xa3  ; block_image.sc:52
  0x0308: Copy r-4, r3
