...
func_4:
  ...
  0x0170: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; stat_progress.sc:20
  ...
  0x01c0: Free1 r0
  0x01c4: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; stat_progress.sc:21
  0x01cc: SetDotRaw r1, 68
  0x01d4: Free1 r2
  0x01d8: CopyGlobWr r5, g2
  0x01e0: GetDotStr r3, "Width"  ; pool_off=0x1f
...
func_5:
  0x0240: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; color_progress_base.sci:14
  ...
  0x0290: Free1 r0
  0x0294: GetDotStr r2, "Plane"  ; pool_off=0x2c  ; color_progress_base.sci:15
  ...
  0x02e4: Free1 r0
  0x02e8: GetDotStr r1, "!ppconfig"  ; pool_off=0x6a  ; color_progress_base.sci:17
  0x02f0: GetDot r0, 0
  0x02f8: Free1 r1
  0x02fc: ToStr r0
  ...
  0x0344: GetDot r0, 0
  0x034c: Free2 r1, r0
  0x0354: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0xa0  ; color_progress_base.sci:21
  0x035c: GetDot r0, 0
  0x0364: Free1 r1
  0x0368: ToStr r0
  ...
  0x03dc: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0xdb  ; color_progress_base.sci:23
  0x03e4: Copy r0, r5
...
func_6:
  ...
  0x04a8: GetDotStr r2, "!vec3"  ; pool_off=0x105
...
func_7:
  ...
  0x0534: GetDotStr r1, "format"  ; pool_off=0x10b  ; stat_progress.sc:40
