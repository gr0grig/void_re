...
;   bc=0x02a4 str=2("../std.sci") val=60
;   bc=0x02ac str=2("../std.sci") val=55
;   bc=0x02c8 str=2("../std.sci") val=56
;   bc=0x02e0 str=2("../std.sci") val=57
;   bc=0x02fc str=2("../std.sci") val=58
;   bc=0x0314 str=2("../std.sci") val=59
...
func_1:
  0x001c: GetDotStr r2, "Plane"  ; pool_off=0x0  ; readtext.sc:12
...
func_2:
  ...
  0x00c0: LoadInt r2, 1
  0x00c8: SetDot r0, 1
  0x00d0: GetDotStr r1, "Height"  ; pool_off=0x2f
  0x00d8: CmpGt r0
  0x00dc: BrZ r0, 0x010c
  0x00e4: GetDotStr r0, "Height"  ; pool_off=0x2f  ; readtext.sc:54
  0x00ec: LoadFloat r1, 0.05000000074505806
  0x00f4: Mul r0
  0x00f8: ToInt r0
  0x00fc: CopyGlobRd r0, g4
  0x0104: Jmp r0, 0x0148  ; readtext.sc:53
  0x010c: GetDotStr r0, "Height"  ; pool_off=0x2f  ; readtext.sc:56
  0x0114: Copy r-4, r2
  0x011c: LoadInt r3, 1
  0x0124: SetDot r1, 1
  0x012c: Sub r0
...
func_3:
  ...
  0x0184: GetDotStr r3, "Width"  ; pool_off=0x41
  0x018c: LoadInt r4, 4
  0x0194: Div r3
  0x0198: CopyGlobWr r4, g4
  0x01a0: GetDotStr r6, "!vec3"  ; pool_off=0x47
  0x01a8: LoadInt r7, 1
  0x01b0: LoadInt r8, 1
  0x01b8: LoadInt r9, 1
  0x01c0: GetDot r5, 3
...
func_4:
  ...
  0x01f8: LoadInt r2, 1
  0x0200: SetDot r0, 1
  0x0208: GetDotStr r1, "Height"  ; pool_off=0x2f
  0x0210: CmpGt r0
  ...
  0x0238: Add r1
  0x023c: ToInt r1
  0x0240: GetDotStr r2, "Height"  ; pool_off=0x2f
  ...
  0x026c: Sub r2
  0x0270: ToInt r2
  0x0274: GetDotStr r3, "Height"  ; pool_off=0x2f
...
; === function 5 (../std.sci, line 60) locals=2 ===
func_5:
  0x02ac: Copy r-6, r0  ; ../std.sci:55
  0x02b4: Copy r-5, r1
  0x02bc: CmpLt r0
  0x02c0: BrZ r0, 0x02e0
  0x02c8: Copy r-5, r0  ; ../std.sci:56
  0x02d0: ToFloat r0
  0x02d4: Copy r0, r4294967289
  0x02dc: Ret r0
  0x02e0: Copy r-6, r0  ; ../std.sci:57
  0x02e8: Copy r-4, r1
  0x02f0: CmpGt r0
  0x02f4: BrZ r0, 0x0314
  0x02fc: Copy r-4, r0  ; ../std.sci:58
  0x0304: ToFloat r0
  0x0308: Copy r0, r4294967289
  0x0310: Ret r0
  0x0314: Copy r-6, r0  ; ../std.sci:59
  0x031c: ToFloat r0
...
func_8:
  ...
  0x03b4: GetDotStr r1, "destroy"  ; pool_off=0x4d  ; readtext.sc:23
  0x03bc: GetDot r0, 0
  0x03c4: Free2 r1, r0
...
func_9:
  0x03d8: GetDotStr r1, "destroy"  ; pool_off=0x4d  ; readtext.sc:31
  0x03e0: GetDot r0, 0
  0x03e8: Free2 r1, r0
