...
;   bc=0x02ec str=3("../std.sci") val=99
;   bc=0x02f4 str=3("../std.sci") val=98
...
func_1:
  0x001c: GetDotStr r1, "!vector"  ; pool_off=0x0  ; paint_limfa.sc:30
  0x0024: GetDot r0, 0
  0x002c: Free1 r1
  0x0030: ToStr r0
...
func_6:
  ...
  0x01cc: GetDotStr r2, "Plane"  ; pool_off=0x34  ; paint_limfa.sc:50
  ...
  0x0214: Free1 r0
  0x0218: GetDotStr r1, "format"  ; pool_off=0x4d  ; paint_limfa.sc:51
  0x0220: LoadString r2, "%s\n%u / %u"  ; len=10, pool_off=0x54
  0x022c: GetDotStr r4, "getString"  ; pool_off=0x68
...
func_8:
  ...
  0x038c: GetDotStr r2, "Window"  ; pool_off=0x7a  ; paint_limfa.sc:62
  ...
  0x0400: LoadInt r6, 0
  0x0408: Add r5
  0x040c: GetDotStr r7, "!vec3"  ; pool_off=0xab
  ...
  0x0484: LoadInt r6, 0
  0x048c: Add r5
  0x0490: GetDotStr r7, "!vec3"  ; pool_off=0xab
  ...
  0x0508: LoadInt r6, 1
  0x0510: Add r5
  0x0514: GetDotStr r7, "!vec3"  ; pool_off=0xab
  ...
  0x058c: LoadInt r6, 1
  0x0594: Sub r5
  0x0598: GetDotStr r7, "!vec3"  ; pool_off=0xab
...
func_9:
  0x065c: GetDotStr r1, "loadSound"  ; pool_off=0xb1  ; paint_limfa.sc:77
  0x0664: Copy r-4, r2
  0x066c: GetDot r0, 1
  0x0674: Free2 r1, r2
  0x067c: ToStr r0
...
func_10:
  ...
  0x0714: GetDotStr r1, "!regionMask"  ; pool_off=0xca  ; paint_limfa.sc:92
  0x071c: GetDot r0, 0
  0x0724: Free1 r1
  0x0728: ToStr r0
  0x072c: CopyGlobRd r0, g7
  0x0734: Free1 r0
  0x0738: GetDotStr r2, "Plane"  ; pool_off=0x34  ; paint_limfa.sc:93
  ...
  0x07ac: GetDotStr r3, "Plane"  ; pool_off=0x34  ; paint_limfa.sc:96
...
func_11:
  0x080c: GetDotStr r2, "Plane"  ; pool_off=0x34  ; color_progress_simple_base.sci:14
  ...
  0x085c: Free1 r0
  0x0860: GetDotStr r1, "!ppconfig"  ; pool_off=0x11c  ; color_progress_simple_base.sci:16
  0x0868: GetDot r0, 0
  0x0870: Free1 r1
  0x0874: ToStr r0
  ...
  0x08bc: GetDot r0, 0
  0x08c4: Free2 r1, r0
  0x08cc: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0x152  ; color_progress_simple_base.sci:20
  0x08d4: GetDot r0, 0
  0x08dc: Free1 r1
  0x08e0: ToStr r0
  ...
  0x0954: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0x199  ; color_progress_simple_base.sci:22
  0x095c: Copy r0, r5
...
func_14:
  ...
  0x0acc: GetDotStr r2, "Window"  ; pool_off=0x7a  ; paint_limfa.sc:109
...
func_15:
  ...
  0x0b78: GetDotStr r2, "Window"  ; pool_off=0x7a  ; paint_limfa.sc:120
...
func_18:
  ...
  0x0cf4: GetDotStr r1, "Plane"  ; pool_off=0x34  ; paint_limfa.sc:147
  0x0cfc: ToStr r1
  0x0d00: CopyGlobWr r8, g3
  0x0d08: GetDotStr r5, "irandMax"  ; pool_off=0x1e2
...
func_19:
  ...
  0x0dd4: Free2 r2, r3
  0x0ddc: ToStr r1
  0x0de0: GetDotStr r6, "Globals"  ; pool_off=0x20b  ; ..\sound.sci:162
...
func_20:
  0x0e58: GetDotStr r2, "Settings"  ; pool_off=0x21a  ; ..\sound.sci:9
  0x0e60: Copy r-4, r3
