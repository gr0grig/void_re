...
;   bc=0x1078 str=2("../std.sci") val=104
;   bc=0x1080 str=2("../std.sci") val=103
...
func_1:
  0x001c: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0x0  ; life_wheel.sc:61
  0x0024: GetDot r0, 0
  0x002c: Free1 r1
  0x0030: ToStr r0
  ...
  0x008c: GetDot r2, 3
  0x0094: Free2 r3, r2
  0x009c: GetDotStr r3, "createPostProcessComposer"  ; pool_off=0x3f  ; life_wheel.sc:64
  0x00a4: Copy r0, r6
  ...
  0x00e8: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0x0  ; life_wheel.sc:68
  0x00f0: GetDot r0, 0
  0x00f8: Free1 r1
  0x00fc: ToStr r0
  ...
  0x0170: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0x3f  ; life_wheel.sc:70
  0x0178: Copy r0, r5
...
func_3:
  ...
  0x022c: GetDotStr r3, "Plane"  ; pool_off=0x80  ; life_wheel.sc:78
  ...
  0x02d0: GetDotStr r2, "Plane"  ; pool_off=0x80  ; life_wheel.sc:81
  ...
  0x032c: Free1 r0
  0x0330: GetDotStr r2, "Plane"  ; pool_off=0x80  ; life_wheel.sc:82
...
func_5:
  0x06f0: GetDotStr r1, "!ppconfig"  ; pool_off=0xb3  ; life_wheel.sc:26
  0x06f8: GetDot r0, 0
  0x0700: Free1 r1
  0x0704: ToStr r0
  ...
  0x0724: Free1 r2
  0x0728: GetDotStr r2, "!vec2"  ; pool_off=0xc6  ; life_wheel.sc:28
  0x0730: Copy r-6, r4
...
func_6:
  ...
  0x0920: Div r1
  0x0924: ToFloat r1
  0x0928: GetDotStr r3, "!vec3"  ; pool_off=0x139  ; life_wheel.sc:20
  0x0930: Copy r1, r4
  0x0938: Copy r1, r5
  0x0940: Copy r1, r6
  0x0948: GetDot r2, 3
...
func_8:
  0x0a30: GetDotStr r1, "!ppconfig"  ; pool_off=0xb3  ; life_wheel.sc:40
  0x0a38: GetDot r0, 0
  0x0a40: Free1 r1
  0x0a44: ToStr r0
  ...
  0x0aa0: Free1 r3
  0x0aa4: LoadInt r3, 0
  0x0aac: GetDotStr r5, "!vec3"  ; pool_off=0x139
  0x0ab4: LoadInt r6, 1
  0x0abc: LoadInt r7, 0
  0x0ac4: LoadInt r8, 0
  0x0acc: GetDot r4, 3
...
func_13:
  0x1080: Copy r-4, r0  ; ../std.sci:103
