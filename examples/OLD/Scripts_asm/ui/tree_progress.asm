...
;   bc=0x0458 str=2("../std.sci") val=104
;   bc=0x0460 str=2("../std.sci") val=103
...
func_1:
  ...
  0x0024: CallMethod r0, 0, 0x3e  ; @patch+8 tree_progress.sc:29
...
func_4:
  0x00a0: GetDotStr r2, "Plane"  ; pool_off=0xc  ; tree_progress.sc:33
  ...
  0x00dc: Free1 r0
  0x00e0: GetDotStr r2, "Plane"  ; pool_off=0xc  ; tree_progress.sc:34
  ...
  0x011c: Free1 r0
  0x0120: GetDotStr r1, "!ppconfig"  ; pool_off=0xa0  ; tree_progress.sc:36
  0x0128: GetDot r0, 0
  0x0130: Free1 r1
  0x0134: ToStr r0
  ...
  0x017c: GetDot r0, 0
  0x0184: Free2 r1, r0
  0x018c: GetDotStr r1, "createImageComposerBuilder"  ; pool_off=0xd6  ; tree_progress.sc:40
  0x0194: GetDot r0, 0
  0x019c: Free1 r1
  0x01a0: ToStr r0
  ...
  0x022c: GetDotStr r2, "createPostProcessComposer"  ; pool_off=0x127  ; tree_progress.sc:42
  0x0234: Copy r0, r5
  ...
  0x0300: GetDot r1, 2
  0x0308: Free2 r2, r1
  0x0310: GetDotStr r2, "!vec3"  ; pool_off=0x15a  ; tree_progress.sc:47
  0x0318: LoadInt r3, 1
  0x0320: LoadInt r4, 1
  0x0328: LoadInt r5, 1
  0x0330: GetDot r1, 3
...
func_6:
  0x0460: Copy r-4, r0  ; ../std.sci:103
...
func_7:
  ...
  0x0504: GetDotStr r5, "!vec3"  ; pool_off=0x15a
