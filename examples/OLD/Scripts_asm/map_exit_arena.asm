...
func_3:
  0x0048: GetDotStr r2, "Scene"  ; pool_off=0x0  ; map_exit_arena.sc:55
...
func_4:
  ...
  0x008c: GetDotStr r3, "Scene"  ; pool_off=0x0  ; map_exit_arena.sc:34
  ...
  0x00c4: GetDotStr r3, "Scene"  ; pool_off=0x0  ; map_exit_arena.sc:35
  ...
  0x010c: GetDotStr r2, "logInfo"  ; pool_off=0x54  ; map_exit_arena.sc:38
  ...
  0x0148: GetDotStr r3, "Scene"  ; pool_off=0x0  ; map_exit_arena.sc:44
  ...
  0x017c: Ret r0
  0x0180: GetDotStr r3, "World"  ; pool_off=0x9c  ; map_exit_arena.sc:48
  0x0188: SetDotRaw r2, 162
  0x0190: Free1 r3
  0x0194: GetDotStr r3, "Scene"  ; pool_off=0x0
