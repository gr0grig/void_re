...
func_2:
  0x0028: GetDotStr r1, "logInfo"  ; pool_off=0x0  ; bridge.sc:11
...
func_3:
  ...
  0x0108: Free2 r2, r3
  0x0110: ToStr r1
  0x0114: GetDotStr r6, "Globals"  ; pool_off=0x8e  ; ..\sound.sci:202
...
func_4:
  0x018c: GetDotStr r2, "Settings"  ; pool_off=0xa1  ; ..\sound.sci:9
  0x0194: Copy r-4, r3
