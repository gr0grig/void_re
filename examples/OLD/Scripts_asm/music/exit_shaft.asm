...
func_2:
  0x0028: GetDotStr r1, "logInfo"  ; pool_off=0x0  ; exit_shaft.sc:11
  0x0030: LoadString r2, "Ima music inited."  ; len=17, pool_off=0x8
  0x003c: GetDot r0, 1
  0x0044: Free3 r1, r2, r0
  0x004c: GetDotStr r2, "World"  ; pool_off=0x2a  ; exit_shaft.sc:13
...
func_3:
  ...
  0x0184: Free2 r2, r3
  0x018c: ToStr r1
  0x0190: GetDotStr r6, "Globals"  ; pool_off=0xa5  ; ..\sound.sci:202
...
func_4:
  0x0208: GetDotStr r2, "Settings"  ; pool_off=0xb8  ; ..\sound.sci:9
  0x0210: Copy r-4, r3
