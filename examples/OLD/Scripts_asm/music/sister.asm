...
;   bc=0x0020 str=1("sister.sc") val=15
;   bc=0x0028 str=1("sister.sc") val=11
;   bc=0x004c str=1("sister.sc") val=13
;   bc=0x0080 str=1("sister.sc") val=14
;   bc=0x0098 str=1("sister.sc") val=15
...
;   bc=0x0228 str=1("sister.sc") val=20
;   bc=0x0230 str=1("sister.sc") val=19
;   bc=0x0254 str=1("sister.sc") val=20
;   bc=0x0258 str=1("sister.sc") val=25
;   bc=0x0260 str=1("sister.sc") val=24
;   bc=0x0284 str=1("sister.sc") val=25
;   bc=0x0288 str=1("sister.sc") val=30
;   bc=0x0290 str=1("sister.sc") val=29
;   bc=0x02c4 str=1("sister.sc") val=30
; func_names:
;   0=initMusic
;   2=pauseMusic
;   6=resumeMusic
...
; === function 2 (pauseMusic, sister.sc, line 15) locals=4 ===
func_2:
  0x0028: GetDotStr r1, "logInfo"  ; pool_off=0x0  ; sister.sc:11
  0x0030: LoadString r2, "Yani music inited."  ; len=18, pool_off=0x8
  0x003c: GetDot r0, 1
  0x0044: Free3 r1, r2, r0
  0x004c: Copy r-5, r1  ; sister.sc:13
  0x0054: LoadString r2, "girl_sister_music"  ; len=17, pool_off=0x2c
  0x0060: LoadString r3, "Music"  ; len=5, pool_off=0x4e
  0x006c: Call r4, 0x00a4
  0x0074: CopyGlobRd r0, g0
  0x007c: Free1 r0
  0x0080: Copy r-5, r0  ; sister.sc:14
  0x0088: CopyGlobWr r0, g1
  0x0090: Call r2, 0x01d8
  0x0098: Free2 r-4, r-5  ; sister.sc:15
  0x00a0: Ret r0
...
; === function 6 (resumeMusic, sister.sc, line 20) locals=3 ===
func_6:
  0x0230: CopyGlobWr r0, g2  ; sister.sc:19
  0x0238: SetDotRaw r1, 217
  0x0240: Free1 r2
  0x0244: GetDot r0, 0
  0x024c: Free2 r1, r0
  0x0254: Ret r0  ; sister.sc:20

; === function 7 (onLocationExit, sister.sc, line 25) locals=3 ===
func_7:
  0x0260: CopyGlobWr r0, g2  ; sister.sc:24
  0x0268: SetDotRaw r1, 223
  0x0270: Free1 r2
  0x0274: GetDot r0, 0
  0x027c: Free2 r1, r0
  0x0284: Ret r0  ; sister.sc:25

; === function 8 (sister.sc, line 30) locals=4 ===
func_8:
  0x0290: CopyGlobWr r0, g2  ; sister.sc:29
