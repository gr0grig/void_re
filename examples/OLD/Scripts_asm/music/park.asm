...
func_2:
  0x0028: GetDotStr r1, "logInfo"  ; pool_off=0x0  ; park.sc:11
...
func_3:
  ...
  0x01b8: Free2 r2, r3
  0x01c0: ToStr r1
  0x01c4: GetDotStr r6, "Globals"  ; pool_off=0x62  ; ..\sound.sci:202
...
func_4:
  0x023c: GetDotStr r2, "Settings"  ; pool_off=0x75  ; ..\sound.sci:9
  0x0244: Copy r-4, r3
