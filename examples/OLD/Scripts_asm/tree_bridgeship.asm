...
; version=0, pool_size=1532
; old_version
; globals=12, func_table=803
; bytecode=10764 bytes
; inline_strings=6, patches=275
...
;   bc=0x15e8 str=4("tree_bridgeship.sc") val=16
;   bc=0x15f0 str=4("tree_bridgeship.sc") val=11
;   bc=0x1600 str=4("tree_bridgeship.sc") val=12
;   bc=0x162c str=4("tree_bridgeship.sc") val=13
;   bc=0x168c str=4("tree_bridgeship.sc") val=14
;   bc=0x169c str=4("tree_bridgeship.sc") val=11
;   bc=0x16a0 str=4("tree_bridgeship.sc") val=16
;   bc=0x16a4 str=4("tree_bridgeship.sc") val=25
;   bc=0x16ac str=4("tree_bridgeship.sc") val=20
;   bc=0x1720 str=4("tree_bridgeship.sc") val=21
;   bc=0x1764 str=4("tree_bridgeship.sc") val=22
;   bc=0x17a8 str=4("tree_bridgeship.sc") val=23
;   bc=0x17ec str=4("tree_bridgeship.sc") val=24
;   bc=0x1830 str=4("tree_bridgeship.sc") val=25
;   bc=0x1838 str=4("tree_bridgeship.sc") val=36
;   bc=0x1840 str=4("tree_bridgeship.sc") val=36
;   bc=0x1844 str=4("tree_bridgeship.sc") val=45
;   bc=0x184c str=4("tree_bridgeship.sc") val=45
;   bc=0x1850 str=5("gameplay.sci") val=500
;   bc=0x1858 str=5("gameplay.sci") val=495
;   bc=0x18b0 str=5("gameplay.sci") val=496
;   bc=0x1908 str=5("gameplay.sci") val=497
;   bc=0x1918 str=5("gameplay.sci") val=498
;   bc=0x193c str=5("gameplay.sci") val=499
;   bc=0x1960 str=5("gameplay.sci") val=555
;   bc=0x1968 str=5("gameplay.sci") val=545
;   bc=0x199c str=5("gameplay.sci") val=546
;   bc=0x19b4 str=5("gameplay.sci") val=548
;   bc=0x19bc str=5("gameplay.sci") val=549
;   bc=0x19c4 str=5("gameplay.sci") val=549
;   bc=0x19e0 str=5("gameplay.sci") val=550
;   bc=0x1a24 str=5("gameplay.sci") val=551
;   bc=0x1a38 str=5("gameplay.sci") val=549
;   bc=0x1a54 str=5("gameplay.sci") val=554
;   bc=0x1a70 str=3("std.sci") val=74
;   bc=0x1a78 str=3("std.sci") val=73
;   bc=0x1ab8 str=4("tree_bridgeship.sc") val=54
;   bc=0x1ac0 str=4("tree_bridgeship.sc") val=49
;   bc=0x1ad0 str=4("tree_bridgeship.sc") val=50
;   bc=0x1afc str=4("tree_bridgeship.sc") val=52
;   bc=0x1b0c str=4("tree_bridgeship.sc") val=53
;   bc=0x1b38 str=4("tree_bridgeship.sc") val=54
;   bc=0x1b3c str=3("std.sci") val=176
;   bc=0x1b44 str=3("std.sci") val=170
;   bc=0x1b78 str=3("std.sci") val=171
;   bc=0x1bc0 str=3("std.sci") val=170
;   bc=0x1bc8 str=3("std.sci") val=174
;   bc=0x1bec str=3("std.sci") val=176
;   bc=0x1bf8 str=1("tree_base.sci") val=182
;   bc=0x1c00 str=1("tree_base.sci") val=139
;   bc=0x1c14 str=1("tree_base.sci") val=141
;   bc=0x1c54 str=1("tree_base.sci") val=142
;   bc=0x1c88 str=1("tree_base.sci") val=144
;   bc=0x1c94 str=1("tree_base.sci") val=146
;   bc=0x1d0c str=1("tree_base.sci") val=147
;   bc=0x1d6c str=1("tree_base.sci") val=148
;   bc=0x1d88 str=1("tree_base.sci") val=150
;   bc=0x1db8 str=1("tree_base.sci") val=153
;   bc=0x1dc8 str=1("tree_base.sci") val=154
;   bc=0x1de8 str=1("tree_base.sci") val=155
;   bc=0x1df8 str=1("tree_base.sci") val=156
;   bc=0x1e4c str=1("tree_base.sci") val=157
;   bc=0x1e6c str=1("tree_base.sci") val=158
;   bc=0x1e8c str=1("tree_base.sci") val=159
;   bc=0x1eb8 str=1("tree_base.sci") val=161
;   bc=0x1f28 str=1("tree_base.sci") val=163
;   bc=0x1f5c str=1("tree_base.sci") val=164
;   bc=0x1f78 str=1("tree_base.sci") val=165
;   bc=0x1f80 str=1("tree_base.sci") val=166
;   bc=0x1f9c str=1("tree_base.sci") val=167
;   bc=0x1fa4 str=1("tree_base.sci") val=166
;   bc=0x1fac str=1("tree_base.sci") val=169
;   bc=0x1fb4 str=1("tree_base.sci") val=171
;   bc=0x1ff4 str=1("tree_base.sci") val=173
;   bc=0x2028 str=1("tree_base.sci") val=174
;   bc=0x20a8 str=1("tree_base.sci") val=175
;   bc=0x2128 str=1("tree_base.sci") val=177
;   bc=0x2134 str=1("tree_base.sci") val=181
;   bc=0x2150 str=5("gameplay.sci") val=609
;   bc=0x2158 str=5("gameplay.sci") val=606
;   bc=0x218c str=5("gameplay.sci") val=607
;   bc=0x2220 str=5("gameplay.sci") val=608
;   bc=0x223c str=1("tree_base.sci") val=53
;   bc=0x2244 str=1("tree_base.sci") val=51
;   bc=0x2264 str=1("tree_base.sci") val=52
;   bc=0x22a8 str=1("tree_base.sci") val=53
;   bc=0x22ac str=1("tree_base.sci") val=47
;   bc=0x22b4 str=1("tree_base.sci") val=45
;   bc=0x22d4 str=1("tree_base.sci") val=46
;   bc=0x2318 str=1("tree_base.sci") val=47
;   bc=0x231c str=1("tree_base.sci") val=41
;   bc=0x2324 str=1("tree_base.sci") val=39
;   bc=0x2344 str=1("tree_base.sci") val=40
;   bc=0x2388 str=1("tree_base.sci") val=41
;   bc=0x238c str=1("tree_base.sci") val=228
;   bc=0x2394 str=1("tree_base.sci") val=203
;   bc=0x23c8 str=1("tree_base.sci") val=204
;   bc=0x245c str=1("tree_base.sci") val=205
;   bc=0x2490 str=1("tree_base.sci") val=207
;   bc=0x24a4 str=1("tree_base.sci") val=209
;   bc=0x24ac str=1("tree_base.sci") val=211
;   bc=0x24b8 str=1("tree_base.sci") val=213
;   bc=0x24c4 str=1("tree_base.sci") val=214
;   bc=0x2508 str=1("tree_base.sci") val=215
;   bc=0x253c str=1("tree_base.sci") val=212
;   bc=0x254c str=1("tree_base.sci") val=218
;   bc=0x2558 str=1("tree_base.sci") val=219
;   bc=0x2574 str=1("tree_base.sci") val=220
;   bc=0x2580 str=1("tree_base.sci") val=221
;   bc=0x25b0 str=1("tree_base.sci") val=222
;   bc=0x25dc str=1("tree_base.sci") val=223
;   bc=0x25ec str=1("tree_base.sci") val=224
;   bc=0x268c str=1("tree_base.sci") val=219
;   bc=0x2694 str=1("tree_base.sci") val=227
;   bc=0x26a8 str=4("tree_bridgeship.sc") val=7
;   bc=0x26b0 str=4("tree_bridgeship.sc") val=6
;   bc=0x26c8 str=3("std.sci") val=104
;   bc=0x26d0 str=3("std.sci") val=103
;   bc=0x26f0 str=1("tree_base.sci") val=188
;   bc=0x26f8 str=1("tree_base.sci") val=186
;   bc=0x270c str=1("tree_base.sci") val=187
;   bc=0x2750 str=1("tree_base.sci") val=188
;   bc=0x2758 str=1("tree_base.sci") val=193
;   bc=0x2760 str=1("tree_base.sci") val=192
;   bc=0x2774 str=1("tree_base.sci") val=135
;   bc=0x277c str=1("tree_base.sci") val=134
;   bc=0x27b0 str=1("tree_base.sci") val=135
;   bc=0x27b4 str=5("gameplay.sci") val=419
;   bc=0x27bc str=5("gameplay.sci") val=402
;   bc=0x27d4 str=5("gameplay.sci") val=405
;   bc=0x2800 str=5("gameplay.sci") val=408
;   bc=0x281c str=5("gameplay.sci") val=408
;   bc=0x2848 str=5("gameplay.sci") val=411
;   bc=0x2864 str=5("gameplay.sci") val=411
;   bc=0x2890 str=5("gameplay.sci") val=414
;   bc=0x28ac str=5("gameplay.sci") val=414
;   bc=0x28d8 str=5("gameplay.sci") val=418
;   bc=0x28f4 str=1("tree_base.sci") val=13
;   bc=0x28fc str=1("tree_base.sci") val=12
;   bc=0x2914 str=1("tree_base.sci") val=69
;   bc=0x291c str=1("tree_base.sci") val=66
;   bc=0x2928 str=1("tree_base.sci") val=67
;   bc=0x297c str=1("tree_base.sci") val=68
; func_names:
;   0=getAllowedTypes
;   5=onStopUsing
;   10=isUsable
...
;   + 80: 27 00 00 01 00 00 00 00 0e 00 00 00 67 65 74 55
;   + 96: 73 65 44 69 73 74 61 6e 63 65 ff ff ff ff f4 28
;   +112: 00 00 00 00 00 00 11 00 00 00 67 65 74 4d 61 78
;   +128: 4c 69 6d 66 61 41 6d 6f 75 6e 74 ff ff ff ff 14
...
;   +192: 64 54 79 70 65 73 ff ff ff ff b4 27 00 00 01 00
;   +208: 00 00 00 0e 00 00 00 67 65 74 55 73 65 44 69 73
;   +224: 74 61 6e 63 65 ff ff ff ff f4 28 00 00 00 00 00
;   +240: 00 11 00 00 00 67 65 74 4d 61 78 4c 69 6d 66 61
;   +256: 41 6d 6f 75 6e 74 ff ff ff ff 14 29 00 00 00 00
...
;   +400: 64 54 79 70 65 73 ff ff ff ff b4 27 00 00 01 00
;   +416: 00 00 00 0e 00 00 00 67 65 74 55 73 65 44 69 73
;   +432: 74 61 6e 63 65 ff ff ff ff f4 28 00 00 00 00 00
;   +448: 00 11 00 00 00 67 65 74 4d 61 78 4c 69 6d 66 61
;   +464: 41 6d 6f 75 6e 74 ff ff ff ff 14 29 00 00 00 00
;   +480: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00
;   +496: 00 00 03 00 00 00 06 00 00 00 03 00 00 00 09 00
;   +512: 00 00 6f 6e 47 65 73 74 75 72 65 ff ff ff ff f8
;   +528: 1b 00 00 01 01 01 03 00 00 00 05 00 00 00 6f 6e
;   +544: 55 73 65 ff ff ff ff f0 26 00 00 03 01 01 00 00
;   +560: 00 00 0b 00 00 00 69 73 50 61 69 6e 74 61 62 6c
;   +576: 65 ff ff ff ff 58 27 00 00 01 00 00 00 0f 00 00
;   +592: 00 67 65 74 41 6c 6c 6f 77 65 64 54 79 70 65 73
;   +608: ff ff ff ff b4 27 00 00 01 00 00 00 00 0e 00 00
;   +624: 00 67 65 74 55 73 65 44 69 73 74 61 6e 63 65 ff
;   +640: ff ff ff f4 28 00 00 00 00 00 00 11 00 00 00 67
;   +656: 65 74 4d 61 78 4c 69 6d 66 61 41 6d 6f 75 6e 74
;   +672: ff ff ff ff 14 29 00 00 00 00 00 00 00 00 00 00
;   +688: 00 00 00 00 00 00 00 00 01 00 00 00 04 00 00 00
;   +704: 03 00 00 00 01 00 00 00 0f 00 00 00 67 65 74 41
;   +720: 6c 6c 6f 77 65 64 54 79 70 65 73 ff ff ff ff b4
;   +736: 27 00 00 01 00 00 00 00 0e 00 00 00 67 65 74 55
;   +752: 73 65 44 69 73 74 61 6e 63 65 ff ff ff ff f4 28
;   +768: 00 00 00 00 00 00 11 00 00 00 67 65 74 4d 61 78
;   +784: 4c 69 6d 66 61 41 6d 6f 75 6e 74 ff ff ff ff 14
;   +800: 29 00 00
...
func_1:
  ...
  0x03a8: CallNat r3, func=10100, info=0x200  ; tree_base.sci:113
...
func_13:
  ...
  0x14e0: Call r8, 0x1844  ; tree_base.sci:300
...
; === function 15 (tree_bridgeship.sc, line 16) locals=7 ===
func_15:
  0x15f0: CopyGlobWr r9, g0  ; tree_bridgeship.sc:11
  0x15f8: BrNZ r0, 0x16a0
  0x1600: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_bridgeship.sc:12
  0x1608: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1610: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1618: GetDot r0, 2
  0x1620: Free3 r1, r2, r3
  0x1628: ToStr r0
  0x162c: GetDotStr r3, "World"  ; pool_off=0xa6  ; tree_bridgeship.sc:13
  0x1634: SetDotRaw r2, 936
  0x163c: Free1 r3
  0x1640: GetDotStr r3, "Scene"  ; pool_off=0x1e
  0x1648: LoadString r4, "ps_bridgeship_treefruit.ps"  ; len=26, pool_off=0x3bd
  0x1654: Copy r0, r5
  ...
  0x1688: Free1 r1
  0x168c: Copy r-4, r1  ; tree_bridgeship.sc:14
  0x1694: Call r2, 0x16a4
  0x169c: Free1 r0  ; tree_bridgeship.sc:11
  0x16a0: Ret r0  ; tree_bridgeship.sc:16

; === function 16 (tree_bridgeship.sc, line 25) locals=7 ===
func_16:
  0x16ac: Copy r-4, r0  ; tree_bridgeship.sc:20
  ...
  0x1718: Mul r0
  0x171c: ToStr r0
  0x1720: CopyGlobWr r9, g3  ; tree_bridgeship.sc:21
  0x1728: SetDotRaw r2, 1009
  0x1730: Free1 r3
  0x1734: LoadInt r3, 0
  0x173c: LoadString r4, "PSColor"  ; len=7, pool_off=0x407
  0x1748: Copy r0, r5
  0x1750: GetDot r1, 3
  0x1758: Free4 r2, r4, r5, r1
  0x1764: CopyGlobWr r9, g3  ; tree_bridgeship.sc:22
  0x176c: SetDotRaw r2, 1009
  0x1774: Free1 r3
  0x1778: LoadInt r3, 1
  0x1780: LoadString r4, "PSColor"  ; len=7, pool_off=0x407
  0x178c: Copy r0, r5
  0x1794: GetDot r1, 3
  0x179c: Free4 r2, r4, r5, r1
  0x17a8: CopyGlobWr r9, g3  ; tree_bridgeship.sc:23
  0x17b0: SetDotRaw r2, 1009
  0x17b8: Free1 r3
  0x17bc: LoadInt r3, 2
  0x17c4: LoadString r4, "PSColor"  ; len=7, pool_off=0x407
  0x17d0: Copy r0, r5
  0x17d8: GetDot r1, 3
  0x17e0: Free4 r2, r4, r5, r1
  0x17ec: CopyGlobWr r9, g3  ; tree_bridgeship.sc:24
  0x17f4: SetDotRaw r2, 1009
  0x17fc: Free1 r3
  0x1800: LoadInt r3, 3
  0x1808: LoadString r4, "PSColor"  ; len=7, pool_off=0x407
  0x1814: Copy r0, r5
  0x181c: GetDot r1, 3
  0x1824: Free4 r2, r4, r5, r1
  0x1830: Free1 r0  ; tree_bridgeship.sc:25
  0x1834: Ret r0

; === function 17 (tree_bridgeship.sc, line 36) locals=0 ===
func_17:
  0x1840: Ret r0  ; tree_bridgeship.sc:36

; === function 18 (tree_bridgeship.sc, line 45) locals=0 ===
func_18:
  0x184c: Ret r0  ; tree_bridgeship.sc:45

; === function 19 (gameplay.sci, line 500) locals=7 ===
func_19:
  0x1858: Copy r-4, r5  ; gameplay.sci:495
  0x1860: SetDotRaw r4, 172
  0x1868: Free1 r5
  0x186c: SetDotRaw r3, 183
  0x1874: Free1 r4
  0x1878: LoadString r4, "Gameplay"  ; len=8, pool_off=0x415
  0x1884: GetDot r2, 1
  0x188c: Free2 r3, r4
  0x1894: SetDotRaw r1, 1061
  0x189c: Free1 r2
  0x18a0: SetDotRaw r0, 678
  0x18a8: Free1 r1
  0x18ac: ToFloat r0
  0x18b0: Copy r-4, r6  ; gameplay.sci:496
  0x18b8: SetDotRaw r5, 172
  0x18c0: Free1 r6
  0x18c4: SetDotRaw r4, 183
  0x18cc: Free1 r5
  0x18d0: LoadString r5, "Gameplay"  ; len=8, pool_off=0x415
  0x18dc: GetDot r3, 1
  0x18e4: Free2 r4, r5
  0x18ec: SetDotRaw r2, 1085
  0x18f4: Free1 r3
  0x18f8: SetDotRaw r1, 678
  0x1900: Free1 r2
  0x1904: ToFloat r1
  0x1908: Copy r-4, r3  ; gameplay.sci:497
  0x1910: Call r4, 0x1960
  0x1918: Copy r0, r3  ; gameplay.sci:498
  0x1920: Copy r1, r4
  0x1928: Copy r2, r5
  0x1930: Mul r4
  0x1934: Add r3
  0x1938: ToInt r3
  0x193c: Copy r3, r4  ; gameplay.sci:499
  0x1944: LoadInt r5, 1000
  0x194c: Mul r4
  0x1950: Copy r4, r4294967291
  0x1958: Free1 r-4
  0x195c: Ret r0

; === function 20 (gameplay.sci, line 555) locals=8 ===
func_20:
  0x1968: Copy r-4, r2  ; gameplay.sci:545
  0x1970: SetDotRaw r1, 36
  0x1978: Free1 r2
  0x197c: LoadString r2, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x1988: GetDot r0, 1
  0x1990: Free2 r1, r2
  0x1998: ToStr r0
  0x199c: Copy r0, r2  ; gameplay.sci:546
  0x19a4: SetDotRaw r1, 172
  0x19ac: Free1 r2
  0x19b0: ToStr r1
  0x19b4: LoadInt r2, 0  ; gameplay.sci:548
  0x19bc: LoadInt r3, 0  ; gameplay.sci:549
  0x19c4: Copy r3, r4  ; gameplay.sci:549
  0x19cc: LoadInt r5, 21
  0x19d4: CmpLt r4
  0x19d8: BrZ r4, 0x1a54
  0x19e0: Copy r1, r7  ; gameplay.sci:550
  0x19e8: SetDotRaw r6, 1113
  0x19f0: Free1 r7
  0x19f4: Copy r3, r7
  0x19fc: AsString r7
  0x1a00: SetDot r5, 1
  ...
  0x1a0c: LoadInt r6, 3
  0x1a14: SetDot r4, 1
  0x1a1c: BrZ r4, 0x1a38
  0x1a24: Copy r2, r4  ; gameplay.sci:551
  0x1a2c: Incr r4
  0x1a30: Copy r4, r2
  0x1a38: Copy r3, r4  ; gameplay.sci:549
  0x1a40: Incr r4
  0x1a44: Copy r4, r3
  0x1a4c: Jmp r0, 0x19c4
  0x1a54: Copy r2, r3  ; gameplay.sci:554
  0x1a5c: Copy r3, r4294967291
  0x1a64: Free3 r1, r0, r-4
  0x1a6c: Ret r0

; === function 21 (std.sci, line 74) locals=2 ===
func_21:
  0x1a78: Copy r-5, r0  ; std.sci:73
  0x1a80: Copy r-4, r1
  0x1a88: CmpLt r0
  0x1a8c: BrNZ r0, 0x1aa4
  0x1a94: Copy r-4, r0
  0x1a9c: Jmp r0, 0x1aac
  0x1aa4: Copy r-5, r0
  0x1aac: Copy r0, r4294967290
  0x1ab4: Ret r0

; === function 22 (tree_bridgeship.sc, line 54) locals=3 ===
func_22:
  0x1ac0: CopyGlobWr r10, g0  ; tree_bridgeship.sc:49
  0x1ac8: BrZ r0, 0x1afc
  0x1ad0: CopyGlobWr r10, g2  ; tree_bridgeship.sc:50
  0x1ad8: SetDotRaw r1, 784
  0x1ae0: Free1 r2
  0x1ae4: Copy r-4, r2
  0x1aec: GetDot r0, 1
  0x1af4: Free2 r1, r0
  0x1afc: CopyGlobWr r9, g0  ; tree_bridgeship.sc:52
  0x1b04: BrZ r0, 0x1b38
  0x1b0c: CopyGlobWr r9, g2  ; tree_bridgeship.sc:53
  0x1b14: SetDotRaw r1, 784
  0x1b1c: Free1 r2
  0x1b20: Copy r-4, r2
  0x1b28: GetDot r0, 1
  0x1b30: Free2 r1, r0
  0x1b38: Ret r0  ; tree_bridgeship.sc:54

; === function 23 (std.sci, line 176) locals=3 ===
func_23:
  0x1b44: Copy r-6, r2  ; std.sci:170
  0x1b4c: SetDotRaw r1, 91
  0x1b54: Free1 r2
  0x1b58: Copy r-5, r2
  0x1b60: GetDot r0, 1
  0x1b68: Free2 r1, r2
  0x1b70: BrZ r0, 0x1bc8
  0x1b78: Copy r-6, r1  ; std.sci:171
  0x1b80: Copy r-5, r2
  0x1b88: SetDot r0, 1
  0x1b90: Free1 r2
  0x1b94: Copy r-4, r1
  ...
  0x1ba0: Copy r-6, r1
  0x1ba8: Copy r-5, r2
  0x1bb0: GetDotRaw r1, 1
  0x1bb8: Free2 r2, r0
  0x1bc0: Jmp r0, 0x1bec  ; std.sci:170
  0x1bc8: Copy r-4, r0  ; std.sci:174
  0x1bd0: Copy r-6, r1
  0x1bd8: Copy r-5, r2
  0x1be0: GetDotRaw r1, 1
  0x1be8: Free1 r2
  0x1bec: Free2 r-5, r-6  ; std.sci:176
  0x1bf4: Ret r0

; === function 24 (onUse, tree_base.sci, line 182) locals=10 ===
func_24:
  0x1c00: GetDotStr r1, "World"  ; pool_off=0xa6  ; tree_base.sci:139
  0x1c08: ToStr r1
  0x1c0c: Call r2, 0x2150
  0x1c14: GetDotStr r2, "logInfo"  ; pool_off=0x2ee  ; tree_base.sci:141
  0x1c1c: LoadString r3, "Inserted into tree limfa amount: "  ; len=33, pool_off=0x463
  0x1c28: Copy r-4, r4
  0x1c30: Copy r0, r5
  0x1c38: Mul r4
  0x1c3c: AsString r4
  0x1c40: Add r3
  0x1c44: GetDot r1, 1
  0x1c4c: Free3 r2, r3, r1
  0x1c54: GetDotStr r2, "logInfo"  ; pool_off=0x2ee  ; tree_base.sci:142
  0x1c5c: LoadString r3, "Actuall used limfa amount (due to inspiration): "  ; len=48, pool_off=0x4a5
  0x1c68: Copy r-4, r4
  0x1c70: AsString r4
  0x1c74: Add r3
  0x1c78: GetDot r1, 1
  0x1c80: Free3 r2, r3, r1
  0x1c88: LoadInt r1, 1  ; tree_base.sci:144
  0x1c90: ToFloat r1
  0x1c94: LoadBool r2, true  ; tree_base.sci:146
  0x1c9c: Copy r-6, r3
  0x1ca4: LoadInt r4, -1
  0x1cac: CmpEq r3
  0x1cb0: BrNZ r3, 0x1d04
  0x1cb8: GetDotStr r4, "getGestureName"  ; pool_off=0x505
  0x1cc0: LoadString r5, "player"  ; len=6, pool_off=0x514
  0x1ccc: Copy r-6, r6
  0x1cd4: GetDot r3, 2
  0x1cdc: Free2 r4, r5
  0x1ce4: LoadString r4, "gesture_donor"  ; len=13, pool_off=0x520
  0x1cf0: CmpNe r3
  0x1cf4: BrNZ r3, 0x1d04
  0x1cfc: LoadBool r2, false
  0x1d04: BrZ r2, 0x1db8
  0x1d0c: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:147
  0x1d14: SetDotRaw r6, 172
  0x1d1c: Free1 r7
  0x1d20: SetDotRaw r5, 183
  0x1d28: Free1 r6
  0x1d2c: LoadString r6, "Gameplay"  ; len=8, pool_off=0x415
  0x1d38: GetDot r4, 1
  0x1d40: Free2 r5, r6
  0x1d48: SetDotRaw r3, 1338
  0x1d50: Free1 r4
  0x1d54: SetDotRaw r2, 678
  0x1d5c: Free1 r3
  0x1d60: ToFloat r2
  0x1d64: Copy r2, r1
  0x1d6c: Copy r0, r2  ; tree_base.sci:148
  0x1d74: Copy r1, r3
  0x1d7c: Mul r2
  0x1d80: Copy r2, r0
  0x1d88: GetDotStr r4, "Scene"  ; pool_off=0x1e  ; tree_base.sci:150
  0x1d90: SetDotRaw r3, 36
  0x1d98: Free1 r4
  0x1d9c: LoadString r4, "showDonorHelp"  ; len=13, pool_off=0x550
  0x1da8: GetDot r2, 1
  0x1db0: Free3 r3, r4, r2
  0x1db8: Copy r-5, r2  ; tree_base.sci:153
  0x1dc0: CopyGlobRd r2, g6
  0x1dc8: Copy r-4, r2  ; tree_base.sci:154
  0x1dd0: Copy r0, r3
  0x1dd8: Mul r2
  0x1ddc: ToInt r2
  0x1de0: CopyGlobRd r2, g8
  0x1de8: LoadInt r2, 0  ; tree_base.sci:155
  0x1df0: CopyGlobRd r2, g7
  0x1df8: GetDotStr r6, "Scene"  ; pool_off=0x1e  ; tree_base.sci:156
  0x1e00: SetDotRaw r5, 36
  0x1e08: Free1 r6
  0x1e0c: LoadString r6, "getLocationProperties"  ; len=21, pool_off=0x29
  0x1e18: GetDot r4, 1
  0x1e20: Free2 r5, r6
  0x1e28: SetDotRaw r3, 83
  0x1e30: Free1 r4
  0x1e34: GetDotStr r4, "Name"  ; pool_off=0x19
  0x1e3c: SetDot r2, 1
  0x1e44: Free1 r4
  0x1e48: ToStr r2
  0x1e4c: Copy r-5, r3  ; tree_base.sci:157
  0x1e54: Copy r2, r4
  0x1e5c: SetInd r4
  0x1e60: LoadString r0, "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀..."  ; len=119, pool_off=0x44a, GARBLED
  0x1e6c: LoadInt r3, 0  ; tree_base.sci:158
  0x1e74: Copy r2, r4
  0x1e7c: SetInd r4
  0x1e80: LoadString r0, "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀..."  ; len=113, pool_off=0x44a, GARBLED
  0x1e8c: Copy r-4, r3  ; tree_base.sci:159
  0x1e94: Copy r0, r4
  0x1e9c: Mul r3
  0x1ea0: Copy r2, r4
  0x1ea8: SetInd r4
  0x1eac: LoadString r0, "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀..."  ; len=195, pool_off=0x44a, GARBLED
  0x1eb8: GetDotStr r8, "World"  ; pool_off=0xa6  ; tree_base.sci:161
  0x1ec0: SetDotRaw r7, 172
  0x1ec8: Free1 r8
  0x1ecc: SetDotRaw r6, 183
  0x1ed4: Free1 r7
  0x1ed8: LoadString r7, "Tree/"  ; len=5, pool_off=0xd1
  0x1ee4: Copy r2, r9
  0x1eec: SetDotRaw r8, 219
  0x1ef4: Free1 r9
  0x1ef8: Add r7
  0x1efc: GetDot r5, 1
  0x1f04: Free2 r6, r7
  0x1f0c: SetDotRaw r4, 1386
  0x1f14: Free1 r5
  0x1f18: SetDotRaw r3, 237
  0x1f20: Free1 r4
  0x1f24: ToInt r3
  0x1f28: Copy r-4, r4  ; tree_base.sci:163
  0x1f30: ToFloat r4
  0x1f34: Copy r0, r5
  0x1f3c: Mul r4
  0x1f40: Copy r3, r5
  0x1f48: ToFloat r5
  0x1f4c: Div r4
  0x1f50: LoadFloat r5, 1000.0
  0x1f58: Div r4
  0x1f5c: Copy r4, r5  ; tree_base.sci:164
  0x1f64: LoadFloat r6, 0.33000001311302185
  0x1f6c: CmpLt r5
  0x1f70: BrZ r5, 0x1f80
  0x1f78: Call r5, 0x223c  ; tree_base.sci:165
  0x1f80: Copy r4, r5  ; tree_base.sci:166
  0x1f88: LoadFloat r6, 0.6600000262260437
  0x1f90: CmpLt r5
  0x1f94: BrZ r5, 0x1fac
  0x1f9c: Call r5, 0x22ac  ; tree_base.sci:167
  0x1fa4: Jmp r0, 0x1fb4  ; tree_base.sci:166
  0x1fac: Call r5, 0x231c  ; tree_base.sci:169
  0x1fb4: GetDotStr r7, "Scene"  ; pool_off=0x1e  ; tree_base.sci:171
  0x1fbc: SetDotRaw r6, 36
  0x1fc4: Free1 r7
  0x1fc8: LoadString r7, "tabooViolation"  ; len=14, pool_off=0x57b
  0x1fd4: Copy r-5, r8
  0x1fdc: Copy r-4, r9
  0x1fe4: GetDot r5, 3
  0x1fec: Free3 r6, r7, r5
  0x1ff4: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:173
  0x1ffc: SetDotRaw r6, 36
  0x2004: Free1 r7
  0x2008: LoadString r7, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x2014: GetDot r5, 1
  0x201c: Free2 r6, r7
  0x2024: ToStr r5
  0x2028: Copy r5, r9  ; tree_base.sci:174
  0x2030: SetDotRaw r8, 172
  0x2038: Free1 r9
  0x203c: SetDotRaw r7, 1431
  0x2044: Free1 r8
  0x2048: Copy r-5, r8
  0x2050: AsString r8
  0x2054: SetDot r6, 1
  ...
  0x2068: Sub r6
  0x206c: Copy r5, r9
  0x2074: SetDotRaw r8, 172
  0x207c: Free1 r9
  0x2080: SetDotRaw r7, 1431
  0x2088: Free1 r8
  0x208c: Copy r-5, r8
  0x2094: AsString r8
  0x2098: GetDotRaw r7, 1537
  0x20a0: Free2 r8, r6
  0x20a8: Copy r5, r9  ; tree_base.sci:175
  0x20b0: SetDotRaw r8, 172
  0x20b8: Free1 r9
  0x20bc: SetDotRaw r7, 1443
  0x20c4: Free1 r8
  0x20c8: Copy r-5, r8
  0x20d0: AsString r8
  0x20d4: SetDot r6, 1
  ...
  0x20e8: Add r6
  0x20ec: Copy r5, r9
  0x20f4: SetDotRaw r8, 172
  0x20fc: Free1 r9
  0x2100: SetDotRaw r7, 1443
  0x2108: Free1 r8
  0x210c: Copy r-5, r8
  0x2114: AsString r8
  0x2118: GetDotRaw r7, 1537
  0x2120: Free2 r8, r6
  0x2128: CallNat2 r4, func=9100, info=0x600  ; tree_base.sci:177
  0x2134: Copy r1, r6  ; tree_base.sci:181
  0x213c: Copy r6, r4294967289
  0x2144: Free2 r5, r2
  0x214c: Ret r0

; === function 25 (gameplay.sci, line 609) locals=9 ===
func_25:
  0x2158: Copy r-4, r2  ; gameplay.sci:606
  0x2160: SetDotRaw r1, 36
  0x2168: Free1 r2
  0x216c: LoadString r2, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x2178: GetDot r0, 1
  0x2180: Free2 r1, r2
  0x2188: ToStr r0
  0x218c: LoadFloat r1, 1.0  ; gameplay.sci:607
  0x2194: Copy r0, r4
  0x219c: SetDotRaw r3, 172
  0x21a4: Free1 r4
  0x21a8: SetDotRaw r2, 1453
  0x21b0: Free1 r3
  0x21b4: GetDotStr r8, "World"  ; pool_off=0xa6
  0x21bc: SetDotRaw r7, 172
  0x21c4: Free1 r8
  0x21c8: SetDotRaw r6, 183
  0x21d0: Free1 r7
  0x21d4: LoadString r7, "Gameplay"  ; len=8, pool_off=0x415
  0x21e0: GetDot r5, 1
  0x21e8: Free2 r6, r7
  0x21f0: SetDotRaw r4, 1465
  0x21f8: Free1 r5
  0x21fc: SetDotRaw r3, 678
  0x2204: Free1 r4
  0x2208: LoadFloat r4, 1.0
  0x2210: Sub r3
  0x2214: Mul r2
  0x2218: Add r1
  0x221c: ToFloat r1
  0x2220: Copy r1, r2  ; gameplay.sci:608
  0x2228: Copy r2, r4294967291
  0x2230: Free2 r0, r-4
  0x2238: Ret r0

; === function 26 (tree_base.sci, line 53) locals=6 ===
func_26:
  0x2244: GetDotStr r1, "irandMax"  ; pool_off=0x5d0  ; tree_base.sci:51
  0x224c: LoadInt r2, 3
  0x2254: GetDot r0, 1
  0x225c: Free1 r1
  0x2260: ToInt r0
  0x2264: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:52
  0x226c: ToStr r2
  0x2270: CopyGlobWr r2, g4
  0x2278: Copy r0, r5
  0x2280: SetDot r3, 1
  0x2288: ToStr r3
  0x228c: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x2298: Call r5, 0x0be4
  0x22a0: Call r2, 0x0b98
  0x22a8: Ret r0  ; tree_base.sci:53

; === function 27 (tree_base.sci, line 47) locals=6 ===
func_27:
  0x22b4: GetDotStr r1, "irandMax"  ; pool_off=0x5d0  ; tree_base.sci:45
  0x22bc: LoadInt r2, 3
  0x22c4: GetDot r0, 1
  0x22cc: Free1 r1
  0x22d0: ToInt r0
  0x22d4: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:46
  0x22dc: ToStr r2
  0x22e0: CopyGlobWr r1, g4
  0x22e8: Copy r0, r5
  0x22f0: SetDot r3, 1
  0x22f8: ToStr r3
  0x22fc: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x2308: Call r5, 0x0be4
  0x2310: Call r2, 0x0b98
  0x2318: Ret r0  ; tree_base.sci:47

; === function 28 (tree_base.sci, line 41) locals=6 ===
func_28:
  0x2324: GetDotStr r1, "irandMax"  ; pool_off=0x5d0  ; tree_base.sci:39
  0x232c: LoadInt r2, 3
  0x2334: GetDot r0, 1
  0x233c: Free1 r1
  0x2340: ToInt r0
  0x2344: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:40
  0x234c: ToStr r2
  0x2350: CopyGlobWr r0, g4
  0x2358: Copy r0, r5
  0x2360: SetDot r3, 1
  0x2368: ToStr r3
  0x236c: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x2378: Call r5, 0x0be4
  0x2380: Call r2, 0x0b98
  0x2388: Ret r0  ; tree_base.sci:41

; === function 29 (tree_base.sci, line 228) locals=16 ===
func_29:
  0x2394: GetDotStr r1, "setLocalGeomParameterBool"  ; pool_off=0x1d2  ; tree_base.sci:203
  0x239c: CopyGlobWr r5, g2
  0x23a4: LoadString r3, "Enabled"  ; len=7, pool_off=0x1ec
  0x23b0: LoadBool r4, true
  0x23b8: GetDot r0, 3
  0x23c0: Free3 r1, r3, r0
  0x23c8: GetDotStr r1, "setLocalGeomParameterColor"  ; pool_off=0x81  ; tree_base.sci:204
  0x23d0: CopyGlobWr r5, g2
  0x23d8: LoadString r3, "Color"  ; len=5, pool_off=0x9c
  0x23e4: GetDotStr r9, "World"  ; pool_off=0xa6
  0x23ec: SetDotRaw r8, 172
  0x23f4: Free1 r9
  0x23f8: SetDotRaw r7, 183
  0x2400: Free1 r8
  0x2404: LoadString r8, "Limfa"  ; len=5, pool_off=0x67
  0x2410: CopyGlobWr r6, g9
  0x2418: AsString r9
  0x241c: Add r8
  0x2420: GetDot r6, 1
  0x2428: Free2 r7, r8
  0x2430: SetDotRaw r5, 150
  0x2438: Free1 r6
  0x243c: SetDotRaw r4, 187
  0x2444: Free1 r5
  0x2448: GetDot r0, 3
  0x2450: Free4 r1, r3, r4, r0
  0x245c: GetDotStr r1, "setLocalGeomParameterFloat"  ; pool_off=0x1fa  ; tree_base.sci:205
  0x2464: CopyGlobWr r5, g2
  0x246c: LoadString r3, "Threshold"  ; len=9, pool_off=0x215
  0x2478: LoadInt r4, 1
  0x2480: GetDot r0, 3
  0x2488: Free3 r1, r3, r0
  0x2490: LoadInt r0, 1  ; tree_base.sci:207
  0x2498: ToFloat r0
  0x249c: Call r1, 0x15e8
  0x24a4: Call r1, 0x26a8  ; tree_base.sci:209
  0x24ac: LoadInt r1, 1  ; tree_base.sci:211
  0x24b4: ToFloat r1
  0x24b8: Free1 r3  ; tree_base.sci:213
  0x24bc: RetV r2
  0x24c0: ToInt r2
  0x24c4: Copy r1, r4  ; tree_base.sci:214
  0x24cc: Copy r2, r6
  0x24d4: Call r7, 0x26c8
  0x24dc: Copy r0, r6
  0x24e4: Div r5
  0x24e8: Sub r4
  0x24ec: LoadInt r5, 0
  0x24f4: ToFloat r5
  0x24f8: Call r6, 0x15a0
  0x2500: Copy r3, r1
  0x2508: GetDotStr r4, "setLocalGeomParameterFloat"  ; pool_off=0x1fa  ; tree_base.sci:215
  0x2510: CopyGlobWr r5, g5
  0x2518: LoadString r6, "Threshold"  ; len=9, pool_off=0x215
  0x2524: Copy r1, r7
  0x252c: GetDot r3, 3
  0x2534: Free3 r4, r6, r3
  0x253c: Copy r1, r2  ; tree_base.sci:212
  0x2544: BrNZ r2, 0x24b8
  0x254c: LoadInt r2, 0  ; tree_base.sci:218
  0x2554: ToFloat r2
  0x2558: Copy r2, r3  ; tree_base.sci:219
  0x2560: LoadInt r4, 1
  0x2568: CmpLt r3
  0x256c: BrZ r3, 0x2694
  0x2574: Free1 r4  ; tree_base.sci:220
  0x2578: RetV r3
  0x257c: ToInt r3
  0x2580: Copy r2, r4  ; tree_base.sci:221
  0x2588: Copy r3, r6
  0x2590: Call r7, 0x26c8
  0x2598: LoadFloat r6, 60.0
  0x25a0: Div r5
  0x25a4: Add r4
  0x25a8: Copy r4, r2
  0x25b0: LoadFloat r4, 0.20000000298023224  ; tree_base.sci:222
  0x25b8: LoadFloat r5, 0.800000011920929
  0x25c0: LoadInt r6, 1
  0x25c8: Copy r2, r7
  0x25d0: Sub r6
  0x25d4: Mul r5
  0x25d8: Add r4
  0x25dc: Copy r4, r5  ; tree_base.sci:223
  0x25e4: Call r6, 0x16a4
  0x25ec: GetDotStr r6, "setLocalGeomParameterColor"  ; pool_off=0x81  ; tree_base.sci:224
  0x25f4: CopyGlobWr r5, g7
  0x25fc: LoadString r8, "Color"  ; len=5, pool_off=0x9c
  0x2608: Copy r4, r9
  0x2610: GetDotStr r15, "World"  ; pool_off=0xa6
  0x2618: SetDotRaw r14, 172
  0x2620: Free1 r15
  0x2624: SetDotRaw r13, 183
  0x262c: Free1 r14
  0x2630: LoadString r14, "Limfa"  ; len=5, pool_off=0x67
  0x263c: CopyGlobWr r6, g15
  0x2644: AsString r15
  0x2648: Add r14
  0x264c: GetDot r12, 1
  0x2654: Free2 r13, r14
  0x265c: SetDotRaw r11, 150
  0x2664: Free1 r12
  0x2668: SetDotRaw r10, 187
  0x2670: Free1 r11
  0x2674: Mul r9
  0x2678: GetDot r5, 3
  0x2680: Free4 r6, r8, r9, r5
  0x268c: Jmp r0, 0x2558  ; tree_base.sci:219
  0x2694: LoadBool r3, true  ; tree_base.sci:227
  0x269c: CallNat r2, func=3616, info=0x301

; === function 30 (tree_bridgeship.sc, line 7) locals=1 ===
func_30:
  0x26b0: LoadInt r0, 3  ; tree_bridgeship.sc:6
  0x26b8: ToFloat r0
...
func_31:
  0x26d0: Copy r-4, r0  ; std.sci:103
  0x26d8: LoadFloat r1, 1000000.0
  0x26e0: Div r0
  0x26e4: Copy r0, r4294967291
  0x26ec: Ret r0

; === function 32 (tree_base.sci, line 188) locals=6 ===
func_32:
  0x26f8: GetDotStr r1, "World"  ; pool_off=0xa6  ; tree_base.sci:186
  0x2700: ToStr r1
  0x2704: Call r2, 0x2150
  0x270c: GetDotStr r3, "Scene"  ; pool_off=0x1e  ; tree_base.sci:187
  0x2714: SetDotRaw r2, 36
  0x271c: Free1 r3
  0x2720: LoadString r3, "activateTree"  ; len=12, pool_off=0x5d9
  0x272c: GetDotStr r4, "self"  ; pool_off=0x237
  0x2734: Copy r0, r5
  0x273c: GetDot r1, 3
  0x2744: Free4 r2, r3, r4, r1
  0x2750: Free1 r-6  ; tree_base.sci:188
  0x2754: Ret r0

; === function 33 (isPaintable, tree_base.sci, line 193) locals=1 ===
func_33:
  0x2760: LoadBool r0, true  ; tree_base.sci:192
  0x2768: Copy r0, r4294967292
  0x2770: Ret r0

; === function 34 (getAllowedTypes, tree_base.sci, line 135) locals=5 ===
func_34:
  0x277c: GetDotStr r1, "setLocalGeomParameterBool"  ; pool_off=0x1d2  ; tree_base.sci:134
  0x2784: CopyGlobWr r5, g2
  0x278c: LoadString r3, "Enabled"  ; len=7, pool_off=0x1ec
  0x2798: LoadBool r4, false
  0x27a0: GetDot r0, 3
  0x27a8: Free3 r1, r3, r0
  0x27b0: Ret r0  ; tree_base.sci:135

; === function 35 (gameplay.sci, line 419) locals=4 ===
func_35:
  0x27bc: GetDotStr r1, "!vector"  ; pool_off=0x5f1  ; gameplay.sci:402
  0x27c4: GetDot r0, 0
  0x27cc: Free1 r1
  0x27d0: ToStr r0
  0x27d4: Copy r0, r3  ; gameplay.sci:405
  0x27dc: SetDotRaw r2, 653
  0x27e4: Free1 r3
  0x27e8: LoadInt r3, 0
  0x27f0: GetDot r1, 1
  0x27f8: Free2 r2, r1
  0x2800: Copy r-4, r1  ; gameplay.sci:408
  0x2808: LoadFloat r2, 259200.015625
  0x2810: CmpGe r1
  0x2814: BrZ r1, 0x2848
  0x281c: Copy r0, r3  ; gameplay.sci:408
  0x2824: SetDotRaw r2, 653
  0x282c: Free1 r3
  0x2830: LoadInt r3, 2
  0x2838: GetDot r1, 1
  0x2840: Free2 r2, r1
  0x2848: Copy r-4, r1  ; gameplay.sci:411
  0x2850: LoadFloat r2, 345600.0
  0x2858: CmpGe r1
  0x285c: BrZ r1, 0x2890
  0x2864: Copy r0, r3  ; gameplay.sci:411
  0x286c: SetDotRaw r2, 653
  0x2874: Free1 r3
  0x2878: LoadInt r3, 1
  0x2880: GetDot r1, 1
  0x2888: Free2 r2, r1
  0x2890: Copy r-4, r1  ; gameplay.sci:414
  0x2898: LoadFloat r2, 604800.0
  0x28a0: CmpGe r1
  0x28a4: BrZ r1, 0x28d8
  0x28ac: Copy r0, r3  ; gameplay.sci:414
  0x28b4: SetDotRaw r2, 653
  0x28bc: Free1 r3
  0x28c0: LoadInt r3, 3
  0x28c8: GetDot r1, 1
  0x28d0: Free2 r2, r1
  0x28d8: Copy r0, r1  ; gameplay.sci:418
  0x28e0: Copy r1, r4294967291
  0x28e8: Free2 r1, r0
  0x28f0: Ret r0

; === function 36 (getUseDistance, tree_base.sci, line 13) locals=1 ===
func_36:
  0x28fc: LoadInt r0, 3  ; tree_base.sci:12
  0x2904: ToFloat r0
  0x2908: Copy r0, r4294967292
  0x2910: Ret r0

; === function 37 (getMaxLimfaAmount, tree_base.sci, line 69) locals=9 ===
func_37:
  0x291c: GetDotStr r0, "Name"  ; pool_off=0x19  ; tree_base.sci:66
  0x2924: ToStr r0
  0x2928: GetDotStr r5, "Scene"  ; pool_off=0x1e  ; tree_base.sci:67
  0x2930: SetDotRaw r4, 36
  0x2938: Free1 r5
  0x293c: LoadString r5, "getLocationProperties"  ; len=21, pool_off=0x29
  0x2948: GetDot r3, 1
  0x2950: Free2 r4, r5
  0x2958: SetDotRaw r2, 83
  0x2960: Free1 r3
  0x2964: Copy r0, r3
  0x296c: SetDot r1, 1
  0x2974: Free1 r3
  0x2978: ToStr r1
  0x297c: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:68
  0x2984: SetDotRaw r6, 172
  0x298c: Free1 r7
  0x2990: SetDotRaw r5, 183
  0x2998: Free1 r6
  0x299c: LoadString r6, "Tree/"  ; len=5, pool_off=0xd1
  0x29a8: Copy r1, r8
  0x29b0: SetDotRaw r7, 219
  0x29b8: Free1 r8
  0x29bc: Add r6
  0x29c0: GetDot r4, 1
  0x29c8: Free2 r5, r6
  0x29d0: SetDotRaw r3, 1386
  0x29d8: Free1 r4
  0x29dc: SetDotRaw r2, 237
  0x29e4: Free1 r3
  0x29e8: LoadInt r3, 1000
  0x29f0: Mul r2
  0x29f4: ToInt r2
  0x29f8: Copy r2, r4294967292
  0x2a00: Free2 r1, r0
  0x2a08: Ret r0
