...
; bytecode=10964 bytes
; inline_strings=6, patches=280
...
;   bc=0x15e8 str=4("tree_foggyroots_bent.sc") val=16
;   bc=0x15f0 str=4("tree_foggyroots_bent.sc") val=11
;   bc=0x1600 str=4("tree_foggyroots_bent.sc") val=12
;   bc=0x162c str=4("tree_foggyroots_bent.sc") val=13
;   bc=0x168c str=4("tree_foggyroots_bent.sc") val=14
;   bc=0x169c str=4("tree_foggyroots_bent.sc") val=11
;   bc=0x16a0 str=4("tree_foggyroots_bent.sc") val=16
;   bc=0x16a4 str=4("tree_foggyroots_bent.sc") val=25
;   bc=0x16ac str=4("tree_foggyroots_bent.sc") val=20
;   bc=0x1720 str=4("tree_foggyroots_bent.sc") val=21
;   bc=0x1764 str=4("tree_foggyroots_bent.sc") val=22
;   bc=0x17a8 str=4("tree_foggyroots_bent.sc") val=23
;   bc=0x17ec str=4("tree_foggyroots_bent.sc") val=24
;   bc=0x1830 str=4("tree_foggyroots_bent.sc") val=25
;   bc=0x1838 str=4("tree_foggyroots_bent.sc") val=33
;   bc=0x1840 str=4("tree_foggyroots_bent.sc") val=29
;   bc=0x1850 str=4("tree_foggyroots_bent.sc") val=30
;   bc=0x187c str=4("tree_foggyroots_bent.sc") val=29
;   bc=0x1880 str=4("tree_foggyroots_bent.sc") val=33
;   bc=0x1884 str=4("tree_foggyroots_bent.sc") val=40
;   bc=0x188c str=4("tree_foggyroots_bent.sc") val=37
;   bc=0x18f4 str=4("tree_foggyroots_bent.sc") val=38
;   bc=0x1910 str=4("tree_foggyroots_bent.sc") val=40
;   bc=0x1918 str=5("gameplay.sci") val=500
;   bc=0x1920 str=5("gameplay.sci") val=495
;   bc=0x1978 str=5("gameplay.sci") val=496
;   bc=0x19d0 str=5("gameplay.sci") val=497
;   bc=0x19e0 str=5("gameplay.sci") val=498
;   bc=0x1a04 str=5("gameplay.sci") val=499
;   bc=0x1a28 str=5("gameplay.sci") val=555
;   bc=0x1a30 str=5("gameplay.sci") val=545
;   bc=0x1a64 str=5("gameplay.sci") val=546
;   bc=0x1a7c str=5("gameplay.sci") val=548
;   bc=0x1a84 str=5("gameplay.sci") val=549
;   bc=0x1a8c str=5("gameplay.sci") val=549
;   bc=0x1aa8 str=5("gameplay.sci") val=550
;   bc=0x1aec str=5("gameplay.sci") val=551
;   bc=0x1b00 str=5("gameplay.sci") val=549
;   bc=0x1b1c str=5("gameplay.sci") val=554
;   bc=0x1b38 str=3("std.sci") val=74
;   bc=0x1b40 str=3("std.sci") val=73
;   bc=0x1b80 str=4("tree_foggyroots_bent.sc") val=49
;   bc=0x1b88 str=4("tree_foggyroots_bent.sc") val=44
;   bc=0x1b98 str=4("tree_foggyroots_bent.sc") val=45
;   bc=0x1bc4 str=4("tree_foggyroots_bent.sc") val=47
;   bc=0x1bd4 str=4("tree_foggyroots_bent.sc") val=48
;   bc=0x1c00 str=4("tree_foggyroots_bent.sc") val=49
;   bc=0x1c04 str=3("std.sci") val=176
;   bc=0x1c0c str=3("std.sci") val=170
;   bc=0x1c40 str=3("std.sci") val=171
;   bc=0x1c88 str=3("std.sci") val=170
;   bc=0x1c90 str=3("std.sci") val=174
;   bc=0x1cb4 str=3("std.sci") val=176
;   bc=0x1cc0 str=1("tree_base.sci") val=182
;   bc=0x1cc8 str=1("tree_base.sci") val=139
;   bc=0x1cdc str=1("tree_base.sci") val=141
;   bc=0x1d1c str=1("tree_base.sci") val=142
;   bc=0x1d50 str=1("tree_base.sci") val=144
;   bc=0x1d5c str=1("tree_base.sci") val=146
;   bc=0x1dd4 str=1("tree_base.sci") val=147
;   bc=0x1e34 str=1("tree_base.sci") val=148
;   bc=0x1e50 str=1("tree_base.sci") val=150
;   bc=0x1e80 str=1("tree_base.sci") val=153
;   bc=0x1e90 str=1("tree_base.sci") val=154
;   bc=0x1eb0 str=1("tree_base.sci") val=155
;   bc=0x1ec0 str=1("tree_base.sci") val=156
;   bc=0x1f14 str=1("tree_base.sci") val=157
;   bc=0x1f34 str=1("tree_base.sci") val=158
;   bc=0x1f54 str=1("tree_base.sci") val=159
;   bc=0x1f80 str=1("tree_base.sci") val=161
;   bc=0x1ff0 str=1("tree_base.sci") val=163
;   bc=0x2024 str=1("tree_base.sci") val=164
;   bc=0x2040 str=1("tree_base.sci") val=165
;   bc=0x2048 str=1("tree_base.sci") val=166
;   bc=0x2064 str=1("tree_base.sci") val=167
;   bc=0x206c str=1("tree_base.sci") val=166
;   bc=0x2074 str=1("tree_base.sci") val=169
;   bc=0x207c str=1("tree_base.sci") val=171
;   bc=0x20bc str=1("tree_base.sci") val=173
;   bc=0x20f0 str=1("tree_base.sci") val=174
;   bc=0x2170 str=1("tree_base.sci") val=175
;   bc=0x21f0 str=1("tree_base.sci") val=177
;   bc=0x21fc str=1("tree_base.sci") val=181
;   bc=0x2218 str=5("gameplay.sci") val=609
;   bc=0x2220 str=5("gameplay.sci") val=606
;   bc=0x2254 str=5("gameplay.sci") val=607
;   bc=0x22e8 str=5("gameplay.sci") val=608
;   bc=0x2304 str=1("tree_base.sci") val=53
;   bc=0x230c str=1("tree_base.sci") val=51
;   bc=0x232c str=1("tree_base.sci") val=52
;   bc=0x2370 str=1("tree_base.sci") val=53
;   bc=0x2374 str=1("tree_base.sci") val=47
;   bc=0x237c str=1("tree_base.sci") val=45
;   bc=0x239c str=1("tree_base.sci") val=46
;   bc=0x23e0 str=1("tree_base.sci") val=47
;   bc=0x23e4 str=1("tree_base.sci") val=41
;   bc=0x23ec str=1("tree_base.sci") val=39
;   bc=0x240c str=1("tree_base.sci") val=40
;   bc=0x2450 str=1("tree_base.sci") val=41
;   bc=0x2454 str=1("tree_base.sci") val=228
;   bc=0x245c str=1("tree_base.sci") val=203
;   bc=0x2490 str=1("tree_base.sci") val=204
;   bc=0x2524 str=1("tree_base.sci") val=205
;   bc=0x2558 str=1("tree_base.sci") val=207
;   bc=0x256c str=1("tree_base.sci") val=209
;   bc=0x2574 str=1("tree_base.sci") val=211
;   bc=0x2580 str=1("tree_base.sci") val=213
;   bc=0x258c str=1("tree_base.sci") val=214
;   bc=0x25d0 str=1("tree_base.sci") val=215
;   bc=0x2604 str=1("tree_base.sci") val=212
;   bc=0x2614 str=1("tree_base.sci") val=218
;   bc=0x2620 str=1("tree_base.sci") val=219
;   bc=0x263c str=1("tree_base.sci") val=220
;   bc=0x2648 str=1("tree_base.sci") val=221
;   bc=0x2678 str=1("tree_base.sci") val=222
;   bc=0x26a4 str=1("tree_base.sci") val=223
;   bc=0x26b4 str=1("tree_base.sci") val=224
;   bc=0x2754 str=1("tree_base.sci") val=219
;   bc=0x275c str=1("tree_base.sci") val=227
;   bc=0x2770 str=4("tree_foggyroots_bent.sc") val=7
;   bc=0x2778 str=4("tree_foggyroots_bent.sc") val=6
;   bc=0x2790 str=3("std.sci") val=104
;   bc=0x2798 str=3("std.sci") val=103
;   bc=0x27b8 str=1("tree_base.sci") val=188
;   bc=0x27c0 str=1("tree_base.sci") val=186
;   bc=0x27d4 str=1("tree_base.sci") val=187
;   bc=0x2818 str=1("tree_base.sci") val=188
;   bc=0x2820 str=1("tree_base.sci") val=193
;   bc=0x2828 str=1("tree_base.sci") val=192
;   bc=0x283c str=1("tree_base.sci") val=135
;   bc=0x2844 str=1("tree_base.sci") val=134
;   bc=0x2878 str=1("tree_base.sci") val=135
;   bc=0x287c str=5("gameplay.sci") val=419
;   bc=0x2884 str=5("gameplay.sci") val=402
;   bc=0x289c str=5("gameplay.sci") val=405
;   bc=0x28c8 str=5("gameplay.sci") val=408
;   bc=0x28e4 str=5("gameplay.sci") val=408
;   bc=0x2910 str=5("gameplay.sci") val=411
;   bc=0x292c str=5("gameplay.sci") val=411
;   bc=0x2958 str=5("gameplay.sci") val=414
;   bc=0x2974 str=5("gameplay.sci") val=414
;   bc=0x29a0 str=5("gameplay.sci") val=418
;   bc=0x29bc str=1("tree_base.sci") val=13
;   bc=0x29c4 str=1("tree_base.sci") val=12
;   bc=0x29dc str=1("tree_base.sci") val=69
;   bc=0x29e4 str=1("tree_base.sci") val=66
;   bc=0x29f0 str=1("tree_base.sci") val=67
;   bc=0x2a44 str=1("tree_base.sci") val=68
; func_names:
;   0=getAllowedTypes
;   5=onStopUsing
;   10=isUsable
...
;   + 64: 6c 6c 6f 77 65 64 54 79 70 65 73 ff ff ff ff 7c
;   + 80: 28 00 00 01 00 00 00 00 0e 00 00 00 67 65 74 55
;   + 96: 73 65 44 69 73 74 61 6e 63 65 ff ff ff ff bc 29
;   +112: 00 00 00 00 00 00 11 00 00 00 67 65 74 4d 61 78
;   +128: 4c 69 6d 66 61 41 6d 6f 75 6e 74 ff ff ff ff dc
;   +144: 29 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
;   +160: 00 00 00 01 00 00 00 01 00 00 00 03 00 00 00 01
;   +176: 00 00 00 0f 00 00 00 67 65 74 41 6c 6c 6f 77 65
;   +192: 64 54 79 70 65 73 ff ff ff ff 7c 28 00 00 01 00
;   +208: 00 00 00 0e 00 00 00 67 65 74 55 73 65 44 69 73
;   +224: 74 61 6e 63 65 ff ff ff ff bc 29 00 00 00 00 00
;   +240: 00 11 00 00 00 67 65 74 4d 61 78 4c 69 6d 66 61
;   +256: 41 6d 6f 75 6e 74 ff ff ff ff dc 29 00 00 00 00
...
;   +400: 64 54 79 70 65 73 ff ff ff ff 7c 28 00 00 01 00
;   +416: 00 00 00 0e 00 00 00 67 65 74 55 73 65 44 69 73
;   +432: 74 61 6e 63 65 ff ff ff ff bc 29 00 00 00 00 00
;   +448: 00 11 00 00 00 67 65 74 4d 61 78 4c 69 6d 66 61
;   +464: 41 6d 6f 75 6e 74 ff ff ff ff dc 29 00 00 00 00
;   +480: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00
;   +496: 00 00 03 00 00 00 06 00 00 00 03 00 00 00 09 00
;   +512: 00 00 6f 6e 47 65 73 74 75 72 65 ff ff ff ff c0
;   +528: 1c 00 00 01 01 01 03 00 00 00 05 00 00 00 6f 6e
;   +544: 55 73 65 ff ff ff ff b8 27 00 00 03 01 01 00 00
;   +560: 00 00 0b 00 00 00 69 73 50 61 69 6e 74 61 62 6c
;   +576: 65 ff ff ff ff 20 28 00 00 01 00 00 00 0f 00 00
;   +592: 00 67 65 74 41 6c 6c 6f 77 65 64 54 79 70 65 73
;   +608: ff ff ff ff 7c 28 00 00 01 00 00 00 00 0e 00 00
;   +624: 00 67 65 74 55 73 65 44 69 73 74 61 6e 63 65 ff
;   +640: ff ff ff bc 29 00 00 00 00 00 00 11 00 00 00 67
;   +656: 65 74 4d 61 78 4c 69 6d 66 61 41 6d 6f 75 6e 74
;   +672: ff ff ff ff dc 29 00 00 00 00 00 00 00 00 00 00
;   +688: 00 00 00 00 00 00 00 00 01 00 00 00 04 00 00 00
;   +704: 03 00 00 00 01 00 00 00 0f 00 00 00 67 65 74 41
;   +720: 6c 6c 6f 77 65 64 54 79 70 65 73 ff ff ff ff 7c
;   +736: 28 00 00 01 00 00 00 00 0e 00 00 00 67 65 74 55
;   +752: 73 65 44 69 73 74 61 6e 63 65 ff ff ff ff bc 29
;   +768: 00 00 00 00 00 00 11 00 00 00 67 65 74 4d 61 78
;   +784: 4c 69 6d 66 61 41 6d 6f 75 6e 74 ff ff ff ff dc
;   +800: 29 00 00
...
func_1:
  ...
  0x03a8: CallNat r3, func=10300, info=0x200  ; tree_base.sci:113
...
func_13:
  ...
  0x14e0: Call r8, 0x1884  ; tree_base.sci:300
...
; === function 15 (tree_foggyroots_bent.sc, line 16) locals=7 ===
func_15:
  0x15f0: CopyGlobWr r9, g0  ; tree_foggyroots_bent.sc:11
  0x15f8: BrNZ r0, 0x16a0
  0x1600: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_foggyroots_bent.sc:12
  0x1608: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1610: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1618: GetDot r0, 2
  0x1620: Free3 r1, r2, r3
  0x1628: ToStr r0
  0x162c: GetDotStr r3, "World"  ; pool_off=0xa6  ; tree_foggyroots_bent.sc:13
  0x1634: SetDotRaw r2, 936
  0x163c: Free1 r3
  0x1640: GetDotStr r3, "Scene"  ; pool_off=0x1e
  0x1648: LoadString r4, "ps_FoggyRootTreeBentFruit.ps"  ; len=28, pool_off=0x3bd
  0x1654: Copy r0, r5
  ...
  0x1688: Free1 r1
  0x168c: Copy r-4, r1  ; tree_foggyroots_bent.sc:14
  0x1694: Call r2, 0x16a4
  0x169c: Free1 r0  ; tree_foggyroots_bent.sc:11
  0x16a0: Ret r0  ; tree_foggyroots_bent.sc:16

; === function 16 (tree_foggyroots_bent.sc, line 25) locals=7 ===
func_16:
  0x16ac: Copy r-4, r0  ; tree_foggyroots_bent.sc:20
  ...
  0x1718: Mul r0
  0x171c: ToStr r0
  0x1720: CopyGlobWr r9, g3  ; tree_foggyroots_bent.sc:21
  0x1728: SetDotRaw r2, 1013
  0x1730: Free1 r3
  0x1734: LoadInt r3, 0
  0x173c: LoadString r4, "PSColor"  ; len=7, pool_off=0x40b
  0x1748: Copy r0, r5
  0x1750: GetDot r1, 3
  0x1758: Free4 r2, r4, r5, r1
  0x1764: CopyGlobWr r9, g3  ; tree_foggyroots_bent.sc:22
  0x176c: SetDotRaw r2, 1013
  0x1774: Free1 r3
  0x1778: LoadInt r3, 1
  0x1780: LoadString r4, "PSColor"  ; len=7, pool_off=0x40b
  0x178c: Copy r0, r5
  0x1794: GetDot r1, 3
  0x179c: Free4 r2, r4, r5, r1
  0x17a8: CopyGlobWr r9, g3  ; tree_foggyroots_bent.sc:23
  0x17b0: SetDotRaw r2, 1013
  0x17b8: Free1 r3
  0x17bc: LoadInt r3, 2
  0x17c4: LoadString r4, "PSColor"  ; len=7, pool_off=0x40b
  0x17d0: Copy r0, r5
  0x17d8: GetDot r1, 3
  0x17e0: Free4 r2, r4, r5, r1
  0x17ec: CopyGlobWr r9, g3  ; tree_foggyroots_bent.sc:24
  0x17f4: SetDotRaw r2, 1013
  0x17fc: Free1 r3
  0x1800: LoadInt r3, 3
  0x1808: LoadString r4, "PSColor"  ; len=7, pool_off=0x40b
  0x1814: Copy r0, r5
  0x181c: GetDot r1, 3
  0x1824: Free4 r2, r4, r5, r1
  0x1830: Free1 r0  ; tree_foggyroots_bent.sc:25
  0x1834: Ret r0

; === function 17 (tree_foggyroots_bent.sc, line 33) locals=4 ===
func_17:
  0x1840: CopyGlobWr r10, g0  ; tree_foggyroots_bent.sc:29
  0x1848: BrNZ r0, 0x1880
  0x1850: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_foggyroots_bent.sc:30
  0x1858: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1860: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1868: GetDot r0, 2
  0x1870: Free3 r1, r2, r3
  0x1878: ToStr r0
  0x187c: Free1 r0  ; tree_foggyroots_bent.sc:29
  0x1880: Ret r0  ; tree_foggyroots_bent.sc:33

; === function 18 (tree_foggyroots_bent.sc, line 40) locals=6 ===
func_18:
  0x188c: GetDotStr r5, "World"  ; pool_off=0xa6  ; tree_foggyroots_bent.sc:37
  0x1894: SetDotRaw r4, 172
  0x189c: Free1 r5
  0x18a0: SetDotRaw r3, 183
  0x18a8: Free1 r4
  0x18ac: LoadString r4, "Limfa"  ; len=5, pool_off=0x67
  0x18b8: CopyGlobWr r6, g5
  0x18c0: AsString r5
  0x18c4: Add r4
  0x18c8: GetDot r2, 1
  0x18d0: Free2 r3, r4
  0x18d8: SetDotRaw r1, 150
  0x18e0: Free1 r2
  0x18e4: SetDotRaw r0, 187
  0x18ec: Free1 r1
  0x18f0: ToStr r0
  0x18f4: CopyGlobWr r7, g1  ; tree_foggyroots_bent.sc:38
  0x18fc: ToFloat r1
  0x1900: CopyGlobWr r11, g2
  0x1908: ToFloat r2
  0x190c: Div r1
  0x1910: Free1 r0  ; tree_foggyroots_bent.sc:40
  0x1914: Ret r0

; === function 19 (gameplay.sci, line 500) locals=7 ===
func_19:
  0x1920: Copy r-4, r5  ; gameplay.sci:495
  0x1928: SetDotRaw r4, 172
  0x1930: Free1 r5
  0x1934: SetDotRaw r3, 183
  0x193c: Free1 r4
  0x1940: LoadString r4, "Gameplay"  ; len=8, pool_off=0x419
  0x194c: GetDot r2, 1
  0x1954: Free2 r3, r4
  0x195c: SetDotRaw r1, 1065
  0x1964: Free1 r2
  0x1968: SetDotRaw r0, 678
  0x1970: Free1 r1
  0x1974: ToFloat r0
  0x1978: Copy r-4, r6  ; gameplay.sci:496
  0x1980: SetDotRaw r5, 172
  0x1988: Free1 r6
  0x198c: SetDotRaw r4, 183
  0x1994: Free1 r5
  0x1998: LoadString r5, "Gameplay"  ; len=8, pool_off=0x419
  0x19a4: GetDot r3, 1
  0x19ac: Free2 r4, r5
  0x19b4: SetDotRaw r2, 1089
  0x19bc: Free1 r3
  0x19c0: SetDotRaw r1, 678
  0x19c8: Free1 r2
  0x19cc: ToFloat r1
  0x19d0: Copy r-4, r3  ; gameplay.sci:497
  0x19d8: Call r4, 0x1a28
  0x19e0: Copy r0, r3  ; gameplay.sci:498
  0x19e8: Copy r1, r4
  0x19f0: Copy r2, r5
  0x19f8: Mul r4
  0x19fc: Add r3
  0x1a00: ToInt r3
  0x1a04: Copy r3, r4  ; gameplay.sci:499
  0x1a0c: LoadInt r5, 1000
  0x1a14: Mul r4
  0x1a18: Copy r4, r4294967291
  0x1a20: Free1 r-4
  0x1a24: Ret r0

; === function 20 (gameplay.sci, line 555) locals=8 ===
func_20:
  0x1a30: Copy r-4, r2  ; gameplay.sci:545
  0x1a38: SetDotRaw r1, 36
  0x1a40: Free1 r2
  0x1a44: LoadString r2, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x1a50: GetDot r0, 1
  0x1a58: Free2 r1, r2
  0x1a60: ToStr r0
  0x1a64: Copy r0, r2  ; gameplay.sci:546
  0x1a6c: SetDotRaw r1, 172
  0x1a74: Free1 r2
  0x1a78: ToStr r1
  0x1a7c: LoadInt r2, 0  ; gameplay.sci:548
  0x1a84: LoadInt r3, 0  ; gameplay.sci:549
  0x1a8c: Copy r3, r4  ; gameplay.sci:549
  0x1a94: LoadInt r5, 21
  0x1a9c: CmpLt r4
  0x1aa0: BrZ r4, 0x1b1c
  0x1aa8: Copy r1, r7  ; gameplay.sci:550
  0x1ab0: SetDotRaw r6, 1117
  0x1ab8: Free1 r7
  0x1abc: Copy r3, r7
  0x1ac4: AsString r7
  0x1ac8: SetDot r5, 1
  ...
  0x1ad4: LoadInt r6, 3
  0x1adc: SetDot r4, 1
  0x1ae4: BrZ r4, 0x1b00
  0x1aec: Copy r2, r4  ; gameplay.sci:551
  0x1af4: Incr r4
  0x1af8: Copy r4, r2
  0x1b00: Copy r3, r4  ; gameplay.sci:549
  0x1b08: Incr r4
  0x1b0c: Copy r4, r3
  0x1b14: Jmp r0, 0x1a8c
  0x1b1c: Copy r2, r3  ; gameplay.sci:554
  0x1b24: Copy r3, r4294967291
  0x1b2c: Free3 r1, r0, r-4
  0x1b34: Ret r0

; === function 21 (std.sci, line 74) locals=2 ===
func_21:
  0x1b40: Copy r-5, r0  ; std.sci:73
  0x1b48: Copy r-4, r1
  0x1b50: CmpLt r0
  0x1b54: BrNZ r0, 0x1b6c
  0x1b5c: Copy r-4, r0
  0x1b64: Jmp r0, 0x1b74
  0x1b6c: Copy r-5, r0
  0x1b74: Copy r0, r4294967290
  0x1b7c: Ret r0

; === function 22 (tree_foggyroots_bent.sc, line 49) locals=3 ===
func_22:
  0x1b88: CopyGlobWr r10, g0  ; tree_foggyroots_bent.sc:44
  0x1b90: BrZ r0, 0x1bc4
  0x1b98: CopyGlobWr r10, g2  ; tree_foggyroots_bent.sc:45
  0x1ba0: SetDotRaw r1, 784
  0x1ba8: Free1 r2
  0x1bac: Copy r-4, r2
  0x1bb4: GetDot r0, 1
  0x1bbc: Free2 r1, r0
  0x1bc4: CopyGlobWr r9, g0  ; tree_foggyroots_bent.sc:47
  0x1bcc: BrZ r0, 0x1c00
  0x1bd4: CopyGlobWr r9, g2  ; tree_foggyroots_bent.sc:48
  0x1bdc: SetDotRaw r1, 784
  0x1be4: Free1 r2
  0x1be8: Copy r-4, r2
  0x1bf0: GetDot r0, 1
  0x1bf8: Free2 r1, r0
  0x1c00: Ret r0  ; tree_foggyroots_bent.sc:49

; === function 23 (std.sci, line 176) locals=3 ===
func_23:
  0x1c0c: Copy r-6, r2  ; std.sci:170
  0x1c14: SetDotRaw r1, 91
  0x1c1c: Free1 r2
  0x1c20: Copy r-5, r2
  0x1c28: GetDot r0, 1
  0x1c30: Free2 r1, r2
  0x1c38: BrZ r0, 0x1c90
  0x1c40: Copy r-6, r1  ; std.sci:171
  0x1c48: Copy r-5, r2
  0x1c50: SetDot r0, 1
  0x1c58: Free1 r2
  0x1c5c: Copy r-4, r1
  ...
  0x1c68: Copy r-6, r1
  0x1c70: Copy r-5, r2
  0x1c78: GetDotRaw r1, 1
  0x1c80: Free2 r2, r0
  0x1c88: Jmp r0, 0x1cb4  ; std.sci:170
  0x1c90: Copy r-4, r0  ; std.sci:174
  0x1c98: Copy r-6, r1
  0x1ca0: Copy r-5, r2
  0x1ca8: GetDotRaw r1, 1
  0x1cb0: Free1 r2
  0x1cb4: Free2 r-5, r-6  ; std.sci:176
  0x1cbc: Ret r0

; === function 24 (onUse, tree_base.sci, line 182) locals=10 ===
func_24:
  0x1cc8: GetDotStr r1, "World"  ; pool_off=0xa6  ; tree_base.sci:139
  0x1cd0: ToStr r1
  0x1cd4: Call r2, 0x2218
  0x1cdc: GetDotStr r2, "logInfo"  ; pool_off=0x2ee  ; tree_base.sci:141
  0x1ce4: LoadString r3, "Inserted into tree limfa amount: "  ; len=33, pool_off=0x467
  0x1cf0: Copy r-4, r4
  0x1cf8: Copy r0, r5
  0x1d00: Mul r4
  0x1d04: AsString r4
  ...
  0x1d1c: GetDotStr r2, "logInfo"  ; pool_off=0x2ee  ; tree_base.sci:142
  0x1d24: LoadString r3, "Actuall used limfa amount (due to inspiration): "  ; len=48, pool_off=0x4a9
  0x1d30: Copy r-4, r4
  0x1d38: AsString r4
  0x1d3c: Add r3
  0x1d40: GetDot r1, 1
  0x1d48: Free3 r2, r3, r1
  0x1d50: LoadInt r1, 1  ; tree_base.sci:144
  0x1d58: ToFloat r1
  0x1d5c: LoadBool r2, true  ; tree_base.sci:146
  0x1d64: Copy r-6, r3
  0x1d6c: LoadInt r4, -1
  0x1d74: CmpEq r3
  0x1d78: BrNZ r3, 0x1dcc
  0x1d80: GetDotStr r4, "getGestureName"  ; pool_off=0x509
  0x1d88: LoadString r5, "player"  ; len=6, pool_off=0x518
  0x1d94: Copy r-6, r6
  0x1d9c: GetDot r3, 2
  0x1da4: Free2 r4, r5
  0x1dac: LoadString r4, "gesture_donor"  ; len=13, pool_off=0x524
  0x1db8: CmpNe r3
  0x1dbc: BrNZ r3, 0x1dcc
  0x1dc4: LoadBool r2, false
  0x1dcc: BrZ r2, 0x1e80
  0x1dd4: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:147
  0x1ddc: SetDotRaw r6, 172
  0x1de4: Free1 r7
  0x1de8: SetDotRaw r5, 183
  0x1df0: Free1 r6
  0x1df4: LoadString r6, "Gameplay"  ; len=8, pool_off=0x419
  0x1e00: GetDot r4, 1
  0x1e08: Free2 r5, r6
  0x1e10: SetDotRaw r3, 1342
  0x1e18: Free1 r4
  0x1e1c: SetDotRaw r2, 678
  0x1e24: Free1 r3
  0x1e28: ToFloat r2
  0x1e2c: Copy r2, r1
  0x1e34: Copy r0, r2  ; tree_base.sci:148
  0x1e3c: Copy r1, r3
  0x1e44: Mul r2
  0x1e48: Copy r2, r0
  0x1e50: GetDotStr r4, "Scene"  ; pool_off=0x1e  ; tree_base.sci:150
  0x1e58: SetDotRaw r3, 36
  0x1e60: Free1 r4
  0x1e64: LoadString r4, "showDonorHelp"  ; len=13, pool_off=0x554
  0x1e70: GetDot r2, 1
  0x1e78: Free3 r3, r4, r2
  0x1e80: Copy r-5, r2  ; tree_base.sci:153
  0x1e88: CopyGlobRd r2, g6
  0x1e90: Copy r-4, r2  ; tree_base.sci:154
  0x1e98: Copy r0, r3
  0x1ea0: Mul r2
  0x1ea4: ToInt r2
  0x1ea8: CopyGlobRd r2, g8
  0x1eb0: LoadInt r2, 0  ; tree_base.sci:155
  0x1eb8: CopyGlobRd r2, g7
  0x1ec0: GetDotStr r6, "Scene"  ; pool_off=0x1e  ; tree_base.sci:156
  0x1ec8: SetDotRaw r5, 36
  0x1ed0: Free1 r6
  0x1ed4: LoadString r6, "getLocationProperties"  ; len=21, pool_off=0x29
  0x1ee0: GetDot r4, 1
  0x1ee8: Free2 r5, r6
  0x1ef0: SetDotRaw r3, 83
  0x1ef8: Free1 r4
  0x1efc: GetDotStr r4, "Name"  ; pool_off=0x19
  0x1f04: SetDot r2, 1
  0x1f0c: Free1 r4
  0x1f10: ToStr r2
  0x1f14: Copy r-5, r3  ; tree_base.sci:157
  0x1f1c: Copy r2, r4
  0x1f24: SetInd r4
  0x1f28: LoadString r0, "潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀..."  ; len=119, pool_off=0x44a, GARBLED
  0x1f34: LoadInt r3, 0  ; tree_base.sci:158
  0x1f3c: Copy r2, r4
  0x1f44: SetInd r4
  0x1f48: LoadString r0, "潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀..."  ; len=113, pool_off=0x44a, GARBLED
  0x1f54: Copy r-4, r3  ; tree_base.sci:159
  0x1f5c: Copy r0, r4
  0x1f64: Mul r3
  0x1f68: Copy r2, r4
  0x1f70: SetInd r4
  0x1f74: LoadString r0, "潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀..."  ; len=195, pool_off=0x44a, GARBLED
  0x1f80: GetDotStr r8, "World"  ; pool_off=0xa6  ; tree_base.sci:161
  0x1f88: SetDotRaw r7, 172
  0x1f90: Free1 r8
  0x1f94: SetDotRaw r6, 183
  0x1f9c: Free1 r7
  0x1fa0: LoadString r7, "Tree/"  ; len=5, pool_off=0xd1
  0x1fac: Copy r2, r9
  0x1fb4: SetDotRaw r8, 219
  0x1fbc: Free1 r9
  0x1fc0: Add r7
  0x1fc4: GetDot r5, 1
  0x1fcc: Free2 r6, r7
  0x1fd4: SetDotRaw r4, 1390
  0x1fdc: Free1 r5
  0x1fe0: SetDotRaw r3, 237
  0x1fe8: Free1 r4
  0x1fec: ToInt r3
  0x1ff0: Copy r-4, r4  ; tree_base.sci:163
  0x1ff8: ToFloat r4
  0x1ffc: Copy r0, r5
  0x2004: Mul r4
  0x2008: Copy r3, r5
  0x2010: ToFloat r5
  0x2014: Div r4
  0x2018: LoadFloat r5, 1000.0
  0x2020: Div r4
  0x2024: Copy r4, r5  ; tree_base.sci:164
  0x202c: LoadFloat r6, 0.33000001311302185
  0x2034: CmpLt r5
  0x2038: BrZ r5, 0x2048
  0x2040: Call r5, 0x2304  ; tree_base.sci:165
  0x2048: Copy r4, r5  ; tree_base.sci:166
  0x2050: LoadFloat r6, 0.6600000262260437
  0x2058: CmpLt r5
  0x205c: BrZ r5, 0x2074
  0x2064: Call r5, 0x2374  ; tree_base.sci:167
  0x206c: Jmp r0, 0x207c  ; tree_base.sci:166
  0x2074: Call r5, 0x23e4  ; tree_base.sci:169
  0x207c: GetDotStr r7, "Scene"  ; pool_off=0x1e  ; tree_base.sci:171
  0x2084: SetDotRaw r6, 36
  0x208c: Free1 r7
  0x2090: LoadString r7, "tabooViolation"  ; len=14, pool_off=0x57f
  0x209c: Copy r-5, r8
  0x20a4: Copy r-4, r9
  0x20ac: GetDot r5, 3
  0x20b4: Free3 r6, r7, r5
  0x20bc: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:173
  0x20c4: SetDotRaw r6, 36
  0x20cc: Free1 r7
  0x20d0: LoadString r7, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x20dc: GetDot r5, 1
  0x20e4: Free2 r6, r7
  0x20ec: ToStr r5
  0x20f0: Copy r5, r9  ; tree_base.sci:174
  0x20f8: SetDotRaw r8, 172
  0x2100: Free1 r9
  0x2104: SetDotRaw r7, 1435
  0x210c: Free1 r8
  0x2110: Copy r-5, r8
  0x2118: AsString r8
  0x211c: SetDot r6, 1
  ...
  0x2144: Free1 r9
  0x2148: SetDotRaw r7, 1435
  0x2150: Free1 r8
  0x2154: Copy r-5, r8
  0x215c: AsString r8
  0x2160: GetDotRaw r7, 1537
  0x2168: Free2 r8, r6
  0x2170: Copy r5, r9  ; tree_base.sci:175
  0x2178: SetDotRaw r8, 172
  0x2180: Free1 r9
  0x2184: SetDotRaw r7, 1447
  0x218c: Free1 r8
  0x2190: Copy r-5, r8
  0x2198: AsString r8
  0x219c: SetDot r6, 1
  ...
  0x21c4: Free1 r9
  0x21c8: SetDotRaw r7, 1447
  0x21d0: Free1 r8
  0x21d4: Copy r-5, r8
  0x21dc: AsString r8
  0x21e0: GetDotRaw r7, 1537
  0x21e8: Free2 r8, r6
  0x21f0: CallNat2 r4, func=9300, info=0x600  ; tree_base.sci:177
  0x21fc: Copy r1, r6  ; tree_base.sci:181
  0x2204: Copy r6, r4294967289
  0x220c: Free2 r5, r2
  0x2214: Ret r0

; === function 25 (gameplay.sci, line 609) locals=9 ===
func_25:
  0x2220: Copy r-4, r2  ; gameplay.sci:606
  0x2228: SetDotRaw r1, 36
  0x2230: Free1 r2
  0x2234: LoadString r2, "getPlayerEntity"  ; len=15, pool_off=0x322
  0x2240: GetDot r0, 1
  0x2248: Free2 r1, r2
  0x2250: ToStr r0
  0x2254: LoadFloat r1, 1.0  ; gameplay.sci:607
  0x225c: Copy r0, r4
  0x2264: SetDotRaw r3, 172
  0x226c: Free1 r4
  0x2270: SetDotRaw r2, 1457
  0x2278: Free1 r3
  0x227c: GetDotStr r8, "World"  ; pool_off=0xa6
  0x2284: SetDotRaw r7, 172
  0x228c: Free1 r8
  0x2290: SetDotRaw r6, 183
  0x2298: Free1 r7
  0x229c: LoadString r7, "Gameplay"  ; len=8, pool_off=0x419
  0x22a8: GetDot r5, 1
  0x22b0: Free2 r6, r7
  0x22b8: SetDotRaw r4, 1469
  0x22c0: Free1 r5
  0x22c4: SetDotRaw r3, 678
  0x22cc: Free1 r4
  0x22d0: LoadFloat r4, 1.0
  0x22d8: Sub r3
  0x22dc: Mul r2
  0x22e0: Add r1
  0x22e4: ToFloat r1
  0x22e8: Copy r1, r2  ; gameplay.sci:608
  0x22f0: Copy r2, r4294967291
  0x22f8: Free2 r0, r-4
  0x2300: Ret r0

; === function 26 (tree_base.sci, line 53) locals=6 ===
func_26:
  0x230c: GetDotStr r1, "irandMax"  ; pool_off=0x5d4  ; tree_base.sci:51
  0x2314: LoadInt r2, 3
  0x231c: GetDot r0, 1
  0x2324: Free1 r1
  0x2328: ToInt r0
  0x232c: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:52
  0x2334: ToStr r2
  0x2338: CopyGlobWr r2, g4
  0x2340: Copy r0, r5
  0x2348: SetDot r3, 1
  0x2350: ToStr r3
  0x2354: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x2360: Call r5, 0x0be4
  0x2368: Call r2, 0x0b98
  0x2370: Ret r0  ; tree_base.sci:53

; === function 27 (tree_base.sci, line 47) locals=6 ===
func_27:
  0x237c: GetDotStr r1, "irandMax"  ; pool_off=0x5d4  ; tree_base.sci:45
  0x2384: LoadInt r2, 3
  0x238c: GetDot r0, 1
  0x2394: Free1 r1
  0x2398: ToInt r0
  0x239c: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:46
  0x23a4: ToStr r2
  0x23a8: CopyGlobWr r1, g4
  0x23b0: Copy r0, r5
  0x23b8: SetDot r3, 1
  0x23c0: ToStr r3
  0x23c4: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x23d0: Call r5, 0x0be4
  0x23d8: Call r2, 0x0b98
  0x23e0: Ret r0  ; tree_base.sci:47

; === function 28 (tree_base.sci, line 41) locals=6 ===
func_28:
  0x23ec: GetDotStr r1, "irandMax"  ; pool_off=0x5d4  ; tree_base.sci:39
  0x23f4: LoadInt r2, 3
  0x23fc: GetDot r0, 1
  0x2404: Free1 r1
  0x2408: ToInt r0
  0x240c: GetDotStr r2, "Scene"  ; pool_off=0x1e  ; tree_base.sci:40
  0x2414: ToStr r2
  0x2418: CopyGlobWr r0, g4
  0x2420: Copy r0, r5
  0x2428: SetDot r3, 1
  0x2430: ToStr r3
  0x2434: LoadString r4, "Sound"  ; len=5, pool_off=0x23c
  0x2440: Call r5, 0x0be4
  0x2448: Call r2, 0x0b98
  0x2450: Ret r0  ; tree_base.sci:41

; === function 29 (tree_base.sci, line 228) locals=16 ===
func_29:
  0x245c: GetDotStr r1, "setLocalGeomParameterBool"  ; pool_off=0x1d2  ; tree_base.sci:203
  0x2464: CopyGlobWr r5, g2
  0x246c: LoadString r3, "Enabled"  ; len=7, pool_off=0x1ec
  0x2478: LoadBool r4, true
  0x2480: GetDot r0, 3
  0x2488: Free3 r1, r3, r0
  0x2490: GetDotStr r1, "setLocalGeomParameterColor"  ; pool_off=0x81  ; tree_base.sci:204
  0x2498: CopyGlobWr r5, g2
  0x24a0: LoadString r3, "Color"  ; len=5, pool_off=0x9c
  0x24ac: GetDotStr r9, "World"  ; pool_off=0xa6
  0x24b4: SetDotRaw r8, 172
  0x24bc: Free1 r9
  0x24c0: SetDotRaw r7, 183
  0x24c8: Free1 r8
  0x24cc: LoadString r8, "Limfa"  ; len=5, pool_off=0x67
  0x24d8: CopyGlobWr r6, g9
  0x24e0: AsString r9
  0x24e4: Add r8
  0x24e8: GetDot r6, 1
  0x24f0: Free2 r7, r8
  0x24f8: SetDotRaw r5, 150
  0x2500: Free1 r6
  0x2504: SetDotRaw r4, 187
  0x250c: Free1 r5
  0x2510: GetDot r0, 3
  0x2518: Free4 r1, r3, r4, r0
  0x2524: GetDotStr r1, "setLocalGeomParameterFloat"  ; pool_off=0x1fa  ; tree_base.sci:205
  0x252c: CopyGlobWr r5, g2
  0x2534: LoadString r3, "Threshold"  ; len=9, pool_off=0x215
  0x2540: LoadInt r4, 1
  0x2548: GetDot r0, 3
  0x2550: Free3 r1, r3, r0
  0x2558: LoadInt r0, 1  ; tree_base.sci:207
  0x2560: ToFloat r0
  0x2564: Call r1, 0x15e8
  0x256c: Call r1, 0x2770  ; tree_base.sci:209
  0x2574: LoadInt r1, 1  ; tree_base.sci:211
  0x257c: ToFloat r1
  0x2580: Free1 r3  ; tree_base.sci:213
  0x2584: RetV r2
  0x2588: ToInt r2
  0x258c: Copy r1, r4  ; tree_base.sci:214
  0x2594: Copy r2, r6
  0x259c: Call r7, 0x2790
  0x25a4: Copy r0, r6
  0x25ac: Div r5
  0x25b0: Sub r4
  0x25b4: LoadInt r5, 0
  0x25bc: ToFloat r5
  0x25c0: Call r6, 0x15a0
  0x25c8: Copy r3, r1
  0x25d0: GetDotStr r4, "setLocalGeomParameterFloat"  ; pool_off=0x1fa  ; tree_base.sci:215
  0x25d8: CopyGlobWr r5, g5
  0x25e0: LoadString r6, "Threshold"  ; len=9, pool_off=0x215
  0x25ec: Copy r1, r7
  0x25f4: GetDot r3, 3
  0x25fc: Free3 r4, r6, r3
  0x2604: Copy r1, r2  ; tree_base.sci:212
  0x260c: BrNZ r2, 0x2580
  0x2614: LoadInt r2, 0  ; tree_base.sci:218
  0x261c: ToFloat r2
  0x2620: Copy r2, r3  ; tree_base.sci:219
  0x2628: LoadInt r4, 1
  0x2630: CmpLt r3
  0x2634: BrZ r3, 0x275c
  0x263c: Free1 r4  ; tree_base.sci:220
  0x2640: RetV r3
  0x2644: ToInt r3
  0x2648: Copy r2, r4  ; tree_base.sci:221
  0x2650: Copy r3, r6
  0x2658: Call r7, 0x2790
  0x2660: LoadFloat r6, 60.0
  0x2668: Div r5
  0x266c: Add r4
  0x2670: Copy r4, r2
  0x2678: LoadFloat r4, 0.20000000298023224  ; tree_base.sci:222
  0x2680: LoadFloat r5, 0.800000011920929
  0x2688: LoadInt r6, 1
  0x2690: Copy r2, r7
  0x2698: Sub r6
  0x269c: Mul r5
  0x26a0: Add r4
  0x26a4: Copy r4, r5  ; tree_base.sci:223
  0x26ac: Call r6, 0x16a4
  0x26b4: GetDotStr r6, "setLocalGeomParameterColor"  ; pool_off=0x81  ; tree_base.sci:224
  0x26bc: CopyGlobWr r5, g7
  0x26c4: LoadString r8, "Color"  ; len=5, pool_off=0x9c
  0x26d0: Copy r4, r9
  0x26d8: GetDotStr r15, "World"  ; pool_off=0xa6
  0x26e0: SetDotRaw r14, 172
  0x26e8: Free1 r15
  0x26ec: SetDotRaw r13, 183
  0x26f4: Free1 r14
  0x26f8: LoadString r14, "Limfa"  ; len=5, pool_off=0x67
  0x2704: CopyGlobWr r6, g15
  0x270c: AsString r15
  0x2710: Add r14
  0x2714: GetDot r12, 1
  0x271c: Free2 r13, r14
  0x2724: SetDotRaw r11, 150
  0x272c: Free1 r12
  0x2730: SetDotRaw r10, 187
  0x2738: Free1 r11
  0x273c: Mul r9
  0x2740: GetDot r5, 3
  0x2748: Free4 r6, r8, r9, r5
  0x2754: Jmp r0, 0x2620  ; tree_base.sci:219
  0x275c: LoadBool r3, true  ; tree_base.sci:227
  0x2764: CallNat r2, func=3616, info=0x301

; === function 30 (tree_foggyroots_bent.sc, line 7) locals=1 ===
func_30:
  0x2778: LoadInt r0, 3  ; tree_foggyroots_bent.sc:6
  0x2780: ToFloat r0
...
func_31:
  0x2798: Copy r-4, r0  ; std.sci:103
  0x27a0: LoadFloat r1, 1000000.0
  0x27a8: Div r0
  0x27ac: Copy r0, r4294967291
  0x27b4: Ret r0

; === function 32 (tree_base.sci, line 188) locals=6 ===
func_32:
  0x27c0: GetDotStr r1, "World"  ; pool_off=0xa6  ; tree_base.sci:186
  0x27c8: ToStr r1
  0x27cc: Call r2, 0x2218
  0x27d4: GetDotStr r3, "Scene"  ; pool_off=0x1e  ; tree_base.sci:187
  0x27dc: SetDotRaw r2, 36
  0x27e4: Free1 r3
  0x27e8: LoadString r3, "activateTree"  ; len=12, pool_off=0x5dd
  0x27f4: GetDotStr r4, "self"  ; pool_off=0x237
  0x27fc: Copy r0, r5
  0x2804: GetDot r1, 3
  0x280c: Free4 r2, r3, r4, r1
  0x2818: Free1 r-6  ; tree_base.sci:188
  0x281c: Ret r0

; === function 33 (isPaintable, tree_base.sci, line 193) locals=1 ===
func_33:
  0x2828: LoadBool r0, true  ; tree_base.sci:192
  0x2830: Copy r0, r4294967292
  0x2838: Ret r0

; === function 34 (getAllowedTypes, tree_base.sci, line 135) locals=5 ===
func_34:
  0x2844: GetDotStr r1, "setLocalGeomParameterBool"  ; pool_off=0x1d2  ; tree_base.sci:134
  0x284c: CopyGlobWr r5, g2
  0x2854: LoadString r3, "Enabled"  ; len=7, pool_off=0x1ec
  0x2860: LoadBool r4, false
  0x2868: GetDot r0, 3
  0x2870: Free3 r1, r3, r0
  0x2878: Ret r0  ; tree_base.sci:135

; === function 35 (gameplay.sci, line 419) locals=4 ===
func_35:
  0x2884: GetDotStr r1, "!vector"  ; pool_off=0x5f5  ; gameplay.sci:402
  0x288c: GetDot r0, 0
  0x2894: Free1 r1
  0x2898: ToStr r0
  0x289c: Copy r0, r3  ; gameplay.sci:405
  0x28a4: SetDotRaw r2, 653
  0x28ac: Free1 r3
  0x28b0: LoadInt r3, 0
  0x28b8: GetDot r1, 1
  0x28c0: Free2 r2, r1
  0x28c8: Copy r-4, r1  ; gameplay.sci:408
  0x28d0: LoadFloat r2, 259200.015625
  0x28d8: CmpGe r1
  0x28dc: BrZ r1, 0x2910
  0x28e4: Copy r0, r3  ; gameplay.sci:408
  0x28ec: SetDotRaw r2, 653
  0x28f4: Free1 r3
  0x28f8: LoadInt r3, 2
  0x2900: GetDot r1, 1
  0x2908: Free2 r2, r1
  0x2910: Copy r-4, r1  ; gameplay.sci:411
  0x2918: LoadFloat r2, 345600.0
  0x2920: CmpGe r1
  0x2924: BrZ r1, 0x2958
  0x292c: Copy r0, r3  ; gameplay.sci:411
  0x2934: SetDotRaw r2, 653
  0x293c: Free1 r3
  0x2940: LoadInt r3, 1
  0x2948: GetDot r1, 1
  0x2950: Free2 r2, r1
  0x2958: Copy r-4, r1  ; gameplay.sci:414
  0x2960: LoadFloat r2, 604800.0
  0x2968: CmpGe r1
  0x296c: BrZ r1, 0x29a0
  0x2974: Copy r0, r3  ; gameplay.sci:414
  0x297c: SetDotRaw r2, 653
  0x2984: Free1 r3
  0x2988: LoadInt r3, 3
  0x2990: GetDot r1, 1
  0x2998: Free2 r2, r1
  0x29a0: Copy r0, r1  ; gameplay.sci:418
  0x29a8: Copy r1, r4294967291
  0x29b0: Free2 r1, r0
  0x29b8: Ret r0

; === function 36 (getUseDistance, tree_base.sci, line 13) locals=1 ===
func_36:
  0x29c4: LoadInt r0, 3  ; tree_base.sci:12
  0x29cc: ToFloat r0
  0x29d0: Copy r0, r4294967292
  0x29d8: Ret r0

; === function 37 (getMaxLimfaAmount, tree_base.sci, line 69) locals=9 ===
func_37:
  0x29e4: GetDotStr r0, "Name"  ; pool_off=0x19  ; tree_base.sci:66
  0x29ec: ToStr r0
  0x29f0: GetDotStr r5, "Scene"  ; pool_off=0x1e  ; tree_base.sci:67
  0x29f8: SetDotRaw r4, 36
  0x2a00: Free1 r5
  0x2a04: LoadString r5, "getLocationProperties"  ; len=21, pool_off=0x29
  0x2a10: GetDot r3, 1
  0x2a18: Free2 r4, r5
  0x2a20: SetDotRaw r2, 83
  0x2a28: Free1 r3
  0x2a2c: Copy r0, r3
  0x2a34: SetDot r1, 1
  0x2a3c: Free1 r3
  0x2a40: ToStr r1
  0x2a44: GetDotStr r7, "World"  ; pool_off=0xa6  ; tree_base.sci:68
  0x2a4c: SetDotRaw r6, 172
  0x2a54: Free1 r7
  0x2a58: SetDotRaw r5, 183
  0x2a60: Free1 r6
  0x2a64: LoadString r6, "Tree/"  ; len=5, pool_off=0xd1
  0x2a70: Copy r1, r8
  0x2a78: SetDotRaw r7, 219
  0x2a80: Free1 r8
  0x2a84: Add r6
  0x2a88: GetDot r4, 1
  0x2a90: Free2 r5, r6
  0x2a98: SetDotRaw r3, 1390
  0x2aa0: Free1 r4
  0x2aa4: SetDotRaw r2, 237
  0x2aac: Free1 r3
  0x2ab0: LoadInt r3, 1000
  0x2ab8: Mul r2
  0x2abc: ToInt r2
  0x2ac0: Copy r2, r4294967292
  0x2ac8: Free2 r1, r0
  0x2ad0: Ret r0
