...
;   bc=0x00c8 str=2("../std.sci") val=104
;   bc=0x00d0 str=2("../std.sci") val=103
; func_names:
;   0=remove
...
func_1:
  ...
  0x0024: CallMethod r0, 0, 0x3e  ; @patch+8 decal.sc:8
...
func_3:
  ...
  0x00ac: GetDotStr r2, "remove"  ; pool_off=0x8  ; decal.sc:24
  0x00b4: GetDot r1, 0
  0x00bc: Free2 r2, r1
...
func_4:
  0x00d0: Copy r-4, r0  ; ../std.sci:103
