...
func_2:
  ...
  0x0040: GetDotStr r2, "World"  ; pool_off=0x0
  0x0048: SetDotRaw r1, 6
  0x0050: Free1 r2
  0x0054: LoadString r2, "easter_egg_peter"  ; len=16, pool_off=0xb
  0x0060: GetDotRaw r1, 1
  0x0068: Free1 r2
  0x006c: GetDotStr r1, "sendGenericEventToWorld"  ; pool_off=0x2b  ; kettle.sc:15
  0x0074: GetDotStr r2, "World"  ; pool_off=0x0
  0x007c: LoadString r3, "onPlot"  ; len=6, pool_off=0x43
  0x0088: GetDot r0, 2
  0x0090: Free4 r1, r2, r3, r0
  0x009c: GetDotStr r1, "sendGenericEventToWorld"  ; pool_off=0x2b  ; kettle.sc:16
  0x00a4: GetDotStr r2, "World"  ; pool_off=0x0
