...
;   bc=0x003c str=2("../std.sci") val=129
;   bc=0x0044 str=2("../std.sci") val=128
...
;   bc=0x02b4 str=2("../std.sci") val=119
;   bc=0x02bc str=2("../std.sci") val=118
;   bc=0x02e4 str=2("../std.sci") val=104
;   bc=0x02ec str=2("../std.sci") val=103
...
;   bc=0x03cc str=2("../std.sci") val=124
;   bc=0x03d4 str=2("../std.sci") val=123
; func_names:
;   0=isTrapAttracted
;   3=isPaintable
;   4=onStartUsing
...
func_2:
  0x0044: GetDotStr r2, "World"  ; pool_off=0x0  ; ../std.sci:128
...
func_10:
  ...
  0x01ec: Mul r2
  0x01f0: Add r1
  0x01f4: GetDotStr r2, "Position"  ; pool_off=0x5b
  0x01fc: Sub r1
  0x0200: ToStr r1
  ...
  0x0240: Free1 r2
  0x0244: GetDotStr r3, "applyForce"  ; pool_off=0x72  ; companioncube.sc:75
  0x024c: LoadFloat r4, 16.0
  0x0254: CopyGlobWr r1, g5
  0x025c: Mul r4
  0x0260: LoadFloat r5, 3.0
  0x0268: GetDotStr r6, "LinearVelocity"  ; pool_off=0x7d
  0x0270: Mul r5
  0x0274: Sub r4
  0x0278: GetDotStr r5, "Mass"  ; pool_off=0x8c
  0x0280: Mul r4
  0x0284: Copy r0, r6
...
; === function 11 (../std.sci, line 119) locals=2 ===
func_11:
  0x02bc: Copy r-4, r0  ; ../std.sci:118
  0x02c4: Copy r-4, r1
  0x02cc: BOr r0
  0x02d0: ToFloat r0
...
func_12:
  0x02ec: Copy r-4, r0  ; ../std.sci:103
...
func_13:
  ...
  0x031c: GetDotStr r2, "World"  ; pool_off=0x0
  0x0324: SetDotRaw r1, 32
  0x032c: Free1 r2
  0x0330: LoadString r2, "easter_egg_companion_cube"  ; len=25, pool_off=0x25
  0x033c: GetDotRaw r1, 1
  0x0344: Free1 r2
  0x0348: GetDotStr r1, "applyForce"  ; pool_off=0x72  ; companioncube.sc:52
  0x0350: Copy r-4, r2
  0x0358: Inv r2
  0x035c: GetDotStr r3, "Mass"  ; pool_off=0x8c
  0x0364: Mul r2
  0x0368: GetDot r0, 1
  0x0370: Free3 r1, r2, r0
  0x0378: GetDotStr r1, "LinearVelocity"  ; pool_off=0x7d  ; companioncube.sc:53
  0x0380: ToStr r1
  0x0384: Call r2, 0x03cc
  0x038c: LoadFloat r1, 0.05000000074505806
  0x0394: CmpGt r0
  0x0398: BrZ r0, 0x03c4
  0x03a0: GetDotStr r0, "LinearVelocity"  ; pool_off=0x7d  ; companioncube.sc:54
  0x03a8: Inv r0
  0x03ac: LoadInt r1, 5
  0x03b4: Mul r0
...
func_14:
  0x03d4: Copy r-4, r0  ; ../std.sci:123
  0x03dc: Copy r-4, r1
  0x03e4: BOr r0
  0x03e8: Sqrt r0
  0x03ec: ToFloat r0
