...
;   bc=0x02e8 str=2("../std.sci") val=104
;   bc=0x02f0 str=2("../std.sci") val=103
; func_table (36 bytes):
...
func_1:
  ...
  0x0290: GetDotStr r0, "Rotation"  ; pool_off=0x0  ; sway.sc:35
  0x0298: GetDotStr r2, "!rotateZ"  ; pool_off=0x9
  0x02a0: CopyGlobWr r4, g3
  0x02a8: GetDot r1, 1
  0x02b0: Free1 r2
  0x02b4: Mul r0
  0x02b8: ToStr r0
  0x02bc: GetDotStr r2, "setRotation"  ; pool_off=0x12  ; sway.sc:36
  0x02c4: Copy r0, r3
  0x02cc: GetDot r1, 1
...
func_2:
  0x02f0: Copy r-4, r0  ; ../std.sci:103
