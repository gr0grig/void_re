...
;   bc=0x0140 str=2("../std.sci") val=1077
;   bc=0x0148 str=2("../std.sci") val=1069
;   bc=0x0158 str=2("../std.sci") val=1070
;   bc=0x0170 str=2("../std.sci") val=1072
;   bc=0x0178 str=2("../std.sci") val=1073
;   bc=0x0188 str=2("../std.sci") val=1074
;   bc=0x01a0 str=2("../std.sci") val=1076
;   bc=0x0204 str=2("../std.sci") val=124
;   bc=0x020c str=2("../std.sci") val=123
; func_table (36 bytes):
...
func_1:
  ...
  0x0038: GetDotStr r0, "Properties"  ; pool_off=0x0  ; easter_egg.sc:7
  0x0040: ToStr r0
  0x0044: Free1 r2  ; easter_egg.sc:12
  0x0048: RetV r1
  0x004c: Free1 r1
  0x0050: GetDotStr r3, "self"  ; pool_off=0xb  ; easter_egg.sc:13
  0x0058: ToStr r3
  ...
  0x009c: GetDotStr r3, "World"  ; pool_off=0x19
...
func_2:
  0x00f8: GetDotStr r2, "World"  ; pool_off=0x19  ; ../std.sci:128
...
func_3:
  0x0148: Copy r-4, r0  ; ../std.sci:1069
  0x0150: BrNZ r0, 0x0170
  0x0158: LoadNullStr r0  ; ../std.sci:1070
  0x015c: Copy r0, r4294967291
  0x0164: Free2 r0, r-4
  0x016c: Ret r0
  0x0170: Call r1, 0x00f0  ; ../std.sci:1072
  0x0178: Copy r0, r1  ; ../std.sci:1073
  0x0180: BrNZ r1, 0x01a0
  0x0188: LoadNullStr r1  ; ../std.sci:1074
  0x018c: Copy r1, r4294967291
  0x0194: Free3 r1, r0, r-4
  0x019c: Ret r0
  0x01a0: GetDotStr r2, "!tuple"  ; pool_off=0x4c  ; ../std.sci:1076
  0x01a8: Copy r-4, r5
...
func_4:
  0x020c: Copy r-4, r0  ; ../std.sci:123
  0x0214: Copy r-4, r1
  0x021c: BOr r0
  0x0220: Sqrt r0
  0x0224: ToFloat r0
