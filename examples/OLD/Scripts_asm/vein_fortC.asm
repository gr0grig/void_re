; gscript disassembly: vein_fortC.bin
; version=0, pool_size=848
; old_version
...
;   bc=0x0040 str=2("vein_fortC.sc") val=12
;   bc=0x0048 str=2("vein_fortC.sc") val=7
;   bc=0x006c str=2("vein_fortC.sc") val=8
;   bc=0x009c str=2("vein_fortC.sc") val=9
;   bc=0x00cc str=2("vein_fortC.sc") val=10
;   bc=0x00fc str=2("vein_fortC.sc") val=11
;   bc=0x012c str=2("vein_fortC.sc") val=12
...
;   bc=0x0348 str=2("vein_fortC.sc") val=31
;   bc=0x0350 str=2("vein_fortC.sc") val=29
;   bc=0x0378 str=2("vein_fortC.sc") val=30
;   bc=0x03b0 str=2("vein_fortC.sc") val=31
...
;   bc=0x075c str=2("vein_fortC.sc") val=38
;   bc=0x0764 str=2("vein_fortC.sc") val=36
;   bc=0x078c str=2("vein_fortC.sc") val=37
;   bc=0x07ec str=2("vein_fortC.sc") val=38
...
;   bc=0x0b80 str=2("vein_fortC.sc") val=25
;   bc=0x0b88 str=2("vein_fortC.sc") val=16
;   bc=0x0b8c str=2("vein_fortC.sc") val=17
;   bc=0x0bec str=2("vein_fortC.sc") val=18
;   bc=0x0c28 str=2("vein_fortC.sc") val=19
;   bc=0x0c88 str=2("vein_fortC.sc") val=20
;   bc=0x0cc4 str=2("vein_fortC.sc") val=21
;   bc=0x0d24 str=2("vein_fortC.sc") val=22
;   bc=0x0d60 str=2("vein_fortC.sc") val=23
;   bc=0x0dc0 str=2("vein_fortC.sc") val=24
;   bc=0x0dfc str=2("vein_fortC.sc") val=25
...
func_1:
  ...
  0x003c: LoadBool r0, 0xffffffff  ; @patch+4 vein_fortC.sc:12
  0x0044: LoadString r0, "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine..."  ; len=327, pool_off=0x8, GARBLED  ; @patch+4 vein_fortC.sc:7
  0x0050: GetDot r0, 0
  0x0058: Free1 r1
  0x005c: ToStr r0
  0x0060: CopyGlobRd r0, g9
  0x0068: Free1 r0
  0x006c: CopyGlobWr r9, g2  ; vein_fortC.sc:8
  0x0074: SetDotRaw r1, 23
  0x007c: Free1 r2
  0x0080: LoadString r2, "minewalls/minewall_fortC_part1.pre"  ; len=34, pool_off=0x28
  0x008c: GetDot r0, 1
  0x0094: Free3 r1, r2, r0
  0x009c: CopyGlobWr r9, g2  ; vein_fortC.sc:9
  0x00a4: SetDotRaw r1, 23
  0x00ac: Free1 r2
  0x00b0: LoadString r2, "minewalls/minewall_fortC_part2.pre"  ; len=34, pool_off=0x6c
  0x00bc: GetDot r0, 1
  0x00c4: Free3 r1, r2, r0
  0x00cc: CopyGlobWr r9, g2  ; vein_fortC.sc:10
  0x00d4: SetDotRaw r1, 23
  0x00dc: Free1 r2
  0x00e0: LoadString r2, "minewalls/minewall_fortC_part3.pre"  ; len=34, pool_off=0xb0
  0x00ec: GetDot r0, 1
  0x00f4: Free3 r1, r2, r0
  0x00fc: CopyGlobWr r9, g2  ; vein_fortC.sc:11
  0x0104: SetDotRaw r1, 23
  0x010c: Free1 r2
  0x0110: LoadString r2, "minewalls/minewall_fortC_part4.pre"  ; len=34, pool_off=0xf4
  0x011c: GetDot r0, 1
  0x0124: Free3 r1, r2, r0
  0x012c: Ret r0  ; vein_fortC.sc:12
...
func_2:
  ...
  0x0178: GetDotStr r2, "Scene"  ; pool_off=0x138  ; vein_base.sci:67
  0x0180: SetDotRaw r1, 318
  0x0188: Free1 r2
  0x018c: LoadString r2, "getLocationProperties"  ; len=21, pool_off=0x143
  0x0198: GetDot r0, 1
  0x01a0: Free2 r1, r2
  0x01a8: ToStr r0
  0x01ac: Copy r0, r2  ; vein_base.sci:68
  0x01b4: LoadString r3, "VeinName"  ; len=8, pool_off=0x16d
  0x01c0: Copy r-9, r4
  0x01c8: LoadInt r5, 1
  0x01d0: Add r4
  0x01d4: AsString r4
  ...
  0x01f4: Free1 r1
  0x01f8: GetDotStr r4, "World"  ; pool_off=0x17d  ; vein_base.sci:70
  0x0200: SetDotRaw r3, 387
  0x0208: Free1 r4
  0x020c: SetDotRaw r2, 398
  0x0214: Free1 r3
  0x0218: LoadString r3, "Vein/"  ; len=5, pool_off=0x192
  ...
  0x024c: SetDotRaw r3, 412
  0x0254: Free1 r4
  0x0258: SetDotRaw r2, 422
  0x0260: Free1 r3
  ...
  0x0284: SetDotRaw r3, 428
  0x028c: Free1 r4
  0x0290: SetDotRaw r2, 422
  0x0298: Free1 r3
  ...
  0x02bc: SetDotRaw r3, 436
  0x02c4: Free1 r4
  0x02c8: SetDotRaw r2, 422
  0x02d0: Free1 r3
...
; === function 3 (getVeinLimfaType, vein_fortC.sc, line 31) locals=6 ===
func_3:
  0x0350: GetDotStr r1, "findMaterial"  ; pool_off=0x1c3  ; vein_fortC.sc:29
  0x0358: LoadString r2, "Material #4"  ; len=11, pool_off=0x1d0
  0x0364: GetDot r0, 1
  0x036c: Free2 r1, r2
  0x0374: ToInt r0
  0x0378: GetDotStr r2, "setLocalGeomParameterColor"  ; pool_off=0x1e6  ; vein_fortC.sc:30
  0x0380: Copy r0, r3
  0x0388: LoadString r4, "Color"  ; len=5, pool_off=0x201
  0x0394: Copy r-4, r5
  0x039c: GetDot r1, 3
  0x03a4: Free4 r2, r4, r5, r1
  0x03b0: Free1 r-4  ; vein_fortC.sc:31
  0x03b4: Ret r0

; === function 4 (vein_base.sci, line 44) locals=6 ===
func_4:
  0x03c0: GetDotStr r5, "World"  ; pool_off=0x17d  ; vein_base.sci:43
  0x03c8: SetDotRaw r4, 387
  0x03d0: Free1 r5
  0x03d4: SetDotRaw r3, 398
  0x03dc: Free1 r4
  0x03e0: LoadString r4, "Limfa"  ; len=5, pool_off=0x20b
  0x03ec: Copy r-4, r5
  0x03f4: AsString r5
  0x03f8: Add r4
  0x03fc: GetDot r2, 1
  0x0404: Free2 r3, r4
  0x040c: SetDotRaw r1, 507
  0x0414: Free1 r2
  0x0418: SetDotRaw r0, 533
  0x0420: Free1 r1
  0x0424: ToStr r0
...
func_10:
  ...
  0x0514: SetDotRaw r2, 318
  0x051c: Free1 r3
  0x0520: LoadString r3, "setAmplitude"  ; len=12, pool_off=0x21d
  0x052c: Copy r0, r4
  0x0534: GetDot r1, 2
...
func_13:
  ...
  0x067c: GetDotStr r2, "randMax"  ; pool_off=0x246  ; vein_base.sci:24
  0x0684: LoadFloat r3, 6.2831854820251465
  0x068c: GetDot r1, 1
  0x0694: Free1 r2
  0x0698: ToFloat r1
  0x069c: GetDotStr r3, "randRange"  ; pool_off=0x24e  ; vein_base.sci:25
...
; === function 14 (vein_fortC.sc, line 38) locals=9 ===
func_14:
  0x0764: GetDotStr r1, "findMaterial"  ; pool_off=0x1c3  ; vein_fortC.sc:36
  0x076c: LoadString r2, "Material #4"  ; len=11, pool_off=0x1d0
  0x0778: GetDot r0, 1
  0x0780: Free2 r1, r2
  0x0788: ToInt r0
  0x078c: GetDotStr r2, "setLocalGeomParameterFloat"  ; pool_off=0x258  ; vein_fortC.sc:37
  0x0794: Copy r0, r3
  0x079c: LoadString r4, "Threshold"  ; len=9, pool_off=0x273
  0x07a8: LoadInt r6, 1
  0x07b0: Copy r-4, r7
  0x07b8: Sub r6
  0x07bc: LoadInt r7, 0
  ...
  0x07ec: Ret r0  ; vein_fortC.sc:38
...
func_22:
  0x0924: GetDotStr r2, "Scene"  ; pool_off=0x138  ; vein_base.sci:220
  0x092c: SetDotRaw r1, 318
  0x0934: Free1 r2
  0x0938: LoadString r2, "updateVeinData"  ; len=14, pool_off=0x285
  ...
  0x0974: GetDotStr r1, "!vec3"  ; pool_off=0x2a1  ; vein_base.sci:223
  0x097c: LoadInt r2, 0
  0x0984: LoadInt r3, 1
  0x098c: LoadInt r4, 0
  0x0994: GetDot r0, 3
  0x099c: Free1 r1
  0x09a0: GetDotStr r2, "Transform"  ; pool_off=0x2a7
  0x09a8: SetDotRaw r1, 689
  0x09b0: Free1 r2
  0x09b4: Mul r0
  0x09b8: ToStr r0
  0x09bc: GetDotStr r2, "Transform"  ; pool_off=0x2a7  ; vein_base.sci:224
  0x09c4: SetDotRaw r1, 698
  0x09cc: Free1 r2
  0x09d0: ToStr r1
  ...
  0x0a88: Add r4
  0x0a8c: ToStr r4
  0x0a90: GetDotStr r7, "World"  ; pool_off=0x17d  ; vein_base.sci:234
  0x0a98: SetDotRaw r6, 710
  0x0aa0: Free1 r7
  0x0aa4: GetDotStr r7, "Scene"  ; pool_off=0x138
  0x0aac: LoadString r8, "limfa.pre"  ; len=9, pool_off=0x2d7
  0x0ab8: Copy r4, r9
  0x0ac0: LoadString r10, "vein_badabum_part"  ; len=17, pool_off=0x2e9
  0x0acc: GetDot r5, 4
  0x0ad4: Free5 r6, r7, r8, r9, r10
  0x0ae0: ToStr r5
  0x0ae4: Copy r5, r8  ; vein_base.sci:235
  0x0aec: SetDotRaw r7, 318
  0x0af4: Free1 r8
  0x0af8: LoadString r8, "initPart"  ; len=8, pool_off=0x30b
...
; === function 23 (vein_fortC.sc, line 25) locals=7 ===
func_23:
  0x0b88: LoadNullStr2 r0  ; vein_fortC.sc:16
  0x0b8c: GetDotStr r3, "World"  ; pool_off=0x17d  ; vein_fortC.sc:17
  0x0b94: SetDotRaw r2, 710
  0x0b9c: Free1 r3
  0x0ba0: GetDotStr r3, "Scene"  ; pool_off=0x138
  0x0ba8: LoadString r4, "minewalls/minewall_fortC_part1.pre"  ; len=34, pool_off=0x28
  0x0bb4: GetDotStr r5, "Transform"  ; pool_off=0x2a7
  0x0bbc: LoadString r6, "vein_part"  ; len=9, pool_off=0x31b
  0x0bc8: GetDot r1, 4
  0x0bd0: Free5 r2, r3, r4, r5, r6
  0x0bdc: ToStr r1
  0x0be0: Copy r1, r0
  0x0be8: Free1 r1
  0x0bec: Copy r0, r3  ; vein_fortC.sc:18
  0x0bf4: SetDotRaw r2, 318
  0x0bfc: Free1 r3
  0x0c00: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x32d
  0x0c0c: Copy r-4, r4
  0x0c14: GetDot r1, 2
  0x0c1c: Free4 r2, r3, r4, r1
  0x0c28: GetDotStr r3, "World"  ; pool_off=0x17d  ; vein_fortC.sc:19
  0x0c30: SetDotRaw r2, 710
  0x0c38: Free1 r3
  0x0c3c: GetDotStr r3, "Scene"  ; pool_off=0x138
  0x0c44: LoadString r4, "minewalls/minewall_fortC_part2.pre"  ; len=34, pool_off=0x6c
  0x0c50: GetDotStr r5, "Transform"  ; pool_off=0x2a7
  0x0c58: LoadString r6, "vein_part"  ; len=9, pool_off=0x31b
  0x0c64: GetDot r1, 4
  0x0c6c: Free5 r2, r3, r4, r5, r6
  0x0c78: ToStr r1
  0x0c7c: Copy r1, r0
  0x0c84: Free1 r1
  0x0c88: Copy r0, r3  ; vein_fortC.sc:20
  0x0c90: SetDotRaw r2, 318
  0x0c98: Free1 r3
  0x0c9c: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x32d
  0x0ca8: Copy r-4, r4
  0x0cb0: GetDot r1, 2
  0x0cb8: Free4 r2, r3, r4, r1
  0x0cc4: GetDotStr r3, "World"  ; pool_off=0x17d  ; vein_fortC.sc:21
  0x0ccc: SetDotRaw r2, 710
  0x0cd4: Free1 r3
  0x0cd8: GetDotStr r3, "Scene"  ; pool_off=0x138
  0x0ce0: LoadString r4, "minewalls/minewall_fortC_part3.pre"  ; len=34, pool_off=0xb0
  0x0cec: GetDotStr r5, "Transform"  ; pool_off=0x2a7
  0x0cf4: LoadString r6, "vein_part"  ; len=9, pool_off=0x31b
  0x0d00: GetDot r1, 4
  0x0d08: Free5 r2, r3, r4, r5, r6
  0x0d14: ToStr r1
  0x0d18: Copy r1, r0
  0x0d20: Free1 r1
  0x0d24: Copy r0, r3  ; vein_fortC.sc:22
  0x0d2c: SetDotRaw r2, 318
  0x0d34: Free1 r3
  0x0d38: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x32d
  0x0d44: Copy r-4, r4
  0x0d4c: GetDot r1, 2
  0x0d54: Free4 r2, r3, r4, r1
  0x0d60: GetDotStr r3, "World"  ; pool_off=0x17d  ; vein_fortC.sc:23
  0x0d68: SetDotRaw r2, 710
  0x0d70: Free1 r3
  0x0d74: GetDotStr r3, "Scene"  ; pool_off=0x138
  0x0d7c: LoadString r4, "minewalls/minewall_fortC_part4.pre"  ; len=34, pool_off=0xf4
  0x0d88: GetDotStr r5, "Transform"  ; pool_off=0x2a7
  0x0d90: LoadString r6, "vein_part"  ; len=9, pool_off=0x31b
  0x0d9c: GetDot r1, 4
  0x0da4: Free5 r2, r3, r4, r5, r6
  0x0db0: ToStr r1
  0x0db4: Copy r1, r0
  0x0dbc: Free1 r1
  0x0dc0: Copy r0, r3  ; vein_fortC.sc:24
  0x0dc8: SetDotRaw r2, 318
  0x0dd0: Free1 r3
  0x0dd4: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x32d
  0x0de0: Copy r-4, r4
  0x0de8: GetDot r1, 2
  0x0df0: Free4 r2, r3, r4, r1
  0x0dfc: Free2 r0, r-4  ; vein_fortC.sc:25
  0x0e04: Ret r0
...
func_24:
  ...
  0x0e2c: LogOr r2
  0x0e30: GetDotStr r2, "irandRange"  ; pool_off=0x345  ; vein_base.sci:155
...
func_27:
  ...
  0x0f0c: LogOr r2
  0x0f10: GetDotStr r1, "irandRange"  ; pool_off=0x345  ; vein_base.sci:175
  0x0f18: LoadInt r2, 2
  0x0f20: LoadInt r3, 3
  0x0f28: GetDot r0, 2
  0x0f30: Free1 r1
  ...
  0x0fd0: Mul r6
  0x0fd4: Sub r5
  0x0fd8: CallMethod r5, 565, 0x20a  ; @patch+8 vein_base.sci:182
  0x0fe4: LoadFalse r0
  0x0fe8: Copy r4, r6
  0x0ff0: Sub r5
  0x0ff4: Copy r5, r2
