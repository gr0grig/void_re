...
func_2:
  0x0028: GetDotStr r1, "loadAnimationSet"  ; pool_off=0x0  ; animated.sc:9
  0x0030: Copy r-5, r2
  0x0038: GetDot r0, 1
...
func_3:
  0x0070: GetDotStr r1, "logInfo"  ; pool_off=0x11  ; animated.sc:17
  0x0078: LoadString r2, "playing"  ; len=7, pool_off=0x19
  0x0084: GetDot r0, 1
  0x008c: Free3 r1, r2, r0
  0x0094: GetDotStr r1, "playAnimation"  ; pool_off=0x27  ; animated.sc:19
  0x009c: Copy r-4, r2
  0x00a4: GetDot r0, 1
  0x00ac: Free2 r1, r2
  0x00b4: ToStr r0
