...
;   [2] "talk_base.sci"
;   [3] "hunter_05_whaler_talk.sc"
;   [4] "hunter_05_whaler_talk_base.sci"
;   [5] "../souls.sci"
;   [6] "../std.sci"
;   [7] "..\sound.sci"
...
;   bc=0x0584 str=3("hunter_05_whaler_talk.sc") val=12
;   bc=0x058c str=3("hunter_05_whaler_talk.sc") val=7
;   bc=0x059c str=3("hunter_05_whaler_talk.sc") val=11
;   bc=0x05ac str=3("hunter_05_whaler_talk.sc") val=12
;   bc=0x05b8 str=4("hunter_05_whaler_talk_base.sci") val=12
;   bc=0x05c0 str=4("hunter_05_whaler_talk_base.sci") val=5
;   bc=0x05d0 str=4("hunter_05_whaler_talk_base.sci") val=6
;   bc=0x05ec str=4("hunter_05_whaler_talk_base.sci") val=7
;   bc=0x0608 str=4("hunter_05_whaler_talk_base.sci") val=11
...
; === function 11 (hunter_05_whaler_talk.sc, line 12) locals=2 ===
func_11:
  0x058c: Copy r-4, r1  ; hunter_05_whaler_talk.sc:7
  0x0594: Call r2, 0x05b8
  0x059c: Copy r0, r1  ; hunter_05_whaler_talk.sc:11
  0x05a4: Call r2, 0x2328
  0x05ac: Free2 r0, r-4  ; hunter_05_whaler_talk.sc:12
  0x05b4: Ret r0

; === function 12 (hunter_05_whaler_talk_base.sci, line 12) locals=3 ===
func_12:
  0x05c0: Copy r-4, r1  ; hunter_05_whaler_talk_base.sci:5
  0x05c8: Call r2, 0x0624
  0x05d0: Copy r0, r2  ; hunter_05_whaler_talk_base.sci:6
  0x05d8: SetDotRaw r1, 385
  0x05e0: Free1 r2
  0x05e4: BrZ r1, 0x0608
  0x05ec: Copy r0, r1  ; hunter_05_whaler_talk_base.sci:7
  0x05f4: Copy r1, r4294967291
  0x05fc: Free3 r1, r0, r-4
  0x0604: Ret r0
  0x0608: Copy r0, r1  ; hunter_05_whaler_talk_base.sci:11
