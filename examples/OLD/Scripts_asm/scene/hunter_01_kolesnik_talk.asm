...
;   [2] "talk_base.sci"
;   [3] "hunter_01_kolesnik_talk.sc"
;   [4] "hunter_01_kolesnik_talk_base.sci"
;   [5] "../souls.sci"
;   [6] "../std.sci"
;   [7] "..\sound.sci"
...
;   bc=0x0584 str=3("hunter_01_kolesnik_talk.sc") val=12
;   bc=0x058c str=3("hunter_01_kolesnik_talk.sc") val=7
;   bc=0x059c str=3("hunter_01_kolesnik_talk.sc") val=11
;   bc=0x05ac str=3("hunter_01_kolesnik_talk.sc") val=12
;   bc=0x05b8 str=4("hunter_01_kolesnik_talk_base.sci") val=16
;   bc=0x05c0 str=4("hunter_01_kolesnik_talk_base.sci") val=5
;   bc=0x05d0 str=4("hunter_01_kolesnik_talk_base.sci") val=6
;   bc=0x05ec str=4("hunter_01_kolesnik_talk_base.sci") val=7
;   bc=0x0608 str=4("hunter_01_kolesnik_talk_base.sci") val=10
;   bc=0x0628 str=4("hunter_01_kolesnik_talk_base.sci") val=11
;   bc=0x0684 str=4("hunter_01_kolesnik_talk_base.sci") val=12
;   bc=0x06a0 str=4("hunter_01_kolesnik_talk_base.sci") val=15
...
; === function 11 (hunter_01_kolesnik_talk.sc, line 12) locals=2 ===
func_11:
  0x058c: Copy r-4, r1  ; hunter_01_kolesnik_talk.sc:7
  0x0594: Call r2, 0x05b8
  0x059c: Copy r0, r1  ; hunter_01_kolesnik_talk.sc:11
  0x05a4: Call r2, 0x23c0
  0x05ac: Free2 r0, r-4  ; hunter_01_kolesnik_talk.sc:12
  0x05b4: Ret r0

; === function 12 (hunter_01_kolesnik_talk_base.sci, line 16) locals=7 ===
func_12:
  0x05c0: Copy r-4, r1  ; hunter_01_kolesnik_talk_base.sci:5
  0x05c8: Call r2, 0x06bc
  0x05d0: Copy r0, r2  ; hunter_01_kolesnik_talk_base.sci:6
  0x05d8: SetDotRaw r1, 385
  0x05e0: Free1 r2
  0x05e4: BrZ r1, 0x0608
  0x05ec: Copy r0, r1  ; hunter_01_kolesnik_talk_base.sci:7
  0x05f4: Copy r1, r4294967291
  0x05fc: Free3 r1, r0, r-4
  0x0604: Ret r0
  0x0608: Copy r-4, r1  ; hunter_01_kolesnik_talk_base.sci:10
  0x0610: LoadString r2, "intro"  ; len=5, pool_off=0x187
  0x061c: CmpEq r1
  0x0620: BrZ r1, 0x06a0
  0x0628: Copy r0, r3  ; hunter_01_kolesnik_talk_base.sci:11
  0x0630: SetDotRaw r2, 401
  0x0638: Free1 r3
  0x063c: LoadString r4, "intro_kolesnik"  ; len=14, pool_off=0x195
  ...
  0x0684: Copy r0, r1  ; hunter_01_kolesnik_talk_base.sci:12
  0x068c: Copy r1, r4294967291
  0x0694: Free3 r1, r0, r-4
  0x069c: Ret r0
  0x06a0: Copy r0, r1  ; hunter_01_kolesnik_talk_base.sci:15
...
func_13:
  ...
  0x06ec: Free1 r2
  0x06f0: ToStr r0
  0x06f4: GetDotStr r2, "!vector"  ; pool_off=0x1b1  ; talk_hunter_base.sci:83
  0x06fc: GetDot r1, 0
  0x0704: Free1 r2
  0x0708: ToStr r1
  0x070c: Copy r-4, r2  ; talk_hunter_base.sci:85
  0x0714: LoadString r3, "kill_girl"  ; len=9, pool_off=0x1b9
  0x0720: CmpEq r2
  0x0724: BrZ r2, 0x07b8
  0x072c: Copy r1, r4  ; talk_hunter_base.sci:87
  0x0734: SetDotRaw r3, 401
  0x073c: Free1 r4
  0x0740: LoadString r5, "kill_girl_"  ; len=10, pool_off=0x1b9
  0x074c: Copy r0, r6
  0x0754: Add r5
  0x0758: ToStr r5
  ...
  0x07c0: LoadString r3, "kill_girl_reward"  ; len=16, pool_off=0x1b9
  0x07cc: CmpEq r2
  0x07d0: BrZ r2, 0x09cc
  0x07d8: Copy r1, r4  ; talk_hunter_base.sci:93
  0x07e0: SetDotRaw r3, 401
  0x07e8: Free1 r4
  0x07ec: LoadString r5, "kill_girl_reward_"  ; len=17, pool_off=0x1b9
  0x07f8: Copy r0, r6
  0x0800: Add r5
  0x0804: ToStr r5
  ...
  0x0894: Mod r3
  0x0898: ToInt r3
  0x089c: GetDotStr r5, "!tuple"  ; pool_off=0x1db  ; talk_hunter_base.sci:97
  0x08a4: LoadInt r6, 0
  0x08ac: LoadInt r7, 0
  0x08b4: LoadInt r8, 0
  0x08bc: LoadInt r9, 0
  ...
  0x08e4: Free1 r5
  0x08e8: ToStr r4
  0x08ec: GetDotStr r6, "irandRange"  ; pool_off=0x1e2  ; talk_hunter_base.sci:98
  ...
  0x0928: Free1 r5
  0x092c: GetDotStr r6, "irandRange"  ; pool_off=0x1e2  ; talk_hunter_base.sci:99
  ...
  0x09d4: LoadString r3, "meeting"  ; len=7, pool_off=0x1ed
  0x09e0: CmpEq r2
  0x09e4: BrZ r2, 0x0a78
  0x09ec: Copy r1, r4  ; talk_hunter_base.sci:107
  0x09f4: SetDotRaw r3, 401
  0x09fc: Free1 r4
  0x0a00: LoadString r5, "meeting_"  ; len=8, pool_off=0x1ed
  0x0a0c: Copy r0, r6
  0x0a14: Add r5
  0x0a18: ToStr r5
  ...
  0x0a80: LoadString r3, "open_zone_count"  ; len=15, pool_off=0x1fd
  0x0a8c: CmpEq r2
  0x0a90: BrZ r2, 0x0b24
  0x0a98: Copy r1, r4  ; talk_hunter_base.sci:113
  0x0aa0: SetDotRaw r3, 401
  0x0aa8: Free1 r4
  0x0aac: LoadString r5, "open_zone_limit_"  ; len=16, pool_off=0x21b
  0x0ab8: Copy r0, r6
  0x0ac0: Add r5
  0x0ac4: ToStr r5
  ...
  0x0b2c: LoadString r3, "capillar_limfa_reaction"  ; len=23, pool_off=0x23b
  0x0b38: CmpEq r2
  0x0b3c: BrZ r2, 0x0bd0
  0x0b44: Copy r1, r4  ; talk_hunter_base.sci:119
  0x0b4c: SetDotRaw r3, 401
  0x0b54: Free1 r4
  0x0b58: LoadString r5, "capillar_limfa_reaction_"  ; len=24, pool_off=0x23b
  0x0b64: Copy r0, r6
  0x0b6c: Add r5
  0x0b70: ToStr r5
  ...
  0x0bd8: LoadString r3, "agression"  ; len=9, pool_off=0x26b
  0x0be4: CmpEq r2
  0x0be8: BrZ r2, 0x0d64
  0x0bf0: GetDotStr r5, "World"  ; pool_off=0x4a  ; talk_hunter_base.sci:125
  0x0bf8: SetDotRaw r4, 637
  0x0c00: Free1 r5
  0x0c04: SetDotRaw r3, 642
  0x0c0c: Free1 r4
  0x0c10: LoadString r4, "was_agression_monolog_"  ; len=22, pool_off=0x286
  0x0c1c: Copy r0, r5
  0x0c24: Add r4
  0x0c28: GetDot r2, 1
  0x0c30: Free2 r3, r4
  ...
  0x0c50: Free1 r4
  0x0c54: LoadString r5, "agression_"  ; len=10, pool_off=0x28e
  0x0c60: Copy r0, r6
  0x0c68: Add r5
  0x0c6c: ToStr r5
  ...
  0x0cbc: Free1 r4
  0x0cc0: LoadString r5, "was_agression_monolog_"  ; len=22, pool_off=0x286
  0x0ccc: Copy r0, r6
  0x0cd4: Add r5
  0x0cd8: ToStr r5
  ...
  0x0d6c: LoadString r3, "process_agression"  ; len=17, pool_off=0x2b2
  0x0d78: CmpEq r2
  0x0d7c: BrZ r2, 0x0e4c
  0x0d84: Copy r1, r4  ; talk_hunter_base.sci:135
  0x0d8c: SetDotRaw r3, 401
  0x0d94: Free1 r4
  0x0d98: LoadString r5, "process_agression_"  ; len=18, pool_off=0x2b2
  0x0da4: Copy r0, r6
  0x0dac: Add r5
  0x0db0: ToStr r5
  ...
  0x0e54: LoadString r3, "girl_upgraded_reaction"  ; len=22, pool_off=0x2d6
  0x0e60: CmpEq r2
  0x0e64: BrZ r2, 0x0ef8
  0x0e6c: Copy r1, r4  ; talk_hunter_base.sci:142
  0x0e74: SetDotRaw r3, 401
  0x0e7c: Free1 r4
  0x0e80: LoadString r5, "girl_upgraded_reaction_"  ; len=23, pool_off=0x2d6
  0x0e8c: Copy r0, r6
  0x0e94: Add r5
  0x0e98: ToStr r5
...
func_15:
  0x0f80: GetDotStr r1, "!tuple"  ; pool_off=0x1db  ; talk_base.sci:83
...
func_17:
  0x0fec: GetDotStr r1, "getNamedString"  ; pool_off=0x30b  ; talk_hunter_base.sci:235
  0x0ff4: Copy r-7, r2
  0x0ffc: GetDot r0, 1
  0x1004: Free2 r1, r2
  0x100c: ToStr r0
  0x1010: GetDotStr r2, "splitString"  ; pool_off=0x31a  ; talk_hunter_base.sci:236
  0x1018: Copy r0, r3
  ...
  0x1090: GetDotStr r4, "splitString"  ; pool_off=0x31a  ; talk_hunter_base.sci:240
  0x1098: Copy r1, r6
  0x10a0: Copy r2, r7
  0x10a8: SetDot r5, 1
  0x10b0: LoadString r6, "|"  ; len=1, pool_off=0x328
...
func_19:
  ...
  0x126c: SetDotRaw r2, 637
  0x1274: Free1 r3
  0x1278: LoadString r3, "Souls"  ; len=5, pool_off=0x32a
  0x1284: SetDot r1, 1
  0x128c: Free1 r3
  0x1290: LoadInt r2, 1
  0x1298: SetDot r0, 1
  ...
  0x12d4: Free1 r3
  0x12d8: GetDotStr r4, "!tuple"  ; pool_off=0x1db
  0x12e0: Copy r-4, r5
  0x12e8: Copy r-4, r7
...
func_20:
  ...
  0x1334: SetDotRaw r2, 637
  0x133c: Free1 r3
  0x1340: SetDotRaw r1, 642
  0x1348: Free1 r2
  0x134c: LoadString r2, "Souls"  ; len=5, pool_off=0x32a
  0x1358: GetDot r0, 1
  0x1360: Free2 r1, r2
  0x1368: ToBool r0
...
func_21:
  ...
  0x1390: Free1 r2
  0x1394: LoadString r2, "getWorldTime"  ; len=12, pool_off=0x334
  0x13a0: GetDot r0, 1
  0x13a8: Free2 r1, r2
  0x13b0: ToInt r0
  ...
  0x13c4: Free1 r3
  0x13c8: LoadString r3, "getWorldTimeString"  ; len=18, pool_off=0x334
  0x13d4: GetDot r1, 1
  0x13dc: Free2 r2, r3
  0x13e4: ToStr r1
  0x13e8: GetDotStr r3, "splitString"  ; pool_off=0x31a  ; ../souls.sci:45
  0x13f0: Copy r-4, r4
  ...
  0x14f4: GetDotStr r7, "getString"  ; pool_off=0x35c
...
func_23:
  ...
  0x15a0: LoadString r1, "kolesnik"  ; len=8, pool_off=0x1a1
  0x15ac: CmpEq r0
  ...
  0x15d8: LoadString r1, "ironclad"  ; len=8, pool_off=0x366
  0x15e4: CmpEq r0
  ...
  0x1610: LoadString r1, "stiltman"  ; len=8, pool_off=0x376
  0x161c: CmpEq r0
  ...
  0x1648: LoadString r1, "mongolfier"  ; len=10, pool_off=0x386
  0x1654: CmpEq r0
  ...
  0x1680: LoadString r1, "whaler"  ; len=6, pool_off=0x39a
  0x168c: CmpEq r0
  ...
  0x16b8: LoadString r1, "driller"  ; len=7, pool_off=0x3a6
  0x16c4: CmpEq r0
  ...
  0x16f0: LoadString r1, "caterpillar"  ; len=11, pool_off=0x3b4
  0x16fc: CmpEq r0
  ...
  0x1728: Copy r-4, r1
  0x1730: LoadString r2, "hole"  ; len=4, pool_off=0x3ca
  0x173c: CmpEq r1
...
func_30:
  0x1e9c: GetDotStr r1, "!tuple"  ; pool_off=0x1db  ; talk_base.sci:252
...
func_31:
  ...
  0x1f0c: Free1 r1
  0x1f10: ToStr r0
  0x1f14: GetDotStr r2, "!tuple"  ; pool_off=0x1db  ; talk_base.sci:212
  0x1f1c: LoadInt r3, 0
  0x1f24: LoadInt r4, 0
  0x1f2c: LoadInt r5, 0
  0x1f34: LoadInt r6, 0
...
func_49:
  0x2de4: GetDotStr r1, "!vector"  ; pool_off=0x1b1  ; ..\gameplay.sci:402
  0x2dec: GetDot r0, 0
  0x2df4: Free1 r1
  0x2df8: ToStr r0
