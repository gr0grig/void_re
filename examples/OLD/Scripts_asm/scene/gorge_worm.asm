...
;   bc=0x9654 str=11("gorge_worm.sc") val=11
;   bc=0x965c str=11("gorge_worm.sc") val=10
;   bc=0x9674 str=11("gorge_worm.sc") val=16
;   bc=0x967c str=11("gorge_worm.sc") val=15
;   bc=0x9690 str=11("gorge_worm.sc") val=16
...
; === function 150 (hasWheel, gorge_worm.sc, line 11) locals=1 ===
func_150:
  0x965c: CopyGlobWr r21, g0  ; gorge_worm.sc:10
  0x9664: Copy r0, r4294967292
  0x966c: Free1 r0
  0x9670: Ret r0

; === function 151 (getWheelLevel, gorge_worm.sc, line 16) locals=1 ===
func_151:
  0x967c: Copy r-4, r0  ; gorge_worm.sc:15
  0x9684: CopyGlobRd r0, g21
  0x968c: Free1 r0
  0x9690: Free1 r-4  ; gorge_worm.sc:16
  0x9694: Ret r0
