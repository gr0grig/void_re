...
;   bc=0x0130 str=2("../std.sci") val=104
;   bc=0x0138 str=2("../std.sci") val=103
; func_table (36 bytes):
...
func_1:
  ...
  0x0024: ToFloat r0
  0x0028: GetDotStr r2, "randRange"  ; pool_off=0x0  ; una_wheel.sc:6
  0x0030: LoadFloat r3, 0.30000001192092896
  0x0038: LoadFloat r4, 0.5
  0x0040: GetDot r1, 2
  0x0048: Free1 r2
  0x004c: ToFloat r1
  0x0050: GetDotStr r2, "Rotation"  ; pool_off=0xa  ; una_wheel.sc:7
  0x0058: ToStr r2
  0x005c: GetDotStr r4, "setKinematic"  ; pool_off=0x13  ; una_wheel.sc:9
  ...
  0x00dc: Sub r3
  0x00e0: Copy r3, r0
  0x00e8: GetDotStr r4, "setRotation"  ; pool_off=0x20  ; una_wheel.sc:17
  0x00f0: Copy r2, r5
  0x00f8: GetDotStr r7, "!rotateX"  ; pool_off=0x2c
  0x0100: Copy r0, r8
  0x0108: GetDot r6, 1
  0x0110: Free1 r7
  0x0114: Mul r5
...
func_2:
  0x0138: Copy r-4, r0  ; ../std.sci:103
