...
func_3:
  ...
  0x005c: ToFloat r0
  0x0060: GetDotStr r2, "!rotateX"  ; pool_off=0x0  ; pelican_devour_camera.sc:28
  ...
  0x0094: Free1 r2
  0x0098: ToStr r1
  0x009c: GetDotStr r3, "!rotateY"  ; pool_off=0x9  ; pelican_devour_camera.sc:29
  ...
  0x00d0: Free1 r3
  0x00d4: ToStr r2
  0x00d8: GetDotStr r4, "!rotateZ"  ; pool_off=0x12  ; pelican_devour_camera.sc:30
