...
;   bc=0x9654 str=11("backyard.sc") val=8
;   bc=0x965c str=11("backyard.sc") val=7
;   bc=0x9674 str=11("backyard.sc") val=13
;   bc=0x967c str=11("backyard.sc") val=12
;   bc=0x9690 str=11("backyard.sc") val=13
...
; === function 150 (hasWheel, backyard.sc, line 8) locals=1 ===
func_150:
  0x965c: CopyGlobWr r21, g0  ; backyard.sc:7
  0x9664: Copy r0, r4294967292
  0x966c: Free1 r0
  0x9670: Ret r0

; === function 151 (getWheelLevel, backyard.sc, line 13) locals=1 ===
func_151:
  0x967c: Copy r-4, r0  ; backyard.sc:12
  0x9684: CopyGlobRd r0, g21
  0x968c: Free1 r0
  0x9690: Free1 r-4  ; backyard.sc:13
  0x9694: Ret r0
