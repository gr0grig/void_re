...
;   bc=0x039c str=2("../std.sci") val=129
;   bc=0x03a4 str=2("../std.sci") val=128
;   bc=0x03ec str=2("../std.sci") val=124
;   bc=0x03f4 str=2("../std.sci") val=123
...
func_1:
  0x001c: GetDotStr r1, "loadSound3D"  ; pool_off=0x0  ; una_hammer.sc:10
  ...
  0x0054: RetV r0
  0x0058: Free1 r0
  0x005c: GetDotStr r1, "randRange"  ; pool_off=0x28  ; una_hammer.sc:12
  0x0064: LoadInt r2, 0
  0x006c: LoadFloat r3, 6.2829999923706055
  0x0074: GetDot r0, 2
  0x007c: Free1 r1
  0x0080: ToFloat r0
  0x0084: GetDotStr r1, "Rotation"  ; pool_off=0x32  ; una_hammer.sc:13
  0x008c: ToStr r1
  0x0090: GetDotStr r3, "setKinematic"  ; pool_off=0x3b  ; una_hammer.sc:15
  ...
  0x0148: Sqrt r8
  0x014c: Mul r7
  0x0150: GetDotStr r9, "setRotation"  ; pool_off=0x48  ; una_hammer.sc:30
  0x0158: GetDotStr r11, "!rotateY"  ; pool_off=0x54
  0x0160: Copy r7, r12
  0x0168: GetDot r10, 1
  0x0170: Free1 r11
  0x0174: Copy r1, r11
  ...
  0x0200: Free1 r11
  0x0204: GetDotStr r11, "Position"  ; pool_off=0x5d
  0x020c: Sub r10
  0x0210: ToStr r10
  ...
  0x02a4: GetDotStr r12, "!vec3"  ; pool_off=0x9c
...
func_3:
  0x03a4: GetDotStr r2, "World"  ; pool_off=0xac  ; ../std.sci:128
...
func_4:
  0x03f4: Copy r-4, r0  ; ../std.sci:123
  0x03fc: Copy r-4, r1
  0x0404: BOr r0
  0x0408: Sqrt r0
  0x040c: ToFloat r0
...
func_5:
  ...
  0x044c: Mul r0
  0x0450: GetDotStr r2, "playSound3D"  ; pool_off=0xd8  ; ..\sound.sci:259
  0x0458: Copy r-8, r3
  0x0460: Copy r-7, r4
  0x0468: Copy r-6, r5
  0x0470: Copy r-5, r6
  ...
  0x0498: ToStr r1
  0x049c: GetDotStr r6, "Globals"  ; pool_off=0xe4  ; ..\sound.sci:260
...
func_6:
  0x0514: GetDotStr r2, "Settings"  ; pool_off=0xf7  ; ..\sound.sci:9
  0x051c: Copy r-4, r3
...
func_7:
  0x0568: GetDotStr r2, "Scene"  ; pool_off=0x114  ; ..\sound.sci:28
