; gscript disassembly: arena_general.bin
...
;   bc=0x0014 str=1("arena_general.sc") val=16
;   bc=0x001c str=1("arena_general.sc") val=15
;   bc=0x0024 str=1("arena_general.sc") val=16
...
;   bc=0x3370 str=1("arena_general.sc") val=12
;   bc=0x3378 str=1("arena_general.sc") val=7
;   bc=0x337c str=1("arena_general.sc") val=8
;   bc=0x33a8 str=1("arena_general.sc") val=9
;   bc=0x33dc str=1("arena_general.sc") val=11
...
; === function 1 (arena_general.sc, line 16) locals=0 ===
func_1:
  0x001c: Call r0, 0x0028  ; arena_general.sc:15
  0x0024: Ret r0  ; arena_general.sc:16
...
; === function 80 (arena_general.sc, line 12) locals=4 ===
func_80:
  0x3378: LoadNullStr2 r0  ; arena_general.sc:7
  0x337c: GetDotStr r2, "hasVariable"  ; pool_off=0xe86  ; arena_general.sc:8
  0x3384: LoadString r3, "Hunter"  ; len=6, pool_off=0x32a
  0x3390: GetDot r1, 1
  0x3398: Free2 r2, r3
  0x33a0: BrZ r1, 0x33dc
  0x33a8: GetDotStr r2, "getVariable"  ; pool_off=0xe92  ; arena_general.sc:9
  ...
  0x33d0: Copy r1, r0
  0x33d8: Free1 r1
  0x33dc: Copy r0, r1  ; arena_general.sc:11
