...
func_3:
  0x0034: GetDotStr r2, "Scene"  ; pool_off=0x0  ; surface_exit_0_2_attic.sc:21
  ...
  0x00ac: GetDotStr r1, "setTimer"  ; pool_off=0x41  ; surface_exit_0_2_attic.sc:23
  0x00b4: LoadInt r2, 0
  0x00bc: LoadInt r3, 5000000
  0x00c4: GetDot r0, 2
  0x00cc: Free2 r1, r0
  0x00d4: GetDotStr r2, "Scene"  ; pool_off=0x0  ; surface_exit_0_2_attic.sc:26
  ...
  0x00fc: Free2 r1, r2
  0x0104: ToStr r0
  0x0108: GetDotStr r3, "World"  ; pool_off=0x7c  ; surface_exit_0_2_attic.sc:27
  0x0110: SetDotRaw r2, 130
  0x0118: Free1 r3
  0x011c: GetDotStr r3, "Scene"  ; pool_off=0x0
  ...
  0x019c: GetDotStr r4, "Scene"  ; pool_off=0x0  ; surface_exit_0_2_attic.sc:30
  ...
  0x01d0: Copy r2, r0
  0x01d8: Free1 r2
  0x01dc: GetDotStr r4, "World"  ; pool_off=0x7c  ; surface_exit_0_2_attic.sc:31
  0x01e4: SetDotRaw r3, 130
  0x01ec: Free1 r4
  0x01f0: GetDotStr r4, "Scene"  ; pool_off=0x0
...
func_4:
  ...
  0x02ac: GetDotStr r2, "Scene"  ; pool_off=0x0  ; surface_exit_0_2_attic.sc:38
  ...
  0x02f4: Free1 r0
  0x02f8: GetDotStr r1, "remove"  ; pool_off=0x13f  ; surface_exit_0_2_attic.sc:39
  0x0300: GetDot r0, 0
  0x0308: Free2 r1, r0
...
func_5:
  ...
  0x0338: GetDotStr r1, "call"  ; pool_off=0x6  ; surface_exit_0_2_attic.sc:48
  ...
  0x0364: GetDotStr r1, "remove"  ; pool_off=0x13f  ; surface_exit_0_2_attic.sc:50
  0x036c: GetDot r0, 0
  0x0374: Free2 r1, r0
