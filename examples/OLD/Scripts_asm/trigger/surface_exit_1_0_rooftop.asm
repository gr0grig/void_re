...
func_3:
  0x0034: GetDotStr r2, "Scene"  ; pool_off=0x0  ; surface_exit_1_0_rooftop.sc:20
  ...
  0x007c: Free1 r0
  0x0080: GetDotStr r1, "!tuple"  ; pool_off=0x35  ; surface_exit_1_0_rooftop.sc:21
  0x0088: GetDotStr r3, "!vec3"  ; pool_off=0x3c
  0x0090: LoadInt r4, 0
  0x0098: LoadInt r5, 0
  0x00a0: LoadInt r6, -1
  0x00a8: GetDot r2, 3
  ...
  0x0114: GetDotStr r3, "Scene"  ; pool_off=0x0  ; surface_exit_1_0_rooftop.sc:25
  ...
  0x013c: Free2 r2, r3
  0x0144: ToStr r1
  0x0148: GetDotStr r4, "World"  ; pool_off=0x9a  ; surface_exit_1_0_rooftop.sc:26
  0x0150: SetDotRaw r3, 160
  0x0158: Free1 r4
  0x015c: GetDotStr r4, "Scene"  ; pool_off=0x0
  ...
  0x01dc: GetDotStr r4, "remove"  ; pool_off=0x111  ; surface_exit_1_0_rooftop.sc:29
  0x01e4: GetDot r3, 0
  0x01ec: Free2 r4, r3
...
func_4:
  ...
  0x0228: GetDotStr r1, "call"  ; pool_off=0x6  ; surface_exit_1_0_rooftop.sc:37
  ...
  0x0254: GetDotStr r1, "remove"  ; pool_off=0x111  ; surface_exit_1_0_rooftop.sc:39
  0x025c: GetDot r0, 0
  0x0264: Free2 r1, r0
