...
func_2:
  0x0028: GetDotStr r1, "trace"  ; pool_off=0x0  ; surface_exit_2_alley.sc:7
...
func_3:
  0x0058: GetDotStr r1, "trace"  ; pool_off=0x0  ; surface_exit_2_alley.sc:12
  0x0060: LoadString r2, "Activate: alley pigeons"  ; len=23, pool_off=0x3a
  0x006c: GetDot r0, 1
  0x0074: Free3 r1, r2, r0
  0x007c: GetDotStr r2, "Scene"  ; pool_off=0x68  ; surface_exit_2_alley.sc:15
  ...
  0x00a4: Free2 r1, r2
  0x00ac: ToStr r0
  0x00b0: GetDotStr r3, "World"  ; pool_off=0xa4  ; surface_exit_2_alley.sc:16
  0x00b8: SetDotRaw r2, 170
  0x00c0: Free1 r3
  0x00c4: GetDotStr r3, "Scene"  ; pool_off=0x68
  ...
  0x0144: GetDotStr r3, "remove"  ; pool_off=0x120  ; surface_exit_2_alley.sc:19
  0x014c: GetDot r2, 0
  0x0154: Free2 r3, r2
