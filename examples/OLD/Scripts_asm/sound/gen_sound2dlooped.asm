...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; pool_off=0x0  ; gen_sound2dlooped.sc:6
  0x0024: ToStr r0
  0x0028: GetDotStr r2, "loadSound"  ; pool_off=0xb  ; gen_sound2dlooped.sc:8
  0x0030: Copy r0, r4
  ...
  0x005c: RetV r2
  0x0060: Free1 r2
  0x0064: GetDotStr r3, "Scene"  ; pool_off=0x15  ; gen_sound2dlooped.sc:11
  0x006c: ToStr r3
  0x0070: Copy r1, r4
...
func_2:
  ...
  0x012c: Free2 r2, r3
  0x0134: ToStr r1
  0x0138: GetDotStr r6, "Globals"  ; pool_off=0x48  ; ..\sound.sci:219
...
func_3:
  0x01b0: GetDotStr r2, "Settings"  ; pool_off=0x5b  ; ..\sound.sci:9
  0x01b8: Copy r-4, r3
...
func_4:
  0x0204: GetDotStr r2, "Scene"  ; pool_off=0x15  ; ..\sound.sci:28
