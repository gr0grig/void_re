...
;   bc=0x00f4 str=2("..\sound.sci") val=312
;   bc=0x00fc str=2("..\sound.sci") val=308
;   bc=0x0124 str=2("..\sound.sci") val=309
;   bc=0x0170 str=2("..\sound.sci") val=310
;   bc=0x01c0 str=2("..\sound.sci") val=311
...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; pool_off=0x0  ; gen_sound3dlooped.sc:6
  0x0024: ToStr r0
  0x0028: GetDotStr r2, "loadSound3D"  ; pool_off=0xb  ; gen_sound3dlooped.sc:8
  0x0030: Copy r0, r4
  ...
  0x006c: GetDotStr r5, "!vec3"  ; pool_off=0x1d
  0x0074: GetDot r4, 0
  0x007c: Free1 r5
  0x0080: ToStr r4
  0x0084: Copy r0, r6
...
; === function 2 (..\sound.sci, line 312) locals=9 ===
func_2:
  0x00fc: LoadString r1, "Master"  ; len=6, pool_off=0x4c  ; ..\sound.sci:308
  0x0108: Call r2, 0x01e0
  0x0110: Copy r-5, r2
  0x0118: Call r3, 0x01e0
  0x0120: Mul r0
  0x0124: GetDotStr r2, "playSound3DLooped"  ; pool_off=0x58  ; ..\sound.sci:309
  0x012c: Copy r-9, r3
  0x0134: Copy r-8, r4
  0x013c: Copy r-7, r5
  0x0144: Copy r-6, r6
  ...
  0x016c: ToStr r1
  0x0170: GetDotStr r6, "Globals"  ; pool_off=0x6a  ; ..\sound.sci:310
  ...
  0x01c0: Copy r1, r2  ; ..\sound.sci:311
...
func_3:
  0x01e8: GetDotStr r2, "Settings"  ; pool_off=0x7d  ; ..\sound.sci:9
  0x01f0: Copy r-4, r3
