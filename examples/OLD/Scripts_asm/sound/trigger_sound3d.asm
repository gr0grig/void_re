...
;   bc=0x0268 str=2("../std.sci") val=129
;   bc=0x0270 str=2("../std.sci") val=128
;   bc=0x02b8 str=2("../std.sci") val=124
;   bc=0x02c0 str=2("../std.sci") val=123
;   bc=0x02ec str=3("..\sound.sci") val=304
;   bc=0x02f4 str=3("..\sound.sci") val=300
;   bc=0x031c str=3("..\sound.sci") val=301
;   bc=0x0368 str=3("..\sound.sci") val=302
;   bc=0x03b8 str=3("..\sound.sci") val=303
...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; pool_off=0x0  ; trigger_sound3d.sc:13
  0x0024: ToStr r0
  ...
  0x0038: RetV r0
  0x003c: Free1 r0
  0x0040: GetDotStr r1, "!vector"  ; pool_off=0xb  ; trigger_sound3d.sc:18
  0x0048: GetDot r0, 0
  0x0050: Free1 r1
  0x0054: ToStr r0
  ...
  0x0074: Free1 r2
  0x0078: GetDotStr r3, "loadSound3D"  ; pool_off=0x17
  ...
  0x00f0: GetDotStr r3, "Position"  ; pool_off=0x29
  0x00f8: Copy r0, r5
  ...
  0x0154: GetDotStr r5, "irandMax"  ; pool_off=0x43
  ...
  0x0188: Free1 r4
  0x018c: ToStr r2
  0x0190: GetDotStr r4, "!vec3"  ; pool_off=0x52
  0x0198: GetDot r3, 0
  0x01a0: Free1 r4
  0x01a4: ToStr r3
  ...
  0x0244: GetDotStr r2, "remove"  ; pool_off=0x81  ; trigger_sound3d.sc:38
  0x024c: GetDot r1, 0
  0x0254: Free2 r2, r1
...
func_2:
  0x0270: GetDotStr r2, "World"  ; pool_off=0x88  ; ../std.sci:128
...
; === function 3 (../std.sci, line 124) locals=2 ===
func_3:
  0x02c0: Copy r-4, r0  ; ../std.sci:123
  0x02c8: Copy r-4, r1
  0x02d0: BOr r0
  0x02d4: Sqrt r0
  0x02d8: ToFloat r0
...
func_4:
  0x02f4: LoadString r1, "Master"  ; len=6, pool_off=0xa8  ; ..\sound.sci:300
  0x0300: Call r2, 0x03d8
  0x0308: Copy r-5, r2
  0x0310: Call r3, 0x03d8
  0x0318: Mul r0
  0x031c: GetDotStr r2, "playSound3D"  ; pool_off=0xb4  ; ..\sound.sci:301
  0x0324: Copy r-9, r3
  0x032c: Copy r-8, r4
  0x0334: Copy r-7, r5
  0x033c: Copy r-6, r6
  ...
  0x0364: ToStr r1
  0x0368: GetDotStr r6, "Globals"  ; pool_off=0xc0  ; ..\sound.sci:302
  ...
  0x03b8: Copy r1, r2  ; ..\sound.sci:303
...
func_5:
  0x03e0: GetDotStr r2, "Settings"  ; pool_off=0xcf  ; ..\sound.sci:9
  0x03e8: Copy r-4, r3
...
func_6:
  0x0434: GetDotStr r2, "Scene"  ; pool_off=0xec  ; ..\sound.sci:28
...
func_7:
  ...
  0x04b8: GetDotStr r1, "remove"  ; pool_off=0x81  ; trigger_sound3d.sc:47
  0x04c0: GetDot r0, 0
  0x04c8: Free2 r1, r0
