...
;   bc=0x0324 str=2("../std.sci") val=129
;   bc=0x032c str=2("../std.sci") val=128
;   bc=0x0374 str=2("../std.sci") val=104
;   bc=0x037c str=2("../std.sci") val=103
;   bc=0x039c str=3("..\sound.sci") val=304
;   bc=0x03a4 str=3("..\sound.sci") val=300
;   bc=0x03cc str=3("..\sound.sci") val=301
;   bc=0x0418 str=3("..\sound.sci") val=302
;   bc=0x0468 str=3("..\sound.sci") val=303
...
;   bc=0x0528 str=2("../std.sci") val=1077
;   bc=0x0530 str=2("../std.sci") val=1069
;   bc=0x0540 str=2("../std.sci") val=1070
;   bc=0x0558 str=2("../std.sci") val=1072
;   bc=0x0560 str=2("../std.sci") val=1073
;   bc=0x0570 str=2("../std.sci") val=1074
;   bc=0x0588 str=2("../std.sci") val=1076
;   bc=0x05ec str=2("../std.sci") val=124
;   bc=0x05f4 str=2("../std.sci") val=123
...
func_1:
  ...
  0x0038: GetDotStr r1, "remove"  ; pool_off=0x0  ; trigger_sound3dperiod.sc:12
  0x0040: GetDot r0, 0
  0x0048: Free2 r1, r0
  0x0050: GetDotStr r0, "Properties"  ; pool_off=0x7  ; trigger_sound3dperiod.sc:14
  0x0058: ToStr r0
  0x005c: CopyGlobRd r0, g0
  0x0064: Free1 r0
  0x0068: GetDotStr r1, "!vector"  ; pool_off=0x12  ; trigger_sound3dperiod.sc:17
  0x0070: GetDot r0, 0
  0x0078: Free1 r1
  0x007c: ToStr r0
  ...
  0x009c: Free1 r2
  0x00a0: GetDotStr r3, "loadSound3D"  ; pool_off=0x1e
  ...
  0x0174: GetDotStr r4, "irandMax"  ; pool_off=0x36
  ...
  0x01a8: Free1 r3
  0x01ac: ToStr r1
  0x01b0: GetDotStr r3, "!vec3"  ; pool_off=0x45
  0x01b8: GetDot r2, 0
  0x01c0: Free1 r3
  0x01c4: ToStr r2
  ...
  0x0258: Free1 r2
  0x025c: GetDotStr r3, "randMax"  ; pool_off=0x37
  ...
  0x029c: GetDotStr r2, "self"  ; pool_off=0x8b  ; trigger_sound3dperiod.sc:37
  0x02a4: ToStr r2
  ...
  0x0304: GetDotStr r1, "remove"  ; pool_off=0x0  ; trigger_sound3dperiod.sc:39
  0x030c: GetDot r0, 0
  0x0314: Free2 r1, r0
...
func_2:
  0x032c: GetDotStr r2, "World"  ; pool_off=0xa0  ; ../std.sci:128
...
func_3:
  0x037c: Copy r-4, r0  ; ../std.sci:103
  0x0384: LoadFloat r1, 1000000.0
  0x038c: Div r0
  0x0390: Copy r0, r4294967291
  0x0398: Ret r0

; === function 4 (..\sound.sci, line 304) locals=9 ===
func_4:
  0x03a4: LoadString r1, "Master"  ; len=6, pool_off=0xc0  ; ..\sound.sci:300
  0x03b0: Call r2, 0x0488
  0x03b8: Copy r-5, r2
  0x03c0: Call r3, 0x0488
  0x03c8: Mul r0
  0x03cc: GetDotStr r2, "playSound3D"  ; pool_off=0xcc  ; ..\sound.sci:301
  0x03d4: Copy r-9, r3
  0x03dc: Copy r-8, r4
  0x03e4: Copy r-7, r5
  0x03ec: Copy r-6, r6
  ...
  0x0414: ToStr r1
  0x0418: GetDotStr r6, "Globals"  ; pool_off=0xd8  ; ..\sound.sci:302
  ...
  0x0468: Copy r1, r2  ; ..\sound.sci:303
...
func_5:
  0x0490: GetDotStr r2, "Settings"  ; pool_off=0xe7  ; ..\sound.sci:9
  0x0498: Copy r-4, r3
...
func_6:
  0x04e4: GetDotStr r2, "Scene"  ; pool_off=0x104  ; ..\sound.sci:28
...
; === function 7 (../std.sci, line 1077) locals=7 ===
func_7:
  0x0530: Copy r-4, r0  ; ../std.sci:1069
  0x0538: BrNZ r0, 0x0558
  0x0540: LoadNullStr r0  ; ../std.sci:1070
  0x0544: Copy r0, r4294967291
  0x054c: Free2 r0, r-4
  0x0554: Ret r0
  0x0558: Call r1, 0x0324  ; ../std.sci:1072
  0x0560: Copy r0, r1  ; ../std.sci:1073
  0x0568: BrNZ r1, 0x0588
  0x0570: LoadNullStr r1  ; ../std.sci:1074
  0x0574: Copy r1, r4294967291
  0x057c: Free3 r1, r0, r-4
  0x0584: Ret r0
  0x0588: GetDotStr r2, "!tuple"  ; pool_off=0x139  ; ../std.sci:1076
  0x0590: Copy r-4, r5
...
func_8:
  0x05f4: Copy r-4, r0  ; ../std.sci:123
  0x05fc: Copy r-4, r1
  0x0604: BOr r0
  0x0608: Sqrt r0
  0x060c: ToFloat r0
...
func_9:
  ...
  0x0660: GetDotStr r1, "remove"  ; pool_off=0x0  ; trigger_sound3dperiod.sc:48
  0x0668: GetDot r0, 0
  0x0670: Free2 r1, r0
