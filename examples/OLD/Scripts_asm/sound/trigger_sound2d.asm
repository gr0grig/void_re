...
;   bc=0x022c str=2("../std.sci") val=129
;   bc=0x0234 str=2("../std.sci") val=128
;   bc=0x027c str=2("../std.sci") val=1077
;   bc=0x0284 str=2("../std.sci") val=1069
;   bc=0x0294 str=2("../std.sci") val=1070
;   bc=0x02ac str=2("../std.sci") val=1072
;   bc=0x02b4 str=2("../std.sci") val=1073
;   bc=0x02c4 str=2("../std.sci") val=1074
;   bc=0x02dc str=2("../std.sci") val=1076
;   bc=0x0340 str=2("../std.sci") val=124
;   bc=0x0348 str=2("../std.sci") val=123
...
func_1:
  0x001c: GetDotStr r0, "Properties"  ; pool_off=0x0  ; trigger_sound2d.sc:11
  0x0024: ToStr r0
  0x0028: CopyGlobRd r0, g0
  0x0030: Free1 r0
  0x0034: CopyGlobWr r0, g0  ; trigger_sound2d.sc:12
  0x003c: BrNZ r0, 0x005c
  0x0044: GetDotStr r1, "remove"  ; pool_off=0xb  ; trigger_sound2d.sc:12
  0x004c: GetDot r0, 0
  0x0054: Free2 r1, r0
  ...
  0x007c: GetDotStr r1, "!vector"  ; pool_off=0x12  ; trigger_sound2d.sc:19
  0x0084: GetDot r0, 0
  0x008c: Free1 r1
  0x0090: ToStr r0
  ...
  0x00b0: Free1 r2
  0x00b4: GetDotStr r3, "loadSound"  ; pool_off=0x1e
  ...
  0x0104: RetV r0
  0x0108: Free1 r0
  0x010c: GetDotStr r2, "self"  ; pool_off=0x28  ; trigger_sound2d.sc:29
  0x0114: ToStr r2
  ...
  0x0150: GetDotStr r1, "Scene"  ; pool_off=0x3e  ; trigger_sound2d.sc:30
  0x0158: ToStr r1
  0x015c: CopyGlobWr r1, g3
  0x0164: GetDotStr r5, "irandMax"  ; pool_off=0x44
  ...
  0x020c: GetDotStr r1, "remove"  ; pool_off=0xb  ; trigger_sound2d.sc:37
  0x0214: GetDot r0, 0
  0x021c: Free2 r1, r0
...
func_2:
  0x0234: GetDotStr r2, "World"  ; pool_off=0x64  ; ../std.sci:128
...
func_3:
  0x0284: Copy r-4, r0  ; ../std.sci:1069
  0x028c: BrNZ r0, 0x02ac
  0x0294: LoadNullStr r0  ; ../std.sci:1070
  0x0298: Copy r0, r4294967291
  0x02a0: Free2 r0, r-4
  0x02a8: Ret r0
  0x02ac: Call r1, 0x022c  ; ../std.sci:1072
  0x02b4: Copy r0, r1  ; ../std.sci:1073
  0x02bc: BrNZ r1, 0x02dc
  0x02c4: LoadNullStr r1  ; ../std.sci:1074
  0x02c8: Copy r1, r4294967291
  0x02d0: Free3 r1, r0, r-4
  0x02d8: Ret r0
  0x02dc: GetDotStr r2, "!tuple"  ; pool_off=0x84  ; ../std.sci:1076
  0x02e4: Copy r-4, r5
...
func_4:
  0x0348: Copy r-4, r0  ; ../std.sci:123
  0x0350: Copy r-4, r1
  0x0358: BOr r0
  0x035c: Sqrt r0
  0x0360: ToFloat r0
...
func_5:
  ...
  0x03d8: Free2 r2, r3
  0x03e0: ToStr r1
  0x03e4: GetDotStr r6, "Globals"  ; pool_off=0xaa  ; ..\sound.sci:211
...
func_6:
  0x045c: GetDotStr r2, "Settings"  ; pool_off=0xb9  ; ..\sound.sci:9
  0x0464: Copy r-4, r3
...
func_7:
  0x04b0: GetDotStr r2, "Scene"  ; pool_off=0x3e  ; ..\sound.sci:28
...
func_8:
  ...
  0x0534: GetDotStr r1, "remove"  ; pool_off=0xb  ; trigger_sound2d.sc:46
  0x053c: GetDot r0, 0
  0x0544: Free2 r1, r0
