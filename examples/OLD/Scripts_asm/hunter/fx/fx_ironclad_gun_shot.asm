...
;   bc=0x0820 str=3("../../std.sci") val=129
;   bc=0x0828 str=3("../../std.sci") val=128
;   bc=0x0870 str=3("../../std.sci") val=124
;   bc=0x0878 str=3("../../std.sci") val=123
;   bc=0x08a4 str=3("../../std.sci") val=222
;   bc=0x08ac str=3("../../std.sci") val=218
;   bc=0x08cc str=3("../../std.sci") val=219
;   bc=0x08e8 str=3("../../std.sci") val=220
;   bc=0x0900 str=3("../../std.sci") val=217
...
;   bc=0x0b74 str=3("../../std.sci") val=104
;   bc=0x0b7c str=3("../../std.sci") val=103
...
func_2:
  ...
  0x00bc: GetDotStr r1, "!qtpair"  ; pool_off=0x59  ; fx_ironclad_gun_shot.sc:48
  0x00c4: GetDot r0, 0
  0x00cc: Free1 r1
  0x00d0: ToStr r0
  0x00d4: GetDotStr r1, "Position"  ; pool_off=0x61  ; fx_ironclad_gun_shot.sc:49
  0x00dc: Copy r0, r2
  0x00e4: SetInd r2
  0x00e8: LoadInt r0, 106
  0x00f0: Free2 r2, r1
  0x00f8: GetDotStr r3, "World"  ; pool_off=0x76  ; fx_ironclad_gun_shot.sc:50
  0x0100: SetDotRaw r2, 124
  0x0108: Free1 r3
  0x010c: GetDotStr r3, "Scene"  ; pool_off=0x91
...
func_3:
  ...
  0x01ec: GetDotStr r2, "!vec3"  ; pool_off=0x11e  ; fx_ironclad_gun_shot.sc:93
  0x01f4: GetDot r1, 0
  0x01fc: Free1 r2
  0x0200: CallMethod r1, 292, 0x14a
  0x020c: GetDotStr r2, "!vec3"  ; pool_off=0x11e  ; fx_ironclad_gun_shot.sc:94
  0x0214: GetDot r1, 0
  0x021c: Free1 r2
...
func_4:
  ...
  0x0300: Free1 r4
  0x0304: GetDotStr r4, "Position"  ; pool_off=0x61
  0x030c: Sub r3
  0x0310: ToStr r3
  ...
  0x03e0: GetDotStr r10, "irandMax"  ; pool_off=0x1b1
  ...
  0x04a0: GetDotStr r3, "!qtpair"  ; pool_off=0x59  ; fx_ironclad_gun_shot.sc:130
  0x04a8: GetDot r2, 0
  0x04b0: Free1 r3
  0x04b4: ToStr r2
  0x04b8: GetDotStr r3, "Position"  ; pool_off=0x61  ; fx_ironclad_gun_shot.sc:131
  0x04c0: Copy r2, r4
  0x04c8: SetInd r4
  ...
  0x04ec: Free1 r5
  0x04f0: GetDotStr r5, "Scene"  ; pool_off=0x91
  ...
  0x066c: GetDotStr r5, "remove"  ; pool_off=0x1ea  ; fx_ironclad_gun_shot.sc:146
  0x0674: GetDot r4, 0
  0x067c: Free2 r5, r4
...
func_5:
  ...
  0x06c0: Mul r0
  0x06c4: GetDotStr r2, "playSound3D"  ; pool_off=0x1fd  ; ..\..\sound.sci:259
  0x06cc: Copy r-8, r3
  0x06d4: Copy r-7, r4
  0x06dc: Copy r-6, r5
  0x06e4: Copy r-5, r6
  ...
  0x070c: ToStr r1
  0x0710: GetDotStr r6, "Globals"  ; pool_off=0x209  ; ..\..\sound.sci:260
...
func_6:
  0x0788: GetDotStr r2, "Settings"  ; pool_off=0x21c  ; ..\..\sound.sci:9
  0x0790: Copy r-4, r3
...
func_7:
  0x07dc: GetDotStr r2, "Scene"  ; pool_off=0x91  ; ..\..\sound.sci:28
...
func_8:
  0x0828: GetDotStr r2, "World"  ; pool_off=0x76  ; ../../std.sci:128
...
func_9:
  0x0878: Copy r-4, r0  ; ../../std.sci:123
  0x0880: Copy r-4, r1
  0x0888: BOr r0
  0x088c: Sqrt r0
  0x0890: ToFloat r0
...
; === function 10 (../../std.sci, line 222) locals=3 ===
func_10:
...
func_11:
  0x0910: GetDotStr r1, "Position"  ; pool_off=0x61  ; fx_ironclad_gun_shot.sc:63
  ...
  0x0964: Copy r1, r0
  0x096c: GetDotStr r3, "!vec3"  ; pool_off=0x11e  ; fx_ironclad_gun_shot.sc:65
  0x0974: CopyGlobWr r2, g5
  0x097c: SetDotRaw r4, 77
  0x0984: Free1 r5
  0x0988: GetDotStr r6, "Position"  ; pool_off=0x61
  ...
  0x09b8: Free1 r7
  0x09bc: GetDotStr r8, "Position"  ; pool_off=0x61
  ...
  0x09f0: GetDotStr r3, "!vec3"  ; pool_off=0x11e  ; fx_ironclad_gun_shot.sc:66
  0x09f8: CopyGlobWr r2, g5
  0x0a00: SetDotRaw r4, 77
  0x0a08: Free1 r5
  0x0a0c: GetDotStr r6, "Position"  ; pool_off=0x61
  ...
  0x0a3c: Free1 r7
  0x0a40: GetDotStr r8, "Position"  ; pool_off=0x61
  ...
  0x0a68: Inv r2
  0x0a6c: ToStr r2
  0x0a70: GetDotStr r4, "applyForce"  ; pool_off=0x27f  ; fx_ironclad_gun_shot.sc:68
  0x0a78: GetDotStr r5, "Mass"  ; pool_off=0x28a
  0x0a80: Copy r2, r6
  0x0a88: Mul r5
  0x0a8c: Copy r1, r6
  0x0a94: Mul r5
  ...
  0x0ad8: LoadString r0, ""  ; len=1610, pool_off=0x541, GARBLED
  0x0ae4: ToInt r5
  ...
  0x0b48: GetDotStr r3, "Position"  ; pool_off=0x61  ; fx_ironclad_gun_shot.sc:79
  0x0b50: CopyGlobWr r0, g4
  0x0b58: SetInd r4
  0x0b5c: LoadString r0, ""  ; len=97, pool_off=0x44b, GARBLED
  0x0b68: LoadString r0, ""  ; len=68, pool_off=0xad4, GARBLED  ; @patch+4 fx_ironclad_gun_shot.sc:71

; === function 12 (../../std.sci, line 104) locals=2 ===
func_12:
  0x0b7c: Copy r-4, r0  ; ../../std.sci:103
