...
;   bc=0x0970 str=2("../../std.sci") val=104
;   bc=0x0978 str=2("../../std.sci") val=103
;   bc=0x0998 str=2("../../std.sci") val=42
;   bc=0x09a0 str=2("../../std.sci") val=40
;   bc=0x09f0 str=2("../../std.sci") val=41
;   bc=0x0a30 str=2("../../std.sci") val=42
; func_table (36 bytes):
...
func_1:
  ...
  0x0040: GetDotStr r1, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_decal.sc:12
  0x0048: Copy r0, r2
  0x0050: Sub r1
  0x0054: CallMethod r1, 0, 0x14a
  0x0060: GetDotStr r0, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_decal.sc:10
  0x0068: LoadFloat r1, 0.0
  0x0070: CmpGt r0
  0x0074: BrNZ r0, 0x002c
  0x007c: GetDotStr r2, "World"  ; pool_off=0x11  ; fx_driller_decal.sc:16
  0x0084: SetDotRaw r1, 23
  0x008c: Free1 r2
  0x0090: GetDotStr r2, "Scene"  ; pool_off=0x28
  0x0098: LoadString r3, "hunter_06_driller_breakPlaneOuter.pre"  ; len=37, pool_off=0x2e
  0x00a4: GetDotStr r4, "Transform"  ; pool_off=0x78
  ...
  0x00dc: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x00e4: ToStr r1
  0x00e8: LoadInt r2, 20
  0x00f0: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x00f8: GetDot r3, 0
  0x0100: Free1 r4
  0x0104: Mul r2
  ...
  0x0138: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x0140: ToStr r1
  0x0144: LoadInt r2, 20
  0x014c: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x0154: GetDot r3, 0
  0x015c: Free1 r4
  0x0160: Mul r2
  ...
  0x0194: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x019c: ToStr r1
  0x01a0: LoadInt r2, 20
  0x01a8: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x01b0: GetDot r3, 0
  0x01b8: Free1 r4
  0x01bc: Mul r2
  ...
  0x01f0: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x01f8: ToStr r1
  0x01fc: LoadInt r2, 20
  0x0204: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x020c: GetDot r3, 0
  0x0214: Free1 r4
  0x0218: Mul r2
  ...
  0x024c: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x0254: ToStr r1
  0x0258: LoadInt r2, 20
  0x0260: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x0268: GetDot r3, 0
  0x0270: Free1 r4
  0x0274: Mul r2
  ...
  0x02a8: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x02b0: ToStr r1
  0x02b4: LoadInt r2, 20
  0x02bc: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x02c4: GetDot r3, 0
  0x02cc: Free1 r4
  0x02d0: Mul r2
  ...
  0x0304: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x030c: ToStr r1
  0x0310: LoadInt r2, 20
  0x0318: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x0320: GetDot r3, 0
  0x0328: Free1 r4
  0x032c: Mul r2
  ...
  0x0360: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x0368: ToStr r1
  0x036c: LoadInt r2, 20
  0x0374: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x037c: GetDot r3, 0
  0x0384: Free1 r4
  0x0388: Mul r2
  ...
  0x03bc: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x03c4: ToStr r1
  0x03c8: LoadInt r2, 20
  0x03d0: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x03d8: GetDot r3, 0
  0x03e0: Free1 r4
  0x03e4: Mul r2
  ...
  0x0418: GetDotStr r1, "Transform"  ; pool_off=0x78
  0x0420: ToStr r1
  0x0424: LoadInt r2, 20
  0x042c: GetDotStr r4, "rand"  ; pool_off=0xcc
  0x0434: GetDot r3, 0
  0x043c: Free1 r4
  0x0440: Mul r2
  ...
  0x048c: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:34
  0x0494: GetDot r1, 0
  0x049c: Free1 r2
  ...
  0x04c0: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x04c8: ToStr r2
  0x04cc: LoadInt r3, 20
  0x04d4: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x04dc: GetDot r4, 0
  0x04e4: Free1 r5
  0x04e8: Mul r3
  ...
  0x0518: Incr r1
  0x051c: Copy r1, r0
  0x0524: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:35
  0x052c: GetDot r1, 0
  0x0534: Free1 r2
  ...
  0x0558: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x0560: ToStr r2
  0x0564: LoadInt r3, 20
  0x056c: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x0574: GetDot r4, 0
  0x057c: Free1 r5
  0x0580: Mul r3
  ...
  0x05b0: Incr r1
  0x05b4: Copy r1, r0
  0x05bc: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:36
  0x05c4: GetDot r1, 0
  0x05cc: Free1 r2
  ...
  0x05f0: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x05f8: ToStr r2
  0x05fc: LoadInt r3, 20
  0x0604: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x060c: GetDot r4, 0
  0x0614: Free1 r5
  0x0618: Mul r3
  ...
  0x0648: Incr r1
  0x064c: Copy r1, r0
  0x0654: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:37
  0x065c: GetDot r1, 0
  0x0664: Free1 r2
  ...
  0x0688: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x0690: ToStr r2
  0x0694: LoadInt r3, 20
  0x069c: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x06a4: GetDot r4, 0
  0x06ac: Free1 r5
  0x06b0: Mul r3
  ...
  0x06e0: Incr r1
  0x06e4: Copy r1, r0
  0x06ec: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:38
  0x06f4: GetDot r1, 0
  0x06fc: Free1 r2
  ...
  0x0720: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x0728: ToStr r2
  0x072c: LoadInt r3, 20
  0x0734: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x073c: GetDot r4, 0
  0x0744: Free1 r5
  0x0748: Mul r3
  ...
  0x0778: Incr r1
  0x077c: Copy r1, r0
  0x0784: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:39
  0x078c: GetDot r1, 0
  0x0794: Free1 r2
  ...
  0x07b8: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x07c0: ToStr r2
  0x07c4: LoadInt r3, 20
  0x07cc: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x07d4: GetDot r4, 0
  0x07dc: Free1 r5
  0x07e0: Mul r3
  ...
  0x0810: Incr r1
  0x0814: Copy r1, r0
  0x081c: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:40
  0x0824: GetDot r1, 0
  0x082c: Free1 r2
  ...
  0x0850: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x0858: ToStr r2
  0x085c: LoadInt r3, 20
  0x0864: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x086c: GetDot r4, 0
  0x0874: Free1 r5
  0x0878: Mul r3
  ...
  0x08a8: Incr r1
  0x08ac: Copy r1, r0
  0x08b4: GetDotStr r2, "rand"  ; pool_off=0xcc  ; fx_driller_decal.sc:41
  0x08bc: GetDot r1, 0
  0x08c4: Free1 r2
  ...
  0x08e8: GetDotStr r2, "Transform"  ; pool_off=0x78
  0x08f0: ToStr r2
  0x08f4: LoadInt r3, 20
  0x08fc: GetDotStr r5, "rand"  ; pool_off=0xcc
  0x0904: GetDot r4, 0
  0x090c: Free1 r5
  0x0910: Mul r3
  ...
  0x0954: GetDotStr r1, "remove"  ; pool_off=0x58b  ; fx_driller_decal.sc:44
  0x095c: GetDot r0, 0
  0x0964: Free2 r1, r0
...
func_2:
  0x0978: Copy r-4, r0  ; ../../std.sci:103
  0x0980: LoadFloat r1, 1000000.0
  0x0988: Div r0
  0x098c: Copy r0, r4294967291
  0x0994: Ret r0

; === function 3 (../../std.sci, line 42) locals=6 ===
func_3:
  0x09a0: GetDotStr r2, "World"  ; pool_off=0x11  ; ../../std.sci:40
  0x09a8: SetDotRaw r1, 23
  0x09b0: Free1 r2
  0x09b4: GetDotStr r2, "Scene"  ; pool_off=0x28
  0x09bc: Copy r-6, r3
  0x09c4: Copy r-5, r4
  ...
  0x0a30: Free3 r0, r-5, r-6  ; ../../std.sci:42
  0x0a38: Ret r0
