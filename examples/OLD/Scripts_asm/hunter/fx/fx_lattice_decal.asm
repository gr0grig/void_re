...
;   bc=0x01d4 str=2("../../std.sci") val=104
;   bc=0x01dc str=2("../../std.sci") val=103
...
func_1:
  ...
  0x0058: BOr r0
  0x005c: GetDotStr r1, "setKinematic"  ; pool_off=0x3b  ; fx_lattice_decal.sc:12
  ...
  0x00ac: GetDot r0, 3
  0x00b4: Free1 r1
  0x00b8: GetDotStr r1, "Rotation"  ; pool_off=0x5d
  0x00c0: Mul r0
  0x00c4: ToStr r0
  0x00c8: GetDotStr r2, "setRotation"  ; pool_off=0x66  ; fx_lattice_decal.sc:17
  0x00d0: GetDotStr r4, "!rotateY"  ; pool_off=0x72
  0x00d8: Copy r0, r6
  ...
  0x0138: GetDotStr r2, "GeomTransparency"  ; pool_off=0x2a  ; fx_lattice_decal.sc:21
  0x0140: Copy r1, r3
  0x0148: Sub r2
  0x014c: CallMethod r2, 42, 0x24a
  0x0158: GetDotStr r1, "GeomTransparency"  ; pool_off=0x2a  ; fx_lattice_decal.sc:19
  0x0160: LoadInt r2, 0
  0x0168: CmpGt r1
...
func_2:
  0x01dc: Copy r-4, r0  ; ../../std.sci:103
...
func_3:
  ...
  0x0218: GetDotStr r1, "GeomTransparency"  ; pool_off=0x2a  ; fx_lattice_decal.sc:38
  0x0220: Copy r0, r2
  0x0228: Add r1
  0x022c: CallMethod r1, 42, 0x14a
  0x0238: GetDotStr r0, "GeomTransparency"  ; pool_off=0x2a  ; fx_lattice_decal.sc:36
  0x0240: LoadInt r1, 1
  0x0248: CmpLt r0
  0x024c: BrNZ r0, 0x0204
  0x0254: GetDotStr r1, "remove"  ; pool_off=0x7f  ; fx_lattice_decal.sc:40
  0x025c: GetDot r0, 0
  0x0264: Free2 r1, r0
