...
;   bc=0x0080 str=2("../../std.sci") val=104
;   bc=0x0088 str=2("../../std.sci") val=103
...
;   bc=0x014c str=2("../../std.sci") val=222
;   bc=0x0154 str=2("../../std.sci") val=218
;   bc=0x0174 str=2("../../std.sci") val=219
;   bc=0x0190 str=2("../../std.sci") val=220
;   bc=0x01a8 str=2("../../std.sci") val=217
...
func_1:
  ...
  0x0040: GetDotStr r1, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_bump.sc:9
  0x0048: Copy r0, r2
  0x0050: Sub r1
  0x0054: CallMethod r1, 0, 0x14a
  0x0060: GetDotStr r0, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_bump.sc:7
...
func_2:
  0x0088: Copy r-4, r0  ; ../../std.sci:103
...
func_4:
  ...
  0x00f4: GetDotStr r1, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_bump.sc:32
  0x00fc: Copy r0, r2
  0x0104: Add r1
  0x0108: CallMethod r1, 0, 0x14a
  0x0114: GetDotStr r0, "GeomTransparency"  ; pool_off=0x0  ; fx_driller_bump.sc:30
  0x011c: LoadFloat r1, 1.0
  0x0124: CmpLt r0
  0x0128: BrNZ r0, 0x00e0
  0x0130: GetDotStr r1, "remove"  ; pool_off=0x11  ; fx_driller_bump.sc:35
  0x0138: GetDot r0, 0
  0x0140: Free2 r1, r0
...
func_5:
  0x0154: Copy r-4, r0  ; ../../std.sci:218
  0x015c: Free1 r2
  0x0160: RetV r1
  0x0164: Sub r0
  0x0168: ToInt r0
  0x016c: Copy r0, r4294967292
  0x0174: Copy r-4, r0  ; ../../std.sci:219
  0x017c: LoadInt r1, 0
  0x0184: CmpLe r0
  0x0188: BrZ r0, 0x01a8
  0x0190: Copy r-4, r0  ; ../../std.sci:220
  0x0198: Neg r0
  0x019c: Copy r0, r4294967291
  0x01a4: Ret r0
  0x01a8: Jmp r0, 0x0154  ; ../../std.sci:217

; === function 6 (remove, fx_driller_bump.sc, line 21) locals=3 ===
func_6:
  0x01b8: GetDotStr r1, "setPosition"  ; pool_off=0x18  ; fx_driller_bump.sc:20
  0x01c0: Copy r-4, r2
  0x01c8: GetDot r0, 1
