...
;   bc=0x0228 str=2("../../std.sci") val=104
;   bc=0x0230 str=2("../../std.sci") val=103
;   bc=0x0250 str=2("../../std.sci") val=124
;   bc=0x0258 str=2("../../std.sci") val=123
...
func_1:
  ...
  0x003c: GetDotStr r0, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:47
  0x0044: ToStr r0
  0x0048: CopyGlobRd r0, g3
  0x0050: Free1 r0
  0x0054: GetDotStr r0, "AngularVelocity"  ; pool_off=0x26  ; hunter_05_whaler_head_phys.sc:48
  0x005c: ToStr r0
...
func_5:
  ...
  0x0118: GetDotStr r1, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:177
  0x0120: ToStr r1
  ...
  0x017c: Add r2
  0x0180: ToFloat r2
  0x0184: GetDotStr r4, "setRotation"  ; pool_off=0x3a  ; hunter_05_whaler_head_phys.sc:179
  0x018c: GetDotStr r6, "!rotateY"  ; pool_off=0x46
  0x0194: Copy r2, r7
  0x019c: GetDot r5, 1
  0x01a4: Free1 r6
  0x01a8: GetDot r3, 1
  ...
  0x01c8: GetDotStr r4, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:183
  0x01d0: ToStr r4
  0x01d4: Call r5, 0x0250
  0x01dc: LoadFloat r4, 0.05000000074505806
  0x01e4: CmpGe r3
  0x01e8: BrZ r3, 0x021c
  0x01f0: GetDotStr r3, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:184
  0x01f8: GetDotStr r4, "LinearVelocity"  ; pool_off=0x17
  0x0200: Copy r0, r5
  0x0208: Mul r4
  0x020c: Sub r3
...
func_6:
  0x0230: Copy r-4, r0  ; ../../std.sci:103
  0x0238: LoadFloat r1, 1000000.0
  0x0240: Div r0
  0x0244: Copy r0, r4294967291
  0x024c: Ret r0

; === function 7 (../../std.sci, line 124) locals=2 ===
func_7:
  0x0258: Copy r-4, r0  ; ../../std.sci:123
  0x0260: Copy r-4, r1
  0x0268: BOr r0
  0x026c: Sqrt r0
  0x0270: ToFloat r0
...
func_8:
  ...
  0x0294: GetDotStr r1, "Position"  ; pool_off=0x4f
  0x029c: Sub r0
  0x02a0: ToStr r0
  ...
  0x02d8: GetDotStr r4, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:230
  0x02e0: LoadInt r5, 0
  0x02e8: LoadInt r6, 0
  0x02f0: LoadInt r7, 0
  0x02f8: GetDot r3, 3
  0x0300: Free1 r4
  0x0304: ToStr r3
  0x0308: GetDotStr r4, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:233
  0x0310: ToStr r4
  ...
  0x036c: Add r5
  0x0370: ToFloat r5
  0x0374: GetDotStr r7, "setRotation"  ; pool_off=0x3a  ; hunter_05_whaler_head_phys.sc:235
  0x037c: GetDotStr r9, "!rotateY"  ; pool_off=0x46
  0x0384: Copy r5, r10
  0x038c: GetDot r8, 1
  0x0394: Free1 r9
  0x0398: GetDot r6, 1
  ...
  0x0438: Div r9
  0x043c: Mul r8
  0x0440: GetDotStr r9, "Mass"  ; pool_off=0x5e
  0x0448: Mul r8
  0x044c: Add r7
  0x0450: ToStr r7
  0x0454: Copy r7, r3
  0x045c: Free1 r7
  0x0460: GetDotStr r8, "applyForce"  ; pool_off=0x63  ; hunter_05_whaler_head_phys.sc:242
  0x0468: Copy r3, r9
  0x0470: Copy r2, r10
  0x0478: LoadFloat r11, 1.6666666269302368
  0x0480: Mul r10
  0x0484: GetDotStr r11, "LinearVelocity"  ; pool_off=0x17
  0x048c: Mul r10
  0x0490: GetDotStr r11, "Mass"  ; pool_off=0x5e
  0x0498: Mul r10
  0x049c: Sub r9
  0x04a0: GetDot r7, 1
  0x04a8: Free3 r8, r9, r7
  0x04b0: Copy r-5, r7  ; hunter_05_whaler_head_phys.sc:246
  0x04b8: GetDotStr r8, "Position"  ; pool_off=0x4f
  0x04c0: Sub r7
  0x04c4: ToStr r7
...
func_9:
  0x0508: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:200
  0x0510: LoadInt r2, 0
  0x0518: LoadInt r3, 0
  0x0520: LoadInt r4, 0
  0x0528: GetDot r0, 3
  ...
  0x0540: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:201
  0x0548: LoadInt r2, 0
  0x0550: LoadInt r3, 0
  0x0558: LoadInt r4, 0
  0x0560: GetDot r0, 3
...
func_12:
  ...
  0x0624: Div r3
  0x0628: Mul r2
  0x062c: GetDotStr r3, "Mass"  ; pool_off=0x5e
  0x0634: Mul r2
  0x0638: Add r1
  0x063c: ToStr r1
  0x0640: Copy r1, r4294967292
  0x0648: Free1 r1
  0x064c: GetDotStr r2, "applyForce"  ; pool_off=0x63  ; hunter_05_whaler_head_phys.sc:33
  0x0654: Copy r-4, r3
  0x065c: CopyGlobWr r1, g4
  0x0664: LoadFloat r5, 1.6666666269302368
  0x066c: Mul r4
  0x0670: GetDotStr r5, "LinearVelocity"  ; pool_off=0x17
  0x0678: Mul r4
  0x067c: GetDotStr r5, "Mass"  ; pool_off=0x5e
  0x0684: Mul r4
  0x0688: Sub r3
  0x068c: GetDot r1, 1
  0x0694: Free3 r2, r3, r1
  0x069c: GetDotStr r2, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:35
  0x06a4: ToStr r2
  ...
  0x06cc: GetDotStr r2, "LinearVelocity"  ; pool_off=0x17
  0x06d4: Inv r2
  0x06d8: Mul r1
...
func_13:
  0x06f8: GetDotStr r1, "setPosition"  ; pool_off=0x6e  ; hunter_05_whaler_head_phys.sc:59
  0x0700: Copy r-4, r2
  0x0708: GetDot r0, 1
...
func_14:
  0x0728: GetDotStr r0, "Position"  ; pool_off=0x4f  ; hunter_05_whaler_head_phys.sc:66
  0x0730: ToStr r0
...
func_15:
  ...
  0x0754: Inv r0
  0x0758: GetDotStr r2, "LinearVelocity"  ; pool_off=0x17
  0x0760: ToStr r2
...
func_16:
  0x078c: GetDotStr r0, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:80
  0x0794: ToStr r0
...
func_19:
  0x0860: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:103
  0x0868: LoadInt r2, 0
  0x0870: LoadInt r3, 0
  0x0878: LoadInt r4, 0
  0x0880: GetDot r0, 3
  ...
  0x0898: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:104
  0x08a0: LoadInt r2, 0
  0x08a8: LoadInt r3, 0
  0x08b0: LoadInt r4, 0
  0x08b8: GetDot r0, 3
...
func_20:
  0x08e8: GetDotStr r0, "LinearVelocity"  ; pool_off=0x17  ; hunter_05_whaler_head_phys.sc:114
  0x08f0: ToStr r0
  0x08f4: CopyGlobRd r0, g3
  0x08fc: Free1 r0
  0x0900: GetDotStr r0, "AngularVelocity"  ; pool_off=0x26  ; hunter_05_whaler_head_phys.sc:115
  0x0908: ToStr r0
  0x090c: CopyGlobRd r0, g4
  0x0914: Free1 r0
  0x0918: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:117
  0x0920: LoadInt r2, 0
  0x0928: LoadInt r3, 0
  0x0930: LoadInt r4, 0
  0x0938: GetDot r0, 3
  ...
  0x0950: GetDotStr r1, "!vec3"  ; pool_off=0x58  ; hunter_05_whaler_head_phys.sc:118
  0x0958: LoadInt r2, 0
  0x0960: LoadInt r3, 0
  0x0968: LoadInt r4, 0
  0x0970: GetDot r0, 3
...
func_24:
  0x0a18: GetDotStr r1, "remove"  ; pool_off=0x8f  ; hunter_05_whaler_head_phys.sc:131
  0x0a20: GetDot r0, 0
  0x0a28: Free2 r1, r0
...
func_27:
  ...
  0x0a70: CallMethod r0, 8, 0x140  ; @patch+8 hunter_05_whaler_head_phys.sc:272
  0x0a7c: .dword 0x000000ec  ; UNKNOWN opcode 0xec
  0x0a80: LoadBool r0, 0x3e  ; @patch+4 hunter_05_whaler_head_phys.sc:273
