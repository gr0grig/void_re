...
;   bc=0x0110 str=2("../std.sci") val=222
;   bc=0x0118 str=2("../std.sci") val=218
;   bc=0x0138 str=2("../std.sci") val=219
;   bc=0x0154 str=2("../std.sci") val=220
;   bc=0x016c str=2("../std.sci") val=217
...
;   bc=0x01ec str=2("../std.sci") val=104
;   bc=0x01f4 str=2("../std.sci") val=103
...
func_1:
  0x001c: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; ps_hunter_09_piper_teleport_in.sc:7
  0x0024: LoadInt r2, 0
  0x002c: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x0038: LoadInt r4, 5
  0x0040: GetDot r0, 3
  0x0048: Free3 r1, r3, r0
  0x0050: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; ps_hunter_09_piper_teleport_in.sc:8
  0x0058: LoadInt r2, 1
  ...
  0x0094: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; ps_hunter_09_piper_teleport_in.sc:12
  0x009c: LoadInt r2, 0
  0x00a4: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x00b0: LoadInt r4, 65535
  0x00b8: GetDot r0, 3
  0x00c0: Free3 r1, r3, r0
  0x00c8: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; ps_hunter_09_piper_teleport_in.sc:13
  0x00d0: LoadInt r2, 1
...
func_2:
  0x0118: Copy r-4, r0  ; ../std.sci:218
  0x0120: Free1 r2
  0x0124: RetV r1
  0x0128: Sub r0
  0x012c: ToInt r0
  0x0130: Copy r0, r4294967292
  0x0138: Copy r-4, r0  ; ../std.sci:219
  0x0140: LoadInt r1, 0
  0x0148: CmpLe r0
  0x014c: BrZ r0, 0x016c
  0x0154: Copy r-4, r0  ; ../std.sci:220
  0x015c: Neg r0
  0x0160: Copy r0, r4294967291
  0x0168: Ret r0
  0x016c: Jmp r0, 0x0118  ; ../std.sci:217
...
func_3:
  ...
  0x01d0: GetDotStr r2, "remove"  ; pool_off=0x23  ; ps_hunter_09_piper_teleport_in.sc:27
  0x01d8: GetDot r1, 0
  0x01e0: Free2 r2, r1
...
func_4:
  0x01f4: Copy r-4, r0  ; ../std.sci:103
