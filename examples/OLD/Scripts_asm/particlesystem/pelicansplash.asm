...
;   bc=0x0120 str=2("../std.sci") val=222
;   bc=0x0128 str=2("../std.sci") val=218
;   bc=0x0148 str=2("../std.sci") val=219
;   bc=0x0164 str=2("../std.sci") val=220
;   bc=0x017c str=2("../std.sci") val=217
...
func_3:
  ...
  0x00a0: GetDotStr r3, "EmmiterCount"  ; pool_off=0x0
  0x00a8: CmpLt r2
  0x00ac: BrZ r2, 0x0104
  0x00b4: GetDotStr r3, "setSysParameterFloat"  ; pool_off=0xd  ; pelicansplash.sc:38
  0x00bc: Copy r1, r4
...
func_4:
  0x0128: Copy r-4, r0  ; ../std.sci:218
  0x0130: Free1 r2
  0x0134: RetV r1
  0x0138: Sub r0
  0x013c: ToInt r0
  0x0140: Copy r0, r4294967292
  0x0148: Copy r-4, r0  ; ../std.sci:219
  0x0150: LoadInt r1, 0
  0x0158: CmpLe r0
  0x015c: BrZ r0, 0x017c
  0x0164: Copy r-4, r0  ; ../std.sci:220
  0x016c: Neg r0
  0x0170: Copy r0, r4294967291
  0x0178: Ret r0
  0x017c: Jmp r0, 0x0128  ; ../std.sci:217
...
func_5:
  ...
  0x01d8: GetDotStr r2, "remove"  ; pool_off=0x30  ; pelicansplash.sc:54
  0x01e0: GetDot r1, 0
  0x01e8: Free2 r2, r1
