...
;   bc=0x02e0 str=2("../std.sci") val=104
;   bc=0x02e8 str=2("../std.sci") val=103
...
func_1:
  ...
  0x0054: ToFloat r1
  0x0058: GetDotStr r3, "setSysParameterFloat"  ; pool_off=0x0  ; ps_driller_smoke.sc:14
  0x0060: LoadInt r4, 0
  ...
  0x00d8: GetDotStr r5, "!vec3"  ; pool_off=0x23  ; ps_driller_smoke.sc:18
  0x00e0: Copy r3, r6
  0x00e8: Copy r2, r7
  0x00f0: Cos r7
  0x00f4: Mul r6
  ...
  0x0120: Free1 r5
  0x0124: ToStr r4
  0x0128: GetDotStr r6, "addEmmiterPoint"  ; pool_off=0x29  ; ps_driller_smoke.sc:19
  0x0130: LoadInt r7, 0
  0x0138: Copy r4, r8
  0x0140: LoadInt r9, 1
  0x0148: GetDot r5, 3
  ...
  0x01e0: GetDotStr r3, "setSysParameterFloat"  ; pool_off=0x0  ; ps_driller_smoke.sc:27
  0x01e8: LoadInt r4, 0
  ...
  0x0268: GetDotStr r4, "setSysParameterFloat"  ; pool_off=0x0  ; ps_driller_smoke.sc:33
  0x0270: LoadInt r5, 0
  ...
  0x02a4: GetDotStr r4, "setSysParameterFloat"  ; pool_off=0x0  ; ps_driller_smoke.sc:36
  0x02ac: LoadInt r5, 0
...
func_2:
  0x02e8: Copy r-4, r0  ; ../std.sci:103
