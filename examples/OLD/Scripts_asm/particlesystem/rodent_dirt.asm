...
;   bc=0x015c str=2("../std.sci") val=222
;   bc=0x0164 str=2("../std.sci") val=218
;   bc=0x0184 str=2("../std.sci") val=219
;   bc=0x01a0 str=2("../std.sci") val=220
;   bc=0x01b8 str=2("../std.sci") val=217
; func_table (36 bytes):
...
func_1:
  ...
  0x0098: Mul r3
  0x009c: Add r2
  0x00a0: GetDotStr r4, "setSysParameterFloat"  ; pool_off=0x0  ; rodent_dirt.sc:14
  0x00a8: LoadInt r5, 0
  ...
  0x00fc: GetDotStr r2, "setSysParameterFloat"  ; pool_off=0x0  ; rodent_dirt.sc:18
  0x0104: LoadInt r3, 0
  ...
  0x0140: GetDotStr r2, "remove"  ; pool_off=0x23  ; rodent_dirt.sc:20
  0x0148: GetDot r1, 0
  0x0150: Free2 r2, r1
...
func_2:
  0x0164: Copy r-4, r0  ; ../std.sci:218
  0x016c: Free1 r2
  0x0170: RetV r1
  0x0174: Sub r0
  0x0178: ToInt r0
  0x017c: Copy r0, r4294967292
  0x0184: Copy r-4, r0  ; ../std.sci:219
  0x018c: LoadInt r1, 0
  0x0194: CmpLe r0
  0x0198: BrZ r0, 0x01b8
  0x01a0: Copy r-4, r0  ; ../std.sci:220
  0x01a8: Neg r0
  0x01ac: Copy r0, r4294967291
  0x01b4: Ret r0
  0x01b8: Jmp r0, 0x0164  ; ../std.sci:217
