...
;   bc=0x013c str=2("../std.sci") val=222
;   bc=0x0144 str=2("../std.sci") val=218
;   bc=0x0164 str=2("../std.sci") val=219
;   bc=0x0180 str=2("../std.sci") val=220
;   bc=0x0198 str=2("../std.sci") val=217
; func_table (36 bytes):
...
func_1:
  0x001c: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; firework.sc:5
  0x0024: LoadInt r2, 0
  0x002c: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x0038: LoadInt r4, 1
  0x0040: GetDot r0, 3
  0x0048: Free3 r1, r3, r0
  0x0050: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; firework.sc:6
  0x0058: LoadInt r2, 1
  ...
  0x00a8: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; firework.sc:11
  0x00b0: LoadInt r2, 0
  0x00b8: LoadString r3, "PPeriod"  ; len=7, pool_off=0x15
  0x00c4: LoadInt r4, 10000000
  0x00cc: GetDot r0, 3
  0x00d4: Free3 r1, r3, r0
  0x00dc: GetDotStr r1, "setSysParameterFloat"  ; pool_off=0x0  ; firework.sc:12
  0x00e4: LoadInt r2, 1
  ...
  0x0120: GetDotStr r1, "remove"  ; pool_off=0x2e  ; firework.sc:15
  0x0128: GetDot r0, 0
  0x0130: Free2 r1, r0
...
func_2:
  0x0144: Copy r-4, r0  ; ../std.sci:218
  0x014c: Free1 r2
  0x0150: RetV r1
  0x0154: Sub r0
  0x0158: ToInt r0
  0x015c: Copy r0, r4294967292
  0x0164: Copy r-4, r0  ; ../std.sci:219
  0x016c: LoadInt r1, 0
  0x0174: CmpLe r0
  0x0178: BrZ r0, 0x0198
  0x0180: Copy r-4, r0  ; ../std.sci:220
  0x0188: Neg r0
  0x018c: Copy r0, r4294967291
  0x0194: Ret r0
  0x0198: Jmp r0, 0x0144  ; ../std.sci:217
