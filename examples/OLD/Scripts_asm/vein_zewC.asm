...
;   bc=0x075c str=2("vein_zewC.sc") val=38
;   bc=0x0764 str=2("vein_zewC.sc") val=36
;   bc=0x078c str=2("vein_zewC.sc") val=37
;   bc=0x07ec str=2("vein_zewC.sc") val=38
...
;   bc=0x0b80 str=2("vein_zewC.sc") val=25
;   bc=0x0b88 str=2("vein_zewC.sc") val=16
;   bc=0x0b8c str=2("vein_zewC.sc") val=17
;   bc=0x0bec str=2("vein_zewC.sc") val=18
;   bc=0x0c28 str=2("vein_zewC.sc") val=19
;   bc=0x0c88 str=2("vein_zewC.sc") val=20
;   bc=0x0cc4 str=2("vein_zewC.sc") val=21
;   bc=0x0d24 str=2("vein_zewC.sc") val=22
;   bc=0x0d60 str=2("vein_zewC.sc") val=23
;   bc=0x0dc0 str=2("vein_zewC.sc") val=24
;   bc=0x0dfc str=2("vein_zewC.sc") val=25
...
func_1:
  ...
  0x003c: LoadBool r0, 0xffffffff  ; @patch+4 vein_zewC.sc:12
  0x0044: LoadString r0, "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine..."  ; len=327, pool_off=0x8, GARBLED  ; @patch+4 vein_zewC.sc:7
  0x0050: GetDot r0, 0
  0x0058: Free1 r1
  0x005c: ToStr r0
...
; === function 3 (getVeinLimfaType, vein_zewC.sc, line 31) locals=6 ===
func_3:
  0x0350: GetDotStr r1, "findMaterial"  ; pool_off=0x1bb  ; vein_zewC.sc:29
  0x0358: LoadString r2, "Material #4"  ; len=11, pool_off=0x1c8
  0x0364: GetDot r0, 1
  0x036c: Free2 r1, r2
  0x0374: ToInt r0
  0x0378: GetDotStr r2, "setLocalGeomParameterColor"  ; pool_off=0x1de  ; vein_zewC.sc:30
  0x0380: Copy r0, r3
...
; === function 14 (vein_zewC.sc, line 38) locals=9 ===
func_14:
  0x0764: GetDotStr r1, "findMaterial"  ; pool_off=0x1bb  ; vein_zewC.sc:36
  0x076c: LoadString r2, "Material #4"  ; len=11, pool_off=0x1c8
  0x0778: GetDot r0, 1
  0x0780: Free2 r1, r2
  0x0788: ToInt r0
  0x078c: GetDotStr r2, "setLocalGeomParameterFloat"  ; pool_off=0x250  ; vein_zewC.sc:37
  0x0794: Copy r0, r3
...
; === function 23 (vein_zewC.sc, line 25) locals=7 ===
func_23:
  0x0b88: LoadNullStr2 r0  ; vein_zewC.sc:16
  0x0b8c: GetDotStr r3, "World"  ; pool_off=0x175  ; vein_zewC.sc:17
  0x0b94: SetDotRaw r2, 702
  0x0b9c: Free1 r3
  0x0ba0: GetDotStr r3, "Scene"  ; pool_off=0x130
  0x0ba8: LoadString r4, "minewalls/minewall_zewC_part1.pre"  ; len=33, pool_off=0x28
  ...
  0x0be0: Copy r1, r0
  0x0be8: Free1 r1
  0x0bec: Copy r0, r3  ; vein_zewC.sc:18
  ...
  0x0c28: GetDotStr r3, "World"  ; pool_off=0x175  ; vein_zewC.sc:19
  0x0c30: SetDotRaw r2, 702
  0x0c38: Free1 r3
  0x0c3c: GetDotStr r3, "Scene"  ; pool_off=0x130
  0x0c44: LoadString r4, "minewalls/minewall_zewC_part2.pre"  ; len=33, pool_off=0x6a
  ...
  0x0c7c: Copy r1, r0
  0x0c84: Free1 r1
  0x0c88: Copy r0, r3  ; vein_zewC.sc:20
  ...
  0x0cc4: GetDotStr r3, "World"  ; pool_off=0x175  ; vein_zewC.sc:21
  0x0ccc: SetDotRaw r2, 702
  0x0cd4: Free1 r3
  0x0cd8: GetDotStr r3, "Scene"  ; pool_off=0x130
  0x0ce0: LoadString r4, "minewalls/minewall_zewC_part3.pre"  ; len=33, pool_off=0xac
  ...
  0x0d18: Copy r1, r0
  0x0d20: Free1 r1
  0x0d24: Copy r0, r3  ; vein_zewC.sc:22
  ...
  0x0d60: GetDotStr r3, "World"  ; pool_off=0x175  ; vein_zewC.sc:23
  0x0d68: SetDotRaw r2, 702
  0x0d70: Free1 r3
  0x0d74: GetDotStr r3, "Scene"  ; pool_off=0x130
  0x0d7c: LoadString r4, "minewalls/minewall_zewC_part4.pre"  ; len=33, pool_off=0xee
  ...
  0x0db4: Copy r1, r0
  0x0dbc: Free1 r1
  0x0dc0: Copy r0, r3  ; vein_zewC.sc:24
  ...
  0x0dfc: Free2 r0, r-4  ; vein_zewC.sc:25
  0x0e04: Ret r0
