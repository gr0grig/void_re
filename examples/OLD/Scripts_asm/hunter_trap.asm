...
;   bc=0x010c str=1("hunter_trap.sc") val=94
;   bc=0x0114 str=1("hunter_trap.sc") val=93
;   bc=0x0128 str=1("hunter_trap.sc") val=112
;   bc=0x0130 str=1("hunter_trap.sc") val=98
;   bc=0x01b8 str=1("hunter_trap.sc") val=99
;   bc=0x01c8 str=1("hunter_trap.sc") val=101
;   bc=0x01f4 str=1("hunter_trap.sc") val=102
;   bc=0x0254 str=1("hunter_trap.sc") val=104
;   bc=0x02d4 str=1("hunter_trap.sc") val=106
;   bc=0x02e4 str=1("hunter_trap.sc") val=107
;   bc=0x02ec str=1("hunter_trap.sc") val=107
;   bc=0x0308 str=1("hunter_trap.sc") val=108
;   bc=0x034c str=1("hunter_trap.sc") val=107
;   bc=0x0368 str=1("hunter_trap.sc") val=110
;   bc=0x0378 str=1("hunter_trap.sc") val=111
;   bc=0x03a4 str=1("hunter_trap.sc") val=112
...
;   bc=0x05bc str=1("hunter_trap.sc") val=86
...
;   bc=0x075c str=1("hunter_trap.sc") val=77
;   bc=0x0790 str=1("hunter_trap.sc") val=80
;   bc=0x07c4 str=1("hunter_trap.sc") val=81
;   bc=0x0850 str=1("hunter_trap.sc") val=82
;   bc=0x08dc str=1("hunter_trap.sc") val=84
;   bc=0x093c str=1("hunter_trap.sc") val=79
;   bc=0x0940 str=1("hunter_trap.sc") val=86
...
;   bc=0x0a68 str=1("hunter_trap.sc") val=52
;   bc=0x0a70 str=1("hunter_trap.sc") val=52
;   bc=0x0a74 str=1("hunter_trap.sc") val=13
;   bc=0x0a7c str=1("hunter_trap.sc") val=12
;   bc=0x0a94 str=1("hunter_trap.sc") val=28
;   bc=0x0a9c str=1("hunter_trap.sc") val=17
;   bc=0x0acc str=1("hunter_trap.sc") val=18
;   bc=0x0adc str=1("hunter_trap.sc") val=19
;   bc=0x0af0 str=1("hunter_trap.sc") val=21
;   bc=0x0b24 str=1("hunter_trap.sc") val=22
;   bc=0x0b28 str=1("hunter_trap.sc") val=23
;   bc=0x0b60 str=1("hunter_trap.sc") val=24
;   bc=0x0b8c str=1("hunter_trap.sc") val=27
; func_names:
;   0=getUseDistance
;   2=getUseDistance
;   8=getUseDistance
...
func_1:
  ...
  0x0020: RetV r0
  0x0024: Free1 r0
  0x0028: GetDotStr r2, "Scene"  ; pool_off=0x0  ; hunter_trap.sc:39
  ...
  0x0100: CallNat r2, func=2664, info=0x0  ; hunter_trap.sc:45

; === function 2 (getUseDistance, hunter_trap.sc, line 94) locals=1 ===
func_2:
  0x0114: LoadBool r0, true  ; hunter_trap.sc:93
  0x011c: Copy r0, r4294967292
  0x0124: Ret r0

; === function 3 (hunter_trap.sc, line 112) locals=9 ===
func_3:
  0x0130: GetDotStr r2, "loadSound3D"  ; pool_off=0x4d  ; hunter_trap.sc:98
  ...
  0x01b4: Free1 r0
  0x01b8: CopyGlobWr r2, g0  ; hunter_trap.sc:99
  0x01c0: Call r1, 0x04f0
  0x01c8: GetDotStr r1, "!qtpair"  ; pool_off=0x8f  ; hunter_trap.sc:101
  0x01d0: GetDotStr r2, "Rotation"  ; pool_off=0x97
  0x01d8: GetDotStr r3, "Position"  ; pool_off=0xa0
  0x01e0: GetDot r0, 2
  0x01e8: Free3 r1, r2, r3
  0x01f0: ToStr r0
  0x01f4: GetDotStr r3, "World"  ; pool_off=0xa9  ; hunter_trap.sc:102
  ...
  0x0250: Free1 r1
  0x0254: CopyGlobWr r1, g3  ; hunter_trap.sc:104
  ...
  0x02cc: Free1 r3
  0x02d0: ToInt r1
  0x02d4: Copy r1, r3  ; hunter_trap.sc:106
  0x02dc: Call r4, 0x053c
  0x02e4: LoadInt r3, 0  ; hunter_trap.sc:107
  0x02ec: Copy r3, r4  ; hunter_trap.sc:107
  0x02f4: LoadInt r5, 3
  0x02fc: CmpLt r4
  0x0300: BrZ r4, 0x0368
  0x0308: CopyGlobWr r0, g6  ; hunter_trap.sc:108
  ...
  0x034c: Copy r3, r4  ; hunter_trap.sc:107
  0x0354: Incr r4
  0x0358: Copy r4, r3
  0x0360: Jmp r0, 0x02ec
  0x0368: Copy r-4, r3  ; hunter_trap.sc:110
  0x0370: BrZ r3, 0x03a4
  0x0378: CopyGlobWr r0, g5  ; hunter_trap.sc:111
  0x0380: SetDotRaw r4, 307
  0x0388: Free1 r5
  0x038c: LoadInt r5, 25000000
  0x0394: GetDot r3, 1
  0x039c: Free2 r4, r3
  0x03a4: Free2 r2, r0  ; hunter_trap.sc:112
  0x03ac: Ret r0
...
func_7:
  0x0544: GetDotStr r5, "World"  ; pool_off=0xa9  ; hunter_trap.sc:32
...
; === function 8 (getUseDistance, hunter_trap.sc, line 86) locals=11 ===
func_8:
  ...
  0x06cc: Free1 r5
  0x06d0: GetDotStr r4, "Scene"  ; pool_off=0x0  ; hunter_trap.sc:68
  0x06d8: ToStr r4
  ...
  0x075c: Copy r0, r3  ; hunter_trap.sc:77
  0x0764: Copy r2, r4
  0x076c: Sub r3
  ...
  0x078c: Free1 r5
  0x0790: GetDotStr r5, "World"  ; pool_off=0xa9  ; hunter_trap.sc:80
  ...
  0x07b8: Free2 r4, r5
  0x07c0: ToStr r3
  0x07c4: Copy r3, r7  ; hunter_trap.sc:81
  ...
  0x0848: Free2 r6, r4
  0x0850: Copy r3, r7  ; hunter_trap.sc:82
  ...
  0x08d4: Free2 r6, r4
  0x08dc: GetDotStr r6, "Scene"  ; pool_off=0x0  ; hunter_trap.sc:84
  ...
  0x093c: Free1 r3  ; hunter_trap.sc:79
  0x0940: Free1 r-6  ; hunter_trap.sc:86
  0x0944: Ret r0
...
func_11:
  0x0a70: Ret r0  ; hunter_trap.sc:52

; === function 12 (isHunterTrap, hunter_trap.sc, line 13) locals=1 ===
func_12:
  0x0a7c: LoadInt r0, 3  ; hunter_trap.sc:12
  0x0a84: ToFloat r0
...
func_13:
  0x0a9c: GetDotStr r1, "callDef"  ; pool_off=0x280  ; hunter_trap.sc:17
  0x0aa4: LoadBool r2, false
  0x0aac: LoadString r3, "isActive"  ; len=8, pool_off=0x288
  0x0ab8: GetDot r0, 2
  0x0ac0: Free2 r1, r3
  0x0ac8: ToBool r0
  0x0acc: Copy r0, r1  ; hunter_trap.sc:18
  0x0ad4: BrZ r1, 0x0af0
  0x0adc: LoadNullStr r1  ; hunter_trap.sc:19
  0x0ae0: Copy r1, r4294967292
  0x0ae8: Free1 r1
  0x0aec: Ret r0
  0x0af0: GetDotStr r3, "Scene"  ; pool_off=0x0  ; hunter_trap.sc:21
  ...
  0x0b18: Free2 r2, r3
  0x0b20: ToStr r1
  0x0b24: LoadIntZero r2  ; hunter_trap.sc:22
  0x0b28: Copy r1, r5  ; hunter_trap.sc:23
  ...
  0x0b60: Copy r1, r4  ; hunter_trap.sc:24
  0x0b68: LoadString r5, "HunterTrapLimfa"  ; len=15, pool_off=0xe0
  0x0b74: SetDot r3, 1
  0x0b7c: Free1 r5
  0x0b80: ToInt r3
  0x0b84: Copy r3, r2
  0x0b8c: GetDotStr r4, "!tuple"  ; pool_off=0x298  ; hunter_trap.sc:27
  0x0b94: Copy r2, r5
  0x0b9c: Copy r1, r7
