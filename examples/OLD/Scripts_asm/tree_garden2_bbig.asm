...
;   bc=0x15e8 str=4("tree_garden2_bbig.sc") val=16
;   bc=0x15f0 str=4("tree_garden2_bbig.sc") val=11
;   bc=0x1600 str=4("tree_garden2_bbig.sc") val=12
;   bc=0x162c str=4("tree_garden2_bbig.sc") val=13
;   bc=0x168c str=4("tree_garden2_bbig.sc") val=14
;   bc=0x169c str=4("tree_garden2_bbig.sc") val=11
;   bc=0x16a0 str=4("tree_garden2_bbig.sc") val=16
;   bc=0x16a4 str=4("tree_garden2_bbig.sc") val=25
;   bc=0x16ac str=4("tree_garden2_bbig.sc") val=20
;   bc=0x1720 str=4("tree_garden2_bbig.sc") val=21
;   bc=0x1764 str=4("tree_garden2_bbig.sc") val=22
;   bc=0x17a8 str=4("tree_garden2_bbig.sc") val=23
;   bc=0x17ec str=4("tree_garden2_bbig.sc") val=24
;   bc=0x1830 str=4("tree_garden2_bbig.sc") val=25
;   bc=0x1838 str=4("tree_garden2_bbig.sc") val=33
;   bc=0x1840 str=4("tree_garden2_bbig.sc") val=29
;   bc=0x1850 str=4("tree_garden2_bbig.sc") val=30
;   bc=0x187c str=4("tree_garden2_bbig.sc") val=29
;   bc=0x1880 str=4("tree_garden2_bbig.sc") val=33
;   bc=0x1884 str=4("tree_garden2_bbig.sc") val=40
;   bc=0x188c str=4("tree_garden2_bbig.sc") val=37
;   bc=0x18f4 str=4("tree_garden2_bbig.sc") val=38
;   bc=0x1910 str=4("tree_garden2_bbig.sc") val=40
...
;   bc=0x1b80 str=4("tree_garden2_bbig.sc") val=49
;   bc=0x1b88 str=4("tree_garden2_bbig.sc") val=44
;   bc=0x1b98 str=4("tree_garden2_bbig.sc") val=45
;   bc=0x1bc4 str=4("tree_garden2_bbig.sc") val=47
;   bc=0x1bd4 str=4("tree_garden2_bbig.sc") val=48
;   bc=0x1c00 str=4("tree_garden2_bbig.sc") val=49
...
;   bc=0x2770 str=4("tree_garden2_bbig.sc") val=7
;   bc=0x2778 str=4("tree_garden2_bbig.sc") val=6
...
; === function 15 (tree_garden2_bbig.sc, line 16) locals=7 ===
func_15:
  0x15f0: CopyGlobWr r9, g0  ; tree_garden2_bbig.sc:11
  0x15f8: BrNZ r0, 0x16a0
  0x1600: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_garden2_bbig.sc:12
  0x1608: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1610: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1618: GetDot r0, 2
  0x1620: Free3 r1, r2, r3
  0x1628: ToStr r0
  0x162c: GetDotStr r3, "World"  ; pool_off=0xa6  ; tree_garden2_bbig.sc:13
  0x1634: SetDotRaw r2, 936
  0x163c: Free1 r3
  0x1640: GetDotStr r3, "Scene"  ; pool_off=0x1e
  0x1648: LoadString r4, "ps_Trunk_TreeBBigFruit.ps"  ; len=25, pool_off=0x3bd
  0x1654: Copy r0, r5
  ...
  0x1688: Free1 r1
  0x168c: Copy r-4, r1  ; tree_garden2_bbig.sc:14
  0x1694: Call r2, 0x16a4
  0x169c: Free1 r0  ; tree_garden2_bbig.sc:11
  0x16a0: Ret r0  ; tree_garden2_bbig.sc:16

; === function 16 (tree_garden2_bbig.sc, line 25) locals=7 ===
func_16:
  0x16ac: Copy r-4, r0  ; tree_garden2_bbig.sc:20
  ...
  0x1718: Mul r0
  0x171c: ToStr r0
  0x1720: CopyGlobWr r9, g3  ; tree_garden2_bbig.sc:21
  ...
  0x1764: CopyGlobWr r9, g3  ; tree_garden2_bbig.sc:22
  ...
  0x17a8: CopyGlobWr r9, g3  ; tree_garden2_bbig.sc:23
  ...
  0x17ec: CopyGlobWr r9, g3  ; tree_garden2_bbig.sc:24
  ...
  0x1830: Free1 r0  ; tree_garden2_bbig.sc:25
  0x1834: Ret r0

; === function 17 (tree_garden2_bbig.sc, line 33) locals=4 ===
func_17:
  0x1840: CopyGlobWr r10, g0  ; tree_garden2_bbig.sc:29
  0x1848: BrNZ r0, 0x1880
  0x1850: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_garden2_bbig.sc:30
  0x1858: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1860: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1868: GetDot r0, 2
  0x1870: Free3 r1, r2, r3
  0x1878: ToStr r0
  0x187c: Free1 r0  ; tree_garden2_bbig.sc:29
  0x1880: Ret r0  ; tree_garden2_bbig.sc:33

; === function 18 (tree_garden2_bbig.sc, line 40) locals=6 ===
func_18:
  0x188c: GetDotStr r5, "World"  ; pool_off=0xa6  ; tree_garden2_bbig.sc:37
  ...
  0x18ec: Free1 r1
  0x18f0: ToStr r0
  0x18f4: CopyGlobWr r7, g1  ; tree_garden2_bbig.sc:38
  0x18fc: ToFloat r1
  0x1900: CopyGlobWr r11, g2
  0x1908: ToFloat r2
  0x190c: Div r1
  0x1910: Free1 r0  ; tree_garden2_bbig.sc:40
  0x1914: Ret r0
...
; === function 22 (tree_garden2_bbig.sc, line 49) locals=3 ===
func_22:
  0x1b88: CopyGlobWr r10, g0  ; tree_garden2_bbig.sc:44
  0x1b90: BrZ r0, 0x1bc4
  0x1b98: CopyGlobWr r10, g2  ; tree_garden2_bbig.sc:45
  0x1ba0: SetDotRaw r1, 784
  0x1ba8: Free1 r2
  0x1bac: Copy r-4, r2
  0x1bb4: GetDot r0, 1
  0x1bbc: Free2 r1, r0
  0x1bc4: CopyGlobWr r9, g0  ; tree_garden2_bbig.sc:47
  0x1bcc: BrZ r0, 0x1c00
  0x1bd4: CopyGlobWr r9, g2  ; tree_garden2_bbig.sc:48
  0x1bdc: SetDotRaw r1, 784
  0x1be4: Free1 r2
  0x1be8: Copy r-4, r2
  0x1bf0: GetDot r0, 1
  0x1bf8: Free2 r1, r0
  0x1c00: Ret r0  ; tree_garden2_bbig.sc:49
...
; === function 30 (tree_garden2_bbig.sc, line 7) locals=1 ===
func_30:
  0x2778: LoadInt r0, 3  ; tree_garden2_bbig.sc:6
  0x2780: ToFloat r0
