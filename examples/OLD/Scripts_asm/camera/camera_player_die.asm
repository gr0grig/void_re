...
;   bc=0x02ec str=2("../std.sci") val=104
;   bc=0x02f4 str=2("../std.sci") val=103
...
func_2:
  0x0030: GetDotStr r1, "!qtpair"  ; pool_off=0x0  ; camera_player_die.sc:16
  0x0038: GetDot r0, 0
  0x0040: Free1 r1
  0x0044: ToStr r0
...
func_3:
  ...
  0x00ec: ToFloat r0
  0x00f0: GetDotStr r2, "!rotateX"  ; pool_off=0x26  ; camera_player_die.sc:29
  ...
  0x0124: Free1 r2
  0x0128: ToStr r1
  0x012c: GetDotStr r3, "!rotateY"  ; pool_off=0x2f  ; camera_player_die.sc:30
  ...
  0x0160: Free1 r3
  0x0164: ToStr r2
  0x0168: GetDotStr r4, "!rotateZ"  ; pool_off=0x38  ; camera_player_die.sc:31
  ...
  0x01c0: Add r4
  0x01c4: Copy r4, r0
  0x01cc: GetDotStr r5, "!lookAt"  ; pool_off=0x41  ; camera_player_die.sc:35
  0x01d4: Copy r-5, r7
  ...
  0x022c: GetDotStr r9, "!vec3"  ; pool_off=0x6d
...
func_4:
  0x02f4: Copy r-4, r0  ; ../std.sci:103
