...
func_1:
  0x001c: GetDotStr r1, "loadAnimationSet"  ; pool_off=0x0  ; camera_final.sc:7
...
func_3:
  0x0070: GetDotStr r1, "!vector"  ; pool_off=0x4d  ; camera_final.sc:26
  0x0078: GetDot r0, 0
  0x0080: Free1 r1
  0x0084: ToStr r0
  ...
  0x0950: GetDotStr r3, "playAnimation"  ; pool_off=0x4df  ; camera_final.sc:102
  0x0958: Copy r0, r5
  0x0960: Copy r1, r6
  0x0968: SetDot r4, 1
  0x0970: GetDot r2, 1
