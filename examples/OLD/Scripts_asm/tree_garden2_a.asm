...
;   bc=0x15e8 str=4("tree_garden2_a.sc") val=16
;   bc=0x15f0 str=4("tree_garden2_a.sc") val=11
;   bc=0x1600 str=4("tree_garden2_a.sc") val=12
;   bc=0x162c str=4("tree_garden2_a.sc") val=13
;   bc=0x168c str=4("tree_garden2_a.sc") val=14
;   bc=0x169c str=4("tree_garden2_a.sc") val=11
;   bc=0x16a0 str=4("tree_garden2_a.sc") val=16
;   bc=0x16a4 str=4("tree_garden2_a.sc") val=25
;   bc=0x16ac str=4("tree_garden2_a.sc") val=20
;   bc=0x1720 str=4("tree_garden2_a.sc") val=21
;   bc=0x1764 str=4("tree_garden2_a.sc") val=22
;   bc=0x17a8 str=4("tree_garden2_a.sc") val=23
;   bc=0x17ec str=4("tree_garden2_a.sc") val=24
;   bc=0x1830 str=4("tree_garden2_a.sc") val=25
;   bc=0x1838 str=4("tree_garden2_a.sc") val=33
;   bc=0x1840 str=4("tree_garden2_a.sc") val=29
;   bc=0x1850 str=4("tree_garden2_a.sc") val=30
;   bc=0x187c str=4("tree_garden2_a.sc") val=29
;   bc=0x1880 str=4("tree_garden2_a.sc") val=33
;   bc=0x1884 str=4("tree_garden2_a.sc") val=40
;   bc=0x188c str=4("tree_garden2_a.sc") val=37
;   bc=0x18f4 str=4("tree_garden2_a.sc") val=38
;   bc=0x1910 str=4("tree_garden2_a.sc") val=40
...
;   bc=0x1b80 str=4("tree_garden2_a.sc") val=49
;   bc=0x1b88 str=4("tree_garden2_a.sc") val=44
;   bc=0x1b98 str=4("tree_garden2_a.sc") val=45
;   bc=0x1bc4 str=4("tree_garden2_a.sc") val=47
;   bc=0x1bd4 str=4("tree_garden2_a.sc") val=48
;   bc=0x1c00 str=4("tree_garden2_a.sc") val=49
...
;   bc=0x2770 str=4("tree_garden2_a.sc") val=7
;   bc=0x2778 str=4("tree_garden2_a.sc") val=6
...
; === function 15 (tree_garden2_a.sc, line 16) locals=7 ===
func_15:
  0x15f0: CopyGlobWr r9, g0  ; tree_garden2_a.sc:11
  0x15f8: BrNZ r0, 0x16a0
  0x1600: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_garden2_a.sc:12
  0x1608: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1610: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1618: GetDot r0, 2
  0x1620: Free3 r1, r2, r3
  0x1628: ToStr r0
  0x162c: GetDotStr r3, "World"  ; pool_off=0xa6  ; tree_garden2_a.sc:13
  0x1634: SetDotRaw r2, 936
  0x163c: Free1 r3
  0x1640: GetDotStr r3, "Scene"  ; pool_off=0x1e
  0x1648: LoadString r4, "ps_Trunk_TreeAFruit.ps"  ; len=22, pool_off=0x3bd
  0x1654: Copy r0, r5
  ...
  0x1688: Free1 r1
  0x168c: Copy r-4, r1  ; tree_garden2_a.sc:14
  0x1694: Call r2, 0x16a4
  0x169c: Free1 r0  ; tree_garden2_a.sc:11
  0x16a0: Ret r0  ; tree_garden2_a.sc:16

; === function 16 (tree_garden2_a.sc, line 25) locals=7 ===
func_16:
  0x16ac: Copy r-4, r0  ; tree_garden2_a.sc:20
  ...
  0x1718: Mul r0
  0x171c: ToStr r0
  0x1720: CopyGlobWr r9, g3  ; tree_garden2_a.sc:21
  ...
  0x1764: CopyGlobWr r9, g3  ; tree_garden2_a.sc:22
  ...
  0x17a8: CopyGlobWr r9, g3  ; tree_garden2_a.sc:23
  ...
  0x17ec: CopyGlobWr r9, g3  ; tree_garden2_a.sc:24
  ...
  0x1830: Free1 r0  ; tree_garden2_a.sc:25
  0x1834: Ret r0

; === function 17 (tree_garden2_a.sc, line 33) locals=4 ===
func_17:
  0x1840: CopyGlobWr r10, g0  ; tree_garden2_a.sc:29
  0x1848: BrNZ r0, 0x1880
  0x1850: GetDotStr r1, "!qtpair"  ; pool_off=0x38e  ; tree_garden2_a.sc:30
  0x1858: GetDotStr r2, "Rotation"  ; pool_off=0x396
  0x1860: GetDotStr r3, "Position"  ; pool_off=0x39f
  0x1868: GetDot r0, 2
  0x1870: Free3 r1, r2, r3
  0x1878: ToStr r0
  0x187c: Free1 r0  ; tree_garden2_a.sc:29
  0x1880: Ret r0  ; tree_garden2_a.sc:33

; === function 18 (tree_garden2_a.sc, line 40) locals=6 ===
func_18:
  0x188c: GetDotStr r5, "World"  ; pool_off=0xa6  ; tree_garden2_a.sc:37
  ...
  0x18ec: Free1 r1
  0x18f0: ToStr r0
  0x18f4: CopyGlobWr r7, g1  ; tree_garden2_a.sc:38
  0x18fc: ToFloat r1
  0x1900: CopyGlobWr r11, g2
  0x1908: ToFloat r2
  0x190c: Div r1
  0x1910: Free1 r0  ; tree_garden2_a.sc:40
  0x1914: Ret r0
...
func_19:
  ...
  0x193c: Free1 r4
  0x1940: LoadString r4, "Gameplay"  ; len=8, pool_off=0x40d
  0x194c: GetDot r2, 1
  0x1954: Free2 r3, r4
  0x195c: SetDotRaw r1, 1053
  0x1964: Free1 r2
  ...
  0x1994: Free1 r5
  0x1998: LoadString r5, "Gameplay"  ; len=8, pool_off=0x40d
  0x19a4: GetDot r3, 1
  0x19ac: Free2 r4, r5
  0x19b4: SetDotRaw r2, 1077
  0x19bc: Free1 r3
...
; === function 22 (tree_garden2_a.sc, line 49) locals=3 ===
func_22:
  0x1b88: CopyGlobWr r10, g0  ; tree_garden2_a.sc:44
  0x1b90: BrZ r0, 0x1bc4
  0x1b98: CopyGlobWr r10, g2  ; tree_garden2_a.sc:45
  0x1ba0: SetDotRaw r1, 784
  0x1ba8: Free1 r2
  0x1bac: Copy r-4, r2
  0x1bb4: GetDot r0, 1
  0x1bbc: Free2 r1, r0
  0x1bc4: CopyGlobWr r9, g0  ; tree_garden2_a.sc:47
  0x1bcc: BrZ r0, 0x1c00
  0x1bd4: CopyGlobWr r9, g2  ; tree_garden2_a.sc:48
  0x1bdc: SetDotRaw r1, 784
  0x1be4: Free1 r2
  0x1be8: Copy r-4, r2
  0x1bf0: GetDot r0, 1
  0x1bf8: Free2 r1, r0
  0x1c00: Ret r0  ; tree_garden2_a.sc:49
...
func_24:
  ...
  0x1ce4: LoadString r3, "Inserted into tree limfa amount: "  ; len=33, pool_off=0x45b
  0x1cf0: Copy r-4, r4
  0x1cf8: Copy r0, r5
  0x1d00: Mul r4
  0x1d04: AsString r4
  ...
  0x1d24: LoadString r3, "Actuall used limfa amount (due to inspiration): "  ; len=48, pool_off=0x49d
  0x1d30: Copy r-4, r4
  0x1d38: AsString r4
  0x1d3c: Add r3
  0x1d40: GetDot r1, 1
  ...
  0x1d80: GetDotStr r4, "getGestureName"  ; pool_off=0x4fd
  0x1d88: LoadString r5, "player"  ; len=6, pool_off=0x50c
  0x1d94: Copy r-6, r6
  0x1d9c: GetDot r3, 2
  0x1da4: Free2 r4, r5
  0x1dac: LoadString r4, "gesture_donor"  ; len=13, pool_off=0x518
  0x1db8: CmpNe r3
  ...
  0x1df0: Free1 r6
  0x1df4: LoadString r6, "Gameplay"  ; len=8, pool_off=0x40d
  0x1e00: GetDot r4, 1
  0x1e08: Free2 r5, r6
  0x1e10: SetDotRaw r3, 1330
  0x1e18: Free1 r4
  ...
  0x1e60: Free1 r4
  0x1e64: LoadString r4, "showDonorHelp"  ; len=13, pool_off=0x548
  0x1e70: GetDot r2, 1
  ...
  0x1f1c: Copy r2, r4
  0x1f24: SetInd r4
  0x1f28: LoadString r0, "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀..."  ; len=119, pool_off=0x44a, GARBLED
  0x1f34: LoadInt r3, 0  ; tree_base.sci:158
  0x1f3c: Copy r2, r4
  0x1f44: SetInd r4
  0x1f48: LoadString r0, "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀..."  ; len=113, pool_off=0x44a, GARBLED
  0x1f54: Copy r-4, r3  ; tree_base.sci:159
  0x1f5c: Copy r0, r4
  0x1f64: Mul r3
  0x1f68: Copy r2, r4
  0x1f70: SetInd r4
  0x1f74: LoadString r0, "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀..."  ; len=195, pool_off=0x44a, GARBLED
  ...
  0x208c: Free1 r7
  0x2090: LoadString r7, "tabooViolation"  ; len=14, pool_off=0x573
  0x209c: Copy r-5, r8
  0x20a4: Copy r-4, r9
  0x20ac: GetDot r5, 3
...
func_25:
  ...
  0x2298: Free1 r7
  0x229c: LoadString r7, "Gameplay"  ; len=8, pool_off=0x40d
  0x22a8: GetDot r5, 1
  0x22b0: Free2 r6, r7
  0x22b8: SetDotRaw r4, 1457
  0x22c0: Free1 r5
...
func_26:
  0x230c: GetDotStr r1, "irandMax"  ; pool_off=0x5c8  ; tree_base.sci:51
  0x2314: LoadInt r2, 3
  0x231c: GetDot r0, 1
  0x2324: Free1 r1
  0x2328: ToInt r0
...
func_27:
  0x237c: GetDotStr r1, "irandMax"  ; pool_off=0x5c8  ; tree_base.sci:45
  0x2384: LoadInt r2, 3
  0x238c: GetDot r0, 1
  0x2394: Free1 r1
  0x2398: ToInt r0
...
func_28:
  0x23ec: GetDotStr r1, "irandMax"  ; pool_off=0x5c8  ; tree_base.sci:39
  0x23f4: LoadInt r2, 3
  0x23fc: GetDot r0, 1
  0x2404: Free1 r1
  0x2408: ToInt r0
...
; === function 30 (tree_garden2_a.sc, line 7) locals=1 ===
func_30:
  0x2778: LoadInt r0, 3  ; tree_garden2_a.sc:6
  0x2780: ToFloat r0
...
func_32:
  ...
  0x27e4: Free1 r3
  0x27e8: LoadString r3, "activateTree"  ; len=12, pool_off=0x5d1
...
func_35:
  0x2884: GetDotStr r1, "!vector"  ; pool_off=0x5e9  ; gameplay.sci:402
  0x288c: GetDot r0, 0
  0x2894: Free1 r1
  0x2898: ToStr r0
