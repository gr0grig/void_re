...
;   bc=0x0294 str=2("../std.sci") val=104
;   bc=0x029c str=2("../std.sci") val=103
...
;   bc=0x038c str=2("../std.sci") val=1027
;   bc=0x0394 str=2("../std.sci") val=1026
;   bc=0x03b0 str=2("../std.sci") val=1027
;   bc=0x03b8 str=2("../std.sci") val=1040
;   bc=0x03c0 str=2("../std.sci") val=1031
;   bc=0x03e4 str=2("../std.sci") val=1032
;   bc=0x0404 str=2("../std.sci") val=1033
;   bc=0x041c str=2("../std.sci") val=1036
;   bc=0x0428 str=2("../std.sci") val=1037
;   bc=0x044c str=2("../std.sci") val=1038
;   bc=0x0454 str=2("../std.sci") val=1035
;   bc=0x045c str=2("../std.sci") val=1040
...
func_3:
  0x00c0: GetDotStr r1, "playAnimation"  ; pool_off=0x76  ; pelican_water.sc:68
  0x00c8: Copy r-5, r2
  0x00d0: GetDot r0, 1
  0x00d8: Free2 r1, r2
  0x00e0: ToStr r0
  ...
  0x0154: GetDotStr r2, "GeomTransparency"  ; pool_off=0x65  ; pelican_water.sc:75
  0x015c: LoadFloat r3, 0.5
  0x0164: CmpGt r2
  0x0168: BrZ r2, 0x0198
  0x0170: GetDotStr r2, "GeomTransparency"  ; pool_off=0x65  ; pelican_water.sc:75
  0x0178: Copy r1, r4
  ...
  0x01f0: GetDot r2, 0
  0x01f8: Free2 r3, r2
  0x0200: GetDotStr r2, "GeomTransparency"  ; pool_off=0x65  ; pelican_water.sc:86
  ...
  0x0234: Mul r2
  0x0238: GetDotStr r3, "GeomTransparency"  ; pool_off=0x65  ; pelican_water.sc:88
  0x0240: Copy r2, r4
  0x0248: Add r3
  ...
  0x0270: GetDotStr r2, "remove"  ; pool_off=0x94  ; pelican_water.sc:94
  0x0278: GetDot r1, 0
  0x0280: Free2 r2, r1
...
func_4:
  0x029c: Copy r-4, r0  ; ../std.sci:103
...
func_6:
  0x02dc: GetDotStr r1, "setPosition"  ; pool_off=0x9b  ; pelican_water.sc:46
  0x02e4: GetDotStr r3, "!vec3"  ; pool_off=0xa7
  0x02ec: LoadInt r4, 0
...
; === function 7 (../std.sci, line 1027) locals=2 ===
func_7:
  0x0394: Copy r-4, r0  ; ../std.sci:1026
  0x039c: LoadInt r1, 1
  0x03a4: ToFloat r1
  0x03a8: Call r2, 0x03b8
  0x03b0: Free1 r-4  ; ../std.sci:1027
  0x03b4: Ret r0

; === function 8 (../std.sci, line 1040) locals=5 ===
func_8:
  0x03c0: GetDotStr r1, "playAnimation"  ; pool_off=0x76  ; ../std.sci:1031
  0x03c8: Copy r-5, r2
  0x03d0: GetDot r0, 1
  0x03d8: Free2 r1, r2
  0x03e0: ToStr r0
  0x03e4: Copy r-4, r1  ; ../std.sci:1032
  0x03ec: Copy r0, r2
  0x03f4: SetInd r2
  0x03f8: LoadInt r0, 132
  0x0400: Free1 r2
  0x0404: Copy r0, r2  ; ../std.sci:1033
  0x040c: GetDot r1, 0
  0x0414: Free2 r2, r1
  0x041c: Free1 r2  ; ../std.sci:1036
  0x0420: RetV r1
  0x0424: ToInt r1
  0x0428: Copy r0, r3  ; ../std.sci:1037
  0x0430: Copy r1, r4
  0x0438: GetDot r2, 1
  0x0440: Free1 r3
  0x0444: BrNZ r2, 0x0454
  0x044c: Jmp r0, 0x045c  ; ../std.sci:1038
  0x0454: Jmp r0, 0x041c  ; ../std.sci:1035
  0x045c: Free2 r0, r-5  ; ../std.sci:1040
  0x0464: Ret r0
