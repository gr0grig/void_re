...
func_3:
  ...
  0x00a8: Mul r0
  0x00ac: GetDotStr r2, "playSound3DLooped"  ; pool_off=0xc  ; ..\sound.sci:276
  0x00b4: Copy r-8, r3
  0x00bc: Copy r-7, r4
  0x00c4: Copy r-6, r5
  0x00cc: Copy r-5, r6
  ...
  0x00f4: ToStr r1
  0x00f8: GetDotStr r6, "Globals"  ; pool_off=0x1e  ; ..\sound.sci:277
...
func_4:
  0x0170: GetDotStr r2, "Settings"  ; pool_off=0x31  ; ..\sound.sci:9
  0x0178: Copy r-4, r3
