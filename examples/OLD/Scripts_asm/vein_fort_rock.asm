...
;   bc=0x072c str=2("vein_fort_rock.sc") val=35
;   bc=0x0734 str=2("vein_fort_rock.sc") val=33
;   bc=0x075c str=2("vein_fort_rock.sc") val=34
;   bc=0x07bc str=2("vein_fort_rock.sc") val=35
...
;   bc=0x0b50 str=2("vein_fort_rock.sc") val=22
;   bc=0x0b58 str=2("vein_fort_rock.sc") val=15
;   bc=0x0b5c str=2("vein_fort_rock.sc") val=16
;   bc=0x0bbc str=2("vein_fort_rock.sc") val=17
;   bc=0x0bf8 str=2("vein_fort_rock.sc") val=18
;   bc=0x0c58 str=2("vein_fort_rock.sc") val=19
;   bc=0x0c94 str=2("vein_fort_rock.sc") val=20
;   bc=0x0cf4 str=2("vein_fort_rock.sc") val=21
;   bc=0x0d30 str=2("vein_fort_rock.sc") val=22
...
func_2:
  ...
  0x0148: GetDotStr r2, "Scene"  ; pool_off=0x106  ; vein_base.sci:67
  ...
  0x01c4: Free1 r1
  0x01c8: GetDotStr r4, "World"  ; pool_off=0x14b  ; vein_base.sci:70
...
func_3:
  0x0320: GetDotStr r1, "findMaterial"  ; pool_off=0x191  ; vein_fort_rock.sc:26
  0x0328: LoadString r2, "Material #4"  ; len=11, pool_off=0x19e
  0x0334: GetDot r0, 1
  0x033c: Free2 r1, r2
  0x0344: ToInt r0
  0x0348: GetDotStr r2, "setLocalGeomParameterColor"  ; pool_off=0x1b4  ; vein_fort_rock.sc:27
  0x0350: Copy r0, r3
...
func_4:
  0x0390: GetDotStr r5, "World"  ; pool_off=0x14b  ; vein_base.sci:43
...
func_11:
  ...
  0x0550: LoadString r2, "楖楳汢e朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦b..."  ; len=782, pool_off=0x0, GARBLED  ; @patch+4 vein_base.sci:131
  0x055c: ToFloat r0
...
func_13:
  ...
  0x064c: GetDotStr r2, "randMax"  ; pool_off=0x214  ; vein_base.sci:24
  0x0654: LoadFloat r3, 6.2831854820251465
  0x065c: GetDot r1, 1
  0x0664: Free1 r2
  0x0668: ToFloat r1
  0x066c: GetDotStr r3, "randRange"  ; pool_off=0x21c  ; vein_base.sci:25
...
func_14:
  0x0734: GetDotStr r1, "findMaterial"  ; pool_off=0x191  ; vein_fort_rock.sc:33
  0x073c: LoadString r2, "Material #4"  ; len=11, pool_off=0x19e
  0x0748: GetDot r0, 1
  0x0750: Free2 r1, r2
  0x0758: ToInt r0
  0x075c: GetDotStr r2, "setLocalGeomParameterFloat"  ; pool_off=0x226  ; vein_fort_rock.sc:34
  0x0764: Copy r0, r3
  0x076c: LoadString r4, "Threshold"  ; len=9, pool_off=0x241
  0x0778: LoadInt r6, 1
  0x0780: Copy r-4, r7
  0x0788: Sub r6
  0x078c: LoadInt r7, 0
  ...
  0x07bc: Ret r0  ; vein_fort_rock.sc:35
...
func_22:
  0x08f4: GetDotStr r2, "Scene"  ; pool_off=0x106  ; vein_base.sci:220
  0x08fc: SetDotRaw r1, 268
  0x0904: Free1 r2
  0x0908: LoadString r2, "updateVeinData"  ; len=14, pool_off=0x253
  ...
  0x0944: GetDotStr r1, "!vec3"  ; pool_off=0x26f  ; vein_base.sci:223
  0x094c: LoadInt r2, 0
  0x0954: LoadInt r3, 1
  0x095c: LoadInt r4, 0
  0x0964: GetDot r0, 3
  0x096c: Free1 r1
  0x0970: GetDotStr r2, "Transform"  ; pool_off=0x275
  0x0978: SetDotRaw r1, 639
  0x0980: Free1 r2
  0x0984: Mul r0
  0x0988: ToStr r0
  0x098c: GetDotStr r2, "Transform"  ; pool_off=0x275  ; vein_base.sci:224
  0x0994: SetDotRaw r1, 648
  0x099c: Free1 r2
  0x09a0: ToStr r1
  ...
  0x0a58: Add r4
  0x0a5c: ToStr r4
  0x0a60: GetDotStr r7, "World"  ; pool_off=0x14b  ; vein_base.sci:234
  0x0a68: SetDotRaw r6, 660
  0x0a70: Free1 r7
  0x0a74: GetDotStr r7, "Scene"  ; pool_off=0x106
  0x0a7c: LoadString r8, "limfa.pre"  ; len=9, pool_off=0x2a5
  0x0a88: Copy r4, r9
  0x0a90: LoadString r10, "vein_badabum_part"  ; len=17, pool_off=0x2b7
  0x0a9c: GetDot r5, 4
  0x0aa4: Free5 r6, r7, r8, r9, r10
  0x0ab0: ToStr r5
  0x0ab4: Copy r5, r8  ; vein_base.sci:235
  0x0abc: SetDotRaw r7, 268
  0x0ac4: Free1 r8
  0x0ac8: LoadString r8, "initPart"  ; len=8, pool_off=0x2d9
...
func_23:
  0x0b58: LoadNullStr2 r0  ; vein_fort_rock.sc:15
  0x0b5c: GetDotStr r3, "World"  ; pool_off=0x14b  ; vein_fort_rock.sc:16
  0x0b64: SetDotRaw r2, 660
  0x0b6c: Free1 r3
  0x0b70: GetDotStr r3, "Scene"  ; pool_off=0x106
  0x0b78: LoadString r4, "minewalls/minewall_fort_rockpart1.pre"  ; len=37, pool_off=0x28
  0x0b84: GetDotStr r5, "Transform"  ; pool_off=0x275
  0x0b8c: LoadString r6, "vein_part"  ; len=9, pool_off=0x2e9
  0x0b98: GetDot r1, 4
  0x0ba0: Free5 r2, r3, r4, r5, r6
  0x0bac: ToStr r1
  0x0bb0: Copy r1, r0
  0x0bb8: Free1 r1
  0x0bbc: Copy r0, r3  ; vein_fort_rock.sc:17
  0x0bc4: SetDotRaw r2, 268
  0x0bcc: Free1 r3
  0x0bd0: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x2fb
  0x0bdc: Copy r-4, r4
  0x0be4: GetDot r1, 2
  0x0bec: Free4 r2, r3, r4, r1
  0x0bf8: GetDotStr r3, "World"  ; pool_off=0x14b  ; vein_fort_rock.sc:18
  0x0c00: SetDotRaw r2, 660
  0x0c08: Free1 r3
  0x0c0c: GetDotStr r3, "Scene"  ; pool_off=0x106
  0x0c14: LoadString r4, "minewalls/minewall_fort_rockpart2.pre"  ; len=37, pool_off=0x72
  0x0c20: GetDotStr r5, "Transform"  ; pool_off=0x275
  0x0c28: LoadString r6, "vein_part"  ; len=9, pool_off=0x2e9
  0x0c34: GetDot r1, 4
  0x0c3c: Free5 r2, r3, r4, r5, r6
  0x0c48: ToStr r1
  0x0c4c: Copy r1, r0
  0x0c54: Free1 r1
  0x0c58: Copy r0, r3  ; vein_fort_rock.sc:19
  0x0c60: SetDotRaw r2, 268
  0x0c68: Free1 r3
  0x0c6c: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x2fb
  0x0c78: Copy r-4, r4
  0x0c80: GetDot r1, 2
  0x0c88: Free4 r2, r3, r4, r1
  0x0c94: GetDotStr r3, "World"  ; pool_off=0x14b  ; vein_fort_rock.sc:20
  0x0c9c: SetDotRaw r2, 660
  0x0ca4: Free1 r3
  0x0ca8: GetDotStr r3, "Scene"  ; pool_off=0x106
  0x0cb0: LoadString r4, "minewalls/minewall_fort_rockpart3.pre"  ; len=37, pool_off=0xbc
  0x0cbc: GetDotStr r5, "Transform"  ; pool_off=0x275
  0x0cc4: LoadString r6, "vein_part"  ; len=9, pool_off=0x2e9
  0x0cd0: GetDot r1, 4
  0x0cd8: Free5 r2, r3, r4, r5, r6
  0x0ce4: ToStr r1
  0x0ce8: Copy r1, r0
  0x0cf0: Free1 r1
  0x0cf4: Copy r0, r3  ; vein_fort_rock.sc:21
  0x0cfc: SetDotRaw r2, 268
  0x0d04: Free1 r3
  0x0d08: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x2fb
  0x0d14: Copy r-4, r4
  0x0d1c: GetDot r1, 2
  0x0d24: Free4 r2, r3, r4, r1
  0x0d30: Free2 r0, r-4  ; vein_fort_rock.sc:22
  0x0d38: Ret r0
...
func_24:
  ...
  0x0d60: LoadString r2, "物湡剤湡敧\0"  ; len=583, pool_off=0x313, GARBLED  ; @patch+4 vein_base.sci:155
...
func_27:
  ...
  0x0e40: LoadString r2, "物湡剤湡敧\0"  ; len=327, pool_off=0x313, GARBLED  ; @patch+4 vein_base.sci:175
  0x0e4c: LoadInt r2, 2
  0x0e54: LoadInt r3, 3
  0x0e5c: GetDot r0, 2
  0x0e64: Free1 r1
  ...
  0x0f04: Mul r6
  0x0f08: Sub r5
  0x0f0c: CallMethod r5, 515, 0x20a  ; @patch+8 vein_base.sci:182
  0x0f18: LoadFalse r0
  0x0f1c: Copy r4, r6
  0x0f24: Sub r5
  0x0f28: Copy r5, r2
