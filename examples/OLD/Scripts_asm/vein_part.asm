...
;   bc=0x00c4 str=2("std.sci") val=213
;   bc=0x00cc str=2("std.sci") val=210
;   bc=0x00f4 str=2("std.sci") val=211
;   bc=0x011c str=2("std.sci") val=212
...
;   bc=0x0294 str=2("std.sci") val=222
;   bc=0x029c str=2("std.sci") val=218
;   bc=0x02bc str=2("std.sci") val=219
;   bc=0x02d8 str=2("std.sci") val=220
;   bc=0x02f0 str=2("std.sci") val=217
; func_names:
;   0=initVeinPart
;   2=initVeinPart
...
func_2:
  ...
  0x0030: GetDotStr r2, "randRange"  ; pool_off=0x0
  0x0038: LoadInt r3, 5
  ...
  0x006c: GetDotStr r2, "randRange"  ; pool_off=0x0
  0x0074: LoadInt r3, -8
  0x007c: LoadInt r4, 8
  0x0084: GetDot r1, 2
  0x008c: Free1 r2
  ...
  0x00a8: CallMethod r0, 41, 0x140  ; @patch+8 vein_part.sc:13
  0x00b4: .dword 0x00000188  ; UNKNOWN opcode 0x88
  0x00b8: LoadBool r0, 0xfffffc4a  ; @patch+4 vein_part.sc:14
  0x00c0: Ret r0

; === function 3 (std.sci, line 213) locals=8 ===
func_3:
  0x00cc: GetDotStr r1, "randRange"  ; pool_off=0x0  ; std.sci:210
  0x00d4: LoadInt r2, 0
  0x00dc: LoadFloat r3, 1.5707963705062866
  0x00e4: GetDot r0, 2
  0x00ec: Free1 r1
  0x00f0: ToFloat r0
  0x00f4: GetDotStr r2, "randRange"  ; pool_off=0x0  ; std.sci:211
  0x00fc: LoadInt r3, 0
  0x0104: LoadFloat r4, 6.2831854820251465
  0x010c: GetDot r1, 2
  0x0114: Free1 r2
  0x0118: ToFloat r1
  0x011c: GetDotStr r3, "!vec3"  ; pool_off=0x3a  ; std.sci:212
  0x0124: Copy r0, r4
  0x012c: Cos r4
  0x0130: Copy r1, r5
  0x0138: Sin r5
...
func_4:
  0x0190: GetDotStr r2, "irandRange"  ; pool_off=0x40  ; vein_part.sc:20
  ...
  0x01d4: CallNat2 r0, func=769, info=0x989680
  ...
  0x0278: GetDotStr r2, "remove"  ; pool_off=0x5c  ; vein_part.sc:31
  0x0280: GetDot r1, 0
  0x0288: Free2 r2, r1
...
func_5:
  0x029c: Copy r-4, r0  ; std.sci:218
  0x02a4: Free1 r2
  0x02a8: RetV r1
  0x02ac: Sub r0
  0x02b0: ToInt r0
  0x02b4: Copy r0, r4294967292
  0x02bc: Copy r-4, r0  ; std.sci:219
  0x02c4: LoadInt r1, 0
  0x02cc: CmpLe r0
  0x02d0: BrZ r0, 0x02f0
  0x02d8: Copy r-4, r0  ; std.sci:220
  0x02e0: Neg r0
  0x02e4: Copy r0, r4294967291
  0x02ec: Ret r0
  0x02f0: Jmp r0, 0x029c  ; std.sci:217
