...
func_2:
  ...
  0x0030: GetDotStr r2, "World"  ; pool_off=0x0
  0x0038: SetDotRaw r1, 6
  0x0040: Free1 r2
  0x0044: LoadString r2, "easter_egg_backyard"  ; len=19, pool_off=0xb
  0x0050: GetDotRaw r1, 1
  0x0058: Free1 r2
  0x005c: GetDotStr r1, "sendGenericEventToWorld"  ; pool_off=0x31  ; map_exit_zew.sc:12
  0x0064: GetDotStr r2, "World"  ; pool_off=0x0
  0x006c: LoadString r3, "onBackyard"  ; len=10, pool_off=0x49
  0x0078: GetDot r0, 2
  0x0080: Free4 r1, r2, r3, r0
  0x008c: GetDotStr r1, "sendGenericEventToWorld"  ; pool_off=0x31  ; map_exit_zew.sc:13
  0x0094: GetDotStr r2, "World"  ; pool_off=0x0
