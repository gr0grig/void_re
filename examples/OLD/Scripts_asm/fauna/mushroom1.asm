; gscript disassembly: mushroom1.bin
...
;   bc=0x0014 str=1("mushroom1.sc") val=7
;   bc=0x001c str=1("mushroom1.sc") val=5
;   bc=0x0040 str=1("mushroom1.sc") val=6
...
; === function 1 (mushroom1.sc, line 7) locals=3 ===
func_1:
  0x001c: GetDotStr r1, "loadAnimationSet"  ; pool_off=0x0  ; mushroom1.sc:5
  0x0024: LoadString r2, "anim/mushroom1.ase"  ; len=18, pool_off=0x11
  0x0030: GetDot r0, 1
  0x0038: Free3 r1, r2, r0
  0x0040: CallNat r1, func=5308, info=0x0  ; mushroom1.sc:6
