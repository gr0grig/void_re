...
func_1:
  0x001c: GetDotStr r1, "!table"  ; pool_off=0x0  ; main_newgame.sc:11
  0x0024: GetDot r0, 0
  0x002c: Free1 r1
  ...
  0x0044: Free2 r1, r0
  0x004c: GetDotStr r1, "!vector"  ; pool_off=0x16  ; main_newgame.sc:12
  0x0054: GetDot r0, 0
  0x005c: Free1 r1
  ...
  0x0088: Free2 r2, r0
  0x0090: GetDotStr r1, "!vector"  ; pool_off=0x16  ; main_newgame.sc:13
  0x0098: GetDot r0, 0
  0x00a0: Free1 r1
  ...
  0x00cc: Free2 r2, r0
  0x00d4: GetDotStr r1, "!vector"  ; pool_off=0x16  ; main_newgame.sc:14
  0x00dc: GetDot r0, 0
  0x00e4: Free1 r1
  ...
  0x0110: Free2 r2, r0
  0x0118: GetDotStr r1, "createWorld"  ; pool_off=0x3c  ; main_newgame.sc:16
  ...
  0x014c: Free1 r0
  0x0150: GetDotStr r1, "!customLoop"  ; pool_off=0x58  ; main_newgame.sc:18
  0x0158: GetDot r0, 0
  0x0160: Free1 r1
  0x0164: ToStr r0
  0x0168: GetDotStr r2, "runScript"  ; pool_off=0x64  ; main_newgame.sc:19
  ...
  0x023c: GetDotStr r2, "hasVariable"  ; pool_off=0xb7  ; main_newgame.sc:26
  0x0244: LoadString r3, "post_effect"  ; len=11, pool_off=0xc3
  0x0250: GetDot r1, 1
  0x0258: Free2 r2, r3
  0x0260: BrZ r1, 0x04a4
  0x0268: GetDotStr r2, "logInfo"  ; pool_off=0xd9  ; main_newgame.sc:27
  0x0270: LoadString r3, "Post-effect enabled"  ; len=19, pool_off=0xe1
  0x027c: GetDot r1, 1
  0x0284: Free3 r2, r3, r1
  0x028c: GetDotStr r2, "splitString"  ; pool_off=0x107  ; main_newgame.sc:28
  0x0294: GetDotStr r4, "getVariable"  ; pool_off=0x113
  ...
  0x03e0: Free2 r3, r2
  0x03e8: GetDotStr r3, "hasVariable"  ; pool_off=0xb7  ; main_newgame.sc:34
  0x03f0: LoadString r4, "post_effect_fp"  ; len=14, pool_off=0x14f
  0x03fc: GetDot r2, 1
  0x0404: Free2 r3, r4
  0x040c: BrZ r2, 0x04a0
  0x0414: GetDotStr r3, "getVariable"  ; pool_off=0x113  ; main_newgame.sc:35
  ...
  0x044c: GetDotStr r5, "toBool"  ; pool_off=0x16b  ; main_newgame.sc:37
  0x0454: Copy r2, r6
  0x045c: AsString r6
  0x0460: GetDot r4, 1
  0x0468: Free2 r5, r6
  ...
  0x0518: GetDotStr r5, "!vec3"  ; pool_off=0x1a3
  0x0520: LoadInt r6, 1
  0x0528: LoadInt r7, 0
  0x0530: LoadInt r8, 0
  0x0538: GetDot r4, 3
  ...
  0x0558: GetDotStr r2, "hasVariable"  ; pool_off=0xb7  ; main_newgame.sc:42
  0x0560: LoadString r3, "Shadows"  ; len=7, pool_off=0x1a9
  0x056c: GetDot r1, 1
  0x0574: Free2 r2, r3
  0x057c: BrZ r1, 0x0614
  0x0584: GetDotStr r2, "toInt"  ; pool_off=0x1b7  ; main_newgame.sc:43
  0x058c: GetDotStr r4, "getVariable"  ; pool_off=0x113
  ...
  0x0734: GetDotStr r4, "setSoundListenerParameters"  ; pool_off=0x209  ; main_newgame.sc:59
  0x073c: Copy r2, r6
  ...
  0x0760: Free1 r7
  0x0764: GetDotStr r8, "!vec3"  ; pool_off=0x1a3
  0x076c: LoadInt r9, 0
...
func_2:
  0x0824: GetDotStr r2, "Globals"  ; pool_off=0x7  ; ..\sound.sci:14
...
func_3:
  ...
  0x098c: GetDotStr r1, "flushDebugRender"  ; pool_off=0x262  ; main_newgame.sc:73
