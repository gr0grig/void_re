...
;   bc=0x14b0 str=3("../std.sci") val=104
;   bc=0x14b8 str=3("../std.sci") val=103
;   bc=0x14d8 str=3("../std.sci") val=69
;   bc=0x14e0 str=3("../std.sci") val=64
;   bc=0x14fc str=3("../std.sci") val=65
;   bc=0x1510 str=3("../std.sci") val=66
;   bc=0x152c str=3("../std.sci") val=67
;   bc=0x1540 str=3("../std.sci") val=68
...
func_2:
  0x0030: GetDotStr r2, "World"  ; pool_off=0x0  ; scene_newgame.sc:114
  ...
  0x00a8: Free1 r3
  0x00ac: ToStr r2
  0x00b0: GetDotStr r4, "rayTraceObj"  ; pool_off=0x2d  ; scene_newgame.sc:117
  0x00b8: Copy r2, r5
  0x00c0: Copy r1, r6
...
func_3:
  ...
  0x0148: GetDotStr r1, "self"  ; pool_off=0x39  ; scene_newgame.sc:125
  0x0150: ToStr r1
  ...
  0x0178: GetDotStr r2, "World"  ; pool_off=0x0  ; scene_newgame.sc:129
  ...
  0x01f0: Free1 r3
  0x01f4: ToStr r2
  0x01f8: GetDotStr r4, "rayTraceObj"  ; pool_off=0x2d  ; scene_newgame.sc:132
  0x0200: Copy r2, r5
  0x0208: Copy r1, r6
  ...
  0x026c: SetDot r4, 1
  0x0274: ToFloat r4
  0x0278: GetDotStr r7, "World"  ; pool_off=0x0  ; scene_newgame.sc:137
  0x0280: SetDotRaw r6, 72
  0x0288: Free1 r7
  0x028c: GetDotStr r7, "self"  ; pool_off=0x39
  ...
  0x02b8: Mul r10
  0x02bc: Add r9
  0x02c0: GetDotStr r11, "!vec3"  ; pool_off=0x6b
  ...
  0x0310: ToStr r5
  0x0314: GetDotStr r7, "!vec3"  ; pool_off=0x6b  ; scene_newgame.sc:138
  0x031c: GetDotStr r9, "rand"  ; pool_off=0x9b
  0x0324: GetDot r8, 0
  0x032c: Free1 r9
  0x0330: GetDotStr r10, "rand"  ; pool_off=0x9b
  0x0338: GetDot r9, 0
  0x0340: Free1 r10
  0x0344: GetDotStr r11, "rand"  ; pool_off=0x9b
  0x034c: GetDot r10, 0
  0x0354: Free1 r11
  0x0358: GetDot r6, 3
  ...
  0x03a0: GetDotStr r13, "!vec3"  ; pool_off=0x6b
  0x03a8: GetDot r12, 0
  0x03b0: Free1 r13
  0x03b4: Copy r6, r13
  0x03bc: GetDot r7, 5
...
func_4:
  ...
  0x0460: Free2 r2, r3
  0x0468: ToStr r1
  0x046c: GetDotStr r6, "Globals"  ; pool_off=0xc8  ; ..\sound.sci:162
...
func_5:
  0x04e4: GetDotStr r2, "Settings"  ; pool_off=0xdb  ; ..\sound.sci:9
  0x04ec: Copy r-4, r3
...
func_7:
  0x0604: GetDotStr r2, "World"  ; pool_off=0x0  ; scene_newgame.sc:158
  ...
  0x073c: Free1 r7
  0x0740: ToStr r6
  0x0744: GetDotStr r8, "rayTraceObj"  ; pool_off=0x2d  ; scene_newgame.sc:167
  0x074c: Copy r6, r9
  0x0754: Copy r5, r10
...
func_11:
  ...
  0x09a8: GetDotStr r1, "loadSound"  ; pool_off=0x13c  ; scene_newgame.sc:47
  ...
  0x09f0: RetV r0
  0x09f4: Free1 r0
  0x09f8: GetDotStr r1, "getLocatorTransform"  ; pool_off=0x168  ; scene_newgame.sc:52
  ...
  0x0a30: Free1 r2
  0x0a34: ToStr r1
  0x0a38: GetDotStr r4, "World"  ; pool_off=0x0  ; scene_newgame.sc:54
  ...
  0x0a74: Free1 r2
  0x0a78: GetDotStr r3, "!lookAt"  ; pool_off=0x1a3  ; scene_newgame.sc:55
  0x0a80: Copy r1, r4
  0x0a88: Copy r1, r5
  0x0a90: GetDotStr r7, "!vec3"  ; pool_off=0x6b
  0x0a98: LoadInt r8, 1
  0x0aa0: LoadInt r9, -1
  ...
  0x0b08: Free1 r3
  0x0b0c: GetDotStr r3, "self"  ; pool_off=0x39  ; scene_newgame.sc:58
  0x0b14: ToStr r3
  ...
  0x0b68: Free1 r3
  0x0b6c: GetDotStr r3, "createUIPlane"  ; pool_off=0x1c8  ; scene_newgame.sc:61
  0x0b74: GetDot r2, 0
  0x0b7c: Free1 r3
  0x0b80: ToStr r2
  ...
  0x0bf0: GetDotStr r5, "World"  ; pool_off=0x0
  0x0bf8: GetDotStr r6, "self"  ; pool_off=0x39
  0x0c00: GetDot r2, 3
  0x0c08: Free5 r3, r4, r5, r6, r2
  0x0c14: GetDotStr r3, "!vector"  ; pool_off=0x205  ; scene_newgame.sc:65
  0x0c1c: GetDot r2, 0
  0x0c24: Free1 r3
  0x0c28: ToStr r2
  ...
  0x0e6c: GetDot r5, 1
  0x0e74: Free2 r6, r5
  0x0e7c: GetDotStr r6, "isActionActive"  ; pool_off=0x230  ; scene_newgame.sc:95
  ...
  0x0ee8: Free2 r6, r5
  0x0ef0: GetDotStr r6, "isActionActive"  ; pool_off=0x230  ; scene_newgame.sc:98
  ...
  0x0f5c: Free2 r6, r5
  0x0f64: GetDotStr r6, "isActionActive"  ; pool_off=0x230  ; scene_newgame.sc:101
  ...
  0x0fd0: Free2 r6, r5
  0x0fd8: GetDotStr r6, "isActionActive"  ; pool_off=0x230  ; scene_newgame.sc:104
  ...
  0x1044: Free2 r6, r5
  0x104c: GetDotStr r6, "!lookAt"  ; pool_off=0x1a3  ; scene_newgame.sc:108
  0x1054: Copy r1, r7
  0x105c: Copy r1, r8
  0x1064: GetDotStr r10, "!vec3"  ; pool_off=0x6b
...
func_12:
  ...
  0x112c: Free2 r2, r3
  0x1134: ToStr r1
  0x1138: GetDotStr r6, "Globals"  ; pool_off=0xc8  ; ..\sound.sci:251
...
func_13:
  0x11b0: GetDotStr r1, "findActor"  ; pool_off=0x27b  ; scene_newgame.sc:203
...
func_14:
  ...
  0x132c: GetDot r0, 3
  0x1334: Free2 r1, r0
  0x133c: GetDotStr r1, "randMax"  ; pool_off=0x308  ; scene_newgame.sc:217
  ...
  0x13c4: Free2 r3, r2
  0x13cc: GetDotStr r4, "World"  ; pool_off=0x0  ; scene_newgame.sc:220
  0x13d4: SetDotRaw r3, 803
  0x13dc: Free1 r4
  0x13e0: GetDotStr r4, "self"  ; pool_off=0x39
  0x13e8: Copy r-6, r5
  0x13f0: LoadString r6, ".xml"  ; len=4, pool_off=0x1f1
  0x13fc: Add r5
  0x1400: GetDotStr r7, "!qtpair"  ; pool_off=0x334
  0x1408: GetDotStr r9, "!rotateY"  ; pool_off=0x33c
  0x1410: Copy r0, r10
  0x1418: GetDot r8, 1
  0x1420: Free1 r9
  0x1424: Copy r1, r9
...
func_15:
  0x14b8: Copy r-4, r0  ; ../std.sci:103
  0x14c0: LoadFloat r1, 1000000.0
  0x14c8: Div r0
  0x14cc: Copy r0, r4294967291
  0x14d4: Ret r0

; === function 16 (../std.sci, line 69) locals=2 ===
func_16:
  0x14e0: Copy r-6, r0  ; ../std.sci:64
  0x14e8: Copy r-5, r1
  0x14f0: CmpLt r0
  0x14f4: BrZ r0, 0x1510
  0x14fc: Copy r-5, r0  ; ../std.sci:65
  0x1504: Copy r0, r4294967289
  0x150c: Ret r0
  0x1510: Copy r-6, r0  ; ../std.sci:66
  0x1518: Copy r-4, r1
  0x1520: CmpGt r0
  0x1524: BrZ r0, 0x1540
  0x152c: Copy r-4, r0  ; ../std.sci:67
  0x1534: Copy r0, r4294967289
  0x153c: Ret r0
  0x1540: Copy r-6, r0  ; ../std.sci:68
