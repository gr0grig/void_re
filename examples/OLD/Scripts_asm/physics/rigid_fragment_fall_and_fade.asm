...
;   bc=0x01a0 str=2("../std.sci") val=222
;   bc=0x01a8 str=2("../std.sci") val=218
;   bc=0x01c8 str=2("../std.sci") val=219
;   bc=0x01e4 str=2("../std.sci") val=220
;   bc=0x01fc str=2("../std.sci") val=217
...
func_1:
  ...
  0x0044: CallMethod r0, 27, 0x13f  ; @patch+8 rigid_fragment_fall_and_fade.sc:28
  0x0050: Jmp r2, 0x0000

; === function 2 (initFragment, rigid_fragment_fall_and_fade.sc, line 36) locals=4 ===
func_2:
...
; === function 3 (rigid_fragment_fall_and_fade.sc, line 59) locals=5 ===
func_3:
...
func_4:
  0x01a8: Copy r-4, r0  ; ../std.sci:218
  0x01b0: Free1 r2
  0x01b4: RetV r1
  0x01b8: Sub r0
  0x01bc: ToInt r0
  0x01c0: Copy r0, r4294967292
  0x01c8: Copy r-4, r0  ; ../std.sci:219
  0x01d0: LoadInt r1, 0
  0x01d8: CmpLe r0
  0x01dc: BrZ r0, 0x01fc
  0x01e4: Copy r-4, r0  ; ../std.sci:220
  0x01ec: Neg r0
  0x01f0: Copy r0, r4294967291
  0x01f8: Ret r0
  0x01fc: Jmp r0, 0x01a8  ; ../std.sci:217

; === function 5 (isTrapAttracted, rigid_fragment_fall_and_fade.sc, line 39) locals=4 ===
func_5:
...
; === function 6 (rigid_fragment_fall_and_fade.sc, line 33) locals=0 ===
func_6:
  0x024c: Ret r0  ; rigid_fragment_fall_and_fade.sc:33

; === function 7 (applyForce, rigid_fragment_fall_and_fade.sc, line 11) locals=1 ===
func_7:
  0x0258: LoadBool r0, true  ; rigid_fragment_fall_and_fade.sc:10
  0x0260: Copy r0, r4294967292
  0x0268: Ret r0

; === function 8 (isTrapAttracted, rigid_fragment_fall_and_fade.sc, line 18) locals=4 ===
func_8:
  0x0274: GetDotStr r1, "applyForce"  ; pool_off=0x69  ; rigid_fragment_fall_and_fade.sc:17
  0x027c: Copy r-4, r2
  0x0284: GetDotStr r3, "Mass"  ; pool_off=0x74
  0x028c: Mul r2
  0x0290: GetDot r0, 1
