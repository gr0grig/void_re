...
func_3:
  ...
  0x00c8: GetDotStr r4, "World"  ; pool_off=0x25  ; collapsible.sc:56
  0x00d0: SetDotRaw r3, 43
  0x00d8: Free1 r4
  0x00dc: GetDotStr r4, "Scene"  ; pool_off=0x3c
  0x00e4: CopyGlobWr r0, g6
  0x00ec: Copy r1, r7
  0x00f4: SetDot r5, 1
  0x00fc: LoadString r6, ".pre"  ; len=4, pool_off=0x42
  0x0108: Add r5
  0x010c: GetDotStr r7, "!qtpair"  ; pool_off=0x4a
  0x0114: GetDotStr r8, "Rotation"  ; pool_off=0x52
  0x011c: GetDotStr r9, "Position"  ; pool_off=0x5b
  0x0124: GetDot r6, 2
  ...
  0x01b8: GetDotStr r2, "remove"  ; pool_off=0xc9  ; collapsible.sc:60
  0x01c0: GetDot r1, 0
  0x01c8: Free2 r2, r1
...
func_4:
  0x01e4: GetDotStr r1, "trace"  ; pool_off=0xd0  ; collapsible.sc:38
  0x01ec: GetDotStr r2, "Position"  ; pool_off=0x5b
  0x01f4: AsString r2
  0x01f8: GetDot r0, 1
  0x0200: Free3 r1, r2, r0
  0x0208: GetDotStr r1, "Position"  ; pool_off=0x5b  ; collapsible.sc:39
  0x0210: SetDotRaw r0, 104
  0x0218: Free1 r1
  0x021c: LoadFloat r1, 0.10000000149011612
  0x0224: CmpLe r0
  0x0228: BrZ r0, 0x0254
  0x0230: GetDotStr r1, "trace"  ; pool_off=0xd0  ; collapsible.sc:40
...
func_5:
  0x0270: GetDotStr r1, "trace"  ; pool_off=0xd0  ; collapsible.sc:16
