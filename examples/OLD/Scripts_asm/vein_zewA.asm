...
;   bc=0x078c str=2("vein_zewA.sc") val=41
;   bc=0x0794 str=2("vein_zewA.sc") val=39
;   bc=0x07bc str=2("vein_zewA.sc") val=40
;   bc=0x081c str=2("vein_zewA.sc") val=41
...
;   bc=0x0bb0 str=2("vein_zewA.sc") val=28
;   bc=0x0bb8 str=2("vein_zewA.sc") val=17
;   bc=0x0bbc str=2("vein_zewA.sc") val=18
;   bc=0x0c1c str=2("vein_zewA.sc") val=19
;   bc=0x0c58 str=2("vein_zewA.sc") val=20
;   bc=0x0cb8 str=2("vein_zewA.sc") val=21
;   bc=0x0cf4 str=2("vein_zewA.sc") val=22
;   bc=0x0d54 str=2("vein_zewA.sc") val=23
;   bc=0x0d90 str=2("vein_zewA.sc") val=24
;   bc=0x0df0 str=2("vein_zewA.sc") val=25
;   bc=0x0e2c str=2("vein_zewA.sc") val=26
;   bc=0x0e8c str=2("vein_zewA.sc") val=27
;   bc=0x0ec8 str=2("vein_zewA.sc") val=28
...
func_2:
  ...
  0x01a8: GetDotStr r2, "Scene"  ; pool_off=0x172  ; vein_base.sci:67
  ...
  0x0224: Free1 r1
  0x0228: GetDotStr r4, "World"  ; pool_off=0x1b7  ; vein_base.sci:70
...
func_3:
  0x0380: GetDotStr r1, "findMaterial"  ; pool_off=0x1fd  ; vein_zewA.sc:32
  0x0388: LoadString r2, "Material #4"  ; len=11, pool_off=0x20a
  0x0394: GetDot r0, 1
  0x039c: Free2 r1, r2
  0x03a4: ToInt r0
  0x03a8: GetDotStr r2, "setLocalGeomParameterColor"  ; pool_off=0x220  ; vein_zewA.sc:33
  0x03b0: Copy r0, r3
...
func_4:
  0x03f0: GetDotStr r5, "World"  ; pool_off=0x1b7  ; vein_base.sci:43
...
func_13:
  ...
  0x06ac: GetDotStr r2, "randMax"  ; pool_off=0x280  ; vein_base.sci:24
  0x06b4: LoadFloat r3, 6.2831854820251465
  0x06bc: GetDot r1, 1
  0x06c4: Free1 r2
  0x06c8: ToFloat r1
  0x06cc: GetDotStr r3, "randRange"  ; pool_off=0x288  ; vein_base.sci:25
...
func_14:
  0x0794: GetDotStr r1, "findMaterial"  ; pool_off=0x1fd  ; vein_zewA.sc:39
  0x079c: LoadString r2, "Material #4"  ; len=11, pool_off=0x20a
  0x07a8: GetDot r0, 1
  0x07b0: Free2 r1, r2
  0x07b8: ToInt r0
  0x07bc: GetDotStr r2, "setLocalGeomParameterFloat"  ; pool_off=0x292  ; vein_zewA.sc:40
  0x07c4: Copy r0, r3
  0x07cc: LoadString r4, "Threshold"  ; len=9, pool_off=0x2ad
  0x07d8: LoadInt r6, 1
  0x07e0: Copy r-4, r7
  0x07e8: Sub r6
  0x07ec: LoadInt r7, 0
...
func_22:
  0x0954: GetDotStr r2, "Scene"  ; pool_off=0x172  ; vein_base.sci:220
  0x095c: SetDotRaw r1, 376
  0x0964: Free1 r2
  0x0968: LoadString r2, "updateVeinData"  ; len=14, pool_off=0x2bf
  ...
  0x09a4: GetDotStr r1, "!vec3"  ; pool_off=0x2db  ; vein_base.sci:223
  0x09ac: LoadInt r2, 0
  0x09b4: LoadInt r3, 1
  0x09bc: LoadInt r4, 0
  0x09c4: GetDot r0, 3
  0x09cc: Free1 r1
  0x09d0: GetDotStr r2, "Transform"  ; pool_off=0x2e1
  0x09d8: SetDotRaw r1, 747
  0x09e0: Free1 r2
  0x09e4: Mul r0
  0x09e8: ToStr r0
  0x09ec: GetDotStr r2, "Transform"  ; pool_off=0x2e1  ; vein_base.sci:224
  0x09f4: SetDotRaw r1, 756
  0x09fc: Free1 r2
  0x0a00: ToStr r1
  ...
  0x0ab8: Add r4
  0x0abc: ToStr r4
  0x0ac0: GetDotStr r7, "World"  ; pool_off=0x1b7  ; vein_base.sci:234
  0x0ac8: SetDotRaw r6, 768
  0x0ad0: Free1 r7
  0x0ad4: GetDotStr r7, "Scene"  ; pool_off=0x172
  0x0adc: LoadString r8, "limfa.pre"  ; len=9, pool_off=0x311
  0x0ae8: Copy r4, r9
  0x0af0: LoadString r10, "vein_badabum_part"  ; len=17, pool_off=0x323
  0x0afc: GetDot r5, 4
  0x0b04: Free5 r6, r7, r8, r9, r10
  0x0b10: ToStr r5
  0x0b14: Copy r5, r8  ; vein_base.sci:235
  0x0b1c: SetDotRaw r7, 376
  0x0b24: Free1 r8
  0x0b28: LoadString r8, "initPart"  ; len=8, pool_off=0x345
...
func_23:
  0x0bb8: LoadNullStr2 r0  ; vein_zewA.sc:17
  0x0bbc: GetDotStr r3, "World"  ; pool_off=0x1b7  ; vein_zewA.sc:18
  0x0bc4: SetDotRaw r2, 768
  0x0bcc: Free1 r3
  0x0bd0: GetDotStr r3, "Scene"  ; pool_off=0x172
  0x0bd8: LoadString r4, "minewalls/minewall_zewA_part1.pre"  ; len=33, pool_off=0x28
  0x0be4: GetDotStr r5, "Transform"  ; pool_off=0x2e1
  0x0bec: LoadString r6, "vein_part"  ; len=9, pool_off=0x355
  0x0bf8: GetDot r1, 4
  0x0c00: Free5 r2, r3, r4, r5, r6
  0x0c0c: ToStr r1
  0x0c10: Copy r1, r0
  0x0c18: Free1 r1
  0x0c1c: Copy r0, r3  ; vein_zewA.sc:19
  0x0c24: SetDotRaw r2, 376
  0x0c2c: Free1 r3
  0x0c30: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x367
  0x0c3c: Copy r-4, r4
  0x0c44: GetDot r1, 2
  0x0c4c: Free4 r2, r3, r4, r1
  0x0c58: GetDotStr r3, "World"  ; pool_off=0x1b7  ; vein_zewA.sc:20
  0x0c60: SetDotRaw r2, 768
  0x0c68: Free1 r3
  0x0c6c: GetDotStr r3, "Scene"  ; pool_off=0x172
  0x0c74: LoadString r4, "minewalls/minewall_zewA_part2.pre"  ; len=33, pool_off=0x6a
  0x0c80: GetDotStr r5, "Transform"  ; pool_off=0x2e1
  0x0c88: LoadString r6, "vein_part"  ; len=9, pool_off=0x355
  0x0c94: GetDot r1, 4
  0x0c9c: Free5 r2, r3, r4, r5, r6
  0x0ca8: ToStr r1
  0x0cac: Copy r1, r0
  0x0cb4: Free1 r1
  0x0cb8: Copy r0, r3  ; vein_zewA.sc:21
  0x0cc0: SetDotRaw r2, 376
  0x0cc8: Free1 r3
  0x0ccc: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x367
  0x0cd8: Copy r-4, r4
  0x0ce0: GetDot r1, 2
  0x0ce8: Free4 r2, r3, r4, r1
  0x0cf4: GetDotStr r3, "World"  ; pool_off=0x1b7  ; vein_zewA.sc:22
  0x0cfc: SetDotRaw r2, 768
  0x0d04: Free1 r3
  0x0d08: GetDotStr r3, "Scene"  ; pool_off=0x172
  0x0d10: LoadString r4, "minewalls/minewall_zewA_part3.pre"  ; len=33, pool_off=0xac
  0x0d1c: GetDotStr r5, "Transform"  ; pool_off=0x2e1
  0x0d24: LoadString r6, "vein_part"  ; len=9, pool_off=0x355
  0x0d30: GetDot r1, 4
  0x0d38: Free5 r2, r3, r4, r5, r6
  0x0d44: ToStr r1
  0x0d48: Copy r1, r0
  0x0d50: Free1 r1
  0x0d54: Copy r0, r3  ; vein_zewA.sc:23
  0x0d5c: SetDotRaw r2, 376
  0x0d64: Free1 r3
  0x0d68: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x367
  0x0d74: Copy r-4, r4
  0x0d7c: GetDot r1, 2
  0x0d84: Free4 r2, r3, r4, r1
  0x0d90: GetDotStr r3, "World"  ; pool_off=0x1b7  ; vein_zewA.sc:24
  0x0d98: SetDotRaw r2, 768
  0x0da0: Free1 r3
  0x0da4: GetDotStr r3, "Scene"  ; pool_off=0x172
  0x0dac: LoadString r4, "minewalls/minewall_zewA_part4.pre"  ; len=33, pool_off=0xee
  0x0db8: GetDotStr r5, "Transform"  ; pool_off=0x2e1
  0x0dc0: LoadString r6, "vein_part"  ; len=9, pool_off=0x355
  0x0dcc: GetDot r1, 4
  0x0dd4: Free5 r2, r3, r4, r5, r6
  0x0de0: ToStr r1
  0x0de4: Copy r1, r0
  0x0dec: Free1 r1
  0x0df0: Copy r0, r3  ; vein_zewA.sc:25
  0x0df8: SetDotRaw r2, 376
  0x0e00: Free1 r3
  0x0e04: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x367
  0x0e10: Copy r-4, r4
  0x0e18: GetDot r1, 2
  0x0e20: Free4 r2, r3, r4, r1
  0x0e2c: GetDotStr r3, "World"  ; pool_off=0x1b7  ; vein_zewA.sc:26
  0x0e34: SetDotRaw r2, 768
  0x0e3c: Free1 r3
  0x0e40: GetDotStr r3, "Scene"  ; pool_off=0x172
  0x0e48: LoadString r4, "minewalls/minewall_zewA_part5.pre"  ; len=33, pool_off=0x130
  0x0e54: GetDotStr r5, "Transform"  ; pool_off=0x2e1
  0x0e5c: LoadString r6, "vein_part"  ; len=9, pool_off=0x355
  0x0e68: GetDot r1, 4
  0x0e70: Free5 r2, r3, r4, r5, r6
  0x0e7c: ToStr r1
  0x0e80: Copy r1, r0
  0x0e88: Free1 r1
  0x0e8c: Copy r0, r3  ; vein_zewA.sc:27
  0x0e94: SetDotRaw r2, 376
  0x0e9c: Free1 r3
  0x0ea0: LoadString r3, "initVeinPart"  ; len=12, pool_off=0x367
  0x0eac: Copy r-4, r4
  0x0eb4: GetDot r1, 2
  0x0ebc: Free4 r2, r3, r4, r1
  0x0ec8: Free2 r0, r-4  ; vein_zewA.sc:28
  0x0ed0: Ret r0
...
func_24:
  ...
  0x0ef8: .dword 0x0000026f  ; UNKNOWN opcode 0x6f
  0x0efc: GetDotStr r2, "irandRange"  ; pool_off=0x37f  ; vein_base.sci:155
...
func_27:
  ...
  0x0fd8: .dword 0x0000026f  ; UNKNOWN opcode 0x6f
  0x0fdc: GetDotStr r1, "irandRange"  ; pool_off=0x37f  ; vein_base.sci:175
  0x0fe4: LoadInt r2, 2
  0x0fec: LoadInt r3, 3
  0x0ff4: GetDot r0, 2
  0x0ffc: Free1 r1
  ...
  0x109c: Mul r6
  0x10a0: Sub r5
  0x10a4: CallMethod r5, 623, 0x20a  ; @patch+8 vein_base.sci:182
  0x10b0: LoadFalse r0
  0x10b4: Copy r4, r6
  0x10bc: Sub r5
  0x10c0: Copy r5, r2
