...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 10504, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    if (!r3) goto L_10a8;
    // tree_base.sci:259
    Call(r3, 0x1904);  // @src tree_base.sci:259
    // tree_base.sci:260
    Call(r3, 0x1950);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x1950);  // @src tree_base.sci:300
    // tree_base.sci:273
...
{
    // tree_garden1.sc:11
    g0 = r9;  // @src tree_garden1.sc:11
    if (r0) goto L_16a0;
    // tree_garden1.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden1.sc:12
    ...
    r0 = (str)r0;
    // tree_garden1.sc:13
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden1.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
{
    // tree_garden1.sc:32
    g0 = r10;  // @src tree_garden1.sc:32
    if (r0) goto L_194c;
    // tree_garden1.sc:33
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden1.sc:33
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
{
    // tree_garden1.sc:40
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden1.sc:40
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
...
{
    // tree_garden1.sc:47
    g0 = r10;  // @src tree_garden1.sc:47
    if (!r0) goto L_1c90;
    // tree_garden1.sc:48
    g2 = r10;  // @src tree_garden1.sc:48
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1.sc:50
  L_1c90:
    g0 = r9;  // @src tree_garden1.sc:50
    if (!r0) goto L_1ccc;
    // tree_garden1.sc:51
    g2 = r9;  // @src tree_garden1.sc:51
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1e98;
    r4 = GetDotStr("getGestureName");  // @pool 0x4fd
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_1f4c:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀...";  // len=119, pool_off=0x44a, GARBLED
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀...";  // len=113, pool_off=0x44a, GARBLED
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀琀...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
    ...
    if (!r5) goto L_2114;
    // tree_base.sci:165
    Call(r5, 0x23d0);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_2114:
    ...
    if (!r5) goto L_2140;
    // tree_base.sci:167
    Call(r5, 0x2440);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_2148;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_2140:
    Call(r5, 0x24b0);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_2148:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 9504, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x5c8  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x5c8  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x5c8  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x283c);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_26ec:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_26ec;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_2828:
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x5e9  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
