...
func_15()
{
    ...
    g0 = r9;  // @src tree_foggyroots_ushan.sc:11
    if (r0) goto L_16a0;
    // tree_foggyroots_ushan.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_foggyroots_ushan.sc:12
    ...
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_foggyroots_ushan.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
func_16()
{
    ...
    g3 = r9;  // @src tree_foggyroots_ushan.sc:21
    SetDotRaw(r2, 1015);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_foggyroots_ushan.sc:22
    SetDotRaw(r2, 1015);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_foggyroots_ushan.sc:23
    SetDotRaw(r2, 1015);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_foggyroots_ushan.sc:24
    SetDotRaw(r2, 1015);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
...
func_17()
{
    ...
    g0 = r10;  // @src tree_foggyroots_ushan.sc:29
    if (r0) goto L_1880;
    // tree_foggyroots_ushan.sc:30
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_foggyroots_ushan.sc:30
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
func_18()
{
    ...
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_foggyroots_ushan.sc:37
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
    ...
    g1 = r7;  // @src tree_foggyroots_ushan.sc:38
    r1 = (float)r1;
    g2 = r11;
    r2 = (float)r2;
    r1 = r1 / r2;
...
func_22()
{
    ...
    g0 = r10;  // @src tree_foggyroots_ushan.sc:44
    if (!r0) goto L_1bc4;
    // tree_foggyroots_ushan.sc:45
    g2 = r10;  // @src tree_foggyroots_ushan.sc:45
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
  ...
  L_1bc4:
    g0 = r9;  // @src tree_foggyroots_ushan.sc:47
    if (!r0) goto L_1c00;
    // tree_foggyroots_ushan.sc:48
    g2 = r9;  // @src tree_foggyroots_ushan.sc:48
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1dcc;
    r4 = GetDotStr("getGestureName");  // @pool 0x50b
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_1e80:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "慦潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀...";  // len=119, pool_off=0x44a, GARBLED
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "慦潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀...";  // len=113, pool_off=0x44a, GARBLED
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "慦潂瑴敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x5d6  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x5d6  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x5d6  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x5f7  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
