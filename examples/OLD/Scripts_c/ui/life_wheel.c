...
{
    // life_wheel.sc:61
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0x0  // @src life_wheel.sc:61
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // life_wheel.sc:62
    ...
    Free2(r3, r2);
    // life_wheel.sc:64
    r3 = GetDotStr("createPostProcessComposer");  // @pool 0x3f  // @src life_wheel.sc:64
    r6 = r0;
    SetDotRaw(r5, 89);
    Free1(r6);
    GetDot(r4, 0);
    ...
    // life_wheel.sc:68
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0x0  // @src life_wheel.sc:68
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // life_wheel.sc:69
    ...
    Free3(r2, r3, r1);
    // life_wheel.sc:70
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0x3f  // @src life_wheel.sc:70
    r5 = r0;
    SetDotRaw(r4, 89);
    Free1(r5);
    GetDot(r3, 0);
...
disable()
{
  ...
  L_0210:
    ...
    if (!r1) goto L_02d0;
    // life_wheel.sc:78
    r3 = GetDotStr("Plane");  // @pool 0x80  // @src life_wheel.sc:78
    SetDotRaw(r2, 134);
    Free1(r3);
    r5 = r_neg4;
    r6 = "Wheel";
    ...
    // life_wheel.sc:81
  L_02d0:
    r2 = GetDotStr("Plane");  // @pool 0x80  // @src life_wheel.sc:81
    SetDotRaw(r1, 134);
    Free1(r2);
    r4 = r_neg4;
    r5 = "Hand";
    ...
    Free1(r0);
    // life_wheel.sc:82
    r2 = GetDotStr("Plane");  // @pool 0x80  // @src life_wheel.sc:82
    SetDotRaw(r1, 134);
    Free1(r2);
    r4 = r_neg4;
    r5 = "HandGrad";
...
{
    // life_wheel.sc:26
    r1 = GetDotStr("!ppconfig");  // @pool 0xb3  // @src life_wheel.sc:26
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // life_wheel.sc:27
    ...
    Free1(r2);
    // life_wheel.sc:28
    r2 = GetDotStr("!vec2");  // @pool 0xc6  // @src life_wheel.sc:28
    r4 = r_neg6;
    SetDotRaw(r3, 204);
    Free1(r4);
    r3 = Neg(r3);
...
func_6()
{
    ...
    r1 = (float)r1;
    // life_wheel.sc:20
    r3 = GetDotStr("!vec3");  // @pool 0x139  // @src life_wheel.sc:20
    r4 = r1;
    r5 = r1;
    r6 = r1;
    GetDot(r2, 3);
...
{
    // life_wheel.sc:40
    r1 = GetDotStr("!ppconfig");  // @pool 0xb3  // @src life_wheel.sc:40
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // life_wheel.sc:41
