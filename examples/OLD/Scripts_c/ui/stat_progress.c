...
setProgress()
{
    ...
    r0 = g7;
    // stat_progress.sc:20
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src stat_progress.sc:20
    SetDotRaw(r1, 50);
    Free1(r2);
    r4 = r_neg4;
    SetDotRaw(r3, 54);
    ...
    Free1(r0);
    // stat_progress.sc:21
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src stat_progress.sc:21
    SetDotRaw(r1, 68);
    Free1(r2);
    g2 = r5;
    r3 = GetDotStr("Width");  // @pool 0x1f
    g5 = r5;
    SetDotRaw(r4, 37);
    Free1(r5);
    GetDot(r0, 3);
...
func_5()
{
    ...
    r1 = GetDotStr("!ppconfig");  // @pool 0x6a  // @src color_progress_base.sci:17
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0xa0  // @src color_progress_base.sci:21
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0xdb  // @src color_progress_base.sci:23
    r5 = r0;
    SetDotRaw(r4, 245);
    Free1(r5);
    GetDot(r3, 0);
...
func_7()
{
    ...
    Call(r1, 0x0020);
    // stat_progress.sc:40
    r1 = GetDotStr("format");  // @pool 0x10b  // @src stat_progress.sc:40
    r2 = "+%u%% (%u)";
    g3 = r8;
    g4 = r9;
    GetDot(r0, 3);
