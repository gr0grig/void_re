...
func_3()
{
    ...
    r0 = GetDotStr("Width");  // @pool 0x0  // @src tree_donor_help.sc:57
    CopyExtWr(r1, 2, 2);
    SetDotRaw(r1, 0);
    Free1(r2);
    r0 = r0 - r1;
    ...
    r1 = GetDotStr("Height");  // @pool 0x6  // @src tree_donor_help.sc:58
    CopyExtWr(r1, 3, 2);
    SetDotRaw(r2, 6);
    Free1(r3);
    r1 = r1 - r2;
...
func_4()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x1c  // @src tree_donor_help.sc:40
    SetDotRaw(r1, 34);
    Free1(r2);
