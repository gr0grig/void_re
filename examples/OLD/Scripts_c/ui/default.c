...
{
    // default.sc:76
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src default.sc:76
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "fontmain_11.ft";
    GetDot(r0, 1);
    ...
    if (r1) goto L_0278;
    // default.sc:78
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src default.sc:78
    SetDotRaw(r2, 43);
    Free1(r3);
    r3 = r0;
    r4 = 256;
    ...
    // default.sc:80
  L_0278:
    r2 = GetDotStr("format");  // @pool 0x3e  // @src default.sc:80
...
hideControl()
{
    ...
    // default.sc:63
  L_04f8:
    r0 = GetDotStr("Width");  // @pool 0x84  // @src default.sc:63
    r1 = 0.5f;
    r0 = r0 * r1;
    g2 = r7;
    r3 = 0;
...
{
    // default.sc:97
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src default.sc:97
    SetDotRaw(r1, 172);
    Free1(r2);
    ...
    Free1(r0);
    // default.sc:99
    r1 = GetDotStr("!regionMask");  // @pool 0xde  // @src default.sc:99
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // default.sc:100
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src default.sc:100
    SetDotRaw(r1, 172);
    Free1(r2);
...
func_10()
{
  ...
  L_090c:
    ...
    Free2(r6, r0);
    // default.sc:113
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src default.sc:113
    SetDotRaw(r1, 314);
    Free1(r2);
    GetDot(r0, 0);
    Free1(r1);
...
onMouseEnter()
{
  ...
  L_0a88:
    ...
    if (!r0) goto L_0ac8;
    // default.sc:123
    r2 = GetDotStr("Window");  // @pool 0x14c  // @src default.sc:123
    SetDotRaw(r1, 339);
    Free1(r2);
    r2 = "onDefault";
    GetDot(r0, 1);
