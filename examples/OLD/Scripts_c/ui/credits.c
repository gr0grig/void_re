...
{
    // credits.sc:11
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:11
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "cursor_paint";
    GetDot(r0, 1);
...
{
    // credits.sc:24
    r0 = GetDotStr("Height");  // @pool 0x2f  // @src credits.sc:24
    r0 = (float)r0;
    r1 = 1200.0f;
    r0 = r0 / r1;
    // credits.sc:25
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:25
    SetDotRaw(r2, 54);
    Free1(r3);
    r3 = "fontmain_";
    r5 = r_neg4;
...
func_8()
{
    ...
    CopyExtRd(r0, 7, 2);
    // credits.sc:120
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:120
    SetDotRaw(r1, 156);
    Free1(r2);
    g2 = r3;
    r3 = GetDotStr("Width");  // @pool 0xaf
    r4 = 2;
    g6 = r3;
    SetDotRaw(r5, 47);
    Free1(r6);
    ...
    Free3(r1, r2, r0);
    // credits.sc:122
    r1 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:122
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
    ...
    Free1(r0);
    // credits.sc:128
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:128
    SetDotRaw(r1, 6);
    Free1(r2);
    ...
    Free1(r0);
    // credits.sc:129
    r1 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:129
    r2 = GetDotStr("Width");  // @pool 0xaf
    ...
    Free1(r0);
    // credits.sc:130
    r1 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:130
    r2 = GetDotStr("Width");  // @pool 0xaf
    CopyExtWr(r4, 4, 2);
    r5 = 0;
    SetDot(r3, 1);
  ...
  L_06a0:
    ...
    if (!r1) goto L_0970;
    // credits.sc:136
    r2 = GetDotStr("isActionActive");  // @pool 0xf7  // @src credits.sc:136
    r3 = "skip_cutscene";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_0708;
  ...
  L_0708:
    ...
    // credits.sc:142
  L_0724:
    r2 = GetDotStr("irandMax");  // @pool 0x106  // @src credits.sc:142
    r4 = r0;
    SetDotRaw(r3, 241);
    Free1(r4);
    GetDot(r1, 1);
    ...
    r1 = (int)r1;
    // credits.sc:144
    r4 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:144
    SetDotRaw(r3, 6);
    Free1(r4);
    r4 = "ui/credits/";
    r6 = r0;
    ...
    Free1(r2);
    // credits.sc:145
    r3 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:145
    r4 = GetDotStr("Height");  // @pool 0x2f
    ...
    Free1(r2);
    // credits.sc:146
    r3 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:146
    r4 = GetDotStr("Width");  // @pool 0xaf
    r5 = 0.5f;
    r4 = r4 * r5;
    CopyExtWr(r4, 6, 2);
    r7 = 0;
    ...
    Free1(r2);
    // credits.sc:148
    r3 = GetDotStr("getNamedString");  // @pool 0x10f  // @src credits.sc:148
    r5 = r0;
    r6 = r1;
    SetDot(r4, 1);
    GetDot(r2, 1);
...
func_9()
{
    ...
    if (!r0) goto L_0a90;
    // credits.sc:184
    r1 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:184
    r2 = GetDotStr("Width");  // @pool 0xaf
    CopyExtWr(r1, 4, 2);
    r5 = 0;
    SetDot(r3, 1);
    ...
    // credits.sc:187
  L_0a90:
    r1 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:187
    r2 = GetDotStr("Width");  // @pool 0xaf
    CopyExtWr(r1, 4, 2);
    r5 = 0;
    SetDot(r3, 1);
  ...
  L_0bac:
    ...
    // credits.sc:199
  L_0bec:
    r3 = GetDotStr("isActionActive");  // @pool 0xf7  // @src credits.sc:199
    r4 = "skip_cutscene";
    GetDot(r2, 1);
    Free2(r3, r4);
    if (!r2) goto L_0c2c;
  ...
  L_0cc4:
    ...
    // credits.sc:215
  L_0d04:
    r3 = GetDotStr("isActionActive");  // @pool 0xf7  // @src credits.sc:215
    r4 = "skip_cutscene";
    GetDot(r2, 1);
    Free2(r3, r4);
    if (!r2) goto L_0d44;
...
{
    // credits.sc:159
    r1 = GetDotStr("!vector");  // @pool 0x125  // @src credits.sc:159
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // credits.sc:161
...
func_14()
{
    ...
    Free1(r0);
    // credits.sc:252
    r1 = GetDotStr("getNamedString");  // @pool 0x10f  // @src credits.sc:252
    ...
    Free1(r0);
    // credits.sc:253
    r1 = GetDotStr("splitString");  // @pool 0x2b2  // @src credits.sc:253
    CopyExtWr(r0, 2, 4);
    r3 = "\n";
    r4 = true;
    GetDot(r0, 3);
    ...
    r0 = (str)r0;
    // credits.sc:254
    r1 = GetDotStr("Height");  // @pool 0x2f  // @src credits.sc:254
    g3 = r4;
    SetDotRaw(r2, 47);
    Free1(r3);
    r3 = 1;
  ...
  L_1430:
    ...
    // credits.sc:263
  L_14b8:
    r4 = GetDotStr("Plane");  // @pool 0x0  // @src credits.sc:263
    SetDotRaw(r3, 156);
    Free1(r4);
    g4 = r4;
    r5 = GetDotStr("Width");  // @pool 0xaf
    r6 = 0.8399999737739563f;
    r5 = r5 * r6;
    r6 = GetDotStr("Height");  // @pool 0x2f
    g8 = r4;
    SetDotRaw(r7, 47);
    Free1(r8);
    r6 = r6 + r7;
    ...
    Free1(r2);
    // credits.sc:265
    r3 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:265
    r4 = GetDotStr("Width");  // @pool 0xaf
  ...
  L_15c0:
    ...
    r3 = r3 > r4;
    if (!r3) goto L_1668;
    r4 = GetDotStr("destroy");  // @pool 0x2c0  // @src credits.sc:277
    GetDot(r3, 0);
    Free2(r4, r3);
    // credits.sc:280
  L_1668:
  ...
  L_17a0:
    ...
    Free1(r3);
    // credits.sc:288
    r4 = GetDotStr("!vec2");  // @pool 0xbd  // @src credits.sc:288
    r5 = GetDotStr("Width");  // @pool 0xaf
    ...
    // credits.sc:292
  L_1830:
    r4 = GetDotStr("isActionActive");  // @pool 0xf7  // @src credits.sc:292
    r5 = "skip_cutscene";
    GetDot(r3, 1);
    Free2(r4, r5);
    if (!r3) goto L_1870;
  ...
  L_188c:
    ...
    // credits.sc:299
  L_1894:
    r3 = GetDotStr("destroy");  // @pool 0x2c0  // @src credits.sc:299
    GetDot(r2, 0);
    Free2(r3, r2);
    // credits.sc:300
...
onReturn()
{
  ...
  L_1970:
    if (!r0) goto L_1990;
    // credits.sc:37
    r1 = GetDotStr("destroy");  // @pool 0x2c0  // @src credits.sc:37
    GetDot(r0, 0);
    Free2(r1, r0);
    // credits.sc:39
  L_1990:
...
{
    // credits.sc:45
    r1 = GetDotStr("destroy");  // @pool 0x2c0  // @src credits.sc:45
    GetDot(r0, 0);
    Free2(r1, r0);
    // credits.sc:46
