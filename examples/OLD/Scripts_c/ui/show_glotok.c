...
initUI()
{
    ...
    Free2(r3, r2);
    // show_glotok.sc:33
    r3 = GetDotStr("createSceneRemover");  // @pool 0xc1  // @src show_glotok.sc:33
    g4 = r1;
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
    ...
    r6 = GetDotStr("loadSound3D");  // @pool 0x12d
    r7 = "fx_glotok_loop";
    GetDot(r5, 1);
    Free2(r6, r7);
    r7 = r0;
...
func_6()
{
    ...
    r2 = (float)r2;
    // show_glotok.sc:73
    r4 = GetDotStr("!rotateX");  // @pool 0x168  // @src show_glotok.sc:73
    r5 = r0;
    GetDot(r3, 1);
    Free1(r4);
    r5 = GetDotStr("!rotateY");  // @pool 0x171
    r6 = r1;
    ...
    Free2(r5, r4);
    // show_glotok.sc:75
    r5 = GetDotStr("!vec3");  // @pool 0x183  // @src show_glotok.sc:75
    r6 = 0;
    r7 = 0;
    r8 = r2;
    r8 = Neg(r8);
