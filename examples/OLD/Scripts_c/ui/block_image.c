...
{
    // block_image.sc:13
    r1 = GetDotStr("!vec3");  // @pool 0x0  // @src block_image.sc:13
    r2 = 0;
    r3 = 0;
    r4 = 0;
    GetDot(r0, 3);
    ...
    Free1(r0);
    // block_image.sc:14
    r1 = GetDotStr("fillA");  // @pool 0x6  // @src block_image.sc:14
    g2 = r3;
    g3 = r4;
    GetDot(r0, 2);
    Free3(r1, r2, r0);
    // block_image.sc:17
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0xc  // @src block_image.sc:17
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // block_image.sc:18
    ...
    Free3(r2, r3, r1);
    // block_image.sc:19
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0x49  // @src block_image.sc:19
    r5 = r0;
    SetDotRaw(r4, 99);
    Free1(r5);
    GetDot(r3, 0);
  ...
  L_0190:
    ...
    r0 = (str)r0;
    // block_image.sc:25
    r2 = GetDotStr("fillA");  // @pool 0x6  // @src block_image.sc:25
    g3 = r3;
    g4 = r4;
    GetDot(r1, 2);
    Free3(r2, r3, r1);
...
func_5()
{
    ...
    if (r0) goto L_039c;
    // block_image.sc:52
    r1 = GetDotStr("createRTImage");  // @pool 0xa3  // @src block_image.sc:52
    r3 = r_neg4;
    SetDotRaw(r2, 177);
    Free1(r3);
    r4 = r_neg4;
