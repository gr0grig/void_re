...
renderTooltip()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src body_free_limfa.sc:46
    SetDotRaw(r1, 50);
    Free1(r2);
    g2 = r13;
    r3 = 256;
  ...
  L_01f4:
    r1 = GetDotStr("format");  // @pool 0x45  // @src body_free_limfa.sc:48
    r2 = "%s\n%u / %u";
...
initUI()
{
  ...
  L_0344:
    ...
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_free_limfa.sc:59
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
onMouseButtonLeft()
{
    ...
    r1 = GetDotStr("!regionMask");  // @pool 0xb4  // @src body_free_limfa.sc:80
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    ...
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src body_free_limfa.sc:81
    SetDotRaw(r1, 192);
    Free1(r2);
    r4 = r_neg4;
    SetDotRaw(r3, 187);
    ...
    r3 = GetDotStr("Plane");  // @pool 0x2c  // @src body_free_limfa.sc:84
    SetDotRaw(r2, 225);
    Free1(r3);
    r3 = "fontmain_10.ft";
    GetDot(r1, 1);
...
func_13()
{
  ...
  L_0a68:
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_free_limfa.sc:99
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
enableControl()
{
    ...
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_free_limfa.sc:111
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "onFreeLimfa";
    g3 = r4;
