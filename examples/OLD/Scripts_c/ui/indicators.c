...
initUI()
{
    ...
    // indicators.sc:48
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src indicators.sc:48
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // indicators.sc:49
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src indicators.sc:49
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g10;
    Free1(r0);
    // indicators.sc:50
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src indicators.sc:50
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    Free1(r0);
    // indicators.sc:51
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src indicators.sc:51
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
    Free1(r0);
    // indicators.sc:52
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src indicators.sc:52
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g18;
    Free1(r0);
    // indicators.sc:54
    r0 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:54
    r0 = (float)r0;
    r1 = 1200.0f;
    r0 = r0 / r1;
    r0 = g17;
  ...
  L_0138:
    ...
    SetDotRaw(r2, 15);
    Free1(r3);
    r4 = GetDotStr("!regionMask");  // @pool 0x53
    GetDot(r3, 0);
    Free1(r4);
    GetDot(r1, 1);
    Free3(r2, r3, r1);
  ...
  L_03f0:
    ...
    // indicators.sc:72
    r2 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:72
    r2 = (int)r2;
    // indicators.sc:73
    r3 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:73
    r4 = 4.0f;
    r3 = r3 * r4;
    r4 = 3.0f;
    r3 = r3 / r4;
    r3 = (int)r3;
    // indicators.sc:75
    r4 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:75
    r5 = 1200.0f;
    r4 = r4 / r5;
    r4 = (float)r4;
    // indicators.sc:77
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:77
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 202;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:78
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:78
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 112;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:81
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:81
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 78;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:82
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:82
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 45;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:85
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:85
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 17;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:86
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:86
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 107;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:89
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:89
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 145;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:90
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:90
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 39;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:93
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:93
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 240;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:94
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:94
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 118;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:97
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:97
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 355;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:98
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:98
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 66;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:101
    r5 = GetDotStr("Width");  // @pool 0x77  // @src indicators.sc:101
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 465;
    r7 = r4;
    ...
    r0 = r5;
    // indicators.sc:102
    r5 = GetDotStr("Height");  // @pool 0x8  // @src indicators.sc:102
    r6 = 0.5f;
    r5 = r5 * r6;
    r6 = 102;
    r7 = r4;
    ...
    Free3(r6, r7, r5);
    // indicators.sc:107
    r1 = GetDotStr("!ppconfig");  // @pool 0x84  // @src indicators.sc:107
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g12;
    ...
    Free2(r1, r0);
    // indicators.sc:111
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0xba  // @src indicators.sc:111
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // indicators.sc:112
    ...
    Free3(r2, r3, r1);
    // indicators.sc:113
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0xf5  // @src indicators.sc:113
    r5 = r0;
    SetDotRaw(r4, 271);
    Free1(r5);
    GetDot(r3, 0);
...
{
    // funny_numbers.sci:8
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src funny_numbers.sci:8
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g0;
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x7d  // @src funny_numbers.sci:21
    r2 = 19;
    r3 = 18;
    r4 = 6;
    r5 = 4;
    ...
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src funny_numbers.sci:36
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g2;
  ...
  L_0ea8:
    ...
    r3 = GetDotStr("Plane");  // @pool 0x13  // @src funny_numbers.sci:38
    SetDotRaw(r2, 25);
    Free1(r3);
    r3 = "ui/number/";
    r4 = r0;
  ...
  L_0f54:
    r2 = GetDotStr("Plane");  // @pool 0x13  // @src funny_numbers.sci:42
    SetDotRaw(r1, 25);
    Free1(r2);
    r2 = "ui/number/minus";
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0xba  // @src funny_numbers.sci:45
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r5 = GetDotStr("createPostProcessComposer");  // @pool 0xf5  // @src funny_numbers.sci:51
    r8 = r0;
    SetDotRaw(r7, 271);
    Free1(r8);
    GetDot(r6, 0);
    ...
    r1 = GetDotStr("!ppconfig");  // @pool 0x84  // @src funny_numbers.sci:54
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
...
func_10()
{
  ...
  L_183c:
    r2 = GetDotStr("!vector");  // @pool 0x0  // @src funny_numbers.sci:130
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
...
func_12()
{
    ...
    r0 = g19;
    // indicators.sc:168
    r2 = GetDotStr("Window");  // @pool 0x205  // @src indicators.sc:168
    SetDotRaw(r1, 379);
    Free1(r2);
    r2 = "onSelectItem";
    g3 = r19;
