...
// @old_version
// @version: 0
// @globals: 9 types=04 03 03 03 03 02 03 03 03
// @func_table: 7 groups offsets=28,197,391,1409,1839,2204,2493
// @ft_group 0: parent=-1 stack=0 locals=0 vtable=[] imports=[(0,0)]
//   export "loadSounds" args=0 cb=-1 {func_37}
//   export "loadButtonSounds" args=1 cb=-1 {func_75} types=[str]
//   export "getWorldTimeString" args=1 cb=-1 {func_52} types=[int]
//   export "render" args=1 cb=0 {func_76} types=[str]
//   export "onReturn" args=0 cb=-1 {func_77}
// @ft_group 1: parent=0 stack=0 locals=0 vtable=[] imports=[(1,0)]
//   export "initMenu" args=1 cb=-1 {func_40} types=[str]
//   export "loadSounds" args=0 cb=-1 {func_37}
//   export "loadButtonSounds" args=1 cb=-1 {func_75} types=[str]
//   export "getWorldTimeString" args=1 cb=-1 {func_52} types=[int]
//   export "render" args=1 cb=0 {func_76} types=[str]
...
//   export "render" args=1 cb=0 {func_41} types=[str]
//   export "onDelete" args=0 cb=-1 {func_44}
//   export "onMouseButtonLeft" args=3 cb=-1 {func_65} types=[int,int,bool]
//   export "onMouseDblClickLeft" args=2 cb=-1 {func_68} types=[int,int]
//   export "deleteOldSaves" args=1 cb=-1 {func_48} types=[str]
//   export "onMouseMove" args=2 cb=-1 {func_69} types=[int,int]
//   export "onWinKeyDown" args=2 cb=-1 {func_70} types=[int,bool]
//   export "deleteCurrent" args=0 cb=-1 {func_71}
//   export "onMouseWheel" args=3 cb=-1 {func_72} types=[int,int,float]
//   export "loadSounds" args=0 cb=-1 {func_37}
//   export "loadButtonSounds" args=1 cb=-1 {func_75} types=[str]
//   export "getWorldTimeString" args=1 cb=-1 {func_52} types=[int]
//   export "onReturn" args=0 cb=-1 {func_77}
...
//   export "onMouseMove" args=2 cb=-1 {func_69} types=[int,int]
//   export "onWinKeyDown" args=2 cb=-1 {func_70} types=[int,bool]
//   export "onMouseButtonLeft" args=3 cb=-1 {func_66} types=[int,int,bool]
//   export "deleteCurrent" args=0 cb=-1 {func_71}
//   export "onMouseWheel" args=3 cb=-1 {func_72} types=[int,int,float]
//   export "loadSounds" args=0 cb=-1 {func_37}
//   export "loadButtonSounds" args=1 cb=-1 {func_75} types=[str]
...
//   export "render" args=1 cb=0 {func_76} types=[str]
//   export "onReturn" args=0 cb=-1 {func_77}
// @ft_group 5: parent=0 stack=13 locals=13 types=[str,str,str,str,str,str,str,str,str,str,bool,bool,str] vtable=[{func_53},{func_54}] imports=[(6,0),(5,12)]
//   export "onWinKeyDown" args=2 cb=-1 {func_45} types=[int,bool]
//   export "render" args=1 cb=0 {func_55} types=[str]
//   export "onMouseMove" args=2 cb=-1 {func_57} types=[int,int]
//   export "onMouseButtonLeft" args=3 cb=-1 {func_60} types=[int,int,bool]
//   export "loadSounds" args=0 cb=-1 {func_37}
//   export "loadButtonSounds" args=1 cb=-1 {func_75} types=[str]
//   export "getWorldTimeString" args=1 cb=-1 {func_52} types=[int]
//   export "onReturn" args=0 cb=-1 {func_77}
// @ft_group 6: parent=0 stack=12 locals=12 types=[str,str,str,str,str,str,str,str,str,str,bool,bool] vtable=[{func_61},{func_62}] imports=[(6,0)]
//   export "render" args=1 cb=0 {func_55} types=[str]
//   export "onMouseMove" args=2 cb=-1 {func_57} types=[int,int]
//   export "onMouseButtonLeft" args=3 cb=-1 {func_60} types=[int,int,bool]
//   export "loadSounds" args=0 cb=-1 {func_37}
...
// #export {func_40} name="initMenu"
// #export {func_41} name="render"
// #export {func_44} name="onDelete"
// #export {func_45} name="onWinKeyDown"
// #export {func_48} name="deleteOldSaves"
// #export {func_52} name="getWorldTimeString"
// #export {func_55} name="render"
// #export {func_57} name="onMouseMove"
// #export {func_60} name="onMouseButtonLeft"
// #export {func_65} name="onMouseButtonLeft"
// #export {func_66} name="onMouseButtonLeft"
// #export {func_68} name="onMouseDblClickLeft"
// #export {func_69} name="onMouseMove"
// #export {func_70} name="onWinKeyDown"
// #export {func_71} name="deleteCurrent"
// #export {func_72} name="onMouseWheel"
// #export {func_75} name="loadButtonSounds"
...
// load_menu.sc:25 (locals=4)
func_1()
{
    // load_menu.sc:18
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src load_menu.sc:18
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "cursor_paint";
    GetDot(r0, 1);
    ...
    // load_menu.sc:21
    r1 = GetDotStr("Plane");  // @pool 0x0  // @src load_menu.sc:21
    r1 = (str)r1;
    Call(r3, 0x00d0);
    Spawn(r0, 0, 0xfc);
    ...
    Free3(r1, r2, r0);
    // load_menu.sc:24
    CallNat(r1, 30916, 0x0);  // @src load_menu.sc:24
}

// load_menu.sc:34 (locals=2)
func_2()
{
    // load_menu.sc:33
    r0 = GetDotStr("Height");  // @pool 0x44  // @src load_menu.sc:33
    r1 = 1200.0f;
    r0 = r0 / r1;
    r0 = (float)r0;
    r_neg4 = r0;
...
func_3()
{
    ...
    r0 = g5;
    // controls.sci:54
    CallNat(r2, 15100, 0x0);  // @src controls.sci:54
}
...
handleMouseButtonLeft()
{
    ...
    Free1(r0);
    // controls.sci:123
    r1 = GetDotStr("!regionMask");  // @pool 0x97  // @src controls.sci:123
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 10, 2);
    ...
    Free3(r1, r2, r0);
    // controls.sci:126
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:126
    g2 = r5;
    CopyExtWr(r8, 4, 2);
    SetDotRaw(r3, 221);
    Free1(r4);
    ...
    Free1(r0);
    // controls.sci:127
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:127
    g2 = r5;
    CopyExtWr(r9, 4, 2);
    SetDotRaw(r3, 221);
    Free1(r4);
    ...
    Free1(r0);
    // controls.sci:129
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:129
    r2 = 96;
    g3 = r5;
    r2 = r2 * r3;
    r3 = 20;
...
handleMouseMove()
{
  ...
  L_051c:
    ...
    r1 = (str)r1;
    g3 = r1;
    r5 = GetDotStr("irandMax");  // @pool 0xf1
    g7 = r1;
    SetDotRaw(r6, 235);
    Free1(r7);
    GetDot(r4, 1);
    ...
    Free1(r0);
    // controls.sci:189
    goto L_0634;  // @src controls.sci:189
    // controls.sci:192
  L_05c4:
    ...
    // controls.sci:185
  L_0634:
    goto L_0664;  // @src controls.sci:185
    // controls.sci:196
  L_063c:
...
func_8()
{
  ...
  L_096c:
    ...
    if (!r4) goto L_0cd8;
    // controls.sci:328
    r6 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:328
    SetDotRaw(r5, 267);
    Free1(r6);
    r6 = "fontmain_";
    r8 = 14;
    ...
    if (r5) goto L_0c30;
    // controls.sci:330
    r7 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:330
    SetDotRaw(r6, 300);
    Free1(r7);
    r7 = r4;
    r8 = 256;
    ...
    // controls.sci:332
  L_0c30:
    r6 = GetDotStr("format");  // @pool 0x13f  // @src controls.sci:332
    CopyExtWr(r1, 9, 2);
    r10 = r2;
    SetDot(r8, 1);
    r9 = 6;
...
func_11()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:162
    r6 = GetDotStr("Globals");  // @pool 0x164  // @src ..\sound.sci:162
    SetDotRaw(r5, 364);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x177  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
func_16()
{
  ...
  L_1b24:
    ...
    Free1(r6);
    // controls.sci:391
    goto L_1c20;  // @src controls.sci:391
    // controls.sci:394
  L_1be4:
  ...
  L_20ac:
    ...
    // controls.sci:429
  L_21ec:
    r7 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:429
    SetDotRaw(r6, 453);
    Free1(r7);
    GetDot(r5, 0);
    Free1(r6);
...
{
    // controls.sci:477
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:477
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // controls.sci:480
  ...
  L_235c:
    ...
    r_neg4 = r2;
    // controls.sci:488
    r4 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:488
    SetDotRaw(r3, 267);
    Free1(r4);
    r4 = "fontmain_";
    r6 = r_neg4;
    ...
    Free1(r2);
    // controls.sci:490
    r4 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:490
    SetDotRaw(r3, 300);
    Free1(r4);
    r4 = r1;
    r5 = GetDotStr("Width");  // @pool 0xdd
    r7 = r1;
    SetDotRaw(r6, 68);
    Free1(r7);
    GetDot(r2, 3);
...
func_19()
{
  ...
  L_2620:
    ...
    if (!r0) goto L_26ac;
    // controls.sci:441
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:441
    r3 = r_neg5;
    SetDotRaw(r2, 227);
    Free1(r3);
    g3 = r5;
  ...
  L_26ac:
    ...
    if (!r0) goto L_2744;
    // controls.sci:443
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:443
    r2 = GetDotStr("Width");  // @pool 0xdd
    r4 = r_neg5;
    SetDotRaw(r3, 227);
    Free1(r4);
    g4 = r5;
  ...
  L_2744:
    ...
    if (!r0) goto L_27dc;
    // controls.sci:445
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:445
    r3 = r_neg5;
    SetDotRaw(r2, 227);
    Free1(r3);
    g3 = r5;
    r2 = r2 * r3;
    r3 = GetDotStr("Height");  // @pool 0x44
    r5 = r_neg5;
    SetDotRaw(r4, 260);
    Free1(r5);
    g5 = r5;
  ...
  L_27dc:
    ...
    if (!r0) goto L_2880;
    // controls.sci:447
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:447
    r2 = GetDotStr("Width");  // @pool 0xdd
    r4 = r_neg5;
    SetDotRaw(r3, 227);
    Free1(r4);
  ...
  L_2880:
    ...
    if (!r0) goto L_2928;
    // controls.sci:449
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:449
    g2 = r5;
    r4 = r_neg5;
    SetDotRaw(r3, 227);
    Free1(r4);
  ...
  L_2928:
    ...
    if (!r0) goto L_29fc;
    // controls.sci:451
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:451
    r2 = GetDotStr("Width");  // @pool 0xdd
    g3 = r5;
    r5 = r_neg5;
    SetDotRaw(r4, 227);
    ...
    // controls.sci:454
  L_29fc:
    r1 = GetDotStr("!vec2");  // @pool 0xd7  // @src controls.sci:454
    r2 = GetDotStr("Width");  // @pool 0xdd
    r3 = 0.5f;
    r2 = r2 * r3;
    g3 = r5;
...
createLabel()
{
    ...
    // controls.sci:508
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:508
    SetDotRaw(r2, 267);
    Free1(r3);
    r3 = "fontmain_";
    CopyExtWr(r4, 7, 2);
    ...
    Free1(r1);
    // controls.sci:510
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src controls.sci:510
    SetDotRaw(r2, 300);
    Free1(r3);
    r3 = r0;
    r4 = GetDotStr("Width");  // @pool 0xdd
    r6 = r0;
    SetDotRaw(r5, 68);
    Free1(r6);
    GetDot(r1, 3);
...
{
    // controls.sci:527
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:527
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // controls.sci:530
...
{
    // controls.sci:565
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:565
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // controls.sci:568
    ...
    r1 = (str)r1;
    // controls.sci:569
    r3 = GetDotStr("!regionMask");  // @pool 0x97  // @src controls.sci:569
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    // controls.sci:570
...
{
    // controls.sci:625
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:625
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // controls.sci:627
    ...
    r2 = (str)r2;
    // controls.sci:630
    r4 = GetDotStr("!regionMask");  // @pool 0x97  // @src controls.sci:630
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    // controls.sci:631
...
{
    // controls.sci:698
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:698
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // controls.sci:699
...
{
    // controls.sci:152
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:152
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 0, 2);
    Free1(r0);
    // controls.sci:153
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:153
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 1, 2);
    Free1(r0);
    // controls.sci:154
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:154
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 2, 2);
    Free1(r0);
    // controls.sci:155
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:155
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 3, 2);
    Free1(r0);
    // controls.sci:156
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:156
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 4, 2);
    ...
    Free1(r0);
    // controls.sci:162
    Call(r0, 0x0138);  // @src controls.sci:162
    // controls.sci:163
    Call(r0, 0x3c48);  // @src controls.sci:163
    // controls.sci:166
  L_3c14:
    ...
    Call(r3, 0x3e60);
    // controls.sci:165
    goto L_3c14;  // @src controls.sci:165
}
...
{
    // controls.sci:67
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:67
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g1;
  ...
  L_3c7c:
    ...
    SetDotRaw(r2, 371);
    Free1(r3);
    r4 = GetDotStr("loadSound");  // @pool 0x1f5
    r5 = "button_";
    r6 = r0;
    r6 = (as_string)r6;
    r5 = r5 + r6;
    ...
    // controls.sci:72
  L_3d0c:
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:72
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g2;
    ...
    SetDotRaw(r1, 371);
    Free1(r2);
    r3 = GetDotStr("loadSound");  // @pool 0x1f5
    r4 = "scroll";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // controls.sci:75
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:75
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
...
createCheckbox()
{
    ...
    // controls.sci:269
  L_3ee0:
    goto L_3f4c;  // @src controls.sci:269
    // controls.sci:273
  L_3ee8:
  ...
  L_3f54:
    ...
    // controls.sci:280
  L_4154:
    goto L_42f4;  // @src controls.sci:280
    // controls.sci:286
  L_415c:
  ...
  L_4264:
    ...
    // controls.sci:278
  L_42f4:
    goto L_43e4;  // @src controls.sci:278
    // controls.sci:297
  L_42fc:
...
// load_menu.sc:99 (locals=8)
createCheckbox()
{
    // load_menu.sc:84
    r0 = r_neg4;  // @src load_menu.sc:84
    r0 = g6;
    Free1(r0);
    // load_menu.sc:87
    g2 = r7;  // @src load_menu.sc:87
    SetDotRaw(r1, 47);
    Free1(r2);
    r2 = "createImg";
    ...
    Free5(r1, r2, r3, r4, r0);
    // load_menu.sc:92
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src load_menu.sc:92
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
    ...
    Free2(r1, r0);
    // load_menu.sc:98
    CallNat2(r3, 19480, 0x0);  // @src load_menu.sc:98
    // load_menu.sc:99
    Free1(r_neg4);  // @src load_menu.sc:99
    return r0;
}

// load_menu.sc:117 (locals=1)
func_41()
{
    // load_menu.sc:117
    r0 = r_neg4;  // @src load_menu.sc:117
    Call(r1, 0x4748);
    Free1(r_neg4);  // @src load_menu.sc:117
    return r0;
}
...
setCheckBoxState()
{
    ...
    g2 = r7;  // @src saveloadbase.sci:192
    SetDotRaw(r1, 47);
    Free1(r2);
    r2 = "render";
    r3 = r_neg4;
  ...
  L_4794:
    ...
    Free1(r2);
    // saveloadbase.sci:197
    goto L_4a98;  // @src saveloadbase.sci:197
  ...
  L_48d8:
    ...
    Free1(r2);
    // saveloadbase.sci:199
    goto L_4a98;  // @src saveloadbase.sci:199
...
// load_menu.sc:126 (locals=6)
createSlider()
{
    // load_menu.sc:123
    CopyExtWr(r7, 0, 4);  // @src load_menu.sc:123
    r1 = -1;
    r0 = r0 != r1;
    if (!r0) goto L_4bb4;
    // load_menu.sc:124
    CopyExtWr(r1, 2, 4);  // @src load_menu.sc:124
    CopyExtWr(r7, 3, 4);
    CopyExtWr(r9, 4, 4);
    r3 = r3 + r4;
    SetDot(r1, 1);
    ...
    SetDotRaw(r1, 806);
    Free1(r2);
    CallNat2(r5, 27068, 0x2);
    // load_menu.sc:126
  L_4bb4:
    return r0;  // @src load_menu.sc:126
}

// load_menu.sc:166 (locals=3)
getSliderValue()
{
    // load_menu.sc:163
    r0 = false;  // @src load_menu.sc:163
    r1 = r_neg5;
    r2 = 27;
    r1 = r1 == r2;
    if (!r1) goto L_4c00;
  ...
  L_4c00:
    if (!r0) goto L_4c14;
    // load_menu.sc:164
    CallNat2(r3, 19480, 0x0);  // @src load_menu.sc:164
    // load_menu.sc:166
  L_4c14:
    return r0;  // @src load_menu.sc:166
}

// load_menu.sc:113 (locals=2)
setSliderValue()
{
    // load_menu.sc:108
    r0 = false;  // @src load_menu.sc:108
    Call(r1, 0x4c44);
    // load_menu.sc:111
  L_4c30:
    Free1(r1);  // @src load_menu.sc:111
    RetV(r0);
    r0 = (int)r0;
    // load_menu.sc:110
    goto L_4c30;  // @src load_menu.sc:110
}
...
func_47()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:159
    SetDotRaw(r1, 267);
    Free1(r2);
    r2 = "fontmain_16.ft";
    GetDot(r0, 1);
    ...
    r0 = GetDotStr("Height");  // @pool 0x44  // @src saveloadbase.sci:161
    CopyExtWr(r0, 2, 4);
    SetDotRaw(r1, 68);
    Free1(r2);
    r2 = 2;
    ...
    r2 = GetDotStr("getSavegameList");  // @pool 0x347  // @src saveloadbase.sci:163
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    Call(r2, 0x4fbc);
    ...
    Call(r0, 0x50d4);  // @src saveloadbase.sci:165
    ...
    Call(r3, 0x4ac0);
    CopyExtRd(r0, 5, 4);
    goto L_4ddc;  // @src saveloadbase.sci:168
  ...
  L_4e10:
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src saveloadbase.sci:174
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 2, 4);
    ...
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src saveloadbase.sci:175
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 3, 4);
    ...
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src saveloadbase.sci:176
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 4, 4);
  ...
  L_4e90:
    ...
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:179
    SetDotRaw(r2, 300);
    Free1(r3);
    CopyExtWr(r0, 3, 4);
    r4 = GetDotStr("Width");  // @pool 0xdd
  ...
  L_4fb0:
    Call(r0, 0x55ec);  // @src saveloadbase.sci:185
...
destroyControls()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src saveloadbase.sci:140
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
...
func_49()
{
  ...
  L_51b4:
    ...
    Free2(r2, r1);
    // saveloadbase.sci:23
    goto L_5208;  // @src saveloadbase.sci:23
    // saveloadbase.sci:27
  L_51f4:
    ...
    // saveloadbase.sci:22
  L_5208:
    goto L_50f8;  // @src saveloadbase.sci:22
    // saveloadbase.sci:21
  L_5210:
    goto L_55e8;  // @src saveloadbase.sci:21
    // saveloadbase.sci:31
  L_5218:
  ...
  L_5230:
    ...
    r0 = r3;
    // saveloadbase.sci:34
    goto L_5304;  // @src saveloadbase.sci:34
    // saveloadbase.sci:38
  L_52b4:
  ...
  L_545c:
    ...
    // saveloadbase.sci:67
  L_54a8:
    r5 = GetDotStr("!vector");  // @pool 0x1d7  // @src saveloadbase.sci:67
    GetDot(r4, 0);
    Free1(r5);
    r4 = (str)r4;
    // saveloadbase.sci:68
...
loadSounds()
{
  ...
  L_5688:
    if (!r2) goto L_5708;
    // saveloadbase.sci:92
    r3 = GetDotStr("getString");  // @pool 0x3b0  // @src saveloadbase.sci:92
    r4 = 2;
    GetDot(r2, 1);
    Free1(r3);
    r2 = (str)r2;
  ...
  L_5738:
    ...
    SetDotRaw(r4, 326);
    Free1(r5);
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 3;
    GetDot(r5, 1);
    Free1(r6);
    GetDot(r3, 1);
    ...
    Free1(r3);
    // saveloadbase.sci:100
    goto L_593c;  // @src saveloadbase.sci:100
  ...
  L_57f0:
    ...
    Free1(r3);
    // saveloadbase.sci:103
    goto L_593c;  // @src saveloadbase.sci:103
  ...
  L_593c:
    r2 = GetDotStr("Width");  // @pool 0xdd  // @src saveloadbase.sci:112
    CopyExtWr(r3, 5, 4);
    r6 = r0;
    SetDot(r4, 1);
    r5 = 0;
    ...
    r3 = GetDotStr("Height");  // @pool 0x44  // @src saveloadbase.sci:113
    CopyExtWr(r2, 5, 4);
    SetDotRaw(r4, 235);
    Free1(r5);
    CopyExtWr(r0, 6, 4);
    ...
    r5 = GetDotStr("!tuple");  // @pool 0x3ba  // @src saveloadbase.sci:114
    r6 = r2;
    r7 = r3;
    GetDot(r4, 2);
    Free1(r5);
...
// load_menu.sc:48 (locals=6)
func_51()
{
    // load_menu.sc:40
    r1 = GetDotStr("getString");  // @pool 0x3b0  // @src load_menu.sc:40
    r2 = 5;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (str)r0;
    // load_menu.sc:41
    r2 = r_neg4;  // @src load_menu.sc:41
    r3 = "GameTime";
    SetDot(r1, 1);
    Free1(r3);
    r1 = (int)r1;
    // load_menu.sc:43
    r4 = r_neg4;  // @src load_menu.sc:43
    SetDotRaw(r3, 855);
    Free1(r4);
    r4 = "CurrentTime";
    GetDot(r2, 1);
    ...
    // load_menu.sc:46
  L_5b6c:
    r2 = null_str;  // @src load_menu.sc:46
    r_neg5 = r2;
    Free3(r2, r0, r_neg4);
    return r0;
}

// load_menu.sc:67 (locals=9)
func_52()
{
    // load_menu.sc:54
    r0 = r_neg4;  // @src load_menu.sc:54
    r1 = 432000;
    r0 = r0 / r1;
    // load_menu.sc:55
    r1 = "";  // @src load_menu.sc:55
    // load_menu.sc:57
    r2 = r0;  // @src load_menu.sc:57
    r3 = 0;
    r2 = r2 == r3;
    if (!r2) goto L_5c30;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:57
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6001;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:58
  L_5c30:
    r2 = r0;  // @src load_menu.sc:58
    r3 = 1;
    r2 = r2 == r3;
    if (!r2) goto L_5cb4;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:58
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6004;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:59
  L_5cb4:
    r2 = r0;  // @src load_menu.sc:59
    r3 = 2;
    r2 = r2 == r3;
    if (!r2) goto L_5d38;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:59
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6007;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:60
  L_5d38:
    r2 = r0;  // @src load_menu.sc:60
    r3 = 3;
    r2 = r2 == r3;
    if (!r2) goto L_5dbc;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:60
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6010;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:61
  L_5dbc:
    r2 = r0;  // @src load_menu.sc:61
    r3 = 4;
    r2 = r2 == r3;
    if (!r2) goto L_5e40;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:61
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6013;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:62
  L_5e40:
    r2 = r0;  // @src load_menu.sc:62
    r3 = 5;
    r2 = r2 == r3;
    if (!r2) goto L_5ec4;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:62
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6016;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:63
  L_5ec4:
    r2 = r0;  // @src load_menu.sc:63
    r3 = 6;
    r2 = r2 == r3;
    if (!r2) goto L_5f48;
    r4 = GetDotStr("splitString");  // @pool 0x3d7  // @src load_menu.sc:63
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 6019;
    GetDot(r5, 1);
    Free1(r6);
    ...
    // load_menu.sc:65
  L_5f48:
    r3 = GetDotStr("format");  // @pool 0x13f  // @src load_menu.sc:65
    r4 = r1;
    r6 = GetDotStr("getString");  // @pool 0x3b0
    r7 = 5;
    GetDot(r5, 1);
    ...
    r2 = (str)r2;
    // load_menu.sc:66
    r3 = r2;  // @src load_menu.sc:66
    r_neg5 = r3;
    Free3(r3, r2, r1);
    return r0;
}

// load_menu.sc:174 (locals=3)
func_53()
{
    // load_menu.sc:172
    r1 = GetDotStr("removeSavegame");  // @pool 0x3e5  // @src load_menu.sc:172
    CopyExtWr(r0, 2, 5);
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // load_menu.sc:173
    CallNat2(r3, 19480, 0x0);  // @src load_menu.sc:173
    // load_menu.sc:174
    return r0;  // @src load_menu.sc:174
}

// load_menu.sc:179 (locals=0)
loadButtonSounds()
{
    // load_menu.sc:178
    CallNat2(r3, 19480, 0x0);  // @src load_menu.sc:178
    // load_menu.sc:179
    return r0;  // @src load_menu.sc:179
}
...
func_55()
{
    ...
    r0 = GetDotStr("Width");  // @pool 0xdd  // @src saveloadbase.sci:357
    CopyExtWr(r3, 2, 6);
    r3 = 0;
    SetDot(r1, 1);
    r0 = r0 - r1;
    ...
    r1 = GetDotStr("Height");  // @pool 0x44  // @src saveloadbase.sci:358
    CopyExtWr(r3, 3, 6);
    r4 = 1;
    SetDot(r2, 1);
    r1 = r1 - r2;
    ...
    Call(r7, 0x6398);
    // saveloadbase.sci:362
    goto L_625c;  // @src saveloadbase.sci:362
  ...
  L_625c:
    ...
    Call(r7, 0x6398);
    // saveloadbase.sci:369
    goto L_6390;  // @src saveloadbase.sci:369
...
func_60()
{
    ...
    // saveloadbase.sci:390
    goto L_69a0;  // @src saveloadbase.sci:390
...
// load_menu.sc:157 (locals=6)
onMouseMove()
{
    // load_menu.sc:153
    r0 = r_neg5;  // @src load_menu.sc:153
    CopyExtRd(r0, 0, 5);
    Free1(r0);
    // load_menu.sc:154
    r1 = r_neg4;  // @src load_menu.sc:154
    Call(r2, 0x5a7c);
    // load_menu.sc:155
    r2 = GetDotStr("format");  // @pool 0x13f  // @src load_menu.sc:155
    r4 = GetDotStr("getNamedString");  // @pool 0x3f4
    r5 = "delete_save_game";
    GetDot(r3, 1);
    Free2(r4, r5);
    r4 = r0;
    ...
    r1 = (str)r1;
    // load_menu.sc:156
    r2 = r1;  // @src load_menu.sc:156
    Call(r3, 0x6a54);
    // load_menu.sc:157
    Free4(r1, r0, r_neg4, r_neg5);  // @src load_menu.sc:157
    return r0;
}
...
func_64()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:338
    SetDotRaw(r1, 267);
    Free1(r2);
    r2 = "fontmain_20.ft";
    GetDot(r0, 1);
    ...
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:339
    SetDotRaw(r1, 300);
    Free1(r2);
    CopyExtWr(r1, 2, 6);
    r3 = GetDotStr("Width");  // @pool 0xdd
    CopyExtWr(r1, 5, 6);
    SetDotRaw(r4, 68);
    Free1(r5);
    GetDot(r0, 3);
    ...
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:340
    SetDotRaw(r1, 300);
    Free1(r2);
    CopyExtWr(r1, 2, 6);
    r3 = GetDotStr("Width");  // @pool 0xdd
    ...
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src saveloadbase.sci:341
    SetDotRaw(r1, 300);
    Free1(r2);
    CopyExtWr(r1, 2, 6);
    r3 = GetDotStr("Width");  // @pool 0xdd
    ...
    SetDotRaw(r1, 326);
    Free1(r2);
    r3 = GetDotStr("getString");  // @pool 0x3b0
    r4 = 7;
    GetDot(r2, 1);
    Free1(r3);
    GetDot(r0, 1);
    ...
    r0 = GetDotStr("Width");  // @pool 0xdd  // @src saveloadbase.sci:346
    CopyExtWr(r5, 2, 6);
    r3 = 0;
    SetDot(r1, 1);
    r0 = r0 - r1;
    ...
    r1 = GetDotStr("Height");  // @pool 0x44  // @src saveloadbase.sci:347
    CopyExtWr(r3, 3, 6);
    r4 = 1;
    SetDot(r2, 1);
    r1 = r1 - r2;
    ...
    r3 = GetDotStr("!tuple");  // @pool 0x3ba  // @src saveloadbase.sci:348
    r4 = r0;
    r5 = r1;
    GetDot(r2, 2);
    Free1(r3);
    ...
    r3 = GetDotStr("!tuple");  // @pool 0x3ba  // @src saveloadbase.sci:350
    r4 = r0;
    r5 = r1;
    GetDot(r2, 2);
    Free1(r3);
...
// load_menu.sc:130 (locals=3)
func_65()
{
    // load_menu.sc:130
    r0 = r_neg6;  // @src load_menu.sc:130
    r1 = r_neg5;
    r2 = r_neg4;
    Call(r3, 0x6e98);
    return r0;  // @src load_menu.sc:130
}
...
func_66()
{
    ...
    g2 = r7;  // @src saveloadbase.sci:222
    SetDotRaw(r1, 47);
    Free1(r2);
  ...
  L_6f84:
    ...
    g3 = r8;  // @src saveloadbase.sci:230
    r4 = r0;
    SetDot(r2, 1);
    r2 = (int)r2;
  ...
  L_7064:
    Call(r3, 0x55ec);  // @src saveloadbase.sci:240
    // saveloadbase.sci:231
    goto L_7190;  // @src saveloadbase.sci:231
  ...
  L_7188:
    Call(r3, 0x55ec);  // @src saveloadbase.sci:251
...
// load_menu.sc:142 (locals=10)
onMouseMove()
{
    // load_menu.sc:136
    r0 = r_neg5;  // @src load_menu.sc:136
    r1 = r_neg4;
    r2 = true;
    Call(r3, 0x6e98);
    // load_menu.sc:138
    r1 = r_neg5;  // @src load_menu.sc:138
    r2 = r_neg4;
    Call(r3, 0x7194);
    // load_menu.sc:139
    r1 = r0;  // @src load_menu.sc:139
    r2 = -1;
    r1 = r1 != r2;
    if (!r1) goto L_7434;
    // load_menu.sc:140
    r2 = GetDotStr("sendGenericEventToWorld");  // @pool 0x469  // @src load_menu.sc:140
    g3 = r6;
    ...
    // load_menu.sc:142
  L_7434:
    return r0;  // @src load_menu.sc:142
}
...
func_70()
{
  ...
  L_74b0:
    ...
    r1 = GetDotStr("destroy");  // @pool 0x4a5  // @src saveloadbase.sci:216
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_71()
{
  ...
  L_7540:
    ...
    r1 = GetDotStr("removeSavegame");  // @pool 0x3e5  // @src saveloadbase.sci:263
    CopyExtWr(r1, 4, 4);
    CopyExtWr(r7, 5, 4);
    CopyExtWr(r9, 6, 4);
    r5 = r5 + r6;
  ...
  L_75f8:
    ...
    // saveloadbase.sci:261
  L_760c:
    goto L_76ec;  // @src saveloadbase.sci:261
  ...
  L_7614:
    ...
    r1 = GetDotStr("removeSavegame");  // @pool 0x3e5  // @src saveloadbase.sci:270
    CopyExtWr(r1, 4, 4);
    CopyExtWr(r7, 5, 4);
    CopyExtWr(r9, 6, 4);
    r5 = r5 + r6;
...
func_72()
{
  ...
  L_7830:
    Call(r0, 0x55ec);  // @src saveloadbase.sci:288
...
// load_menu.sc:78 (locals=2)
func_74()
{
    // load_menu.sc:76
  L_78cc:
    Free1(r1);  // @src load_menu.sc:76
    RetV(r0);
    r0 = (int)r0;
    // load_menu.sc:75
    goto L_78cc;  // @src load_menu.sc:75
}
...
{
    // controls.sci:83
    r1 = GetDotStr("!vector");  // @pool 0x1d7  // @src controls.sci:83
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g1;
...
// load_menu.sc:187 (locals=4)
func_76()
{
    // load_menu.sc:186
    g2 = r7;  // @src load_menu.sc:186
    SetDotRaw(r1, 47);
    Free1(r2);
    r2 = "render";
    r3 = r_neg4;
    ...
    Free4(r1, r2, r3, r0);
    // load_menu.sc:187
    Free1(r_neg4);  // @src load_menu.sc:187
    return r0;
}

// load_menu.sc:194 (locals=2)
onReturn()
{
    // load_menu.sc:193
    r1 = GetDotStr("destroy");  // @pool 0x4a5  // @src load_menu.sc:193
    GetDot(r0, 0);
    Free2(r1, r0);
    // load_menu.sc:194
    return r0;  // @src load_menu.sc:194
}
