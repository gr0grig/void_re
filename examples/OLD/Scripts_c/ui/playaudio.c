...
{
    // playaudio.sc:77
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src playaudio.sc:77
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "fontmain_11.ft";
    GetDot(r0, 1);
    ...
    if (r1) goto L_0278;
    // playaudio.sc:79
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src playaudio.sc:79
    SetDotRaw(r2, 43);
    Free1(r3);
    r3 = r0;
    r4 = 256;
    ...
    // playaudio.sc:81
  L_0278:
    r2 = GetDotStr("format");  // @pool 0x3e  // @src playaudio.sc:81
...
hideControl()
{
    ...
    // playaudio.sc:64
  L_04f8:
    r0 = GetDotStr("Width");  // @pool 0x76  // @src playaudio.sc:64
    r1 = 0.5f;
    r0 = r0 * r1;
    g2 = r7;
    r3 = 0;
...
{
    // playaudio.sc:98
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src playaudio.sc:98
    SetDotRaw(r1, 158);
    Free1(r2);
    ...
    Free1(r0);
    // playaudio.sc:100
    r1 = GetDotStr("!regionMask");  // @pool 0xcc  // @src playaudio.sc:100
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // playaudio.sc:101
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src playaudio.sc:101
    SetDotRaw(r1, 158);
    Free1(r2);
...
func_10()
{
  ...
  L_090c:
    ...
    Free2(r6, r0);
    // playaudio.sc:114
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src playaudio.sc:114
    SetDotRaw(r1, 292);
    Free1(r2);
    GetDot(r0, 0);
    Free1(r1);
...
onMouseEnter()
{
  ...
  L_0a88:
    ...
    if (!r0) goto L_0ac8;
    // playaudio.sc:124
    r2 = GetDotStr("Window");  // @pool 0x136  // @src playaudio.sc:124
    SetDotRaw(r1, 317);
    Free1(r2);
    r2 = "onPlayAudio";
    GetDot(r0, 1);
