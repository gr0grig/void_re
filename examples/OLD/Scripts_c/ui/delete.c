...
{
    // delete.sc:77
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src delete.sc:77
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "fontmain_11.ft";
    GetDot(r0, 1);
    ...
    if (r1) goto L_0278;
    // delete.sc:79
    r3 = GetDotStr("Plane");  // @pool 0x0  // @src delete.sc:79
    SetDotRaw(r2, 43);
    Free1(r3);
    r3 = r0;
    r4 = 256;
    ...
    // delete.sc:81
  L_0278:
    r2 = GetDotStr("format");  // @pool 0x3e  // @src delete.sc:81
...
hideControl()
{
    ...
    // delete.sc:64
  L_04f8:
    r0 = GetDotStr("Width");  // @pool 0x82  // @src delete.sc:64
    r1 = 0.5f;
    r0 = r0 * r1;
    g2 = r7;
    r3 = 0;
...
{
    // delete.sc:98
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src delete.sc:98
    SetDotRaw(r1, 170);
    Free1(r2);
    ...
    Free1(r0);
    // delete.sc:100
    r1 = GetDotStr("!regionMask");  // @pool 0xda  // @src delete.sc:100
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
    Free1(r0);
    // delete.sc:101
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src delete.sc:101
    SetDotRaw(r1, 170);
    Free1(r2);
...
func_10()
{
  ...
  L_090c:
    ...
    Free2(r6, r0);
    // delete.sc:114
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src delete.sc:114
    SetDotRaw(r1, 308);
    Free1(r2);
    GetDot(r0, 0);
    Free1(r1);
...
onMouseEnter()
{
  ...
  L_0a88:
    ...
    if (!r0) goto L_0ac8;
    // delete.sc:124
    r2 = GetDotStr("Window");  // @pool 0x146  // @src delete.sc:124
    SetDotRaw(r1, 333);
    Free1(r2);
    r2 = "onDelete";
    GetDot(r0, 1);
