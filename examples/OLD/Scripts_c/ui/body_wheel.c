...
// @func_table: 2 groups offsets=8,298
...
//   export "checkHitTest" args=2 cb=1 {func_8} types=[int,int]
//   export "updateTooltip" args=0 cb=-1 {func_7}
//   export "renderTooltip" args=3 cb=-1 {func_9} types=[str,int,int]
...
// #export {func_8} name="checkHitTest"
// #export {func_9} name="renderTooltip"
...
{
    // body_wheel.sc:136
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0x0  // @src body_wheel.sc:136
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // body_wheel.sc:137
    ...
    Free2(r3, r2);
    // body_wheel.sc:139
    r3 = GetDotStr("createPostProcessComposer");  // @pool 0x3f  // @src body_wheel.sc:139
    r6 = r0;
    SetDotRaw(r5, 89);
    Free1(r6);
    GetDot(r4, 0);
    ...
    // body_wheel.sc:143
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0x0  // @src body_wheel.sc:143
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // body_wheel.sc:144
    ...
    Free3(r2, r3, r1);
    // body_wheel.sc:145
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0x3f  // @src body_wheel.sc:145
    r5 = r0;
    SetDotRaw(r4, 89);
    Free1(r5);
    GetDot(r3, 0);
...
updateTooltip()
{
    ...
    r0 = g18;
    // body_wheel.sc:40
    Call(r0, 0x0390);  // @src body_wheel.sc:40
    // body_wheel.sc:41
...
func_7()
{
  ...
  L_03f4:
    ...
    if (r0) goto L_0450;
    // body_wheel.sc:70
    r2 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:70
    SetDotRaw(r1, 166);
    Free1(r2);
    g2 = r15;
    r3 = 256;
    ...
    // body_wheel.sc:72
  L_0450:
    r1 = GetDotStr("format");  // @pool 0xb9  // @src body_wheel.sc:72
    r2 = "%s : %u%%";
    g4 = r19;
    g5 = r18;
    SetDot(r3, 1);
...
renderTooltip()
{
  ...
  L_0548:
    ...
    r3 = g18;
    // body_wheel.sc:51
    Call(r3, 0x0390);  // @src body_wheel.sc:51
    // body_wheel.sc:52
  ...
  L_0664:
    ...
    r0 = g18;
    // body_wheel.sc:57
    Call(r0, 0x0390);  // @src body_wheel.sc:57
    // body_wheel.sc:59
...
func_9()
{
    ...
    // body_wheel.sc:81
  L_06c0:
    r2 = GetDotStr("Window");  // @pool 0xdf  // @src body_wheel.sc:81
    SetDotRaw(r1, 230);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r18;
...
func_10()
{
    ...
    Free1(r0);
    // body_wheel.sc:155
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:155
    r2 = 20002;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:156
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:156
    r2 = 20003;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:157
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:157
    r2 = 20004;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:158
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:158
    r2 = 20005;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:159
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:159
    r2 = 20006;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:160
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:160
    r2 = 20007;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
    ...
    Free1(r0);
    // body_wheel.sc:161
    r1 = GetDotStr("getString");  // @pool 0x11b  // @src body_wheel.sc:161
    r2 = 20008;
    GetDot(r0, 1);
    Free1(r1);
    g1 = r19;
  ...
  L_0c3c:
    ...
    if (!r1) goto L_0e14;
    // body_wheel.sc:174
    r3 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:174
    SetDotRaw(r2, 293);
    Free1(r3);
    ...
    Free1(r1);
    // body_wheel.sc:175
    r2 = GetDotStr("!regionMask");  // @pool 0x15d  // @src body_wheel.sc:175
    GetDot(r1, 0);
    Free1(r2);
    g2 = r5;
    r3 = r0;
    ...
    Free3(r3, r4, r2);
    // body_wheel.sc:179
    r3 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:179
    r5 = r1;
    SetDotRaw(r4, 382);
    Free1(r5);
    r4 = (float)r4;
    ...
    // body_wheel.sc:182
  L_0e14:
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:182
    r2 = 57;
    g5 = r1;
    r6 = 0;
    SetDot(r4, 1);
    ...
    r3 = r3 / r4;
    r2 = r2 - r3;
    r3 = GetDotStr("Height");  // @pool 0x184
    r4 = 43;
    r3 = r3 - r4;
    g6 = r1;
    r7 = 0;
    ...
    Free1(r0);
    // body_wheel.sc:183
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:183
    r2 = 57;
    g5 = r1;
    r6 = 1;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:185
    r2 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:185
    SetDotRaw(r1, 293);
    Free1(r2);
  ...
  L_0fcc:
    ...
    if (!r1) goto L_1150;
    // body_wheel.sc:188
    r3 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:188
    SetDotRaw(r2, 293);
    Free1(r3);
    ...
    Free1(r1);
    // body_wheel.sc:189
    r3 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:189
    SetDotRaw(r2, 293);
    Free1(r3);
    ...
    Free1(r1);
    // body_wheel.sc:190
    r2 = GetDotStr("!regionMask");  // @pool 0x15d  // @src body_wheel.sc:190
    GetDot(r1, 0);
    Free1(r2);
    g2 = r7;
    r3 = r0;
  ...
  L_1158:
    ...
    r1 = r1 + r2;
    // body_wheel.sc:196
    r4 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:196
    SetDotRaw(r3, 293);
    Free1(r4);
    ...
    Free1(r2);
    // body_wheel.sc:197
    r4 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:197
    SetDotRaw(r3, 293);
    Free1(r4);
    ...
    Free1(r2);
    // body_wheel.sc:198
    r3 = GetDotStr("!regionMask");  // @pool 0x15d  // @src body_wheel.sc:198
    GetDot(r2, 0);
    Free1(r3);
    g3 = r7;
    r4 = r1;
    ...
    // body_wheel.sc:202
  L_12d8:
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:202
    r2 = 196;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:203
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:203
    r2 = 273;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:204
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:204
    r2 = 334;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:205
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:205
    r2 = 346;
    g5 = r8;
    r6 = 0;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:206
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:206
    r2 = 101;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:207
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:207
    r2 = 169;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:208
    r1 = GetDotStr("!tuple");  // @pool 0x177  // @src body_wheel.sc:208
    r2 = 128;
    g5 = r8;
    r6 = 1;
    SetDot(r4, 1);
    ...
    Free1(r0);
    // body_wheel.sc:210
    r2 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:210
    SetDotRaw(r1, 293);
    Free1(r2);
    ...
    Free1(r0);
    // body_wheel.sc:211
    r2 = GetDotStr("Plane");  // @pool 0xa0  // @src body_wheel.sc:211
    SetDotRaw(r1, 619);
    Free1(r2);
    r2 = "fontmain_16.ft";
    GetDot(r0, 1);
    ...
    Free1(r0);
    // body_wheel.sc:213
    CallNat2(r1, 8148, 0x0);  // @src body_wheel.sc:213
    // body_wheel.sc:214
...
func_11()
{
  ...
  L_17d0:
    ...
    g2 = r4;
    r3 = 86;
    r4 = GetDotStr("Height");  // @pool 0x184
    r5 = 191;
    r4 = r4 - r5;
    GetDot(r0, 3);
    Free4(r1, r2, r4, r0);
...
{
    // body_wheel.sc:95
    r1 = GetDotStr("!ppconfig");  // @pool 0x29a  // @src body_wheel.sc:95
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // body_wheel.sc:96
    ...
    Free1(r2);
    // body_wheel.sc:97
    r2 = GetDotStr("!vec2");  // @pool 0x2ad  // @src body_wheel.sc:97
    r3 = 0;
    r4 = 0;
    GetDot(r1, 2);
    Free1(r2);
...
{
    // body_wheel.sc:109
    r1 = GetDotStr("!ppconfig");  // @pool 0x29a  // @src body_wheel.sc:109
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // body_wheel.sc:110
    ...
    Free1(r2);
    // body_wheel.sc:111
    r2 = GetDotStr("!vec2");  // @pool 0x2ad  // @src body_wheel.sc:111
    r3 = 0;
    r4 = 0;
    GetDot(r1, 2);
    Free1(r2);
    ...
    Free3(r2, r4, r1);
    // body_wheel.sc:118
    r3 = GetDotStr("Window");  // @pool 0xdf  // @src body_wheel.sc:118
    SetDotRaw(r2, 230);
    Free1(r3);
    r3 = "getLimfaColor";
    r4 = r_neg6;
    ...
    Free2(r3, r2);
    // body_wheel.sc:121
    goto L_1edc;  // @src body_wheel.sc:121
    // body_wheel.sc:125
  L_1ea8:
...
func_14()
{
  ...
  L_1fdc:
    ...
    Free1(r0);
    // body_wheel.sc:220
    goto L_1fdc;  // @src body_wheel.sc:220
}
