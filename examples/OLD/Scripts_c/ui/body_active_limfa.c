...
renderTooltip()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src body_active_limfa.sc:48
    SetDotRaw(r1, 50);
    Free1(r2);
    g2 = r13;
    r3 = 256;
  ...
  L_01f4:
    r1 = GetDotStr("format");  // @pool 0x45  // @src body_active_limfa.sc:50
    r2 = "%s\n%u / %u";
    r4 = GetDotStr("getString");  // @pool 0x60
    r5 = 20009;
    g6 = r4;
    r5 = r5 + r6;
    GetDot(r3, 1);
...
initUI()
{
  ...
  L_0344:
    ...
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_active_limfa.sc:61
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
onMouseButtonLeft()
{
    ...
    r1 = GetDotStr("!regionMask");  // @pool 0xb4  // @src body_active_limfa.sc:82
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    ...
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src body_active_limfa.sc:83
    SetDotRaw(r1, 192);
    Free1(r2);
    r4 = r_neg4;
    SetDotRaw(r3, 187);
    ...
    r3 = GetDotStr("Plane");  // @pool 0x2c  // @src body_active_limfa.sc:86
    SetDotRaw(r2, 225);
    Free1(r3);
    r3 = "fontmain_10.ft";
    GetDot(r1, 1);
...
func_10()
{
    ...
    r2 = GetDotStr("Plane");  // @pool 0x2c  // @src color_progress_simple_base.sci:14
    SetDotRaw(r1, 192);
    Free1(r2);
    r4 = r_neg4;
    SetDotRaw(r3, 25);
    ...
    r1 = GetDotStr("!ppconfig");  // @pool 0x106  // @src color_progress_simple_base.sci:16
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g2;
    ...
    r1 = GetDotStr("createImageComposerBuilder");  // @pool 0x13c  // @src color_progress_simple_base.sci:20
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    ...
    r2 = GetDotStr("createPostProcessComposer");  // @pool 0x183  // @src color_progress_simple_base.sci:22
    r5 = r0;
    SetDotRaw(r4, 413);
    Free1(r5);
    GetDot(r3, 0);
...
func_13()
{
  ...
  L_0a54:
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_active_limfa.sc:102
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "getLimfaColor";
    g3 = r4;
...
enableControl()
{
    ...
    r2 = GetDotStr("Window");  // @pool 0x72  // @src body_active_limfa.sc:114
    SetDotRaw(r1, 121);
    Free1(r2);
    r2 = "onActiveLimfa";
    g3 = r4;
