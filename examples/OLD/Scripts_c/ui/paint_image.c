...
{
    // paint_image.sc:17
    r1 = GetDotStr("fillA");  // @pool 0x0  // @src paint_image.sc:17
    ...
    r1 = (float)r1;
    // paint_image.sc:26
    r3 = GetDotStr("createImageComposerBuilder");  // @pool 0x14  // @src paint_image.sc:26
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    // paint_image.sc:27
    ...
    Free2(r5, r4);
    // paint_image.sc:29
    r5 = GetDotStr("createPostProcessComposer");  // @pool 0x53  // @src paint_image.sc:29
    r8 = r2;
    SetDotRaw(r7, 109);
    Free1(r8);
    GetDot(r6, 0);
    ...
    // paint_image.sc:32
    r3 = GetDotStr("!ppconfig");  // @pool 0x74  // @src paint_image.sc:32
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    r2 = g2;
    ...
    Free2(r3, r2);
    // paint_image.sc:40
    r3 = GetDotStr("createImageComposerBuilder");  // @pool 0x14  // @src paint_image.sc:40
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    // paint_image.sc:41
    ...
    Free3(r4, r5, r3);
    // paint_image.sc:42
    r4 = GetDotStr("createPostProcessComposer");  // @pool 0x53  // @src paint_image.sc:42
    r7 = r2;
    SetDotRaw(r6, 109);
    Free1(r7);
    GetDot(r5, 0);
    ...
    Free1(r5);
    r5 = 0;
    r6 = GetDotStr("self");  // @pool 0xfe
    GetDot(r3, 2);
    Free3(r4, r6, r3);
    // paint_image.sc:39
    Free1(r2);  // @src paint_image.sc:39
    // paint_image.sc:46
    r3 = GetDotStr("!vector");  // @pool 0x103  // @src paint_image.sc:46
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    r2 = g12;
  ...
  L_03bc:
    ...
    r10 = r10 - r11;
    // paint_image.sc:63
    r12 = GetDotStr("!vec3");  // @pool 0x6  // @src paint_image.sc:63
    GetDot(r11, 0);
    Free1(r12);
    r11 = (str)r11;
    // paint_image.sc:64
    ...
    // paint_image.sc:70
  L_061c:
    r10 = GetDotStr("rand");  // @pool 0x127  // @src paint_image.sc:70
    GetDot(r9, 0);
    Free1(r10);
    r10 = 1;
    r9 = r9 < r10;
  ...
  L_0870:
    ...
    r8 = r8 + r9;
    r9 = r0;
    r11 = GetDotStr("randRange");  // @pool 0x147
    r12 = -15;
    r13 = 15;
    GetDot(r10, 2);
    Free1(r11);
    ...
    r9 = r9 + r10;
    r10 = r0;
    r12 = GetDotStr("randRange");  // @pool 0x147
    r13 = -15;
    r14 = 15;
    GetDot(r11, 2);
    Free1(r12);
    ...
    r9 = (float)r9;
    // paint_image.sc:95
    r11 = GetDotStr("randRange");  // @pool 0x147  // @src paint_image.sc:95
    ...
    r12 = 0.5f;
    r13 = 0.25f;
    r15 = GetDotStr("randRange");  // @pool 0x147
    r16 = -1;
    r17 = 1;
    GetDot(r14, 2);
    Free1(r15);
    ...
    // paint_image.sc:103
    r15 = GetDotStr("irandMax");  // @pool 0x151  // @src paint_image.sc:103
    r16 = 30;
    GetDot(r14, 1);
    Free1(r15);
    r15 = 0;
    ...
    if (!r14) goto L_0b60;
    // paint_image.sc:108
    r15 = GetDotStr("randRange");  // @pool 0x147  // @src paint_image.sc:108
    r16 = 50;
    r17 = 75;
    GetDot(r14, 2);
    Free1(r15);
    ...
    r12 = r14;
    // paint_image.sc:109
    r15 = GetDotStr("randRange");  // @pool 0x147  // @src paint_image.sc:109
    r16 = 50;
    r17 = 75;
    GetDot(r14, 2);
    Free1(r15);
    ...
    // paint_image.sc:115
  L_0b60:
    r15 = GetDotStr("randRange");  // @pool 0x147  // @src paint_image.sc:115
    r16 = 15;
    r17 = 25;
    GetDot(r14, 2);
    Free1(r15);
    ...
    r12 = r14;
    // paint_image.sc:116
    r15 = GetDotStr("randRange");  // @pool 0x147  // @src paint_image.sc:116
    r16 = 15;
    r17 = 25;
    GetDot(r14, 2);
    Free1(r15);
    ...
    // paint_image.sc:119
  L_0bd8:
    r15 = GetDotStr("!vector");  // @pool 0x103  // @src paint_image.sc:119
    GetDot(r14, 0);
    Free1(r15);
    r14 = (str)r14;
    // paint_image.sc:120
    r16 = GetDotStr("irandRange");  // @pool 0x15a  // @src paint_image.sc:120
    r17 = 200000;
    r18 = 2000000;
    GetDot(r15, 2);
    Free1(r16);
    ...
    SetDotRaw(r17, 357);
    Free1(r18);
    r19 = GetDotStr("randRange");  // @pool 0x147
...
func_3()
{
    ...
    Free1(r0);
    // paint_image.sc:151
    r1 = GetDotStr("!vector");  // @pool 0x103  // @src paint_image.sc:151
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
...
{
    // paint_image.sc:166
    r1 = GetDotStr("fillA");  // @pool 0x0  // @src paint_image.sc:166
    r3 = GetDotStr("!vec3");  // @pool 0x6
    r4 = 0;
    r5 = 0;
    r6 = 0;
...
draw()
{
    ...
    if (r0) goto L_1584;
    // paint_image.sc:222
    r1 = GetDotStr("createRTImage");  // @pool 0x1fb  // @src paint_image.sc:222
    r3 = r_neg4;
    SetDotRaw(r2, 521);
    Free1(r3);
    r4 = r_neg4;
