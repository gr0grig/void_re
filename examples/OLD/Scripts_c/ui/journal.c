...
//   export "initUI" args=1 cb=-1 {func_22} types=[str]
...
getAllowedTypes()
{
    ...
    Free1(r0);
    // journal.sc:266
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src journal.sc:266
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "fontmain_9.ft";
    GetDot(r0, 1);
    ...
    Free1(r0);
    // journal.sc:267
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src journal.sc:267
    SetDotRaw(r1, 41);
    Free1(r2);
    r2 = "cursor_paint";
    GetDot(r0, 1);
...
func_3()
{
    ...
    r0 = (str)r0;
    // journal.sc:209
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:209
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g12;
    Free1(r1);
    // journal.sc:210
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:210
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g13;
    Free1(r1);
    // journal.sc:211
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:211
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g14;
    Free1(r1);
    // journal.sc:212
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:212
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g11;
    Free1(r1);
    // journal.sc:213
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:213
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g8;
    Free1(r1);
    // journal.sc:214
    r2 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:214
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g16;
    ...
    // journal.sc:218
    r2 = GetDotStr("Width");  // @pool 0x89  // @src journal.sc:218
    r3 = 0.5f;
    r2 = r2 * r3;
    r3 = 496;
    r4 = r1;
  ...
  L_029c:
    ...
    if (!r6) goto L_07d4;
    // journal.sc:226
    r8 = GetDotStr("Plane");  // @pool 0x0  // @src journal.sc:226
    SetDotRaw(r7, 149);
    Free1(r8);
    g8 = r3;
    r9 = 256;
    ...
    r7 = (int)r7;
    // journal.sc:229
    r9 = GetDotStr("getString");  // @pool 0xd2  // @src journal.sc:229
    r10 = r7;
    GetDot(r8, 1);
    Free1(r9);
    r8 = (str)r8;
    ...
    r9 = (int)r9;
    // journal.sc:232
    r11 = GetDotStr("getString");  // @pool 0xd2  // @src journal.sc:232
    r12 = r9;
    GetDot(r10, 1);
    Free1(r11);
    r10 = (str)r10;
    ...
    r12 = r12 + r13;
    // journal.sc:237
    r13 = GetDotStr("Height");  // @pool 0xf0  // @src journal.sc:237
    r14 = 0.5f;
    r13 = r13 * r14;
    r14 = -246;
    Call(r16, 0x07dc);
    ...
    SetDotRaw(r16, 247);
    Free1(r17);
    r18 = GetDotStr("!regionMask");  // @pool 0x10b
    GetDot(r17, 0);
    Free1(r18);
    GetDot(r15, 1);
    Free3(r16, r17, r15);
...
{
    // journal.sc:57
    r0 = GetDotStr("Height");  // @pool 0xf0  // @src journal.sc:57
    r1 = 1200.0f;
    r0 = r0 / r1;
    r0 = (float)r0;
    r_neg4 = r0;
...
func_5()
{
    ...
    Free1(r0);
    // journal.sc:111
    r1 = GetDotStr("createSceneRemover");  // @pool 0x156  // @src journal.sc:111
    g2 = r17;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r1);
    // journal.sc:119
    r1 = GetDotStr("randRange");  // @pool 0x195  // @src journal.sc:119
    ...
    r0 = g21;
    // journal.sc:120
    r1 = GetDotStr("randRange");  // @pool 0x195  // @src journal.sc:120
    r2 = -3.1415927410125732f;
    r3 = 3.1415927410125732f;
    GetDot(r0, 2);
    Free1(r1);
    ...
    r0 = g22;
    // journal.sc:121
    r1 = GetDotStr("randRange");  // @pool 0x195  // @src journal.sc:121
    r2 = -3.1415927410125732f;
    r3 = 3.1415927410125732f;
    GetDot(r0, 2);
    Free1(r1);
...
func_6()
{
  ...
  L_0a60:
    ...
    r2 = g9;
    // journal.sc:389
    r4 = GetDotStr("Plane");  // @pool 0x0  // @src journal.sc:389
    SetDotRaw(r3, 149);
    Free1(r4);
    g4 = r3;
    r5 = GetDotStr("Width");  // @pool 0x89
    r6 = 3;
    r5 = r5 / r6;
    r6 = GetDotStr("Height");  // @pool 0xf0
    r7 = 3;
    r6 = r6 / r7;
    GetDot(r2, 3);
    Free4(r3, r4, r5, r6);
...
func_11()
{
    ...
    if (r2) goto L_14c8;
    r2 = r_neg5;
    r4 = GetDotStr("getKeyCode");  // @pool 0x1db
    r5 = "j";
    GetDot(r3, 1);
    Free2(r4, r5);
    r2 = r2 == r3;
  ...
  L_14ec:
    if (!r0) goto L_150c;
    // journal.sc:438
    r1 = GetDotStr("destroy");  // @pool 0x1e8  // @src journal.sc:438
    GetDot(r0, 0);
    Free2(r1, r0);
    // journal.sc:440
  L_150c:
...
func_13()
{
  ...
  L_1b3c:
    ...
    // journal.sc:338
  L_1b70:
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:338
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g4;
    Free1(r0);
    // journal.sc:339
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:339
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
    Free1(r0);
    // journal.sc:340
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:340
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g6;
    Free1(r0);
    // journal.sc:341
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src journal.sc:341
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
...
{
    // journal.sc:69
    r1 = GetDotStr("!vec2");  // @pool 0x412  // @src journal.sc:69
    r2 = GetDotStr("Width");  // @pool 0x89
    r3 = 0.5f;
    r2 = r2 * r3;
    r3 = r_neg5;
    Call(r5, 0x07dc);
...
{
    // journal.sc:89
    r2 = GetDotStr("Plane");  // @pool 0x0  // @src journal.sc:89
    SetDotRaw(r1, 41);
    Free1(r2);
    r2 = r_neg7;
    GetDot(r0, 1);
    ...
    SetDotRaw(r2, 247);
    Free1(r3);
    r4 = GetDotStr("!regionMask");  // @pool 0x10b
    GetDot(r3, 0);
    Free1(r4);
    GetDot(r1, 1);
    Free3(r2, r3, r1);
...
{
    // journal.sc:62
    r0 = GetDotStr("Width");  // @pool 0x89  // @src journal.sc:62
    r0 = (float)r0;
    r1 = GetDotStr("Height");  // @pool 0xf0
    r1 = (float)r1;
    r0 = r0 / r1;
    r_neg4 = r0;
    return r0;
...
func_19()
{
    ...
    Free2(r1, r0);
    // journal.sc:129
    r1 = GetDotStr("!rotateX");  // @pool 0x429  // @src journal.sc:129
    g2 = r21;
    GetDot(r0, 1);
    Free1(r1);
    r2 = GetDotStr("!rotateY");  // @pool 0x432
    g3 = r22;
    GetDot(r1, 1);
    Free1(r2);
    r0 = r0 * r1;
    r2 = GetDotStr("!rotateZ");  // @pool 0x43b
    g3 = r23;
    GetDot(r1, 1);
    Free1(r2);
    r0 = r0 * r1;
...
{
    // ../gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src ../gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // ../gameplay.sci:405
...
func_23()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src background_base.sci:6
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g0;
    ...
    r1 = GetDotStr("!vector");  // @pool 0x81  // @src background_base.sci:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g1;
