...
func_2()
{
    ...
    r1 = GetDotStr("!qtpair");  // @pool 0x59  // @src fx_ironclad_gun_shot.sc:48
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_ironclad_gun_shot.sc:49
    r1 = GetDotStr("Position");  // @pool 0x61  // @src fx_ironclad_gun_shot.sc:49
    r2 = r0;
    SetInd(r2);
    r0 = 106;
    Free2(r2, r1);
    // fx_ironclad_gun_shot.sc:50
    r3 = GetDotStr("World");  // @pool 0x76  // @src fx_ironclad_gun_shot.sc:50
    SetDotRaw(r2, 124);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x91
...
func_3()
{
    ...
    r2 = GetDotStr("!vec3");  // @pool 0x11e  // @src fx_ironclad_gun_shot.sc:93
    GetDot(r1, 0);
    Free1(r2);
    CallMethod(r1, 292, 0x14a);
    // fx_ironclad_gun_shot.sc:94
    r2 = GetDotStr("!vec3");  // @pool 0x11e  // @src fx_ironclad_gun_shot.sc:94
    GetDot(r1, 0);
    Free1(r2);
...
func_4()
{
    ...
    SetDotRaw(r3, 97);
    Free1(r4);
    r4 = GetDotStr("Position");  // @pool 0x61
    r3 = r3 - r4;
    r3 = (str)r3;
    Call(r4, 0x0870);
    ...
    r7 = "onDamage";
    g8 = r1;
    r10 = GetDotStr("irandMax");  // @pool 0x1b1
    r11 = 7;
    GetDot(r9, 1);
    Free1(r10);
    r10 = 32000;
  ...
  L_04a0:
    r3 = GetDotStr("!qtpair");  // @pool 0x59  // @src fx_ironclad_gun_shot.sc:130
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    // fx_ironclad_gun_shot.sc:131
    r3 = GetDotStr("Position");  // @pool 0x61  // @src fx_ironclad_gun_shot.sc:131
    r4 = r2;
    SetInd(r4);
  ...
  L_066c:
    r5 = GetDotStr("remove");  // @pool 0x1ea  // @src fx_ironclad_gun_shot.sc:146
    GetDot(r4, 0);
    Free2(r5, r4);
...
func_5()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x1fd  // @src ..\..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0x209  // @src ..\..\sound.sci:260
    SetDotRaw(r5, 529);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x21c  // @src ..\..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x91  // @src ..\..\sound.sci:28
    SetDotRaw(r1, 412);
    Free1(r2);
...
{
    // ../../std.sci:128
    r2 = GetDotStr("World");  // @pool 0x76  // @src ../../std.sci:128
    SetDotRaw(r1, 611);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
func_11()
{
    ...
    r1 = GetDotStr("Position");  // @pool 0x61  // @src fx_ironclad_gun_shot.sc:63
    SetDotRaw(r0, 215);
    Free1(r1);
    g2 = r2;
    SetDotRaw(r1, 215);
  ...
  L_096c:
    r3 = GetDotStr("!vec3");  // @pool 0x11e  // @src fx_ironclad_gun_shot.sc:65
    g5 = r2;
    SetDotRaw(r4, 77);
    Free1(r5);
    ...
    SetDotRaw(r6, 637);
    Free1(r7);
    r8 = GetDotStr("Position");  // @pool 0x61
    SetDotRaw(r7, 637);
    Free1(r8);
    r6 = r6 - r7;
    GetDot(r2, 3);
    ...
    r3 = GetDotStr("!vec3");  // @pool 0x11e  // @src fx_ironclad_gun_shot.sc:66
    g5 = r2;
    SetDotRaw(r4, 77);
    Free1(r5);
    r6 = GetDotStr("Position");  // @pool 0x61
    ...
    r4 = GetDotStr("applyForce");  // @pool 0x27f  // @src fx_ironclad_gun_shot.sc:68
    r5 = GetDotStr("Mass");  // @pool 0x28a
    r6 = r2;
    r5 = r5 * r6;
    r6 = r1;
    r5 = r5 * r6;
    ...
    r0 = "";  // len=1610, pool_off=0x541, GARBLED
    r5 = (int)r5;
    Call(r6, 0x0b74);
    r3 = r3 + r4;
    r3 = g3;
    ...
    r3 = GetDotStr("Position");  // @pool 0x61  // @src fx_ironclad_gun_shot.sc:79
    g4 = r0;
    SetInd(r4);
    r0 = "";  // len=97, pool_off=0x44b, GARBLED
    r0 = "";  // len=68, pool_off=0xad4, GARBLED  // @patch+4 fx_ironclad_gun_shot.sc:71
}
