...
func_1()
{
    ...
    r1 = GetDotStr("loadSound3D");  // @pool 0x28  // @src fx_stiltman_energy_ball.sc:53
...
func_2()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:276
    r2 = GetDotStr("playSound3DLooped");  // @pool 0xa4  // @src ..\..\sound.sci:276
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:277
    r6 = GetDotStr("Globals");  // @pool 0xb6  // @src ..\..\sound.sci:277
    SetDotRaw(r5, 190);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0xc9  // @src ..\..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0xe6  // @src ..\..\sound.sci:28
    SetDotRaw(r1, 236);
    Free1(r2);
...
isTrapAttracted()
{
    ...
    r1 = GetDotStr("!qtpair");  // @pool 0x11b  // @src fx_stiltman_energy_ball.sc:76
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_stiltman_energy_ball.sc:77
    r1 = GetDotStr("Position");  // @pool 0x123  // @src fx_stiltman_energy_ball.sc:77
    r2 = r0;
    SetInd(r2);
    r0 = 300;
    Free2(r2, r1);
    // fx_stiltman_energy_ball.sc:78
    r3 = GetDotStr("World");  // @pool 0x138  // @src fx_stiltman_energy_ball.sc:78
    SetDotRaw(r2, 318);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0xe6
    ...
    r2 = GetDotStr("applyForce");  // @pool 0x1d5  // @src fx_stiltman_energy_ball.sc:81
    r3 = r_neg4;
    r4 = GetDotStr("Mass");  // @pool 0x1e0
    r3 = r3 * r4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
...
func_6()
{
  ...
  L_04c8:
    ...
    r5 = r1;
    r4 = r4 + r5;
    r5 = GetDotStr("Position");  // @pool 0x123
    r4 = r4 - r5;
    r4 = (str)r4;
    ...
    r7 = GetDotStr("Mass");  // @pool 0x1e0
    r6 = r6 * r7;
    g7 = r4;
    r6 = r6 * r7;
    r6 = (float)r6;
    // fx_stiltman_energy_ball.sc:116
    r8 = GetDotStr("applyForce");  // @pool 0x1d5  // @src fx_stiltman_energy_ball.sc:116
    r9 = r3;
    r10 = r6;
    r11 = r4;
    r10 = r10 * r11;
    ...
    r10 = r10 / r11;
    r11 = 0.5f;
    r12 = GetDotStr("LinearVelocity");  // @pool 0x21a
    r11 = r11 * r12;
    r10 = r10 - r11;
    r9 = r9 * r10;
    GetDot(r7, 1);
  ...
  L_0618:
    r7 = GetDotStr("setRotation");  // @pool 0x229  // @src fx_stiltman_energy_ball.sc:119
    r10 = GetDotStr("!lookAt");  // @pool 0x235
    r11 = GetDotStr("Position");  // @pool 0x123
    r12 = GetDotStr("Position");  // @pool 0x123
    r13 = GetDotStr("LinearVelocity");  // @pool 0x21a
    r12 = r12 + r13;
    GetDot(r9, 2);
    Free3(r10, r11, r12);
    SetDotRaw(r8, 556);
    ...
    r6 = GetDotStr("Position");  // @pool 0x123  // @src fx_stiltman_energy_ball.sc:120
    g7 = r0;
    SetInd(r7);
    LoadIntZero(r0);
    r1 = Log(r1);
    ...
    r8 = GetDotStr("Scene");  // @pool 0xe6  // @src fx_stiltman_energy_ball.sc:123
    SetDotRaw(r7, 573);
    Free1(r8);
    r9 = GetDotStr("!sphere");  // @pool 0x24d
    r10 = GetDotStr("Position");  // @pool 0x123
    r11 = 1;
    GetDot(r8, 2);
    Free2(r9, r10);
    r9 = true;
    ...
    r9 = GetDotStr("Scene");  // @pool 0xe6  // @src fx_stiltman_energy_ball.sc:130
    r9 = (str)r9;
    r11 = GetDotStr("loadSound");  // @pool 0x26b
    r12 = "drill_collision";
    GetDot(r10, 1);
    Free2(r11, r12);
    r10 = (str)r10;
...
func_7()
{
  ...
  L_0a78:
    ...
    r3 = GetDotStr("World");  // @pool 0x138  // @src fx_stiltman_energy_ball.sc:169
    SetDotRaw(r2, 318);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0xe6
    r4 = "hunter/ps_hunter_03_stiltmanEnergyBallexplode.ps";
    r5 = GetDotStr("Position");  // @pool 0x123
    r7 = GetDotStr("!vec3");  // @pool 0x88
    r8 = 0;
    r9 = 0.5f;
    r10 = 0;
    GetDot(r6, 3);
  ...
  L_0b98:
    r3 = GetDotStr("remove");  // @pool 0x3ba  // @src fx_stiltman_energy_ball.sc:174
    GetDot(r2, 0);
    Free2(r3, r2);
...
func_8()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x3c1  // @src ..\..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0xb6  // @src ..\..\sound.sci:260
    SetDotRaw(r5, 190);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
func_11()
{
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:162
    r6 = GetDotStr("Globals");  // @pool 0xb6  // @src ..\..\sound.sci:162
    SetDotRaw(r5, 190);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ../../std.sci:128
    r2 = GetDotStr("World");  // @pool 0x138  // @src ../../std.sci:128
    SetDotRaw(r1, 490);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
isTrapAttracted()
{
    ...
    r1 = r_neg4;
    r1 = Inv(r1);
    r2 = GetDotStr("LinearVelocity");  // @pool 0x21a
    r2 = Inv(r2);
    r1 = r1 + r2;
    r0 = r0 * r1;
    r0 = Inv(r0);
    ...
    r2 = GetDotStr("applyForce");  // @pool 0x1d5  // @src fx_stiltman_energy_ball.sc:37
    r3 = r0;
    r5 = GetDotStr("LinearVelocity");  // @pool 0x21a
    r5 = (str)r5;
    Call(r6, 0x0cd0);
    r3 = r3 * r4;
    g4 = r1;
