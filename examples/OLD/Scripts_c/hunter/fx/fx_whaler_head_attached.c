...
func_1()
{
    ...
    r1 = GetDotStr("setKinematic");  // @pool 0x0  // @src fx_whaler_head_attached.sc:8
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // fx_whaler_head_attached.sc:9
    r0 = false;  // @src fx_whaler_head_attached.sc:9
    CallMethod(r0, 13, 0x13f);  // @patch+8 fx_whaler_head_attached.sc:10
    Free3(r5, r0, r0);
}
...
destroy()
{
    ...
    r1 = GetDotStr("setTransform");  // @pool 0x1c  // @src fx_whaler_head_attached.sc:35
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
func_4()
{
    ...
    r2 = GetDotStr("World");  // @pool 0x29  // @src fx_whaler_head_attached.sc:53
    SetDotRaw(r1, 47);
    Free1(r2);
    r2 = GetDotStr("Scene");  // @pool 0x40
    ...
    r4 = "_gibs_1.pre";
    r3 = r3 + r4;
    r5 = GetDotStr("!qtpair");  // @pool 0x86
    r6 = GetDotStr("Rotation");  // @pool 0x8e
    r7 = GetDotStr("Position");  // @pool 0x97
    GetDot(r4, 2);
    Free3(r5, r6, r7);
    ...
    r3 = GetDotStr("World");  // @pool 0x29  // @src fx_whaler_head_attached.sc:56
    SetDotRaw(r2, 47);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x40
    ...
    r5 = "_gibs_2.pre";
    r4 = r4 + r5;
    r6 = GetDotStr("!qtpair");  // @pool 0x86
    r7 = GetDotStr("Rotation");  // @pool 0x8e
    r8 = GetDotStr("Position");  // @pool 0x97
    GetDot(r5, 2);
    Free3(r6, r7, r8);
    ...
    r3 = GetDotStr("World");  // @pool 0x29  // @src fx_whaler_head_attached.sc:59
    SetDotRaw(r2, 47);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x40
    r4 = "hunter_05_whaler_head_";
    ...
    r3 = GetDotStr("World");  // @pool 0x29  // @src fx_whaler_head_attached.sc:63
    SetDotRaw(r2, 47);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x40
    r4 = "hunter_05_whaler_head_";
  ...
  L_0438:
    r3 = GetDotStr("Scene");  // @pool 0x40  // @src fx_whaler_head_attached.sc:68
    SetDotRaw(r2, 327);
    Free1(r3);
    r3 = GetDotStr("Position");  // @pool 0x97
    r5 = GetDotStr("!vec3");  // @pool 0x157
    r7 = GetDotStr("rand");  // @pool 0x15d
    GetDot(r6, 0);
    Free1(r7);
    r7 = 0.5f;
    r6 = r6 - r7;
    r8 = GetDotStr("rand");  // @pool 0x15d
    GetDot(r7, 0);
    Free1(r8);
    r8 = 0.5f;
    r7 = r7 - r8;
    r9 = GetDotStr("rand");  // @pool 0x15d
    GetDot(r8, 0);
    Free1(r9);
    r9 = 0.5f;
    r8 = r8 - r9;
    ...
    r3 = r3 + r4;
    r4 = 3;
    r6 = GetDotStr("!invQuadratic");  // @pool 0x162
    r7 = 15;
    r8 = 0;
    r9 = 0;
    r10 = 1;
    ...
    r2 = GetDotStr("remove");  // @pool 0x170  // @src fx_whaler_head_attached.sc:70
    GetDot(r1, 0);
    Free2(r2, r1);
