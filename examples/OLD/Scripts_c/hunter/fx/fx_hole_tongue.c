...
func_1()
{
    ...
    CallMethod(r0, 32, 0x13f);  // @patch+8 fx_hole_tongue.sc:45
    ...
    r1 = GetDotStr("!qtpair");  // @pool 0x28  // @src fx_hole_tongue.sc:63
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_hole_tongue.sc:64
    r1 = GetDotStr("Position");  // @pool 0x30  // @src fx_hole_tongue.sc:64
    r2 = r0;
    SetInd(r2);
    r0 = 57;
    Free2(r2, r1);
    // fx_hole_tongue.sc:66
    r2 = GetDotStr("applyForce");  // @pool 0x45  // @src fx_hole_tongue.sc:66
    r3 = r_neg4;
    r4 = GetDotStr("Mass");  // @pool 0x50
    r3 = r3 * r4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
...
isTrapAttracted()
{
  ...
  L_0198:
    ...
    r5 = GetDotStr("Mass");  // @pool 0x50
    r4 = r4 * r5;
    g5 = r4;
    r4 = r4 * r5;
    r4 = (float)r4;
    // fx_hole_tongue.sc:163
    r6 = GetDotStr("applyForce");  // @pool 0x45  // @src fx_hole_tongue.sc:163
    r7 = r3;
    r8 = r4;
    r9 = r1;
    r8 = r8 * r9;
    r9 = 0.4000000059604645f;
    r10 = GetDotStr("LinearVelocity");  // @pool 0x5a
    r9 = r9 * r10;
    r8 = r8 - r9;
    r7 = r7 * r8;
    GetDot(r5, 1);
...
{
    // ../../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x69  // @src ../../std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // ../../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x69  // @src ../../std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // ../../std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x73  // @src ../../std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
...
func_6()
{
    ...
    r1 = GetDotStr("remove");  // @pool 0x79  // @src fx_hole_tongue.sc:185
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_7()
{
  ...
  L_044c:
    ...
    r7 = GetDotStr("Mass");  // @pool 0x50
    r6 = r6 * r7;
    g7 = r4;
    r6 = r6 * r7;
    r6 = (float)r6;
    // fx_hole_tongue.sc:103
    r8 = GetDotStr("applyForce");  // @pool 0x45  // @src fx_hole_tongue.sc:103
    r9 = r3;
    r10 = r6;
    r11 = r4;
    r10 = r10 * r11;
    ...
    r12 = GetDotStr("LinearVelocity");  // @pool 0x5a
    r11 = r11 * r12;
    r10 = r10 - r11;
    r9 = r9 * r10;
    GetDot(r7, 1);
  ...
  L_059c:
    r7 = GetDotStr("setRotation");  // @pool 0xb0  // @src fx_hole_tongue.sc:106
    r10 = GetDotStr("!lookAt");  // @pool 0xbc
    r11 = GetDotStr("Position");  // @pool 0x30
    r12 = GetDotStr("Position");  // @pool 0x30
    r13 = GetDotStr("LinearVelocity");  // @pool 0x5a
    r12 = r12 + r13;
    GetDot(r9, 2);
    Free3(r10, r11, r12);
    SetDotRaw(r8, 179);
    ...
    r8 = GetDotStr("Scene");  // @pool 0xc4  // @src fx_hole_tongue.sc:109
    SetDotRaw(r7, 202);
    Free1(r8);
    r9 = GetDotStr("!sphere");  // @pool 0xda
...
func_9()
{
    ...
    r1 = GetDotStr("Scene");  // @pool 0xc4  // @src fx_hole_tongue.sc:122
    r1 = (str)r1;
    r3 = GetDotStr("loadSound");  // @pool 0xfd
    r4 = "drill_collision";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
  ...
  L_07ac:
    ...
    SetDotRaw(r2, 48);
    Free1(r3);
    r3 = GetDotStr("Position");  // @pool 0x30
    r2 = r2 - r3;
    r2 = (str)r2;
    Call(r3, 0x06b8);
...
{
    // ..\..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0xc4  // @src ..\..\sound.sci:28
    SetDotRaw(r1, 232);
    Free1(r2);
...
func_11()
{
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:162
    r6 = GetDotStr("Globals");  // @pool 0x1bc  // @src ..\..\sound.sci:162
    SetDotRaw(r5, 452);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x1cf  // @src ..\..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ../../std.sci:128
    r2 = GetDotStr("World");  // @pool 0x1ec  // @src ../../std.sci:128
    SetDotRaw(r1, 128);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
applyForce()
{
    ...
    r1 = r_neg4;
    r1 = Inv(r1);
    r2 = GetDotStr("LinearVelocity");  // @pool 0x5a
    r2 = Inv(r2);
    r1 = r1 + r2;
    r0 = r0 * r1;
    r0 = Inv(r0);
    ...
    r2 = GetDotStr("applyForce");  // @pool 0x45  // @src fx_hole_tongue.sc:34
    r3 = r0;
    r5 = GetDotStr("LinearVelocity");  // @pool 0x5a
    r5 = (str)r5;
    Call(r6, 0x06b8);
    r3 = r3 * r4;
    g4 = r0;
