...
func_1()
{
    ...
    r1 = GetDotStr("setKinematic");  // @pool 0x0  // @src fx_kolesnik_disc.sc:12
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // fx_kolesnik_disc.sc:13
    r1 = GetDotStr("setCollisionGroup");  // @pool 0xd  // @src fx_kolesnik_disc.sc:13
    r2 = 1;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    r1 = GetDotStr("Position");  // @pool 0x2b  // @src fx_kolesnik_disc.sc:18
    r1 = (str)r1;
  ...
  L_0138:
    ...
    r9 = GetDotStr("setPosition");  // @pool 0x3a  // @src fx_kolesnik_disc.sc:30
    g10 = r1;
    GetDot(r8, 1);
    Free3(r9, r10, r8);
  ...
  L_01c0:
    r9 = GetDotStr("setTransform");  // @pool 0x46  // @src fx_kolesnik_disc.sc:33
    r11 = GetDotStr("!qtpair");  // @pool 0x53
    r13 = GetDotStr("!rotateY");  // @pool 0x5b
    r14 = r5;
    r14 = Neg(r14);
    r15 = r3;
    r14 = r14 * r15;
  ...
  L_02bc:
    r8 = GetDotStr("remove");  // @pool 0x64  // @src fx_kolesnik_disc.sc:37
    GetDot(r7, 0);
    Free2(r8, r7);
    // fx_kolesnik_disc.sc:39
    g8 = r0;  // @src fx_kolesnik_disc.sc:39
    r9 = GetDotStr("Position");  // @pool 0x2b
    r8 = r8 - r9;
    r8 = (str)r8;
    Call(r9, 0x0434);
    r8 = 3.0f;
  ...
  L_03c8:
    ...
    r9 = "onDamage";
    g10 = r4;
    r12 = GetDotStr("irandMax");  // @pool 0xe0
    r13 = 7;
    GetDot(r11, 1);
    Free1(r12);
    g12 = r3;
