...
func_1()
{
    ...
    CallMethod(r0, 32, 0x13f);  // @patch+8 fx_large_lympha.sc:17
    r9 = null_str2;
    ...
    r1 = GetDotStr("!qtpair");  // @pool 0x28  // @src fx_large_lympha.sc:44
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // fx_large_lympha.sc:45
    r1 = GetDotStr("Position");  // @pool 0x30  // @src fx_large_lympha.sc:45
    r2 = r0;
    SetInd(r2);
    r0 = 57;
    Free2(r2, r1);
    // fx_large_lympha.sc:46
    r3 = GetDotStr("World");  // @pool 0x45  // @src fx_large_lympha.sc:46
    SetDotRaw(r2, 75);
    Free1(r3);
    ...
    r6 = GetDotStr("World");  // @pool 0x45  // @src fx_large_lympha.sc:47
    SetDotRaw(r5, 186);
    Free1(r6);
    SetDotRaw(r4, 197);
    Free1(r5);
...
func_3()
{
    ...
    r4 = GetDotStr("World");  // @pool 0x45  // @src fx_large_lympha.sc:101
    SetDotRaw(r3, 325);
    Free1(r4);
    r4 = GetDotStr("Scene");  // @pool 0x60
    r5 = "fx_player_damage_limfa.pre";
    r6 = GetDotStr("Position");  // @pool 0x30
    r7 = r1;
    r6 = r6 + r7;
    r8 = GetDotStr("!vec3");  // @pool 0x18a
    r9 = 0;
...
onStartUsing()
{
    ...
    r1 = GetDotStr("!vec3");  // @pool 0x18a  // @src fx_large_lympha.sc:134
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    ...
    r2 = GetDotStr("randRange");  // @pool 0x1d4  // @src fx_large_lympha.sc:136
    r3 = r_neg4;
    r3 = Neg(r3);
    r4 = 2.0f;
    r3 = r3 / r4;
...
canSuckLimfa()
{
  ...
  L_05e8:
    ...
    r4 = GetDotStr("World");  // @pool 0x45  // @src fx_large_lympha.sc:76
    SetDotRaw(r3, 292);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
...
func_10()
{
    ...
    r1 = GetDotStr("setKinematic");  // @pool 0x206  // @src fx_large_lympha.sc:149
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    r1 = GetDotStr("remove");  // @pool 0x213  // @src fx_large_lympha.sc:153
    GetDot(r0, 0);
    Free2(r1, r0);
...
isUsable()
{
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x21a  // @src fx_large_lympha.sc:168
    r2 = true;
    g4 = r3;
    r5 = 1000;
    Call(r6, 0x0988);
