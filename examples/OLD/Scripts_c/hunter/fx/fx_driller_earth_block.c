...
func_1()
{
    ...
    r1 = GetDotStr("setKinematic");  // @pool 0x0  // @src fx_driller_earth_block.sc:9
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    CallMethod(r0, 42, 0x13f);  // @patch+8 fx_driller_earth_block.sc:14
    r6 = Sin(r6);
...
func_2()
{
    ...
    r2 = GetDotStr("randRange");  // @pool 0x44  // @src fx_driller_earth_block.sc:35
    r3 = 0.5f;
    r4 = 2;
    GetDot(r1, 2);
    Free1(r2);
    ...
    r3 = GetDotStr("randRange");  // @pool 0x44  // @src fx_driller_earth_block.sc:36
  ...
  L_0164:
    ...
    r5 = r3;
    r4 = r4 - r5;
    CallMethod(r4, 13, 0x44);  // @patch+8 fx_driller_earth_block.sc:42
    r2 = (int)r2;
  ...
  L_01c0:
    ...
    r5 = 9;
    r4 = r4 - r5;
    CallMethod(r4, 13, 0x44);  // @patch+8 fx_driller_earth_block.sc:44
    r2 = (int)r2;
  ...
  L_0200:
    ...
    r6 = GetDotStr("!vec3");  // @pool 0x4e  // @src fx_driller_earth_block.sc:52
    GetDot(r5, 0);
    Free1(r6);
    r5 = (str)r5;
    ...
    r8 = GetDotStr("!rotate");  // @pool 0x58  // @src fx_driller_earth_block.sc:58
    r9 = r0;
    r10 = r3;
    r11 = r1;
    r10 = r10 * r11;
    ...
    r10 = GetDotStr("setPosition");  // @pool 0x60  // @src fx_driller_earth_block.sc:63
    r11 = r8;
    r12 = r5;
    r11 = r11 + r12;
    GetDot(r9, 1);
  ...
  L_0420:
    r9 = GetDotStr("setPosition");  // @pool 0x60  // @src fx_driller_earth_block.sc:66
    g10 = r2;
    r11 = r5;
    r10 = r10 + r11;
    GetDot(r8, 1);
  ...
  L_044c:
    r9 = GetDotStr("setRotation");  // @pool 0x6c  // @src fx_driller_earth_block.sc:69
    r10 = r7;
    GetDot(r8, 1);
    Free3(r9, r10, r8);
    // fx_driller_earth_block.sc:41
...
{
    // ../../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x44  // @src ../../std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // ../../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x44  // @src ../../std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // ../../std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x4e  // @src ../../std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
