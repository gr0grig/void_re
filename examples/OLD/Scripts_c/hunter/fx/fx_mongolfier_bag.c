...
func_1()
{
    ...
    SetDotRaw(r1, 52);
    Free1(r2);
    r3 = GetDotStr("loadSound3D");  // @pool 0x38
    ...
    r1 = GetDotStr("!vector");  // @pool 0x2c  // @src fx_mongolfier_bag.sc:49
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g3;
...
detach()
{
    ...
    r1 = GetDotStr("setTransform");  // @pool 0xf2  // @src fx_mongolfier_bag.sc:89
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
isTrapAttracted()
{
    ...
    r4 = GetDotStr("Position");  // @pool 0xff  // @src fx_mongolfier_bag.sc:100
    SetDotRaw(r3, 264);
    Free1(r4);
    r6 = r0;
    SetDotRaw(r5, 255);
  ...
  L_0304:
    r6 = GetDotStr("!vec3");  // @pool 0x10a  // @src fx_mongolfier_bag.sc:104
    r9 = r0;
    SetDotRaw(r8, 255);
    Free1(r9);
    SetDotRaw(r7, 100);
    ...
    SetDotRaw(r9, 272);
    Free1(r10);
    r11 = GetDotStr("Position");  // @pool 0xff
    SetDotRaw(r10, 272);
    Free1(r11);
    r9 = r9 - r10;
    GetDot(r5, 3);
    ...
    r5 = GetDotStr("!vec3");  // @pool 0x10a  // @src fx_mongolfier_bag.sc:105
    r8 = r0;
    SetDotRaw(r7, 255);
    Free1(r8);
    SetDotRaw(r6, 100);
    Free1(r7);
    r8 = GetDotStr("Position");  // @pool 0xff
    SetDotRaw(r7, 100);
    Free1(r8);
    r6 = r6 - r7;
    r7 = 0;
    ...
    r5 = GetDotStr("applyForce");  // @pool 0x112  // @src fx_mongolfier_bag.sc:106
    r6 = GetDotStr("Mass");  // @pool 0x11d
    r7 = r1;
    r6 = r6 * r7;
    r7 = r2;
    r6 = r6 * r7;
    ...
    CallMethod(r4, 12, 0x44);  // @patch+8 fx_mongolfier_bag.sc:102
  ...
  L_04e4:
    ...
    SetDotRaw(r5, 255);
    Free1(r6);
    r6 = GetDotStr("Position");  // @pool 0xff
    r5 = r5 - r6;
    r5 = (str)r5;
    Call(r6, 0x06d4);
    r2 = r4;
    ...
    r5 = GetDotStr("applyForce");  // @pool 0x112  // @src fx_mongolfier_bag.sc:112
    r6 = GetDotStr("Mass");  // @pool 0x11d
    r7 = r1;
    r6 = r6 * r7;
    r7 = r2;
    ...
    r5 = GetDotStr("!vec3");  // @pool 0x10a  // @src fx_mongolfier_bag.sc:115
    r6 = 3.1415927410125732f;
    r8 = GetDotStr("rand");  // @pool 0x122
    GetDot(r7, 0);
    Free1(r8);
    r6 = r6 * r7;
    r7 = 3.1415927410125732f;
    r9 = GetDotStr("rand");  // @pool 0x122
    GetDot(r8, 0);
    Free1(r9);
    r7 = r7 * r8;
    r8 = 3.1415927410125732f;
    r10 = GetDotStr("rand");  // @pool 0x122
    GetDot(r9, 0);
    Free1(r10);
    r8 = r8 * r9;
    GetDot(r4, 3);
    ...
    r6 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:116
    SetDotRaw(r5, 317);
    Free1(r6);
    r6 = GetDotStr("Scene");  // @pool 0x152
    r7 = "ps_fuse.ps";
    r8 = GetDotStr("Position");  // @pool 0xff
...
{
    // ../../std.sci:128
    r2 = GetDotStr("World");  // @pool 0x137  // @src ../../std.sci:128
    SetDotRaw(r1, 412);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
func_7()
{
  ...
  L_076c:
    ...
    r2 = GetDotStr("!vec3");  // @pool 0x10a  // @src fx_mongolfier_bag.sc:146
    GetDot(r1, 0);
    Free1(r2);
    CallMethod(r1, 444, 0x14a);
    // fx_mongolfier_bag.sc:147
    r2 = GetDotStr("!vec3");  // @pool 0x10a  // @src fx_mongolfier_bag.sc:147
    GetDot(r1, 0);
    Free1(r2);
...
{
    // ..\..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x152  // @src ..\..\sound.sci:28
    SetDotRaw(r1, 492);
    Free1(r2);
...
func_9()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x227  // @src ..\..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0x233  // @src ..\..\sound.sci:260
    SetDotRaw(r5, 571);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x242  // @src ..\..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
func_11()
{
    ...
    r7 = GetDotStr("irandMax");  // @pool 0x1d3
    r8 = 2;
    GetDot(r6, 1);
    Free1(r7);
    SetDot(r4, 1);
    ...
    r3 = GetDotStr("Position");  // @pool 0xff  // @src fx_mongolfier_bag.sc:169
    r3 = (str)r3;
    r4 = 5.0f;
    g5 = r0;
    r7 = GetDotStr("irandMax");  // @pool 0x1d3
    ...
    r4 = GetDotStr("randRange");  // @pool 0x25f  // @src fx_mongolfier_bag.sc:173
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:174
    SetDotRaw(r4, 617);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x152
    r6 = "sack_part1.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x25f  // @src fx_mongolfier_bag.sc:178
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:179
    SetDotRaw(r4, 617);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x152
    r6 = "sack_part2.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x25f  // @src fx_mongolfier_bag.sc:183
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:184
    SetDotRaw(r4, 617);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x152
    r6 = "sack_part3a.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x25f  // @src fx_mongolfier_bag.sc:188
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:189
    SetDotRaw(r4, 617);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x152
    r6 = "sack_part3b.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x25f  // @src fx_mongolfier_bag.sc:193
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:194
    SetDotRaw(r4, 617);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x152
    r6 = "sack_part3c.pre";
    ...
    r4 = GetDotStr("!qtpair");  // @pool 0x36c  // @src fx_mongolfier_bag.sc:198
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    // fx_mongolfier_bag.sc:199
    r4 = GetDotStr("Position");  // @pool 0xff  // @src fx_mongolfier_bag.sc:199
    r6 = GetDotStr("!vec3");  // @pool 0x10a
    r7 = 0;
    r8 = 0.25f;
    r9 = 0;
    ...
    r6 = GetDotStr("World");  // @pool 0x137  // @src fx_mongolfier_bag.sc:200
    SetDotRaw(r5, 317);
    Free1(r6);
    r6 = GetDotStr("Scene");  // @pool 0x152
    ...
    r7 = GetDotStr("Scene");  // @pool 0x152  // @src fx_mongolfier_bag.sc:207
    SetDotRaw(r6, 1065);
    Free1(r7);
    r7 = GetDotStr("Position");  // @pool 0xff
    r8 = 7;
    r10 = GetDotStr("!invQuadratic");  // @pool 0x439
    r11 = 30;
    r12 = 0;
    r13 = 0;
    r14 = 1;
    ...
    r9 = GetDotStr("irandMax");  // @pool 0x1d3
    r10 = 2;
    GetDot(r8, 1);
    Free1(r9);
    SetDot(r6, 1);
  ...
  L_12f4:
    r7 = GetDotStr("remove");  // @pool 0x447  // @src fx_mongolfier_bag.sc:213
    GetDot(r6, 0);
    Free2(r7, r6);
...
{
    // ../../std.sci:1093
    Call(r1, 0x0684);  // @src ../../std.sci:1093
    // ../../std.sci:1094
...
{
    // ../../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x25f  // @src ../../std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // ../../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x25f  // @src ../../std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // ../../std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x10a  // @src ../../std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
...
func_14()
{
    ...
    r1 = GetDotStr("Position");  // @pool 0xff  // @src fx_mongolfier_bag.sc:134
    g2 = r1;
    SetInd(r2);
    r0 = 255;
    Free2(r2, r1);
    ...
    CallMethod(r1, 27, 0x44);  // @patch+8 fx_mongolfier_bag.sc:132
...
applyForce()
{
    ...
    r1 = GetDotStr("applyForce");  // @pool 0x112  // @src fx_mongolfier_bag.sc:26
    r2 = r_neg4;
    r3 = GetDotStr("Mass");  // @pool 0x11d
    r2 = r2 * r3;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
setTransform()
{
    ...
    r1 = GetDotStr("setTransform");  // @pool 0xf2  // @src fx_mongolfier_bag.sc:33
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
