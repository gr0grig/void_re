...
func_1()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x20  // @src fx_mongolfier_mine.sc:48
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g4;
    ...
    SetDotRaw(r1, 40);
    Free1(r2);
    r3 = GetDotStr("loadSound3D");  // @pool 0x2c
    ...
    r1 = GetDotStr("!vector");  // @pool 0x20  // @src fx_mongolfier_mine.sc:52
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
    ...
    r1 = GetDotStr("!vector");  // @pool 0x20  // @src fx_mongolfier_mine.sc:58
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g6;
...
initMine()
{
    ...
    r1 = GetDotStr("setTransform");  // @pool 0x1a8  // @src fx_mongolfier_mine.sc:82
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
isTrapAttracted()
{
  ...
  L_03d8:
    ...
    r1 = GetDotStr("applyForce");  // @pool 0x1b5  // @src fx_mongolfier_mine.sc:93
    r2 = r_neg5;
    r2 = Inv(r2);
    r3 = 12.0f;
    r2 = r2 * r3;
    r3 = GetDotStr("Mass");  // @pool 0x1c0
    r2 = r2 * r3;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // fx_mongolfier_mine.sc:94
    r1 = GetDotStr("!vec3");  // @pool 0x1c5  // @src fx_mongolfier_mine.sc:94
    r2 = 3.1415927410125732f;
    r4 = GetDotStr("rand");  // @pool 0x1cb
    GetDot(r3, 0);
    Free1(r4);
    r2 = r2 * r3;
    r3 = 3.1415927410125732f;
    r5 = GetDotStr("rand");  // @pool 0x1cb
    GetDot(r4, 0);
    Free1(r5);
    r3 = r3 * r4;
    r4 = 3.1415927410125732f;
    r6 = GetDotStr("rand");  // @pool 0x1cb
    GetDot(r5, 0);
    Free1(r6);
    r4 = r4 * r5;
    GetDot(r0, 3);
    ...
    r2 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:96
    SetDotRaw(r1, 486);
    Free1(r2);
    r2 = GetDotStr("Scene");  // @pool 0x1fb
    r3 = "ps_fuse.ps";
    r4 = GetDotStr("Position");  // @pool 0x215
...
func_5()
{
    ...
    r3 = GetDotStr("Position");  // @pool 0x215  // @src fx_mongolfier_mine.sc:172
    r3 = (str)r3;
    r4 = 5.0f;
    g5 = r0;
    r7 = GetDotStr("irandMax");  // @pool 0x25c
    r8 = 7;
    GetDot(r6, 1);
    Free1(r7);
    r6 = (int)r6;
    ...
    r4 = GetDotStr("randRange");  // @pool 0x265  // @src fx_mongolfier_mine.sc:176
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:177
    SetDotRaw(r4, 623);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x1fb
    r6 = "sack_part1.pre";
    r7 = GetDotStr("Position");  // @pool 0x215
    r8 = r2;
    r9 = r0;
    r8 = r8 * r9;
    r7 = r7 + r8;
    ...
    r4 = GetDotStr("randRange");  // @pool 0x265  // @src fx_mongolfier_mine.sc:181
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:182
    SetDotRaw(r4, 623);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x1fb
    r6 = "sack_part2.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x265  // @src fx_mongolfier_mine.sc:186
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:187
    SetDotRaw(r4, 623);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x1fb
    r6 = "sack_part3a.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x265  // @src fx_mongolfier_mine.sc:191
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:192
    SetDotRaw(r4, 623);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x1fb
    r6 = "sack_part3b.pre";
    ...
    r4 = GetDotStr("randRange");  // @pool 0x265  // @src fx_mongolfier_mine.sc:196
    r5 = 0.5f;
    r6 = 1;
    GetDot(r3, 2);
    Free1(r4);
    ...
    r5 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:197
    SetDotRaw(r4, 623);
    Free1(r5);
    r5 = GetDotStr("Scene");  // @pool 0x1fb
    r6 = "sack_part3c.pre";
    ...
    r4 = GetDotStr("!qtpair");  // @pool 0x377  // @src fx_mongolfier_mine.sc:201
    GetDot(r3, 0);
    Free1(r4);
    r3 = (str)r3;
    // fx_mongolfier_mine.sc:202
    r4 = GetDotStr("Position");  // @pool 0x215  // @src fx_mongolfier_mine.sc:202
    r6 = GetDotStr("!vec3");  // @pool 0x1c5
    r7 = 0;
    r8 = 0.25f;
    r9 = 0;
    GetDot(r5, 3);
    ...
    r6 = GetDotStr("World");  // @pool 0x1e0  // @src fx_mongolfier_mine.sc:203
    SetDotRaw(r5, 486);
    Free1(r6);
    r6 = GetDotStr("Scene");  // @pool 0x1fb
    ...
    r7 = GetDotStr("Scene");  // @pool 0x1fb  // @src fx_mongolfier_mine.sc:210
    SetDotRaw(r6, 1076);
    Free1(r7);
    r7 = GetDotStr("Position");  // @pool 0x215
    r8 = 7;
    r10 = GetDotStr("!invQuadratic");  // @pool 0x444
    r11 = 30;
    r12 = 0;
    r13 = 0;
    r14 = 1;
    ...
    r9 = GetDotStr("irandMax");  // @pool 0x25c
    r10 = 2;
    GetDot(r8, 1);
    Free1(r9);
    SetDot(r6, 1);
  ...
  L_0e58:
    r7 = GetDotStr("remove");  // @pool 0x45c  // @src fx_mongolfier_mine.sc:217
    GetDot(r6, 0);
    Free2(r7, r6);
...
{
    // ../../std.sci:1093
    Call(r1, 0x0f50);  // @src ../../std.sci:1093
    // ../../std.sci:1094
...
{
    // ../../std.sci:128
    r2 = GetDotStr("World");  // @pool 0x1e0  // @src ../../std.sci:128
    SetDotRaw(r1, 1139);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
{
    // ../../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x265  // @src ../../std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // ../../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x265  // @src ../../std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // ../../std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x1c5  // @src ../../std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
...
func_10()
{
    ...
    r0 = r0 * r1;
    // ..\..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x499  // @src ..\..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0x4a5  // @src ..\..\sound.sci:260
    SetDotRaw(r5, 1197);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x4b4  // @src ..\..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x1fb  // @src ..\..\sound.sci:28
    SetDotRaw(r1, 740);
    Free1(r2);
...
func_13()
{
    ...
    r4 = GetDotStr("irandMax");  // @pool 0x25c
    g6 = r6;
    SetDotRaw(r5, 1275);
    Free1(r6);
    GetDot(r3, 1);
    ...
    r5 = GetDotStr("irandMax");  // @pool 0x25c
    g7 = r5;
    SetDotRaw(r6, 1275);
    Free1(r7);
    GetDot(r4, 1);
  ...
  L_13f0:
    r3 = GetDotStr("self");  // @pool 0x501  // @src fx_mongolfier_mine.sc:125
    r3 = (str)r3;
    Call(r4, 0x163c);
    r3 = 0;
    SetDot(r1, 1);
  ...
  L_1504:
    ...
    r2 = Not(r2);
    if (!r2) goto L_1550;
    r3 = GetDotStr("LinearVelocity");  // @pool 0x506
    r3 = (str)r3;
    Call(r4, 0x0fa0);
  ...
  L_1610:
    r1 = GetDotStr("Position");  // @pool 0x215  // @src fx_mongolfier_mine.sc:137
    g2 = r3;
    SetInd(r2);
    r0 = 533;
    Free2(r2, r1);
...
func_14()
{
    ...
    // ../../std.sci:1072
  L_166c:
    Call(r1, 0x0f50);  // @src ../../std.sci:1072
    // ../../std.sci:1073
    ...
    // ../../std.sci:1076
  L_169c:
    r2 = GetDotStr("!tuple");  // @pool 0x515  // @src ../../std.sci:1076
    r5 = r_neg4;
    SetDotRaw(r4, 533);
    Free1(r5);
    r6 = r0;
...
setTransform()
{
    ...
    r1 = GetDotStr("setTransform");  // @pool 0x1a8  // @src fx_mongolfier_mine.sc:30
    r2 = r_neg4;
    GetDot(r0, 1);
    Free3(r1, r2, r0);
...
applyForce()
{
    ...
    r1 = GetDotStr("applyForce");  // @pool 0x1b5  // @src fx_mongolfier_mine.sc:37
    r2 = r_neg4;
    r3 = GetDotStr("Mass");  // @pool 0x1c0
    r2 = r2 * r3;
    GetDot(r0, 1);
