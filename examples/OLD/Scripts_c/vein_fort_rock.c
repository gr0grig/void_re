...
func_1()
{
    ...
    r0 = 0xffffffff;  // @patch+4 vein_fort_rock.sc:11
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_fort_rock.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // vein_fort_rock.sc:8
    g2 = r9;  // @src vein_fort_rock.sc:8
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fort_rockpart1.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fort_rock.sc:9
    g2 = r9;  // @src vein_fort_rock.sc:9
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fort_rockpart2.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fort_rock.sc:10
    g2 = r9;  // @src vein_fort_rock.sc:10
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_fort_rockpart3.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_fort_rock.sc:11
    return r0;  // @src vein_fort_rock.sc:11
}
...
func_2()
{
    ...
    r0 = g4;
    // vein_base.sci:67
    r2 = GetDotStr("Scene");  // @pool 0x106  // @src vein_base.sci:67
    SetDotRaw(r1, 268);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:70
    r4 = GetDotStr("World");  // @pool 0x14b  // @src vein_base.sci:70
    SetDotRaw(r3, 337);
    Free1(r4);
    SetDotRaw(r2, 348);
    Free1(r3);
...
// vein_fort_rock.sc:28 (locals=6)
getVeinLimfaType()
{
    // vein_fort_rock.sc:26
    r1 = GetDotStr("findMaterial");  // @pool 0x191  // @src vein_fort_rock.sc:26
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fort_rock.sc:27
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x1b4  // @src vein_fort_rock.sc:27
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // vein_fort_rock.sc:28
    Free1(r_neg4);  // @src vein_fort_rock.sc:28
    return r0;
}
...
{
    // vein_base.sci:43
    r5 = GetDotStr("World");  // @pool 0x14b  // @src vein_base.sci:43
    SetDotRaw(r4, 337);
    Free1(r5);
    SetDotRaw(r3, 348);
    Free1(r4);
...
func_11()
{
    ...
    r0 = 0x49;
    r2 = "楖楳汢e朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦b...";  // len=782, pool_off=0x0, GARBLED  // @patch+4 vein_base.sci:131
    r0 = (float)r0;
    g1 = r6;
    r0 = r0 / r1;
    // vein_base.sci:132
...
getVeinLimfaType()
{
    ...
    // vein_base.sci:24
    r2 = GetDotStr("randMax");  // @pool 0x214  // @src vein_base.sci:24
    r3 = 6.2831854820251465f;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (float)r1;
    // vein_base.sci:25
    r3 = GetDotStr("randRange");  // @pool 0x21c  // @src vein_base.sci:25
...
// vein_fort_rock.sc:35 (locals=9)
func_14()
{
    // vein_fort_rock.sc:33
    r1 = GetDotStr("findMaterial");  // @pool 0x191  // @src vein_fort_rock.sc:33
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fort_rock.sc:34
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x226  // @src vein_fort_rock.sc:34
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
    ...
    GetDot(r1, 3);
    Free3(r2, r4, r1);
    // vein_fort_rock.sc:35
    return r0;  // @src vein_fort_rock.sc:35
}
...
{
    // vein_base.sci:220
    r2 = GetDotStr("Scene");  // @pool 0x106  // @src vein_base.sci:220
    SetDotRaw(r1, 268);
    Free1(r2);
    r2 = "updateVeinData";
    g3 = r1;
    ...
    Free3(r1, r2, r0);
    // vein_base.sci:223
    r1 = GetDotStr("!vec3");  // @pool 0x26f  // @src vein_base.sci:223
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    Free1(r1);
    r2 = GetDotStr("Transform");  // @pool 0x275
    SetDotRaw(r1, 639);
    Free1(r2);
    r0 = r0 * r1;
    r0 = (str)r0;
    // vein_base.sci:224
    r2 = GetDotStr("Transform");  // @pool 0x275  // @src vein_base.sci:224
    SetDotRaw(r1, 648);
    Free1(r2);
    r1 = (str)r1;
    // vein_base.sci:226
  ...
  L_0a14:
    ...
    r4 = (str)r4;
    // vein_base.sci:234
    r7 = GetDotStr("World");  // @pool 0x14b  // @src vein_base.sci:234
    SetDotRaw(r6, 660);
    Free1(r7);
    r7 = GetDotStr("Scene");  // @pool 0x106
    r8 = "limfa.pre";
    r9 = r4;
...
// vein_fort_rock.sc:22 (locals=7)
func_23()
{
    // vein_fort_rock.sc:15
    r0 = null_str2;  // @src vein_fort_rock.sc:15
    // vein_fort_rock.sc:16
    r3 = GetDotStr("World");  // @pool 0x14b  // @src vein_fort_rock.sc:16
    SetDotRaw(r2, 660);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x106
    r4 = "minewalls/minewall_fort_rockpart1.pre";
    r5 = GetDotStr("Transform");  // @pool 0x275
    r6 = "vein_part";
    GetDot(r1, 4);
    ...
    r0 = r1;
    Free1(r1);
    // vein_fort_rock.sc:17
    r3 = r0;  // @src vein_fort_rock.sc:17
    SetDotRaw(r2, 268);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_fort_rock.sc:18
    r3 = GetDotStr("World");  // @pool 0x14b  // @src vein_fort_rock.sc:18
    SetDotRaw(r2, 660);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x106
    r4 = "minewalls/minewall_fort_rockpart2.pre";
    r5 = GetDotStr("Transform");  // @pool 0x275
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_fort_rock.sc:19
    r3 = r0;  // @src vein_fort_rock.sc:19
    SetDotRaw(r2, 268);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_fort_rock.sc:20
    r3 = GetDotStr("World");  // @pool 0x14b  // @src vein_fort_rock.sc:20
    SetDotRaw(r2, 660);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x106
    r4 = "minewalls/minewall_fort_rockpart3.pre";
    r5 = GetDotStr("Transform");  // @pool 0x275
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_fort_rock.sc:21
    r3 = r0;  // @src vein_fort_rock.sc:21
    SetDotRaw(r2, 268);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_fort_rock.sc:22
    Free2(r0, r_neg4);  // @src vein_fort_rock.sc:22
    return r0;
}
...
func_24()
{
    ...
    r0 = 73;
    r2 = "物湡剤湡敧\0";  // len=583, pool_off=0x313, GARBLED  // @patch+4 vein_base.sci:155
    r3 = 10000000.0f;
    r4 = 40000000.0f;
    GetDot(r1, 2);
    Free1(r2);
...
getVeinLimfaType()
{
    ...
    r0 = 73;
    r2 = "物湡剤湡敧\0";  // len=327, pool_off=0x313, GARBLED  // @patch+4 vein_base.sci:175
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_0e98:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 515, 0x20a);  // @patch+8 vein_base.sci:182
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
