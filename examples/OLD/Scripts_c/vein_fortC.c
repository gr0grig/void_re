...
func_1()
{
    ...
    r0 = 0xffffffff;  // @patch+4 vein_fortC.sc:12
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_fortC.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
...
func_2()
{
    ...
    r0 = g4;
    // vein_base.sci:67
    r2 = GetDotStr("Scene");  // @pool 0x138  // @src vein_base.sci:67
    SetDotRaw(r1, 318);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:70
    r4 = GetDotStr("World");  // @pool 0x17d  // @src vein_base.sci:70
    SetDotRaw(r3, 387);
    Free1(r4);
    SetDotRaw(r2, 398);
    Free1(r3);
...
{
    // vein_fortC.sc:29
    r1 = GetDotStr("findMaterial");  // @pool 0x1c3  // @src vein_fortC.sc:29
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortC.sc:30
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x1e6  // @src vein_fortC.sc:30
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_base.sci:43
    r5 = GetDotStr("World");  // @pool 0x17d  // @src vein_base.sci:43
    SetDotRaw(r4, 387);
    Free1(r5);
    SetDotRaw(r3, 398);
    Free1(r4);
...
getVeinLimfaType()
{
    ...
    // vein_base.sci:24
    r2 = GetDotStr("randMax");  // @pool 0x246  // @src vein_base.sci:24
    r3 = 6.2831854820251465f;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (float)r1;
    // vein_base.sci:25
    r3 = GetDotStr("randRange");  // @pool 0x24e  // @src vein_base.sci:25
...
{
    // vein_fortC.sc:36
    r1 = GetDotStr("findMaterial");  // @pool 0x1c3  // @src vein_fortC.sc:36
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortC.sc:37
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x258  // @src vein_fortC.sc:37
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:220
    r2 = GetDotStr("Scene");  // @pool 0x138  // @src vein_base.sci:220
    SetDotRaw(r1, 318);
    Free1(r2);
    r2 = "updateVeinData";
    g3 = r1;
    ...
    Free3(r1, r2, r0);
    // vein_base.sci:223
    r1 = GetDotStr("!vec3");  // @pool 0x2a1  // @src vein_base.sci:223
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    Free1(r1);
    r2 = GetDotStr("Transform");  // @pool 0x2a7
    SetDotRaw(r1, 689);
    Free1(r2);
    r0 = r0 * r1;
    r0 = (str)r0;
    // vein_base.sci:224
    r2 = GetDotStr("Transform");  // @pool 0x2a7  // @src vein_base.sci:224
    SetDotRaw(r1, 698);
    Free1(r2);
    r1 = (str)r1;
    // vein_base.sci:226
  ...
  L_0a44:
    ...
    r4 = (str)r4;
    // vein_base.sci:234
    r7 = GetDotStr("World");  // @pool 0x17d  // @src vein_base.sci:234
    SetDotRaw(r6, 710);
    Free1(r7);
    r7 = GetDotStr("Scene");  // @pool 0x138
    r8 = "limfa.pre";
    r9 = r4;
...
func_23()
{
    ...
    // vein_fortC.sc:17
    r3 = GetDotStr("World");  // @pool 0x17d  // @src vein_fortC.sc:17
    SetDotRaw(r2, 710);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x138
    r4 = "minewalls/minewall_fortC_part1.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2a7
    r6 = "vein_part";
    GetDot(r1, 4);
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:19
    r3 = GetDotStr("World");  // @pool 0x17d  // @src vein_fortC.sc:19
    SetDotRaw(r2, 710);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x138
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:21
    r3 = GetDotStr("World");  // @pool 0x17d  // @src vein_fortC.sc:21
    SetDotRaw(r2, 710);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x138
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortC.sc:23
    r3 = GetDotStr("World");  // @pool 0x17d  // @src vein_fortC.sc:23
    SetDotRaw(r2, 710);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x138
...
func_24()
{
    ...
    r2 = r2 || r3;
    // vein_base.sci:155
    r2 = GetDotStr("irandRange");  // @pool 0x345  // @src vein_base.sci:155
    r3 = 10000000.0f;
    r4 = 40000000.0f;
    GetDot(r1, 2);
    Free1(r2);
...
getVeinLimfaType()
{
    ...
    r2 = r2 || r3;
    // vein_base.sci:175
    r1 = GetDotStr("irandRange");  // @pool 0x345  // @src vein_base.sci:175
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_0f64:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 565, 0x20a);  // @patch+8 vein_base.sci:182
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
