...
onTriggerPlayer()
{
    ...
    r1 = GetDotStr("trace");  // @pool 0x0  // @src surface_exit_2_alley.sc:7
...
func_3()
{
    ...
    r1 = GetDotStr("trace");  // @pool 0x0  // @src surface_exit_2_alley.sc:12
    r2 = "Activate: alley pigeons";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_2_alley.sc:15
    r2 = GetDotStr("Scene");  // @pool 0x68  // @src surface_exit_2_alley.sc:15
    SetDotRaw(r1, 110);
    Free1(r2);
    ...
    r3 = GetDotStr("World");  // @pool 0xa4  // @src surface_exit_2_alley.sc:16
    SetDotRaw(r2, 170);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x68
    ...
    r3 = GetDotStr("remove");  // @pool 0x120  // @src surface_exit_2_alley.sc:19
    GetDot(r2, 0);
    Free2(r3, r2);
