...
onTriggerPlayer()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0x0  // @src surface_exit_2_0.sc:14
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getNahodka";
    GetDot(r0, 1);
...
initTriggerByGroup()
{
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x1f  // @src surface_exit_2_0.sc:21
    r3 = GetDotStr("!vec3");  // @pool 0x26
    r4 = 1;
    r5 = 0;
    r6 = 0;
    GetDot(r2, 3);
    ...
    r2 = GetDotStr("remove");  // @pool 0x4e  // @src surface_exit_2_0.sc:24
    GetDot(r1, 0);
    Free2(r2, r1);
...
func_4()
{
    ...
    r1 = GetDotStr("call");  // @pool 0x6  // @src surface_exit_2_0.sc:32
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_2_0.sc:31
  ...
  L_017c:
    r1 = GetDotStr("remove");  // @pool 0x4e  // @src surface_exit_2_0.sc:34
    GetDot(r0, 0);
    Free2(r1, r0);
