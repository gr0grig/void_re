...
onTriggerPlayer()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0x0  // @src surface_exit_0_0_backalley.sc:14
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getNahodka";
    GetDot(r0, 1);
...
initTriggerByGroup()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0x0  // @src surface_exit_0_0_backalley.sc:24
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "createNahodkaAt";
    r3 = "pt_0_1";
    ...
    r1 = GetDotStr("remove");  // @pool 0x6b  // @src surface_exit_0_0_backalley.sc:26
    GetDot(r0, 0);
    Free2(r1, r0);
...
func_4()
{
    ...
    r1 = GetDotStr("call");  // @pool 0x6  // @src surface_exit_0_0_backalley.sc:35
    r2 = "initTrigger";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // surface_exit_0_0_backalley.sc:34
  ...
  L_0168:
    r1 = GetDotStr("remove");  // @pool 0x6b  // @src surface_exit_0_0_backalley.sc:37
    GetDot(r0, 0);
    Free2(r1, r0);
