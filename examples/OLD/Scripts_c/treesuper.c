...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 10804, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    // tree_base.sci:260
    Call(r3, 0x19a0);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x19a0);  // @src tree_base.sci:300
    // tree_base.sci:273
...
{
    // treesuper.sc:11
    g0 = r9;  // @src treesuper.sc:11
    if (r0) goto L_16a0;
    // treesuper.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src treesuper.sc:12
    ...
    r0 = (str)r0;
    // treesuper.sc:13
    r3 = GetDotStr("World");  // @pool 0xa6  // @src treesuper.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
{
    // treesuper.sc:29
    g0 = r10;  // @src treesuper.sc:29
    if (r0) goto L_199c;
    // treesuper.sc:30
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src treesuper.sc:30
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
    r0 = (str)r0;
    // treesuper.sc:31
    r3 = GetDotStr("World");  // @pool 0xa6  // @src treesuper.sc:31
    SetDotRaw(r2, 936);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1e
    ...
    Free1(r1);
    // treesuper.sc:33
    r6 = GetDotStr("World");  // @pool 0xa6  // @src treesuper.sc:33
    SetDotRaw(r5, 172);
    Free1(r6);
    SetDotRaw(r4, 183);
    Free1(r5);
...
{
    // treesuper.sc:40
    r5 = GetDotStr("World");  // @pool 0xa6  // @src treesuper.sc:40
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
    ...
    r0 = (str)r0;
    // treesuper.sc:41
    g1 = r7;  // @src treesuper.sc:41
    r1 = (float)r1;
    g2 = r11;
    r2 = (float)r2;
    r1 = r1 / r2;
    // treesuper.sc:42
    g4 = r10;  // @src treesuper.sc:42
    SetDotRaw(r3, 1105);
    Free1(r4);
    r4 = 0;
    r5 = "Strength";
...
{
    // treesuper.sc:49
    g0 = r10;  // @src treesuper.sc:49
    if (!r0) goto L_1dbc;
    // treesuper.sc:50
    g2 = r10;  // @src treesuper.sc:50
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // treesuper.sc:52
  L_1dbc:
    g0 = r9;  // @src treesuper.sc:52
    if (!r0) goto L_1df8;
    // treesuper.sc:53
    g2 = r9;  // @src treesuper.sc:53
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1fc4;
    r4 = GetDotStr("getGestureName");  // @pool 0x570
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_2078:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "⸀瀀猀猀瑥祓偳牡浡瑥牥汆慯tStreng...";  // len=119, pool_off=0x44a, GARBLED
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "⸀瀀猀猀瑥祓偳牡浡瑥牥汆慯tStreng...";  // len=113, pool_off=0x44a, GARBLED
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "⸀瀀猀猀瑥祓偳牡浡瑥牥汆慯tStreng...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
    ...
    if (!r5) goto L_2240;
    // tree_base.sci:165
    Call(r5, 0x24fc);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_2240:
    ...
    if (!r5) goto L_226c;
    // tree_base.sci:167
    Call(r5, 0x256c);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_2274;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_226c:
    Call(r5, 0x25dc);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_2274:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 9804, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x63b  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x63b  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x63b  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x2968);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_2818:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_2818;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_2954:
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x65c  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
