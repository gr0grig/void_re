...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 9412, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    if (!r3) goto L_10a8;
    // tree_base.sci:259
    Call(r3, 0x15f4);  // @src tree_base.sci:259
    // tree_base.sci:260
    Call(r3, 0x1600);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x1600);  // @src tree_base.sci:300
    // tree_base.sci:273
...
// treeonlysprout.sc:12 (locals=0)
func_15()
{
    // treeonlysprout.sc:12
    return r0;  // @src treeonlysprout.sc:12
}

// treeonlysprout.sc:21 (locals=0)
func_16()
{
    // treeonlysprout.sc:21
    return r0;  // @src treeonlysprout.sc:21
}

// treeonlysprout.sc:26 (locals=0)
func_17()
{
    // treeonlysprout.sc:26
    return r0;  // @src treeonlysprout.sc:26
}
...
// treeonlysprout.sc:31 (locals=0)
func_21()
{
    // treeonlysprout.sc:31
    return r0;  // @src treeonlysprout.sc:31
}
...
// treeonlysprout.sc:16 (locals=0)
func_23()
{
    // treeonlysprout.sc:16
    return r0;  // @src treeonlysprout.sc:16
}
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1a54;
    r4 = GetDotStr("getGestureName");  // @pool 0x47e
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_1b08:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "unt (due to inspiration): 敧䝴獥畴敲慎敭瀀氀愀礀攀爀最攀猀琀甀爀攀开搀漀渀漀爀一湯潄潮呲敲䙥汩卬慣敬猀栀漀眀䐀漀渀漀爀䠀攀氀瀀䴀硡湉敳瑲摥楌晭atabooViolation捁楴敶楌晭a獕摥楌晭a湉灳物瑡潩n汐祡牥";
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "unt (due to inspiration): 敧䝴獥畴敲慎敭瀀氀愀礀攀爀最攀猀琀甀爀攀开搀漀渀漀爀一湯潄潮呲敲䙥汩卬慣敬猀栀漀眀䐀漀渀漀爀䠀攀氀瀀䴀硡湉敳瑲摥楌晭atabooViolation捁楴敶楌晭a獕摥楌晭a湉灳物";
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "unt (due to inspirat...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
    ...
    if (!r5) goto L_1cd0;
    // tree_base.sci:165
    Call(r5, 0x1f8c);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_1cd0:
    ...
    if (!r5) goto L_1cfc;
    // tree_base.sci:167
    Call(r5, 0x1ffc);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_1d04;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_1cfc:
    Call(r5, 0x206c);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_1d04:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 8412, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x549  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x549  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x549  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x23f8);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_22a8:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_22a8;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_23e4:
...
// treeonlysprout.sc:7 (locals=1)
func_30()
{
    // treeonlysprout.sc:6
    r0 = 3;  // @src treeonlysprout.sc:6
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x56a  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
