...
{
    // gorge.sc:7
    return r0;  // @src gorge.sc:7
}

// gorge.sc:15 (locals=4)
pauseMusic()
{
    // gorge.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src gorge.sc:11
    r2 = "Gorge music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // gorge.sc:13
    r1 = r_neg5;  // @src gorge.sc:13
    r2 = "park_gorge_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // gorge.sc:14
    r0 = r_neg5;  // @src gorge.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // gorge.sc:15
    Free2(r_neg4, r_neg5);  // @src gorge.sc:15
    return r0;
}
...
// gorge.sc:20 (locals=3)
resumeMusic()
{
    // gorge.sc:19
    g2 = r0;  // @src gorge.sc:19
    SetDotRaw(r1, 217);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // gorge.sc:20
    return r0;  // @src gorge.sc:20
}

// gorge.sc:25 (locals=3)
onLocationExit()
{
    // gorge.sc:24
    g2 = r0;  // @src gorge.sc:24
    SetDotRaw(r1, 223);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // gorge.sc:25
    return r0;  // @src gorge.sc:25
}

// gorge.sc:30 (locals=4)
func_8()
{
    // gorge.sc:29
    g2 = r0;  // @src gorge.sc:29
    SetDotRaw(r1, 230);
    Free1(r2);
    r2 = 0;
    r3 = r_neg4;
