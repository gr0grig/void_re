...
{
    // ima.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src ima.sc:11
    r2 = "Ima music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // ima.sc:13
    r1 = r_neg5;  // @src ima.sc:13
    r2 = "girl_ima_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // ima.sc:14
    r0 = r_neg5;  // @src ima.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // ima.sc:15
    Free2(r_neg4, r_neg5);  // @src ima.sc:15
    return r0;
}
...
func_3()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:202
    r6 = GetDotStr("Globals");  // @pool 0x6e  // @src ..\sound.sci:202
    SetDotRaw(r5, 118);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x81  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
