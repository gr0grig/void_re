...
{
    // ava.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src ava.sc:11
    r2 = "Ava music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // ava.sc:13
    r1 = r_neg5;  // @src ava.sc:13
    r2 = "girl_ava_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // ava.sc:14
    r0 = r_neg5;  // @src ava.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // ava.sc:15
    Free2(r_neg4, r_neg5);  // @src ava.sc:15
    return r0;
}
