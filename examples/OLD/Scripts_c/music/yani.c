...
{
    // yani.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src yani.sc:11
    r2 = "Yani music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // yani.sc:13
    r1 = r_neg5;  // @src yani.sc:13
    r2 = "girl_yani_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // yani.sc:14
    r0 = r_neg5;  // @src yani.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // yani.sc:15
    Free2(r_neg4, r_neg5);  // @src yani.sc:15
    return r0;
}
...
{
    // yani.sc:19
    g2 = r0;  // @src yani.sc:19
    SetDotRaw(r1, 213);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // yani.sc:20
    return r0;  // @src yani.sc:20
}
...
{
    // yani.sc:24
    g2 = r0;  // @src yani.sc:24
    SetDotRaw(r1, 219);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // yani.sc:25
    return r0;  // @src yani.sc:25
}
