...
// backyard.sc:15 (locals=4)
pauseMusic()
{
    // backyard.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src backyard.sc:11
    r2 = "Backyard music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // backyard.sc:13
    r1 = r_neg5;  // @src backyard.sc:13
    r2 = "backyard_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // backyard.sc:14
    r0 = r_neg5;  // @src backyard.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // backyard.sc:15
    Free2(r_neg4, r_neg5);  // @src backyard.sc:15
    return r0;
}
...
func_3()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:202
    r6 = GetDotStr("Globals");  // @pool 0x78  // @src ..\sound.sci:202
    SetDotRaw(r5, 128);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x8b  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
// backyard.sc:20 (locals=3)
resumeMusic()
{
    // backyard.sc:19
    g2 = r0;  // @src backyard.sc:19
    SetDotRaw(r1, 219);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // backyard.sc:20
    return r0;  // @src backyard.sc:20
}

// backyard.sc:25 (locals=3)
onLocationExit()
{
    // backyard.sc:24
    g2 = r0;  // @src backyard.sc:24
    SetDotRaw(r1, 225);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // backyard.sc:25
    return r0;  // @src backyard.sc:25
}

// backyard.sc:31 (locals=4)
func_8()
{
    // backyard.sc:30
    g2 = r0;  // @src backyard.sc:30
    SetDotRaw(r1, 232);
    Free1(r2);
    r2 = 0;
    r3 = r_neg4;
