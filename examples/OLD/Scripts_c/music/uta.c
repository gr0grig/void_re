...
{
    // uta.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src uta.sc:11
    r2 = "Uta music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // uta.sc:13
    r1 = r_neg5;  // @src uta.sc:13
    r2 = "girl_uta_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // uta.sc:14
    r0 = r_neg5;  // @src uta.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // uta.sc:15
    Free2(r_neg4, r_neg5);  // @src uta.sc:15
    return r0;
}
