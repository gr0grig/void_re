...
{
    // exit_shaft.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src exit_shaft.sc:11
    r2 = "Ima music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // exit_shaft.sc:13
    r2 = GetDotStr("World");  // @pool 0x2a  // @src exit_shaft.sc:13
    SetDotRaw(r1, 48);
    Free1(r2);
    r2 = "Chapter";
    SetDot(r0, 1);
...
func_3()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:202
    r6 = GetDotStr("Globals");  // @pool 0xa5  // @src ..\sound.sci:202
    SetDotRaw(r5, 173);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0xb8  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
