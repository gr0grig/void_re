...
// bottles.sc:7 (locals=0)
func_1()
{
    // bottles.sc:7
    return r0;  // @src bottles.sc:7
}

// bottles.sc:15 (locals=4)
pauseMusic()
{
    // bottles.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src bottles.sc:11
    r2 = "Bottles music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // bottles.sc:13
    r1 = r_neg5;  // @src bottles.sc:13
    r2 = "garden_bottles_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // bottles.sc:14
    r0 = r_neg5;  // @src bottles.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // bottles.sc:15
    Free2(r_neg4, r_neg5);  // @src bottles.sc:15
    return r0;
}
...
// bottles.sc:20 (locals=3)
resumeMusic()
{
    // bottles.sc:19
    g2 = r0;  // @src bottles.sc:19
    SetDotRaw(r1, 229);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // bottles.sc:20
    return r0;  // @src bottles.sc:20
}

// bottles.sc:25 (locals=3)
onLocationExit()
{
    // bottles.sc:24
    g2 = r0;  // @src bottles.sc:24
    SetDotRaw(r1, 235);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // bottles.sc:25
    return r0;  // @src bottles.sc:25
}

// bottles.sc:30 (locals=4)
func_8()
{
    // bottles.sc:29
    g2 = r0;  // @src bottles.sc:29
    SetDotRaw(r1, 242);
    Free1(r2);
    r2 = 0;
    r3 = r_neg4;
