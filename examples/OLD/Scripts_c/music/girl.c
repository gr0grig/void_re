...
{
    // girl.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src girl.sc:11
    r2 = "Girl music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // girl.sc:13
    r1 = r_neg4;  // @src girl.sc:13
    r2 = "MusicAmbient";
    SetDot(r0, 1);
    Free1(r2);
    r0 = (str)r0;
    // girl.sc:14
    r1 = r0;  // @src girl.sc:14
    if (!r1) goto L_00c8;
    // girl.sc:15
    r2 = r_neg5;  // @src girl.sc:15
    r3 = r0;
    r4 = "Music";
    Call(r5, 0x00d4);
    r1 = g0;
    Free1(r1);
    // girl.sc:16
    r1 = r_neg5;  // @src girl.sc:16
    g2 = r0;
    Call(r3, 0x0208);
    // girl.sc:18
  L_00c8:
    Free3(r0, r_neg4, r_neg5);  // @src girl.sc:18
    return r0;
}
...
func_3()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:202
    r6 = GetDotStr("Globals");  // @pool 0x62  // @src ..\sound.sci:202
    SetDotRaw(r5, 106);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x75  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // girl.sc:22
    g2 = r0;  // @src girl.sc:22
    SetDotRaw(r1, 197);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girl.sc:23
    return r0;  // @src girl.sc:23
}
...
{
    // girl.sc:27
    g2 = r0;  // @src girl.sc:27
    SetDotRaw(r1, 203);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // girl.sc:28
    return r0;  // @src girl.sc:28
}
