...
// lemnamod.sc:7 (locals=0)
func_1()
{
    // lemnamod.sc:7
    return r0;  // @src lemnamod.sc:7
}

// lemnamod.sc:15 (locals=4)
pauseMusic()
{
    // lemnamod.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src lemnamod.sc:11
    r2 = "Lemnamod music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // lemnamod.sc:13
    r1 = r_neg5;  // @src lemnamod.sc:13
    r2 = "park_lemnamod_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // lemnamod.sc:14
    r0 = r_neg5;  // @src lemnamod.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // lemnamod.sc:15
    Free2(r_neg4, r_neg5);  // @src lemnamod.sc:15
    return r0;
}
...
// lemnamod.sc:20 (locals=3)
resumeMusic()
{
    // lemnamod.sc:19
    g2 = r0;  // @src lemnamod.sc:19
    SetDotRaw(r1, 229);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // lemnamod.sc:20
    return r0;  // @src lemnamod.sc:20
}

// lemnamod.sc:25 (locals=3)
onLocationExit()
{
    // lemnamod.sc:24
    g2 = r0;  // @src lemnamod.sc:24
    SetDotRaw(r1, 235);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // lemnamod.sc:25
    return r0;  // @src lemnamod.sc:25
}

// lemnamod.sc:30 (locals=4)
func_8()
{
    // lemnamod.sc:29
    g2 = r0;  // @src lemnamod.sc:29
    SetDotRaw(r1, 242);
    Free1(r2);
    r2 = 0;
    r3 = r_neg4;
