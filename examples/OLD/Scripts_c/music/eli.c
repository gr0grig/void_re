...
{
    // eli.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src eli.sc:11
    r2 = "Ima music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // eli.sc:13
    r1 = r_neg5;  // @src eli.sc:13
    r2 = "girl_eli_music";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // eli.sc:14
    r0 = r_neg5;  // @src eli.sc:14
    g1 = r0;
    Call(r2, 0x01d8);
    // eli.sc:15
    Free2(r_neg4, r_neg5);  // @src eli.sc:15
    return r0;
}
