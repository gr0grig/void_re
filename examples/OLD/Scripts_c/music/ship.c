...
{
    // ship.sc:11
    r1 = GetDotStr("logInfo");  // @pool 0x0  // @src ship.sc:11
    r2 = "Ship music inited.";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // ship.sc:14
    r1 = r_neg5;  // @src ship.sc:14
    r2 = "garden_ship_music_new";
    r3 = "Music";
    Call(r4, 0x00a4);
    r0 = g0;
    Free1(r0);
    // ship.sc:15
    r0 = r_neg5;  // @src ship.sc:15
    g1 = r0;
    Call(r2, 0x01d8);
    // ship.sc:16
    Free2(r_neg4, r_neg5);  // @src ship.sc:16
    return r0;
}
...
{
    // ship.sc:20
    g2 = r0;  // @src ship.sc:20
    SetDotRaw(r1, 225);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // ship.sc:21
    return r0;  // @src ship.sc:21
}
...
{
    // ship.sc:25
    g2 = r0;  // @src ship.sc:25
    SetDotRaw(r1, 231);
    Free1(r2);
    GetDot(r0, 0);
    Free2(r1, r0);
    // ship.sc:26
    return r0;  // @src ship.sc:26
}
