...
func_1()
{
    ...
    RawDword(0x0000102c);  // UNKNOWN opcode 0x2c
    r0 = 0xffffffff;  // @patch+4 vein_zewB.sc:12
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_zewB.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
...
func_2()
{
    ...
    r0 = g4;
    // vein_base.sci:67
    r2 = GetDotStr("Scene");  // @pool 0x130  // @src vein_base.sci:67
    SetDotRaw(r1, 310);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:70
    r4 = GetDotStr("World");  // @pool 0x175  // @src vein_base.sci:70
    SetDotRaw(r3, 379);
    Free1(r4);
    SetDotRaw(r2, 390);
    Free1(r3);
    ...
    // vein_base.sci:79
    goto L_033c;  // @src vein_base.sci:79
    // vein_base.sci:83
  L_0330:
    CallNat2(r3, 3592, 0x200);  // @src vein_base.sci:83
    // vein_base.sci:85
  L_033c:
...
{
    // vein_zewB.sc:29
    r1 = GetDotStr("findMaterial");  // @pool 0x1bb  // @src vein_zewB.sc:29
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewB.sc:30
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x1de  // @src vein_zewB.sc:30
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_base.sci:43
    r5 = GetDotStr("World");  // @pool 0x175  // @src vein_base.sci:43
    SetDotRaw(r4, 379);
    Free1(r5);
    SetDotRaw(r3, 390);
    Free1(r4);
...
onHarpoon()
{
    ...
    CopyExtRd(r0, 1, 2);
    // vein_base.sci:116
    Call(r0, 0x04d0);  // @src vein_base.sci:116
    // vein_base.sci:117
...
func_11()
{
    ...
    Free1(r1);
    // vein_base.sci:133
    Call(r1, 0x04d0);  // @src vein_base.sci:133
    // vein_base.sci:134
  ...
  L_05f0:
    ...
    // vein_base.sci:136
  L_0644:
    goto L_05f0;  // @src vein_base.sci:136
    // vein_base.sci:142
  L_064c:
...
getVeinLimfaType()
{
    ...
    // vein_base.sci:24
    r2 = GetDotStr("randMax");  // @pool 0x23e  // @src vein_base.sci:24
    r3 = 6.2831854820251465f;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (float)r1;
    // vein_base.sci:25
    r3 = GetDotStr("randRange");  // @pool 0x246  // @src vein_base.sci:25
  ...
  L_06dc:
    ...
    r0 = r4;
    // vein_base.sci:27
    goto L_06dc;  // @src vein_base.sci:27
}
...
{
    // vein_zewB.sc:36
    r1 = GetDotStr("findMaterial");  // @pool 0x1bb  // @src vein_zewB.sc:36
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewB.sc:37
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x250  // @src vein_zewB.sc:37
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:162
    CallNat2(r5, 2332, 0x0);  // @src vein_base.sci:162
    // vein_base.sci:163
...
{
    // vein_base.sci:220
    r2 = GetDotStr("Scene");  // @pool 0x130  // @src vein_base.sci:220
    SetDotRaw(r1, 310);
    Free1(r2);
    r2 = "updateVeinData";
    g3 = r1;
    ...
    Free3(r1, r2, r0);
    // vein_base.sci:223
    r1 = GetDotStr("!vec3");  // @pool 0x299  // @src vein_base.sci:223
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    Free1(r1);
    r2 = GetDotStr("Transform");  // @pool 0x29f
    SetDotRaw(r1, 681);
    Free1(r2);
    r0 = r0 * r1;
    r0 = (str)r0;
    // vein_base.sci:224
    r2 = GetDotStr("Transform");  // @pool 0x29f  // @src vein_base.sci:224
    SetDotRaw(r1, 690);
    Free1(r2);
    r1 = (str)r1;
    // vein_base.sci:226
  ...
  L_0a44:
    ...
    r4 = (str)r4;
    // vein_base.sci:234
    r7 = GetDotStr("World");  // @pool 0x175  // @src vein_base.sci:234
    SetDotRaw(r6, 702);
    Free1(r7);
    r7 = GetDotStr("Scene");  // @pool 0x130
    r8 = "limfa.pre";
    r9 = r4;
...
func_23()
{
    ...
    // vein_zewB.sc:17
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewB.sc:17
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
    r4 = "minewalls/minewall_zewB_part1.pre";
    r5 = GetDotStr("Transform");  // @pool 0x29f
    r6 = "vein_part";
    GetDot(r1, 4);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewB.sc:19
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewB.sc:19
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewB.sc:21
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewB.sc:21
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewB.sc:23
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewB.sc:23
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
...
func_24()
{
    ...
    RawDword(0x0000022d);  // UNKNOWN opcode 0x2d
    // vein_base.sci:155
    r2 = GetDotStr("irandRange");  // @pool 0x33d  // @src vein_base.sci:155
    r3 = 10000000.0f;
    r4 = 40000000.0f;
    GetDot(r1, 2);
    Free1(r2);
    ...
    Call(r2, 0x0e6c);
    // vein_base.sci:157
    CallNat(r6, 3816, 0x0);  // @src vein_base.sci:157
}
...
{
    // vein_base.sci:191
    CallNat2(r5, 2332, 0x0);  // @src vein_base.sci:191
    // vein_base.sci:192
...
getVeinLimfaType()
{
    ...
    RawDword(0x0000022d);  // UNKNOWN opcode 0x2d
    // vein_base.sci:175
    r1 = GetDotStr("irandRange");  // @pool 0x33d  // @src vein_base.sci:175
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_0f64:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 557, 0x20a);  // @patch+8 vein_base.sci:182
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
    // vein_base.sci:178
    goto L_0f64;  // @src vein_base.sci:178
    // vein_base.sci:176
  L_1004:
    r2 = r1;  // @src vein_base.sci:176
    r2 = Incr(r2);
    ...
    // vein_base.sci:186
  L_1020:
    CallNat(r6, 3816, 0x100);  // @src vein_base.sci:186
}
