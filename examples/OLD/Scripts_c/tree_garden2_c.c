...
func_15()
{
    ...
    g0 = r9;  // @src tree_garden2_c.sc:11
    if (r0) goto L_16a0;
    // tree_garden2_c.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden2_c.sc:12
    ...
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden2_c.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
func_16()
{
    ...
    g3 = r9;  // @src tree_garden2_c.sc:21
    SetDotRaw(r2, 1001);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_garden2_c.sc:22
    SetDotRaw(r2, 1001);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_garden2_c.sc:23
    SetDotRaw(r2, 1001);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_garden2_c.sc:24
    SetDotRaw(r2, 1001);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
...
func_17()
{
    ...
    g0 = r10;  // @src tree_garden2_c.sc:29
    if (r0) goto L_1880;
    // tree_garden2_c.sc:30
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden2_c.sc:30
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
func_18()
{
    ...
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden2_c.sc:37
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
    ...
    g1 = r7;  // @src tree_garden2_c.sc:38
    r1 = (float)r1;
    g2 = r11;
    r2 = (float)r2;
    r1 = r1 / r2;
...
func_22()
{
    ...
    g0 = r10;  // @src tree_garden2_c.sc:44
    if (!r0) goto L_1bc4;
    // tree_garden2_c.sc:45
    g2 = r10;  // @src tree_garden2_c.sc:45
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
  ...
  L_1bc4:
    g0 = r9;  // @src tree_garden2_c.sc:47
    if (!r0) goto L_1c00;
    // tree_garden2_c.sc:48
    g2 = r9;  // @src tree_garden2_c.sc:48
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
