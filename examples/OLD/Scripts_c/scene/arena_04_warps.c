...
// @func_table: 18 groups offsets=72,651,1964,3273,4545,5245,6546,7864,8569,9995,11352,12778,14135,14714,15352,16006,16656,17310
...
// @ft_group 1: parent=0 stack=0 locals=0 vtable=[{func_13},{func_14},{func_19},{func_20},{func_21},{func_22},{func_23},{func_24},{func_80},{func_6}] imports=[(4,0),(3,0),(2,0),(1,0)]
//   export "initMusic" args=0 cb=-1 {func_5}
//   export "registerSlowMotionMusic" args=1 cb=-1 {func_81} types=[str]
//   export "registerSlowMotionSFX" args=1 cb=-1 {func_82} types=[str]
//   export "startBlocked" args=2 cb=-1 {func_83} types=[str,float]
//   export "stopBlocked" args=0 cb=-1 {func_84}
//   export "startSlowMotion" args=1 cb=-1 {func_85} types=[float]
//   export "stopSlowMotion" args=0 cb=-1 {func_86}
//   export "setLimfaChangeAmount" args=2 cb=-1 {func_87} types=[int,int]
//   export "showHelper" args=1 cb=-1 {func_88} types=[str]
//   export "informInactiveGesture" args=0 cb=-1 {func_89}
//   export "informHealthChange" args=0 cb=-1 {func_90}
//   export "showWheel" args=1 cb=-1 {func_91} types=[bool]
//   export "disableWheel" args=1 cb=-1 {func_92} types=[bool]
//   export "render" args=0 cb=-1 {func_93}
//   export "onGestureDrawn" args=4 cb=-1 {func_96} types=[int,int,float,str]
//   export "onInputAction" args=2 cb=-1 {func_98} types=[str,bool]
//   export "activateObscure" args=1 cb=-1 {func_100} types=[str]
//   export "activateTree" args=2 cb=-1 {func_101} types=[str,float]
//   export "suckTree" args=1 cb=-1 {func_102} types=[str]
//   export "spectateFromCamera" args=1 cb=-1 {func_103} types=[str]
//   export "getActivePlane" args=0 cb=-1 {func_104}
//   export "getSpeedFactor" args=0 cb=-1 {func_105}
//   export "getWheelLevel0" args=0 cb=-1 {func_47}
//   export "getWheelLevel1" args=0 cb=-1 {func_48}
//   export "getWheelLevel2" args=0 cb=-1 {func_49}
//   export "getSelectedIndices" args=0 cb=-1 {func_50}
...
//   export "getActivePlane" args=0 cb=-1 {func_104}
//   export "render" args=0 cb=-1 {func_95}
//   export "getSpeedFactor" args=0 cb=-1 {func_105}
//   export "onInputAction" args=2 cb=-1 {func_99} types=[str,bool]
//   export "getWheelLevel0" args=0 cb=-1 {func_47}
//   export "getWheelLevel1" args=0 cb=-1 {func_48}
//   export "getWheelLevel2" args=0 cb=-1 {func_49}
//   export "getSelectedIndices" args=0 cb=-1 {func_50}
...
// #export {func_81} name="registerSlowMotionMusic"
// #export {func_82} name="registerSlowMotionSFX"
// #export {func_83} name="startBlocked"
// #export {func_84} name="stopBlocked"
// #export {func_85} name="startSlowMotion"
// #export {func_86} name="stopSlowMotion"
// #export {func_87} name="setLimfaChangeAmount"
// #export {func_88} name="showHelper"
// #export {func_89} name="informInactiveGesture"
// #export {func_90} name="informHealthChange"
// #export {func_91} name="showWheel"
// #export {func_92} name="disableWheel"
// #export {func_93} name="render"
// #export {func_95} name="render"
// #export {func_96} name="onGestureDrawn"
// #export {func_98} name="onInputAction"
// #export {func_99} name="onInputAction"
// #export {func_100} name="activateObscure"
// #export {func_101} name="activateTree"
// #export {func_102} name="suckTree"
// #export {func_103} name="spectateFromCamera"
// #export {func_104} name="getActivePlane"
// #export {func_105} name="getSpeedFactor"
...
func_80()
{
    ...
    // arena_04_warps.sc:8
    r2 = GetDotStr("hasVariable");  // @pool 0xe86  // @src arena_04_warps.sc:8
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_33dc;
    // arena_04_warps.sc:9
    r2 = GetDotStr("getVariable");  // @pool 0xe92  // @src arena_04_warps.sc:9
    r3 = "Hunter";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
...
{
    // playable.sci:109
    r1 = GetDotStr("changeUpdateSpeed");  // @pool 0xecf  // @src playable.sci:109
    r2 = r_neg4;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (str)r0;
...
{
    // playable.sci:209
    Call(r0, 0x3d34);  // @src playable.sci:209
    // playable.sci:210
...
func_94()
{
    ...
    Free2(r1, r0);
    // playable.sci:215
    Call(r0, 0x3d6c);  // @src playable.sci:215
    // playable.sci:216
...
{
    // playable.sci:220
    Call(r1, 0x3e18);  // @src playable.sci:220
    // playable.sci:221
    r1 = r0;  // @src playable.sci:221
    if (!r1) goto L_3e0c;
    // playable.sci:222
    r2 = GetDotStr("sendWorldGenericEvent");  // @pool 0xf7f  // @src playable.sci:222
    r3 = r0;
    r4 = "onGesture";
    r5 = r_neg7;
    r6 = r_neg6;
...
activateObscure()
{
  ...
  L_3f4c:
    ...
    // playable.sci:228
    goto L_4038;  // @src playable.sci:228
    // playable.sci:236
  L_3f5c:
...
{
    // paintable.sci:26
    r0 = GetDotStr("SpeedFactor");  // @pool 0xff4  // @src paintable.sci:26
    r0 = (float)r0;
    r_neg4 = r0;
    return r0;
}
