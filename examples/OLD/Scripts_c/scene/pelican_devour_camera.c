...
func_3()
{
  ...
  L_0060:
    r2 = GetDotStr("!rotateX");  // @pool 0x0  // @src pelican_devour_camera.sc:28
    ...
    r3 = GetDotStr("!rotateY");  // @pool 0x9  // @src pelican_devour_camera.sc:29
    ...
    r4 = GetDotStr("!rotateZ");  // @pool 0x12  // @src pelican_devour_camera.sc:30
