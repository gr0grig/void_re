...
{
    // una_hammer.sc:10
    r1 = GetDotStr("loadSound3D");  // @pool 0x0  // @src una_hammer.sc:10
    r2 = "una_hammer_hit";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // una_hammer.sc:12
    r1 = GetDotStr("randRange");  // @pool 0x28  // @src una_hammer.sc:12
    r2 = 0;
    ...
    r0 = (float)r0;
    // una_hammer.sc:13
    r1 = GetDotStr("Rotation");  // @pool 0x32  // @src una_hammer.sc:13
    r1 = (str)r1;
    // una_hammer.sc:15
    r3 = GetDotStr("setKinematic");  // @pool 0x3b  // @src una_hammer.sc:15
    r4 = true;
    GetDot(r2, 1);
    Free2(r3, r2);
    // una_hammer.sc:17
  ...
  L_00cc:
    ...
    r7 = r7 * r8;
    // una_hammer.sc:30
    r9 = GetDotStr("setRotation");  // @pool 0x48  // @src una_hammer.sc:30
    r11 = GetDotStr("!rotateY");  // @pool 0x54
    r12 = r7;
    GetDot(r10, 1);
    Free1(r11);
    r11 = r1;
  ...
  L_01d0:
    ...
    SetDotRaw(r10, 93);
    Free1(r11);
    r11 = GetDotStr("Position");  // @pool 0x5d
    r10 = r10 - r11;
    r10 = (str)r10;
    Call(r11, 0x03ec);
    // una_hammer.sc:36
...
{
    // ../std.sci:128
    r2 = GetDotStr("World");  // @pool 0xac  // @src ../std.sci:128
    SetDotRaw(r1, 178);
    Free1(r2);
    r2 = null_str;
    r3 = "getPlayer";
...
func_5()
{
    ...
    r0 = r0 * r1;
    // ..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0xd8  // @src ..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0xe4  // @src ..\sound.sci:260
    SetDotRaw(r5, 236);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0xf7  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x114  // @src ..\sound.sci:28
    SetDotRaw(r1, 282);
    Free1(r2);
