...
func_1()
{
    ...
    r0 = 0xffffffff;  // @patch+4 vein_zewC.sc:12
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_zewC.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
...
{
    // vein_zewC.sc:29
    r1 = GetDotStr("findMaterial");  // @pool 0x1bb  // @src vein_zewC.sc:29
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewC.sc:30
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x1de  // @src vein_zewC.sc:30
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_zewC.sc:36
    r1 = GetDotStr("findMaterial");  // @pool 0x1bb  // @src vein_zewC.sc:36
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewC.sc:37
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x250  // @src vein_zewC.sc:37
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
func_23()
{
    ...
    // vein_zewC.sc:17
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewC.sc:17
    SetDotRaw(r2, 702);
    Free1(r3);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:19
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewC.sc:19
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:21
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewC.sc:21
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewC.sc:23
    r3 = GetDotStr("World");  // @pool 0x175  // @src vein_zewC.sc:23
    SetDotRaw(r2, 702);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x130
