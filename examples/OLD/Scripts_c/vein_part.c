...
initVeinPart()
{
    ...
    r2 = GetDotStr("randRange");  // @pool 0x0
    r3 = 5;
    r4 = 10;
    GetDot(r1, 2);
    Free1(r2);
    ...
    CallMethod(r0, 41, 0x140);  // @patch+8 vein_part.sc:13
...
{
    // std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x0  // @src std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x0  // @src std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x3a  // @src std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
...
{
    // vein_part.sc:20
    r2 = GetDotStr("irandRange");  // @pool 0x40  // @src vein_part.sc:20
    r3 = 100000;
    r4 = 200000;
    GetDot(r1, 2);
    Free1(r2);
  ...
  L_0208:
    ...
    // vein_part.sc:31
  L_0278:
    r2 = GetDotStr("remove");  // @pool 0x5c  // @src vein_part.sc:31
    GetDot(r1, 0);
    Free2(r2, r1);
    // vein_part.sc:32
