...
func_2()
{
    ...
    r0 = g4;
    // vein_base.sci:67
    r2 = GetDotStr("Scene");  // @pool 0x17c  // @src vein_base.sci:67
    SetDotRaw(r1, 386);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:70
    r4 = GetDotStr("World");  // @pool 0x1c1  // @src vein_base.sci:70
    SetDotRaw(r3, 455);
    Free1(r4);
    SetDotRaw(r2, 466);
    Free1(r3);
...
{
    // vein_fortD.sc:32
    r1 = GetDotStr("findMaterial");  // @pool 0x207  // @src vein_fortD.sc:32
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortD.sc:33
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x22a  // @src vein_fortD.sc:33
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
...
{
    // vein_base.sci:43
    r5 = GetDotStr("World");  // @pool 0x1c1  // @src vein_base.sci:43
    SetDotRaw(r4, 455);
    Free1(r5);
    SetDotRaw(r3, 466);
    Free1(r4);
...
getVeinLimfaType()
{
    ...
    // vein_base.sci:24
    r2 = GetDotStr("randMax");  // @pool 0x28a  // @src vein_base.sci:24
    r3 = 6.2831854820251465f;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (float)r1;
    // vein_base.sci:25
    r3 = GetDotStr("randRange");  // @pool 0x292  // @src vein_base.sci:25
...
{
    // vein_fortD.sc:39
    r1 = GetDotStr("findMaterial");  // @pool 0x207  // @src vein_fortD.sc:39
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_fortD.sc:40
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x29c  // @src vein_fortD.sc:40
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
{
    // vein_base.sci:220
    r2 = GetDotStr("Scene");  // @pool 0x17c  // @src vein_base.sci:220
    SetDotRaw(r1, 386);
    Free1(r2);
    r2 = "updateVeinData";
    g3 = r1;
    ...
    Free3(r1, r2, r0);
    // vein_base.sci:223
    r1 = GetDotStr("!vec3");  // @pool 0x2e5  // @src vein_base.sci:223
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    Free1(r1);
    r2 = GetDotStr("Transform");  // @pool 0x2eb
    SetDotRaw(r1, 757);
    Free1(r2);
    r0 = r0 * r1;
    r0 = (str)r0;
    // vein_base.sci:224
    r2 = GetDotStr("Transform");  // @pool 0x2eb  // @src vein_base.sci:224
    SetDotRaw(r1, 766);
    Free1(r2);
    r1 = (str)r1;
    // vein_base.sci:226
  ...
  L_0a74:
    ...
    r4 = (str)r4;
    // vein_base.sci:234
    r7 = GetDotStr("World");  // @pool 0x1c1  // @src vein_base.sci:234
    SetDotRaw(r6, 778);
    Free1(r7);
    r7 = GetDotStr("Scene");  // @pool 0x17c
    r8 = "limfa.pre";
    r9 = r4;
...
func_23()
{
    ...
    // vein_fortD.sc:18
    r3 = GetDotStr("World");  // @pool 0x1c1  // @src vein_fortD.sc:18
    SetDotRaw(r2, 778);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x17c
    r4 = "minewalls/minewall_fortD_part1.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2eb
    r6 = "vein_part";
    GetDot(r1, 4);
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortD.sc:20
    r3 = GetDotStr("World");  // @pool 0x1c1  // @src vein_fortD.sc:20
    SetDotRaw(r2, 778);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x17c
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortD.sc:22
    r3 = GetDotStr("World");  // @pool 0x1c1  // @src vein_fortD.sc:22
    SetDotRaw(r2, 778);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x17c
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortD.sc:24
    r3 = GetDotStr("World");  // @pool 0x1c1  // @src vein_fortD.sc:24
    SetDotRaw(r2, 778);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x17c
    ...
    Free4(r2, r3, r4, r1);
    // vein_fortD.sc:26
    r3 = GetDotStr("World");  // @pool 0x1c1  // @src vein_fortD.sc:26
    SetDotRaw(r2, 778);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x17c
...
func_24()
{
    ...
    RawDword(0x00000279);  // UNKNOWN opcode 0x79
    // vein_base.sci:155
    r2 = GetDotStr("irandRange");  // @pool 0x389  // @src vein_base.sci:155
    r3 = 10000000.0f;
    r4 = 40000000.0f;
    GetDot(r1, 2);
    Free1(r2);
...
getVeinLimfaType()
{
    ...
    RawDword(0x00000279);  // UNKNOWN opcode 0x79
    // vein_base.sci:175
    r1 = GetDotStr("irandRange");  // @pool 0x389  // @src vein_base.sci:175
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_1030:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 633, 0x20a);  // @patch+8 vein_base.sci:182
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
