...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 10436, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    if (!r3) goto L_10a8;
    // tree_base.sci:259
    Call(r3, 0x18c0);  // @src tree_base.sci:259
    // tree_base.sci:260
    Call(r3, 0x190c);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x190c);  // @src tree_base.sci:300
    // tree_base.sci:273
...
{
    // tree_garden1b.sc:11
    g0 = r9;  // @src tree_garden1b.sc:11
    if (r0) goto L_16a0;
    // tree_garden1b.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden1b.sc:12
    ...
    r0 = (str)r0;
    // tree_garden1b.sc:13
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden1b.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
{
    // tree_garden1b.sc:31
    g0 = r10;  // @src tree_garden1b.sc:31
    if (r0) goto L_1908;
    // tree_garden1b.sc:32
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_garden1b.sc:32
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
{
    // tree_garden1b.sc:39
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_garden1b.sc:39
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
...
{
    // tree_garden1b.sc:46
    g0 = r10;  // @src tree_garden1b.sc:46
    if (!r0) goto L_1c4c;
    // tree_garden1b.sc:47
    g2 = r10;  // @src tree_garden1b.sc:47
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_garden1b.sc:49
  L_1c4c:
    g0 = r9;  // @src tree_garden1b.sc:49
    if (!r0) goto L_1c88;
    // tree_garden1b.sc:50
    g2 = r9;  // @src tree_garden1b.sc:50
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1e54;
    r4 = GetDotStr("getGestureName");  // @pool 0x4ff
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_1f08:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀...";  // len=119, pool_off=0x44a, GARBLED
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀...";  // len=113, pool_off=0x44a, GARBLED
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀 椀渀...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
    ...
    if (!r5) goto L_20d0;
    // tree_base.sci:165
    Call(r5, 0x238c);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_20d0:
    ...
    if (!r5) goto L_20fc;
    // tree_base.sci:167
    Call(r5, 0x23fc);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_2104;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_20fc:
    Call(r5, 0x246c);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_2104:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 9436, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x5ca  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x5ca  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x5ca  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x27f8);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_26a8:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_26a8;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_27e4:
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x5eb  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
