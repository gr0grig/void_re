...
func_3()
{
  ...
  L_0060:
    r2 = GetDotStr("!rotateX");  // @pool 0x0  // @src pangolin_camera.sc:26
    ...
    r3 = GetDotStr("!rotateY");  // @pool 0x9  // @src pangolin_camera.sc:27
    ...
    r4 = GetDotStr("!rotateZ");  // @pool 0x12  // @src pangolin_camera.sc:28
