// gscript: vein_arbocliff_usual.bin
// @old_version
// @version: 0
...
func_1()
{
    ...
    RawDword(0x000011c4);  // UNKNOWN opcode 0xc4
    r0 = 0xffffffff;  // @patch+4 vein_arbocliff_usual.sc:14
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_arbocliff_usual.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // vein_arbocliff_usual.sc:8
    g2 = r9;  // @src vein_arbocliff_usual.sc:8
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part1.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:9
    g2 = r9;  // @src vein_arbocliff_usual.sc:9
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part2.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:10
    g2 = r9;  // @src vein_arbocliff_usual.sc:10
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part3.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:11
    g2 = r9;  // @src vein_arbocliff_usual.sc:11
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part4.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:12
    g2 = r9;  // @src vein_arbocliff_usual.sc:12
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part5.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:13
    g2 = r9;  // @src vein_arbocliff_usual.sc:13
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_arbocliff_part6.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_arbocliff_usual.sc:14
    return r0;  // @src vein_arbocliff_usual.sc:14
}
...
func_2()
{
    ...
    r0 = g4;
    // vein_base.sci:67
    r2 = GetDotStr("Scene");  // @pool 0x1f0  // @src vein_base.sci:67
    SetDotRaw(r1, 502);
    Free1(r2);
    ...
    Free1(r1);
    // vein_base.sci:70
    r4 = GetDotStr("World");  // @pool 0x235  // @src vein_base.sci:70
    SetDotRaw(r3, 571);
    Free1(r4);
    SetDotRaw(r2, 582);
    Free1(r3);
    ...
    CallNat2(r2, 1448, 0x201);
    // vein_base.sci:79
    goto L_039c;  // @src vein_base.sci:79
    // vein_base.sci:83
  L_0390:
    CallNat2(r3, 4000, 0x200);  // @src vein_base.sci:83
    // vein_base.sci:85
  L_039c:
...
// vein_arbocliff_usual.sc:37 (locals=6)
getVeinLimfaType()
{
    // vein_arbocliff_usual.sc:35
    r1 = GetDotStr("findMaterial");  // @pool 0x27b  // @src vein_arbocliff_usual.sc:35
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_arbocliff_usual.sc:36
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x29e  // @src vein_arbocliff_usual.sc:36
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // vein_arbocliff_usual.sc:37
    Free1(r_neg4);  // @src vein_arbocliff_usual.sc:37
    return r0;
}
...
{
    // vein_base.sci:43
    r5 = GetDotStr("World");  // @pool 0x235  // @src vein_base.sci:43
    SetDotRaw(r4, 571);
    Free1(r5);
    SetDotRaw(r3, 582);
    Free1(r4);
...
onHarpoon()
{
    ...
    CopyExtRd(r0, 1, 2);
    // vein_base.sci:116
    Call(r0, 0x0530);  // @src vein_base.sci:116
    // vein_base.sci:117
...
func_11()
{
    ...
    r0 = 0x49;
    RawDword(0x000002ed);  // UNKNOWN opcode 0xed
    // vein_base.sci:131
    ...
    Free1(r1);
    // vein_base.sci:133
    Call(r1, 0x0530);  // @src vein_base.sci:133
    // vein_base.sci:134
  ...
  L_0650:
    ...
    // vein_base.sci:136
  L_06a4:
    goto L_0650;  // @src vein_base.sci:136
    // vein_base.sci:142
  L_06ac:
...
getVeinLimfaType()
{
    ...
    // vein_base.sci:24
    r2 = GetDotStr("randMax");  // @pool 0x2fe  // @src vein_base.sci:24
    r3 = 6.2831854820251465f;
    GetDot(r1, 1);
    Free1(r2);
    r1 = (float)r1;
    // vein_base.sci:25
    r3 = GetDotStr("randRange");  // @pool 0x306  // @src vein_base.sci:25
  ...
  L_073c:
    ...
    r0 = r4;
    // vein_base.sci:27
    goto L_073c;  // @src vein_base.sci:27
}

// vein_arbocliff_usual.sc:44 (locals=9)
func_14()
{
    // vein_arbocliff_usual.sc:42
    r1 = GetDotStr("findMaterial");  // @pool 0x27b  // @src vein_arbocliff_usual.sc:42
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_arbocliff_usual.sc:43
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x310  // @src vein_arbocliff_usual.sc:43
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
    ...
    GetDot(r1, 3);
    Free3(r2, r4, r1);
    // vein_arbocliff_usual.sc:44
    return r0;  // @src vein_arbocliff_usual.sc:44
}
...
{
    // vein_base.sci:162
    CallNat2(r5, 2428, 0x0);  // @src vein_base.sci:162
    // vein_base.sci:163
...
{
    // vein_base.sci:220
    r2 = GetDotStr("Scene");  // @pool 0x1f0  // @src vein_base.sci:220
    SetDotRaw(r1, 502);
    Free1(r2);
    r2 = "updateVeinData";
    g3 = r1;
    ...
    Free3(r1, r2, r0);
    // vein_base.sci:223
    r1 = GetDotStr("!vec3");  // @pool 0x359  // @src vein_base.sci:223
    r2 = 0;
    r3 = 1;
    r4 = 0;
    GetDot(r0, 3);
    Free1(r1);
    r2 = GetDotStr("Transform");  // @pool 0x35f
    SetDotRaw(r1, 873);
    Free1(r2);
    r0 = r0 * r1;
    r0 = (str)r0;
    // vein_base.sci:224
    r2 = GetDotStr("Transform");  // @pool 0x35f  // @src vein_base.sci:224
    SetDotRaw(r1, 882);
    Free1(r2);
    r1 = (str)r1;
    // vein_base.sci:226
  ...
  L_0aa4:
    ...
    r4 = (str)r4;
    // vein_base.sci:234
    r7 = GetDotStr("World");  // @pool 0x235  // @src vein_base.sci:234
    SetDotRaw(r6, 894);
    Free1(r7);
    r7 = GetDotStr("Scene");  // @pool 0x1f0
    r8 = "limfa.pre";
    r9 = r4;
  ...
  L_0bcc:
    ...
    CallNat(r2, 1448, 0x301);
}

// vein_arbocliff_usual.sc:31 (locals=7)
func_23()
{
    // vein_arbocliff_usual.sc:18
    r0 = null_str2;  // @src vein_arbocliff_usual.sc:18
    // vein_arbocliff_usual.sc:19
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:19
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part1.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:20
    r3 = r0;  // @src vein_arbocliff_usual.sc:20
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:21
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:21
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part2.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:22
    r3 = r0;  // @src vein_arbocliff_usual.sc:22
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:23
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:23
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part3.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:24
    r3 = r0;  // @src vein_arbocliff_usual.sc:24
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:25
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:25
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part4.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:26
    r3 = r0;  // @src vein_arbocliff_usual.sc:26
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:27
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:27
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part5.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:28
    r3 = r0;  // @src vein_arbocliff_usual.sc:28
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:29
    r3 = GetDotStr("World");  // @pool 0x235  // @src vein_arbocliff_usual.sc:29
    SetDotRaw(r2, 894);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x1f0
    r4 = "minewalls/minewall_arbocliff_part6.pre";
    r5 = GetDotStr("Transform");  // @pool 0x35f
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    r0 = r1;
    Free1(r1);
    // vein_arbocliff_usual.sc:30
    r3 = r0;  // @src vein_arbocliff_usual.sc:30
    SetDotRaw(r2, 502);
    Free1(r3);
    r3 = "initVeinPart";
    r4 = r_neg4;
    GetDot(r1, 2);
    Free4(r2, r3, r4, r1);
    // vein_arbocliff_usual.sc:31
    Free2(r0, r_neg4);  // @src vein_arbocliff_usual.sc:31
    return r0;
}
...
func_24()
{
    ...
    RawDword(0x000002ed);  // UNKNOWN opcode 0xed
    // vein_base.sci:155
    r2 = GetDotStr("irandRange");  // @pool 0x3fd  // @src vein_base.sci:155
    r3 = 10000000.0f;
    r4 = 40000000.0f;
    GetDot(r1, 2);
    Free1(r2);
    ...
    Call(r2, 0x1004);
    // vein_base.sci:157
    CallNat(r6, 4224, 0x0);  // @src vein_base.sci:157
}
...
{
    // vein_base.sci:191
    CallNat2(r5, 2428, 0x0);  // @src vein_base.sci:191
    // vein_base.sci:192
...
getVeinLimfaType()
{
    ...
    RawDword(0x000002ed);  // UNKNOWN opcode 0xed
    // vein_base.sci:175
    r1 = GetDotStr("irandRange");  // @pool 0x3fd  // @src vein_base.sci:175
    r2 = 2;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_10fc:
    ...
    r6 = r6 * r7;
    r5 = r5 - r6;
    CallMethod(r5, 749, 0x20a);  // @patch+8 vein_base.sci:182
    LoadFalse(r0);
    r6 = r4;
    r5 = r5 - r6;
    r2 = r5;
    // vein_base.sci:178
    goto L_10fc;  // @src vein_base.sci:178
    // vein_base.sci:176
  L_119c:
    r2 = r1;  // @src vein_base.sci:176
    r2 = Incr(r2);
    ...
    // vein_base.sci:186
  L_11b8:
    CallNat(r6, 4224, 0x100);  // @src vein_base.sci:186
}
