...
{
    // tree_lemnamod.sc:11
    g0 = r9;  // @src tree_lemnamod.sc:11
    if (r0) goto L_16a0;
    // tree_lemnamod.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_lemnamod.sc:12
    ...
    r0 = (str)r0;
    // tree_lemnamod.sc:13
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_lemnamod.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
{
    // tree_lemnamod.sc:29
    g0 = r10;  // @src tree_lemnamod.sc:29
    if (r0) goto L_1880;
    // tree_lemnamod.sc:30
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_lemnamod.sc:30
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
{
    // tree_lemnamod.sc:37
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_lemnamod.sc:37
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
...
{
    // tree_lemnamod.sc:44
    g0 = r10;  // @src tree_lemnamod.sc:44
    if (!r0) goto L_1bc4;
    // tree_lemnamod.sc:45
    g2 = r10;  // @src tree_lemnamod.sc:45
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_lemnamod.sc:47
  L_1bc4:
    g0 = r9;  // @src tree_lemnamod.sc:47
    if (!r0) goto L_1c00;
    // tree_lemnamod.sc:48
    g2 = r9;  // @src tree_lemnamod.sc:48
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
