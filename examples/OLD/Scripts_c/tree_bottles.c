...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 10368, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    if (!r3) goto L_10a8;
    // tree_base.sci:259
    Call(r3, 0x187c);  // @src tree_base.sci:259
    // tree_base.sci:260
    Call(r3, 0x18c8);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x18c8);  // @src tree_base.sci:300
    // tree_base.sci:273
...
{
    // tree_bottles.sc:11
    g0 = r9;  // @src tree_bottles.sc:11
    if (r0) goto L_16a0;
    // tree_bottles.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_bottles.sc:12
    ...
    r0 = (str)r0;
    // tree_bottles.sc:13
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_bottles.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
{
    // tree_bottles.sc:30
    g0 = r10;  // @src tree_bottles.sc:30
    if (r0) goto L_18c4;
    // tree_bottles.sc:31
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_bottles.sc:31
    r2 = GetDotStr("Rotation");  // @pool 0x396
    r3 = GetDotStr("Position");  // @pool 0x39f
    GetDot(r0, 2);
    Free3(r1, r2, r3);
...
{
    // tree_bottles.sc:38
    r5 = GetDotStr("World");  // @pool 0xa6  // @src tree_bottles.sc:38
    SetDotRaw(r4, 172);
    Free1(r5);
    SetDotRaw(r3, 183);
    Free1(r4);
...
{
    // tree_bottles.sc:45
    g0 = r10;  // @src tree_bottles.sc:45
    if (!r0) goto L_1c08;
    // tree_bottles.sc:46
    g2 = r10;  // @src tree_bottles.sc:46
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
    ...
    // tree_bottles.sc:48
  L_1c08:
    g0 = r9;  // @src tree_bottles.sc:48
    if (!r0) goto L_1c44;
    // tree_bottles.sc:49
    g2 = r9;  // @src tree_bottles.sc:49
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
  ...
  L_1ec4:
    ...
    if (!r5) goto L_208c;
    // tree_base.sci:165
    Call(r5, 0x2348);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_208c:
    ...
    if (!r5) goto L_20b8;
    // tree_base.sci:167
    Call(r5, 0x23b8);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_20c0;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_20b8:
    Call(r5, 0x2428);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_20c0:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 9368, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x27b4);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_2664:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_2664;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_27a0:
