...
onCreateLimfa()
{
    ...
    r2 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:114
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getView";
    GetDot(r0, 1);
    ...
    r4 = GetDotStr("rayTraceObj");  // @pool 0x2d  // @src scene_newgame.sc:117
    r5 = r2;
    r6 = r1;
    r7 = 100;
    r8 = 2147483647;
...
onSuckTree()
{
    ...
    r1 = GetDotStr("self");  // @pool 0x39  // @src scene_newgame.sc:125
    r1 = (str)r1;
    g2 = r7;
    r3 = "Sound";
    Call(r4, 0x03fc);
  ...
  L_0178:
    r2 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:129
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getView";
    GetDot(r0, 1);
    ...
    r4 = GetDotStr("rayTraceObj");  // @pool 0x2d  // @src scene_newgame.sc:132
    r5 = r2;
    r6 = r1;
    r7 = 100;
    r8 = 2147483647;
    ...
    r7 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:137
    SetDotRaw(r6, 72);
    Free1(r7);
    r7 = GetDotStr("self");  // @pool 0x39
    r8 = "limfa.pre";
    r9 = r2;
    r10 = r1;
    r11 = r4;
    ...
    r7 = GetDotStr("!vec3");  // @pool 0x6b  // @src scene_newgame.sc:138
    r9 = GetDotStr("rand");  // @pool 0x9b
    GetDot(r8, 0);
    Free1(r9);
    r10 = GetDotStr("rand");  // @pool 0x9b
    GetDot(r9, 0);
    Free1(r10);
    r11 = GetDotStr("rand");  // @pool 0x9b
    GetDot(r10, 0);
    Free1(r11);
    GetDot(r6, 3);
    Free4(r7, r8, r9, r10);
...
func_4()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:162
    r6 = GetDotStr("Globals");  // @pool 0xc8  // @src ..\sound.sci:162
    SetDotRaw(r5, 208);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0xdb  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
func_7()
{
    ...
    r2 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:158
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "getView";
    GetDot(r0, 1);
  ...
  L_0664:
    ...
    r8 = GetDotStr("rayTraceObj");  // @pool 0x2d  // @src scene_newgame.sc:167
    r9 = r6;
    r10 = r5;
    r11 = 100;
    r12 = 2147483647;
...
func_11()
{
    ...
    r0 = g10;
    // scene_newgame.sc:47
    r1 = GetDotStr("loadSound");  // @pool 0x13c  // @src scene_newgame.sc:47
    ...
    Free1(r0);
    // scene_newgame.sc:52
    r1 = GetDotStr("getLocatorTransform");  // @pool 0x168  // @src scene_newgame.sc:52
    r2 = "start";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    r1 = (str)r1;
    // scene_newgame.sc:54
    r4 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:54
    SetDotRaw(r3, 402);
    Free1(r4);
    r4 = "";
    GetDot(r2, 1);
    ...
    Free1(r2);
    // scene_newgame.sc:55
    r3 = GetDotStr("!lookAt");  // @pool 0x1a3  // @src scene_newgame.sc:55
    r4 = r1;
    r5 = r1;
    r7 = GetDotStr("!vec3");  // @pool 0x6b
    r8 = 1;
    r9 = -1;
    r10 = 0;
    GetDot(r6, 3);
    ...
    Free1(r3);
    // scene_newgame.sc:58
    r3 = GetDotStr("self");  // @pool 0x39  // @src scene_newgame.sc:58
    r3 = (str)r3;
    r4 = "newgame";
    r5 = "Music";
    ...
    Free1(r3);
    // scene_newgame.sc:61
    r3 = GetDotStr("createUIPlane");  // @pool 0x1c8  // @src scene_newgame.sc:61
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    r2 = g2;
    ...
    r6 = GetDotStr("self");  // @pool 0x39
    GetDot(r2, 3);
    Free5(r3, r4, r5, r6, r2);
    // scene_newgame.sc:65
    r3 = GetDotStr("!vector");  // @pool 0x205  // @src scene_newgame.sc:65
    GetDot(r2, 0);
    Free1(r3);
    r2 = (str)r2;
    r2 = g6;
  ...
  L_0e30:
    ...
    Free2(r6, r5);
    // scene_newgame.sc:95
    r6 = GetDotStr("isActionActive");  // @pool 0x230  // @src scene_newgame.sc:95
    r7 = "forward";
    GetDot(r5, 1);
    Free2(r6, r7);
    if (!r5) goto L_0ef0;
    ...
    // scene_newgame.sc:98
  L_0ef0:
    r6 = GetDotStr("isActionActive");  // @pool 0x230  // @src scene_newgame.sc:98
    r7 = "back";
    GetDot(r5, 1);
    Free2(r6, r7);
    if (!r5) goto L_0f64;
  ...
  L_0f64:
    r6 = GetDotStr("isActionActive");  // @pool 0x230  // @src scene_newgame.sc:101
    r7 = "left";
    GetDot(r5, 1);
    Free2(r6, r7);
    if (!r5) goto L_0fd8;
  ...
  L_0fd8:
    r6 = GetDotStr("isActionActive");  // @pool 0x230  // @src scene_newgame.sc:104
    r7 = "right";
    GetDot(r5, 1);
    Free2(r6, r7);
    if (!r5) goto L_104c;
  ...
  L_104c:
    r6 = GetDotStr("!lookAt");  // @pool 0x1a3  // @src scene_newgame.sc:108
    r7 = r1;
    r8 = r1;
    r10 = GetDotStr("!vec3");  // @pool 0x6b
    r11 = 1;
    r12 = -1;
    r13 = 0;
    GetDot(r9, 3);
...
render()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:251
    r6 = GetDotStr("Globals");  // @pool 0xc8  // @src ..\sound.sci:251
    SetDotRaw(r5, 208);
    Free1(r6);
    r6 = r_neg5;
    SetDot(r4, 1);
...
onInputAction()
{
    ...
    r1 = GetDotStr("findActor");  // @pool 0x27b  // @src scene_newgame.sc:203
    r2 = "animals";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
getActionPoints()
{
    ...
    r1 = GetDotStr("randMax");  // @pool 0x308  // @src scene_newgame.sc:217
    ...
    r4 = GetDotStr("World");  // @pool 0x0  // @src scene_newgame.sc:220
    SetDotRaw(r3, 803);
    Free1(r4);
    r4 = GetDotStr("self");  // @pool 0x39
    r5 = r_neg6;
    r6 = ".xml";
    r5 = r5 + r6;
    r7 = GetDotStr("!qtpair");  // @pool 0x334
    r9 = GetDotStr("!rotateY");  // @pool 0x33c
    r10 = r0;
    GetDot(r8, 1);
    Free1(r9);
    r9 = r1;
