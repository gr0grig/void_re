...
getTimeLeft()
{
    ...
    r1 = GetDotStr("changeNavMesh");  // @pool 0x3b  // @src truten_newgame.sc:135
    r2 = "truten";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // truten_newgame.sc:137
    r1 = GetDotStr("getNavHeightAt");  // @pool 0x49  // @src truten_newgame.sc:137
    r2 = GetDotStr("Position");  // @pool 0x58
    r4 = GetDotStr("!vec3");  // @pool 0x61
    r5 = 0;
    r6 = 0.5f;
    r7 = 0;
    GetDot(r3, 3);
    ...
    r2 = GetDotStr("logError");  // @pool 0x67  // @src truten_newgame.sc:139
  ...
  L_017c:
    r2 = GetDotStr("Position");  // @pool 0x58  // @src truten_newgame.sc:143
    SetDotRaw(r1, 152);
    Free1(r2);
    r3 = r0;
    r4 = 0;
    ...
    r2 = GetDotStr("putOnGrid");  // @pool 0x9a  // @src truten_newgame.sc:145
    GetDot(r1, 0);
    Free2(r2, r1);
    // truten_newgame.sc:146
    r1 = GetDotStr("Location");  // @pool 0xa4  // @src truten_newgame.sc:146
    if (!r1) goto L_0258;
    // truten_newgame.sc:147
    r2 = GetDotStr("Location");  // @pool 0xa4  // @src truten_newgame.sc:147
    SetDotRaw(r1, 173);
    Free1(r2);
    if (!r1) goto L_0250;
    // truten_newgame.sc:148
    r2 = GetDotStr("logInfo");  // @pool 0xb5  // @src truten_newgame.sc:148
  ...
  L_0258:
    r2 = GetDotStr("logInfo");  // @pool 0xb5  // @src truten_newgame.sc:153
...
func_3()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x119  // @src truten_newgame.sc:30
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g5;
    ...
    SetDotRaw(r1, 289);
    Free1(r2);
    r3 = GetDotStr("loadSound3D");  // @pool 0x125
    r4 = "truten_wander1";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
    ...
    r1 = GetDotStr("!vector");  // @pool 0x119  // @src truten_newgame.sc:37
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g6;
    ...
    r1 = GetDotStr("!vector");  // @pool 0x119  // @src truten_newgame.sc:41
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
...
func_7()
{
    ...
    r1 = GetDotStr("killTimer");  // @pool 0x262  // @src truten_newgame.sc:328
    r2 = 1;
    GetDot(r0, 1);
    Free2(r1, r0);
    ...
    r3 = GetDotStr("Position");  // @pool 0x58
    r2 = r2 - r3;
    r2 = (str)r2;
    Call(r3, 0x07f8);
    r2 = 0.25f;
    ...
    r2 = GetDotStr("stop");  // @pool 0x26c  // @src truten_newgame.sc:332
    r3 = true;
    GetDot(r1, 1);
    Free2(r2, r1);
    // truten_newgame.sc:333
    r2 = GetDotStr("clearSensor");  // @pool 0x271  // @src truten_newgame.sc:333
    GetDot(r1, 0);
    Free2(r2, r1);
  ...
  L_091c:
    ...
    r2 = GetDotStr("getLocationAt");  // @pool 0x27d  // @src truten_newgame.sc:342
    r3 = r0;
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    ...
    r4 = GetDotStr("findConstainedPath");  // @pool 0x28b  // @src truten_newgame.sc:345
    r5 = r1;
    r7 = r2;
    r8 = 0;
    SetDot(r6, 1);
    ...
    r5 = GetDotStr("stop");  // @pool 0x26c  // @src truten_newgame.sc:347
    r6 = true;
    GetDot(r4, 1);
    Free2(r5, r4);
    // truten_newgame.sc:348
    r5 = GetDotStr("clearSensor");  // @pool 0x271  // @src truten_newgame.sc:348
    GetDot(r4, 0);
    Free2(r5, r4);
...
func_9()
{
  ...
  L_0ae8:
    ...
    r3 = GetDotStr("getRandomPoint");  // @pool 0x29e  // @src truten_newgame.sc:431
    r5 = r1;
    r6 = 0;
    SetDot(r4, 1);
    r6 = r1;
    ...
    r4 = GetDotStr("findConstainedPath");  // @pool 0x28b  // @src truten_newgame.sc:432
    r5 = r2;
    r7 = r1;
    r8 = 0;
    SetDot(r6, 1);
    ...
    r4 = GetDotStr("logInfo");  // @pool 0xb5  // @src truten_newgame.sc:434
    ...
    r4 = GetDotStr("logInfo");  // @pool 0xb5  // @src truten_newgame.sc:435
    r7 = r2;
    SetDotRaw(r6, 88);
    Free1(r7);
    SetDotRaw(r5, 685);
  ...
  L_0cf0:
    ...
    r2 = GetDotStr("irandMax");  // @pool 0x2b5  // @src truten_newgame.sc:442
    r3 = 2;
    GetDot(r1, 1);
    Free1(r2);
    r2 = 0;
...
func_10()
{
    ...
    r1 = GetDotStr("addConeSector");  // @pool 0x2be  // @src truten_newgame.sc:283
    r3 = GetDotStr("!vec2");  // @pool 0x2cc
    r4 = 0;
    r5 = 1;
    GetDot(r2, 2);
    Free1(r3);
    ...
    r1 = GetDotStr("addConeSector");  // @pool 0x2be  // @src truten_newgame.sc:284
    r3 = GetDotStr("!vec2");  // @pool 0x2cc
    r4 = 0;
    r5 = -1;
    GetDot(r2, 2);
    ...
    r1 = GetDotStr("!vector");  // @pool 0x119  // @src truten_newgame.sc:285
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    CopyExtRd(r0, 0, 3);
    ...
    r1 = GetDotStr("setTimer");  // @pool 0x2d2  // @src truten_newgame.sc:286
    r2 = 1;
    r3 = 500000.0f;
    GetDot(r0, 2);
    Free2(r1, r0);
...
func_11()
{
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x2db  // @src truten_newgame.sc:60
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
...
func_12()
{
  ...
  L_0f78:
    ...
    r6 = GetDotStr("stop");  // @pool 0x26c  // @src truten_newgame.sc:94
    r7 = true;
    GetDot(r5, 1);
    Free2(r6, r5);
  ...
  L_1030:
    r6 = GetDotStr("updateTrajectory");  // @pool 0x2f5  // @src truten_newgame.sc:97
    GetDot(r5, 0);
    Free1(r6);
    r5 = (float)r5;
    r1 = r5;
  ...
  L_1094:
    r3 = GetDotStr("moveRoute");  // @pool 0x306  // @src truten_newgame.sc:102
    r4 = r0;
    GetDot(r2, 1);
    Free3(r3, r4, r2);
  ...
  L_10bc:
    r2 = GetDotStr("stop");  // @pool 0x26c  // @src truten_newgame.sc:105
    r3 = true;
    GetDot(r1, 1);
    Free2(r2, r1);
...
{
    // ../std.sci:389
    r1 = GetDotStr("getRotation");  // @pool 0x310  // @src ../std.sci:389
    GetDot(r0, 0);
    Free1(r1);
    r1 = GetDotStr("TrajectoryRotation");  // @pool 0x31c
    r0 = r0 + r1;
    r0 = (float)r0;
    // ../std.sci:390
    r2 = GetDotStr("moveRoute");  // @pool 0x306  // @src ../std.sci:390
    r3 = r_neg4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // ../std.sci:391
    r2 = GetDotStr("setRotation");  // @pool 0x32f  // @src ../std.sci:391
    r3 = r0;
    r4 = GetDotStr("TrajectoryRotation");  // @pool 0x31c
    r3 = r3 - r4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // ../std.sci:392
...
func_17()
{
    ...
    r1 = GetDotStr("setBoneTranslation");  // @pool 0x33b  // @src truten_newgame.sc:55
    r3 = GetDotStr("findBone");  // @pool 0x34e
    r4 = "";
    GetDot(r2, 1);
    Free2(r3, r4);
    r4 = GetDotStr("!vec3");  // @pool 0x61
...
func_19()
{
    ...
    r_neg5 = r1;
    // ../std.sci:257
    r2 = GetDotStr("getRotation");  // @pool 0x310  // @src ../std.sci:257
    GetDot(r1, 0);
    Free1(r2);
    r1 = (float)r1;
    // ../std.sci:258
  ...
  L_155c:
    ...
    // ../std.sci:276
  L_1578:
    r8 = GetDotStr("setRotation");  // @pool 0x32f  // @src ../std.sci:276
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:277
    goto L_1628;  // @src ../std.sci:277
    // ../std.sci:280
  L_15a0:
    ...
    r1 = r7;
    // ../std.sci:281
    r8 = GetDotStr("setRotation");  // @pool 0x32f  // @src ../std.sci:281
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:282
    ...
    r4 = r7;
    // ../std.sci:265
    goto L_147c;  // @src ../std.sci:265
    // ../std.sci:287
  L_1628:
    r6 = false;  // @src ../std.sci:287
    RetV(r5);
    Free2(r6, r5);
    goto L_1628;  // @src ../std.sci:287
}
...
func_20()
{
  ...
  L_164c:
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x357  // @src truten_newgame.sc:382
    r2 = "walk";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_21()
{
    ...
    r1 = GetDotStr("playAnimation");  // @pool 0x37a  // @src truten_newgame.sc:454
    r2 = "idle";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_22()
{
  ...
  L_181c:
    r1 = GetDotStr("Position");  // @pool 0x58  // @src truten_newgame.sc:226
    r1 = (str)r1;
    r3 = r_neg4;
    SetDotRaw(r2, 88);
    Free1(r3);
...
func_24()
{
  ...
  L_1924:
    ...
    r4 = GetDotStr("irandMax");  // @pool 0x2b5
    g6 = r7;
    SetDotRaw(r5, 537);
    Free1(r6);
    GetDot(r3, 1);
  ...
  L_19cc:
    r2 = GetDotStr("playAnimation");  // @pool 0x37a  // @src truten_newgame.sc:243
    r3 = "idle";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
...
func_25()
{
    ...
    r0 = r0 * r1;
    // ..\sound.sci:276
    r2 = GetDotStr("playSound3DLooped");  // @pool 0x3cd  // @src ..\sound.sci:276
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\sound.sci:277
    r6 = GetDotStr("Globals");  // @pool 0x3df  // @src ..\sound.sci:277
    SetDotRaw(r5, 999);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x3ee  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x40b  // @src ..\sound.sci:28
    SetDotRaw(r1, 928);
    Free1(r2);
...
func_30()
{
  ...
  L_1f40:
    r2 = GetDotStr("playAnimationInplace");  // @pool 0x357  // @src truten_newgame.sc:167
    r3 = "run";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
  ...
  L_1f88:
    ...
    r4 = GetDotStr("!tuple");  // @pool 0x2db  // @src truten_newgame.sc:174
    r5 = 0;
    GetDot(r3, 1);
    Free1(r4);
    RetV(r2);
...
getTimeLeft()
{
    ...
    r1 = GetDotStr("logInfo");  // @pool 0xb5  // @src truten_newgame.sc:322
    r2 = "rodent: tracking";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
