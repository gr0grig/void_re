...
{
    // main_newgame.sc:11
    r1 = GetDotStr("!table");  // @pool 0x0  // @src main_newgame.sc:11
    GetDot(r0, 0);
    Free1(r1);
    ...
    Free2(r1, r0);
    // main_newgame.sc:12
    r1 = GetDotStr("!vector");  // @pool 0x16  // @src main_newgame.sc:12
    GetDot(r0, 0);
    Free1(r1);
    ...
    Free2(r2, r0);
    // main_newgame.sc:13
    r1 = GetDotStr("!vector");  // @pool 0x16  // @src main_newgame.sc:13
    GetDot(r0, 0);
    Free1(r1);
    r2 = GetDotStr("Globals");  // @pool 0x7
    SetDotRaw(r1, 15);
    ...
    Free2(r2, r0);
    // main_newgame.sc:14
    r1 = GetDotStr("!vector");  // @pool 0x16  // @src main_newgame.sc:14
    GetDot(r0, 0);
    Free1(r1);
    r2 = GetDotStr("Globals");  // @pool 0x7
    SetDotRaw(r1, 15);
    ...
    Free2(r2, r0);
    // main_newgame.sc:16
    r1 = GetDotStr("createWorld");  // @pool 0x3c  // @src main_newgame.sc:16
    r2 = "test.xml";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // main_newgame.sc:18
    r1 = GetDotStr("!customLoop");  // @pool 0x58  // @src main_newgame.sc:18
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // main_newgame.sc:19
    r2 = GetDotStr("runScript");  // @pool 0x64  // @src main_newgame.sc:19
    r3 = "loading";
    GetDot(r1, 1);
    Free2(r2, r3);
    r1 = (str)r1;
    ...
    // main_newgame.sc:26
    r2 = GetDotStr("hasVariable");  // @pool 0xb7  // @src main_newgame.sc:26
    r3 = "post_effect";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_04a4;
    // main_newgame.sc:27
    r2 = GetDotStr("logInfo");  // @pool 0xd9  // @src main_newgame.sc:27
    r3 = "Post-effect enabled";
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // main_newgame.sc:28
    r2 = GetDotStr("splitString");  // @pool 0x107  // @src main_newgame.sc:28
    r4 = GetDotStr("getVariable");  // @pool 0x113
    r5 = "post_effect";
    GetDot(r3, 1);
    Free2(r4, r5);
    r3 = (as_string)r3;
    ...
    Free2(r3, r2);
    // main_newgame.sc:34
    r3 = GetDotStr("hasVariable");  // @pool 0xb7  // @src main_newgame.sc:34
    r4 = "post_effect_fp";
    GetDot(r2, 1);
    Free2(r3, r4);
    if (!r2) goto L_04a0;
    // main_newgame.sc:35
    r3 = GetDotStr("getVariable");  // @pool 0x113  // @src main_newgame.sc:35
    r4 = "post_effect_fp";
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
    ...
    if (!r3) goto L_049c;
    // main_newgame.sc:37
    r5 = GetDotStr("toBool");  // @pool 0x16b  // @src main_newgame.sc:37
    r6 = r2;
    r6 = (as_string)r6;
    GetDot(r4, 1);
    Free2(r5, r6);
  ...
  L_04a4:
    ...
    Free4(r2, r3, r4, r1);
    // main_newgame.sc:42
    r2 = GetDotStr("hasVariable");  // @pool 0xb7  // @src main_newgame.sc:42
    r3 = "Shadows";
    GetDot(r1, 1);
    Free2(r2, r3);
    if (!r1) goto L_0614;
    // main_newgame.sc:43
    r2 = GetDotStr("toInt");  // @pool 0x1b7  // @src main_newgame.sc:43
    r4 = GetDotStr("getVariable");  // @pool 0x113
    r5 = "Shadows";
    GetDot(r3, 1);
    Free2(r4, r5);
  ...
  L_0664:
    ...
    Free3(r4, r5, r3);
    // main_newgame.sc:59
    r4 = GetDotStr("setSoundListenerParameters");  // @pool 0x209  // @src main_newgame.sc:59
    r6 = r2;
    SetDotRaw(r5, 548);
    Free1(r6);
    r7 = r2;
...
func_3()
{
    ...
    Free3(r1, r2, r0);
    // main_newgame.sc:73
    r1 = GetDotStr("flushDebugRender");  // @pool 0x262  // @src main_newgame.sc:73
    CopyExtWr(r2, 2, 1);
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // main_newgame.sc:74
