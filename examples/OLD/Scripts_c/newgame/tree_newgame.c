...
{
    // tree_newgame.sc:64
    r1 = GetDotStr("findMaterial");  // @pool 0x0  // @src tree_newgame.sc:64
    r2 = "Sprout";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    ...
    Free1(r0);
    // tree_newgame.sc:68
    r1 = GetDotStr("!vec3");  // @pool 0x19  // @src tree_newgame.sc:68
    r3 = GetDotStr("rand");  // @pool 0x1f
    GetDot(r2, 0);
    Free1(r3);
    r4 = GetDotStr("rand");  // @pool 0x1f
    GetDot(r3, 0);
    Free1(r4);
    r5 = GetDotStr("rand");  // @pool 0x1f
    GetDot(r4, 0);
    Free1(r5);
    GetDot(r0, 3);
    Free4(r1, r2, r3, r4);
    ...
    Free1(r0);
    // tree_newgame.sc:70
    r1 = GetDotStr("setLocalGeomParameterBool");  // @pool 0x24  // @src tree_newgame.sc:70
    g2 = r6;
    r3 = "Enabled";
    r4 = false;
    GetDot(r0, 3);
...
func_2()
{
    ...
    Free1(r0);
    // tree_newgame.sc:27
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:27
    ...
    Free1(r0);
    // tree_newgame.sc:28
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:28
    ...
    Free1(r0);
    // tree_newgame.sc:30
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:30
    ...
    Free1(r0);
    // tree_newgame.sc:31
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:31
    ...
    Free1(r0);
    // tree_newgame.sc:32
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:32
    ...
    Free1(r0);
    // tree_newgame.sc:34
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:34
    ...
    Free1(r0);
    // tree_newgame.sc:35
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:35
    ...
    Free1(r0);
    // tree_newgame.sc:36
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:36
    ...
    Free1(r0);
    // tree_newgame.sc:38
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:38
    ...
    Free1(r0);
    // tree_newgame.sc:39
    r1 = GetDotStr("loadSound");  // @pool 0x4c  // @src tree_newgame.sc:39
...
{
    // tree_newgame.sc:123
    r1 = GetDotStr("Scene");  // @pool 0x298  // @src tree_newgame.sc:123
    r1 = (str)r1;
    g2 = r5;
    r3 = "Sound";
    Call(r4, 0x04a0);
...
func_5()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:162
    r6 = GetDotStr("Globals");  // @pool 0x2ed  // @src ..\sound.sci:162
    SetDotRaw(r5, 757);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x300  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
func_7()
{
    ...
    if (r0) goto L_0618;
    r1 = GetDotStr("randRange");  // @pool 0x31d
    r2 = 100.0f;
    r3 = 200.0f;
    GetDot(r0, 2);
    Free1(r1);
    goto L_0634;
  L_0618:
    r1 = GetDotStr("randMax");  // @pool 0x327
    r2 = 200.0f;
    GetDot(r0, 1);
    Free1(r1);
  L_0634:
    r0 = (float)r0;
    // tree_newgame.sc:88
    r2 = GetDotStr("setLocalGeomParameterBool");  // @pool 0x24  // @src tree_newgame.sc:88
    g3 = r6;
    r4 = "Enabled";
    r5 = false;
    GetDot(r1, 3);
    ...
    Call(r3, 0x0728);
    // tree_newgame.sc:105
    r2 = GetDotStr("irandRange");  // @pool 0x32f  // @src tree_newgame.sc:105
    r3 = 2;
    r4 = 10;
    GetDot(r1, 2);
    Free1(r2);
...
{
    // tree_newgame.sc:44
    r1 = GetDotStr("irandMax");  // @pool 0x33a  // @src tree_newgame.sc:44
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // tree_newgame.sc:45
    r2 = GetDotStr("Scene");  // @pool 0x298  // @src tree_newgame.sc:45
    r2 = (str)r2;
    g4 = r1;
    r5 = r0;
    SetDot(r3, 1);
...
{
    // tree_newgame.sc:50
    r1 = GetDotStr("irandMax");  // @pool 0x33a  // @src tree_newgame.sc:50
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // tree_newgame.sc:51
    r2 = GetDotStr("Scene");  // @pool 0x298  // @src tree_newgame.sc:51
    r2 = (str)r2;
    g4 = r2;
    r5 = r0;
    SetDot(r3, 1);
...
{
    // tree_newgame.sc:56
    r1 = GetDotStr("irandMax");  // @pool 0x33a  // @src tree_newgame.sc:56
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // tree_newgame.sc:57
    r2 = GetDotStr("Scene");  // @pool 0x298  // @src tree_newgame.sc:57
    r2 = (str)r2;
    g4 = r3;
    r5 = r0;
    SetDot(r3, 1);
...
func_12()
{
    ...
    r0 = r0 / r1;
    // tree_newgame.sc:133
    r2 = GetDotStr("setLocalGeomParameterBool");  // @pool 0x24  // @src tree_newgame.sc:133
    g3 = r6;
    r4 = "Enabled";
    r5 = true;
    GetDot(r1, 3);
    Free3(r2, r4, r1);
    // tree_newgame.sc:134
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x343  // @src tree_newgame.sc:134
    g3 = r6;
    r4 = "Color";
    g5 = r0;
    r6 = r0;
    ...
    Free4(r2, r4, r5, r1);
    // tree_newgame.sc:135
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x368  // @src tree_newgame.sc:135
    g3 = r6;
    r4 = "Threshold";
    r5 = 1;
    GetDot(r1, 3);
  ...
  L_09bc:
    ...
    r2 = r4;
    // tree_newgame.sc:143
    r5 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x368  // @src tree_newgame.sc:143
    g6 = r6;
    r7 = "Threshold";
    r8 = r2;
    GetDot(r4, 3);
...
{
    // tree_newgame.sc:166
    r1 = GetDotStr("Scene");  // @pool 0x298  // @src tree_newgame.sc:166
    r1 = (str)r1;
    g2 = r4;
    r3 = "Sound";
    Call(r4, 0x04a0);
...
func_17()
{
    ...
    r0 = r0 / r1;
    // tree_newgame.sc:177
    r2 = GetDotStr("setLocalGeomParameterBool");  // @pool 0x24  // @src tree_newgame.sc:177
    g3 = r6;
    r4 = "Enabled";
    r5 = true;
    GetDot(r1, 3);
    Free3(r2, r4, r1);
    // tree_newgame.sc:178
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x343  // @src tree_newgame.sc:178
    g3 = r6;
    r4 = "Color";
    g5 = r0;
    r6 = r0;
  ...
  L_0bf4:
    ...
    r2 = r4;
    // tree_newgame.sc:187
    r5 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x368  // @src tree_newgame.sc:187
    g6 = r6;
    r7 = "Threshold";
    r8 = r2;
    GetDot(r4, 3);
