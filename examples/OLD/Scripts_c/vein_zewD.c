...
func_1()
{
    ...
    r0 = 0xffffffff;  // @patch+4 vein_zewD.sc:13
    r0 = "朡潥敭牴䍹捡敨挀捡敨楒楧偤敲慦bmine...";  // len=327, pool_off=0x8, GARBLED  // @patch+4 vein_zewD.sc:7
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    Free1(r0);
    // vein_zewD.sc:8
    g2 = r9;  // @src vein_zewD.sc:8
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewD_part1.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewD.sc:9
    g2 = r9;  // @src vein_zewD.sc:9
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewD_part2.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewD.sc:10
    g2 = r9;  // @src vein_zewD.sc:10
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewD_part3.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewD.sc:11
    g2 = r9;  // @src vein_zewD.sc:11
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewD_part4.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewD.sc:12
    g2 = r9;  // @src vein_zewD.sc:12
    SetDotRaw(r1, 23);
    Free1(r2);
    r2 = "minewalls/minewall_zewD_part5.pre";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // vein_zewD.sc:13
    return r0;  // @src vein_zewD.sc:13
}
...
// vein_zewD.sc:34 (locals=6)
getVeinLimfaType()
{
    // vein_zewD.sc:32
    r1 = GetDotStr("findMaterial");  // @pool 0x1fd  // @src vein_zewD.sc:32
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewD.sc:33
    r2 = GetDotStr("setLocalGeomParameterColor");  // @pool 0x220  // @src vein_zewD.sc:33
    r3 = r0;
    r4 = "Color";
    r5 = r_neg4;
    GetDot(r1, 3);
    Free4(r2, r4, r5, r1);
    // vein_zewD.sc:34
    Free1(r_neg4);  // @src vein_zewD.sc:34
    return r0;
}
...
// vein_zewD.sc:41 (locals=9)
func_14()
{
    // vein_zewD.sc:39
    r1 = GetDotStr("findMaterial");  // @pool 0x1fd  // @src vein_zewD.sc:39
    r2 = "Material #4";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (int)r0;
    // vein_zewD.sc:40
    r2 = GetDotStr("setLocalGeomParameterFloat");  // @pool 0x292  // @src vein_zewD.sc:40
    r3 = r0;
    r4 = "Threshold";
    r6 = 1;
    r7 = r_neg4;
...
// vein_zewD.sc:28 (locals=7)
func_23()
{
    // vein_zewD.sc:17
    r0 = null_str2;  // @src vein_zewD.sc:17
    // vein_zewD.sc:18
    r3 = GetDotStr("World");  // @pool 0x1b7  // @src vein_zewD.sc:18
    SetDotRaw(r2, 768);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x172
    r4 = "minewalls/minewall_zewD_part1.pre";
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:20
    r3 = GetDotStr("World");  // @pool 0x1b7  // @src vein_zewD.sc:20
    SetDotRaw(r2, 768);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x172
    r4 = "minewalls/minewall_zewD_part2.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2e1
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:22
    r3 = GetDotStr("World");  // @pool 0x1b7  // @src vein_zewD.sc:22
    SetDotRaw(r2, 768);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x172
    r4 = "minewalls/minewall_zewD_part3.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2e1
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:24
    r3 = GetDotStr("World");  // @pool 0x1b7  // @src vein_zewD.sc:24
    SetDotRaw(r2, 768);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x172
    r4 = "minewalls/minewall_zewD_part4.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2e1
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:26
    r3 = GetDotStr("World");  // @pool 0x1b7  // @src vein_zewD.sc:26
    SetDotRaw(r2, 768);
    Free1(r3);
    r3 = GetDotStr("Scene");  // @pool 0x172
    r4 = "minewalls/minewall_zewD_part5.pre";
    r5 = GetDotStr("Transform");  // @pool 0x2e1
    r6 = "vein_part";
    GetDot(r1, 4);
    Free5(r2, r3, r4, r5, r6);
    ...
    Free4(r2, r3, r4, r1);
    // vein_zewD.sc:28
    Free2(r0, r_neg4);  // @src vein_zewD.sc:28
    return r0;
}
