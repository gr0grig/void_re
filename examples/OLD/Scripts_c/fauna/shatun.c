...
// @old_version
// @version: 0
// @globals: 23 types=02 01 01 01 01 02 01 03 03 03 03 03 03 03 03 03 03 03 03 03 01 01 00
// @func_table: 12 groups offsets=48,556,1094,1701,2270,2809,3375,3940,4545,5196,5840,6490
...
//   export "getFaunaHP" args=0 cb=-1 {func_83}
//   export "getMaxFaunaHP" args=0 cb=-1 {func_84}
//   export "setFaunaHealth" args=1 cb=-1 {func_85} types=[int]
//   export "damageFauna" args=2 cb=-1 {func_14} types=[int,int]
//   export "isFaunaDead" args=0 cb=-1 {func_15}
//   export "isLymphaDamageAccepted" args=0 cb=-1 {func_86}
//   export "hasJibs" args=0 cb=-1 {func_87}
//   export "isUshanEnemy" args=0 cb=-1 {func_88}
//   export "isLassoAttached" args=0 cb=-1 {func_89}
//   export "getLassoLimfaType" args=0 cb=-1 {func_90}
//   export "getLassoLimfaAmount" args=0 cb=-1 {func_91}
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
...
//   export "isMineAttractor" args=0 cb=-1 {func_33}
...
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
// @ft_group 7: parent=0 stack=1 locals=1 types=[str] vtable=[{func_69}] imports=[(3,0),(7,0)]
...
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
// @ft_group 8: parent=0 stack=11 locals=11 types=[bool,str,str,float,bool,str,float,str,str,str,str] vtable=[{func_41}] imports=[(9,0),(8,8)]
//   export "onStop" args=2 cb=-1 {func_42} types=[bool,str]
//   export "onStop" args=1 cb=-1 {func_43} types=[str]
//   export "onResetStop" args=0 cb=-1 {func_44}
//   export "onTrack" args=2 cb=-1 {func_45} types=[str,float]
//   export "setSpeed" args=1 cb=-1 {func_46} types=[float]
//   export "getFaunaProps" args=0 cb=-1 {func_3}
//   export "initFaunaHealth" args=0 cb=-1 {func_2}
//   export "initFaunaHealth" args=1 cb=-1 {func_5} types=[int]
//   export "getFaunaHP" args=0 cb=-1 {func_83}
...
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
// @ft_group 9: parent=0 stack=8 locals=8 types=[bool,str,str,float,bool,str,float,str] vtable=[{func_47}] imports=[(9,0)]
//   export "onStop" args=2 cb=-1 {func_42} types=[bool,str]
//   export "onStop" args=1 cb=-1 {func_43} types=[str]
//   export "onResetStop" args=0 cb=-1 {func_44}
//   export "onTrack" args=2 cb=-1 {func_45} types=[str,float]
...
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
// @ft_group 10: parent=0 stack=10 locals=10 types=[bool,str,str,float,bool,str,float,str,str,str] vtable=[{func_72}] imports=[(9,0),(10,8)]
//   export "onStop" args=2 cb=-1 {func_42} types=[bool,str]
//   export "onStop" args=1 cb=-1 {func_43} types=[str]
//   export "onResetStop" args=0 cb=-1 {func_44}
//   export "onTrack" args=2 cb=-1 {func_45} types=[str,float]
...
//   export "attachLasso" args=2 cb=-1 {func_92} types=[int,int]
//   export "isLassoTarget" args=0 cb=-1 {func_95}
// @ft_group 11: parent=0 stack=9 locals=9 types=[bool,str,str,float,bool,str,float,str,str] vtable=[{func_76}] imports=[(9,0),(11,8)]
//   export "onStop" args=2 cb=-1 {func_42} types=[bool,str]
//   export "onStop" args=1 cb=-1 {func_43} types=[str]
//   export "onResetStop" args=0 cb=-1 {func_44}
//   export "onTrack" args=2 cb=-1 {func_45} types=[str,float]
...
// #export {func_33} name="isMineAttractor"
// #export {func_34} name="onDamage"
// #export {func_42} name="onStop"
// #export {func_43} name="onStop"
// #export {func_44} name="onResetStop"
// #export {func_45} name="onTrack"
// #export {func_46} name="setSpeed"
...
// #export {func_83} name="getFaunaHP"
// #export {func_84} name="getMaxFaunaHP"
// #export {func_85} name="setFaunaHealth"
// #export {func_86} name="isLymphaDamageAccepted"
// #export {func_87} name="hasJibs"
// #export {func_88} name="isUshanEnemy"
// #export {func_89} name="isLassoAttached"
// #export {func_90} name="getLassoLimfaType"
// #export {func_91} name="getLassoLimfaAmount"
// #export {func_92} name="attachLasso"
// #export {func_95} name="isLassoTarget"
...
getFaunaProps()
{
    ...
    r0 = g5;
    // shatun_base.sci:309
    r1 = GetDotStr("changeNavMesh");  // @pool 0x44  // @src shatun_base.sci:309
    r2 = "shatun";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // shatun_base.sci:311
    r1 = GetDotStr("getNavHeightAt");  // @pool 0x52  // @src shatun_base.sci:311
    ...
    if (r1) goto L_0270;
    // shatun_base.sci:313
    r2 = GetDotStr("logError");  // @pool 0x70  // @src shatun_base.sci:313
    ...
    // shatun_base.sci:317
  L_0270:
    r2 = GetDotStr("Position");  // @pool 0x61  // @src shatun_base.sci:317
    SetDotRaw(r1, 161);
    Free1(r2);
    r3 = r0;
    r4 = 0;
    ...
    Free2(r2, r1);
    // shatun_base.sci:319
    r2 = GetDotStr("putOnGrid");  // @pool 0xa3  // @src shatun_base.sci:319
    GetDot(r1, 0);
    Free2(r2, r1);
    // shatun_base.sci:320
    r1 = GetDotStr("Location");  // @pool 0xad  // @src shatun_base.sci:320
    if (!r1) goto L_0374;
    // shatun_base.sci:321
    r2 = GetDotStr("Location");  // @pool 0xad  // @src shatun_base.sci:321
    SetDotRaw(r1, 182);
    Free1(r2);
    if (!r1) goto L_036c;
    // shatun_base.sci:322
    r2 = GetDotStr("logInfo");  // @pool 0xbe  // @src shatun_base.sci:322
    r3 = "shatun on blocked polygon";
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // shatun_base.sci:323
    r2 = GetDotStr("remove");  // @pool 0xf8  // @src shatun_base.sci:323
    GetDot(r1, 0);
    Free2(r2, r1);
    // shatun_base.sci:324
  ...
  L_036c:
    ...
    // shatun_base.sci:328
  L_0374:
    r2 = GetDotStr("logInfo");  // @pool 0xbe  // @src shatun_base.sci:328
    r3 = "shatun is not on grid";
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // shatun_base.sci:329
    r2 = GetDotStr("remove");  // @pool 0xf8  // @src shatun_base.sci:329
    GetDot(r1, 0);
    Free2(r2, r1);
    // shatun_base.sci:330
  ...
  L_03c8:
    ...
    Free1(r1);
    // shatun_base.sci:337
    r2 = GetDotStr("logInfo");  // @pool 0xbe  // @src shatun_base.sci:337
    r3 = "shatun - inited";
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // shatun_base.sci:338
...
{
    // shatun_base.sci:35
    r1 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:35
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    ...
    SetDotRaw(r1, 357);
    Free1(r2);
    r3 = GetDotStr("loadSound3D");  // @pool 0x169
    r4 = "shatun_wander1_1";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
    ...
    Free3(r1, r2, r0);
    // shatun_base.sci:40
    r1 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:40
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
    ...
    Free3(r1, r2, r0);
    // shatun_base.sci:45
    r1 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:45
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g9;
    ...
    Free3(r1, r2, r0);
    // shatun_base.sci:49
    r1 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:49
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g10;
    ...
    Free3(r1, r2, r0);
    // shatun_base.sci:53
    r1 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:53
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g11;
    ...
    Free3(r1, r2, r0);
    // shatun_base.sci:58
    r1 = GetDotStr("loadSound3D");  // @pool 0x169  // @src shatun_base.sci:58
    r2 = "shatun_attack";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // shatun_base.sci:60
    r1 = GetDotStr("loadSound3D");  // @pool 0x169  // @src shatun_base.sci:60
    ...
    Free1(r0);
    // shatun_base.sci:61
    r1 = GetDotStr("loadSound3D");  // @pool 0x169  // @src shatun_base.sci:61
    r2 = "shatun_push_end";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // shatun_base.sci:62
    r1 = GetDotStr("loadSound3D");  // @pool 0x169  // @src shatun_base.sci:62
    r2 = "shatun_search";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // shatun_base.sci:63
    r1 = GetDotStr("loadSound3D");  // @pool 0x169  // @src shatun_base.sci:63
    r2 = "shatun_turn";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // shatun_base.sci:110
    r1 = GetDotStr("!spline");  // @pool 0x36f  // @src shatun_base.sci:110
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // shatun_base.sci:111
    r2 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:111
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // shatun_base.sci:113
  ...
  L_0ad4:
    ...
    if (!r4) goto L_0c18;
    // shatun_base.sci:120
    r5 = GetDotStr("!bezier3D");  // @pool 0x37d  // @src shatun_base.sci:120
    r7 = r1;
    r8 = r3;
    SetDot(r6, 1);
    r8 = r2;
...
func_11()
{
    ...
    r0 = (int)r0;
    // ../spline.sci:8
    r2 = GetDotStr("!vector");  // @pool 0x15d  // @src ../spline.sci:8
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // ../spline.sci:10
...
func_17()
{
    ...
    Call(r1, 0x1478);
    // shatun_base.sci:716
    r1 = GetDotStr("!ragdoll");  // @pool 0x3c9  // @src shatun_base.sci:716
    r2 = "shatun.rd";
    r3 = 0;
    GetDot(r0, 2);
    Free2(r1, r2);
  ...
  L_12a8:
    ...
    if (!r2) goto L_1308;
    // shatun_base.sci:724
    r3 = GetDotStr("renderDebug");  // @pool 0x3e4  // @src shatun_base.sci:724
    r4 = GetDotStr("LightingBox");  // @pool 0x3f0
  ...
  L_13a4:
    ...
    if (!r2) goto L_1404;
    // shatun_base.sci:734
    r3 = GetDotStr("renderDebug");  // @pool 0x3e4  // @src shatun_base.sci:734
    r4 = GetDotStr("LightingBox");  // @pool 0x3f0
    r6 = GetDotStr("!vec3");  // @pool 0x6a
    r7 = 1;
    r8 = 0;
  ...
  L_1404:
    ...
    r3 = 2000000.0f;
    r2 = r2 / r3;
    CallMethod(r2, 1020, 0x10a);  // @patch+8 shatun_base.sci:736
    ...
    // shatun_base.sci:739
  L_1458:
    r3 = GetDotStr("remove");  // @pool 0xf8  // @src shatun_base.sci:739
    GetDot(r2, 0);
    Free2(r3, r2);
    // shatun_base.sci:740
...
{
    // shatun_base.sci:186
    r2 = GetDotStr("Scene");  // @pool 0x40d  // @src shatun_base.sci:186
    SetDotRaw(r1, 1043);
    Free1(r2);
...
{
    // ../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x4ad  // @src ../std.sci:210
    r2 = 0;
    ...
    r0 = (float)r0;
    // ../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x4ad  // @src ../std.sci:211
    r3 = 0;
...
{
    // ../std.sci:141
    r1 = GetDotStr("hasVariable");  // @pool 0x4b7  // @src ../std.sci:141
    r2 = "show_debug";
    GetDot(r0, 1);
    Free2(r1, r2);
    if (!r0) goto L_183c;
    // ../std.sci:142
    r1 = GetDotStr("toBool");  // @pool 0x4d7  // @src ../std.sci:142
    r3 = GetDotStr("getVariable");  // @pool 0x4de
    r4 = "show_debug";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
...
getFaunaProps()
{
    ...
    if (!r0) goto L_19b4;
    // shatun_base.sci:355
    r1 = GetDotStr("clearSensor");  // @pool 0x504  // @src shatun_base.sci:355
    GetDot(r0, 0);
    Free2(r1, r0);
    // shatun_base.sci:356
...
// shatun_base.sci:365 (locals=2)
getFaunaProps()
{
    // shatun_base.sci:362
    r0 = r_neg5;  // @src shatun_base.sci:362
    r1 = r_neg4;
    Call(r2, 0x113c);
    // shatun_base.sci:363
    Call(r1, 0x1190);  // @src shatun_base.sci:363
    if (!r0) goto L_1a58;
    // shatun_base.sci:364
...
func_26()
{
  ...
  L_1a64:
    ...
    // shatun_base.sci:415
  L_1a70:
    r2 = GetDotStr("getRandomPoint");  // @pool 0x547  // @src shatun_base.sci:415
    r3 = 0;
    r4 = 0;
    GetDot(r1, 2);
    Free1(r2);
    r1 = (str)r1;
    // shatun_base.sci:416
    r3 = GetDotStr("findPath");  // @pool 0x556  // @src shatun_base.sci:416
    r4 = r1;
    GetDot(r2, 1);
    Free2(r3, r4);
    r2 = (str)r2;
    ...
    if (r2) goto L_1c18;
    // shatun_base.sci:418
    r3 = GetDotStr("logInfo");  // @pool 0xbe  // @src shatun_base.sci:418
    r5 = GetDotStr("Position");  // @pool 0x61
    SetDotRaw(r4, 1018);
    Free1(r5);
    r4 = (as_string)r4;
    r5 = ", ";
    ...
    Free3(r3, r4, r2);
    // shatun_base.sci:419
    r3 = GetDotStr("logInfo");  // @pool 0xbe  // @src shatun_base.sci:419
    r6 = r1;
    SetDotRaw(r5, 97);
    Free1(r6);
    SetDotRaw(r4, 1018);
  ...
  L_1c80:
    ...
    r2 = (str)r2;
    // shatun_base.sci:437
    r4 = GetDotStr("stop");  // @pool 0x57b  // @src shatun_base.sci:437
    r5 = true;
    GetDot(r3, 1);
    Free2(r4, r3);
    // shatun_base.sci:439
...
{
    // shatun_base.sci:349
    r1 = GetDotStr("addConeSector");  // @pool 0x580  // @src shatun_base.sci:349
    r3 = GetDotStr("!vec2");  // @pool 0x58e
    r4 = 0;
    r5 = 1;
    GetDot(r2, 2);
    Free1(r3);
...
{
    // shatun_base.sci:276
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src shatun_base.sci:276
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_1fc0:
    ...
    // shatun_base.sci:288
  L_1ff0:
    r3 = GetDotStr("updateTrajectory");  // @pool 0x5a9  // @src shatun_base.sci:288
    GetDot(r2, 0);
    Free2(r3, r2);
    // shatun_base.sci:281
...
func_29()
{
    ...
    if (!r0) goto L_209c;
    // shatun_base.sci:234
    r1 = GetDotStr("Position");  // @pool 0x61  // @src shatun_base.sci:234
    r1 = (str)r1;
    r3 = r_neg5;
    SetDotRaw(r2, 97);
    Free1(r3);
...
func_31()
{
    ...
    r_neg5 = r1;
    // ../std.sci:257
    r2 = GetDotStr("getRotation");  // @pool 0x5ba  // @src ../std.sci:257
    GetDot(r1, 0);
    Free1(r2);
    r1 = (float)r1;
    // ../std.sci:258
  ...
  L_2308:
    ...
    // ../std.sci:276
  L_2324:
    r8 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:276
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:277
  ...
  L_234c:
    ...
    r1 = r7;
    // ../std.sci:281
    r8 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:281
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:282
...
func_35()
{
    ...
    if (!r3) goto L_2714;
    // shatun_base.sci:501
    r3 = GetDotStr("Position");  // @pool 0x61  // @src shatun_base.sci:501
    r5 = r_neg5;
    SetDotRaw(r4, 97);
    Free1(r5);
    r3 = r3 - r4;
    ...
    if (!r5) goto L_2708;
    // shatun_base.sci:504
    r6 = GetDotStr("stop");  // @pool 0x57b  // @src shatun_base.sci:504
    r7 = true;
    GetDot(r5, 1);
    Free2(r6, r5);
    // shatun_base.sci:505
...
func_36()
{
  ...
  L_2834:
    ...
    r5 = GetDotStr("irandMax");  // @pool 0x5e8
    g7 = r10;
    SetDotRaw(r6, 887);
    Free1(r7);
    GetDot(r4, 1);
...
{
    // ..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x40d  // @src ..\sound.sci:28
    SetDotRaw(r1, 1043);
    Free1(r2);
...
func_38()
{
    ...
    r0 = r0 * r1;
    // ..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x631  // @src ..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0x63d  // @src ..\sound.sci:260
    SetDotRaw(r5, 1605);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x64c  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
func_41()
{
    ...
    if (!r0) goto L_2bf4;
    // ../std.sci:693
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:693
    CopyExtWr(r2, 2, 8);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_2bf4:
    ...
    if (!r0) goto L_2c48;
    // ../std.sci:696
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:696
    CopyExtWr(r0, 2, 8);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    // ../std.sci:698
  L_2c48:
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:698
    CopyExtWr(r1, 2, 8);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
// ../std.sci:707 (locals=3)
func_48()
{
    // ../std.sci:703
    r0 = r_neg7;  // @src ../std.sci:703
    CopyExtRd(r0, 0, 8);
    Free1(r0);
    // ../std.sci:704
...
func_49()
{
  ...
  L_2fcc:
    ...
    if (!r1) goto L_3028;
    // ../std.sci:557
    r3 = GetDotStr("!tuple");  // @pool 0x66f  // @src ../std.sci:557
    r4 = r_neg6;
    r5 = 2;
    CopyExtWr(r1, 6, 9);
    r7 = r0;
  ...
  L_3028:
    ...
    // ../std.sci:562
  L_3030:
    r4 = GetDotStr("!tuple");  // @pool 0x66f  // @src ../std.sci:562
    r5 = r_neg6;
    r6 = r1;
    r7 = null_str;
    r8 = r0;
  ...
  L_30e0:
    ...
    if (!r3) goto L_3118;
    // ../std.sci:571
    r4 = GetDotStr("move");  // @pool 0xfa  // @src ../std.sci:571
    r5 = GetDotStr("MoveDistance");  // @pool 0x676
    r5 = Neg(r5);
    GetDot(r3, 1);
    Free3(r4, r5, r3);
    // ../std.sci:574
...
{
    // ../std.sci:533
    r1 = GetDotStr("Position");  // @pool 0x61  // @src ../std.sci:533
    r1 = (str)r1;
    r3 = r_neg5;
    SetDotRaw(r2, 97);
    Free1(r3);
...
func_52()
{
    ...
    r_neg5 = r1;
    // ../std.sci:296
    r2 = GetDotStr("getRotation");  // @pool 0x5ba  // @src ../std.sci:296
    GetDot(r1, 0);
    Free1(r2);
    r2 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r1 = r1 + r2;
    r1 = (float)r1;
    // ../std.sci:297
  ...
  L_3458:
    ...
    // ../std.sci:315
  L_3474:
    r8 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:315
    r9 = r1;
    r10 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r9 = r9 - r10;
    GetDot(r7, 1);
    Free3(r8, r9, r7);
    // ../std.sci:316
  ...
  L_34a8:
    ...
    r1 = r7;
    // ../std.sci:320
    r8 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:320
    r9 = r1;
    r10 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r9 = r9 - r10;
    GetDot(r7, 1);
...
func_54()
{
  ...
  L_35e4:
    ...
    r2 = (int)r2;
    // ../follow.sci:24
    r4 = GetDotStr("getRotation");  // @pool 0x5ba  // @src ../follow.sci:24
    GetDot(r3, 0);
    Free1(r4);
    r4 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r3 = r3 + r4;
    r3 = (float)r3;
    // ../follow.sci:27
  L_3614:
    ...
    if (!r5) goto L_3710;
    // ../follow.sci:29
    r6 = GetDotStr("findPath");  // @pool 0x556  // @src ../follow.sci:29
    r8 = r4;
    SetDotRaw(r7, 173);
    Free1(r8);
    GetDot(r5, 1);
    ...
    Free2(r6, r5);
    // ../follow.sci:32
    r6 = GetDotStr("moveRoute");  // @pool 0x6b6  // @src ../follow.sci:32
    r7 = r1;
    GetDot(r5, 1);
    Free3(r6, r7, r5);
    // ../follow.sci:35
  ...
  L_3724:
    ...
    r9 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r9 = (float)r9;
    g10 = r0;
    r12 = r2;
    Call(r13, 0x23f0);
    ...
    Free1(r8);
    // ../follow.sci:43
    r9 = GetDotStr("updateTrajectory");  // @pool 0x5a9  // @src ../follow.sci:43
    GetDot(r8, 0);
    Free1(r9);
    r8 = (float)r8;
    r6 = r8;
  ...
  L_3874:
    ...
    // ../follow.sci:62
  L_38c4:
    r8 = GetDotStr("moveRoute");  // @pool 0x6b6  // @src ../follow.sci:62
    r9 = r1;
    GetDot(r7, 1);
    Free3(r8, r9, r7);
    // ../follow.sci:37
...
func_56()
{
  ...
  L_3a90:
    ...
    // ../std.sci:383
  L_3aac:
    r6 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:383
    r7 = r_neg6;
    r8 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r7 = r7 - r8;
    GetDot(r5, 1);
    Free3(r6, r7, r5);
    // ../std.sci:384
...
func_57()
{
    ...
    // shatun_base.sci:218
    r1 = GetDotStr("Position");  // @pool 0x61  // @src shatun_base.sci:218
    r3 = r0;
    SetDotRaw(r2, 97);
    Free1(r3);
    r1 = r1 - r2;
...
{
    // shatun_base.sci:546
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src shatun_base.sci:546
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_3dec:
    ...
    r1 = (str)r1;
    // shatun_base.sci:564
    r3 = GetDotStr("irandMax");  // @pool 0x5e8  // @src shatun_base.sci:564
    r4 = 7;
    GetDot(r2, 1);
    Free1(r3);
    r2 = (int)r2;
    // shatun_base.sci:565
    r4 = GetDotStr("irandRange");  // @pool 0x6d0  // @src shatun_base.sci:565
    r7 = r1;
    SetDotRaw(r6, 1755);
    Free1(r7);
    SetDotRaw(r5, 11);
    ...
    Free1(r6);
    r6 = "onDamage";
    r7 = GetDotStr("self");  // @pool 0x702
    r8 = r2;
    r9 = r3;
    GetDot(r4, 4);
    Free4(r5, r6, r7, r4);
    // shatun_base.sci:567
    r5 = GetDotStr("playAnimation");  // @pool 0x707  // @src shatun_base.sci:567
    r6 = "attack";
    GetDot(r4, 1);
    Free2(r5, r6);
    r4 = (str)r4;
  ...
  L_40bc:
    ...
    // shatun_base.sci:585
  L_40e0:
    r1 = GetDotStr("playAnimation");  // @pool 0x707  // @src shatun_base.sci:585
    r2 = "push_begin";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_4250:
    ...
    Free3(r1, r3, r0);
    // shatun_base.sci:605
    r1 = GetDotStr("irandMax");  // @pool 0x5e8  // @src shatun_base.sci:605
    r2 = 7;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // shatun_base.sci:606
    r2 = GetDotStr("irandRange");  // @pool 0x6d0  // @src shatun_base.sci:606
    r3 = 500;
    r4 = 10000;
    GetDot(r1, 2);
    Free1(r2);
    ...
    Free1(r4);
    r4 = "onDamage";
    r5 = GetDotStr("self");  // @pool 0x702
    r6 = r0;
    r7 = r1;
    GetDot(r2, 4);
    Free4(r3, r4, r5, r2);
    // shatun_base.sci:611
    r1 = GetDotStr("playAnimation");  // @pool 0x707  // @src shatun_base.sci:611
    r2 = "push_end";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_62()
{
    ...
    // shatun_base.sci:206
    r1 = GetDotStr("Position");  // @pool 0x61  // @src shatun_base.sci:206
    r3 = r0;
    SetDotRaw(r2, 97);
    Free1(r3);
    r1 = r1 - r2;
...
func_63()
{
    ...
    r4 = GetDotStr("irandMax");  // @pool 0x5e8
    g6 = r11;
    SetDotRaw(r5, 887);
    Free1(r6);
    GetDot(r3, 1);
...
{
    // shatun_base.sci:241
    r1 = GetDotStr("playAnimation");  // @pool 0x707  // @src shatun_base.sci:241
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // ../std.sci:1031
    r1 = GetDotStr("playAnimation");  // @pool 0x707  // @src ../std.sci:1031
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_72()
{
    ...
    if (!r0) goto L_4c2c;
    // ../std.sci:674
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:674
    CopyExtWr(r1, 2, 10);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    // ../std.sci:676
  L_4c2c:
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:676
    CopyExtWr(r0, 2, 10);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // ../std.sci:623
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x594  // @src ../std.sci:623
    CopyExtWr(r0, 2, 11);
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_79()
{
  ...
  L_4f04:
    ...
    if (!r2) goto L_4f78;
    // ../std.sci:749
    r3 = GetDotStr("stop");  // @pool 0x57b  // @src ../std.sci:749
    r4 = true;
    GetDot(r2, 1);
    Free2(r3, r2);
    // ../std.sci:750
  ...
  L_5008:
    ...
    if (!r5) goto L_5080;
    // ../std.sci:759
    r6 = GetDotStr("stop");  // @pool 0x57b  // @src ../std.sci:759
    r7 = true;
    GetDot(r5, 1);
    Free2(r6, r5);
    // ../std.sci:760
  ...
  L_5128:
    ...
    if (!r5) goto L_51a0;
    // ../std.sci:773
    r6 = GetDotStr("stop");  // @pool 0x57b  // @src ../std.sci:773
    r7 = true;
    GetDot(r5, 1);
    Free2(r6, r5);
    // ../std.sci:774
  ...
  L_5244:
    ...
    if (!r6) goto L_52bc;
    // ../std.sci:788
    r7 = GetDotStr("stop");  // @pool 0x57b  // @src ../std.sci:788
    r8 = true;
    GetDot(r6, 1);
    Free2(r7, r6);
    // ../std.sci:789
    ...
    // ../std.sci:791
  L_52bc:
    r7 = GetDotStr("updateTrajectory");  // @pool 0x5a9  // @src ../std.sci:791
    GetDot(r6, 0);
    Free1(r7);
    r6 = (float)r6;
    r3 = r6;
    ...
    // ../std.sci:796
  L_5320:
    r5 = GetDotStr("moveRoute");  // @pool 0x6b6  // @src ../std.sci:796
    r6 = r0;
    GetDot(r4, 1);
    Free3(r5, r6, r4);
    // ../std.sci:781
    ...
    // ../std.sci:799
  L_5348:
    r4 = GetDotStr("stop");  // @pool 0x57b  // @src ../std.sci:799
    r5 = true;
    GetDot(r3, 1);
    Free2(r4, r3);
    // ../std.sci:800
...
{
    // ../std.sci:389
    r1 = GetDotStr("getRotation");  // @pool 0x5ba  // @src ../std.sci:389
    GetDot(r0, 0);
    Free1(r1);
    r1 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r0 = r0 + r1;
    r0 = (float)r0;
    // ../std.sci:390
    r2 = GetDotStr("moveRoute");  // @pool 0x6b6  // @src ../std.sci:390
    r3 = r_neg4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // ../std.sci:391
    r2 = GetDotStr("setRotation");  // @pool 0x5c6  // @src ../std.sci:391
    r3 = r0;
    r4 = GetDotStr("TrajectoryRotation");  // @pool 0x683
    r3 = r3 - r4;
    GetDot(r1, 1);
...
func_82()
{
    ...
    CallMethod(r0, 1908, 0x1);  // @patch+8 shatun_base.sci:297
    LoadFalse(r0);
    CallMethod(r0, 1920, 0x147);  // @patch+8 shatun_base.sci:299
    RawDword(0x00000791);  // UNKNOWN opcode 0x91
    r2 = "anim/shatun.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // shatun_base.sci:300
...
func_94()
{
    ...
    // shatun_base.sci:80
    r2 = GetDotStr("!vector");  // @pool 0x15d  // @src shatun_base.sci:80
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g19;
  ...
  L_5900:
    ...
    if (!r3) goto L_5978;
    // shatun_base.sci:86
    r4 = GetDotStr("makeAttachPoint");  // @pool 0x859  // @src shatun_base.sci:86
    r5 = "loc_lasso0";
    r6 = r1;
    r7 = 1;
    r6 = r6 + r7;
    ...
    // shatun_base.sci:89
  L_5978:
    r4 = GetDotStr("makeAttachPoint");  // @pool 0x859  // @src shatun_base.sci:89
    r5 = "loc_lasso";
    r6 = r1;
    r7 = 1;
    r6 = r6 + r7;
