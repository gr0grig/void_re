...
// mushroom1.sc:7 (locals=3)
func_1()
{
    // mushroom1.sc:5
    r1 = GetDotStr("loadAnimationSet");  // @pool 0x0  // @src mushroom1.sc:5
    r2 = "anim/mushroom1.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // mushroom1.sc:6
    CallNat(r1, 5308, 0x0);  // @src mushroom1.sc:6
}
