...
{
    // rodent_base.sci:51
    CallNat(r1, 11456, 0x0);  // @src rodent_base.sci:51
}
...
func_17()
{
  ...
  L_140c:
    ...
    if (!r1) goto L_146c;
    // rodent_base.sci:263
    CallNat(r8, 7764, 0x100);  // @src rodent_base.sci:263
    // rodent_base.sci:246
  L_146c:
...
func_22()
{
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x36b  // @src rodent_branches.sc:13
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
  ...
  L_1778:
    r1 = GetDotStr("!tuple");  // @pool 0x36b  // @src rodent_branches.sc:15
    r2 = 3;
    r3 = 3;
    GetDot(r0, 2);
    Free1(r1);
...
func_23()
{
    ...
    RawDword(0x000018ec);  // UNKNOWN opcode 0xec
    // ../std.sci:859
...
func_27()
{
  ...
  L_1b84:
    ...
    r4 = r7;
    // ../std.sci:265
    goto L_1a60;  // @src ../std.sci:265
    // ../std.sci:287
  L_1c0c:
    r6 = false;  // @src ../std.sci:287
    RetV(r5);
    Free2(r6, r5);
    goto L_1c0c;  // @src ../std.sci:287
}
...
func_30()
{
  ...
  L_1e04:
    ...
    if (r2) goto L_1e40;
    // rodent_base.sci:228
    goto L_1e48;  // @src rodent_base.sci:228
    // rodent_base.sci:225
  L_1e40:
    goto L_1e04;  // @src rodent_base.sci:225
    // rodent_base.sci:220
  L_1e48:
...
func_31()
{
  ...
  L_1fa8:
    ...
    if (r2) goto L_1fe0;
    // rodent_base.sci:492
    goto L_1fe8;  // @src rodent_base.sci:492
    // rodent_base.sci:489
  L_1fe0:
    goto L_1fa8;  // @src rodent_base.sci:489
    // rodent_base.sci:495
  L_1fe8:
...
func_33()
{
  ...
  L_22bc:
    ...
    if (r4) goto L_232c;
    // rodent_base.sci:420
    goto L_2334;  // @src rodent_base.sci:420
    // rodent_base.sci:408
  L_232c:
    goto L_21e0;  // @src rodent_base.sci:408
    // rodent_base.sci:404
  L_2334:
...
func_36()
{
  ...
  L_2410:
    ...
    Free2(r2, r1);
    // rodent_base.sci:346
    goto L_24b8;  // @src rodent_base.sci:346
    // rodent_base.sci:348
  L_2474:
    ...
    if (r2) goto L_24b0;
    // rodent_base.sci:350
    goto L_24b8;  // @src rodent_base.sci:350
    // rodent_base.sci:343
  L_24b0:
    goto L_2410;  // @src rodent_base.sci:343
    // rodent_base.sci:339
  L_24b8:
...
onSectorEnter()
{
    ...
    CallNat2(r10, 9856, 0x1);
    // rodent_base.sci:193
    goto L_2678;  // @src rodent_base.sci:193
    // rodent_base.sci:199
  L_25f0:
    ...
    Call(r2, 0x0818);
    // rodent_base.sci:200
    goto L_2678;  // @src rodent_base.sci:200
    // rodent_base.sci:204
  L_2668:
...
onStartUsing()
{
  ...
  L_2838:
    ...
    if (r5) goto L_2870;
    // rodent_base.sci:288
    goto L_2878;  // @src rodent_base.sci:288
    // rodent_base.sci:285
  L_2870:
    goto L_2838;  // @src rodent_base.sci:285
    // rodent_base.sci:291
  L_2878:
    r4 = r_neg4;  // @src rodent_base.sci:291
    CallNat(r11, 10616, 0x401);
}
...
func_41()
{
  ...
  L_2aa4:
    ...
    Free2(r2, r1);
    // rodent_base.sci:309
    CallNat(r12, 10968, 0x100);  // @src rodent_base.sci:309
    // rodent_base.sci:304
  L_2ad0:
    goto L_2a30;  // @src rodent_base.sci:304
}
...
func_42()
{
  ...
  L_2bcc:
    ...
    if (r2) goto L_2c04;
    // rodent_base.sci:330
    goto L_2c0c;  // @src rodent_base.sci:330
    // rodent_base.sci:327
  L_2c04:
    goto L_2bcc;  // @src rodent_base.sci:327
    // rodent_base.sci:333
  L_2c0c:
...
onBranchesDestroy()
{
    ...
    Free3(r1, r2, r0);
    // rodent_base.sci:62
    Call(r0, 0x2d08);  // @src rodent_base.sci:62
    // rodent_base.sci:63
...
func_47()
{
    ...
    r1 = GetDotStr("Location");  // @pool 0x75  // @src rodent_branches.sc:22
    SetDotRaw(r0, 1546);
    Free1(r1);
    r0 = (int)r0;
    // rodent_branches.sc:24
    r2 = GetDotStr("stop");  // @pool 0x20f  // @src rodent_branches.sc:24
    r3 = true;
    GetDot(r1, 1);
    Free2(r2, r1);
    ...
    CallNat2(r5, 2780, 0x101);
    // rodent_branches.sc:26
    goto L_2db8;  // @src rodent_branches.sc:26
    // rodent_branches.sc:30
  L_2dac:
    CallNat2(r2, 4332, 0x100);  // @src rodent_branches.sc:30
