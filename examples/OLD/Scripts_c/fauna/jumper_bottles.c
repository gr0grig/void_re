...
getFaunaProps()
{
    ...
    r0 = g5;
    // jumper_base.sci:296
    r1 = GetDotStr("changeNavMesh");  // @pool 0x54  // @src jumper_base.sci:296
    r2 = "jumper";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // jumper_base.sci:298
    r1 = GetDotStr("getNavHeightAt");  // @pool 0x62  // @src jumper_base.sci:298
    r2 = GetDotStr("Position");  // @pool 0x71
    r4 = GetDotStr("!vec3");  // @pool 0x7a
    r5 = 0;
    r6 = 0.5f;
    r7 = 0;
    GetDot(r3, 3);
    ...
    if (r1) goto L_0270;
    // jumper_base.sci:300
    r2 = GetDotStr("logError");  // @pool 0x80  // @src jumper_base.sci:300
    ...
    // jumper_base.sci:304
  L_0270:
    r2 = GetDotStr("Position");  // @pool 0x71  // @src jumper_base.sci:304
    SetDotRaw(r1, 177);
    Free1(r2);
    r3 = r0;
    r4 = 0;
    ...
    Free2(r2, r1);
    // jumper_base.sci:306
    r2 = GetDotStr("putOnGrid");  // @pool 0xb3  // @src jumper_base.sci:306
    GetDot(r1, 0);
    Free2(r2, r1);
    // jumper_base.sci:308
    r1 = GetDotStr("Location");  // @pool 0xbd  // @src jumper_base.sci:308
    if (!r1) goto L_035c;
    // jumper_base.sci:309
    r2 = GetDotStr("Location");  // @pool 0xbd  // @src jumper_base.sci:309
    SetDotRaw(r1, 198);
    Free1(r2);
    if (!r1) goto L_0354;
    // jumper_base.sci:310
    r2 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:310
  ...
  L_0354:
    ...
    // jumper_base.sci:315
  L_035c:
    r2 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:315
...
{
    // jumper_base.sci:33
    r1 = GetDotStr("!vector");  // @pool 0x132  // @src jumper_base.sci:33
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g7;
    ...
    SetDotRaw(r1, 314);
    Free1(r2);
    r3 = GetDotStr("loadSound3D");  // @pool 0x13e
    r4 = "jumper_attack1_1";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
    ...
    Free3(r1, r2, r0);
    // jumper_base.sci:37
    r1 = GetDotStr("!vector");  // @pool 0x132  // @src jumper_base.sci:37
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    r0 = g8;
    ...
    Free3(r1, r2, r0);
    // jumper_base.sci:41
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:41
    r2 = "jumper_scream";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // jumper_base.sci:42
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:42
    ...
    Free1(r0);
    // jumper_base.sci:43
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:43
    ...
    Free1(r0);
    // jumper_base.sci:45
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:45
    r2 = "jumper_run_begin";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    Free1(r0);
    // jumper_base.sci:46
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:46
    r2 = "jumper_run";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    ...
    g74 = r0;
    // jumper_base.sci:49
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:49
    r2 = "jumper_jump1_1";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
    ...
    Free1(r0);
    // jumper_base.sci:50
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:50
    r2 = "jumper_jump1_2";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
    ...
    Free1(r0);
    // jumper_base.sci:51
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:51
    r2 = "jumper_jump2_1";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
    ...
    Free1(r0);
    // jumper_base.sci:52
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:52
    r2 = "jumper_jump2_2";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
    ...
    Free1(r0);
    // jumper_base.sci:53
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:53
    r2 = "jumper_jump3_1";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
    ...
    Free1(r0);
    // jumper_base.sci:54
    r1 = GetDotStr("loadSound3D");  // @pool 0x13e  // @src jumper_base.sci:54
    r2 = "jumper_jump3_2";
    GetDot(r0, 1);
    Free2(r1, r2);
    g1 = r14;
...
getFaunaProps()
{
    ...
    if (!r0) goto L_0880;
    // jumper_base.sci:336
    r1 = GetDotStr("stop");  // @pool 0x2f6  // @src jumper_base.sci:336
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // jumper_base.sci:337
    r1 = GetDotStr("clearSensor");  // @pool 0x2fb  // @src jumper_base.sci:337
    GetDot(r0, 0);
    Free2(r1, r0);
    // jumper_base.sci:338
...
func_10()
{
    ...
    Call(r2, 0x1390);
    // jumper_base.sci:446
    r1 = GetDotStr("irandMax");  // @pool 0x345  // @src jumper_base.sci:446
    r2 = 4;
    GetDot(r0, 1);
    Free1(r1);
    r1 = 1;
  ...
  L_0a0c:
    ...
    if (!r4) goto L_0af4;
    // jumper_base.sci:455
    r5 = GetDotStr("stop");  // @pool 0x2f6  // @src jumper_base.sci:455
    r6 = true;
    GetDot(r4, 1);
    Free2(r5, r4);
    // jumper_base.sci:456
    g5 = r9;  // @src jumper_base.sci:456
    r7 = GetDotStr("!vec3");  // @pool 0x7a
    r8 = 0;
    r9 = 0;
    r10 = 0;
    GetDot(r6, 3);
  ...
  L_0afc:
    ...
    if (!r4) goto L_0bc4;
    // jumper_base.sci:463
    r5 = GetDotStr("stop");  // @pool 0x2f6  // @src jumper_base.sci:463
    r6 = true;
    GetDot(r4, 1);
    Free2(r5, r4);
    // jumper_base.sci:464
  ...
  L_0bc4:
    ...
    if (!r4) goto L_0c08;
    // jumper_base.sci:471
    r5 = GetDotStr("stop");  // @pool 0x2f6  // @src jumper_base.sci:471
    r6 = true;
    GetDot(r4, 1);
    Free2(r5, r4);
    // jumper_base.sci:472
  ...
  L_0c08:
    ...
    // jumper_base.sci:480
  L_0c44:
    r5 = GetDotStr("irandMax");  // @pool 0x345  // @src jumper_base.sci:480
    r6 = 2;
    GetDot(r4, 1);
    Free1(r5);
    r5 = 1;
    ...
    r5 = (str)r5;
    // jumper_base.sci:483
    r7 = GetDotStr("irandMax");  // @pool 0x345  // @src jumper_base.sci:483
    r8 = 7;
    GetDot(r6, 1);
    Free1(r7);
    r6 = (int)r6;
    // jumper_base.sci:484
    r8 = GetDotStr("irandRange");  // @pool 0x36c  // @src jumper_base.sci:484
    r11 = r5;
    SetDotRaw(r10, 887);
    Free1(r11);
    SetDotRaw(r9, 11);
    ...
    r12 = GetDotStr("irandMax");  // @pool 0x345
    g14 = r7;
    SetDotRaw(r13, 910);
    Free1(r14);
    GetDot(r11, 1);
    ...
    Call(r10, 0x1390);
    // jumper_base.sci:489
    r10 = GetDotStr("self");  // @pool 0x3ae  // @src jumper_base.sci:489
    r10 = (str)r10;
    Call(r11, 0x32b0);
    r10 = 0;
    SetDot(r8, 1);
  ...
  L_0ee8:
    ...
    Call(r10, 0x1390);
    // jumper_base.sci:496
    r10 = GetDotStr("self");  // @pool 0x3ae  // @src jumper_base.sci:496
    r10 = (str)r10;
    Call(r11, 0x32b0);
    r10 = 0;
    SetDot(r8, 1);
  ...
  L_1050:
    ...
    Call(r10, 0x1390);
    // jumper_base.sci:498
    r10 = GetDotStr("self");  // @pool 0x3ae  // @src jumper_base.sci:498
    r10 = (str)r10;
    Call(r11, 0x32b0);
    r10 = 0;
    SetDot(r8, 1);
  ...
  L_1108:
    ...
    // jumper_base.sci:502
  L_1124:
    r9 = GetDotStr("irandMax");  // @pool 0x345  // @src jumper_base.sci:502
    r10 = 3;
    GetDot(r8, 1);
    Free1(r9);
    r9 = 0;
...
{
    // ..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x42c  // @src ..\sound.sci:28
    SetDotRaw(r1, 947);
    Free1(r2);
...
func_12()
{
    ...
    r0 = r0 * r1;
    // ..\sound.sci:259
    r2 = GetDotStr("playSound3D");  // @pool 0x468  // @src ..\sound.sci:259
    r3 = r_neg8;
    r4 = r_neg7;
    r5 = r_neg6;
    r6 = r_neg5;
    ...
    r1 = (str)r1;
    // ..\sound.sci:260
    r6 = GetDotStr("Globals");  // @pool 0x474  // @src ..\sound.sci:260
    SetDotRaw(r5, 1148);
    Free1(r6);
    r6 = r_neg4;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x483  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // jumper_base.sci:210
    r1 = GetDotStr("playAnimation");  // @pool 0x4a0  // @src jumper_base.sci:210
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // jumper_base.sci:203
    r1 = GetDotStr("Position");  // @pool 0x71  // @src jumper_base.sci:203
    r1 = (str)r1;
    r3 = r_neg5;
    SetDotRaw(r2, 113);
    Free1(r3);
...
func_17()
{
    ...
    r_neg5 = r1;
    // ../std.sci:257
    r2 = GetDotStr("getRotation");  // @pool 0x4b0  // @src ../std.sci:257
    GetDot(r1, 0);
    Free1(r2);
    r1 = (float)r1;
    // ../std.sci:258
  ...
  L_1774:
    ...
    // ../std.sci:276
  L_1790:
    r8 = GetDotStr("setRotation");  // @pool 0x4bc  // @src ../std.sci:276
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:277
  ...
  L_17b8:
    ...
    r1 = r7;
    // ../std.sci:281
    r8 = GetDotStr("setRotation");  // @pool 0x4bc  // @src ../std.sci:281
    r9 = r1;
    GetDot(r7, 1);
    Free2(r8, r7);
    // ../std.sci:282
...
{
    // jumper_base.sci:390
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x4d6  // @src jumper_base.sci:390
    r2 = "run_begin";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_24()
{
    ...
    SetDotRaw(r1, 1259);
    Free1(r2);
    r2 = GetDotStr("NavMesh");  // @pool 0x5a
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
    // jumper_base.sci:367
...
{
    // jumper_base.sci:372
    r1 = GetDotStr("playAnimationInplace");  // @pool 0x4d6  // @src jumper_base.sci:372
    r2 = r_neg4;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_28()
{
  ...
  L_1e10:
    ...
    r2 = (int)r2;
    // ../follow.sci:24
    r4 = GetDotStr("getRotation");  // @pool 0x4b0  // @src ../follow.sci:24
    GetDot(r3, 0);
    Free1(r4);
    r4 = GetDotStr("TrajectoryRotation");  // @pool 0x4f8
    r3 = r3 + r4;
    r3 = (float)r3;
    // ../follow.sci:27
  L_1e40:
    ...
    SetDotRaw(r5, 1259);
    Free1(r6);
    r6 = GetDotStr("NavMesh");  // @pool 0x5a
    GetDot(r4, 1);
    Free2(r5, r6);
    r4 = (str)r4;
    // ../follow.sci:28
    ...
    if (!r5) goto L_1f3c;
    // ../follow.sci:29
    r6 = GetDotStr("findPath");  // @pool 0x50b  // @src ../follow.sci:29
    r8 = r4;
    SetDotRaw(r7, 189);
    Free1(r8);
    GetDot(r5, 1);
    ...
    Free2(r6, r5);
    // ../follow.sci:32
    r6 = GetDotStr("moveRoute");  // @pool 0x527  // @src ../follow.sci:32
    r7 = r1;
    GetDot(r5, 1);
    Free3(r6, r7, r5);
    // ../follow.sci:35
  ...
  L_1f50:
    ...
    r9 = GetDotStr("TrajectoryRotation");  // @pool 0x4f8
    r9 = (float)r9;
    g10 = r0;
    r12 = r2;
    Call(r13, 0x185c);
    ...
    Free1(r8);
    // ../follow.sci:43
    r9 = GetDotStr("updateTrajectory");  // @pool 0x531  // @src ../follow.sci:43
    GetDot(r8, 0);
    Free1(r9);
    r8 = (float)r8;
    r6 = r8;
  ...
  L_20a0:
    ...
    // ../follow.sci:62
  L_20f0:
    r8 = GetDotStr("moveRoute");  // @pool 0x527  // @src ../follow.sci:62
    r9 = r1;
    GetDot(r7, 1);
    Free3(r8, r9, r7);
    // ../follow.sci:37
...
func_30()
{
  ...
  L_22bc:
    ...
    // ../std.sci:383
  L_22d8:
    r6 = GetDotStr("setRotation");  // @pool 0x4bc  // @src ../std.sci:383
    r7 = r_neg6;
    r8 = GetDotStr("TrajectoryRotation");  // @pool 0x4f8
    r7 = r7 - r8;
    GetDot(r5, 1);
    Free3(r6, r7, r5);
    // ../std.sci:384
...
func_31()
{
    ...
    // jumper_base.sci:594
  L_234c:
    r2 = GetDotStr("Scene");  // @pool 0x42c  // @src jumper_base.sci:594
    SetDotRaw(r1, 1346);
    Free1(r2);
    r2 = "animals";
    GetDot(r0, 1);
    ...
    if (r1) goto L_23c0;
    // jumper_base.sci:596
    r2 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:596
  ...
  L_2454:
    ...
    if (!r2) goto L_24e0;
    // jumper_base.sci:608
    r3 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:608
    r4 = "Warning: Animal locators doesn't containe jumper group, can't teleport";
    GetDot(r2, 1);
    Free3(r3, r4, r2);
    // jumper_base.sci:609
    r2 = 0;  // @src jumper_base.sci:609
    CallMethod(r2, 1676, 0x23f);  // @patch+8 jumper_base.sci:610
    ...
    r3 = (str)r3;
    // jumper_base.sci:619
    r5 = GetDotStr("setPosition");  // @pool 0x6c1  // @src jumper_base.sci:619
    r6 = r3;
    GetDot(r4, 1);
    Free3(r5, r6, r4);
    // jumper_base.sci:620
    r5 = GetDotStr("putOnGrid");  // @pool 0xb3  // @src jumper_base.sci:620
    GetDot(r4, 0);
    Free1(r5);
    r5 = false;
    r4 = r4 == r5;
    if (!r4) goto L_25c8;
    // jumper_base.sci:621
    r5 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:621
    ...
    // jumper_base.sci:625
  L_25c8:
    r5 = GetDotStr("Location");  // @pool 0xbd  // @src jumper_base.sci:625
    SetDotRaw(r4, 198);
    Free1(r5);
    if (!r4) goto L_2614;
    // jumper_base.sci:626
    r5 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:626
...
{
    // jumper_base.sci:567
    r1 = GetDotStr("playAnimation");  // @pool 0x4a0  // @src jumper_base.sci:567
    r2 = "idle";
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
func_33()
{
  ...
  L_27d4:
    ...
    // jumper_base.sci:547
    r3 = GetDotStr("getRandomPoint");  // @pool 0x787  // @src jumper_base.sci:547
    r5 = r1;
    r6 = 0;
    SetDot(r4, 1);
    r6 = r1;
    ...
    r2 = (str)r2;
    // jumper_base.sci:548
    r4 = GetDotStr("findConstainedPath");  // @pool 0x796  // @src jumper_base.sci:548
    r5 = r2;
    r7 = r1;
    r8 = 0;
    SetDot(r6, 1);
    ...
    if (r3) goto L_29dc;
    // jumper_base.sci:550
    r4 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:550
    r6 = GetDotStr("Position");  // @pool 0x71
    SetDotRaw(r5, 844);
    Free1(r6);
    r5 = (as_string)r5;
    r6 = ", ";
    r5 = r5 + r6;
    r7 = GetDotStr("Position");  // @pool 0x71
    SetDotRaw(r6, 177);
    Free1(r7);
    r6 = (as_string)r6;
    r5 = r5 + r6;
    ...
    Free3(r4, r5, r3);
    // jumper_base.sci:551
    r4 = GetDotStr("logInfo");  // @pool 0xce  // @src jumper_base.sci:551
    r7 = r2;
    SetDotRaw(r6, 113);
    Free1(r7);
    SetDotRaw(r5, 844);
...
{
    // jumper_base.sci:330
    r1 = GetDotStr("addConeSector");  // @pool 0x7a9  // @src jumper_base.sci:330
    r3 = GetDotStr("!vec2");  // @pool 0x7b7
    r4 = 0;
    r5 = 1;
    GetDot(r2, 2);
    Free1(r3);
...
func_35()
{
    ...
    r1 = GetDotStr("!tuple");  // @pool 0x7bd  // @src jumper_bottles.sc:14
    r2 = 0;
    r3 = 0;
    GetDot(r0, 2);
    Free1(r1);
...
{
    // ../std.sci:389
    r1 = GetDotStr("getRotation");  // @pool 0x4b0  // @src ../std.sci:389
    GetDot(r0, 0);
    Free1(r1);
    r1 = GetDotStr("TrajectoryRotation");  // @pool 0x4f8
    r0 = r0 + r1;
    r0 = (float)r0;
    // ../std.sci:390
    r2 = GetDotStr("moveRoute");  // @pool 0x527  // @src ../std.sci:390
    r3 = r_neg4;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // ../std.sci:391
    r2 = GetDotStr("setRotation");  // @pool 0x4bc  // @src ../std.sci:391
    r3 = r0;
    r4 = GetDotStr("TrajectoryRotation");  // @pool 0x4f8
    r3 = r3 - r4;
    GetDot(r1, 1);
...
func_39()
{
  ...
  L_2ce0:
    ...
    if (!r3) goto L_2d5c;
    // ../std.sci:870
    r4 = GetDotStr("stop");  // @pool 0x2f6  // @src ../std.sci:870
    r5 = true;
    GetDot(r3, 1);
    Free2(r4, r3);
    // ../std.sci:871
    ...
    // ../std.sci:873
  L_2d5c:
    r4 = GetDotStr("updateTrajectory");  // @pool 0x531  // @src ../std.sci:873
    GetDot(r3, 0);
    Free1(r4);
    r3 = (float)r3;
    r0 = r3;
    ...
    // ../std.sci:878
  L_2dc0:
    r2 = GetDotStr("moveRoute");  // @pool 0x527  // @src ../std.sci:878
    r3 = r_neg5;
    GetDot(r1, 1);
    Free3(r2, r3, r1);
    // ../std.sci:864
    ...
    // ../std.sci:881
  L_2de8:
    r1 = GetDotStr("stop");  // @pool 0x2f6  // @src ../std.sci:881
    r2 = true;
    GetDot(r0, 1);
    Free2(r1, r0);
    // ../std.sci:882
...
func_40()
{
    // jumper_base.sci:515
  L_2e28:
    r1 = GetDotStr("irandMax");  // @pool 0x345  // @src jumper_base.sci:515
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
    // jumper_base.sci:516
    r2 = GetDotStr("playAnimationInplace");  // @pool 0x4d6  // @src jumper_base.sci:516
    r3 = "jump";
    r4 = r0;
    r5 = 1;
    r4 = r4 + r5;
  ...
  L_2ed4:
    ...
    r5 = r0;
    r7 = GetDotStr("irandMax");  // @pool 0x345
    r8 = 2;
    GetDot(r6, 1);
    Free1(r7);
    SetDot(r3, 2);
...
{
    // ../std.sci:1031
    r1 = GetDotStr("playAnimation");  // @pool 0x4a0  // @src ../std.sci:1031
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
...
{
    // jumper_base.sci:248
    r1 = GetDotStr("playAnimation");  // @pool 0x4a0  // @src jumper_base.sci:248
    r2 = r_neg5;
    GetDot(r0, 1);
    Free2(r1, r2);
    r0 = (str)r0;
  ...
  L_31ac:
    ...
    r4 = (float)r4;
    r3 = r3 / r4;
    CallMethod(r3, 1676, 0x44);  // @patch+8 jumper_base.sci:265
  ...
  L_321c:
    ...
    r4 = r4 / r5;
    r3 = r3 - r4;
    CallMethod(r3, 1676, 0x44);  // @patch+8 jumper_base.sci:255
    ...
    CallMethod(r2, 1676, 0x44);  // @patch+8 jumper_base.sci:271
    RawDword(0x000032a4);  // UNKNOWN opcode 0xa4
    // jumper_base.sci:274
    r2 = 0;  // @src jumper_base.sci:274
    CallMethod(r2, 1676, 0x4b);  // @patch+8 jumper_base.sci:275
...
func_44()
{
  ...
  L_32e0:
    ...
    // ../std.sci:1076
  L_3310:
    r2 = GetDotStr("!tuple");  // @pool 0x7bd  // @src ../std.sci:1076
    r5 = r_neg4;
    SetDotRaw(r4, 113);
    Free1(r5);
    r6 = r0;
...
func_45()
{
    ...
    CallMethod(r0, 2001, 0x1);  // @patch+8 jumper_base.sci:282
    r0 = "桓摡睯䙳摡䉥来湩氀慯䅤楮慭楴湯敓tani...";  // len=73, pool_off=0x7dd, GARBLED
    // jumper_base.sci:284
    r1 = GetDotStr("loadAnimationSet");  // @pool 0x7ee  // @src jumper_base.sci:284
    r2 = "anim/jumper.ase";
    GetDot(r0, 1);
    Free3(r1, r2, r0);
    // jumper_base.sci:286
...
func_61()
{
    ...
    // jumper_base.sci:65
    r2 = GetDotStr("!vector");  // @pool 0x132  // @src jumper_base.sci:65
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    r1 = g18;
  ...
  L_381c:
    ...
    if (!r3) goto L_3894;
    // jumper_base.sci:71
    r4 = GetDotStr("makeAttachPoint");  // @pool 0x8cd  // @src jumper_base.sci:71
    r5 = "loc_lasso_0";
    r6 = r1;
    r7 = 1;
    r6 = r6 + r7;
    ...
    // jumper_base.sci:74
  L_3894:
    r4 = GetDotStr("makeAttachPoint");  // @pool 0x8cd  // @src jumper_base.sci:74
    r5 = "loc_lasso_";
    r6 = r1;
    r7 = 1;
    r6 = r6 + r7;
...
{
    // jumper_base.sci:95
    r1 = GetDotStr("!spline");  // @pool 0x8f3  // @src jumper_base.sci:95
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // jumper_base.sci:96
    r2 = GetDotStr("!vector");  // @pool 0x132  // @src jumper_base.sci:96
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // jumper_base.sci:98
  ...
  L_3ad8:
    ...
    if (!r4) goto L_3c1c;
    // jumper_base.sci:105
    r5 = GetDotStr("!bezier3D");  // @pool 0x8fb  // @src jumper_base.sci:105
    r7 = r1;
    r8 = r3;
    SetDot(r6, 1);
    r8 = r2;
...
func_64()
{
    ...
    r0 = (int)r0;
    // ../spline.sci:8
    r2 = GetDotStr("!vector");  // @pool 0x132  // @src ../spline.sci:8
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // ../spline.sci:10
...
{
    // jumper_base.sci:166
    r0 = GetDotStr("Position");  // @pool 0x71  // @src jumper_base.sci:166
    r2 = GetDotStr("!vec3");  // @pool 0x7a
    r3 = 0;
    r4 = 1;
    r5 = 0;
    GetDot(r1, 3);
...
{
    // jumper_base.sci:176
    r1 = GetDotStr("!vec3");  // @pool 0x7a  // @src jumper_base.sci:176
    r2 = 0;
    r3 = 1.5f;
    r4 = 0;
    GetDot(r0, 3);
...
getFaunaProps()
{
    ...
    Call(r1, 0x4554);
    // jumper_base.sci:654
    r1 = GetDotStr("!ragdoll");  // @pool 0x93a  // @src jumper_base.sci:654
    r2 = "jumper.rd";
    r3 = 0;
    GetDot(r0, 2);
    Free2(r1, r2);
  ...
  L_42dc:
    ...
    if (!r3) goto L_4398;
    // jumper_base.sci:665
    r4 = GetDotStr("renderDebug");  // @pool 0x955  // @src jumper_base.sci:665
    r5 = GetDotStr("LightingBox");  // @pool 0x961
    r7 = GetDotStr("!vec3");  // @pool 0x7a
    r8 = 1;
    r9 = 0;
    r10 = 0;
  ...
  L_43e0:
    ...
    if (!r2) goto L_445c;
    // jumper_base.sci:674
    r3 = GetDotStr("renderDebug");  // @pool 0x955  // @src jumper_base.sci:674
    r4 = GetDotStr("LightingBox");  // @pool 0x961
    r6 = GetDotStr("!vec3");  // @pool 0x7a
    r7 = 1;
    r8 = 0;
    r9 = 0;
    GetDot(r5, 3);
  ...
  L_445c:
    ...
    r3 = 2000000.0f;
    r2 = r2 / r3;
    CallMethod(r2, 1676, 0x34a);  // @patch+8 jumper_base.sci:677
    RetV(r2);
    r2 = (int)r2;
    // jumper_base.sci:678
  ...
  L_4500:
    ...
    // jumper_base.sci:689
  L_4534:
    r3 = GetDotStr("remove");  // @pool 0x96d  // @src jumper_base.sci:689
    GetDot(r2, 0);
    Free2(r3, r2);
    // jumper_base.sci:690
...
{
    // jumper_base.sci:229
    r2 = GetDotStr("Scene");  // @pool 0x42c  // @src jumper_base.sci:229
    SetDotRaw(r1, 947);
    Free1(r2);
  ...
  L_4688:
    ...
    SetDotRaw(r3, 2480);
    Free1(r4);
    r4 = GetDotStr("Scene");  // @pool 0x42c
    r5 = "limfa.pre";
    r6 = GetDotStr("Position");  // @pool 0x71
    r8 = GetDotStr("!vec3");  // @pool 0x7a
    r9 = 0;
    r10 = 1;
    r11 = 0;
    GetDot(r7, 3);
...
{
    // ../std.sci:210
    r1 = GetDotStr("randRange");  // @pool 0x36d  // @src ../std.sci:210
    r2 = 0;
    r3 = 1.5707963705062866f;
    GetDot(r0, 2);
    Free1(r1);
    r0 = (float)r0;
    // ../std.sci:211
    r2 = GetDotStr("randRange");  // @pool 0x36d  // @src ../std.sci:211
    r3 = 0;
    ...
    r1 = (float)r1;
    // ../std.sci:212
    r3 = GetDotStr("!vec3");  // @pool 0x7a  // @src ../std.sci:212
    r4 = r0;
    r4 = Cos(r4);
    r5 = r1;
    r5 = Sin(r5);
...
{
    // ../std.sci:141
    r1 = GetDotStr("hasVariable");  // @pool 0xa09  // @src ../std.sci:141
    r2 = "show_debug";
    GetDot(r0, 1);
    Free2(r1, r2);
    if (!r0) goto L_4918;
    // ../std.sci:142
    r1 = GetDotStr("toBool");  // @pool 0xa29  // @src ../std.sci:142
    r3 = GetDotStr("getVariable");  // @pool 0xa30
    r4 = "show_debug";
    GetDot(r2, 1);
    Free2(r3, r4);
    GetDot(r0, 1);
