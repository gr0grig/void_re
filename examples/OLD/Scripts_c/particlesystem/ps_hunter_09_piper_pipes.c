...
func_1()
{
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x8  // @src ps_hunter_09_piper_pipes.sc:17
    r2 = 0;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x8  // @src ps_hunter_09_piper_pipes.sc:18
    r2 = 1;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
...
func_3()
{
  ...
  L_0198:
    r2 = GetDotStr("remove");  // @pool 0x2b  // @src ps_hunter_09_piper_pipes.sc:32
    GetDot(r1, 0);
    Free2(r2, r1);
