...
{
    // lympha_fall.sc:5
    r1 = GetDotStr("trace");  // @pool 0x0  // @src lympha_fall.sc:5
...
{
    // lympha_fall.sc:15
    r1 = GetDotStr("trace");  // @pool 0x0  // @src lympha_fall.sc:15
  ...
  L_0080:
    ...
    if (!r1) goto L_00ec;
    // lympha_fall.sc:18
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x88  // @src lympha_fall.sc:18
    r3 = r0;
    r4 = "PPeriod";
    r5 = 2048;
    GetDot(r1, 3);
  ...
  L_00ec:
    ...
    Call(r1, 0x0434);
    // lympha_fall.sc:23
    r1 = GetDotStr("updateAllEmmiters");  // @pool 0xab  // @src lympha_fall.sc:23
    r2 = 16000000;
    GetDot(r0, 1);
    Free2(r1, r0);
    // lympha_fall.sc:26
...
{
    // lympha_fall.sc:35
    r1 = GetDotStr("!vector");  // @pool 0xbd  // @src lympha_fall.sc:35
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // lympha_fall.sc:36
    r2 = GetDotStr("!vector");  // @pool 0xbd  // @src lympha_fall.sc:36
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // lympha_fall.sc:39
    r4 = GetDotStr("World");  // @pool 0xc5  // @src lympha_fall.sc:39
    SetDotRaw(r3, 203);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
...
func_4()
{
  ...
  L_0444:
    ...
    if (!r1) goto L_0500;
    // lympha_fall.sc:71
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x88  // @src lympha_fall.sc:71
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 1;
