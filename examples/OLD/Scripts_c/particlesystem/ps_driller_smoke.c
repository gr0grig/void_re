...
func_1()
{
    ...
    r3 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_driller_smoke.sc:14
    r4 = 0;
    r5 = "PPeriod";
    r6 = 200;
    GetDot(r2, 3);
  ...
  L_00bc:
    ...
    r5 = GetDotStr("!vec3");  // @pool 0x23  // @src ps_driller_smoke.sc:18
    r6 = r3;
    r7 = r2;
    r7 = Cos(r7);
    r6 = r6 * r7;
    ...
    r6 = GetDotStr("addEmmiterPoint");  // @pool 0x29  // @src ps_driller_smoke.sc:19
    r7 = 0;
    r8 = r4;
    r9 = 1;
    GetDot(r5, 3);
  ...
  L_01d0:
    ...
    r3 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_driller_smoke.sc:27
    r4 = 0;
    r5 = "PPeriod";
    r6 = 1000000;
    GetDot(r2, 3);
  ...
  L_021c:
    ...
    r4 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_driller_smoke.sc:33
    r5 = 0;
    r6 = "PPeriod";
    r7 = 10;
    GetDot(r3, 3);
  ...
  L_02a4:
    r4 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_driller_smoke.sc:36
    r5 = 0;
    r6 = "PPeriod";
    r7 = 200;
    GetDot(r3, 3);
