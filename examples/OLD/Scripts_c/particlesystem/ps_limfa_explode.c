...
func_2()
{
    ...
    r1 = GetDotStr("setSysParameterVector");  // @pool 0x0  // @src ps_limfa_explode.sc:17
    r2 = 0;
    r3 = "PColor";
    r4 = r_neg4;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterVector");  // @pool 0x0  // @src ps_limfa_explode.sc:18
    r2 = 2;
    r3 = "PColor";
    r4 = r_neg4;
    GetDot(r0, 3);
...
func_3()
{
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x22  // @src ps_limfa_explode.sc:28
    r2 = 0;
    r3 = "PPeriod";
    r4 = 10000000;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x22  // @src ps_limfa_explode.sc:30
    r2 = 2;
    r3 = "PPeriod";
    r4 = 10000000;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("remove");  // @pool 0x45  // @src ps_limfa_explode.sc:33
    GetDot(r0, 0);
    Free2(r1, r0);
