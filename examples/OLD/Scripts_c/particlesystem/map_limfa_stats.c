...
func_3()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x0  // @src map_limfa_stats.sc:30
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // map_limfa_stats.sc:31
    r2 = GetDotStr("!vector");  // @pool 0x0  // @src map_limfa_stats.sc:31
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // map_limfa_stats.sc:34
    r4 = GetDotStr("World");  // @pool 0x8  // @src map_limfa_stats.sc:34
    SetDotRaw(r3, 14);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
  ...
  L_01cc:
    ...
    r5 = GetDotStr("remove");  // @pool 0x51  // @src map_limfa_stats.sc:44
    GetDot(r4, 0);
    Free2(r5, r4);
  ...
  L_0218:
    ...
    r8 = GetDotStr("irandMax");  // @pool 0x58  // @src map_limfa_stats.sc:51
    r10 = r1;
    SetDotRaw(r9, 97);
    Free1(r10);
    GetDot(r7, 1);
...
{
    // ../gameplay.sci:728
    r2 = GetDotStr("World");  // @pool 0x8  // @src ../gameplay.sci:728
    SetDotRaw(r1, 103);
    Free1(r2);
    r2 = "Chapter";
    SetDot(r0, 1);
...
func_6()
{
  ...
  L_053c:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x7a  // @src map_limfa_stats.sc:71
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 4;
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x7a  // @src map_limfa_stats.sc:72
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 4;
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x7a  // @src map_limfa_stats.sc:73
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 4;
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x7a  // @src map_limfa_stats.sc:74
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 4;
