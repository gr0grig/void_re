...
func_2()
{
  ...
  L_0038:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src lympha_fall_bottles1.sc:19
    r3 = r0;
    r4 = "PPeriod";
    r5 = 2048;
    GetDot(r1, 3);
  ...
  L_00a4:
    ...
    r1 = GetDotStr("updateAllEmmiters");  // @pool 0x23  // @src lympha_fall_bottles1.sc:24
    r2 = 16000000;
    GetDot(r0, 1);
    Free2(r1, r0);
...
func_3()
{
    ...
    r1 = GetDotStr("!vector");  // @pool 0x35  // @src lympha_fall_bottles1.sc:36
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // lympha_fall_bottles1.sc:37
    r2 = GetDotStr("!vector");  // @pool 0x35  // @src lympha_fall_bottles1.sc:37
    GetDot(r1, 0);
    Free1(r2);
    r1 = (str)r1;
    // lympha_fall_bottles1.sc:40
    r4 = GetDotStr("World");  // @pool 0x3d  // @src lympha_fall_bottles1.sc:40
    SetDotRaw(r3, 67);
    Free1(r4);
    r4 = "getPlayerEntity";
    GetDot(r2, 1);
...
func_5()
{
  ...
  L_0438:
    ...
    r2 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src lympha_fall_bottles1.sc:68
    r5 = r_neg4;
    r6 = r0;
    SetDot(r4, 1);
    r5 = 1;
