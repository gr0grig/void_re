...
func_1()
{
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_hunter_09_piper_teleport_out.sc:8
    r2 = 0;
    r3 = "PPeriod";
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_hunter_09_piper_teleport_out.sc:9
    r2 = 1;
    r3 = "PPeriod";
    r4 = 0;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_hunter_09_piper_teleport_out.sc:17
    r2 = 1;
    r3 = "PPeriod";
    r4 = 6;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_hunter_09_piper_teleport_out.sc:21
    r2 = 0;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
    ...
    r1 = GetDotStr("setSysParameterFloat");  // @pool 0x0  // @src ps_hunter_09_piper_teleport_out.sc:22
    r2 = 1;
    r3 = "PPeriod";
    r4 = 65535;
    GetDot(r0, 3);
...
func_3()
{
  ...
  L_0268:
    r2 = GetDotStr("remove");  // @pool 0x2b  // @src ps_hunter_09_piper_teleport_out.sc:36
    GetDot(r1, 0);
    Free2(r2, r1);
