...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @pool 0x0  // @src gen_sound2dperiod.sc:11
    r0 = (str)r0;
    r0 = g0;
    Free1(r0);
    // gen_sound2dperiod.sc:13
    r1 = GetDotStr("loadSound");  // @pool 0xb  // @src gen_sound2dperiod.sc:13
    g3 = r0;
    SetDotRaw(r2, 15);
    Free1(r3);
    GetDot(r0, 1);
  ...
  L_00ac:
    ...
    r1 = GetDotStr("Scene");  // @pool 0x1b  // @src gen_sound2dperiod.sc:24
    r1 = (str)r1;
    g2 = r1;
    r3 = "Sound";
    g5 = r0;
  ...
  L_015c:
    ...
    SetDotRaw(r1, 50);
    Free1(r2);
    r3 = GetDotStr("randMax");  // @pool 0x3d
    g5 = r0;
    SetDotRaw(r4, 69);
    Free1(r5);
    GetDot(r2, 1);
...
func_3()
{
    ...
    r1 = (str)r1;
    // ..\sound.sci:211
    r6 = GetDotStr("Globals");  // @pool 0x67  // @src ..\sound.sci:211
    SetDotRaw(r5, 111);
    Free1(r6);
    r6 = r_neg5;
    SetDot(r4, 1);
...
{
    // ..\sound.sci:9
    r2 = GetDotStr("Settings");  // @pool 0x7a  // @src ..\sound.sci:9
    r3 = r_neg4;
    r4 = "Volume";
    r3 = r3 + r4;
    SetDot(r1, 1);
...
{
    // ..\sound.sci:28
    r2 = GetDotStr("Scene");  // @pool 0x1b  // @src ..\sound.sci:28
    SetDotRaw(r1, 151);
    Free1(r2);
