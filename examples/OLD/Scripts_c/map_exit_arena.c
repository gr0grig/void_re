...
func_3()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0x0  // @src map_exit_arena.sc:55
    SetDotRaw(r1, 6);
    Free1(r2);
    r2 = "onLocationExit";
    GetDot(r0, 1);
...
func_4()
{
    ...
    r3 = GetDotStr("Scene");  // @pool 0x0  // @src map_exit_arena.sc:34
    SetDotRaw(r2, 39);
    Free1(r3);
    r3 = "pt_exit";
    GetDot(r1, 1);
    ...
    r3 = GetDotStr("Scene");  // @pool 0x0  // @src map_exit_arena.sc:35
    SetDotRaw(r2, 64);
    Free1(r3);
    r3 = "pt_exit";
    GetDot(r1, 1);
  ...
  L_010c:
    r2 = GetDotStr("logInfo");  // @pool 0x54  // @src map_exit_arena.sc:38
  ...
  L_0138:
    ...
    r3 = GetDotStr("Scene");  // @pool 0x0  // @src map_exit_arena.sc:44
    SetDotRaw(r2, 6);
    Free1(r3);
    r3 = "onLocationExit";
    GetDot(r1, 1);
  ...
  L_0180:
    r3 = GetDotStr("World");  // @pool 0x9c  // @src map_exit_arena.sc:48
    SetDotRaw(r2, 162);
    Free1(r3);
