...
func_1()
{
    ...
    r0 = GetDotStr("Properties");  // @pool 0x0  // @src DeveloperCommentary.sc:11
    r0 = (str)r0;
    r0 = g0;
    Free1(r0);
...
onUse()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0xb  // @src DeveloperCommentary.sc:38
    SetDotRaw(r1, 17);
    Free1(r2);
    r2 = "onCommentaryActivate";
    r3 = GetDotStr("self");  // @pool 0x3e
    GetDot(r0, 2);
    Free4(r1, r2, r3, r0);
    // DeveloperCommentary.sc:40
    r1 = GetDotStr("playSoundInScene");  // @pool 0x43  // @src DeveloperCommentary.sc:40
    r2 = GetDotStr("Scene");  // @pool 0xb
    r4 = GetDotStr("loadSound");  // @pool 0x54
    g7 = r0;
    SetDotRaw(r6, 88);
    Free1(r7);
    SetDotRaw(r5, 94);
...
onCommentaryStop()
{
    ...
    r2 = GetDotStr("Scene");  // @pool 0xb  // @src DeveloperCommentary.sc:64
    SetDotRaw(r1, 17);
    Free1(r2);
...
func_5()
{
    ...
    r1 = GetDotStr("call");  // @pool 0x11  // @src DeveloperCommentary.sc:76
    r2 = "onUse";
    r3 = null_str;
    r4 = 0;
    r5 = 0;
