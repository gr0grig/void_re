...
func_1()
{
  ...
  L_0388:
    ...
    r2 = g8;
    // tree_base.sci:113
    CallNat(r3, 10100, 0x200);  // @src tree_base.sci:113
}
...
func_13()
{
  ...
  L_1068:
    ...
    // tree_base.sci:260
    Call(r3, 0x1844);  // @src tree_base.sci:260
    // tree_base.sci:257
  ...
  L_1360:
    ...
    Free4(r9, r11, r12, r8);
    // tree_base.sci:300
    Call(r8, 0x1844);  // @src tree_base.sci:300
    // tree_base.sci:273
...
func_15()
{
    ...
    g0 = r9;  // @src tree_bridgeship.sc:11
    if (r0) goto L_16a0;
    // tree_bridgeship.sc:12
    r1 = GetDotStr("!qtpair");  // @pool 0x38e  // @src tree_bridgeship.sc:12
    ...
    r3 = GetDotStr("World");  // @pool 0xa6  // @src tree_bridgeship.sc:13
    SetDotRaw(r2, 936);
    Free1(r3);
...
func_16()
{
    ...
    g3 = r9;  // @src tree_bridgeship.sc:21
    SetDotRaw(r2, 1009);
    Free1(r3);
    r3 = 0;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_bridgeship.sc:22
    SetDotRaw(r2, 1009);
    Free1(r3);
    r3 = 1;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_bridgeship.sc:23
    SetDotRaw(r2, 1009);
    Free1(r3);
    r3 = 2;
    r4 = "PSColor";
    ...
    g3 = r9;  // @src tree_bridgeship.sc:24
    SetDotRaw(r2, 1009);
    Free1(r3);
    r3 = 3;
    r4 = "PSColor";
...
func_22()
{
    ...
    g0 = r10;  // @src tree_bridgeship.sc:49
    if (!r0) goto L_1afc;
    // tree_bridgeship.sc:50
    g2 = r10;  // @src tree_bridgeship.sc:50
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
  ...
  L_1afc:
    g0 = r9;  // @src tree_bridgeship.sc:52
    if (!r0) goto L_1b38;
    // tree_bridgeship.sc:53
    g2 = r9;  // @src tree_bridgeship.sc:53
    SetDotRaw(r1, 784);
    Free1(r2);
    r2 = r_neg4;
    GetDot(r0, 1);
...
onUse()
{
    ...
    r3 = r3 == r4;
    if (r3) goto L_1d04;
    r4 = GetDotStr("getGestureName");  // @pool 0x505
    r5 = "player";
    r6 = r_neg6;
    GetDot(r3, 2);
    Free2(r4, r5);
  ...
  L_1db8:
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀...";  // len=119, pool_off=0x44a, GARBLED
    // tree_base.sci:158
    r3 = 0;  // @src tree_base.sci:158
    r4 = r2;
    SetInd(r4);
    r0 = "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀...";  // len=113, pool_off=0x44a, GARBLED
    // tree_base.sci:159
    ...
    r4 = r2;
    SetInd(r4);
    r0 = "敬楓敺湉牣慥敳娀湯䱥浩慦䤀渀猀攀爀琀攀搀...";  // len=195, pool_off=0x44a, GARBLED
    // tree_base.sci:161
    ...
    if (!r5) goto L_1f80;
    // tree_base.sci:165
    Call(r5, 0x223c);  // @src tree_base.sci:165
    // tree_base.sci:166
  L_1f80:
    ...
    if (!r5) goto L_1fac;
    // tree_base.sci:167
    Call(r5, 0x22ac);  // @src tree_base.sci:167
    // tree_base.sci:166
    goto L_1fb4;  // @src tree_base.sci:166
    // tree_base.sci:169
  L_1fac:
    Call(r5, 0x231c);  // @src tree_base.sci:169
    // tree_base.sci:171
  L_1fb4:
    ...
    Free2(r8, r6);
    // tree_base.sci:177
    CallNat2(r4, 9100, 0x600);  // @src tree_base.sci:177
    // tree_base.sci:181
...
{
    // tree_base.sci:51
    r1 = GetDotStr("irandMax");  // @pool 0x5d0  // @src tree_base.sci:51
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:45
    r1 = GetDotStr("irandMax");  // @pool 0x5d0  // @src tree_base.sci:45
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
{
    // tree_base.sci:39
    r1 = GetDotStr("irandMax");  // @pool 0x5d0  // @src tree_base.sci:39
    r2 = 3;
    GetDot(r0, 1);
    Free1(r1);
    r0 = (int)r0;
...
func_29()
{
    ...
    Call(r1, 0x15e8);
    // tree_base.sci:209
    Call(r1, 0x26a8);  // @src tree_base.sci:209
    // tree_base.sci:211
  ...
  L_2558:
    ...
    Free4(r6, r8, r9, r5);
    // tree_base.sci:219
    goto L_2558;  // @src tree_base.sci:219
    // tree_base.sci:227
  L_2694:
...
{
    // gameplay.sci:402
    r1 = GetDotStr("!vector");  // @pool 0x5f1  // @src gameplay.sci:402
    GetDot(r0, 0);
    Free1(r1);
    r0 = (str)r0;
    // gameplay.sci:405
